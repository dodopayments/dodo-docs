...
description: Learn how to migrate your existing subscribers and payment methods
  from your current payment processor to Dodo Payments.
icon: file-import
keywords:
  - Dodo Payments
---
...
Dodo Paymentsでサブスクリプションがどのように機能するかを理解するためにAPIを探検してください。
</Card>
</CardGroup>
