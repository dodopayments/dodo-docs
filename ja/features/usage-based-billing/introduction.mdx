...
<Frame>
<img src="/images/usage-based/UBB-2.png" alt="メーターインターフェースの作成" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/usage-based/UBB-4.png" alt="価格設定の構成" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
ドル単位で課金する代わりに、メーターを構成して顧客の[クレジット残高](/features/credit-based-billing)から差し引かれるようにできます。クレジットは各請求サイクルでリフレッシュされ、超過料金より前に適用されます。
...
<Frame>
<img src="/images/usage-based/UBB-5.png" alt="製品へのメーター追加" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/guides/usage-based-billing/meter-quantities-chart.png" alt="メーターダッシュボード" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
