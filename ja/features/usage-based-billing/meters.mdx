...
<Frame>
<img src="/images/usage-based/UBB-2.png" alt="イベント名、集計タイプ、フィルタリングオプションを示すメーター作成インターフェイス" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/usage-based/UBB-3.png" alt="イベントフィルタリング" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
**比較演算子**: 等しい、等しくない、より大きい、以上、より小さい、以下、含む、含まない
...
<Frame>
<img src="/images/usage-based/UBB-1.png" alt="メーター分析" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Attach Credit - UBB-5.jpg" alt="クレジットのビル使用が有効になっているメーター設定" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
