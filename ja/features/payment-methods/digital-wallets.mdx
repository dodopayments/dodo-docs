...
| ウォレット | 利用可能地域 | 通貨 | サブスクリプション | 設定要件 |
| :----- | :----------- | :--------- | :-----------: | :------------- |
| **Apple Pay** | グローバル（インドを除く） | すべて | はい | ドメイン認証 |
| **Google Pay** | グローバル（インドを除く） | すべて | はい | なし |
| **Amazon Pay** | グローバル（インドを除く） | USD | いいえ | なし |
| **Cash App Pay** | 米国のみ | USD | はい | なし |
| **RevolutPay** | グローバル | GBP | いいえ | なし |
