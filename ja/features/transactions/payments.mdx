---
title: Payments
description: The Payments section provides merchants with a detailed overview of
  all payment transactions. Merchants can track payment statuses, initiate
  refunds, and access payment details for each transaction.
...
<img src="/images/transactions/payments/successful-payment.png" alt="支払い詳細ページに緑のステータスと取引内訳が表示された成功した支払い" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/transactions/payments/failed-payment.png" alt="支払い詳細ページに赤いエラーバナー、拒否エラーコードとメッセージが表示された失敗した支払い" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
