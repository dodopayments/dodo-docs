...
### 1. **コミュニケーション設定**
   ...
   <Frame>
     <img src="/images/communication-preferences/overview.png" alt="通知設定を示すコミュニケーション設定の概要" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
...
### 2. **チェックアウトセッションのカスタムフィールド**
   ...
   **利点**
   ...
   <Info>
   カスタムフィールドの値は、支払いおよびサブスクリプションのレスポンス内の`custom_field_responses`配列で返されます。
   </Info>

   詳細: [チェックアウトセッションのカスタムフィールド](/developer-resources/checkout-session#15-collecting-custom-fields)
