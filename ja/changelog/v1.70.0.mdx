...
1. **インラインチェックアウト - 完全に埋め込まれたチェックアウト体験 (BETA)**  
   ...
   <Frame>
   <img src="/images/inline-checkout/cover.png" alt="インラインチェックアウトカバー画像" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
...
3. **ダッシュボードでのサブスクリプションプランの変更と次回請求日更新**  
    ...
    <Frame>
    <img src="/images/changelog/subscription-plan-changes.png" alt="ダッシュボードでのサブスクリプションプランの変更" style={{ maxHeight: '500px', width: 'auto' }} />
    </Frame>
...
4. **支払いURLの短縮リンク**  
   ...
   <Frame>
   <img src="/images/changelog/short-links.png" alt="支払いURLのショートリンク機能" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
