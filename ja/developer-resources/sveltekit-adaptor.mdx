...
description: Learn how to integrate Dodo Payments with your SvelteKit App Router
  project using our SvelteKit Adaptor. Covers checkout, customer portal,
  webhooks, and secure environment setup.
icon: code-merge
---
