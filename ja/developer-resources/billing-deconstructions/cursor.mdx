...
keywords: ["Dodo Payments", "Cursor", "Cursor billing", "AI code editor pricing", "billing model", "cursor billing model"]
---
...
**Pricing Tiers**: Cursor offers tiers from Hobby to Ultra, balancing premium and standard access to fit different workflows.
...
**Model-Weighted Depletion**: Different requests consume different amounts of credits based on the underlying model's cost. This allows Cursor to offer a single subscription that covers multiple providers while ensuring expensive operations are accounted for.
...
**Credit Exhaustion and Overages**: When credits run out, users move to a "Slow" queue with cheaper models instead of being cut off. Alternatively, they can enable usage-based overages to maintain premium access at a fixed per-request cost.
