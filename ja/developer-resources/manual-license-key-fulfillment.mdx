...
- ダッシュボードから取得した API key（`DODO_PAYMENTS_API_KEY`）と webhook secret key。[API key generation guide](/api-reference/introduction#api-key-management-and-authentication)を参照してください。
- webhookを受信できるバックエンドエンドポイント。
