...
<Tip>
`--format json`を使用して、`jq`でシェルスクリプト内で強力なデータ処理を行うことができます。
</Tip>
...
- **Discord**: 私たちの[コミュニティサーバー](https://discord.gg/bYqAp4ayYh)に参加してください
- **Email**: support@dodopayments.comまでご連絡ください
- **GitHub**: [リポジトリ](https://github.com/dodopayments/dodopayments-cli)に問題をオープンしてください
