...
依存関係をあなたの`build.gradle`に追加してください:
...
<Tip>
最新のDodo Payments機能にアクセスするために、常に最新のSDKバージョンを使用してください。最新バージョンについては[Maven Central](https://central.sonatype.com/artifact/com.dodopayments.api/dodo-payments-java)を確認してください。
</Tip>
