...
関数型のエラーハンドリングには `Result` を使用してください:
...
<Tip>
Result 型を用いたより関数型のエラーハンドリングには Kotlin の `runCatching` を使用してください。
</Tip>
...
貢献を歓迎します！始めるための[貢献ガイドライン](https://github.com/dodopayments/dodopayments-kotlin/blob/main/CONTRIBUTING.md)を確認してください。
