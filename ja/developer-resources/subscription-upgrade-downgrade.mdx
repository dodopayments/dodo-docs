...
<Info>
<code>difference_immediately</code>を使用して作成されたクレジットは購読スコープであり、<a href="/features/credit-based-billing">Credit-Based Billing</a>の権利とは別のものです。同じ購読の将来の更新時に自動的に適用され、購読間で移行することはできません。
</Info>
...
- `subscription.on_hold`に対するアラートを実装する
