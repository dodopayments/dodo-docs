...
- `subscription.active`: プラン変更に成功し、サブスクリプションが更新されました
- `subscription.plan_changed`: サブスクリプションプランが変更されました（アップグレード／ダウングレード／アドオンの更新）
- `subscription.on_hold`: プラン変更の請求に失敗し、更新が停止されました
- `payment.succeeded`: プラン変更の即時請求に成功しました
...
- `subscription.on_hold`: 請求に失敗し、更新が停止されました
- `subscription.renewed`: 更新に成功しました
- `payment.succeeded`: プラン変更または更新の支払いに成功しました
