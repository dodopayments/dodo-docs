...
<Card title="TypeScript SDK" icon="js" href="/developer-resources/sdks/typescript">
  TypeScriptとNode.jsのための型安全な統合、PromiseベースのAPIと自動ページネーション
</Card>

<Card title="Python SDK" icon="python" href="/developer-resources/sdks/python">
  Python 3.7+アプリケーション向けのasync/awaitサポートを持つPythonicインターフェース
</Card>
...
<Card title="Go SDK" icon="golang" href="/developer-resources/sdks/go">
  コンテキストサポートと強い型付けを持つ慣用的なGoインターフェース
</Card>
...
<Step title="クライアントを初期化する">
  ...
  <Warning>
  APIキーは環境変数を使用して安全に保管してください。バージョン管理にコミットしないでください。
  </Warning>
</Step>
...
- **認証**: 環境変数サポートを持つシンプルなAPIキー認証
- **非同期サポート**: 適用可能な場合のモダンなasync/awaitパターン
...
<Info>
Apple Pay、Google Pay、Cash App、UPIは現在React Native SDKでサポートされていません。これらの支払い方法のサポートは今後のリリースで計画されています。
</Info>
...
すべてのSDKへの貢献を歓迎します！各リポジトリには、以下のガイドラインを含む`CONTRIBUTING.md`ファイルがあります：
