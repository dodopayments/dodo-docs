...
<Frame>
  <img src="/images/cover-images/Webhooks.webp" alt="Webhook カバー画像" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Step title="Create Webhook Endpoint">
    ...
    <Frame>
        <img src="/images/webhooks/create-endpoint.png" alt="Webhookを追加" style={{ maxHeight: '500px', width: 'auto' }} />
    </Frame>
</Step>
...
<Expandable title="Data object properties">
  ...
  リソースのタイプ。以下のいずれかです: `Payment`, `Subscription`, `Refund`, `Dispute`, `LicenseKey`, `CreditLedgerEntry`, `CreditBalanceLow`, `AbandonedCheckout`, `DunningAttempt`, または `EntitlementGrant`。
  </ResponseField>
  
  追加のフィールドはイベントタイプによって異なります。完全なスキーマについては、イベント固有のドキュメントを参照してください。
</Expandable>
</ResponseField>
...
<Frame>
    <img src="/images/webhooks/endpoints.png" alt="エンドポイントの詳細" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
このインタラクティブツールを使用すると、サポートされているすべてのイベントタイプから選択し、リアルなモックペイロードをエンドポイントに送信できます。複数のイベントを一度にテストできるようにループします。
...
<Frame>
    <img src="/images/webhooks/logs.png" alt="ログ" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
    <img src="/images/webhooks/activity.png" alt="アクティビティ" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/images/webhooks/alerting.png" alt="Webhookアラート設定でメール通知設定を表示" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
