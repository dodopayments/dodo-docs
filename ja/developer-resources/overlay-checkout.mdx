...
<Tip>
**オーバーレイチェックアウト**を使用して、既存のページに最小限の変更で迅速に統合します。**インラインチェックアウト**を使用して、チェックアウトエクスペリエンスとシームレスなブランディングに最大の制御を持ちます。
</Tip>
...
<Card title="インラインチェックアウト" icon="credit-card" href="/developer-resources/inline-checkout">
    ページに直接チェックアウトを埋め込んで、完全に統合されたエクスペリエンスを提供します。
</Card>

<Card title="チェックアウトセッション API" icon="code" href="/api-reference/checkout-sessions/create">
    チェックアウトエクスペリエンスを強化するためにチェックアウトセッションを作成します。
</Card>
