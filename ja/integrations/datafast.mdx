...
<Step title="Open the Webhook Section">
  Dodo Payments ダッシュボードで、<b>Webhooks → + エンドポイントを追加</b>を選択し、統合のドロップダウンを展開します。
  <Frame>
    <img src="/images/integrations/datafast/add.png" alt="エンドポイントを追加と統合ドロップダウン" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
...
<Step title="Enter API Key">
  設定フィールドに DataFast API キーを提供します。
  <Frame>
    <img src="/images/integrations/datafast/api-key.png" alt="API キーを追加" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
