...
<Step title="Open the Webhook Section">
  Dodo Payments ダッシュボードで、<b>Webhooks → + エンドポイントの追加</b> に移動し、統合ドロップダウンを展開します。
  <Frame>
    <img src="/images/integrations/close-crm.png" alt="エンドポイントの追加と統合のドロップダウン" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
