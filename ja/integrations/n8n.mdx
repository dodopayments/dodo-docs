...
<Step title="Open the Webhook Section">
  Dodo Payments ダッシュボードで、<b>Webhooks → + エンドポイントの追加</b>をナビゲートし、統合のドロップダウンを展開します。
  <Frame>
    <img src="/images/integrations/n8n.png" alt="エンドポイントと統合ドロップダウンの追加" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
