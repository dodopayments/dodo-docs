...
- **Lemon Squeezy ヘルプ**: `dodo-migrate lemonsqueezy --help`
- **Stripe ヘルプ**: `dodo-migrate stripe --help`
- **Polar.sh ヘルプ**: `dodo-migrate polar --help`
- **Paddle ヘルプ**: `dodo-migrate paddle --help`
- **コミュニティサポート**: [Discord](https://discord.gg/bYqAp4ayYh)
- **問題報告**: [GitHub](https://github.com/dodopayments/dodo-migrate)
