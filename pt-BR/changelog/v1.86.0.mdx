...
Os créditos são anexados como **direitos** no fluxo de criação do produto. Você pode anexar até **5 créditos por produto**, e eles funcionam com os três tipos de precificação: assinaturas, pagamentos únicos e cobrança baseada em uso.
...
Saiba mais: [List Payments API](/api-reference/payments/get-payments)
