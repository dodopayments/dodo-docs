...
<Frame>
<img src="/images/CBB/Checkout.png" alt="Finalização de compra mostrando créditos incluídos com a compra do produto" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/CBB/Customer Portal.jpg" alt="Visualização de créditos no Portal do Cliente com saldo e histórico de transações" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/design/general-color-settings.jpg" alt="Configurações avançadas expandidas mostrando configuração completa de cores para modos claro e escuro" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Tip>
Use estes campos para construir painéis de disputas e reembolsos, acionar alertas sobre mudanças de status de disputas ou destacar pagamentos que precisam de atenção.
</Tip>

Saiba mais: [API List Payments](/api-reference/payments/get-payments)

### 4. **Tabela de Reembolsos no Portal do Cliente**

O Portal do Cliente agora inclui uma seção dedicada a **Reembolsos**, onde os clientes podem ver todos os reembolsos associados aos seus pagamentos. Cada entrada de reembolso mostra o valor do reembolso, status, data e o pagamento original contra o qual foi emitido, proporcionando aos clientes total transparência no histórico de reembolsos sem precisar contatar o suporte.

<Check>
A tabela de reembolsos está disponível automaticamente no portal do cliente para todos os negócios. Nenhuma configuração é necessária.
</Check>

Saiba mais: [Portal do Cliente](/features/customer-portal)

### 5. **Copiar para Modo Live para Medidores**

Agora você pode **copiar medidores do modo de teste para o modo live** diretamente do painel. Quando terminar de testar uma configuração de medidor no modo de teste, use a ação de cópia para replicá-la no modo live com todas as configurações preservadas: tipo de agregação, nome do evento, filtros e associações de crédito. Isso elimina a necessidade de recriar manualmente os medidores ao passar do desenvolvimento para a produção.

<Tip>
Construa e valide suas configurações de medidor no modo de teste primeiro, depois copie-as para o modo live quando estiver pronto para ir para produção. Isso garante que sua configuração de cobrança seja testada antes de lidar com o uso real do cliente.
</Tip>
