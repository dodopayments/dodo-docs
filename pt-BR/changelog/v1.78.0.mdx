...
keywords:
  ...
  - v1.78.0 (2 de fevereiro de 2026)
---
...
### 1. **Preferências de Comunicação**
   ...
   <Frame>
     <img src="/images/communication-preferences/overview.png" alt="Visão geral das Preferências de Comunicação mostrando as configurações de notificação" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
...
### 2. **Campos Personalizados em Sessões de Checkout**
   ...
   **Benefícios**
   ...
   <Info>
   Os valores de campos personalizados são retornados no array `custom_field_responses` nas respostas de pagamentos e assinaturas.
   </Info>

   Saiba mais: [Campos personalizados da sessão de Checkout](/developer-resources/checkout-session#15-collecting-custom-fields)
