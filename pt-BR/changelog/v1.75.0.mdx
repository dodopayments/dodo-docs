...
### 1. **Coleções de Produtos**  
   ...
   <Frame>
     <img src="/images/product-collection/checkout-page.png" alt="Página de finalização de compra da coleção de produtos mostrando múltiplas opções de plano" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
...
### 3. **Pré-visualização da Sessão de Checkout**  
   ...
   **Como Funciona**
   ...
   console.log('Total:', preview.total_price);
   ```
