...
keywords:
  ...
  - v1.84.0 (20 de fevereiro de 2026)
---
...
<Frame>
<img src="/images/product-analytics/overview.png" alt="Análises em Nível de Produto" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
| Benefit | Impacto |
|---------|--------|
| **Taxa de disputa reduzida** | Disputas resolvidas por RDR não contam para o limite de 0,9% da Visa |
| **Taxa de disputa ainda se aplica** | Uma taxa de disputa ainda é cobrada em transações resolvidas por RDR - isso cobre o custo de contestar com a Visa em seu nome |
| **Nenhuma sobrecarga operacional** | Sem coleta de evidências ou prazos de resposta |
| **Melhor experiência do cliente** | Portadores de cartão recebem reembolsos instantâneos |
| **Proteção de conta** | Mantenha-se fora do Programa de Monitoramento de Disputas da Visa (VDMP) |
...
<Frame>
<img src="/images/customer-portal/new-portal.png" alt="Reforma do UI do Portal do Cliente" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
