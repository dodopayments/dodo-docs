...
keywords:
  ...
  - v1.81.0 (6 de fevereiro de 2026)
---
...
Adicionado o campo `refund_status` à resposta `GET /payments/{payment_id}` para verificar rapidamente se um pagamento foi reembolsado sem consultar separadamente o endpoint de reembolsos.
