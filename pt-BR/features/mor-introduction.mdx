...
Sim. Com o [Bring Your Own Processor (BYOP)](/features/byop), você pode conectar sua própria conta Stripe ou Adyen e encaminhar pagamentos de países selecionados por ela, enquanto a Dodo Payments continua fornecendo produtos, assinaturas, faturamento e analytics. Os países que você não encaminhar explicitamente continuarão sendo processados pela Dodo Payments como seu Merchant of Record de serviço completo, o que nos permite assumir a responsabilidade tributária e por fraudes nesses fluxos.
</Accordion>
