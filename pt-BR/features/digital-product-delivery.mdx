...
description: The Digital Product Delivery feature in Dodo Payments allows
  merchants to deliver digital products to their customers.
icon: download
keywords:
  - Dodo Payments
...
<Frame>
<img src="/images/digital-product-delivery/2.png" alt="Email de confirmação de compra mostrando links de download para produtos digitais" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
