...
| Método de pagamento     | Países aceitos        | Moedas aceitas       | Assinaturas | Valor mínimo |
| :----------------------- | :------------------- | :------------------- | :-----------: | :--------- |
...
| **Przelewy24 (P24)**     | Polônia               | PLN                  | Não | 2.00 PLN |
...
| `blik` | BLIK (Polônia) |
| `sepa` | Débito direto SEPA (Zona do Euro) |
...
Os métodos BNPL têm valores mínimos por provedor: Klarna e Afterpay exigem $50.01. Não os inclua em produtos fora dessas faixas — eles simplesmente não aparecerão, o que não é um problema.
</Accordion>
...
5. Para assinaturas: o método oferece suporte a pagamentos recorrentes?
