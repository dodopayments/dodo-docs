...
<Step title="Defina o endereço de cobrança apropriado">
...
<Accordion title="Forneça alternativas de cartão">
...
2. Moeda definida como EUR?
3. Método incluído em `allowed_payment_method_types`?

**Solução:** Métodos europeus são estritamente regionais. Um cliente com país de cobrança `DE` (Alemanha) não verá iDEAL, que é exclusivo para os Países Baixos.
</Accordion>
