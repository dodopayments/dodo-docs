...
|-------|--------------|-------|
| **Por solicitação** | `mandate_min_amount_inr_paise` em uma checkout session ou subscription | Uma transação |
| **Merchant** | Configurações da empresa | Todas as suas subscriptions em INR |
