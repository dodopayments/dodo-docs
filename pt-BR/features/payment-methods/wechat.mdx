...
Crie uma sessão de checkout com `we_chat_pay` nos métodos de pagamento permitidos.
</Step>
...
**Verifique:**
1. `we_chat_pay` incluído em `allowed_payment_method_types`?
2. Moeda de faturamento configurada para USD ou CNY?
3. O valor da transação atende ao mínimo?
