...
Quando solicitado a informar um CPF do Pix, insira `1234567890`. Um QR code de teste será gerado — escaneie-o com a câmera normal do seu celular (não é necessário usar um aplicativo do Pix). Você será redirecionado para uma página de teste onde poderá simular a transação como sucesso ou falha.
</Step>
</Steps>
