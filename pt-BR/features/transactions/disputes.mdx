...
3. **Escolha Sua Resposta**
   ...
   <Frame>
       <img src="/images/disputes/1.png" alt="Criação de Disputa" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
...
5. **Se For Contestar**
   ...
   <Frame>
       <img src="/images/disputes/2.png" alt="Criação de Disputa" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
   
   <Frame>
       <img src="/images/disputes/3.png" alt="Criação de Disputa" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>

<Info>
Você tem **10 dias** para responder a uma contestação após sua criação. A contagem regressiva exibida na contestação em seu painel reflete o mesmo período.
</Info>
...
<Frame caption="Visa RDR configuration in the Dodo Payments dashboard">
    <img src="/images/disputes/rdr.png" alt="Configurações do Visa RDR mostrando a alternância habilitada e configuração de limite" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Step title="Open the Disputes Settings">
    Navegue até **Configurações → Negócio** no painel do Dodo Payments e localize a seção **Visa Rapid Dispute Resolution (RDR)**.
</Step>
