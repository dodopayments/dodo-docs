...
| `prorated_immediately` | Cobra com base no tempo restante do ciclo de cobrança | Cobrança justa baseada no tempo |
| `full_immediately` | Cobra o preço total do novo plano e ignora o tempo restante | Redefinição do ciclo de cobrança |
| `do_not_bill` | Aplica a alteração do plano sem cobrança imediata; o novo plano é cobrado na próxima renovação e a data de cobrança original é preservada | Upgrades de cortesia e migrações gratuitas |
