...
Timestamp ISO 8601 (UTC). Assume o horário atual do servidor se omitido. Inclua para um faturamento preciso com eventos atrasados/em lote. Timestamps com mais de 1 hora ou mais de 5 minutos no futuro serão rejeitados.
</ParamField>
...
<Tip>
Agrupe até 1.000 eventos por solicitação para melhor desempenho. A API impõe um limite rígido de 1.000 eventos por chamada.
</Tip>
