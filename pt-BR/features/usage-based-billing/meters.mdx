...
<Frame>
<img src="/images/usage-based/UBB-2.png" alt="Interface de criação de medidor mostrando o nome do evento, tipo de agregação e opções de filtragem" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/usage-based/UBB-3.png" alt="Filtragem de eventos" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
**Comparadores**: igual a, diferente de, maior que, maior ou igual a, menor que, menor ou igual a, contém, não contém
...
<Frame>
<img src="/images/usage-based/UBB-1.png" alt="Análise de medidor" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Attach Credit - UBB-5.jpg" alt="Configuração de medidor com cobrança de uso em créditos ativada" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
