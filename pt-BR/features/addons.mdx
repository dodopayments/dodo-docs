...
- **Preço**: Defina um preço único ou recorrente para o complemento
...
- **Limites de quantidade**: Defina as quantidades mínima e máxima por cliente
- **Disponibilidade**: Controle quais produtos de assinatura podem usar o complemento
- **Configurações de impostos**: Configure as categorias de impostos apropriadas
