...
<Frame>
<img src="/images/cookbooks/seat-based/seat-based-addons.png" alt="Complementos anexados a produtos de assinatura no painel" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/cookbooks/seat-based/seat-based-addons-creation.png" alt="Criando complementos na interface do painel" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
- **Preço**: Defina o valor do complemento (`price`) na menor unidade da moeda. O complemento é cobrado de acordo com o ciclo da assinatura principal
- **Moeda**: Defina o preço base em qualquer moeda que o Dodo Payments possa cobrar. O seletor de moedas pesquisável fixa **USD, GBP, EUR e INR** no topo; clientes fora da sua moeda base são cobrados por meio do [Adaptive Currency](/features/adaptive-currency)
- **Quantidade**: Os clientes escolhem uma quantidade quando o complemento é associado a uma assinatura
- **Disponibilidade**: Controle quais produtos de assinatura podem usar o complemento
- **Configurações de impostos**: Configure o `tax_category`
...
<Tip>
Para permitir que os clientes adicionem ou removam adicionais na página de checkout, defina a flag de recurso [`allow_editing_addons`](/developer-resources/checkout-session#optional-fields) como `true` ao criar a sessão. O padrão é `false` e se aplica apenas a produtos de assinatura.
...
### Alterações de Plano com Adicionais
Modifique assinaturas existentes para adicionar, remover ou atualizar adicionais:
...
### Preço Dinâmico
Calcule custos totais dinamicamente com base nas seleções de adicionais:
...
- **Comece simples**: Lançar com 2-3 adicionais principais e expandir opções com base no feedback dos clientes e uso.
- **Mantenha a clareza dos preços**: Comunique claramente o preço e o valor dos adicionais, para que os clientes entendam o que estão adquirindo pelo custo extra.
- **Teste minuciosamente**: Valide combinações de adicionais para garantir que os cálculos de preços permaneçam precisos e que os fluxos de checkout funcionem sem problemas.

### Considerações de Design

- **Proposta de Valor Clara**: Cada adicional deve ter um benefício claro que os clientes possam facilmente entender
- **Agrupamento Lógico**: Agrupar adicionais relacionados no seu fluxo de checkout
- **Quantidades Flexíveis**: Permitir que os clientes ajustem as quantidades dos adicionais conforme necessário
- **Preço Transparente**: Mostrar os custos totais claramente durante todo o processo de checkout

<Info>
Os adicionais são uma maneira poderosa de criar modelos de preços flexíveis e escaláveis que crescem com seus clientes. Comece com casos de uso simples e expanda conforme você aprende o que funciona melhor para seu negócio e clientes.
</Info>
