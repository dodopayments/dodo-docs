...
<img src="/images/CBB/Checkout.png" alt="Checkout mostrando créditos incluídos com a compra do produto" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Entitlements  - Credits.jpg" alt="Página de listagem de créditos mostrando direitos de crédito criados" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Create Credit.jpg" alt="Formulário de criação de crédito mostrando informações básicas, configurações gerais e configurações de assinatura" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - Subscription.jpg" alt="Seção de direitos do produto mostrando o botão de anexar Créditos" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - Subscription-2.jpg" alt="Painel Adicionar Créditos com dropdown de seleção de crédito" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Attach Credit - Subscription-4.jpg" alt="Formulário de configuração de crédito com ciclo de faturamento, teste e configurações de prorrata" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - Subscription-5.jpg" alt="Painel Adicionar Créditos mostrando crédito selecionado com detalhes" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
</Steps>
...
<img src="/images/CBB/Desktop - Attach Credit - OTP.jpg" alt="Seção de preços do produto com Pagamento Único selecionado" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - UBB.jpg" alt="Configuração de preço de Faturamento Baseado em Uso" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - UBB-3.jpg" alt="Painel Selecionar Medidor mostrando limite gratuito e alternância de crédito" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - UBB-5.jpg" alt="Configuração de medidor com seleção de crédito e unidades de medidor por crédito" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - UBB-6.jpg" alt="Configuração de crédito para produto UBB" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - UBB-1.jpg" alt="Medidor configurado mostrando detalhes de anexação de crédito" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
</Steps>
...
<img src="/images/CBB/Desktop - Usage Billing.jpg" alt="Painel de Faturamento por Uso mostrando tabela de eventos com créditos consumidos" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Checkout.png" alt="Página de checkout mostrando produto com créditos de chamada de API incluídos" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Customer Portal.jpg" alt="Vista de créditos no Portal do Cliente com saldo e histórico de transações" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Subscription Details.jpg" alt="Página de detalhes da assinatura mostrando direitos e histórico de uso" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Transactions - Payment Summary.jpg" alt="Página de detalhes da transação mostrando direitos de crédito" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Entitlements  - Credits.jpg" alt="Página de listagem de créditos na seção de Produtos" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Customer Details.jpg" alt="Página de detalhes do cliente com aba de Créditos mostrando saldo e transações" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
Inicie o cliente Dodo Payments:
...
**Configuração:**
- Tipo de Crédito: Unidade Personalizada ("AI Tokens")
- Precisão: 0 (tokens inteiros)
- Acúmulo: 25% no máximo, período de 1 mês
- Excedente: Habilitado, cobre o excedente na cobrança
...
| Plano | Preço | Créditos/Mês | Excedente |
|------|-------|---------------|---------|
| Free | $0/mo | 1,000 calls | Bloqueado |
| Developer | $19/mo | 50,000 calls | $0.001/call |
| Business | $99/mo | 500,000 calls | $0.0005/call |

**Configuração:**
- Tipo de Crédito: Unidade Personalizada ("API Calls")
- Precisão: 0 (chamadas inteiras)
- Acúmulo: Desativado
- Excedente: Planos Developer+ permitem excedente (perdoa no reset), plano Free desativa excedente
...
- Acúmulo: 50% no máximo, transfere uma vez
