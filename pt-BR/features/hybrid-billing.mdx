...
**Soluções**:
1. Utilize a API `previewChangePlan` para mostrar as cobranças exatas antes de confirmar
2. Comunique que a proporcionalidade se aplica tanto à assinatura quanto aos complementos
