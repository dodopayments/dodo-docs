...
**Team Analytics: US$ 20/usuário/mês**

**Cada usuário inclui:**
- Processamento de 5 GB de dados/mês
- Excedente: US$ 2/GB após o limite

**Cálculo de exemplo** (equipe de 10 usuários usando 80 GB no total):
- Taxas de assentos: 10 × US$ 20 = US$ 200,00
- Dados incluídos: 10 × 5 GB = 50 GB
- Excedente: (80 - 50) × US$ 2 = US$ 60,00
- **Total: US$ 260,00/mês**
...
Como não é possível associar usage meters e add-ons à mesma assinatura, escolha uma destas abordagens:
...
Acompanhe a quantidade de assentos e calcule as taxas de assentos separadamente.
...
<Info>
**Recomendação**: A Opção B (Add-on de assentos + uso sob demanda) costuma ser mais fácil de implementar porque Dodo gerencia a cobrança de assentos automaticamente. Você só precisa acompanhar e cobrar os excedentes de uso.
</Info>
...
O modelo mais abrangente: taxa da plataforma + por usuário + consumo.

<Warning>
**Restrição**: Dodo Payments atualmente não oferece suporte à associação de usage meters e add-ons ao mesmo produto de assinatura. Este modelo exige uma solução alternativa.
</Warning>
...
- **Taxa da plataforma**: US$ 199/mês
- **Por assento**: US$ 25/usuário/mês
- **Uso**: US$ 0,10/1.000 chamadas de API (50 mil incluídas)

**Cálculo de exemplo** (empresa com 20 usuários e 150.000 chamadas de API):
- Plataforma: US$ 199,00
- Assentos: 20 × US$ 25 = US$ 500,00
...
- **Plataformas de IA**: Workspace + desenvolvedores + inferência

### Opções de implementação

Escolha uma destas abordagens para implementar a cobrança do modelo híbrido triplo:

<Tabs>
<Tab title="Option A: Base + Seats (Add-on) + On-Demand Usage">
Use uma assinatura com add-ons de assentos e cobre o uso manualmente por meio de cobranças sob demanda.
...
Use uma assinatura com usage meter e gerencie a cobrança de assentos na sua aplicação.
...
## Modelo híbrido 6: base por níveis + excedente de uso

Diferentes níveis de assinatura com diferentes limites incluídos e taxas de excedente.

### Como funciona

| Nível | Preço | Chamadas incluídas | Taxa de excedente |
|------|-------|--------------------|-------------------|
| **Starter** | US$ 19/mês | 1.000 | US$ 0,02/chamada |
| **Pro** | US$ 79/mês | 25.000 | US$ 0,01/chamada |
| **Business** | US$ 199/mês | 100.000 | US$ 0,005/chamada |
| **Enterprise** | US$ 499/mês | 500.000 | US$ 0,002/chamada |
...
Quando os clientes fazem upgrade de nível, eles obtêm:
- Limite incluído maior
...
- Consultoria extra: US$ 150/hora
- Desenvolvimento personalizado: US$ 200/hora
- Suporte emergencial: US$ 100/incidente

**Cálculo de exemplo** (neste mês):
- Retenção: US$ 199,00
- 3 horas extras de consultoria: US$ 450,00
- 1 suporte emergencial: US$ 100,00
- **Total: US$ 749,00**

### Casos de uso

- **Serviços de consultoria**: Retenção + cobrança por hora
- **Serviços gerenciados**: Taxa base + cobranças por incidente
- **Serviços de agência**: Taxa mensal + cobranças por projeto
- **Planos de suporte**: Taxa de SLA + cobrança por ticket ou hora

### Implementação

<Steps>
<Step title="Create On-Demand Subscription">
Configure uma assinatura com cobrança sob demanda habilitada.
...
<Info>
Estes exemplos mostram estruturas de preços ideais. Devido à restrição de que usage meters e add-ons não podem ser associados ao mesmo produto, algumas combinações exigem soluções alternativas (usando cobranças sob demanda para o uso ou assentos gerenciados pela aplicação).
</Info>

### Exemplo 1: plataforma SaaS de IA

**Estrutura de preços:**
- **Assinatura base**: US$ 99/mês (acesso à plataforma, 5 assentos incluídos)
- **Add-on de assento**: US$ 20/assento/mês
- **Add-ons de recursos**: Modelos personalizados (\$49/mês), acesso à API (\$29/mês), fila prioritária (\$19/mês)
- **Excedente de uso**: US$ 0,02 por 1.000 tokens após 100 mil (cobrado sob demanda)

**Implementação**: Use uma assinatura com add-ons de assentos e recursos. Acompanhe o uso de tokens na sua aplicação e cobre os excedentes por meio de cobranças sob demanda ao final do ciclo de cobrança.

**Cliente de exemplo** (12 usuários, 500 mil tokens, Modelos personalizados + acesso à API):
| Componente | Cálculo | Valor |
|-----------|-------------|--------|
| Base | Taxa da plataforma | US$ 99 |
| Assentos extras | 7 × US$ 20 | US$ 140 |
| Modelos personalizados | Add-on | US$ 49 |
| Acesso à API | Add-on | US$ 29 |
...
|---|------|-----|------------|
| **Preço** | US$ 0/mês | US$ 29/mês | US$ 199/mês |
...
**Opção A** (focada em uso): Crie produtos com usage meters para builds/armazenamento. Gerencie os usuários na sua aplicação.

**Opção B** (focada em assentos): Crie produtos com add-ons de assentos. Acompanhe o uso de builds/armazenamento e cobre os excedentes sob demanda.

**Add-ons (se usar a Opção B):**
- Usuários extras: US$ 10/usuário/mês
- Builds prioritários: US$ 19/mês
- Domínios personalizados: US$ 9/domínio/mês

### Exemplo 3: automação de marketing

**Estrutura de preços:**
- **Base**: US$ 79/mês (recursos essenciais de automação, 3 assentos incluídos)
- **Níveis de contatos** (add-ons): 1 mil incluídos, 5 mil (+\$30), 25 mil (+\$80), 100 mil (+\$200)
- **Add-ons de recursos**: Marketing por SMS (\$29/mês), Landing Pages (\$19/mês), Testes A/B (\$29/mês)
- **Assentos da equipe**: add-on de US$ 15/usuário/mês
- **Volume de e-mails**: Acompanhe na aplicação e cobre o excedente sob demanda (US$ 1/1.000 e-mails acima do limite)

**Implementação**: Use uma assinatura com add-ons de níveis de contatos, recursos e assentos. Acompanhe os envios de e-mail na sua aplicação e cobre os excedentes por meio de cobranças sob demanda.
...
<Tip>
Torne os preços híbridos fáceis de entender. Mostre claramente na página de preços os custos base, o que está incluído e como funcionam os excedentes.
</Tip>
...
| Item | Valor |
|-----------|--------|
| Plano Pro (mensal) | US$ 49,00 |
| Assentos adicionais (7 × US$ 15,00) | US$ 105,00 |
| Uso da API - incluído (10.000 chamadas) | US$ 0,00 |
| Uso da API - excedente (15.420 chamadas × US$ 0,005) | US$ 77,10 |
| Add-on de analytics avançado | US$ 19,00 |
| **Subtotal** | **US$ 250,10** |
| Imposto (8,5%) | US$ 21,26 |
| **Total devido** | **US$ 271,36** |
...
**Sintomas**: O uso aparece como 0 ou com valores incorretos.
...
3. Verifique se `event_name` corresponde à configuração do meter
4. Verifique se os eventos têm timestamps corretos (não datados no futuro)
</Accordion>

<Accordion title="Proration confusion with multiple components">
**Sintomas**: O cliente é cobrado com valores inesperados ao mudar de plano.

**Soluções**:
1. Use a API `previewChangePlan` para mostrar as cobranças exatas antes da confirmação
2. Comunique que o rateio proporcional se aplica à assinatura E aos add-ons
3. Considere usar `difference_immediately` para uma cobrança de upgrade mais simples
</Accordion>
...
3. Confirme se o usage meter está associado corretamente ao produto de assinatura
</Accordion>
...
**Soluções**:
1. Verifique se os add-ons estão associados ao produto de assinatura no dashboard
2. Confira se os IDs dos add-ons estão corretos nas chamadas da API
3. Certifique-se de que a moeda do add-on corresponde à moeda do produto de assinatura
</Accordion>
</AccordionGroup>
...
<Card title="Usage-Based Billing Guide" icon="chart-line" href="/developer-resources/usage-based-billing-guide">
  Implementação completa da cobrança baseada em uso.
</Card>
...
<Card title="Add-ons" icon="puzzle" href="/features/addons">
  Ampliação de assinaturas com add-ons.
</Card>
</CardGroup>
