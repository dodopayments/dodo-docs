...
Uma assinatura do Team Pro custa \$99/mês e inclui 5 licenças. Se você tiver mais de 5 usuários, pagará \$15/mês adicionais por cada licença extra.

Por exemplo, se sua equipe precisar de 15 licenças:
- Plano básico: \$99/mês (inclui 5 licenças)
- Adicionais: 10 licenças extras × \$15/mês = \$150/mês
- Custo mensal total: \$99 + \$150 = \$249 para 15 licenças
...
<Card title="Plan Changes & Proration" icon="arrows-rotate" href="/developer-resources/subscription-upgrade-downgrade">
  Gerencie modificações em assinaturas.
</Card>
