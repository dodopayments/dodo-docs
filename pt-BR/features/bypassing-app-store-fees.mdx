...
**O que é:** Incorpore uma interface de pagamento — como um SDK nativo de terceiros — diretamente no seu app para oferecer um checkout fluido sem exigir que os usuários saiam do app.
...
Comece sua integração com Dodo Payments
</Card>
