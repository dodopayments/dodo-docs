...
- **Nomeie claramente**: Use códigos reconhecíveis que correspondam aos nomes das campanhas
- **Estabeleça prazos**: Adicione expiracões para criar urgência e prevenir uso indevido
- **Defina escopo sabiamente**: Limite a produtos específicos para evitar perda de margem
