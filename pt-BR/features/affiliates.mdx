...
<Steps>
  ...
  <Step title="Adicionar o Script de Rastreamento">
    ...
    - Habilita o rastreamento de inscrição e pagamento
  ...
  <Step title="Testando Sua Integração">
    ...
    **Lista de Verificação de Testes:**
    ...
    - ✅ Garanta que o script Affonso carrega e o cookie `affonso_referral` é definido
    - ✅ Complete uma inscrição (opcional)
    - ✅ Complete um pagamento via Dodo Payments
    - ✅ Confirme o rastreamento e atribuição no seu painel do Affonso
  </Step>
</Steps>
...
1. **Habilite o rastreamento de conversões** no seu painel Dub para links de afiliados
2. **Capture o ID de clique Dub** (`dub_id` cookie) ao criar sessões de checkout
3. **Armazene o ID de clique** nos metadados de pagamento junto com as informações do cliente
4. **Configure a integração de webhook** para enviar dados de venda para Dub quando os pagamentos forem bem-sucedidos
