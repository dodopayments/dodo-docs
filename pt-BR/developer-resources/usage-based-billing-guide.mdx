...
<Frame>
<img src="/images/guides/usage-based-billing/meter-quantities-chart.png" alt="Gráfico de quantidades do medidor mostrando tendências de uso ao longo do tempo com visualização de gradiente roxo" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
Configuração de Filtro (usando lógica AND):
