...
<Info>
Este boilerplate usa o Next.js 16 App Router com TypeScript, Tailwind CSS 4 e o `@dodopayments/nextjs` adapter.
</Info>
...
<Accordion title="Redirecionamento do checkout falha">
**Causas comuns:**
...
Substitua o `CUSTOMER_ID` codificado em `src/app/components/Header.tsx` por um ID de cliente real do seu painel Dodo.
