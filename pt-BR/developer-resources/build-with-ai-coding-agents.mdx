...
- **Crie sessões de checkout e links de pagamento** — [Pagamentos únicos](/features/one-time-payment-products) e [assinaturas](/features/subscription)
- **Implemente cobrança por assinatura e por uso de ponta a ponta** — [Assinaturas](/features/subscription), [Cobrança baseada em uso](/features/usage-based-billing/introduction), [Cobrança baseada em crédito](/features/credit-based-billing)
- **Gere handlers compatíveis com Webhooks Padrão** com verificação de assinatura — [Webhooks](/developer-resources/webhooks)
- **Configure componentes React do BillingSDK** para tabelas de preços e gerenciamento de assinaturas — [BillingSDK](/developer-resources/billingsdk)
- **Crie fluxos de chave de licença** para produtos digitais — [Chaves de licença](/features/license-keys)
- **Implemente cobrança baseada em crédito** com direitos, saldos, rollover e excesso — [Créditos](/features/credit-based-billing)
