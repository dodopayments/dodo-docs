...
<Card title="Manipulador de Checkout" icon="cart-shopping" href="#checkout-route-handler">
    Integre o checkout dos pagamentos Dodo em seu aplicativo SvelteKit.
</Card>
...
<Info>
Todos os exemplos assumem que você está usando o SvelteKit App Router.
</Info>

<Tabs>
<Tab title="Manipulador de Checkout">
  <Info>
  Use este manipulador para integrar o checkout dos pagamentos Dodo em seu aplicativo SvelteKit. Suporta fluxos de pagamento estáticos (GET), dinâmicos (POST) e de sessão (POST).
  </Info>
  <CodeGroup>
...
<Tab title="Manipulador do Portal do Cliente">
  <Info>
  Use este manipulador para permitir que os clientes gerenciem suas assinaturas e detalhes através do portal do cliente do Dodo Payments.
  </Info>
  <CodeGroup>
...
<Tab title="Manipulador de Webhook">
  <Info>
  Use este manipulador para receber e processar eventos de webhook dos pagamentos Dodo de forma segura em seu aplicativo SvelteKit.
  </Info>
  <CodeGroup>
...
<Info>
Dodo Payments suporta três tipos de fluxos de pagamento para integrar pagamentos em seu site, este adaptador suporta todos os tipos de fluxos de pagamento.
</Info>
