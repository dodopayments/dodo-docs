---
title: Adaptador SvelteKit
description: Aprenda como integrar os pagamentos Dodo com seu projeto SvelteKit
  App Router usando nosso Adaptador SvelteKit. Cobre checkout, portal do
  cliente, webhooks e configuração de ambiente seguro.
icon: code-merge
---
<CardGroup cols={2}>
{/* LOCKED_PATTERN_848a353666469e7a047ef05af5a45770 */}
    Integrar o checkout do Dodo Payments no seu app SvelteKit.
</Card>
{/* LOCKED_PATTERN_df89dec21e12f4bf30b6acf75ba025e1 */}
    Permitir que clientes gerenciem assinaturas e detalhes.
</Card>
<Card title="Webhooks" icon="bell" href="#webhook-route-handler">
    Receber e processar eventos webhook do Dodo Payments.
</Card>
</CardGroup>
...
<Info>
Todos os exemplos presumem que você está usando o SvelteKit App Router.
</Info>

<Tabs>
{/* LOCKED_PATTERN_28fd81a4703a84d931eeff69f1520d54 */}
  <Info>
  Use esse manipulador para integrar o checkout do Dodo Payments ao seu app SvelteKit. Suporta fluxos de pagamento estático (GET), dinâmico (POST) e de sessão (POST).
  </Info>
  <CodeGroup>
...
{/* LOCKED_PATTERN_085b207030169d6eead800f9835ef4fb */}
  <Info>
  Use esse manipulador para permitir que os clientes gerenciem suas assinaturas e dados por meio do portal do cliente Dodo Payments.
  </Info>
  <CodeGroup>
...
{/* LOCKED_PATTERN_0026b036379d81a9d03c36b3b6e83ddd */}
  <Info>
  Use esse manipulador para receber e processar eventos webhook do Dodo Payments com segurança no seu app SvelteKit.
  </Info>
  <CodeGroup>
...
Desabilitar o campo de último nome.
</ParamField>
...
Qualquer parâmetro de consulta que começar com <code>metadata_</code> será enviado como metadados.
</ParamField>
...
As sessões de checkout oferecem uma experiência de checkout hospedada mais segura que lida com o fluxo completo de pagamento tanto para compras únicas quanto para assinaturas, com controle total de personalização.
...
O Manipulador de Rota do Portal do Cliente permite que você integre perfeitamente o portal do cliente dos pagamentos Dodo em sua aplicação SvelteKit.
