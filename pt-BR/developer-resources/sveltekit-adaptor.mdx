...
Define o valor cobrado, em unidades monetárias principais (por exemplo, <code>12.5</code> para US$ 12,50). Somente para produtos Pay What You Want e ignorado se estiver abaixo do preço mínimo do produto.
</ParamField>
...
As sessões de checkout oferecem uma experiência de checkout hospedada e mais segura, que gerencia todo o fluxo de pagamento para compras únicas e assinaturas, com controle total de personalização.

Consulte o [Guia de integração do Checkout Sessions](https://docs.dodopayments.com/developer-resources/checkout-session) para obter mais detalhes e a lista completa de campos compatíveis.
...
## Manipulador de rotas do Customer Portal

O manipulador de rotas do Customer Portal permite integrar perfeitamente o portal do cliente do Dodo Payments ao seu aplicativo SvelteKit.
...
## Manipulador de rotas de webhook
