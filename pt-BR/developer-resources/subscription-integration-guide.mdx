...
{/* LOCKED_PATTERN_c21ea96b1e20037b291044a1d897b04e */}
  Referência de API para criar produtos de assinatura e gerenciar o ciclo de vida da assinatura
</Card>
{/* LOCKED_PATTERN_08ed481caa915d7a238364a556427420 */}
  Referência de API para atualizar, rebaixar ou alterar planos de assinatura com opções de rateio
</Card>
{/* LOCKED_PATTERN_2047d0ff0f7dc8f82d1032143e196fd0 */}
  Referência de API para atualizar métodos de pagamento e reativar assinaturas em espera
</Card>
{/* LOCKED_PATTERN_e887d5c7e993031251906dd3e3d548dc */}
  Referência de API para atualizar detalhes e configurações de assinatura
</Card>
