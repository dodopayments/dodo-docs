...
{/* LOCKED_PATTERN_4700cb45e192de62824dd8e282daade1 */}
  Use npx para executar o CLI sem instalação:
...
{/* LOCKED_PATTERN_b6f9141b8ec9a64c2fd2a3672cc7ca68 */}
  ...
  - Seu provedor de pagamentos (Dodo Payments)
</Step>
...
1. Faz o download da configuração do componente do registro
...
<Warning>
Sempre armazene suas chaves de API com segurança usando variáveis de ambiente. Nunca as envie ao controle de versão.
</Warning>
...
<Info>
O Billing SDK é lançado sob a Licença Pública Geral GNU (GPL), garantindo que o projeto permaneça aberto e gratuito.
</Info>
...
<CardGroup cols={3}>
  {/* LOCKED_PATTERN_eb7cbd65b140cb42412d66b449581b08 */}
    Guia completo do Billing SDK com exemplos e melhores práticas
  </Card>
  {/* LOCKED_PATTERN_ffd8f0692a343d28b70c5cc4c7e92e14 */}
    Documentação detalhada do CLI para todos os comandos e opções
  </Card>
  {/* LOCKED_PATTERN_7b1ddd651e55ecb92c4e41d12be0cd5d */}
    Explore todos os componentes disponíveis com exemplos ao vivo
  </Card>
</CardGroup>
