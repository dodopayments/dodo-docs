...
description: Implante webhooks do DodoPayments no Cloudflare Workers
icon: cloud
---

<Card title="Repositório do GitHub" icon="github" href="https://github.com/dodopayments/cloud-functions/tree/main/cloudflare">
...
1. Vá para o [DodoPayments Dashboard](https://app.dodopayments.com) → Desenvolvedor → Webhooks
...
| Worker não implantando | Execute `npm install`, verifique a sintaxe de `wrangler.toml` |
