...
O estado da assinatura que acionou a cobrança de inadimplência. Um de:
- `on_hold` — Renovações interrompidas devido a falha no pagamento
- `cancelled` — Cliente cancelado pelo portal do cliente
</ParamField>
