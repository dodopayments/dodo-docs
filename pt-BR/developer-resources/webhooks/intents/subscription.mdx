...
| `subscription.updated` | O objeto de assinatura foi atualizado (qualquer alteração em um campo aciona este evento) |
...
| `subscription.unpaused` | A assinatura foi retomada após ser pausada |
...
| `subscription.expired` | A assinatura chegou ao fim do prazo |
