...
description: Integre Dodo Payments ao
  seu projeto Nuxt usando o módulo oficial do Nuxt. Abrange checkout, portal do
  cliente, webhooks e configuração segura do ambiente.
icon: code-merge
keywords:
  - "Dodo Payments"
  - Nuxt
...
As sessões de checkout oferecem uma experiência de checkout hospedada e mais segura, que gerencia todo o fluxo de pagamento para compras únicas e assinaturas, com controle completo de personalização.

Consulte o [Guia de integração das sessões de checkout](https://docs.dodopayments.com/developer-resources/checkout-session) para obter mais detalhes e uma lista completa dos campos compatíveis.
...
O manipulador de rota Customer Portal permite integrar perfeitamente o portal do cliente do Dodo Payments ao seu aplicativo Nuxt.
