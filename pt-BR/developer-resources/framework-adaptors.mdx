...
<Card title="Remix" icon="react" href="/developer-resources/remix-adaptor">
  Framework full-stack React com manipuladores de carregamento e ação
</Card>

<Card title="TanStack Start" icon="chart-line" href="/developer-resources/tanstack-adaptor">
  Framework full-stack React com segurança de tipo e funções de servidor
</Card>
...
Todos os adaptadores fornecem manipulação de webhook segura em tipo com callbacks de eventos granulares:
...
|-----------|----------|---------|
| **Next.js** | Aplicativos full-stack React com App Router | Node.js, Edge |
| **Nuxt** | Aplicações full-stack Vue.js | Node.js |
...
| **SvelteKit** | Aplicações full-stack Svelte | Node.js |
| **Remix** | Full-stack React com roteamento aninhado | Node.js |
| **TanStack Start** | Full-stack React seguro em tipo | Node.js |
