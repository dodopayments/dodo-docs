...
Fixa o valor cobrado, em unidades principais da moeda (por exemplo, <code>12.5</code> para US$ 12,50). Somente para produtos Pay What You Want; ignorado se estiver abaixo do preço mínimo do produto.
</ParamField>
