...
| `/webhook` | POST | Lidar com webhooks de pagamentos Dodo |
...
- Certifique-se de que `DODO_PAYMENTS_WEBHOOK_KEY` está configurado corretamente em seu `.env`
- Verifique se você está usando o corpo da solicitação bruta para a verificação da assinatura
