...
<Tab title="VS Code">
<Steps>
<Step title="Abrir Marketplace de Extensões">
1. Abra o VS Code.
...
2. Abra o Palette de Comandos (`Cmd+Shift+P` no macOS / `Ctrl+Shift+P` no Windows/Linux).
...
2. **Verifique a instalação**: Verifique se a extensão está instalada indo em Extensões e procurando por "Sentra"
3. **Recarregue a janela**: Use o Palette de Comandos (`Cmd+Shift+P` / `Ctrl+Shift+P`) e execute "Developer: Reload Window"
