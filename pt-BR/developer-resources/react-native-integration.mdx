...
Você pode personalizar o React Native Unified Checkout para combinar com o design do seu aplicativo, modificando cores, fontes e mais através do parâmetro de aparência ao chamar `initPaymentSession()`.

#### Personalização de Cores

Cada categoria de cor determina a cor de um ou mais componentes na UI. Por exemplo, `primary` define a cor do botão Pagar.
...
| `componentText` | Cor do texto de entrada (ex: número do cartão, código postal) |
| `placeholderText` | Cor do texto do espaço reservado para campos de entrada |
| `icon` | Cor para ícones (ex: botão fechar) |
