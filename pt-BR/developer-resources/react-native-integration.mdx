...
- Ative o registro de depuração no desenvolvimento
- Verifique as solicitações de rede para o seu backend
- Verifique se as chaves de API estão configuradas corretamente
- Teste em ambas as plataformas iOS e Android
- Revise nossas [FAQs Técnicas](/miscellaneous/faq) para problemas comuns
- Use [Modo de Teste vs Modo Ao Vivo](/miscellaneous/test-mode-vs-live-mode) adequadamente
</Accordion>
</AccordionGroup>
