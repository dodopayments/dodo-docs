...
**Moeda**: Selecione sua moeda preferida (ex: `USD`)
...
Crie um arquivo `.env` com sua chave da API Dodo Payments:
...
2. Atualize os IDs do produto e do add-on no seu código com os valores reais do seu painel Dodo Payments
...
2. Você deve ver a interface de demonstração de preços baseado em assentos
3. Experimente diferentes quantidades de assentos (0, 3, 10, etc.)
4. Clique em "Gerar Link de Checkout" para cada quantidade
5. Verifique se as URLs de checkout foram geradas corretamente
