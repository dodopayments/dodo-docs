...
Define o valor cobrado, em unidades principais da moeda (por exemplo, <code>12.5</code> para US$ 12,50). Apenas para produtos Pay What You Want e ignorado se estiver abaixo do preço mínimo do produto.
</ParamField>
