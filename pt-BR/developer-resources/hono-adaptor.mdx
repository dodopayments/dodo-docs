...
{/* LOCKED_PATTERN_848a353666469e7a047ef05af5a45770 */}
    Integre o checkout da Dodo Payments ao seu app Hono.
</Card>
...
<Warning>
Nunca faça commit do seu arquivo <code>.env</code> ou de segredos no controle de versão.
</Warning>
</Step>
</Steps>
...
<Info>
Todos os exemplos supõem que você está usando o Hono App Router.
</Info>

<Tabs>
{/* LOCKED_PATTERN_28fd81a4703a84d931eeff69f1520d54 */}
  <Info>
  Use este manipulador para integrar o checkout da Dodo Payments ao seu app Hono. Suporta fluxos estáticos (GET), dinâmicos (POST) e de sessão (POST).
  </Info>
  <CodeGroup>
...
{/* LOCKED_PATTERN_085b207030169d6eead800f9835ef4fb */}
  <Info>
  Use este manipulador para permitir que os clientes gerenciem suas assinaturas e informações por meio do portal do cliente Dodo Payments.
  </Info>
  <CodeGroup>
...
{/* LOCKED_PATTERN_0026b036379d81a9d03c36b3b6e83ddd */}
  <Info>
  Use este manipulador para receber e processar eventos de webhook da Dodo Payments de forma segura em seu app Hono.
  </Info>
  <CodeGroup>
...
<Info>
A Dodo Payments oferece suporte a três tipos de fluxos de pagamento para integrar pagamentos ao seu site; este adaptador suporta todos os tipos de fluxos.
</Info>
...
Desativar o campo de último nome.
</ParamField>
...
As sessões de checkout oferecem uma experiência de checkout hospedada mais segura que lida com todo o fluxo de pagamento para compras únicas e assinaturas, com controle completo de personalização.
</Info>
