...
Identificador único para este campo. Usado como a chave nos payloads de webhook e respostas da API.
...
- `dropdown` - Selecione entre opções predefinidas
...
Para informações detalhadas sobre configuração e teste de UPI, consulte a página <a href="/features/payment-methods/india">Métodos de Pagamento na Índia</a>.
...
Para informações detalhadas sobre configuração e teste de BNPL, consulte a página <a href="/features/payment-methods/bnpl">Buy Now Pay Later (BNPL)</a>.
...
## Movendo de Links Dinâmicos para Sessões de Checkout

### Principais Diferenças
Anteriormente, ao criar um link de pagamento com Links Dinâmicos, você precisava fornecer o endereço de cobrança completo do cliente.

Com Sessões de Checkout, isso não é mais necessário. Você pode simplesmente passar as informações que possui, e nós cuidamos do resto. Por exemplo:
