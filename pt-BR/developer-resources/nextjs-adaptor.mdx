...
description: Aprenda como integrar os pagamentos Dodo com seu projeto Next.js
  App Router usando nosso Adaptor NextJS. Cobre checkout, portal do cliente,
...
{/* LOCKED_PATTERN_085b207030169d6eead800f9835ef4fb */}
  <Info>
  Use este handler para permitir que clientes gerenciem suas assinaturas e detalhes por meio do portal do cliente da Dodo Payments.
  </Info>
  <CodeGroup>
...
{/* LOCKED_PATTERN_0026b036379d81a9d03c36b3b6e83ddd */}
  <Info>
  Use este handler para receber e processar eventos de webhook da Dodo Payments com segurança no seu app Next.js.
  </Info>
  <CodeGroup>
...
Desative o campo de último nome.
</ParamField>
...
Desative o campo da linha de endereço.
</ParamField>
...
Qualquer parâmetro de consulta começando com <code>metadata_</code> será passado como metadata.
</ParamField>
...
O Manipulador de Rota do Portal do Cliente permite que você integre perfeitamente o portal do cliente dos pagamentos Dodo em sua aplicação Next.js.
