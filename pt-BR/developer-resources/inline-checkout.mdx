...
<Info>
A verificação de domínio é necessária apenas para **checkout embutido (inline)**. O checkout em overlay, checkout hospedado e links de pagamento não precisam disso.
</Info>

O Apple Pay é verificado por domínio a partir do dashboard.

<Steps>
<Step title="Open Wallet domains">
Vá para **Configurações → Métodos de Pagamento** e, na linha de **Apple Pay**, clique em **Gerenciar domínios**.

<Frame caption="Open Wallet domains from the Apple Pay row">
  <img src="/images/apple-pay-domains/manage-domains.png" alt="Botão de Gerenciar Domínios na linha Apple Pay em Configurações de Métodos de Pagamento" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
Clique em **Registrar domínio** e insira o domínio onde você incorpora o checkout embutido (por exemplo, `shop.example.com`), em seguida, clique em **Continuar**.

<Frame caption="Register the domain where you embed inline checkout">
  <img src="/images/apple-pay-domains/register-domain.png" alt="Formulário de Registrar um domínio com um domínio inserido" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
Deve ser servido via HTTPS, acessível sem redirecionamentos e servido com `Content-Type: application/octet-stream` ou `text/plain`.
</Step>

<Step title="Verify the domain">
Clique em **Verificar domínio**. A Dodo Payments confirma que o arquivo está ativo e envia seu domínio para a Apple.

<Frame caption="Verify the hosted association file">
  <img src="/images/apple-pay-domains/verify-domain.png" alt="Tela de Verificar seu domínio com o caminho do host do arquivo de associação e botão Verificar domínio" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>

<Step title="Confirm it's active">
Quando o status mostrar **Ativo**, o Apple Pay está habilitado para esse domínio. Use o toggle **Habilitado** para ativá-lo ou desativá-lo por domínio.

<Frame caption="Verified domains show an Active status">
  <img src="/images/apple-pay-domains/domains-active.png" alt="Lista de domínios da Carteira mostrando domínios com status Ativo do Apple Pay e toggles Habilitados" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
## Checkout Embutido vs Checkout em Overlay
...
<Tip>
Use **checkout embutido** quando desejar o máximo controle sobre a experiência de checkout e branding integrado. Use **checkout em overlay** para integração mais rápida com mudanças mínimas nas suas páginas existentes.
</Tip>
...
<Card title="Overlay Checkout" icon="layer-group" href="/developer-resources/overlay-checkout">
    Use o checkout em overlay para integração rápida baseada em modal.
</Card>
