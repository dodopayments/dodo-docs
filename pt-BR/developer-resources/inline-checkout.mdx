...
Para informações detalhadas sobre como configurar Apple Pay, Google Pay e outras carteiras digitais, consulte a página de <a href="/features/payment-methods/digital-wallets">Carteiras Digitais</a>.
...
Uma vez confirmado, verifique se o Apple Pay aparece na finalização da compra e teste todo o fluxo.
</Step>
</Steps>

<Warning>
O Apple Pay requer verificação de domínio antes de aparecer em produção. Entre em contato com o suporte antes de entrar em operação se você planeja oferecer Apple Pay.
</Warning>
...
|---------|-----------------|------------------|
| Profundidade de integração | Totalmente incorporado na página | Modal no topo da página |
...
<Tip>
Use o **checkout inline** quando você quiser controle máximo sobre a experiência de checkout e branding contínuo. Use o **checkout overlay** para uma integração mais rápida com mudanças mínimas nas suas páginas existentes.
</Tip>
