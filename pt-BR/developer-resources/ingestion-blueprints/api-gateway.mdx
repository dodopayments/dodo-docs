...
- **Nome do Evento**: `api_call` (ou o nome de sua preferência)
...
<Tip>
**Use Batching para Alto Volume**: Para aplicações que lidam com mais de 10 requisições por segundo, use `createBatch()` para reduzir a sobrecarga e melhorar o desempenho.
</Tip>

<Warning>
**Sempre Limpe os Lotes**: Chame `batch.cleanup()` ao desligar a aplicação para limpar eventos pendentes e evitar perda de dados.
</Warning>
