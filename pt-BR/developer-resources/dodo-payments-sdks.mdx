...
- **Segurança de tipos**: Tipagem forte para garantir a segurança em tempo de compilação e oferecer melhor suporte à IDE
- **Tratamento de erros**: Tratamento abrangente de exceções com mensagens de erro detalhadas
- **Autenticação**: Autenticação simples por chave de API com suporte a variáveis de ambiente
- **Suporte assíncrono**: Padrões modernos de async/await quando aplicável
- **Paginação automática**: Paginação automática para respostas de listagem
- **Faturamento baseado no uso**: Suporte integrado para rastrear e ingerir eventos de uso
- **Testes**: Suporte completo ao Test Mode para desenvolvimento e testes
...
<Card title="CLI" icon="terminal" href="/developer-resources/sdks/cli">
  Interface de linha de comando gerada automaticamente com suporte à API do Dodo Payments
</Card>
