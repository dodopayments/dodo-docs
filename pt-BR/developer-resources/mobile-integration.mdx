...
<Warning>
`@dodopayments/react-native-checkout` também oferece um plugin de configuração do Expo, mas
atualmente não grava nenhum esquema de URL nem nenhum placeholder de manifesto. Adicioná-lo sozinho
**não** registrará seu esquema de callback — use a configuração acima. Consulte a página do
