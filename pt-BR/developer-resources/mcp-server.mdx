...
O [Dodo Agent Plugin](/developer-resources/build-with-ai-coding-agents) instala os dois MCP servers e todas as dezessete skills em uma única etapa para Claude Code, Codex CLI, Cursor, VS Code / GitHub Copilot, Kiro e OpenCode. O Gemini CLI recebe apenas os dois MCP servers, pois não possui uma primitiva de agent-skill. Consulte o [guia de AI Coding Agents](/developer-resources/build-with-ai-coding-agents) para ver os comandos de instalação de cada agente.
