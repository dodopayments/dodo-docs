...
<Tabs>
<Tab title="Cursor">
Configure o servidor MCP do Dodo Payments no Cursor para habilitar o acesso conversacional aos seus dados de pagamento.
...
Após clicar, defina suas variáveis de ambiente nas `mcp.json` do Cursor via **Configurações do Cursor** > **Ferramentas & MCP** > **Novo Servidor MCP**.
...
Configure o servidor MCP do Dodo Payments no Claude Desktop para habilitar o acesso conversacional aos seus dados de pagamento.
<Steps>
...
Configure o servidor MCP do Dodo Payments no Claude Code CLI.
...
<Tip>
Claude Code automaticamente captura variáveis de ambiente do seu shell, então você também pode exportá-las antes de executar o comando.
</Tip>
</Tab>

<Tab title="VS Code">
Configure o servidor MCP do Dodo Payments no VS Code.
...
Após clicar, defina suas variáveis de ambiente nas `mcp.json` do VS Code via **Paleta de Comandos** > **MCP: Abrir Configuração do Usuário**.

**Configuração Manual**

<Steps>
<Step title="Abra a configuração do MCP">
...
<Step title="Adicione a configuração do servidor">
    Adicione o servidor MCP do Dodo Payments:
...
<Step title="Recarregue a janela">
...
Configure o servidor MCP do Dodo Payments no Cline (VS Code) para habilitar o acesso conversacional aos seus dados de pagamento.
<Steps>
...
<Step title="Configure o servidor MCP">
    Adicione a configuração do servidor MCP do Dodo Payments:
...
<Tab title="Zed">
Configure o servidor MCP do Dodo Payments no Zed para habilitar o acesso conversacional aos seus dados de pagamento.
<Steps>
<Step title="Abra as configurações do Zed">
    Navegue até **Configurações** > **Assistente** > **Modelo Contextual de Protocolo**.
</Step>
...
Configure o servidor MCP do Dodo Payments em outros clientes compatíveis com MCP.
...
Ao implantar remotamente, sempre exija autenticação através do cabeçalho `Authorization` ou do cabeçalho `x-dodo-payments-api-key`.
...
Verifique se `DODO_PAYMENTS_ENVIRONMENT` está configurada corretamente (`live_mode` para produção).
...
<Card title="Protocolo MCP" icon="link" href="https://modelcontextprotocol.io">
  Saiba mais sobre o padrão do Protocolo de Contexto do Modelo
</Card>
