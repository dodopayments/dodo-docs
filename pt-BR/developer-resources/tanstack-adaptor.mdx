...
As sessões de checkout oferecem uma experiência de checkout hospedada mais segura, que gerencia o fluxo completo de pagamento para compras únicas e assinaturas, com controle total de personalização.

Consulte o [Guia de integração de Checkout Sessions](https://docs.dodopayments.com/developer-resources/checkout-session) para obter mais detalhes e a lista completa de campos compatíveis.
...
O Customer Portal Route Handler permite integrar perfeitamente o portal do cliente do Dodo Payments ao seu aplicativo Tanstack.
