...
{/* LOCKED_PATTERN_848a353666469e7a047ef05af5a45770 */}
    Integre o checkout da Dodo Payments ao seu app Tanstack.
</Card>
...
<Info>
Todos os exemplos consideram que você está usando o Tanstack App Router.
</Info>

<Tabs>
{/* LOCKED_PATTERN_28fd81a4703a84d931eeff69f1520d54 */}
  <Info>
  Use este manipulador para integrar o checkout da Dodo Payments ao seu app Tanstack. Suporta fluxos de pagamento estáticos (GET), dinâmicos (POST) e de sessão (POST).
  </Info>
  <CodeGroup>
...
{/* LOCKED_PATTERN_085b207030169d6eead800f9835ef4fb */}
  <Info>
  Use este manipulador para permitir que os clientes administrem suas assinaturas e detalhes por meio do portal do cliente da Dodo Payments.
  </Info>
  <CodeGroup>
...
{/* LOCKED_PATTERN_0026b036379d81a9d03c36b3b6e83ddd */}
  <Info>
  Use este manipulador para receber e processar eventos de webhook da Dodo Payments com segurança no seu app Tanstack.
  </Info>
  <CodeGroup>
...
<Info>
A Dodo Payments suporta três tipos de fluxos de pagamento para integrar pagamentos ao seu site; este adaptador suporta todos os tipos.
</Info>
...
Desabilita o campo de último nome.
</ParamField>
...
Desabilita o campo de linha de endereço.
</ParamField>
...
- Suporta pagamentos pontuais e recorrentes.
...
As sessões de checkout proporcionam uma experiência de checkout hospedada mais segura que lida com o fluxo completo de pagamento para compras pontuais e assinaturas, com controle total de personalização.
