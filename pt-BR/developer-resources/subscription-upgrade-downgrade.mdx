...
- `subscription.on_hold`: Falha na cobrança da alteração de plano, renovações interrompidas
- `payment.succeeded`: Cobrança imediata pela alteração de plano realizada com sucesso
- `payment.failed`: Falha na cobrança imediata
...
### Tipos de evento a serem tratados
- `subscription.active`: assinatura ativada
- `subscription.plan_changed`: plano da assinatura alterado (alterações de upgrade/downgrade/addon)
- `subscription.on_hold`: cobrança falhou, renovações interrompidas
- `subscription.renewed`: renovação realizada com sucesso
- `payment.succeeded`: pagamento pela alteração de plano ou renovação realizado com sucesso
