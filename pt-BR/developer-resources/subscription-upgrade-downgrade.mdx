...
<Info>
Créditos gerados por rebaixamentos usando <code>difference_immediately</code> são específicos da assinatura e distintos dos direitos de <a href="/features/credit-based-billing">Faturamento com Créditos</a>. Eles se aplicam automaticamente a renovações futuras da mesma assinatura e não são transferíveis entre assinaturas.
</Info>
...
- Revise a <a href="/api-reference/subscriptions/change-plan">API de Alteração de Plano</a>
- Explore o <a href="/features/credit-based-billing">Faturamento com Créditos</a>
- Implemente alertas para `subscription.on_hold`
- Confira nosso <a href="/developer-resources/webhooks">Guia de Integração com Webhooks</a>
