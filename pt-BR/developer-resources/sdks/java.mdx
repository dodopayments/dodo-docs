...
<Info>
`productPrice` é expresso na menor denominação da moeda (por exemplo, centavos para USD, paise para INR). Para cobrar $25.00, passe `2500`.
</Info>

<Tip>
Cobrar via `subscriptions().charge(...)` é destinado para [assinaturas sob demanda](/developer-resources/ondemand-subscriptions). Assinaturas programadas padrão são cobradas automaticamente com base no cronograma de preços do produto.
</Tip>
...
Ingerir vários eventos de forma eficiente (máximo de 1000 por solicitação):
...
<Tip>
O SDK tenta automaticamente novas solicitações em casos de erros de conexão, 408, 409, 429 e erros 5xx com um backoff exponencial.
</Tip>
...
<Card title="Discord Community" icon="discord" href="https://discord.gg/bYqAp4ayYh">
  Obtenha ajuda e conecte-se com os desenvolvedores
</Card>
...
- **Discord**: Junte-se ao nosso [servidor comunitário](https://discord.gg/bYqAp4ayYh) para suporte em tempo real
...
Acolhemos contribuições! Confira as [diretrizes de contribuição](https://github.com/dodopayments/dodopayments-java/blob/main/CONTRIBUTING.md) para começar.
