...
Os métodos da lista na API DodoPayments são paginados. Você pode usar a sintaxe `for await … of` para iterar por itens em todas as páginas:
...
- Cloudflare Workers
- Vercel Edge Runtime
- Jest 28 ou maior com o ambiente `"node"`
