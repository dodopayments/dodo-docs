...
<Info>
O SDK requer Go 1.22 ou versões posteriores, aproveitando recursos modernos do Go para desempenho ideal.
</Info>
...
<CardGroup cols={2}>
<Card title="Suporte a Contexto" icon="clock">
  Suporte total para context.Context para cancelamento e timeouts
</Card>
...
<Card title="Middleware" icon="layer-group">
  Suporte extensível a middleware para logging, métricas e lógica personalizada
</Card>

<Card title="Seguro para Goroutines" icon="bolt">
  Cliente thread-safe projetado para operações concorrentes
</Card>
</CardGroup>
...
<CardGroup cols={2}>
<Card title="Repositório do GitHub" icon="github" href="https://github.com/dodopayments/dodopayments-go">
...
<Card title="Relatar Problemas" icon="bug" href="https://github.com/dodopayments/dodopayments-go/issues">
