...
<Info>
O SDK C# está atualmente em beta. Estamos trabalhando ativamente em melhorias e agradecemos seu feedback.
</Info>
...
<Info>
O SDK requer .NET Standard 2.0 ou posterior. Ele funciona com ASP.NET Core, aplicações Console e outros tipos de projetos .NET.
</Info>
...
<Warning>
Sempre armazene suas chaves de API de forma segura usando variáveis de ambiente, segredos de usuário ou Azure Key Vault. Nunca as codifique diretamente em seu código-fonte ou as comite no controle de versão.
</Warning>
...
<Card title="Tipagem Forte" icon="shield-check">
  Segurança de tipo abrangente com tipos de referência anuláveis
</Card>

<Card title="Injeção de Dependência" icon="layer-group">
...
| Propriedade   | Variável de ambiente        | Obrigatória | Valor padrão                     |
| ------------- | --------------------------- | ----------- | --------------------------------- |
...
<CardGroup cols={2}>
<Card title="Repositório do GitHub" icon="github" href="https://github.com/dodopayments/dodopayments-csharp">
...
<Card title="Relatar Problemas" icon="bug" href="https://github.com/dodopayments/dodopayments-csharp/issues">
