...
| Variável | Descrição |
|----------|-------------|
| `DODO_WH_TEST_SERVER_URL` | Substituir a URL padrão do servidor de relé de webhook usada por `dodo wh listen` |
...
- **Email**: Entre em contato conosco através do email support@dodopayments.com
