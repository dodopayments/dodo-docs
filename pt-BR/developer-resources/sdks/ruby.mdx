...
<CardGroup cols={2}>
<Card title="Convenções Ruby" icon="gem">
  Segue as convenções de nomenclatura e padrões idiomáticos do Ruby
</Card>

<Card title="Sintaxe Elegante" icon="code">
...
<CardGroup cols={2}>
<Card title="Repositório do GitHub" icon="github" href="https://github.com/dodopayments/dodopayments-ruby">
...
<Card title="Relatar Problemas" icon="bug" href="https://github.com/dodopayments/dodopayments-ruby/issues">
