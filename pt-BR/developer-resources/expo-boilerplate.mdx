...
<Warning>
As variáveis `EXPO_PUBLIC_*` são incorporadas ao bundle JavaScript distribuído e podem ser lidas por qualquer pessoa que baixe seu app. As chaves da API do Dodo Payments são secrets bearer, portanto use isso somente com uma chave do Test Mode durante o desenvolvimento. Em produção, crie sessões de checkout no seu backend e passe apenas o `checkout_url` resultante para o app — consulte [Mobile Integration](/developer-resources/mobile-integration).
</Warning>
</Step>
...
Escaneie o código QR com o app Expo Go no seu dispositivo ou pressione `i` para o simulador do iOS ou `a` para o emulador do Android.

<Check>
Você já pode começar a criar! O boilerplate inclui telas e componentes de exemplo para ajudar você a entender a integração.
</Check>
</Step>
</Steps>
...
O boilerplate vem com os elementos essenciais pré-configurados:
...
Fluxo de pagamento completo com tratamento de sucesso e erro
</Card>
...
Configuração de navegação com o Expo Router para um roteamento integrado
</Card>
</CardGroup>
...
Adapte o código de exemplo para atender às necessidades e ao design do seu app.
</Step>
...
<Step title="Go Live">
Quando estiver tudo pronto, alterne para as chaves da API do Live Mode e compile seu app para produção.
</Step>
</Steps>
...
- Participe da nossa [comunidade no Discord](https://discord.gg/bYqAp4ayYh) para fazer perguntas e participar de discussões
