...
<Expandable title="Data object properties">
  ...
  Tipo de recurso. Um dos seguintes: `Payment`, `Subscription`, `Refund`, `Dispute`, `LicenseKey`, `CreditLedgerEntry`, `CreditBalanceLow`, `AbandonedCheckout`, `DunningAttempt`, ou `EntitlementGrant`.
  </ResponseField>
  
  Campos adicionais variam por tipo de evento. Consulte a documentação específica do evento para esquemas completos.
</Expandable>
</ResponseField>
...
Esta ferramenta interativa permite que você selecione entre todos os tipos de eventos suportados e envie cargas simuladas realistas para o seu endpoint. Ela faz loop para que você possa testar múltiplos eventos em uma única sessão.
...
<Frame>
    <img src="/images/webhooks/activity.png" alt="Atividade" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/images/webhooks/alerting.png" alt="Configurações de Alerta do Webhook mostrando configuração de notificações por email" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
