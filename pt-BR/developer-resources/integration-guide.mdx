...
2. Crie um produto (pagamento único ou assinatura). Produtos de assinatura devem ter um preço de pelo menos **$1** (ou o equivalente na moeda escolhida); valores abaixo desse mínimo não são suportados.
...
<Card title="Create Checkout Session" icon="code" href="/api-reference/checkout-sessions/create">
  Referência da API para criar sessões de checkout seguras e hospedadas para pagamentos únicos e assinaturas
</Card>
