...
<Steps>
  ...
  <Step title="Create Usage Meters">
    ...
    * **Tokens de saída:** 1.000.000 tokens / \$10.00 = 100.000 tokens por \$1.
    ...
    No painel da Dodo, você definiria "Meter units per credit" como 4.000 para a entrada e 1.000 para a saída. Os créditos são denominados em centavos, portanto um crédito compra 1/100 dos valores por dólar acima.
  </Step>
