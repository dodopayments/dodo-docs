...
1. Volte para o seu painel de controle do Dodo Payments
2. Navegue até **Vendas → Clientes** na barra lateral
3. Encontre o cliente que você acabou de criar (com o e-mail de teste)
4. Copie o ID do cliente - ele parecerá com `cus_abc123def456`
