...
**Nome do Medidor**: Copie e cole exatamente → `Image Generation Meter`
...
<Warning>
O nome do evento `image.generated` deve corresponder exatamente ao que enviaremos do nosso código de aplicação mais tarde. Os nomes dos eventos são sensíveis a maiúsculas!
</Warning>
</Step>
...
1. **Ativar Filtragem de Eventos**: Alterne isso **ON**
...
**Preço por Unidade**: Insira → `0.05` (isso é $0,05 por imagem)

**Limite Gratuito**: Insira → `10` (clientes recebem 10 imagens gratuitas por mês)
