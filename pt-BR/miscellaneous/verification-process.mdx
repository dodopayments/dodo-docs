...
<Frame>
  <img src="/images/tax-forms/W8 - BEN - PLC - SAMPLE - 1.png" alt="Página de Exemplo 1 do W-8 BEN-E Private Limited" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>

**Page 2**

<Frame>
  <img src="/images/tax-forms/W8 - BEN - PLC - SAMPLE - 2.png" alt="Página de Exemplo 2 do W-8 BEN-E Private Limited" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>

**Page 8**

<Frame>
  <img src="/images/tax-forms/W8 - BEN - PLC - SAMPLE - 8.png" alt="Página de Exemplo 8 do W-8 BEN-E Private Limited" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Accordion>
...
<Frame>
  <img src="/images/tax-forms/W8 - BEN - LLP SAMPLE - 1.png" alt="Página de Exemplo 1 do W-8 BEN-E LLP" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>

**Page 2**

<Frame>
  <img src="/images/tax-forms/W8 - BEN - LLP SAMPLE - 2.png" alt="Página de Exemplo 2 do W-8 BEN-E LLP" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>

**Page 8**

<Frame>
  <img src="/images/tax-forms/W8 - BEN - PLC - SAMPLE - 8.png" alt="Página de Exemplo 8 do W-8 BEN-E LLP" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Accordion>
</AccordionGroup>
...
Se houver problemas com os documentos enviados durante o processo de integração, a Equipe de Verificação do Dodo Payments pode solicitar que você reenviar documentos específicos.

Você pode reenviar documentos usando a opção **reenviar** no seu dashboard.

### Quando Você Pode Reenviar Documentos?

- **Informações Faltando ou Incompletas**: Se detalhes essenciais, como números de identificação, nome da empresa ou outros dados principais estiverem faltando.
...
- **Documentos Ilegíveis ou Vencidos**: Se os documentos enviados estiverem desfocados, ilegíveis ou expirados.
- **Necessária Clarificação Adicional**: Se a equipe de verificação precisar de documentação adicional para esclarecer sua identidade ou informações comerciais.

### Como Reenviar Documentos

<Steps>
<Step title="Check your dashboard">
Verifique o seu Dashboard do Dodo Payments para uma solicitação de reenvio (você também receberá uma notificação por e-mail se o reenvio for necessário).
</Step>

<Step title="Access the resubmit option">
A equipe de verificação ativará a opção **Reenviar**, permitindo que você carregue novos documentos.
</Step>

<Step title="Upload correct documents">
Navegue até a **Seção de Verificação** no dashboard e carregue os documentos corretos.
</Step>
...
<CardGroup cols={2}>
  <Card
    ...
    href="/miscellaneous/merchant-acceptance"
  >
    Revise nossos padrões abrangentes de aceitação, incluindo produtos suportados e proibidos, e assegure-se de que sua empresa é elegível para integração.
  </Card>
  <Card
    title="Review Monitoring Policy"
    icon="magnifying-glass"
    href="/miscellaneous/review-monitoring-policy"
  >
    Entenda como a conformidade contínua é monitorada, saiba sobre os gatilhos para revisão de documentos e mantenha-se proativo com o status da sua conta.
  </Card>
</CardGroup>
