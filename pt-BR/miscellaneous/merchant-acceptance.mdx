...
keywords:
  - Dodo Payments
  - política de aceitação de comerciantes
---
...
<Note>
Esta política se aplica a todas as designações de países feitas a partir de 23 de março de 2026. Comerciantes que recebem serviços em países suportados antes dessa data não serão afetados, a menos que o país relevante esteja sujeito a sanções ativas ou restrições regulatórias. Nesses casos, a Dodo Payments reserva-se o direito de descontinuar o suporte.
</Note>
...
23. Sint Maarten
24. Ilhas Turks e Caicos
25. Ilhas Virgens Americanas
26. Wallis e Futuna
...
<Note>
Essa lista é regularmente atualizada para refletir as diretrizes FATF, OFAC, ONU e UE AML/CFT. Todos os comerciantes são responsáveis por garantir a conformidade contínua.

Os pagamentos são suportados apenas nos países e regiões listados acima. Se seu país não estiver incluído, os pagamentos não estão atualmente disponíveis a partir dessa localização.
...
As contas de comerciantes são suportadas apenas onde a documentação KYC é emitida nos países listados acima.
</Note>

## Execução

Levamos a sério as violações de nossa política de comerciantes. Se determinarmos que um comerciante foi integrado em violação desta política ou de nossos termos — incluindo adulterando seu negócio, tentando contornar restrições ou se envolvendo em atividades proibidas — a Dodo Payments pode tomar as medidas apropriadas.

### As Ações de Execução Podem Incluir:
...
- Multas ou penalidades proporcionais às perdas, danos reputacionais ou risco descendente (até USD 425.000)
...
Os seguintes casos podem desencadear uma investigação ou execução:

1. Classificar incorretamente seu negócio ou produtos para contornar restrições de categoria.
2. Usar comerciantes proxy, subcontas ou apropriações de contas para evitar execução.
3. Vender ou promover produtos que são enganosos, prejudiciais ou violam nossas regras de conteúdo proibido.
4. Não divulgar informações essenciais durante a integração (ex.: incompatibilidade de site, tipo de entidade incorreto).
...
8. Solicitações por autoridades legais mediante recebimento de ordem legal relevante.
9. Relatórios de atividades fraudulentas sinalizados por nossos parceiros regulatórios e de conformidade, e relatórios de clientes.
...
Se você acredita que a execução foi aplicada por engano, pode enviar um pedido de revisão. Observe que as revisões são consideradas apenas uma vez. A decisão da revisão de apelação será final.

Em alguns casos, podemos permitir ação corretiva ou reenvio para revisão. A divulgação voluntária de potenciais problemas pode ser considerada favoravelmente. Você pode entrar em contato com **compliance@dodopayments.com** para iniciar o processo de revisão.
