...
<Step title="Open the Webhook Section">
  ...
  <Frame>
    <img src="/images/integrations/datafast/add.png" alt="Adicionar Endpoint e menu suspenso de integrações" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
...
<Step title="Enter API Key">
  ...
  <Frame>
    <img src="/images/integrations/datafast/api-key.png" alt="Adicionar chave API" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
