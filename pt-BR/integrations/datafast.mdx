...
3. **Envie os dados de pagamento para o DataFast** quando os pagamentos forem bem-sucedidos usando a API de Pagamento deles
...
<Steps>
<Step title="Instale o Script do DataFast">
...
- Verifique se a chave API do DataFast está correta e ativa
- Confira se o `datafast_visitor_id` está sendo capturado e armazenado nos metadados de pagamento
- Assegure-se de que a transformação do webhook está formatando corretamente o payload
...
- Garanta que você está capturando o ID do visitante antes de criar a sessão de checkout
...
- Assegure-se de que o valor está corretamente convertido (divida por 100 para a maioria das moedas, exceto moedas de zero decimais)
