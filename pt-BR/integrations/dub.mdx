...
{/* LOCKED_PATTERN_c337a250e2e6db475d2eb18e95cb3e6a */}
  No seu painel do Dodo Payments, navegue até **Webhooks → + Adicionar Endpoint** e expanda o menu suspenso de integrações.
  <Frame>
    <img src="/images/integrations/dub/add.png" alt="Adicionar Endpoint e menu de integrações" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
...
{/* LOCKED_PATTERN_b0cbf67cc15e78743c0724f27d5e90ef */}
  Forneça sua Dub API Key no campo de configuração.
  <Frame>
    <img src="/images/integrations/dub/api-key.png" alt="Adicionar API Key" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
