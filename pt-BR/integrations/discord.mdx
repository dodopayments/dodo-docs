...
<Step title="Open the Webhook Section">
  No painel do Dodo Payments, abra <b>Webhooks → + Adicionar Endpoint</b> e expanda o menu suspenso para revelar integrações.
  <Frame>
    <img src="/images/integrations/discord.png" alt="Adicionar Endpoint e menu suspenso de integrações" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
