...
<Step title="Open the Webhook Section">
  No dashboard do Dodo Payments, navegue até <b>Webhooks → + Adicionar Endpoint</b> e expanda o menu suspenso de integrações.
  <Frame>
    <img src="/images/integrations/resend.png" alt="Adicionar Endpoint e menu suspenso de integrações" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
