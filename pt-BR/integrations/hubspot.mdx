...
<Step title="Open the Webhook Section">
  No painel do Dodo Payments, vá para <b>Webhooks → + Adicionar Endpoint</b> e expanda o menu suspenso de integrações.
  <Frame>
    <img src="/images/integrations/hubspot.png" alt="Adicionar Endpoint e menu suspenso de integrações" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
