...
<Steps>
<Step title="Abrir Seção de Webhook">
  Navegue até a seção de Webhooks no seu painel do Dodo Payments.
  
  <Frame>
    <img src="/images/integrations/autosend.png" alt="Adicionar Endpoint e dropdown de integrações" />
  </Frame>
</Step>

<Step title="Selecionar Integração do AutoSend">
...
<Step title="Inserir Chave de API">
  ...
  <Card title="Aprenda como criar e gerenciar chaves de API" icon="key" href="https://docs.autosend.com/api-keys">
...
<AccordionGroup>
<Accordion title="E-mails não sendo enviados">
- Verifique se a chave da API está correta e ativa
- Confira se o domínio do remetente está verificado no AutoSend
- Assegure-se de que os endereços de e-mail do destinatário são válidos
...
- Verifique se os parâmetros necessários estão presentes na carga útil
</Accordion>
...
- Assegure-se de que os endereços de e-mail estão formatados corretamente
- Verifique se o `templateId` é válido se estiver usando modelos
- Confira se as chaves `dynamicData` correspondem às suas variáveis de modelo
</Accordion>

<Accordion title="Problemas de modelo">
- Verifique se seu ID de modelo está correto e ativo no AutoSend
- Assegure-se de que as chaves `dynamicData` correspondam às variáveis usadas em seu modelo
- Confira se todas as variáveis de modelo obrigatórias estão fornecidas
