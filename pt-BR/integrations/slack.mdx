...
<Step title="Open the Webhook Section">
  ...
  <Frame>
    <img src="/images/integrations/slack/1.png" alt="Painel do Dodo Payments mostrando o botão Adicionar Endpoint e dropdown de integrações" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
...
<Step title="Select Slack Integration">
  ...
  <Frame>
    <img src="/images/integrations/slack/2.png" alt="Cartão de integração do Slack e botão de conectar" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
...
<Step title="Grant Slack Permissions">
  ...
  <Frame>
    <img src="/images/integrations/slack/3.png" alt="Tela de permissões OAuth do Slack para o aplicativo Incoming Webhooks" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
...
<Step title="Customize Transformation Code">
  ...
  <Frame>
    <img src="/images/integrations/slack/4.png" alt="Editor de código de transformação para integração do Slack" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
...
<Step title="Test and Create">
  ...
  <Frame>
    <img src="/images/integrations/slack/5.png" alt="Teste de transformação e botão de criar" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
...
- Use anexos de mensagem avançados com cores, campos e formatação para proporcionar clareza e facilitar ações.
- Sempre inclua dados importantes, como valores, e-mails dos clientes e IDs, para identificação rápida.
- Escolha cores que correspondam ao tipo de evento: verde (`good`) para sucesso, vermelho (`danger`) para contestações ou falhas, amarelo (`warning`) para cancelamentos e azul (`#3aa3e3`) para eventos informativos.
- Adicione timestamps para ajudar a acompanhar quando cada evento ocorreu.
