...
Crie seu próprio projeto de plugin Figma usando o [guia de início rápido do plugin do Figma](https://www.figma.com/plugin-docs/plugin-quickstart-guide/). Isso gerará uma estrutura com um arquivo `manifest.json`.
...
<Step title="Configurar Modo da API">
...
2. Teste minuciosamente nos modos de teste e ao vivo
