...
<Steps>
<Step title="Criar Plugin Base">
Crie seu próprio projeto de plugin Figma usando o [guia rápido de plugins do Figma](https://www.figma.com/plugin-docs/plugin-quickstart-guide/). Isso irá gerar um esqueleto com um arquivo `manifest.json`.
...
<Step title="Clonar a Implementação de Exemplo">
Clone o repositório [dodopayments-figma](https://github.com/dodopayments/dodopayments-figma) e atualize seu `manifest.json` com o nome e ID da sua pasta de plugin gerada.
...
- Personalize `LicenseKeyInput.tsx` para combinar com suas preferências de design
...
<Step title="Iniciar Servidor de Desenvolvimento">
...
| Comando | Descrição |
|---------|-------------|
| `npm run build` | Compilar o plugin para produção |
| `npm run dev` | Iniciar servidor de desenvolvimento com monitoramento de arquivos |
| `npm run lint` | Verificar estilo de código e erros |
...
2. Teste minuciosamente em modos de teste e ao vivo
