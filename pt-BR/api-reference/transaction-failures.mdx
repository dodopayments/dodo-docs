...
| `FRAUDULENT` | Sim | A transação foi marcada como potencialmente fraudulenta |
...
| `INSUFFICIENT_FUNDS` | Sim | O saldo da conta é insuficiente para completar a transação |
...
| `REENTER_TRANSACTION` | Sim | A transação precisa ser inserida novamente |
