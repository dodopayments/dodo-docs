...
- Os valores de metadados podem ser uma string, número ou booleano; strings podem ter até 500 caracteres
...
- As chaves devem conter apenas caracteres alfanuméricos, hífens e sublinhados
- Os metadados não são pesquisáveis usando nossa API, mas são retornados nas respostas da API e webhooks
