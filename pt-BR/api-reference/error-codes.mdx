...
- `UNSUPPORTED_BILLING_CURRENCY`
  - **Trigger:** A moeda de cobrança solicitada não é compatível com esta assinatura
  - **Message:** Moedas de cobrança diferentes de USD não são compatíveis com assinaturas
...
- `UNSUPPORTED_CURRENCY`
  - **Trigger:** A moeda do produto ou addon não é uma moeda que Dodo Payments pode cobrar. Os preços base podem ser definidos em qualquer moeda cobrável, então isso geralmente significa que o código da moeda é inválido ou ainda não é compatível.
  - **Message:** A moeda não é compatível no momento / Atualmente, apenas produtos em USD e INR são compatíveis / Atualmente, apenas USD e INR são compatíveis com o preço do addon / Só é possível solicitar USD ou INR para billing_currency / Moeda não compatível / Moeda inesperada para assinaturas com cartões indianos
