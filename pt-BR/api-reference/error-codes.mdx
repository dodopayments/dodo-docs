...
- `DISCOUNT_CONCURRENT_REDEMPTION`
  - **Gatilho:** Outro resgate do mesmo código manteve o bloqueio da linha de limite de uso por tempo demais
  - **Mensagem:** O desconto está sendo resgatado simultaneamente; tente novamente
  - **Observação:** Transitório. O código ainda pode ter capacidade, portanto é seguro tentar novamente. Não exiba isso ao cliente como "código esgotado".
