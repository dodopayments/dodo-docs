...
## Guias de Desenvolvedores Relacionados

Explore nossos guias abrangentes para entender como implementar recursos-chave usando a API:

<CardGroup cols={2}>
{/* LOCKED_PATTERN_f7cf71c4394981bb4f21a4fe70918d2a */}
  Aprenda a integrar pagamentos únicos, sessões de checkout e links de pagamento em sua aplicação
</Card>
{/* LOCKED_PATTERN_111d19916a89f7256f741dfba74b6bd8 */}
  Guia completo para implementar assinaturas, gerenciar planos e lidar com eventos do ciclo de vida de assinaturas
</Card>
{/* LOCKED_PATTERN_5077a75db45fcbd237199b9c9e2a1768 */}
  Configure medições e eventos de uso para modelos de cobrança por consumo e preços baseados em utilização
</Card>
...
{/* LOCKED_PATTERN_da690bf0c88a9186dd98cff7b602ef0f */}
  Crie experiências de checkout seguras e hospedadas com total personalização e recursos avançados
</Card>
</CardGroup>