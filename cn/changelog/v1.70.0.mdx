...
1. **内嵌结账 - 完全嵌入式结账体验（测试版）**  
   ...
   <Frame>
   <img src="/images/inline-checkout/cover.png" alt="内联结帐封面图片" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
...
3. **仪表板中的订阅计划变更及下次账单日期更新**  
    ...
    <Frame>
    <img src="/images/changelog/subscription-plan-changes.png" alt="仪表板中的订阅计划更改" style={{ maxHeight: '500px', width: 'auto' }} />
    </Frame>
...
4. **支付URL的短链接**  
   ...
   <Frame>
   <img src="/images/changelog/short-links.png" alt="支付 URL 的短链接功能" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
