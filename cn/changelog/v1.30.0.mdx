...
- **自定义付款阈值**：新增设置美元钱包最低付款金额的功能，帮助商家优化付款处理并减少小额交易的费用。可以在 `Payouts ▸ USD Wallet ▸ Edit Payout Threshold` 访问该功能。
  
  <Frame>
    <img src="/images/changelog/payout-threshold.png" alt="付款阈值封面图"/>
  </Frame>
