...
- **自定义支付阈值**：增加了为美元钱包设置最低支付金额的功能，帮助商家优化支付处理并减少小额交易的费用。可以在 `Payouts ▸ USD Wallet ▸ Edit Payout Threshold` 访问此功能。
  
  <Frame>
    <img src="/images/changelog/payout-threshold.png" alt="支付阈值封面图"/>
  </Frame>
