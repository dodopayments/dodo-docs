...
### 1. **沟通偏好设置**
   ...
   <Frame>
     <img src="/images/communication-preferences/overview.png" alt="通信偏好概览，显示通知设置" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
...
### 2. **结账会话中的自定义字段**
   ...
   **优势**
   ...
   <Info>
   自定义字段值会在支付和订阅响应中的 `custom_field_responses` 数组内返回。
   </Info>

   了解更多：[Checkout Session 自定义字段](/developer-resources/checkout-session#15-collecting-custom-fields)
