...
<Tip>
使用元数据通过活动、来源或内部参考ID标记折扣，以便稍后对使用情况进行对账和衡量投资回报率。
</Tip>
...
<Info>
如果订阅已经有一个折扣，且您未传递新代码，则当适用于新产品时，现有折扣会自动保留。
</Info>

### 启用不预先应用的折扣条目
允许客户在结账时输入代码，而不提前传递一个。
...
<Info>
折扣代码是获取和保留客户的强大杠杆。 从简单、命名良好的优惠开始，彻底验证，并根据表现进行迭代。
</Info>