...
- **跨业务可视性**：在一个地方查看所有来自 Dodo Payments 商家的购买和订阅
- **集中管理**：从单一仪表板管理不同业务的订阅
- **统一账单历史**：访问所有购买的发票和付款历史
- **单点登录**：使用邮箱登录一次即可访问所有 Dodo Payments 商家的购买信息

<Tip>
统一客户门户补充了特定业务的门户。客户可以根据个人偏好使用品牌商家门户或统一门户。
</Tip>

## 故障排除

- **链接过期**：生成并发送新的动态链接。
- **邮箱无法识别**：要求客户使用与其购买相关联的邮箱
- **订阅暂停**：如果订阅被暂停，客户必须通过门户更新付款方式以清除欠款并重新激活订阅。更新过程将自动扣除剩余欠款。
- **付款方式更新失败**：如果在更新过程 `on_hold` 中付款失败，订阅将保持暂停状态。客户可以尝试使用不同的付款方式。

<Card title="Design & Theme Customization" icon="palette" href="/features/design">
  在设计页面通过预构建的主题、字体、颜色和实时预览自定义您的客户门户外观。
</Card>
