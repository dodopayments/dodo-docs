...
<img src="/images/CBB/Checkout.png" alt="结账显示产品购买所含积分" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Entitlements  - Credits.jpg" alt="积分列表页面显示已创建的积分权益" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Create Credit.jpg" alt="积分创建表单展示基本信息、常规设置和订阅设置" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - Subscription.jpg" alt="产品权益部分显示积分附加按钮" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - Subscription-2.jpg" alt="添加积分面板包含积分选择下拉菜单" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Attach Credit - Subscription-4.jpg" alt="积分配置表单包含账单周期、试用和分摊设置" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - Subscription-5.jpg" alt="显示选定积分及其详细信息的添加积分面板" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
</Steps>
...
<img src="/images/CBB/Desktop - Attach Credit - OTP.jpg" alt="产品定价部分选择了单次付款" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - UBB.jpg" alt="基于用量计费的定价配置" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - UBB-3.jpg" alt="选择计量器面板显示免费阈值和积分切换" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - UBB-5.jpg" alt="计量器配置包括积分选择和每积分的计量单位" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - UBB-6.jpg" alt="UBB产品的积分配置" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - UBB-1.jpg" alt="配置的计量器显示积分附加详情" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
</Steps>
...
<img src="/images/CBB/Desktop - Usage Billing.jpg" alt="使用计费仪表板显示的包含消费积分的事件表" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Checkout.png" alt="结账页面显示的产品包含API调用积分" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Customer Portal.jpg" alt="客户门户积分视图显示余额和交易历史" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Subscription Details.jpg" alt="订阅详情页面显示权益和使用历史" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Transactions - Payment Summary.jpg" alt="交易详情页面显示积分权益" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Entitlements  - Credits.jpg" alt="产品部分的积分列表页面" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Customer Details.jpg" alt="客户详情页面包含积分选项卡显示余额和交易" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
| 计划 | 价格 | 每月积分 | 超额 |
|------|-------|---------------|---------|
| 入门 | $29/月 | 10,000 代币 | $0.003/代币 |
| 专业 | $99/月 | 100,000 代币 | $0.002/代币 |
| 企业 | $499/月 | 1,000,000 代币 | $0.001/代币 |
...
- 滚存：最多 25%，为期 1 个月
- 超额：已启用，在计费时结算超额
- 计量器：`ai.generation`，`tokens` 字段上使用求和聚合
</Accordion>
...
| 计划 | 价格 | 每月积分 | 超额 |
|------|-------|---------------|---------|
| 免费 | $0/月 | 1,000 次调用 | 已阻止 |
| 开发者 | $19/月 | 50,000 次调用 | $0.001/次调用 |
| 商业 | $99/月 | 500,000 次调用 | $0.0005/次调用 |

**配置：**
- 积分类型：自定义单位（“API 调用”）
- 精度：0（整数调用）
- 滚存：已禁用
- 超额：开发者及以上计划允许超额（在重置时豁免），免费计划禁用超额
