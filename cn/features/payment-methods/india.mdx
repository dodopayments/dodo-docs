...
The amount registered with the customer's bank is `max(mandate_floor, billing_amount)`. So the floor is effectively the customer-facing **authorization ceiling** whenever billing is lower than the floor.
