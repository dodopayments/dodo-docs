...
| 功能                              | MoR（Dodo Payments）         | 支付网关（传统PG）                      |
|----------------------------------|--------------------------------------------|--------------------------------------------|
| 法定卖家                         | Dodo Payments (MoR)                        | 您的公司                                 |
| 税收征管和汇缴                   | 由Dodo处理                               | 您负责                                   |
| 合规与监管负担                   | Dodo承担责任                              | 您处理当地法律和拒付                      |
| 结算货币                         | 支持USD, EUR, GBP和其他25+种              | 取决于您的商家账户                        |
| 风险管理                         | 内置欺诈和拒付保护                        | 您设置自己的工具（例如 Stripe Radar）      |
| 支付                             | 简化的全球支付汇总                        | 直接从支付网关到您，需设置银行账户         |
