...
<Frame>
<img src="/images/usage-based/UBB-2.png" alt="仪表创建界面，显示事件名称、聚合类型和过滤选项" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/usage-based/UBB-3.png" alt="事件过滤" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
**比较运算符**：等于、不等于、大于、大于或等于、小于、小于或等于、包含、不包含
...
<Frame>
<img src="/images/usage-based/UBB-1.png" alt="仪表分析" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Attach Credit - UBB-5.jpg" alt="启用信用计费使用的仪表配置切换" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
