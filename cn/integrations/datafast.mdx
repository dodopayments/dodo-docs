...
<Step title="Open the Webhook Section">
  在您的 Dodo Payments 仪表板中，导航至 <b>Webhooks → + 添加端点</b> 并展开集成下拉菜单。
  <Frame>
    <img src="/images/integrations/datafast/add.png" alt="添加端点和集成下拉菜单" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
...
<Step title="Enter API Key">
  ...
  <Frame>
    <img src="/images/integrations/datafast/api-key.png" alt="添加 API 密钥" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
