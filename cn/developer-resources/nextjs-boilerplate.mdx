...
<Info>
此模板使用 Next.js 16 App Router，配合 TypeScript、Tailwind CSS 4 和 `@dodopayments/nextjs` 适配器。
</Info>
...
<Step title="添加您的产品">
使用 Dodo Payments 中的实际产品 ID 更新 `src/lib/products.ts`：
...
该模板演示了如何在 `src/app/api/webhook/route.ts` 中处理两个 webhook 事件：
