...
<Step title="创建您的环境文件">
使用您的 Dodo Payments API 密钥创建一个 `.env` 文件:
...
<Check>
**静态文件已配置!** 请访问 `http://localhost:3000` 查看您的演示界面。
</Check>
</Step>
</Steps>
...
2. 更新代码中的产品和附加组件 ID，使用您 Dodo Payments 仪表盘中的实际值
3. 启动您的服务器:
