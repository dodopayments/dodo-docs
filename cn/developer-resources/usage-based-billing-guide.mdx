...
- `not_equals` - 排除过滤器
- `greater_than` - 数值比较
- `greater_than_or_equals` - 数值比较 (包含)
- `less_than` - 数值比较
- `less_than_or_equals` - 数值比较 (包含)
- `contains` - 字符串包含子字符串
...
<Frame>
<img src="/images/guides/usage-based-billing/meter-quantities-chart.png" alt="显示随时间变化的使用趋势的计量数量图表，带有紫色渐变可视化效果" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/guides/usage-based-billing/events-table.png" alt="事件表，显示事件名称、ID 和用于详细事件分析的分页控件" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
