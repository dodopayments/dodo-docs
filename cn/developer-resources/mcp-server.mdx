...
[Dodo Agent Plugin](/developer-resources/build-with-ai-coding-agents) 可为 Claude Code、Codex CLI、Cursor 和 OpenCode 一步安装两个 MCP servers 以及全部十七个 skills。有关各代理的安装命令，请参阅 [AI Coding Agents 指南](/developer-resources/build-with-ai-coding-agents)。
