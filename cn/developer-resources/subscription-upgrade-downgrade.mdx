...
<Info>
使用 <code>difference_immediately</code> 降级所产生的积分是针对订阅范围的，与 <a href="/features/credit-based-billing">基于积分的计费</a> 权益区分。它们会自动应用于同一订阅的未来续订，并且不能在订阅之间转移。
</Info>
...
- 探索 <a href="/features/credit-based-billing">基于积分的计费</a>
