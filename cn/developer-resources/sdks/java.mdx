...
<Tip>
始终使用最新的 SDK 版本以访问最新的 Dodo Payments 功能。请查看 [Maven Central](https://central.sonatype.com/artifact/com.dodopayments.api/dodo-payments-java) 以获取最新版本。
</Tip>
...
<Card title="线程安全" icon="bolt">
  在多线程应用程序中安全并发使用
</Card>

<Card title="构建者模式" icon="layer-group">
  直观的构建者模式用于构建请求
</Card>

<Card title="异步支持" icon="arrows-rotate">
...
<CardGroup cols={2}>
<Card title="GitHub 仓库" icon="github" href="https://github.com/dodopayments/dodopayments-java">
  查看源代码并贡献
</Card>
...
<Card title="报告问题" icon="bug" href="https://github.com/dodopayments/dodopayments-java/issues">
  报告错误或请求功能
</Card>
</CardGroup>
