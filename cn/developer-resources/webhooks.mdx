...
<Frame>
  <img src="/images/cover-images/Webhooks.webp" alt="Webhook 封面图" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Step title="Create Webhook Endpoint">
    ...
    <Frame>
        <img src="/images/webhooks/create-endpoint.png" alt="添加 Webhook" style={{ maxHeight: '500px', width: 'auto' }} />
    </Frame>
</Step>
...
<Expandable title="Data object properties">
  ...
  资源类型。可选项包括：`Payment`, `Subscription`, `Refund`, `Dispute`, `LicenseKey`, `CreditLedgerEntry`, `CreditBalanceLow`, `AbandonedCheckout`, `DunningAttempt`，或 `EntitlementGrant`。
  </ResponseField>
  
  其他字段根据事件类型而异。请参阅特定事件的文档以获取完整架构。
</Expandable>
</ResponseField>
...
<Frame>
    <img src="/images/webhooks/endpoints.png" alt="端点详情" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
此交互式工具让您从所有支持的事件类型中进行选择，并将真实的模拟有效负载发送到您的端点。它会循环，以便您在一个会话中测试多个事件。
...
<Frame>
    <img src="/images/webhooks/logs.png" alt="日志" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
    <img src="/images/webhooks/activity.png" alt="活动" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/images/webhooks/alerting.png" alt="Webhook 警报设置显示电子邮件通知配置" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
