...
1. 从注册表下载组件配置
2. 在你的 `components/billingsdk/` 目录中安装组件文件
3. 如有需要，更新你的项目配置
4. 安装任何额外的依赖项

## 生成的文件结构

运行 `init` 后，你将获得一个完整的项目结构，包括：
...
<CardGroup cols={3}>
  <Card title="完整文档" icon="book" href="https://billingsdk.com/docs">
    包含示例和最佳实践的计费 SDK 完整指南
  </Card>
  <Card title="CLI 参考" icon="terminal" href="https://billingsdk.com/docs/cli">
    所有命令和选项的详细 CLI 文档
  </Card>
  <Card title="组件库" icon="boxes-stacked" href="https://billingsdk.com/docs/components">
    浏览所有可用组件及其实时示例
  </Card>
</CardGroup>
