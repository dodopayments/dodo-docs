...
{/* LOCKED_PATTERN_848a353666469e7a047ef05af5a45770 */}
    将 Dodo Payments 结账集成到你的 Remix 应用中。
</Card>
{/* LOCKED_PATTERN_df89dec21e12f4bf30b6acf75ba025e1 */}
    允许客户通过 Dodo Payments 管理订阅和详情。
</Card>
...
<Warning>
绝不将你的 <code>.env</code> 文件或密钥提交到版本控制中。
</Warning>
</Step>
</Steps>
...
<Info>
所有示例均假设你正在使用 Remix App Router。
</Info>

<Tabs>
{/* LOCKED_PATTERN_28fd81a4703a84d931eeff69f1520d54 */}
  <Info>
  使用此处理程序将 Dodo Payments 结账集成到你的 Remix 应用中，支持静态（GET）、动态（POST）和会话（POST）支付流程。
  </Info>
  <CodeGroup>
...
{/* LOCKED_PATTERN_085b207030169d6eead800f9835ef4fb */}
  <Info>
  使用此处理程序通过 Dodo Payments 客户门户让客户管理其订阅和详情。
  </Info>
  <CodeGroup>
...
{/* LOCKED_PATTERN_0026b036379d81a9d03c36b3b6e83ddd */}
  <Info>
  使用此处理程序在你的 Remix 应用中安全地接收并处理 Dodo Payments 的 webhook 事件。
  </Info>
  <CodeGroup>
...
<Info>
Dodo Payments 支持三种类型的支付流程来将支付集成到你的网站中，该适配器支持所有类型的支付流程。
</Info>
...
指定付款金额（例如 <code>1000</code> 表示 $10.00）。
</ParamField>
...
Checkout 会话提供更安全的托管结账体验，可处理一次性购买和订阅的完整支付流程，并支持完全自定义控制。
