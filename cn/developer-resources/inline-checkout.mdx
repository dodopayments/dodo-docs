...
<Frame caption="Open Wallet domains from the Apple Pay row">
  <img src="/images/apple-pay-domains/manage-domains.png" alt="支付方式设置中Apple Pay行的管理域名按钮" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<Frame caption="Download the Apple Pay domain association file">
  <img src="/images/apple-pay-domains/wallet-domains-panel.png" alt="带有下载文件按钮的钱包域名面板" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<Frame caption="Register the domain where you embed inline checkout">
  <img src="/images/apple-pay-domains/register-domain.png" alt="注册域名表单，其中已输入了域名" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
它必须通过 HTTPS 提供，且无重定向并使用 `Content-Type: application/octet-stream` 或 `text/plain` 提供。
</Step>
...
<Frame caption="Verify the hosted association file">
  <img src="/images/apple-pay-domains/verify-domain.png" alt="带有关联文件主机路径和验证域名按钮的验证域名屏幕" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<Frame caption="Verified domains show an Active status">
  <img src="/images/apple-pay-domains/domains-active.png" alt="钱包域名列表，显示具有活动 Apple Pay 状态和启用切换开关的域名" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
有关更多帮助，请访问我们的 [Discord 社区](https://discord.gg/bYqAp4ayYh) 或联系开发者支持团队。
