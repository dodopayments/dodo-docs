...
**Common options**: `credit`、`debit`、`upi_collect`、`apple_pay`、`google_pay`、`amazon_pay`、`klarna`、`affirm`、`afterpay_clearpay`、`cashapp`、`multibanco`、`bancontact_card`、`eps`、`ideal`、`przelewy24`、`paypal`。这并非完整集合——所有可接受的值请参阅 [Create Checkout Session API reference](/api-reference/checkout-sessions/create)。
