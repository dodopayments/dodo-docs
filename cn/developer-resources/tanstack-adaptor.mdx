---
title: Tanstack 适配器
description: 了解如何使用我们的 Tanstack 适配器将 Dodo Payments 集成到您的 Tanstack App Router
...
<Card title="结账处理程序" icon="cart-shopping" href="#checkout-route-handler">
    将 Dodo Payments 结账集成到您的 Tanstack 应用中。
</Card>
...
代码占位符_09dbe5ddedc7cb09_END

</Step>
<Step title="设置环境变量">
在项目根目录中创建一个 <code>.env</code> 文件：

代码占位符_3446a0449b54fa6b_END
...
客户门户路由处理程序使您能够将 Dodo Payments 客户门户无缝集成到您的 Tanstack 应用中。
