...
{/* LOCKED_PATTERN_085b207030169d6eead800f9835ef4fb */}
  <Info>
  使用此处理程序允许客户通过 Dodo Payments 客户门户管理其订阅和信息。
  </Info>
  <CodeGroup>
...
{/* LOCKED_PATTERN_0026b036379d81a9d03c36b3b6e83ddd */}
  <Info>
  使用此处理程序在你的 Tanstack 应用中安全地接收和处理 Dodo Payments webhook 事件。
  </Info>
  <CodeGroup>
...
结账会话提供更安全的托管结账体验，处理一次性购买和订阅的完整支付流程，同时提供完全的自定义控制。
