...
- `UNSUPPORTED_BILLING_CURRENCY`
  - **Trigger:** 请求的计费货币不支持此订阅
  - **Message:** 订阅不支持非 USD 计费货币
...
- `UNSUPPORTED_CURRENCY`
  - **Trigger:** 产品或附加项的货币不是 Dodo Payments 可以收取的货币。基础价格可以使用任何可收取的货币设置，因此这通常意味着货币代码无效或尚未受支持。
  - **Message:** 当前不支持此货币 / 当前仅支持 USD 和 INR 产品 / 附加项价格仅支持 USD 和 INR / billing_currency 只能请求 USD 或 INR / 不支持的货币 / 印度银行卡订阅使用了意外的货币
