...
<Tip>
Använd alltid den senaste SDK-versionen för att få tillgång till de senaste Dodo Payments-funktionerna. Kontrollera [Maven Central](https://central.sonatype.com/artifact/com.dodopayments.api/dodo-payments-kotlin) för den senaste versionen.
</Tip>

<Info>
SDK:n kräver Java 8 eller senare och är kompatibel med både JVM och Android-plattformar.
</Info>
...
<Card title="Coroutines" icon="bolt">
  Fullt stöd för Kotlin coroutines för asynkrona operationer
</Card>

<Card title="Null Safety" icon="shield-check">
  Utnyttja Kottins null-säkerhet för robust felhantering
</Card>

<Card title="Extension Functions" icon="code">
  Idiomatiska Kotlin-extensions för förbättrad funktionalitet
</Card>

<Card title="Data Classes" icon="layer-group">
  Typ-säkra dataklasser med kopierings- och destruktureringsstöd
</Card>
</CardGroup>
...
<Tip>
Använd Kotlin's `runCatching` för en mer funktionell metod för felhantering med Result-typer.
</Tip>
...
<CardGroup cols={2}>
<Card title="GitHub-repo" icon="github" href="https://github.com/dodopayments/dodopayments-kotlin">
...
<Card title="Rapportera problem" icon="bug" href="https://github.com/dodopayments/dodopayments-kotlin/issues">
