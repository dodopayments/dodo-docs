...
<Note>
  ...
  ärende](https://github.com/dodopayments/dodopayments-php/issues).
</Note>
...
<Warning>
  Förvara dina API-nycklar säkert med hjälp av miljövariabler. Exponera dem aldrig i
  din kodbas eller kommitta dem till versionskontroll.
</Warning>

## Kärnfunktioner

<CardGroup cols={2}>
<Card title="PSR-4 Kompatibel" icon="check">
...
<Card title="Omfattande Testning" icon="vial">
  Omfattande testtäckning för tillförlitlighet och stabilitet
</Card>

<Card title="Undantagshantering" icon="shield-check">
...
<Tip>
  Wrap alltid API-anrop i try-catch-block för att hantera potentiella fel
  på ett smidigt sätt och ge meningsfull feedback till användarna.
</Tip>
...
<Notera>
  De `extra*` parametrarna med samma namn överskrider dokumenterade parametrar.
</Notera>
...
<Card title="Rapportera problem" icon="bug" href="https://github.com/dodopayments/dodopayments-php/issues">
