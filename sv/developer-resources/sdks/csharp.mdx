...
SDK:n kastar specifika undantag baserat på HTTP-statuskoden. Alla 4xx-fel ärv från `DodoPayments4xxException`.
...
| andra  | `DodoPaymentsUnexpectedStatusCodeException` |
...
<Tip>
För utveckling, använd [user secrets](https://learn.microsoft.com/en-us/aspnet/core/security/app-secrets) istället för att lagra nycklar i `appsettings.json`:
...
- **GitHub**: Öppna ett ärende på [repository](https://github.com/dodopayments/dodopayments-csharp)
