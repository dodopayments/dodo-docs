...
Konfigurera för Test Mode-miljön:
...
<Warning>
`POST /subscriptions` (SDK:ns `subscriptions.create`-metod) är **föråldrad**. Den fungerar fortfarande för befintliga integrationer, men nya integrationer bör skapa prenumerationer via en [Checkout Session](/developer-resources/checkout-session).
</Warning>
...
<Info>
`productPrice` anges i den lägsta valutaenheten (t.ex. cent för USD och paise för INR). För att debitera 25,00 USD skickar du `2500`.
</Info>

<Tip>
Debitering via `subscriptions().charge(...)` är avsedd för [on-demand-prenumerationer](/developer-resources/ondemand-subscriptions). Standardprenumerationer med schemaläggning debiteras automatiskt baserat på produktens prisplan.
</Tip>
...
### Samla in händelser i batchar

Samla effektivt in flera händelser (max. 1000 per begäran):
...
<Tip>
SDK:t försöker automatiskt skicka om begäranden vid anslutningsfel samt vid 408-, 409-, 429- och 5xx-fel, med exponentiell backoff.
</Tip>

## Asynkrona åtgärder

Använd CompletableFuture för asynkrona åtgärder:
...
<Card title="Discord Community" icon="discord" href="https://discord.gg/bYqAp4ayYh">
  Få hjälp och få kontakt med utvecklare
</Card>
...
- **GitHub**: Öppna ett ärende i [kodförvaret](https://github.com/dodopayments/dodopayments-java)

## Bidra

Vi välkomnar bidrag! Läs [riktlinjerna för bidrag](https://github.com/dodopayments/dodopayments-java/blob/main/CONTRIBUTING.md) för att komma igång.
