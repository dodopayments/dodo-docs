...
<Tip>
Använd alltid den senaste SDK-versionen för att få tillgång till de senaste Dodo Payments-funktionerna. Kontrollera [Maven Central](https://central.sonatype.com/artifact/com.dodopayments.api/dodo-payments-java) för den senaste versionen.
</Tip>
...
<Warning>
Lagra alltid dina API-nycklar säkert med hjälp av miljövariabler, systemegenskaper eller ett säkert konfigurationshanteringssystem. Hårdkoda dem aldrig i din källkod.
</Warning>
...
<Card title="Typ Säkerhet" icon="shield-check">
  Starkt typad API med säkerhet vid kompileringstid
</Card>

<Card title="Trådsäker" icon="bolt">
  Säker för samtidig användning i flertrådade applikationer
</Card>

<Card title="Builder-mönster" icon="layer-group">
  Intuitivt builder-mönster för att konstruera förfrågningar
</Card>

<Card title="Async Stöd" icon="arrows-rotate">
...
<Tip>
SDK:n försöker automatiskt om begärningar vid anslutningsfel, 408, 409, 429 och 5xx-fel med exponentiell backoff.
</Tip>
...
<Card title="Rapportera Problem" icon="bug" href="https://github.com/dodopayments/dodopayments-java/issues">
