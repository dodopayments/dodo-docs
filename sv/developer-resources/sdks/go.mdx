...
<Warning>
Lagra alltid dina API-nycklar säkert med hjälp av miljövariabler. Hårdkoda dem aldrig i din källkod.
</Warning>

## Kärnfunktioner

<CardGroup cols={2}>
<Card title="Kontextstöd" icon="clock">
  Fullt stöd för context.Context för avbrytande och tidsgränser
</Card>

<Card title="Stark typning" icon="shield-check">
  Stark typade förfrågningar och svar för säkerhet vid kompilering
</Card>

<Card title="Middleware" icon="layer-group">
  Utbyggbart middleware-stöd för loggning, mätvärden och anpassad logik
</Card>

<Card title="Goroutine-säker" icon="bolt">
  Trådsäker klient designad för samtidiga operationer
</Card>
</CardGroup>
...
<CardGroup cols={2}>
<Card title="GitHub-repo" icon="github" href="https://github.com/dodopayments/dodopayments-go">
...
<Card title="Rapportera problem" icon="bug" href="https://github.com/dodopayments/dodopayments-go/issues">
