...
- **Aggerings Typ**: `count` för att spåra antalet samtal
- Konfigurera ytterligare egenskaper om du spårar metadata som responstider, statuskoder, osv.
</Step>
...
Automatisk tömning intervall i millisekunder. Standard: `5000` (5 sekunder).
</ParamField>
...
<Warning>
**Städa Alltid Batcher**: Anropa `batch.cleanup()` vid applikationsavstängning för att tömma pågående händelser och förhindra dataloss.
</Warning>
