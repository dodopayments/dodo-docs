...
Tillåt kunder att lägga till eller ta bort tillägg på en prenumerationsprodukt under kassan. Gäller endast prenumerationsprodukter.
</ParamField>

<ParamField body="allow_phone_number_collection" type="boolean" default="true">
Samla in kundens telefonnummer under kassan.
</ParamField>
...
Tvinga fram skapande av en ny kundpost istället för att uppdatera befintliga.
</ParamField>
...
Hoppa över standardsidan för betalningsframgång och omdirigera kunder omedelbart till din `return_url` efter slutförd betalning.

<Tip>
Använd detta när du har en anpassad framgångssida som ger en bättre användarupplevelse, eller för mobilappar och inbäddade kassa-flöden.
</Tip>
</ParamField>
</Expandable>
</ParamField>
...
Displayetikett som visas för kunden på kassans formulär.

**Exempel**: `"Company Name"`, `"How did you hear about us?"`, `"Team Size"`
</ParamField>

<ParamField body="field_type" type="string" required>
Typ av fält som bestämmer regler för inmatningsvalidering.
...
Huruvida detta fält måste fyllas i innan kassan kan slutföras.
</ParamField>

<ParamField body="placeholder" type="string">
Placholdertext som visas i inmatningsfältet.
</ParamField>
...
Antal dagar för provperioden innan första debiteringen. Måste vara mellan 0 och 10000 dagar.
</ParamField>

<ParamField body="on_demand" type="object">
On-demand prenumerationskonfiguration för användningsbaserad eller mätardebitering.

<Expandable title="On-demand object properties">
<ParamField body="mandate_only" type="boolean" required>
Om satt till true, utförs ingen debitering och endast betalningsmetodens detaljer godkänns för framtida användning.
</ParamField>

<ParamField body="product_price" type="integer">
Produktpris för den initiala debiteringen till kunden. Om det inte specificeras används produktens lagrade pris.

**Format**: Representeras i den lägsta valören av valutan (t.ex. cent för USD). Till exempel, för att debitera $1.00, ange `100`.
</ParamField>

<ParamField body="product_currency" type="string">
Valuta för produktpriset, valfritt. Om det inte anges standardiseras det till produktens valuta.
</ParamField>

<ParamField body="product_description" type="string">
Valfri produktbeskrivningsöversikt för fakturering och radposter. Om det inte anges används produktens lagrade beskrivning.
</ParamField>

<ParamField body="adaptive_currency_fees_inclusive" type="boolean">
Huruvida anpassade valutakurser ska inkluderas i produktpriset (true) eller läggas till (false). Ignoreras om adaptiv prissättning inte är aktiverad.
</ParamField>
</Expandable>
</ParamField>
</Expandable>
...
Med Kassasessioner är detta inte längre nödvändigt. Du kan helt enkelt skicka in den information du har, så tar vi hand om resten. Till exempel:
