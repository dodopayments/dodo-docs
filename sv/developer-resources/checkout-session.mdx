...
<Info>
Svar på anpassade fält inkluderas automatiskt i webhook-payloads (`payment.succeeded`, `subscription.active` osv.) och kan hämtas via API:et. Använd dem för att berika ditt CRM, trigga onboardingflöden eller anpassa kundupplevelsen.
</Info>
