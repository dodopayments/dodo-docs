...
<Step title="Gör ditt första API-anrop">
...
<Info>
Vi har migrerat från Node.js SDK till den nya TypeScript SDK. Om du använder den äldre Node.js SDK, se [migrationsguiden](https://github.com/dodopayments/dodopayments-typescript/blob/main/MIGRATION.md) för att uppdatera din integration.
</Info>
...
Vi välkomnar bidrag till alla våra SDK:er! Varje repo har en `CONTRIBUTING.md`-fil med riktlinjer för:
