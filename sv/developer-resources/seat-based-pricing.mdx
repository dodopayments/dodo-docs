...
<Step title="Implementera skapandet av kassanhet">
...
1. Se till att du har din `.env`-fil med den korrekta API-nyckeln
...
2. Du bör se gränssnittet för prissättning baserat på antal platser
3. Prova olika kvantiteter av platser (0, 3, 10, etc.)
4. Klicka på "Generera kassa-länk" för varje kvantitet
