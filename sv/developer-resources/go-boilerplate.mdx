...
- **Modern UI** - Ren, mörk-temad prissida med HTML-mallar
...
- **Förifylld kassa** - Visar hur man skickar kunddata för att förbättra användarupplevelsen
...
I `templates/index.html`, ersätt den hårdkodade kunddata med dina faktiska användardata:
...
Boilerplate visar hur man hanterar webhook-händelser i `internal/api/webhook.go`. Stödda händelser inkluderar:
