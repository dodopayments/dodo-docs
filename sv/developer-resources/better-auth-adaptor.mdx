...
<AccordionGroup>
  {/* LOCKED_PATTERN_9586fa213a07317c452129bb9c8365ad */}
    - <b>client</b> (obligatoriskt): DodoPayments-klientinstans -{" "}
    <b>createCustomerOnSignUp</b> (valfritt): Skapa kunder automatiskt vid
    registrering - <b>use</b> (obligatoriskt): Array över plug-ins att aktivera (checkout,
    portal, usage, webhooks)
  </Accordion>
  {/* LOCKED_PATTERN_a313db3f1395a5521aceb89c3251fabd */}
    - <b>products</b>: Array med produkter eller asynkron funktion som returnerar
    produkter - <b>successUrl</b>: URL att omdirigera till efter lyckad betalning -{" "}
    <b>authenticatedUsersOnly</b>: Kräver användarauktorisering (standard: false)
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  {/* LOCKED_PATTERN_8cb977e6bc7a95fb0f5c0e3c34015b67 */}
    ...
    <code>DODO_PAYMENTS_API_KEY</code> i <code>.env</code> igen. -{" "}
    <b>Webhook-signatur mismatch</b>: Säkerställ att webhook-hemligheten matchar den
    som är angiven i Dodo Payments Dashboard. - <b>Kund skapades inte</b>: Bekräfta{" "}
    att <code>createCustomerOnSignUp</code> är satt till <code>true</code>.
  </Accordion>
