...
Säkerhetsnot: Lämna INTE in hemligheter till versionskontroll. Använd .env-filer lokalt och hantera hemligheter i distributionsmiljöer (t.ex. AWS, Vercel, Heroku, etc.).