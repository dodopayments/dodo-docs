...
Antal enheter för den nya planen (för sätbaserade produkter).
</ParamField>
...
<AccordionGroup>
<Accordion title="200 OK">
Förfrågan om ändring av plan genomfördes framgångsrikt. Prenumerationen uppdateras och betalningsbehandling har påbörjats.
</Accordion>

<Accordion title="400 Bad Request">
Ogiltiga begäransparametrar. Kontrollera att alla obligatoriska fält är ifyllda och rätt formaterade.
</Accordion>
...
- Granska <a href="/api-reference/subscriptions/change-plan">Change Plan API</a>
- Utforska <a href="/features/credit-based-billing">Krediteringsbaserad fakturering</a>
