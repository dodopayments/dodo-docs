...
<Info>
Krediter som skapas genom nedgraderingar med <code>difference_immediately</code> är begränsade till prenumerationen och skiljer sig från <a href="/features/credit-based-billing">Credit-Based Billing</a>-rättigheter. De tillämpas automatiskt på framtida förnyelser av samma prenumeration och går inte att överföra mellan prenumerationer.
</Info>
...
- Ta en titt på vår <a href="/developer-resources/webhooks">Webhook Integration Guide</a>
