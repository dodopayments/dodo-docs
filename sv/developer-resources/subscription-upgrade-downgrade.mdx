...
- `subscription.plan_changed`: Prenumerationsplan ändrad (uppgradering/nedgradering/uppdatering av tillägg)
- `subscription.on_hold`: Debiteringen för planändringen misslyckades, förnyelser stoppades
- `payment.succeeded`: Omedelbar debitering för planändringen lyckades
...
- `subscription.plan_changed`: prenumerationsplan ändrad (uppgradering/nedgradering/ändringar av tillägg)
- `subscription.on_hold`: debitering misslyckades, förnyelser stoppades
