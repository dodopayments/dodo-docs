...
<Info>
Detta avsnitt täcker **klientside** tema-konfiguration med Checkout SDK. Du kan också konfigurera teman **serverside** när du skapar en checkout-session via API:et med hjälp av parametern `theme_config`. Se [Checkout Theme Customization](/features/checkout#checkout-theme-customization) för API-nivåkonfiguration, eller använd [Design page](/features/design) i kontrollpanelen för att konfigurera teman visuellt med liveförhandsvisning.
</Info>
