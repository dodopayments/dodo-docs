...
1. **Aktivera evenemang filtrering**: Växla detta **PÅ**
...
**Kostnadsfri tröskel**: Ange → `10` (kunder får 10 gratis bilder per månad)
...
Betalningslänken kommer att se ut som: `https://test.checkout.dodopayments.com/buy/pdt_IgPWlRsfpbPd5jQKezzW1?quantity=1`
</Step>
...
2. Navigera till **Kunder** i vänstra sidofältet
