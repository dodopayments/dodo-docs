...
<Steps>
  ...
  <Step title="Create Usage Meters">
    ...
    * **Outputtokens:** 1 000 000 tokens / \$10.00 = 100 000 tokens per \$1.
    ...
    I Dodo-dashboarden skulle du ställa in "Meter units per credit" till 4 000 för input och 1 000 för output. Krediter anges i cent, så en kredit köper 1/100 av beloppen per dollar ovan.
  </Step>
