...
2. Skapa en produkt (engångsbetalning eller prenumeration). Prenumerationsprodukter måste ha ett pris på minst **1 USD** (eller motsvarande i din valda valuta); belopp under denna miniminivå stöds inte.
...
<Card title="Create Checkout Session" icon="code" href="/api-reference/checkout-sessions/create">
  API-referens för att skapa säkra, värdtjänade utcheckningssessioner för engångsbetalningar och prenumerationer
</Card>
<Card title="Create Payment Link" icon="link" href="/api-reference/payments/post-payments">
  API-referens för att skapa dynamiska betalningslänkar programmässigt
</Card>
</CardGroup>