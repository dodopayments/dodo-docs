...
<Info>
Denna boilerplate använder FastAPI med async/await-mönster, Pydantic för validering, och `dodopayments` Python SDK för sömlös API-integration.
</Info>
...
Skapa en `.env`-fil i roten av din katalog:
...
|----------|--------|-------------|
| `/checkout` | POST | Skapa en ny kassatjänst |
...
| `payment.failed` | Försök att betala misslyckades |
...
<Accordion title="Kassasessions skapande misslyckas">
**Vanliga orsaker:**
