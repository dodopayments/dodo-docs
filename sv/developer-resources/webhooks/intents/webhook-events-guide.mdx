...
|---------------------------------|------------------------------------------------------|---------------------------------------------------------------------------------|
| **Aktiv prenumeration**         | `subscription.active`        | Anger att en prenumeration nu är aktiv och att återkommande debiteringar har schemalagts.|
| **Uppdaterad prenumeration**    | `subscription.updated`        | Utlöses när något fält i en prenumeration uppdateras (synkronisering i realtid utan polling). |
| **Pausad prenumeration**        | `subscription.on_hold`        | Utlöses när en prenumeration tillfälligt pausas på grund av en misslyckad förnyelse. |
| **Förnyad prenumeration**       | `subscription.renewed`        | Inträffar när en prenumeration förnyas.                                              |
| **Ändrad prenumerationsplan**   | `subscription.plan_changed`        | Utlöses när en prenumeration uppgraderas, nedgraderas eller ändras med andra tillägg. |
| **Betalningsmetod för prenumeration uppdaterad** | `subscription.update_payment_method` | Skickas när betalningsmetoden för en prenumeration uppdateras. Innehåller nyttolasten för prenumerationen. |
| **Prenumeration avslutad**       | `subscription.cancelled`       | Utlöses när en prenumeration avslutas av handlaren eller kunden.         |
| **Misslyckad prenumeration**     | `subscription.failed`       | Anger en misslyckad prenumeration. Det innebär att vi inte kunde skapa ett betalningsmandat. |
| **Prenumeration löpt ut**        | `subscription.expired`       | Utlöses när en prenumeration når slutet av sin löptid och löper ut.          |
