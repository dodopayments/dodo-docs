...
description: Förstå de olika webhook-händelser som utlöses av Dodo Payments
  ...
  återhämtning och påminnelseaktiviteter
icon: bell
keywords:
  - Dodo Payments
  - webhook-händelser
...
| **Händelsenamn**           | **Händelsetyp**                  | **Beskrivning**                                                                 |
|--------------------------|---------------------------------|---------------------------------------------------------------------------------|
| **Övergiven kassa upptäckt** | `abandoned_checkout.detected` | Utlöses när en ofullständig eller misslyckad kassa upptäcks efter 60 minuter.  |
| **Övergiven kassa återhämtad** | `abandoned_checkout.recovered` | Sker när en kund slutför betalningen via en återhämtningslänk.              |
...
| **Händelsenamn**           | **Händelsetyp**           | **Beskrivning**                                                                 |
|--------------------------|--------------------------|---------------------------------------------------------------------------------|
| **Påminnelse startad**      | `dunning.started`        | Utlöses när ett påminnelseförsök börjar för en prenumeration som pausats eller avbrutits. |
| **Påminnelse återhämtad**    | `dunning.recovered`      | Sker när en kund uppdaterar sin betalningsmetod och den resulterande debiteringen lyckas. |

För detaljerade nyttolastscheman, fältbeskrivningar och exempel på hanterare, se [Återhämtningswebhooks](/developer-resources/webhooks/intents/recovery).

Dessa webhook-händelser är utformade för att ge handlare kritiska uppdateringar för att effektivt hantera sina operationer. Implementera robusta hanterare för varje relevant händelse i din webhook-integration för att säkerställa smidig och pålitlig funktionalitet.
