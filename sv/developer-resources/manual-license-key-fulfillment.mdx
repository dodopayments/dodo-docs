...
- Din API key (`DODO_PAYMENTS_API_KEY`) och webhook secret key från dashboarden. Se [guiden för att generera API key](/api-reference/introduction#api-key-management-and-authentication).
- En backend-endpoint som kan ta emot webhooks.
