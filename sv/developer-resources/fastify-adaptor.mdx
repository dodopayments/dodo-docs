...
### Parametrar för query som stöds
...
Fastställer det debiterade beloppet i hela valutaenheter (t.ex. <code>12.5</code> för 12,50 USD). Endast för Pay What You Want-produkter och ignoreras om beloppet understiger produktens lägsta pris.
</ParamField>
...
Säkerhetsanteckning: Lämna INTE in hemligheter till versionskontroll. Använd .env-filer lokalt och hemlighetshanterare i distributionsmiljöer (t.ex. AWS, Vercel, Heroku, etc.).