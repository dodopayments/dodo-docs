...
Dodo Agent Plugin installerar både MCP-servrar och alla sjutton skills i ett steg för Claude Code, Codex CLI, Cursor och OpenCode. Se [guiden för AI-kodningsagenter](/developer-resources/build-with-ai-coding-agents) för installationskommandon för varje agent.
