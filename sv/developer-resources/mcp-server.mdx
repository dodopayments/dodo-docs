...
[Dodo Agent Plugin](/developer-resources/build-with-ai-coding-agents) installerar både MCP servers och alla sjutton skills i ett enda steg för Claude Code, Codex CLI, Cursor, VS Code / GitHub Copilot, Kiro och OpenCode. Gemini CLI får endast de två MCP servers, eftersom det saknar en agent-skill-primitive. Se guiden [AI Coding Agents](/developer-resources/build-with-ai-coding-agents) för installationskommandon för varje agent.
