...
<Frame>
  <iframe 
      ...
      title="Använda Dodo Payments Fjärr-MCP-server"
      frameBorder="0"
...
<Steps>
<Step title="Åtkomst till den fjärranslutna servern">
...
<Step title="Hitta konfigurationsfil">
    Hitta konfigurationsfilen för Claude Desktop:
...
<Step title="Öppna Cline-inställningar">
    Hitta konfigurationsfilen för Cline:
...
När du distribuerar på distans, kräva alltid autentisering via `Authorization` huvudet eller `x-dodo-payments-api-key` huvudet.
...
Om verktygen inte fungerar korrekt, försök att specificera din klient uttryckligen:
...
<Card title="MCP-protokoll" icon="link" href="https://modelcontextprotocol.io">
  Lär dig mer om Model Context Protocol-standarden
</Card>
