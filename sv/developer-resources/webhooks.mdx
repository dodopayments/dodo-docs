...
<Expandable title="Data object properties">
  ...
  Typ av resurs. En av: `Payment`, `Subscription`, `Refund`, `Dispute`, `LicenseKey`, `CreditLedgerEntry`, `CreditBalanceLow`, `AbandonedCheckout`, `DunningAttempt`, eller `EntitlementGrant`.
  </ResponseField>
...
Detta interaktiva verktyg låter dig välja bland alla stödjade händelsetyper och skickar realistiska mock-payloads till din endpoint. Det loopar så att du kan testa flera händelser i en session.
...
<Frame>
    <img src="/images/webhooks/logs.png" alt="Loggar" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
    <img src="/images/webhooks/activity.png" alt="Aktivitet" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/images/webhooks/alerting.png" alt="Webhook Larminställningar som visar e-postmeddelandeinställningar" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
