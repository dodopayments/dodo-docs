...
<Card title="Kassa-hanterare" icon="cart-shopping" href="#checkout-route-handler">
    Integrera Dodo Payments kassa i din Astro-app.
</Card>
...
<Warning>
Kom ihåg att aldrig begå din <code>.env</code> fil eller hemligheter till versionskontroll.
</Warning>
</Step>
</Steps>
...
<Tab title="Kassa-hanterare">
  <Info>
  Använd denna hanterare för att integrera Dodo Payments kassa i din Astro-app. Stöder statiska (GET), dynamiska (POST) och sessions (POST) betalningsflöden.
  </Info>
  <CodeGroup>
...
<Tab title="Webhook-hanterare">
  <Info>
  Använd denna hanterare för att ta emot och bearbeta Dodo Payments webhook-händelser säkert i din Astro-app.
  </Info>
  <CodeGroup>
...
Kassa-sessioner ger en säkrare, värd kassaupplevelse som hanterar hela betalningsflödet för både engångsköp och prenumerationer med full anpassningskontroll.

Se [Kassa-sessioners integrationsguide](https://docs.dodopayments.com/developer-resources/checkout-session) för mer information och en komplett lista över stödda fält.
