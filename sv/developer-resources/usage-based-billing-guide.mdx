...
{/* LOCKED_PATTERN_e11b972ff38970af092497ad2b5da99c */}
  API-referens för att skapa och konfigurera användningsmätare för att spåra kundkonsumtion
</Card>
{/* LOCKED_PATTERN_b87752b420a84d90b09130bc3e896ab1 */}
  API-referens för att skicka användningshändelser till dina konfigurerade mätare för faktureringsberäkningar
</Card>
</CardGroup>
