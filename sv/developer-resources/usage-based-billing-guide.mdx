...
<Frame>
<img src="/images/guides/usage-based-billing/meter-quantities-chart.png" alt="Mätarens kvantitetsdiagram som visar användningstrender över tid med lila gradientvisualisering" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
- Egenskap: `hour`, Jämförare: `greater_than_or_equals`, Värde: `9`
