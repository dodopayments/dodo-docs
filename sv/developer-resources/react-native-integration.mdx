...
<Step title="Installera betalningsleverantör">
...
Du kan anpassa React Native Unified Checkout för att matcha din apps design genom att modifiera färger, typsnitt och mer genom apparensparameter när du anropar `initPaymentSession()`.
...
| `background` | Bakgrundsfärg på betalningssidan |
| `componentBackground` | Bakgrundsfärg för inmatningsfält, flikar och andra komponenter |
| `componentBorder` | Yttre kantfärg för inmatningsfält, flikar och andra komponenter |
| `componentDivider` | Intern kantfärg (delade kanter) för komponenter |
| `primaryText` | Rubriktextfärg |
