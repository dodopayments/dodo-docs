...
description: Lär dig hur du integrerar Dodo Payments med ditt Next.js App
...
{/* LOCKED_PATTERN_848a353666469e7a047ef05af5a45770 */}
    Integrera Dodo Payments-kassan med statiska, dynamiska och sessionsflöden.
</Card>
...
<Warning>
Lägg aldrig upp din <code>.env</code>-fil eller hemligheter i versionskontrollen.
</Warning>
</Step>
</Steps>
...
<Info>
Alla exempel utgår från att du använder Next.js App Router.
</Info>
...
{/* LOCKED_PATTERN_28fd81a4703a84d931eeff69f1520d54 */}
  <Info>
  Använd den här hanteraren för att integrera Dodo Payments-kassan i din Next.js-app. Stöder statiska (GET), dynamiska (POST) och checkout session (POST) betalningsflöden.
  </Info>
  <CodeGroup>
...
{/* LOCKED_PATTERN_0026b036379d81a9d03c36b3b6e83ddd */}
  <Info>
  Använd den här hanteraren för att ta emot och bearbeta Dodo Payments webhook-händelser säkert i din Next.js-app.
  </Info>
  <CodeGroup>
...
<Warning>
Om <code>productId</code> saknas returnerar hanteraren 400. Ogiltiga frågeparametrar ger också 400.
</Warning>
...
Checkout-sessioner erbjuder en säkrare, värdbaserad checkout-upplevelse som hanterar hela betalningsflödet för både engångsköp och prenumerationer med full anpassningskontroll.
...
Kundportal-rutt-hanteraren gör det möjligt för dig att sömlöst integrera Dodo Payments kundportal i din Next.js-applikation.
...
<ParamField query="send_email" type="boolean">
Om satt till <code>true</code> skickas ett e-postmeddelande till kunden med portallänken.
