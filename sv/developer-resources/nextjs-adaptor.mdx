...
Mer information och en fullständig lista över fält som stöds finns i [integrationsguiden för Checkout Sessions](https://docs.dodopayments.com/developer-resources/checkout-session).
...
Customer Portal-route handlern gör det möjligt att sömlöst integrera Dodo Payments Customer Portal i din Next.js-applikation.
