...
Fastställer det debiterade beloppet i större valutaenheter (t.ex. <code>12.5</code> för 12,50 USD). Gäller endast produkter av typen Pay What You Want och ignoreras om beloppet understiger produktens minimipris.
</ParamField>
...
Säkerhetsnotering: Lämna INTE in hemligheter till versionskontroll. Använd .env-filer lokalt och hemlighetshanterare i distributionsmiljöer (t.ex. AWS, Vercel, Heroku, etc.).