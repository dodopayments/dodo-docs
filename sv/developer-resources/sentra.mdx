...
<Frame>
  <img
    ...
    alt="Extensionsmarknaden för VS Code som visar Sentra-tillägget"
...
1. Logga in på din [Dodo Payments-instrumentpanel](https://app.dodopayments.com).
...
<Frame>
  <img
    ...
    alt="Sentra-konfigurationsskärm med API-nyckelinmatning och miljöval"
    width="50%"
  style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<Frame>
  <img
    ...
    alt="Sentra-gränssnitt visar promptinmatning med exempeluppgift"
    width="50%"
  style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
