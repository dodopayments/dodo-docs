...
3. Sök efter "Sentra by Dodo Payments" i marketplace.
...
3. **Ladda om fönster**: Använd Kommandopaletten (`Cmd+Shift+P` / `Ctrl+Shift+P`) och kör "Developer: Ladda om fönster"
