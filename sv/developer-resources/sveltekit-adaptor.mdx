...
Ange valuta för betalningen (t.ex. <code>USD</code>).
</ParamField>
<ParamField query="showCurrencySelector" type="boolean">
Visa valutaväljare.
</ParamField>
<ParamField query="paymentAmount" type="integer">
Ange beloppet för betalningen (t.ex. <code>1000</code> för $10.00).
</ParamField>
...
Checkout-sessioner erbjuder en säkrare, värdhostad kassaupplevelse som hanterar hela betalflödet för både engångsköp och prenumerationer med full anpassningskontroll.
...
Kundportalens rutt-hanterare gör det möjligt för dig att sömlöst integrera Dodo Payments kundportal i din SvelteKit-applikation.
...
Om det sätts till <code>true</code> skickas ett e-postmeddelande till kunden med portallänken.
</ParamField>
