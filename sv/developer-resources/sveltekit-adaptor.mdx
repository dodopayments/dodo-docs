...
<Card title="Kassa-hanterare" icon="cart-shopping" href="#checkout-route-handler">
    Integrera Dodo Payments kassa i din SvelteKit-app.
</Card>
...
<Tab title="Kassa-hanterare">
  <Info>
  Använd denna hanterare för att integrera Dodo Payments kassa i din SvelteKit-app. Stöder statiska (GET), dynamiska (POST) och sessionsbaserade (POST) betalningsflöden.
  </Info>
  <CodeGroup>
...
<Tab title="Webhook-hanterare">
  <Info>
  Använd denna hanterare för att ta emot och bearbeta Dodo Payments webhook-händelser på ett säkert sätt i din SvelteKit-app.
  </Info>
  <CodeGroup>
