...
1. **Inline Checkout - Fullt inbäddade utcheckningsupplevelser (BETA)**  
   ...
   <Frame>
   <img src="/images/inline-checkout/cover.png" alt="Omslagsbild för Inline Checkout" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
...
3. **Ändringar av prenumerationsplaner i instrumentpanelen med uppdateringar av nästa faktureringsdatum**  
    ...
    <Frame>
    <img src="/images/changelog/subscription-plan-changes.png" alt="Ändringar i abonnemangsplan i dashboard" style={{ maxHeight: '500px', width: 'auto' }} />
    </Frame>
...
4. **Korta länkar för betalnings-URL:er**  
   ...
   <Frame>
   <img src="/images/changelog/short-links.png" alt="Funktion för korta länkar för betalnings-URL" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
