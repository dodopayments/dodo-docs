...
Lade till fältet `refund_status` i `GET /payments/{payment_id}`-svaret för att snabbt kontrollera om en betalning har återbetalats utan att separat fråga refunds-endpointen.
