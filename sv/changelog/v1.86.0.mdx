...
Krediter fästs som **rättigheter** i skapandeprocessen för produkter. Du kan fästa upp till **5 krediter per produkt**, och krediter fungerar med alla tre prissättningsmetoder: prenumerationer, engångsbetalningar och fakturering baserad på användning.
