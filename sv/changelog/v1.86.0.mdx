...
<Frame>
<img src="/images/CBB/Checkout.png" alt="Kassa som visar inkluderade krediter med produktköpet" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/CBB/Customer Portal.jpg" alt="Kundportalens kreditvy med saldo och transaktionshistorik" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/design/general-overview.jpg" alt="Designinställningssida med liveförhandsvisning av kassa, kundportal och butik" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/design/general-color-settings.jpg" alt="Avancerade inställningar expanderade som visar full färgkonfiguration för ljusa och mörka lägen" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Tip>
Använd dessa fält för att bygga instrumentpaneler för tvister och återbetalningar, utlösa varningar vid statusändringar för tvister, eller lyfta fram betalningar som behöver uppmärksamhet.
</Tip>

Läs mer: [List Payments API](/api-reference/payments/get-payments)

### 4. **Återbetalningstabellen i kundportalen**

Kundportalen innehåller nu en dedikerad avsnitt för **Återbetalningar** där kunder kan se alla återbetalningar kopplade till sina betalningar. Varje post visar återbetalningsbeloppet, status, datum och den ursprungliga betalningen det utfärdades mot, vilket ger kunder full transparens i sin återbetalningshistorik utan att behöva kontakta support.

<Check>
Återbetalningstabellen är automatiskt tillgänglig i kundportalen för alla företag. Ingen konfiguration behövs.
</Check>
...
Du kan nu **kopiera mätare från testläge till live-läge** direkt från instrumentpanelen. När du har slutfört testningen av en mätarkonfiguration i testläge, använd kopieringsåtgärden för att återskapa den till live-läge med alla inställningar bevarade: aggregationstyp, eventnamn, filter och kreditassociationer. Detta eliminerar behovet av att manuellt återskapa mätare när du flyttar från utveckling till produktion.

<Tip>
Bygg och validera dina mätarkonfigurationer i testläge först, kopiera dem sedan till live-läge när du är redo att gå till produktion. Detta säkerställer att din faktureringskonfiguration testas innan den hanterar verklig kundanvändning.
</Tip>

Läs mer: [Användningsbaserad Fakturering](/features/usage-based-billing/introduction) | [Mätare](/features/usage-based-billing/meters)
