...
Betalnings- och tvistsvar innehåller nu även en `payment_provider` discriminator (`stripe`, `adyen` eller `dodo`), så att du kan identifiera hur varje transaktion dirigerades, och förhandsgranskningssvaret för checkout-sessionen returnerar `is_byop`. Fälten är additiva — Merchant-of-Record-trafik fortsätter att rapportera `payment_provider: dodo`.
