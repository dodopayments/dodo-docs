...
<Frame>
<img src="/images/product-analytics/overview.png" alt="Produktnivåanalys" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
| Fördel | Effekt |
|---------|--------|
| **Lägre tvistfrekvens** | RDR-lösta tvister räknas inte mot Visas 0,9% tröskelvärde |
| **Tvistavgift gäller fortfarande** | En tvistavgift debiteras fortfarande på RDR-lösta transaktioner -- detta täcker kostnaden för att bestrida med Visa å dina vägnar |
| **Noll operativt pålägg** | Ingen bevisinsamling eller svarsfrister |
| **Bättre kundupplevelse** | Korthållare får omedelbara återbetalningar |
...
<Frame>
<img src="/images/customer-portal/new-portal.png" alt="Kundportalens UI-omdesign" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
