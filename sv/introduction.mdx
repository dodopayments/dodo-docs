...
<Card title="Global Merchant of Record" icon="globe">
  Gå globalt utan komplexitet: inbyggd täckning i över 190 länder, 80+ valutor och 30+ betalningsmetoder
</Card>
...
<Accordion title="For AI Agents">
  ...
  **Installera**. För Claude Code, Codex CLI, Cursor, VS Code / GitHub Copilot, Kiro eller OpenCode kopplar [Dodo Agent Plugin](/developer-resources/build-with-ai-coding-agents) samman båda MCP-servrarna och alla skills i ett enda steg. Gemini CLI får endast MCP-servrarna. Se guiden [AI Coding Agents](/developer-resources/build-with-ai-coding-agents) för installationskommandon för varje agent.
  ...
  **Extend**. Install official [Dodo Payments Skills](/developer-resources/agent-skills) to teach your agent how to handle checkout, subscriptions, usage-based billing, credit-based billing, webhooks, and more:
  ...
  Fungerar med Claude Code, Codex CLI, Cursor, VS Code / GitHub Copilot, Kiro, OpenCode och alla agenter som stöder skills-protokollet.
</Accordion>
</AccordionGroup>
...
<Step title="Add Your First Product">
  ...
  <Card title="Subscription Product" icon="repeat" href="/features/subscription">
    Perfekt för SaaS, medlemskap eller återkommande tjänster
  </Card>
  ...
  <Card title="Credit-Based Billing" icon="coins" href="/features/credit-based-billing">
    Utfärda krediter (API-anrop, tokens, beräkningsenheter) och dra av när kunder konsumerar - med överföring och överbelastningskontroller
  </Card>
  </CardGroup>
</Step>
...
<Step title="Choose Your Integration Method">
  ...
  <Tab title="Full SDK Integration">
    **Best for advanced, fully customized solutions:**
    ...
    - Använd vårt TypeScript/Python/Go/PHP/Java/Kotlin/C#/Ruby/Rust SDK för sömlös integration
    - Programmatisk åtkomst till alla API:er för betalningar, prenumerationer och Customer Portal
    - Djup integration med din backend, dina arbetsflöden och dina datamodeller
    - Fullständigt stöd för webhooks, avancerade funktioner och automatisering
...
Anslut din AI-kodningsassistent direkt till Dodo Payments. Agent Plugin är en konfiguration med ett enda kommando för Claude Code, Codex CLI, Cursor, VS Code / GitHub Copilot, Kiro och OpenCode. Andra MCP-kompatibla agenter, såsom Windsurf, Claude Desktop, Cline och Zed, ansluter manuellt via MCP-servrarna.

<CardGroup cols={3}>
<Card title="Agent Plugin" icon="robot" href="/developer-resources/build-with-ai-coding-agents">
  En enda installation paketerar båda MCP-servrarna och alla sjutton skills för Claude Code, Codex CLI, Cursor, VS Code, Kiro och OpenCode
</Card>
...
<Card title="Supabase" icon="database" href="/developer-resources/supabase-boilerplate">
  Firebase-alternativ med öppen källkod, Postgres och Auth
</Card>
...
Hantera Dodo Payments från din terminal. Dodo CLI levereras med ett interaktivt TUI, en inbyggd AI-assistent och offline-webhook-testning — installera det med en rad:
...
<Card title="Dodo CLI" icon="terminal" href="/developer-resources/sdks/cli">
  Hantera betalningar, kunder och webhooks från din terminal — med ett TUI, en AI-assistent och en realtids-webhook-lyssnare inbyggd.
</Card>

### Billing SDK

Sluta uppfinna hjulet på nytt. Använd produktionsklara, tillgängliga faktureringskomponenter, från priskort till prenumerationspaneler, byggda för React och ShadCN.
...
<Card
  ...
  target="_blank"
>
  Vackra, anpassningsbara faktureringskomponenter, prislistor, prenumerationshantering och användningsmätare - spara utvecklingstid med produktionsklara UI för fakturering och betalningar.
</Card>

<Info>
**Open Source & Free**: BillingSDK är helt gratis att använda och modifiera för personliga och kommersiella projekt. Byggd av teamet på Dodo Payments för utvecklare.
</Info>

### In-App Purchases för Android och iOS
...
<Card title="Expo Boilerplate" icon="box-open" href="/developer-resources/expo-boilerplate">
  Kom igång med betalningar i appar för React Native med vår Expo-mall med öppen källkod
</Card>
...
Anslut Dodo Payments till dina favoritverktyg och plattformar för att automatisera arbetsflöden, skicka aviseringar och effektivisera din betalningshantering.

<Info>
**Automatisera allt**: Konfigurera aviseringar i realtid, utlösa arbetsflöden, synkronisera kunddata och mycket mer med vårt växande bibliotek av integrationer.
</Info>

### Populära integrationer

Anslut snabbt Dodo Payments till de mest använda design- och produktivitetsverktygen för att effektivisera ditt arbetsflöde och automatisera betalningshanteringen.
...
<Card title="WooCommerce" icon="wordpress" href="/integrations/woocommerce-plugin">
  Ta emot betalningar i WooCommerce-butiker
</Card>
...
<AccordionGroup>
  <Accordion title="Communication & Notifications">
    Håll dig informerad om betalningshändelser med aviseringar i realtid i teamets kommunikationsverktyg.
    ...
    <CardGroup cols={3}>
      ...
      <Card title="Discord" icon="discord" href="/integrations/discord">
        Få omedelbara betalningsuppdateringar på din Discord-server
      </Card>
  ...
  <Accordion title="Email Marketing & Customer Communication">
    Synkronisera kunddata och utlös e-postkampanjer baserat på betalningshändelser.

    <CardGroup cols={4}>
      <Card title="Resend" icon="envelope" href="/integrations/resend">
        Skicka transaktionsmeddelanden med Resend
      </Card>
  ...
  <Accordion title="CRM & Sales">
    Anslut dina betalningsdata till CRM-plattformar för att effektivisera försäljning och kundhantering.
  ...
  <Accordion title="Automation & Workflows">
    Skapa kraftfulla automatiseringar och datapipelines med plattformar för arbetsflödesautomatisering.

    <CardGroup cols={4}>
      <Card title="Zapier" icon="bolt" href="/integrations/zapier">
        Anslut till över 5 000 appar med Zapier
      </Card>
      <Card title="N8N" icon="diagram-project" href="/integrations/n8n">
        Automatisera arbetsflöden med egenhostade N8N eller N8N i molnet
      </Card>
      <Card title="Windmill" icon="wind" href="/integrations/windmill">
        Skapa anpassade arbetsflöden med Windmill
      </Card>
...
<Card title="View All Integrations" icon="puzzle-piece" href="/integrations/introduction">
  Utforska vårt kompletta bibliotek med integrationer och detaljerade installationsguider
</Card>
...
<Card title="API Reference" icon="terminal" href="/api-reference/introduction">
  Fullständig OpenAPI-referens med endpoints, parametrar och exempelanrop för alla Dodo Payments API:er
</Card>
