...
<Card title="React Native SDK" icon="mobile" href="/developer-resources/react-native-integration">
  Native mobila SDKs för iOS och Android med sömlösa betalflöden
</Card>

<Card title="Expo Boilerplate" icon="box-open" href="/developer-resources/expo-boilerplate">
  Påbörja din React Native in-app betalning med vår open source Expo-mall
</Card>
...
<Info>
**Automatisera Allt**: Ställ in realtidsaviseringar, trigga arbetsflöden, synka kunddata, och mer med vårt växande bibliotek av integrationer.
</Info>
...
<Card title="Figma Plugin" icon="figma" href="/integrations/figma-plugin">
  Få tillgång till Dodo Payments i Figma
</Card>
</CardGroup>
...
<AccordionGroup>
  ...
  <Accordion title="Email Marketing & Customer Communication">
    Synka kunddata och trigga e-postkampanjer baserat på betalningshändelser.

    <CardGroup cols={4}>
      <Card title="Resend" icon="envelope" href="/integrations/resend">
        Skicka transaktionsmail med Resend
      </Card>
      ...
      <Card title="AutoSend" icon="paper-plane" href="/integrations/autosend">
        Skicka automatiserade transaktionsmail med AutoSend
      </Card>
    </CardGroup>
  </Accordion>
  ...
  <Accordion title="Automation & Workflows">
    Bygg kraftfulla automationer och datarörledningar med arbetsflödesautomationsplattformar.
    ...
    <CardGroup cols={4}>
      ...
      <Card title="N8N" icon="diagram-project" href="/integrations/n8n">
        Automatisera arbetsflöden med egenvärd eller moln N8N
      </Card>
