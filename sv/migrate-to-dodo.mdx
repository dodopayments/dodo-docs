...
<CardGroup cols={3}>
  <Card title="Produkter & Prissättning" icon="box">
    Migrera alla dina produkter och prissättningsdetaljer.
  </Card>
  <Card title="Kunddata" icon="users">
    Överför din kompletta kunddatabas, inklusive kontaktuppgifter.
  </Card>
  <Card title="Rabattkoder & Kampanjer" icon="tag">
    Flytta alla rabattkoder och kampanjer sömlöst.
  </Card>
</CardGroup>
...
<Note>
Du behöver Node.js ≥ 18 installerat på din dator.
</Note>
...
- **Verktyg hjälp**: `dodo-migrate --help`
