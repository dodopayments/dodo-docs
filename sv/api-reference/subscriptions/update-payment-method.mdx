...
<Info>
För prenumerationer i `on_hold` tillstånd, skapar uppdatering av betalningsmetoden automatiskt en avgift för kvarstående skulder, genererar en faktura och reaktiverar prenumerationen till `active` tillstånd efter lyckad betalning.
</Info>
...
<Info>
För att lista befintliga betalningsmetoder för en kund, använd [List Payment Methods API](/api-reference/customers/get-customer-payment-methods). Detta hjälper dig att hämta tillgängliga betalningsmetod-ID:n när du använder `type: "existing"` för att uppdatera en prenumerations betalningsmetod.
</Info>
...
1. **`payment.succeeded`** - Avgiften för kvarstående skulder var lyckad
