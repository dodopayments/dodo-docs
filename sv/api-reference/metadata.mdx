...
- Metadatanycklar kan vara upp till 40 tecken långa
- Metadatavärden kan vara en sträng, ett nummer eller en boolean; strängar kan vara upp till 500 tecken långa
- Objekt, arrayer och `null` accepteras inte som metadatavärden
- Du kan ha upp till 50 metadatanyckel-värdepar per objekt
- Nycklar bör endast innehålla alfanumeriska tecken, bindestreck och understreck
- Metadata är inte sökbar med vår API men returneras i API-svar och webhooks
