...
- `DISCOUNT_CONCURRENT_REDEMPTION`
  - **Trigger:** En annan inlösen av samma kod höll låset på raden för användningsgränsen för länge
  - **Message:** Rabatten löses in samtidigt; försök igen
  - **Note:** Tillfälligt. Koden kan fortfarande ha kapacitet, så begäran kan tryggt försökas igen. Visa inte detta för kunden som "koden är uttömd".
