...
Ja. Med [Bring Your Own Processor (BYOP)](/features/byop) kan du ansluta ditt eget Stripe- eller Adyen-konto och dirigera betalningar från utvalda länder genom det, medan Dodo Payments fortsätter att driva produkter, prenumerationer, fakturering och analys. Länder som du inte uttryckligen dirigerar fortsätter att gå genom Dodo Payments som din fullständiga Merchant of Record, vilket gör det möjligt för oss att ta ansvar för skatte- och bedrägeriansvar för dessa rutter.
</Accordion>
