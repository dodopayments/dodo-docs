...
| Betalningsmetod          | Länder som stöds      | Valutor som stöds   | Abonnemang | Minsta belopp |
| :----------------------- | :-------------------- | :------------------ | :---------: | :------------ |
| **Credit Cards**         | Globalt               | Alla valutor        | Ja | $0.50 |
| **Debit Cards**          | Globalt               | Alla valutor        | Ja | $0.50 |
...
| **Afterpay**             | USA, Storbritannien   | USD, GBP            | Nej | $50.01 |
| **UPI**                  | Indien                | INR                 | Ja* | ₹1 |
