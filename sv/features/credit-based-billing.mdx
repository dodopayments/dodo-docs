...
Koppla krediter till en prenumerationsprodukt under kassan:
...
| Plan | Pris | Krediter/månad | Överutnyttjande |
|------|-------|---------------|-----------------|
...
**Konfiguration:**
- Kredittyp: Custom Unit ("AI Tokens")
- Precision: 0 (heltal)
- Överföring: 25 % max, tidsram 1 månad
- Överutnyttjande: Aktiverat, fakturera överutnyttjande vid fakturering
...
| Plan | Pris | Krediter/månad | Överutnyttjande |
|------|-------|---------------|-----------------|
| Gratis | $0/mån | 1 000 samtal | Blockerat |
| Developer | $19/mån | 50 000 samtal | $0.001/samtal |
| Business | $99/mån | 500 000 samtal | $0.0005/samtal |

**Konfiguration:**
- Kredittyp: Custom Unit ("API Calls")
- Precision: 0 (heltal)
- Överföring: Inaktiverat
- Överutnyttjande: Developer+ planer tillåter överutnyttjande (efterskänks vid återställning), Gratisplanen inaktiverar överutnyttjande
...
| Plan | Pris | Krediter/månad | Överutnyttjande |
|------|-------|---------------|-----------------|
| Personal | $9/mån | 100 GB-timmar | $0.05/GB-timme |
| Team | $49/mån | 1 000 GB-timmar | $0.03/GB-timme |

**Konfiguration:**
- Kredittyp: Custom Unit ("GB-hours")
- Precision: 2 (två decimaler)
- Överföring: 50 % max, överförs en gång
- Överutnyttjande: Aktiverat med 200 % gräns
...
- **Börja enkelt**: Starta med en enda kredittyp och ingen överföring. Lägg till komplexitet baserat på kundåterkoppling och användningsmönster.
- **Sätt tydliga förväntningar**: Visa kreditallokeringar, återstående saldon och prissättning för överutnyttjande tydligt på produktsidor och kundportal.
- **Använd meningsfulla enheter**: Namnge krediter efter vad de representerar (t.ex. "API Calls", "AI Tokens") istället för generiska termer. Det hjälper kunder att förstå värdet.
- **Konfigurera utgångstid med eftertanke**: Kortare utgångsfönster (7 dagar) skapar brådska men kan frustrera kunder. Längre fönster (30–90 dagar) är mer kundvänliga för de flesta SaaS-produkter.
- **Övervaka låga saldon**: Sätt tröskelvärden för låga saldon för att varna kunder innan de tar slut, vilket minskar överraskande överutnyttjandeavgifter.
- **Testa i testläge**: Skapa krediter, koppla dem till testprodukter och simulera hela köp → användning → avdrag → utgång-cykeln innan du går live.

<Info>
Kreditbaserad fakturering fungerar sömlöst med alla andra Dodo Payments-funktioner – prenumerationer med provperioder, planändringar med proration och kundportalen. Börja med en grundläggande konfiguration och utöka i takt med att din prismodell utvecklas.
</Info>
