...
|------|----------|----------|
| `difference_immediately` | Debiterar prisskillnaden direkt ($30→$80 = $50) | Enkla uppgraderingar |
| `prorated_immediately` | Debiterar baserat på återstående tid i faktureringscykeln | Rättvis tidsbaserad fakturering |
| `full_immediately` | Debiterar hela priset för den nya planen och bortser från återstående tid | Faktureringscykeln återställs |
| `do_not_bill` | Tillämpa planändringen utan någon omedelbar debitering; den nya planen faktureras vid nästa förnyelse och det ursprungliga faktureringsdatumet bevaras | Uppgraderingar som goodwill och kostnadsfria migreringar |
