...
- **Flexibla rabatter**: Procentbaserade rabatter
- **Staplingsbara koder**: Tillämpa upp till 20 koder per kassatransaktion, betalning eller prenumeration — kombinera kampanjer (t.ex. `WELCOME10` + `BLACKFRIDAY20`) utan att skapa specialkoder
...
- **Rabattnamn** (obligatoriskt): Intern och instrumentpanelsvisningsnamn
- **Kod** (obligatoriskt): Strängen som kunder anger vid kassan
- **Typ & Belopp** (obligatoriskt): Ange ett procentvärde (endast procentbaserade rabatter stöds för närvarande), eller generera en slumpmässig kod med den angivna knappen
- **Utgångsdatum** (valfritt): Datum efter vilket koden blir ogiltig
- **Användningsbegränsning** (valfritt): Maximal antal inlösningar för alla kunder
- **Produktbegränsning** (valfritt): Begränsa användbarheten till utvalda produkter
- **Prenumerationscykelbegränsning** (valfritt): Antal faktureringscykler som rabatten gäller för
- **Metadata** (valfritt): Bifoga anpassade nyckel–värdepar för intern spårning eller integrationer
