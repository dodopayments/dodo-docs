...
3. **Välj ditt svar**
   - Du kan antingen acceptera eller motsätta tvisten
...
5. **Om du motsätter dig**
   - Förbered dig för att lämna in bevis
...
<Info>
Du har **10 dagar** på dig att svara på en tvist efter att den har skapats. Nedräkningen som visas för tvisten i din instrumentpanel återspeglar samma tidsfönster.
</Info>
...
<Frame caption="Visa RDR configuration in the Dodo Payments dashboard">
    <img src="/images/disputes/rdr.png" alt="Visa RDR-inställningar som visar den aktiverade växeln och tröskelkonfigurationen" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Step title="Open the Disputes Settings">
    Navigera till **Inställningar → Företag** i din Dodo Payments-instrumentpanel och leta efter avsnittet **Visa Rapid Dispute Resolution (RDR)**.
</Step>
