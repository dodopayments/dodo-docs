...
En Team Pro-prenumeration kostar \$99/månad och inkluderar 5 platser. Om du har fler än 5 användare betalar du ytterligare \$15/månad för varje extra plats.

Till exempel, om ditt team behöver 15 platser:
- Basplan: \$99/månad (inkluderar 5 platser)
...
<CardGroup cols={2}>
<Card title="Seat-Based Pricing Tutorial" icon="code" href="/developer-resources/seat-based-pricing">
  Fullständig implementeringsguide med kod.
</Card>
...
<Card title="Plan Changes & Proration" icon="arrows-rotate" href="/developer-resources/subscription-upgrade-downgrade">
  Hantera ändringar av prenumerationer.
</Card>
