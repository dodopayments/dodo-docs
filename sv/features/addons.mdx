...
Använd `POST /addons`-ändpunkten för att skapa nya tillägg med anpassad prissättning, beskrivningar och konfigurationsalternativ.
...
Ändra befintliga tillägg med `PATCH /addons/{id}`-ändpunkten för att uppdatera prissättning, beskrivningar eller tillgänglighet.
...
Uppdatera tilläggsbilder med `PUT /addons/{id}/images`-ändpunkten för bättre produktpresentation.
