...
1. Kunden slutför köpet.
2. Dodo Payments skapar ett grant med statusen `Pending` och en `oauth_url` som kunden kan använda för att länka sitt GitHub-konto.
3. Kunden godkänner via länken i sitt e-postmeddelande eller i kundportalen.
4. Dodo Payments bjuder in kundens GitHub-konto till repot med den konfigurerade behörigheten. Grantet övergår till `Delivered` när inbjudan har skapats.
