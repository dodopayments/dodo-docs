...
Skapa en betalningssession med `we_chat_pay` i de tillåtna betalningsmetoderna.
</Step>
...
**Kontrollera:**
1. `we_chat_pay` inkluderas i `allowed_payment_method_types`?
2. Är faktureringsvalutan satt till USD eller CNY?
3. Uppfyller transaktionsbeloppet minimum?
