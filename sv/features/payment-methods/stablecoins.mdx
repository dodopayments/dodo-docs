...
| Typ | Metod | Land |
| :--- | :----- | :------ |
| `crypto_currency` | Stablecoins | Global (Exkl. IN) |
...
Skapa en checkout-session med `crypto_currency` i de tillåtna betalningsmetoderna.
</Step>
...
**Kontrollera:**
1. `crypto_currency` inkluderad i `allowed_payment_method_types`?
