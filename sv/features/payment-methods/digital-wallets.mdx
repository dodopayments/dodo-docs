...
Filnamnet måste vara tillgängligt utan omdirigeringar och serveras med `Content-Type: application/octet-stream` eller `text/plain`.
</Step>

<Step title="Begär aktivering">
Email **support@dodopayments.com** med:
...
<Warning>
Apple Pay kräver HTTPS. Det kommer inte att visas på `localhost` utan korrekt SSL-konfiguration.
</Warning>
...
<Accordion title="Inkludera alltid kortalternativ">
...
2. Använder HTTPS?
3. Enheten har iOS 17+ / Safari 17+ / iPadOS 17+?
