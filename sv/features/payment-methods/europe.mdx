...
sidebarTitle: Europe
description: Acceptera iDEAL, Bancontact, EPS, Multibanco och Przelewy24 för att
  öka konverteringsgraden på europeiska marknader. Lär dig om regional
...
- `AT` för EPS
- `PT` för Multibanco
- `PL` för Przelewy24 (med faktureringsvaluta i PLN)
</Step>
...
De flesta europeiska betalningsmetoder kräver EUR — se till att din prissättning stödjer Euro-transaktioner. Undantaget är Przelewy24, som endast erbjuds med **PLN** (polska złoty) fakturering.
</Accordion>

<Accordion title="Handle redirects gracefully">
Alla europeiska metoder involverar omdirigeringar till banksajter. Se till att din hantering av retur-URL:er är robust och hanterar användare som avbryter mitt i flödet.
</Accordion>

<Accordion title="Provide card fallbacks">
Inte alla europeiska kunder har tillgång till dessa regionala metoder (turister, expats, etc.). Inkludera alltid `credit` och `debit` som backup.
</Accordion>

<Accordion title="Consider Multibanco timing">
Multibanco bankomatbetalningar kan ta timmar att slutföra. Blockera inte leveransen på omedelbar betalning — använd webhooks för asynkron bekräftelse.
</Accordion>
</AccordionGroup>
...
2. Valutan inställd på EUR?
3. Metoden inkluderad i `allowed_payment_method_types`?

**Lösning:** Europeiska metoder är strikt regionala. En kund med faktureringsland `DE` (Tyskland) kommer inte att se iDEAL, som endast är för Nederländerna.
</Accordion>
...
**Lösning:** Kunden bör försöka igen. Om det är ihållande, föreslå att försöka en annan betalningsmetod.
</Accordion>

<Accordion title="Redirect not completing">
**Orsaker:**
- Kunden stängde webbläsaren under bankomdirigering
- Nätverksproblem under autentisering
- Felkonfigurerad retur-URL

**Lösning:** Verifiera att retur-URL är korrekt och tillgänglig. Se till att den hanterar både framgångs- och felmeddelanden.
</Accordion>

<Accordion title="Multibanco payment pending">
**Orsak:** Kunden har fått betalningsreferens men har inte betalat ännu.

**Lösning:** Detta är förväntat för betalningar baserade på bankomat. Vänta på webhook-bekräftelse. Referensen löper vanligtvis ut inom 24-72 timmar.
</Accordion>
</AccordionGroup>
