...
| Nivå | Var det ställs in | Omfattning |
|-------|-------------------|------------|
| **Per begäran** | `mandate_min_amount_inr_paise` på en checkout-session eller prenumeration | En transaktion |
| **Handlare** | Företagsinställningar | Alla dina INR-prenumerationer |
| **System** | — | ₹15 000 som standardvärde |
