...
sidebarTitle: Indien
description: Acceptera UPI och alla Indiska utfärdade kort i Indien med
  RBI-kompatibla prenumerationsmandat. Förstå 48-timmars behandlingsfördröjning,
...
keywords:
  ...
  - INR
  - betalningsmetoder
  - indiska betalningsmetoder
---

Indien har en unik betalningsinfrastruktur dominerad av UPI (60 % av digitala transaktioner) och Indiska utfärdade kort (Visa, Mastercard, Rupay, etc.). Dodo Payments stöder alla dessa med full RBI-kompatibilitet för prenumerationsmandat.
...
Till skillnad från de flesta alternativa betalningsmetoder, stöder UPI och alla Indiska utfärdade kort (Visa, Mastercard, Rupay, etc.) återkommande betalningar via RBI-mandat.
</Card>
</CardGroup>
...
*Prenumerationer kräver RBI-kompatibla mandat med särskilda behandlingsregler. 48-timmars behandlingsfördröjning gäller för alla Indiska utfärdade kort och UPI.
...
<Accordion title="Payment deduction delayed beyond 48 hours">
**Orsak:** Förseningar i bankens API kan förlänga bearbetningen med 2-3 ytterligare timmar.

**Lösning:** Detta förväntas. Utforma ditt system för att hantera varierande förseningar på upp till ~51 timmar totalt.
</Accordion>

<Accordion title="Mandate cancelled but subscription still active">
**Orsak:** Kantfall i RBI-regler — mandatavbokning under behandlingsfönstret avbryter inte omedelbart prenumerationen.

**Lösning:** Nästa debitering kommer att misslyckas och prenumerationen kommer att gå till `on_hold`. Övervaka webhooks för `payment.failed`.
</Accordion>
</AccordionGroup>
...
<Card title="Subscriptions" icon="repeat" href="/features/subscription">
Komplett prenumerationsdokumentation inklusive RBI-mandat.
</Card>

<Card title="Webhooks" icon="webhook" href="/developer-resources/webhooks">
Webhook-hantering för betalningshändelser.
</Card>
