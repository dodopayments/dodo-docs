...
**Lösningar**:
1. Verifiera att händelseinkapslingen fungerar (kontrollera API-svar)
2. Bekräfta att `customer_id` matchar abonnemangskunden
3. Kontrollera att `event_name` matchar mätarkonfigurationen
4. Verifiera att händelser har korrekta tidsstämplar (inte framtida datum)
</Accordion>
...
2. Kommunicera att proportionering gäller både abonnemang OCH tillägg
