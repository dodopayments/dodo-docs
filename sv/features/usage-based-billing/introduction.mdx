...
keywords:
  ...
  - användnings baserad fakturering
---
...
<Frame>
<img src="/images/usage-based/UBB-2.png" alt="Skapa mätargränssnitt" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/usage-based/UBB-4.png" alt="Prisinställningar" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
Istället för att ta betalt per enhet i dollar kan du konfigurera mätare så att de drar från en kunds [kreditbalans](/features/credit-based-billing). Krediter uppdateras varje faktureringsperiod och tillämpas före eventuella överagesavgifter.
...
<Frame>
<img src="/images/usage-based/UBB-5.png" alt="Lägga till mätare till produkt" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/guides/usage-based-billing/meter-quantities-chart.png" alt="Mätarinstrumentpanel" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
