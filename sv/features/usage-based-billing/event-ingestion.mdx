...
Händelsetyp som matchar din meters händelsenamn (skiftlägeskänslig). Exempel: `api.call`, `image.generated`
</ParamField>
</Accordion>
...
Ytterligare egenskaper för aggregation och filtrering:
...
Kontrollera att API-nyckeln är korrekt och använd format: `Bearer YOUR_API_KEY`
</Accordion>

<Accordion title="Valideringsfel (400)">
Se till att alla obligatoriska fält är närvarande: `event_id`, `customer_id`, `event_name`
</Accordion>

<Accordion title="Metadata aggregeras inte">
- Metadata-nycklar måste matcha meterens "Över egenskap" exakt
