...
ISO 8601-tidsstämpel (UTC). Använd aktuell servertid som standard om den utelämnas. Inkludera den för korrekt debitering vid fördröjda händelser eller batchhändelser. Tidsstämplar som är äldre än 1 timme eller ligger mer än 5 minuter framåt i tiden avvisas.
</ParamField>
...
<Tip>
Samla upp till 1 000 händelser per begäran för bättre prestanda. API:et har en strikt gräns på 1 000 händelser per anrop.
</Tip>
