...
<Steps>
  ...
  <Step title="Lägg till spårningsscriptet">
    ...
    Detta skript:
    - Spårar affiliatebesök
    - Sätter en cookie med referens-ID:t (`affonso_referral`)
    - Möjliggör registrering och betalningsspårning
  ...
  <Step title="Testa din integration">
    ...
    **Testchecklista:**
    ...
    - ✅ Kontrollera att Affonso-skriptet laddas och att `affonso_referral`-cookien sätts
    - ✅ Genomför en registrering (valfritt)
    - ✅ Genomför en betalning via Dodo Payments
...
2. **Fånga Dub klick-ID** (`dub_id`-cookien) vid skapande av kassan
