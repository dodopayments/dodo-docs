...
| `fields` | object | Nej | Objekt med fältnamn/värdena |
...
| `groups` | array | Nej | Array av grupp-ID:n för att lägga till prenumerant i |
| `status` | string | Nej | En av: aktiv, avbeställd, okonfirmerad, studsad, skräp |
| `subscribed_at` | string | Nej | Datum i format `yyyy-MM-dd HH:mm:ss` |
