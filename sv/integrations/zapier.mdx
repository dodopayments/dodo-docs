...
<Step title="Open the Webhook Section">
  I din Dodo Payments-instrumentpanel, navigera till <b>Webhooks → + Lägg till slutpunkt</b> och expandera integrationsmenyn.
  <Frame>
    <img src="/images/integrations/zapier.png" alt="Lägg till slutpunkt och integrationsmeny" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
