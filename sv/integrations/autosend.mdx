...
<Step title="Open Webhook Section">
  Navigera till avsnittet Webhooks i din Dodo Payments-instrumentpanel.
  
  <Frame>
    <img src="/images/integrations/autosend.png" alt="Lägg till slutpunkt och integrationsrullgardinsmeny" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
