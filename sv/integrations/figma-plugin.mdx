...
<Steps>
<Step title="Skapa Grundplugin">
Skapa ditt eget Figma-pluginprojekt med hjälp av [Figma's plugin snabbstartsguide](https://www.figma.com/plugin-docs/plugin-quickstart-guide/). Detta kommer att generera ett skal med en `manifest.json`-fil.
...
<Note>
Den `Authenticated.tsx`-komponenten är där du lägger till dina plugins premiumfunktioner som kräver en giltig licens.
</Note>
</Step>
</Steps>
...
3. Följ [Figma's plugin publiceringsriktlinjer](https://www.figma.com/plugin-docs/publishing-plugins/)
