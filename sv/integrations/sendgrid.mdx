...
<Step title="Open the Webhook Section">
  Gå till <b>Webhooks → + Lägg till slutpunkt</b> i din Dodo Payments-instrumentpanel och expandera rullgardinsmenyn för integrationer.
  <Frame>
    <img src="/images/integrations/sendgrid.png" alt="Lägg till slutpunkt och integrationsrullgardinsmeny" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
