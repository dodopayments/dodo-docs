...
<Step title="Open the Webhook Section">
  I din Dodo Payments-instrumentpanel, navigera till <b>Webhooks → + Lägg till Endpoint</b> och expandera integrationsmenyn.
  <Frame>
    <img src="/images/integrations/loops.png" alt="Lägg till Endpoint och integrationsmeny" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
