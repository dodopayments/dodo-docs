...
<Step title="Open the Webhook Section">
  I din Dodo Payments-instrumentpanel, öppna <b>Webhooks → + Lägg till slutpunkt</b> och expandera rullgardinsmenyn för att visa integrationer.
  <Frame>
    <img src="/images/integrations/discord.png" alt="Lägg till slutpunkt och integrationers rullgardinsmeny" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
...
function handler(webhook) {
  if (webhook.eventType.startsWith("dispute.")) {
    ...
    webhook.payload = {
      embeds: [{
        title: d.dispute_status === "dispute_won" ? "🏆 Dispute Won" : d.dispute_status === "dispute_lost" ? "❌ Dispute Lost" : "🚨 Dispute Update",
        fields: [
        ...
        color: d.dispute_status === "dispute_won" ? 0x2ecc71 : d.dispute_status === "dispute_lost" ? 0xe74c3c : 0xe67e22
      }]
    };
  }
  return webhook;
