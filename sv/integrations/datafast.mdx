...
<Step title="Open the Webhook Section">
  På din Dodo Payments-instrumentpanel, navigera till <b>Webhooks → + Lägg till slutpunkt</b> och expandera rullgardinsmenyn för integrationer.
  <Frame>
    <img src="/images/integrations/datafast/add.png" alt="Lägg till slutpunkt och dropdown för integrationer" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
...
<Step title="Enter API Key">
  ...
  <Frame>
    <img src="/images/integrations/datafast/api-key.png" alt="Lägg till API-nyckel" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
