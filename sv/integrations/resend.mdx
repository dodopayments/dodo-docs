...
keywords:
  - Dodo Payments
  - Skicka igen
  - transaktionellt e-postmeddelande
  - e-post-API
---
...
<Step title="Open the Webhook Section">
  ...
  <Frame>
    <img src="/images/integrations/resend.png" alt="Lägg till slutpunkt och rullgardinsmenyn för integrationer" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
