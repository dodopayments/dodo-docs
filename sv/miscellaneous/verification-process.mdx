...
<Frame>
  <img src="/images/tax-forms/W8 - BEN - PLC - SAMPLE - 1.png" alt="W-8 BEN-E Private Limited Exempelsida 1" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>

**Page 2**

<Frame>
  <img src="/images/tax-forms/W8 - BEN - PLC - SAMPLE - 2.png" alt="W-8 BEN-E Private Limited Exempelsida 2" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>

**Page 8**

<Frame>
  <img src="/images/tax-forms/W8 - BEN - PLC - SAMPLE - 8.png" alt="W-8 BEN-E Private Limited Exempelsida 8" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Accordion>
...
<Frame>
  <img src="/images/tax-forms/W8 - BEN - LLP SAMPLE - 1.png" alt="W-8 BEN-E LLP Exempelsida 1" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>

**Page 2**

<Frame>
  <img src="/images/tax-forms/W8 - BEN - LLP SAMPLE - 2.png" alt="W-8 BEN-E LLP Exempelsida 2" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>

**Page 8**

<Frame>
  <img src="/images/tax-forms/W8 - BEN - PLC - SAMPLE - 8.png" alt="W-8 BEN-E LLP Exempelsida 8" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Accordion>
</AccordionGroup>
...
<Frame>
  <img src="/images/payouts/payout-activation2.png" alt="Konto Aktiverat" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
## Insändande av dokument på nytt

Om det finns problem med dokumenten som skickades in under onboardingprocessen kan Dodo Payments Verification Team begära att du skickar in specifika dokument igen.

Du kan skicka in dokument på nytt med alternativet **skicka in på nytt** i din instrumentpanel.

### När kan du skicka in dokument på nytt?

- **Saknad eller ofullständig information**: Om viktiga uppgifter som identifikationsnummer, företagsnamn eller annan viktig data saknas.
- **Dokumentfel**: När de inskickade dokumenten inte matchar de angivna företags- eller personuppgifterna.
- **Oläsbara eller utgångna dokument**: Om de uppladdade dokumenten är otydliga, oläsbara eller har gått ut.
...
### Hur man skickar in dokument på nytt

<Steps>
<Step title="Check your dashboard">
Kontrollera din Dodo Payments-instrumentpanel för en begäran om återinsändning (du kommer också att få ett e-postmeddelande om återinsändning krävs).
</Step>

<Step title="Access the resubmit option">
Verifieringsteamet kommer att aktivera alternativet **Skicka in på nytt**, vilket gör att du kan ladda upp nya dokument.
</Step>

<Step title="Upload correct documents">
Navigera till **Verifieringssektionen** i instrumentpanelen och ladda upp rätt dokument.
</Step>
...
<CardGroup cols={2}>
  <Card
    ...
    href="/miscellaneous/merchant-acceptance"
  >
    Granska våra omfattande godkännandestandarder, inklusive stödda och förbjudna produkter, och se till att ditt företag är berättigat till onboarding.
  </Card>
  <Card
    title="Review Monitoring Policy"
    icon="magnifying-glass"
    href="/miscellaneous/review-monitoring-policy"
  >
    Förstå hur löpande efterlevnad övervakas, lär dig om triggers för dokumentgranskning, och håll dig proaktiv med din kontostatus.
  </Card>
</CardGroup>
