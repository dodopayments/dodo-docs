...
<Accordion title="Test regional methods with correct addresses">
Regionala betalningsmetoder (UPI, iDEAL, etc.) kräver matchande fakturaadresser. En amerikansk fakturaadress visar inte iDEAL.
</Accordion>

<Accordion title="Verify minimum amounts">
BNPL-metoder kräver minst $50,01. Testa att de visas/göms korrekt beroende på varukorgens total.
</Accordion>
</AccordionGroup>
