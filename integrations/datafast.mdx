---
title: "Datafast"
description: "Send transactional emails through Datafast based on Dodo Payments events with high deliverability."
icon: "envelope"
---

## Introduction

Send professional transactional emails automatically when payment events occur. Deliver payment confirmations, subscription updates, and important notifications with Datafast's reliable email infrastructure and excellent deliverability rates.

<Info>
This integration requires your Datafast API Key for authentication.
</Info>
...
<Step title="Open the Webhook Section">
  ...
  <Frame>
    <img src="/images/integrations/datafast.png" alt="Add Endpoint and integrations dropdown" />
  </Frame>
</Step>
...
<Step title="Enter API Key">
  Provide your Datafast API Key in the configuration.
</Step>

<Step title="Configure Transformation">
  Edit the transformation code to format emails for Datafast's API.
</Step>
...
<Step title="Done!">
  🎉 Payment events will now automatically trigger transactional emails via Datafast.
</Step>
</Steps>
...
function handler(webhook) {
  if (webhook.eventType === "payment.succeeded") {
    ...
    webhook.url = "https://api.datafast.com/emails";
    webhook.payload = {
...
- Check that sender domain is verified in Datafast
- Ensure recipient email addresses are valid
- Review Datafast sending limits and quotas
</Accordion>

<Accordion title="Transformation errors">
- Validate JSON structure matches Datafast API format
