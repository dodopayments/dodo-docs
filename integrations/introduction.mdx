...
<CardGroup cols={2}>
  ...
  <Card title="AutoSend" icon="message" href="/integrations/autosend">
...
- **Email Services**: Automate transactional emails and customer communication with Resend, SendGrid, Customer.io, Loops, and AutoSend
