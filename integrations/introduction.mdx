...
icon: "book"
keywords: ["Dodo Payments", "integrations", "third-party apps", "automation", "workflow", "external integrations"]
---
...
<CardGroup cols={2}>
  ...
  <Card title="GoHighLevel" icon="link" href="/integrations/gohighlevel">
    Sell through GoHighLevel funnels and websites using Dodo Payments payment links, overlay checkout, or inline checkout, then automate fulfillment with webhooks.
  </Card>
  ...
  <Card title="ParityDeals" icon="globe" href="/integrations/paritydeals">
    Show a location-based discount banner on your own website and let ParityDeals generate the matching Dodo Payments discount codes.
  </Card>
  <Card title="Evendeals" icon="tags" href="/integrations/evendeals">
    Sync location-based discount coupons into Dodo Payments automatically, with rotation rules that keep codes from being shared.
  </Card>
</CardGroup>

<Note>
Dodo Payments already prices by country natively. [Purchasing Power Parity](/features/purchasing-power-parity) and [Charm Pricing](/features/charm-pricing) apply at checkout with no banner, no script, and no coupon codes to manage. Reach for a pricing integration only when you specifically want a visible discount banner on your own site or seasonal campaigns.
</Note>
...
- **Email Services**: Automate transactional emails and customer communication with Resend, SendGrid, Customer.io, Loops, MailerLite, AutoSend, and Keplars
- **CRM & Sales**: Sync payment data and customer information with HubSpot, Close CRM, and GoHighLevel
...
- **Pricing**: Layer location-based discount campaigns on top of your prices with ParityDeals and Evendeals
