...
keywords: ["Dodo Payments", "Slack", "Slack notifications", "team messaging"]
---
...
- Choose colors that match the event type: green (`good`) for success, red (`danger`) for disputes or failures, yellow (`warning`) for cancellations, and blue (`#3aa3e3`) for informational events.
