...
<Step title="Create a Full-Access API Key">
  In your Dodo Payments dashboard, go to **Developer → API Keys** and create a key (name it "Rekomi"). See the [API key guide](/api-reference/introduction#api-key-management-and-authentication) for detailed instructions.
