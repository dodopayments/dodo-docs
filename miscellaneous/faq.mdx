...
<Accordion title="Q92: How do payouts work with Dodo Payments?">
  ...
  - **Bi-Weekly**: Payouts on the 4th, 7th, 11th, 14th, 18th, 21st, 25th, and 29th of each month (contact support to request)
  - **Tri-Weekly**: Payouts on every even day of the month — 2nd through 30th, up to 15 payout dates per month (contact support to request)
  - **Monthly**:
...
<Accordion title="Q108: Do you support daily payouts?">
  A: No, daily payouts are not available. The available payout cycles are bi-monthly (default), weekly, bi-weekly, and tri-weekly (for high-volume businesses, on request), and monthly. See full details: https://docs.dodopayments.com/features/payouts/payout-structure#payout-cycles
</Accordion>
