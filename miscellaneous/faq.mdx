...
<Accordion title="Q24: I submitted my W-8BEN form, but the signature section doesn't work properly. What do I do?">
...
<Accordion title="Q26: My verification was declined due to entity mismatch. What should I do?">
  ...
  Step 2: Contact support via Intercom or support email (support@dodopayments.com) to request resubmission access for the Payout Compliance form.
...
<Accordion title="Q27: Can I use a different name (like my parent's) to sign up and get verified?">
...
<Accordion title="Q28: How do I check the reason for verification rejection?">
...
<Accordion title="Q29: Can I create a new business account if my previous one was declined?">
  A: Yes — but only if:
...
<Accordion title="Q30: I've been told my account was previously deboarded. What does this mean?">
...
<Accordion title="Q31: How do I get my payout verification cleared faster?">
  A: To avoid delays:
...
<Accordion title="Q32: What if I chose the wrong form (W-8BEN vs W-8BEN-E)?">
...
<Accordion title="Q33: I have a GST with a trade name. Is that considered an organization?">
...
<Accordion title="Q34: My account was deboarded. Can I just create a new one?">
...
<Accordion title="Q35: How does Dodo Payments handle GST for Indian SaaS merchants?">
  A: Dodo Payments automatically calculates and applies **GST** for Indian merchants based on your customer's location.
</Accordion>

<Accordion title="Q36: Does Dodo Payments handle international sales?">
  A: Yes, Dodo Payments supports international sales and manages all associated compliances.
</Accordion>

<Accordion title="Q37: Are address data such as city, state, zipcode fields mandatory? Can I exclude requesting those values from my customer?">
...
<Accordion title="Q38: Do I need to file taxes in the US if I sell there?">
...
<Accordion title="Q39: I don't know whether to fill W-8BEN or W-8BEN-E — help?">
...
<Accordion title="Q40: Do I need a PAN or GST to receive payments?">
...
<Accordion title="Q41: I have a Udyam/MSME certificate. Should I submit W-8BEN or W-8BEN-E?">
...
<Accordion title="Q43: What types of payments can I accept with Dodo Payments?">
...
<Accordion title="Q44: Why was the first payment marked successful with an amount of $0 for subscription?">
...
<Accordion title="Q45: After the trial period ends, does the customer need to pay (product price(e.g $25)) again manually?">
...
<Accordion title="Q46: What if the trial period shows differently on my app vs. the Dodo Payments dashboard?">
...
<Accordion title="Q47: Do I need to test the trial feature before going live?">
...
<Accordion title="Q48: How can I track payment statuses?">
...
<Accordion title="Q49: What should I do if a payment fails?">
...
<Accordion title="Q50: Do merchants get notified when a user’s payment fails?">
...
<Accordion title="Q51: What happens to a subscription if a payment fails?">
...
<Accordion title="Q52: If I retry payments myself, do I need the failed payment ID?">
  A: No. You only need the subscription ID to initiate a new payment attempt.
</Accordion>

<Accordion title="Q53: How can a subscription payment fail with INCORRECT_NUMBER if previous cycles were successful?">
...
<Accordion title="Q54: Does the chargeback apply for business even if my business has a no refund policy?">
...
<Accordion title="Q55: Why is payment.status sometimes null?">
...
<Accordion title="Q56: Why is product_cart null even though it's a checkout in webhook payload?">
  A:
...
<Accordion title="Q57: Why was my real card blocked during testing?">
...
<Accordion title="Q58: My customer completed payment but I didn't receive webhook?">
  A: Checklist:
...
<Accordion title="Q59: Why is my dashboard showing success, but my app didn't update?">
...
<Accordion title="Q60: I'm not seeing UPI as a payment option — why?">
...
<Accordion title="Q61: Does Dodo support UPI for subscriptions?">
...
<Accordion title="Q62: How do I enable Google Pay / Apple Pay on static payment links?">
...
<Accordion title="Q63: How can I enable 3DS in Dodo Payments?">
...
<Accordion title="Q64: How do I collect billing details without passing them in API?">
...
<Accordion title="Q65: What's the difference between static and dynamic payment links?">
...
<Accordion title="Q66: Will I get two webhook events when someone starts a subscription?">
...
<Accordion title="Q67: What does subscription.cancelled_at mean? Is it a scheduled cancellation?">
...
<Accordion title="Q68: When does a subscription get charged?">
...
<Accordion title="Q69: Why does the Change Plan API return an empty response?">
...
<Accordion title="Q70: Why wasn't a new payment prompted when switching from a monthly to an annual plan?">
...
<Accordion title="Q71: Why does my product price (Rs 100) show a higher amount (Rs 104) during checkout?">
  A: This happens when Adaptive Currency is enabled. The feature adds an additional 4% charge automatically.
</Accordion>

<Accordion title="Q72: Why does checkout ignore existing active subscriptions and create a new one?">
...
<Accordion title="Q73: Why am I seeing a TRANSACTION_NOT_ALLOWED error during a subscription upgrade/downgrade?">
...
<Accordion title="Q74: Is there a way to test in live mode without making real payments?">
...
<Accordion title="Q75: What is the $0 payment method?">
...
<Accordion title="Q76: It seems my account appears to be suspended, but compliance says everything is fine. What should I do?">
...
<Accordion title="Q77: How do payouts work with Dodo Payments?">
...
<Accordion title="Q78: What is the minimum threshold amount after fees & taxes to process payouts?">
  A: The minimum payout threshold is **$50 USD** (or Rs 1,000 INR) after platform fees and taxes deduction. However, payouts are only initiated when the overall wallet balance across all currencies exceeds **$50 USD**. You can customize your USD wallet threshold to any amount **≥ $50** directly from your dashboard. If your balance doesn't meet the threshold, it will carry forward to the next payout cycle.
...
<Accordion title="Q79: How do I link my bank account to receive payouts?">
...
<Accordion title="Q80: Can I track the status of my payouts?">
  A: Yes, you can track your payout status from the **Payouts** section of the dashboard.
</Accordion>

<Accordion title="Q81: What are payout fees and how much are they?">
...
<Accordion title="Q82: I received a &quot;payout processed&quot; email — when will the funds arrive?">
...
<Accordion title="Q83: How do I add Payoneer as a payout account?">
...
<Accordion title="Q84: Can I receive payouts to a Payoneer account?">
...
<Accordion title="Q85: My bank info and compliance form are still in review — what should I do?">
...
<Accordion title="Q86: What happens if my payout day falls on a Friday or weekend?">
...
<Accordion title="Q87: How can I expedite payout compliance if I have an urgent launch or ad campaign planned?">
...
<Accordion title="Q88: I submitted the wrong bank account details. How do I update them?">
...
<Accordion title="Q89: Can I use my personal bank account if I have a registered company?">
  A: No. If you're registered as a company or legal entity, you must use the entity's bank account.
</Accordion>

<Accordion title="Q90: My country doesn't use SWIFT codes. How will that affect my verification?">
...
<Accordion title="Q91: What alternative documentation can I provide if my country doesn't use SWIFT codes?">
...
<Accordion title="Q92: Can I set a payout threshold lower than $50?">
...
<Accordion title="Q93: Does Dodo Payments generate invoices automatically?">
...
<Accordion title="Q94: Can I customize the invoices?">
...
<Accordion title="Q95: How do I access or download an invoice?">
...
<Accordion title="Q96: How do I view reports on my transactions and payouts?">
...
<Accordion title="Q97: How do I issue a refund?">
...
<Accordion title="Q98: How long does it take for a customer to receive their refund?">
...
<Accordion title="Q99: I'm facing a dispute or chargeback. What can I do?">
...
<Accordion title="Q100: The customer disputed the charge after using the service. Can I appeal this?">
  A: Yes — you can:
...
<Accordion title="Q101: How is proration calculated — on the product price or the total amount?">
...
<Accordion title="Q102: Why do we use the `subscription.renewed` webhook for the first subscription?">
...
<Accordion title="Q103: Can I manually verify Dodo Payments webhooks in Python?">
...
<Accordion title="Q104: Where can I find official docs on manual webhook verification?">
...
<Accordion title="Q105: My webhook isn't receiving a POST request, only a GET. Why?">
...
<Accordion title="Q106: I get a 401 Unauthorized error using the Python SDK. Why?">
...
<Accordion title="Q107: Is there a way to manually trigger a webhook event for testing?">
A: You can do it through the webhook dashboard. Go to Dashboard -> Developers -> Webhooks
</Accordion>

<Accordion title="Q108: What's the difference between webhook and redirect URL?">
A:
...
<Accordion title="Q109: Why didn't I receive the product id in the payment.succeeded webhook for a subscription product?">
...
<Accordion title="Q110: How do I verify the webhooks I receive are actually from dodo payments and not from any malicious actors?">
...
<Accordion title="Q111: Why am I receiving a subscription.renew webhook even for the first month payment?">
...
<Accordion title="Q112: How can I test webhooks locally?">
...
<Accordion title="Q113: Why is my webhook not being called after payment?">
...
<Accordion title="Q114: Is it safe to rely on status=success in URL query params?">
...
<Accordion title="Q115: Can I integrate Dodo Payments with my existing website or platform?">
...
<Accordion title="Q116: Why are my webhooks always failing?">
  A: Common causes:
...
<Accordion title="Q117: Can I test subscriptions in Test Mode?">
A: Yes — subscriptions can be tested fully in Test Mode.

Just don't use real card numbers.
</Accordion>

<Accordion title="Q118: How do I switch between Test and Live Mode?">
A:
...
<Accordion title="Q119: Can I use real customer data in Test Mode?">
...
<Accordion title="Q120: I'm getting: &quot;You must provide a mandate for off-session card payments&quot;">
A: It means:
...
<Accordion title="Q121: How do I contact support?">
...
<Accordion title="Q122: My support messages are getting no response. What should I do?">
...
<Accordion title="Q123: How does Dodo Payments protect my business from fraud?">
...
<Accordion title="Q124: Is my customer data secure with Dodo Payments?">
...
<Accordion title="Q129: Why am I getting an 'Invalid authorization details' error?">
  A: This usually happens when the 3D Secure (3DS) authentication fails or is not completed by the user.
</Accordion>


<Accordion title="Q130: Why am I getting an 'Authentication failure' error for payments?">
...
<Accordion title="Q131: I'm seeing a 500 internal_error (&quot;Internal Server Error&quot;) in test mode. How do I fix it?">
...
<Accordion title="Q132: Why am I getting payment_method_unsupported (&quot;mode not enabled for merchant&quot;) in test mode?">
...
<Accordion title="Q133: What does the requires_customer_action status mean?">
...
<Accordion title="Q134: Why am I getting a SUBSCRIPTION_NOT_ACTIVE error?">
...
<Accordion title="Q135: Why am I getting a payment failure with unknown_error?">
