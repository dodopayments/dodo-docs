...
<Accordion title="Q46: My verification is On-Hold — what does that mean?">
  A: On-Hold means our compliance team needs additional information or documents from you before it can finish the review. It is not a rejection.

  We email you to ask for additional verification and raise an additional verification form in the **Verification** section of your dashboard. Complete that form to move the review forward — the form you originally submitted stays locked, so your dashboard may show that resubmissions are temporarily paused. See [If a Form Is Placed On Hold](/miscellaneous/verification-process#if-a-form-is-placed-on-hold) for the full steps.

  If your dashboard shows a hold but no additional verification form, contact support@dodopayments.com with your registered email for clarification.
</Accordion>
...
<Accordion title="Q57: If I retry payments myself, do I need the failed payment ID?">
  A: No. You only need the subscription ID to initiate a new payment attempt. If you would rather not manage retries yourself, enable [Subscription Payment Retries](/features/recovery/payment-retries) to recover failed renewals automatically.
</Accordion>
