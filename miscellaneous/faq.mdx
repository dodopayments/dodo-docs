...
<Accordion title="Q74: Why does the Change Plan API return a response with only null fields?">
  A: The Change Plan API returns a 200 status code with a body containing `payment_id`, `payment_link`, `client_secret`, and `expires_on`. For a standard plan change, where the saved card is charged, all four are `null` — so the response looks empty even though the plan change succeeded. Confirm the outcome with webhook events such as `subscription.plan_changed`, or by re-reading the subscription.
</Accordion>
...
<Accordion title="Q114: Can I change the billing address on my invoice?">
...
<Accordion title="Q115: If I change the billing address, will it update all my existing invoices?">
...
<Accordion title="Q116: How do I issue a refund?">
...
<Accordion title="Q117: How long does it take for a customer to receive their refund?">
...
<Accordion title="Q118: I'm facing a dispute or chargeback. What can I do?">
...
<Accordion title="Q119: The customer disputed the charge after using the service. Can I appeal this?">
  A: Yes — you can:
...
<Accordion title="Q120: Why is my refund failing with an 'insufficient funds' error?">
...
<Accordion title="Q121: How is proration calculated — on the product price or the total amount?">
...
<Accordion title="Q122: Why do we use the `subscription.renewed` webhook for the first subscription?">
...
<Accordion title="Q123: Can I manually verify Dodo Payments webhooks in Python?">
...
<Accordion title="Q124: Where can I find official docs on manual webhook verification?">
...
<Accordion title="Q125: My webhook isn't receiving a POST request, only a GET. Why?">
...
<Accordion title="Q126: I get a 401 Unauthorized error using the Python SDK. Why?">
...
<Accordion title="Q127: Is there a way to manually trigger a webhook event for testing?">
A: You can do it through the webhook dashboard. Go to Dashboard -> Developers -> Webhooks
</Accordion>

<Accordion title="Q128: What's the difference between webhook and redirect URL?">
A:
...
<Accordion title="Q129: Why didn't I receive the product id in the payment.succeeded webhook for a subscription product?">
...
<Accordion title="Q130: How do I verify the webhooks I receive are actually from dodo payments and not from any malicious actors?">
...
<Accordion title="Q131: Why am I receiving a subscription.renewed webhook even for the first month payment?">
...
<Accordion title="Q132: How can I test webhooks locally?">
...
<Accordion title="Q133: Why is my webhook not being called after payment?">
...
<Accordion title="Q134: Is it safe to rely on status=success in URL query params?">
...
<Accordion title="Q135: Can I integrate Dodo Payments with my existing website or platform?">
...
<Accordion title="Q136: Why are my webhooks always failing?">
  A: Common causes:
...
<Accordion title="Q137: Where do I find my API key?">
...
<Accordion title="Q138: What are the base URLs for the Dodo Payments API?">
...
<Accordion title="Q139: Can I test subscriptions in Test Mode?">
A: Yes — subscriptions can be tested fully in Test Mode.

Just don't use real card numbers.
</Accordion>

<Accordion title="Q140: How do I switch between Test and Live Mode?">
A:
...
<Accordion title="Q141: Can I use real customer data in Test Mode?">
...
<Accordion title="Q142: Can I advance the next billing date in test mode?">
...
<Accordion title="Q143: Why don't I receive emails in Test Mode?">
...
<Accordion title="Q144: How do I contact support?">
...
<Accordion title="Q145: My support messages are getting no response. What should I do?">
...
<Accordion title="Q146: How do I unsubscribe a customer from Dodo Digest emails?">
  A: Share the customer's email address with us via Intercom and we'll unsubscribe them from our end.
</Accordion>

## Security & Fraud Prevention

<Accordion title="Q147: How does Dodo Payments protect my business from fraud?">
...
<Accordion title="Q148: Is my customer data secure with Dodo Payments?">
...
<Accordion title="Q149: I found a security vulnerability in Dodo Payments. How should I report it?">
A: Please report any discovered vulnerabilities directly to our security team at pt-team@dodopayments.com
</Accordion>

<Accordion title="Q150: Does Dodo Payments offer bug bounties?">
A: We currently do not offer monetary bounties, but we do provide Dodo Payments merchandise as a token of appreciation.
</Accordion>

<Accordion title="Q151: How are customers protected from fraud on Dodo Payments?">
...
<Accordion title="Q152: Why is my payment status showing 'Not Initiated'?">
  A: This means the payment link was created, but the user never opened the payment page or attempted the payment.
</Accordion>

<Accordion title="Q153: Why is my payment status showing 'Requires Payment Method'?">
...
<Accordion title="Q154: Why am I getting an 'Invalid authorization details' error?">
  A: This usually happens when the 3D Secure (3DS) authentication fails or is not completed by the user.
</Accordion>


<Accordion title="Q155: Why am I getting an 'Authentication failure' error for payments?">
...
<Accordion title="Q156: I'm seeing a 500 INTERNAL_SERVER_ERROR (&quot;Internal Server Error&quot;) in test mode. How do I fix it?">
...
<Accordion title="Q157: Why am I getting PAYMENT_METHOD_UNSUPPORTED (&quot;mode not enabled for merchant&quot;) in test mode?">
...
<Accordion title="Q158: What does the requires_customer_action status mean?">
...
<Accordion title="Q159: Why am I getting a SUBSCRIPTION_NOT_ACTIVE error?">
...
<Accordion title="Q160: Why am I getting a payment failure with UNKNOWN_ERROR?">
...
<Accordion title="Q161: I'm getting: &quot;You must provide a mandate for off-session card payments&quot;">
  A: It means:
...
<Accordion title="Q162: Is the customer portal tied to a specific customer?">
...
<Accordion title="Q165: Can I integrate Dodo Payments in an Android or mobile app?">
...
<Accordion title="Q166: How do I find my live publishable key (pk_live_...)?">
...
<Accordion title="Q167: Does Dodo Payments support WooCommerce blocks (WordPress block editor)?">
...
<Accordion title="Q168: Why can't I see the upgrade/downgrade button in my customer portal?">
...
<Accordion title="Q169: How many discount codes can be applied in one checkout?">
...
<Accordion title="Q170: How do I change my login email?">
...
<Accordion title="Q171: Why am I getting the business_id as my brand_id?">
...
<Accordion title="Q172: What are the limitations when adding Notion content?">
