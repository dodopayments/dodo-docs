...
<Accordion title="Q10: How do I get live mode access?">
  A: Once your account is created, you will automatically get access to live mode.
</Accordion>

<Accordion title="Q11: Does Dodo Payments have an affiliate program?">
...
<Accordion title="Q12: How can I delete the products/customers that I have created?">
...
<Accordion title="Q13: How can I have a custom UI for the payments page?">
...
<Accordion title="Q14: Can I update the branding on the checkout page?">
  A: Yes. You can:
...
<Accordion title="Q15: Can I embed Dodo Checkout in an iframe?">
...
<Accordion title="Q16: Can I create a one-time hosted checkout payment without adding products to Dodo Payments?">
  A: No. Products are mandatory in the Dodo Payments system.
</Accordion>

<Accordion title="Q17: Do you support e-commerce websites?">
  A: No, we do not support e-commerce websites.
</Accordion>

<Accordion title="Q18: Can I switch between brands in Dodo Payments?">
...
<Accordion title="Q19: Can I delete a brand or update the Brand URL in Dodo Payments?">
...
<Accordion title="Q20: Can I integrate Dodo Payments with Shopify to sell physical products?">
  A: No, Dodo Payments currently does not support physical goods and does not offer a Shopify plugin.
</Accordion>
<Accordion title="Q21: My INR subscription product is showing USD on checkout. How do I fix that?">
...
<Accordion title="Q22: Why is my verification taking so long?">
...
<Accordion title="Q23: I submitted my W-8BEN form, but the signature section doesn't work properly. What do I do?">
...
<Accordion title="Q25: My verification was declined due to entity mismatch. What should I do?">
...
<Accordion title="Q31: What if I chose the wrong form (W-8BEN vs W-8BEN-E)?">
...
<Accordion title="Q32: I have a GST with a trade name. Is that considered an organization?">
...
<Accordion title="Q33: My account was deboarded. Can I just create a new one?">
...
<Accordion title="Q34: How does Dodo Payments handle GST for Indian SaaS merchants?">
  A: Dodo Payments automatically calculates and applies **GST** for Indian merchants based on your customer's location.
</Accordion>

<Accordion title="Q35: Does Dodo Payments handle international sales?">
  A: Yes, Dodo Payments supports international sales and manages all associated compliances.
</Accordion>

<Accordion title="Q36: Are address data such as city, state, zipcode fields mandatory? Can I exclude requesting those values from my customer?">
...
<Accordion title="Q37: Do I need to file taxes in the US if I sell there?">
...
<Accordion title="Q38: I don't know whether to fill W-8BEN or W-8BEN-E — help?">
...
<Accordion title="Q39: Do I need a PAN or GST to receive payments?">
...
<Accordion title="Q40: I have a Udyam/MSME certificate. Should I submit W-8BEN or W-8BEN-E?">
...
<Accordion title="Q41: If Dodo handles taxes, why do I need to file W-8BEN(-E)?">
...
<Accordion title="Q42: What types of payments can I accept with Dodo Payments?">
...
<Accordion title="Q43: Why was the first payment marked successful with an amount of $0 for subscription?">
...
<Accordion title="Q44: After the trial period ends, does the customer need to pay (product price(e.g $25)) again manually?">
...
<Accordion title="Q45: What if the trial period shows differently on my app vs. the Dodo Payments dashboard?">
...
<Accordion title="Q46: Do I need to test the trial feature before going live?">
...
<Accordion title="Q47: How can I track payment statuses?">
...
<Accordion title="Q48: What should I do if a payment fails?">
...
<Accordion title="Q49: Do merchants get notified when a user’s payment fails?">
...
<Accordion title="Q50: What happens to a subscription if a payment fails?">
...
<Accordion title="Q51: If I retry payments myself, do I need the failed payment ID?">
  A: No. You only need the subscription ID to initiate a new payment attempt.
</Accordion>

<Accordion title="Q52: How can a subscription payment fail with INCORRECT_NUMBER if previous cycles were successful?">
...
<Accordion title="Q53: Does the chargeback apply for business even if my business has a no refund policy?">
...
<Accordion title="Q54: Why is payment.status sometimes null?">
...
<Accordion title="Q55: Why is product_cart null even though it's a checkout in webhook payload?">
  A:
...
<Accordion title="Q56: Why was my real card blocked during testing?">
...
<Accordion title="Q57: My customer completed payment but I didn't receive webhook?">
  A: Checklist:
...
<Accordion title="Q58: Why is my dashboard showing success, but my app didn't update?">
...
<Accordion title="Q59: I'm not seeing UPI as a payment option — why?">
  ...
  Note: If you are a non-Indian merchant or Adaptive Currency is not enabled, UPI will not be available for your customers.
  Note: If you are a non-Indian merchant or Adaptive Currency is not enabled, UPI will not be available for your customers.
</Accordion>

<Accordion title="Q60: Does Dodo support UPI for subscriptions?">
...
<Accordion title="Q61: How do I enable Google Pay / Apple Pay on static payment links?">
...
<Accordion title="Q62: How can I enable 3DS in Dodo Payments?">
...
<Accordion title="Q63: How do I collect billing details without passing them in API?">
...
<Accordion title="Q64: What's the difference between static and dynamic payment links?">
...
<Accordion title="Q65: Will I get two webhook events when someone starts a subscription?">
...
<Accordion title="Q66: What does subscription.cancelled_at mean? Is it a scheduled cancellation?">
...
<Accordion title="Q67: When does a subscription get charged?">
...
<Accordion title="Q68: Why does the Change Plan API return an empty response?">
...
<Accordion title="Q69: Why wasn't a new payment prompted when switching from a monthly to an annual plan?">
...
<Accordion title="Q71: Why does checkout ignore existing active subscriptions and create a new one?">
...
<Accordion title="Q72: Why am I seeing a TRANSACTION_NOT_ALLOWED error during a subscription upgrade/downgrade?">
...
<Accordion title="Q73: Is there a way to test in live mode without making real payments?">
...
<Accordion title="Q74: What is the $0 payment method?">
...
<Accordion title="Q75: It seems my account appears to be suspended, but compliance says everything is fine. What should I do?">
...
<Accordion title="Q76: How do payouts work with Dodo Payments?">
...
<Accordion title="Q78: How do I link my bank account to receive payouts?">
...
<Accordion title="Q79: Can I track the status of my payouts?">
  A: Yes, you can track your payout status from the **Payouts** section of the dashboard.
</Accordion>

<Accordion title="Q80: What are payout fees and how much are they?">
...
<Accordion title="Q81: I received a &quot;payout processed&quot; email — when will the funds arrive?">
...
<Accordion title="Q82: How do I add Payoneer as a payout account?">
...
<Accordion title="Q83: Can I receive payouts to a Payoneer account?">
...
<Accordion title="Q84: My bank info and compliance form are still in review — what should I do?">
...
<Accordion title="Q85: What happens if my payout day falls on a Friday or weekend?">
...
<Accordion title="Q86: How can I expedite payout compliance if I have an urgent launch or ad campaign planned?">
...
<Accordion title="Q87: I submitted the wrong bank account details. How do I update them?">
...
<Accordion title="Q88: Can I use my personal bank account if I have a registered company?">
  A: No. If you're registered as a company or legal entity, you must use the entity's bank account.
</Accordion>

<Accordion title="Q89: My country doesn't use SWIFT codes. How will that affect my verification?">
...
<Accordion title="Q90: What alternative documentation can I provide if my country doesn't use SWIFT codes?">
...
<Accordion title="Q92: Does Dodo Payments generate invoices automatically?">
...
<Accordion title="Q93: Can I customize the invoices?">
...
<Accordion title="Q94: How do I access or download an invoice?">
...
<Accordion title="Q95: How do I view reports on my transactions and payouts?">
...
<Accordion title="Q96: How do I issue a refund?">
...
<Accordion title="Q97: How long does it take for a customer to receive their refund?">
...
<Accordion title="Q98: I'm facing a dispute or chargeback. What can I do?">
...
<Accordion title="Q99: The customer disputed the charge after using the service. Can I appeal this?">
  A: Yes — you can:
...
<Accordion title="Q100: How is proration calculated — on the product price or the total amount?">
...
<Accordion title="Q101: Why do we use the `subscription.renewed` webhook for the first subscription?">
...
<Accordion title="Q103: Where can I find official docs on manual webhook verification?">
...
<Accordion title="Q104: My webhook isn't receiving a POST request, only a GET. Why?">
...
<Accordion title="Q105: I get a 401 Unauthorized error using the Python SDK. Why?">
...
<Accordion title="Q106: Is there a way to manually trigger a webhook event for testing?">
A: You can do it through the webhook dashboard. Go to Dashboard -> Developers -> Webhooks
</Accordion>

<Accordion title="Q107: What's the difference between webhook and redirect URL?">
A:
...
<Accordion title="Q108: Why didn't I receive the product id in the payment.succeeded webhook for a subscription product?">
...
<Accordion title="Q109: How do I verify the webhooks I receive are actually from dodo payments and not from any malicious actors?">
...
<Accordion title="Q110: Why am I receiving a subscription.renew webhook even for the first month payment?">
...
<Accordion title="Q111: How can I test webhooks locally?">
...
<Accordion title="Q112: Why is my webhook not being called after payment?">
...
<Accordion title="Q113: Is it safe to rely on status=success in URL query params?">
...
<Accordion title="Q114: Can I integrate Dodo Payments with my existing website or platform?">
...
<Accordion title="Q115: Can I test subscriptions in Test Mode?">
A: Yes — subscriptions can be tested fully in Test Mode.

Just don't use real card numbers.
</Accordion>

<Accordion title="Q116: How do I switch between Test and Live Mode?">
A:
...
<Accordion title="Q117: Can I use real customer data in Test Mode?">
...
<Accordion title="Q118: I'm getting: &quot;You must provide a mandate for off-session card payments&quot;">
A: It means:
...
<Accordion title="Q119: How do I contact support?">
...
<Accordion title="Q120: My support messages are getting no response. What should I do?">
...
<Accordion title="Q121: How does Dodo Payments protect my business from fraud?">
...
<Accordion title="Q122: Is my customer data secure with Dodo Payments?">
...
<Accordion title="Q127: Why am I getting an 'Invalid authorization details' error?">
