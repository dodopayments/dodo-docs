...
<Accordion title="Q45: What types of payments can I accept with Dodo Payments?">
...
<Accordion title="Q46: Why was the first payment marked successful with an amount of $0 for subscription?">
...
<Accordion title="Q47: After the trial period ends, does the customer need to pay (product price(e.g $25)) again manually?">
...
<Accordion title="Q48: What if the trial period shows differently on my app vs. the Dodo Payments dashboard?">
...
<Accordion title="Q49: Do I need to test the trial feature before going live?">
...
<Accordion title="Q50: How can I track payment statuses?">
...
<Accordion title="Q51: What should I do if a payment fails?">
...
<Accordion title="Q52: Do merchants get notified when a user's payment fails?">
...
<Accordion title="Q53: What happens to a subscription if a payment fails?">
...
<Accordion title="Q54: If I retry payments myself, do I need the failed payment ID?">
  A: No. You only need the subscription ID to initiate a new payment attempt.
</Accordion>

<Accordion title="Q55: How can a subscription payment fail with INCORRECT_NUMBER if previous cycles were successful?">
...
<Accordion title="Q56: Does the chargeback apply for business even if my business has a no refund policy?">
...
<Accordion title="Q57: Why is payment.status sometimes null?">
...
<Accordion title="Q58: Why is product_cart null even though it's a checkout in webhook payload?">
  A:
...
<Accordion title="Q59: Why was my real card blocked during testing?">
...
<Accordion title="Q60: My customer completed payment but I didn't receive webhook?">
  A: Checklist:
...
<Accordion title="Q61: Why is my dashboard showing success, but my app didn't update?">
...
<Accordion title="Q62: I'm not seeing UPI as a payment option — why?">
...
<Accordion title="Q63: Does Dodo support UPI for subscriptions?">
...
<Accordion title="Q64: How do I enable Google Pay / Apple Pay on static payment links?">
...
<Accordion title="Q65: How can I enable 3DS in Dodo Payments?">
...
<Accordion title="Q66: How do I collect billing details without passing them in API?">
...
<Accordion title="Q67: What's the difference between static and dynamic payment links?">
...
<Accordion title="Q68: Will I get two webhook events when someone starts a subscription?">
...
<Accordion title="Q69: What does subscription.cancelled_at mean? Is it a scheduled cancellation?">
...
<Accordion title="Q70: When does a subscription get charged?">
...
<Accordion title="Q71: Why does the Change Plan API return an empty response?">
...
<Accordion title="Q72: Why wasn't a new payment prompted when switching from a monthly to an annual plan?">
...
<Accordion title="Q73: Why does my product price (Rs 100) show a higher amount (Rs 104) during checkout?">
  A: This happens when Adaptive Currency is enabled. The feature adds an additional 4% charge automatically.
</Accordion>

<Accordion title="Q74: Why does checkout ignore existing active subscriptions and create a new one?">
...
<Accordion title="Q75: Why am I seeing a TRANSACTION_NOT_ALLOWED error during a subscription upgrade/downgrade?">
...
<Accordion title="Q76: Is there a way to test in live mode without making real payments?">
...
<Accordion title="Q77: What is the $0 payment method?">
...
<Accordion title="Q78: It seems my account appears to be suspended, but compliance says everything is fine. What should I do?">
...
<Accordion title="Q79: How do payouts work with Dodo Payments?">
...
<Accordion title="Q80: What is the minimum threshold amount after fees and taxes to process payouts?">
...
<Accordion title="Q81: How do I link my bank account to receive payouts?">
...
<Accordion title="Q82: Can I track the status of my payouts?">
  A: Yes, you can track your payout status from the **Payouts** section of the dashboard.
</Accordion>

<Accordion title="Q83: What are payout fees and how much are they?">
...
<Accordion title="Q84: I received a &quot;payout processed&quot; email — when will the funds arrive?">
...
<Accordion title="Q85: How do I add Payoneer as a payout account?">
...
<Accordion title="Q86: Can I receive payouts to a Payoneer account?">
...
<Accordion title="Q87: My bank info is still in review — what should I do?">
...
<Accordion title="Q88: What happens if my payout day falls on a Friday or weekend?">
...
<Accordion title="Q89: How can I expedite payout compliance if I have an urgent launch or ad campaign planned?">
...
<Accordion title="Q90: I submitted the wrong bank account details. How do I update them?">
...
<Accordion title="Q91: Can I use my personal bank account if I have a registered company?">
  A: No. If you're registered as a company or legal entity, you must use the entity's bank account.
</Accordion>

<Accordion title="Q92: My country doesn't use SWIFT codes. How will that affect my verification?">
...
<Accordion title="Q93: What alternative documentation can I provide if my country doesn't use SWIFT codes?">
...
<Accordion title="Q94: Can I set a payout threshold lower than $50?">
...
<Accordion title="Q95: Does Dodo Payments generate invoices automatically?">
...
<Accordion title="Q96: Can I customize the invoices?">
...
<Accordion title="Q97: How do I access or download an invoice?">
...
<Accordion title="Q98: How do I view reports on my transactions and payouts?">
...
<Accordion title="Q99: How do I issue a refund?">
...
<Accordion title="Q100: How long does it take for a customer to receive their refund?">
...
<Accordion title="Q101: I'm facing a dispute or chargeback. What can I do?">
...
<Accordion title="Q102: The customer disputed the charge after using the service. Can I appeal this?">
  A: Yes — you can:
...
<Accordion title="Q103: How is proration calculated — on the product price or the total amount?">
...
<Accordion title="Q104: Why do we use the `subscription.renewed` webhook for the first subscription?">
...
<Accordion title="Q105: Can I manually verify Dodo Payments webhooks in Python?">
...
<Accordion title="Q106: Where can I find official docs on manual webhook verification?">
...
<Accordion title="Q107: My webhook isn't receiving a POST request, only a GET. Why?">
...
<Accordion title="Q108: I get a 401 Unauthorized error using the Python SDK. Why?">
...
<Accordion title="Q109: Is there a way to manually trigger a webhook event for testing?">
A: You can do it through the webhook dashboard. Go to Dashboard -> Developers -> Webhooks
</Accordion>

<Accordion title="Q110: What's the difference between webhook and redirect URL?">
A:
...
<Accordion title="Q111: Why didn't I receive the product id in the payment.succeeded webhook for a subscription product?">
...
<Accordion title="Q112: How do I verify the webhooks I receive are actually from dodo payments and not from any malicious actors?">
...
<Accordion title="Q113: Why am I receiving a subscription.renew webhook even for the first month payment?">
...
<Accordion title="Q114: How can I test webhooks locally?">
...
<Accordion title="Q115: Why is my webhook not being called after payment?">
...
<Accordion title="Q116: Is it safe to rely on status=success in URL query params?">
...
<Accordion title="Q117: Can I integrate Dodo Payments with my existing website or platform?">
...
<Accordion title="Q118: Why are my webhooks always failing?">
  A: Common causes:
...
<Accordion title="Q119: Can I test subscriptions in Test Mode?">
A: Yes — subscriptions can be tested fully in Test Mode.

Just don't use real card numbers.
</Accordion>

<Accordion title="Q120: How do I switch between Test and Live Mode?">
A:
...
<Accordion title="Q121: Can I use real customer data in Test Mode?">
...
<Accordion title="Q122: How do I contact support?">
...
<Accordion title="Q123: My support messages are getting no response. What should I do?">
...
<Accordion title="Q124: How does Dodo Payments protect my business from fraud?">
...
<Accordion title="Q125: Is my customer data secure with Dodo Payments?">
...
<Accordion title="Q130: Why am I getting an 'Invalid authorization details' error?">
  A: This usually happens when the 3D Secure (3DS) authentication fails or is not completed by the user.
</Accordion>


<Accordion title="Q131: Why am I getting an 'Authentication failure' error for payments?">
...
<Accordion title="Q132: I'm seeing a 500 internal_error (&quot;Internal Server Error&quot;) in test mode. How do I fix it?">
...
<Accordion title="Q133: Why am I getting payment_method_unsupported (&quot;mode not enabled for merchant&quot;) in test mode?">
...
<Accordion title="Q134: What does the requires_customer_action status mean?">
...
<Accordion title="Q135: Why am I getting a SUBSCRIPTION_NOT_ACTIVE error?">
...
<Accordion title="Q136: Why am I getting a payment failure with unknown_error?">
...
<Accordion title="Q137: I'm getting: &quot;You must provide a mandate for off-session card payments&quot;">
  A: It means:
