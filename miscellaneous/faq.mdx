...
<Accordion title="Q116: Why are my webhooks failing?">
  A: Common causes:
...
<Accordion title="Q131: I'm getting a 500 internal_error – 'Internal Server Error' in test mode. How do I fix it?">
...
<Accordion title="Q132: Why am I seeing payment_method_unsupported – 'mode not enabled for merchant' in test mode?">
...
<Accordion title="Q133: What does the require_customer_action status mean?">
...
<Accordion title="Q135: Why am I getting a payment error with unknown_error?">
