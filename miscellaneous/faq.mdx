...
<Accordion title="Q92: How do payouts work with Dodo Payments?">
  ...
  - **Biweekly**: A higher-frequency cycle with 8 payout dates per month, available on request
  - **Tri-weekly**: The highest-frequency cycle, with 15 payout dates per month, available on request
  - **Monthly**:
...
<Accordion title="Q108: Do you support daily payouts?">
  A: No, daily payouts are not available. The available payout cycles are bi-monthly (default), weekly, biweekly, and tri-weekly (for high-volume businesses, on request), and monthly. See full details: https://docs.dodopayments.com/features/payouts/payout-structure#payout-cycles
</Accordion>
