...
<Accordion title="Q113: Can I change the billing address on my invoice?">
...
<Accordion title="Q114: If I change the billing address, will it update all my existing invoices?">
...
<Accordion title="Q115: How do I issue a refund?">
...
<Accordion title="Q116: How long does it take for a customer to receive their refund?">
...
<Accordion title="Q117: I'm facing a dispute or chargeback. What can I do?">
...
<Accordion title="Q118: The customer disputed the charge after using the service. Can I appeal this?">
  A: Yes — you can:
...
<Accordion title="Q119: Why is my refund failing with an 'insufficient funds' error?">
...
<Accordion title="Q120: How is proration calculated — on the product price or the total amount?">
...
<Accordion title="Q121: Why do we use the `subscription.renewed` webhook for the first subscription?">
...
<Accordion title="Q122: Can I manually verify Dodo Payments webhooks in Python?">
...
<Accordion title="Q123: Where can I find official docs on manual webhook verification?">
...
<Accordion title="Q124: My webhook isn't receiving a POST request, only a GET. Why?">
...
<Accordion title="Q125: I get a 401 Unauthorized error using the Python SDK. Why?">
...
<Accordion title="Q126: Is there a way to manually trigger a webhook event for testing?">
A: You can do it through the webhook dashboard. Go to Dashboard -> Developers -> Webhooks
</Accordion>

<Accordion title="Q127: What's the difference between webhook and redirect URL?">
A:
...
<Accordion title="Q128: Why didn't I receive the product id in the payment.succeeded webhook for a subscription product?">
...
<Accordion title="Q129: How do I verify the webhooks I receive are actually from dodo payments and not from any malicious actors?">
...
<Accordion title="Q130: Why am I receiving a subscription.renewed webhook even for the first month payment?">
...
<Accordion title="Q131: How can I test webhooks locally?">
...
<Accordion title="Q132: Why is my webhook not being called after payment?">
...
<Accordion title="Q133: Is it safe to rely on status=success in URL query params?">
...
<Accordion title="Q134: Can I integrate Dodo Payments with my existing website or platform?">
...
<Accordion title="Q135: Why are my webhooks always failing?">
  A: Common causes:
...
<Accordion title="Q136: Where do I find my API key?">
...
<Accordion title="Q137: What are the base URLs for the Dodo Payments API?">
...
<Accordion title="Q138: Can I test subscriptions in Test Mode?">
A: Yes — subscriptions can be tested fully in Test Mode.

Just don't use real card numbers.
</Accordion>

<Accordion title="Q139: How do I switch between Test and Live Mode?">
A:
...
<Accordion title="Q140: Can I use real customer data in Test Mode?">
...
<Accordion title="Q141: Can I advance the next billing date in test mode?">
...
<Accordion title="Q142: Why don't I receive emails in Test Mode?">
...
<Accordion title="Q143: How do I contact support?">
...
<Accordion title="Q144: My support messages are getting no response. What should I do?">
...
<Accordion title="Q145: How do I unsubscribe a customer from Dodo Digest emails?">
  A: Share the customer's email address with us via Intercom and we'll unsubscribe them from our end.
</Accordion>

## Security & Fraud Prevention

<Accordion title="Q146: How does Dodo Payments protect my business from fraud?">
...
<Accordion title="Q147: Is my customer data secure with Dodo Payments?">
...
<Accordion title="Q148: I found a security vulnerability in Dodo Payments. How should I report it?">
A: Please report any discovered vulnerabilities directly to our security team at pt-team@dodopayments.com
</Accordion>

<Accordion title="Q149: Does Dodo Payments offer bug bounties?">
A: We currently do not offer monetary bounties, but we do provide Dodo Payments merchandise as a token of appreciation.
</Accordion>

<Accordion title="Q150: How are customers protected from fraud on Dodo Payments?">
...
<Accordion title="Q151: Why is my payment status showing 'Not Initiated'?">
  A: This means the payment link was created, but the user never opened the payment page or attempted the payment.
</Accordion>

<Accordion title="Q152: Why is my payment status showing 'Requires Payment Method'?">
...
<Accordion title="Q153: Why am I getting an 'Invalid authorization details' error?">
  A: This usually happens when the 3D Secure (3DS) authentication fails or is not completed by the user.
</Accordion>


<Accordion title="Q154: Why am I getting an 'Authentication failure' error for payments?">
...
<Accordion title="Q155: I'm seeing a 500 INTERNAL_SERVER_ERROR (&quot;Internal Server Error&quot;) in test mode. How do I fix it?">
...
<Accordion title="Q156: Why am I getting PAYMENT_METHOD_UNSUPPORTED (&quot;mode not enabled for merchant&quot;) in test mode?">
...
<Accordion title="Q157: What does the requires_customer_action status mean?">
...
<Accordion title="Q158: Why am I getting a SUBSCRIPTION_NOT_ACTIVE error?">
...
<Accordion title="Q159: Why am I getting a payment failure with UNKNOWN_ERROR?">
...
<Accordion title="Q160: I'm getting: &quot;You must provide a mandate for off-session card payments&quot;">
  A: It means:
...
<Accordion title="Q161: Is the customer portal tied to a specific customer?">
...
<Accordion title="Q164: Can I integrate Dodo Payments in an Android or mobile app?">
...
<Accordion title="Q165: How do I find my live publishable key (pk_live_...)?">
...
<Accordion title="Q166: Does Dodo Payments support WooCommerce blocks (WordPress block editor)?">
...
<Accordion title="Q167: Why can't I see the upgrade/downgrade button in my customer portal?">
...
<Accordion title="Q168: How many discount codes can be applied in one checkout?">
  A: Up to 20 codes can be stacked via the `discount_code` array (max 20 entries).
</Accordion>

<Accordion title="Q169: How do I change my login email?">
...
<Accordion title="Q170: Why am I getting the business_id as my brand_id?">
...
<Accordion title="Q171: What are the limitations when adding Notion content?">
