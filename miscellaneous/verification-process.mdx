---
title: Payouts Activation
description: Learn how to activate payouts for your account and how we monitor your account for compliance.
icon: "id-card"
---

This section will help you understand the process to activate payouts for your account

At Dodo Payments, businesses can start accepting payments immediately after sign-up: **Live Mode is available from Day 1.**

To receive payouts merchants must complete **Payout Activation**, which includes submitting **Payout Details** after which our compliance team will review the details and the merchant’s account before enabling payouts. This ensures compliance with regulatory guidelines, card-network rules, tax requirements, and our Merchant Acceptance Policy.
...
This is available in the `Payouts → Payouts` section on the dashboard

### **When Do You Need to Activate Payouts?**
...
<Frame>
  <img src="/images/payouts/payout-activation.png" alt="Payout Activation"/>
</Frame>

Once this amount is reached:

- An **Activate Payouts** prompt will appear on your dashboard
- The **Payout Details** section will unlock when you click submit details (Refer to screenshot)
- You can begin the Payout Activation process by submitting all details

Until then:

- You can continue accepting payments normally
