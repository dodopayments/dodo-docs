...
27. **Gaming and virtual-goods environments** – This includes online games, chance-based reward mechanics (such as loot boxes or spins), in-game currencies, digital item sales, game boosters, or private servers - whether official or unofficial.
28. **Hosting, servers, and infrastructure services** – This includes VPS or dedicated servers, hosting plans, cloud compute credits, bandwidth reselling, or any product that provides users with persistent infrastructure or server-level access.    
...
| 79 | IL | Israel |
| 80 | IT | Italy |
| 81 | CI | Ivory Coast (Côte d'Ivoire) |
| 82 | JM | Jamaica |
| 83 | JP | Japan |
| 84 | JO | Jordan |
| 85 | KE | Kenya |
...
| 134 | PT | Portugal |
| 135 | QA | Qatar |
| 136 | CG | Republic of the Congo |
| 137 | RO | Romania |
| 138 | RW | Rwanda |
| 139 | BL | Saint Barthélemy |
| 140 | KN | Saint Kitts and Nevis |
| 141 | LC | Saint Lucia |
| 142 | MF | Saint Martin |
| 143 | PM | Saint Pierre and Miquelon |
| 144 | VC | Saint Vincent and the Grenadines |
| 145 | WS | Samoa |
| 146 | SM | San Marino |
| 147 | ST | São Tomé and Príncipe |
| 148 | SA | Saudi Arabia |
| 149 | SN | Senegal |
| 150 | RS | Serbia |
| 151 | SC | Seychelles |
...
| 175 | UG | Uganda |
| 176 | UA | Ukraine |
| 177 | AE | United Arab Emirates |
| 178 | GB | United Kingdom |
| 179 | US | United States |
| 180 | UY | Uruguay |
| 181 | VI | US Virgin Islands |
| 182 | VU | Vanuatu |
| 183 | VN | Vietnam |
| 184 | ZM | Zambia |
| 185 | ZW | Zimbabwe |
