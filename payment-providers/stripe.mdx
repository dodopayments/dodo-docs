...
sidebarTitle: "Stripe"
description: "Why Bring Your Own Processor needs raw card API access on your Stripe account, and how to request it by providing Dodo Payments' PCI DSS Attestation of Compliance (AOC)."
icon: "stripe"
keywords: ["Stripe", "raw card data API", "PCI DSS", "AOC", "attestation of compliance", "BYOP", "bring your own processor", "PAN"]
---
