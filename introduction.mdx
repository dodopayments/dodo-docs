...
Open Dodo's hosted checkout in each platform's native browser surface.
Apple Pay and Google Pay work the same way they do on the open web.

<CardGroup cols={3}>
<Card title="iOS" icon="apple" href="/developer-resources/ios-checkout-sdk" />
<Card title="Android" icon="android" href="/developer-resources/android-checkout-sdk" />
<Card title="React Native" icon="react" href="/developer-resources/react-native-checkout-sdk" />
</CardGroup>
