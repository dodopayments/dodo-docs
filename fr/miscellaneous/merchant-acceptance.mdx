...
1. Malclasser votre entreprise ou vos produits pour contourner les restrictions de catégorie.
2. Utiliser des commerçants de substitution, des sous-comptes ou des détournements de comptes pour éviter l'application.
3. Vendre ou promouvoir des produits qui sont trompeurs, nuisibles ou qui violent nos règles de contenu interdit.
4. Ne pas divulguer des informations essentielles lors de l'intégration (par exemple, inadéquation du site Web, type d'entité incorrect).
...
8. Demandes par des autorités légales à la réception d'un ordre légal pertinent.
9. Rapports d'activités frauduleuses signalés par nos partenaires réglementaires et de conformité, et rapports de clients.
10. Toutes autres violations matérielles de nos politiques de plateforme ou violations de la loi, le cas échéant

### Appels & Résolution

Si vous pensez que l'application a été appliquée par erreur, vous pouvez soumettre une demande de révision. Veuillez noter que les révisions sont considérées une seule fois. La décision de révision de l'appel sera finale.

Dans certains cas, nous pouvons permettre une action corrective ou une nouvelle soumission pour révision. La divulgation volontaire de problèmes potentiels peut être considérée favorablement. Vous pouvez contacter **compliance@dodopayments.com** pour initier le processus de révision.