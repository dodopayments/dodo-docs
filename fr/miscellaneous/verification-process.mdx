...
<Frame>
  <img src="/images/tax-forms/W8 - BEN - PLC - SAMPLE - 1.png" alt="Exemple de Page 1 W-8 BEN-E Private Limited" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>

**Page 2**

<Frame>
  <img src="/images/tax-forms/W8 - BEN - PLC - SAMPLE - 2.png" alt="Exemple de Page 2 W-8 BEN-E Private Limited" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>

**Page 8**

<Frame>
  <img src="/images/tax-forms/W8 - BEN - PLC - SAMPLE - 8.png" alt="Exemple de Page 8 W-8 BEN-E Private Limited" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Accordion>
...
<Frame>
  <img src="/images/tax-forms/W8 - BEN - LLP SAMPLE - 1.png" alt="Exemple de Page 1 W-8 BEN-E LLP" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>

**Page 2**

<Frame>
  <img src="/images/tax-forms/W8 - BEN - LLP SAMPLE - 2.png" alt="Exemple de Page 2 W-8 BEN-E LLP" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>

**Page 8**

<Frame>
  <img src="/images/tax-forms/W8 - BEN - PLC - SAMPLE - 8.png" alt="Exemple de Page 8 W-8 BEN-E LLP" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Accordion>
</AccordionGroup>
...
## Réenvoi des Documents

Si des problèmes surviennent avec les documents soumis pendant le processus d'intégration, l'équipe de vérification de Dodo Payments peut vous demander de soumettre à nouveau des documents spécifiques.

Vous pouvez soumettre à nouveau des documents en utilisant l'option **soumettre à nouveau** dans votre tableau de bord.

### Quand Pouvez-Vous Réenvoyer des Documents ?
...
- **Non-Correspondance des Documents** : Lorsque les documents soumis ne correspondent pas aux informations professionnelles ou personnelles fournies.
- **Documents Illisibles ou Expirés** : Si les documents téléchargés sont flous, illisibles, ou ont expiré.
- **Clarification Supplémentaire Nécessaire** : Si l'équipe de vérification nécessite des documents supplémentaires pour clarifier votre identité ou les informations sur votre entreprise.

### Comment Réenvoyer des Documents

<Steps>
<Step title="Check your dashboard">
Vérifiez votre tableau de bord Dodo Payments pour une demande de réenvoi (vous recevrez également une notification par email si un réenvoi est requis).
</Step>

<Step title="Access the resubmit option">
L'équipe de vérification activera l'option **Soumettre à nouveau**, vous permettant de télécharger de nouveaux documents.
</Step>

<Step title="Upload correct documents">
Naviguez vers la **Section de Vérification** dans le tableau de bord et téléchargez les documents corrects.
</Step>

<Step title="Submit for review">
Soumettez les documents pour examen en cliquant sur **Soumettre pour Révision**.
</Step>
</Steps>
...
<CardGroup cols={2}>
  <Card
    ...
    href="/miscellaneous/merchant-acceptance"
  >
    Consultez nos normes d'acceptation complètes, y compris les produits pris en charge et interdits, et assurez-vous que votre entreprise est éligible pour l'intégration.
  </Card>
  <Card
    title="Review Monitoring Policy"
    icon="magnifying-glass"
    href="/miscellaneous/review-monitoring-policy"
  >
    Comprenez comment la conformité continue est surveillée, apprenez les déclencheurs pour la révision des documents, et restez proactif avec le statut de votre compte.
  </Card>
</CardGroup>
