...
Définir le montant de la transaction entre **$60,00 et $19 999,00**.
</Step>
...
<Note>
Sunbit n'apparaît que pour les clients américains payant en USD avec un montant compris entre **$60,00** et **$19 999,00**.
</Note>

Pour la documentation complète BNPL, y compris les tests Billie B2B, consultez la page [Achetez maintenant, payez plus tard](/features/payment-methods/bnpl).
...
[Rejoignez le groupe de cartes test Google Pay](https://groups.google.com/g/googlepay-test-mode-stub-data) pour obtenir automatiquement des cartes de test ajoutées à votre portefeuille.
</Step>
...
Pour la documentation complète des portefeuilles numériques, y compris la vérification de domaine pour Apple Pay, consultez la page [Portefeuilles numériques](/features/payment-methods/digital-wallets).
