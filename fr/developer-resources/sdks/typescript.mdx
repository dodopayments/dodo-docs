...
<Card title="Auto-Pagination" icon="arrows-rotate">
  Pagination automatique pour les réponses de liste facilite le travail avec de grands ensembles de données
</Card>
...
Si vous mettez à niveau depuis le SDK Node.js hérité, le SDK TypeScript offre une sécurité de type et des fonctionnalités améliorées :
