...
<Info>
Le SDK prend en charge Go 1.18 et les versions ultérieures, tirant parti des fonctionnalités modernes de Go pour des performances optimales.
</Info>
...
<Card title="Middleware" icon="layer-group">
  Support de middleware extensible pour la journalisation, les métriques et la logique personnalisée
</Card>

<Card title="Sûr pour les goroutines" icon="bolt">
