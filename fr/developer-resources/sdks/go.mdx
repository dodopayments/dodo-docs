...
<Info>
Le SDK nécessite Go 1.22 ou des versions ultérieures, tirant parti des fonctionnalités modernes de Go pour des performances optimales.
</Info>
...
<Warning>
Stockez toujours vos clés API en toute sécurité en utilisant des variables d'environnement. Ne les intégrez jamais en dur dans votre code source.
</Warning>

## Fonctionnalités principales

<CardGroup cols={2}>
<Card title="Support du contexte" icon="clock">
  Support complet pour context.Context pour l'annulation et les délais d'attente
</Card>

<Card title="Typage fort" icon="shield-check">
  Requêtes et réponses fortement typées pour la sécurité à la compilation
</Card>

<Card title="Middleware" icon="layer-group">
  Support extensible pour le middleware pour la journalisation, les métriques et la logique personnalisée
</Card>

<Card title="Sécurisé pour les goroutines" icon="bolt">
  Client thread-safe conçu pour des opérations concurrentes
</Card>
</CardGroup>
...
<CardGroup cols={2}>
<Card title="Dépôt GitHub" icon="github" href="https://github.com/dodopayments/dodopayments-go">
...
<Card title="Signaler des problèmes" icon="bug" href="https://github.com/dodopayments/dodopayments-go/issues">
