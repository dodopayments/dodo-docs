...
`dodo wh trigger` peut envoyer des payloads simulés pour les 46 types d’événements que Dodo Payments transmet :
...
| **Panier abandonné** | `detected`, `recovered` |
| **Relance** | `started`, `recovered` |
