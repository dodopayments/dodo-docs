...
|----------|-------------|
| `DODO_WH_TEST_SERVER_URL` | Remplacer l'URL du serveur relais de webhook par défaut utilisée par `dodo wh listen` |
...
- **Discord**: Rejoindre notre [serveur communautaire](https://discord.gg/bYqAp4ayYh)
- **GitHub**: Ouvrir un problème sur le [dépôt](https://github.com/dodopayments/dodopayments-cli/issues)
