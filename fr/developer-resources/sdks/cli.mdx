...
| `--version`, `-v` | Afficher la version du CLI |
...
<Info>
Utilisez `dodopayments --help` pour voir toutes les ressources disponibles et `dodopayments [resource] --help` pour les commandes spécifiques aux ressources.
</Info>
