...
<Info>
Le SDK nécessite .NET Standard 2.0 ou une version ultérieure. Il fonctionne avec ASP.NET Core, des applications Console et d'autres types de projets .NET.
</Info>
...
<Card title="Typage fort" icon="shield-check">
  Sécurité de type complète avec des types de référence nullable
</Card>

<Card title="Injection de dépendances" icon="layer-group">
...
| Propriété     | Variable d'environnement     | Requis   | Valeur par défaut                 |
| -------------- | --------------------------- | -------- | --------------------------------- |
| `BearerToken` | `DODO_PAYMENTS_API_KEY`    | vrai     | -                                 |
| `WebhookKey`  | `DODO_PAYMENTS_WEBHOOK_KEY` | faux     | -                                 |
| `BaseUrl`     | `DODO_PAYMENTS_BASE_URL`   | vrai     | `"https://live.dodopayments.com"` |
...
Ajoutez une configuration dans `appsettings.json` :
...
<CardGroup cols={2}>
<Card title="Dépôt GitHub" icon="github" href="https://github.com/dodopayments/dodopayments-csharp">
...
<Card title="Signaler des problèmes" icon="bug" href="https://github.com/dodopayments/dodopayments-csharp/issues">
