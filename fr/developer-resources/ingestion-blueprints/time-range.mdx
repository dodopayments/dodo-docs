...
- **Sur Propriété**: `durationSeconds`, `durationMinutes`, ou `durationMs`
</Step>
...
<Warning>
**Timing Précis** : Utilisez `Date.now()` ou `performance.now()` pour un suivi temporel précis, en particulier pour les fonctions sans serveur.
</Warning>
