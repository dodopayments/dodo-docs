...
<Tip>
**Utilisez le regroupement pour un volume élevé** : Pour les applications traitant plus de 10 requêtes par seconde, utilisez `createBatch()` pour réduire la surcharge et améliorer les performances.
</Tip>
