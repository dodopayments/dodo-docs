...
Données supplémentaires optionnelles à attacher à l'événement de suivi. Utile pour le filtrage et l'analyse.
...
Suivez l'utilisation avec le SDK AI de Vercel pour un support LLM universel.
...
<Tip>
OpenRouter donne accès à des modèles d'OpenAI, Anthropic, Google, Meta et de nombreux autres fournisseurs via une seule API.
</Tip>
</Accordion>
