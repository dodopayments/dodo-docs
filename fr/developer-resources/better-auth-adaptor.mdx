...
<AccordionGroup>
  <Accordion title="Plugin Options">
    - <b>client</b> (obligatoire) : Instance client de DodoPayments
    ...
    - <b>getCustomerParams</b> (optionnel) : Fonction qui reçoit le BetterAuth `User` et renvoie des champs supplémentaires à ajouter au client DodoPayments lors de la création et de la mise à jour (par exemple, `metadata`, `phone_number`)
  ...
  <Accordion title="Checkout Plugin Options">
    ...
    <b>successUrl</b>: URL pour rediriger après un paiement réussi -{" "}
...
<AccordionGroup>
  <Accordion title="Common Issues">
    ...
    <b>Signature de webhook incorrecte</b>: Assurez-vous que le secret du webhook correspond à celui
    défini dans le tableau de bord Dodo Payments. - <b>Client non créé</b>: Confirmez{" "}
