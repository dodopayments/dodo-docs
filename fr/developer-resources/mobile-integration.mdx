...
- **Identifiants API** : Clé API et clé secrète webhook de votre tableau de bord
...
Apprenez à créer une session de paiement dans votre backend en utilisant Node.js, Python, et plus encore. Consultez des exemples complets et des références de paramètres dans la documentation dédiée à la <strong>API des sessions de paiement</strong>.
</Card>
<Note>
