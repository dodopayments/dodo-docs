---
title: Astro Adaptor
description: Apprenez à intégrer Dodo Payments avec votre projet Astro App
  Router en utilisant notre Astro Adaptor. Couvre le processus de paiement, le
  portail client, les webhooks et la configuration d'un environnement sécurisé.
icon: code-merge
---

<CardGroup cols={2}>
{/* LOCKED_PATTERN_848a353666469e7a047ef05af5a45770 */}
    Intégrez la caisse Dodo Payments dans votre application Astro.
</Card>
...
<Info>
Tous les exemples supposent que vous utilisez l'Astro App Router.
</Info>

  <Tabs>
  {/* LOCKED_PATTERN_28fd81a4703a84d931eeff69f1520d54 */}
  Utilisez ce gestionnaire pour intégrer la caisse Dodo Payments dans votre application Astro. Il prend en charge les flux de paiement statiques (GET), dynamiques (POST) et de session (POST).
  </Info>
  <CodeGroup>
...
{/* LOCKED_PATTERN_0026b036379d81a9d03c36b3b6e83ddd */}
  <Info>
  Utilisez ce gestionnaire pour recevoir et traiter en toute sécurité les événements webhook de Dodo Payments dans votre application Astro.
  </Info>
  <CodeGroup>
...
<Info>
Dodo Payments prend en charge trois types de flux de paiement pour intégrer des paiements à votre site web ; cet adaptateur supporte tous les types de flux de paiement.
</Info>
...
Indiquez le montant du paiement (par exemple, <code>1000</code> pour 10,00 $).
</ParamField>
...
Les sessions de caisse offrent une expérience de paiement hébergée plus sécurisée qui gère l'intégralité du flux de paiement pour les achats ponctuels et les abonnements, avec un contrôle total de la personnalisation.
...
Le Gestionnaire de Route du Portail Client vous permet d'intégrer de manière transparente le portail client Dodo Payments dans votre application Astro.
