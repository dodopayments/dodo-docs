...
<Card title="Gestionnaire de Paiement" icon="cart-shopping" href="#checkout-route-handler">
    Intégrez le processus de paiement Dodo Payments dans votre application Astro.
</Card>
...
<Tab title="Gestionnaire de Paiement">
  <Info>
  Utilisez ce gestionnaire pour intégrer le processus de paiement Dodo Payments dans votre application Astro. Prend en charge les flux de paiement statiques (GET), dynamiques (POST) et de session (POST).
  </Info>
  <CodeGroup>
...
<Tab title="Gestionnaire de Webhook">
  <Info>
  Utilisez ce gestionnaire pour recevoir et traiter les événements de webhook Dodo Payments de manière sécurisée dans votre application Astro.
  </Info>
  <CodeGroup>
