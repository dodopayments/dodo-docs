...
<Card title="Suivre les décisions de prix" icon="chart-line">
...
Si les clients ne voient pas le champ de saisie de prix, assurez-vous que vous avez omis le champ `amount` du panier de produits. Lorsque `amount` est fourni, la caisse utilise ce montant exact.
</Accordion>
</AccordionGroup>