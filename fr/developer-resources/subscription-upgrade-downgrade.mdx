...
<Info>
Les crédits créés par les rétrogradations utilisant <code>difference_immediately</code> sont limités à l’abonnement et distincts des droits liés à la <a href="/features/credit-based-billing">facturation basée sur les crédits</a>. Ils s’appliquent automatiquement aux renouvellements futurs du même abonnement et ne sont pas transférables entre abonnements.
</Info>
