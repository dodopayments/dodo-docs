...
- `subscription.plan_changed` : Plan d’abonnement modifié (mise à niveau/rétrogradation/mise à jour du module complémentaire)
- `subscription.on_hold` : Échec du débit lié au changement de plan, renouvellements arrêtés
- `payment.succeeded` : Débit immédiat lié au changement de plan réussi
...
- `subscription.plan_changed` : plan d’abonnement modifié (mise à niveau/rétrogradation/modifications du module complémentaire)
- `subscription.on_hold` : échec du débit, renouvellements arrêtés
