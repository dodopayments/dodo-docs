...
description: Intégrez Dodo Payments à
  votre projet Nuxt à l’aide du module Nuxt officiel. Couvre le checkout, le
  portail client, les webhooks et la configuration sécurisée de l’environnement.
icon: code-merge
keywords:
  - "Dodo Payments"
  - Nuxt
...
Spécifier la devise du paiement (par ex. <code>USD</code>).
</ParamField>
...
Spécifier le montant du paiement (par ex. <code>1000</code> pour 10,00 $).
</ParamField>
