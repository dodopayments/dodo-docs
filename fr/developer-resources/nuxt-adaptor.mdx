...
<Info>
Ce guide explique comment intégrer Dodo Payments dans votre application Nuxt en utilisant le module Nuxt officiel. Vous apprendrez à configurer les routes API de paiement, de portail client et de webhook, et comment gérer en toute sécurité les variables d'environnement.
</Info>
...
<Info>
Créez une route POST pour recevoir et traiter en toute sécurité les événements de webhook de Dodo Payments.
</Info>
<CodeGroup>
...
Les sessions de paiement offrent une expérience de paiement hébergée plus sécurisée qui gère l'ensemble du flux de paiement pour les achats uniques et les abonnements avec un contrôle de personnalisation complet.
...
Le Gestionnaire de Route du Portail Client vous permet d'intégrer sans effort le portail client Dodo Payments dans votre application Nuxt.
