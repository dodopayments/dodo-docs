...
<Card title="Gestionnaire de Paiement" icon="cart-shopping" href="#checkout-route-handler">
    Intégrez le processus de paiement Dodo Payments dans votre application Express.
</Card>
...
<Tab title="Gestionnaire de Webhook">
  <Info>
  Utilisez ce gestionnaire pour recevoir et traiter les événements webhook de Dodo Payments de manière sécurisée dans votre application Express.
  </Info>
  <CodeGroup> 
...
L'adaptateur @dodopayments/express fournit des gestionnaires de route pour les fonctionnalités de Paiement, Portail Client et Webhook de Dodo Payments, conçues pour s'intégrer directement dans une application Express.
