---
title: Adaptateur Hono
description: Apprenez à intégrer Dodo Payments avec votre projet Hono App Router
  en utilisant notre adaptateur NextJS. Couvre le processus de paiement, le
...
<Card title="Gestionnaire de Paiement" icon="cart-shopping" href="#checkout-route-handler">
    Intégrez le processus de paiement Dodo dans votre application Hono.
</Card>
...
<Tab title="Gestionnaire de Portail Client">
  <Info>
  Utilisez ce gestionnaire pour permettre aux clients de gérer leurs abonnements et leurs détails via le portail client de Dodo Payments.
  </Info>
  <CodeGroup>
