...
Fixe le montant facturé, exprimé dans les unités principales de la devise (par exemple, <code>12.5</code> pour 12,50 $). Uniquement pour les produits Pay What You Want, et ignoré si le montant est inférieur au prix minimal du produit.
</ParamField>
