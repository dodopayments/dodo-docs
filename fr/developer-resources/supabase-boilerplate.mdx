...
description: Utilisez le modèle officiel Next.js + Supabase + Dodo Payments pour
  les abonnements afin de livrer rapidement des abonnements. Comprend
  l'authentification, le schéma de base de données, le gestionnaire de webhook
  et l'interface utilisateur de tarification.
icon: database
---
...
<Accordion title="Échec de la poussée de la base de données">
