...
<Step title="Access Webhook Settings">
    Naviguez vers le tableau de bord DodoPayments et accédez à `Developer > Webhooks`.
</Step>
...
<Step title="Navigate to Webhook Details">
    Allez à votre tableau de bord Dodo Payments et naviguez vers `Developer > Webhooks`.
</Step>
...
{/* LOCKED_PATTERN_e00062f1a73be4cdce7478c87f820958 */}
  Référence API pour créer et configurer les endpoints de webhook par programmation
</Card>
