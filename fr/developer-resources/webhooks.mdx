...
<Expandable title="Data object properties">
  ...
  Type de ressource. L'un de : `Payment`, `Subscription`, `Refund`, `Dispute`, `LicenseKey`, `CreditLedgerEntry`, `CreditBalanceLow`, `AbandonedCheckout`, `DunningAttempt`, ou `EntitlementGrant`.
  </ResponseField>
  
  Les champs supplémentaires varient selon le type d'événement. Consultez la documentation spécifique à l'événement pour obtenir les schémas complets.
</Expandable>
</ResponseField>
...
Cet outil interactif vous permet de sélectionner parmi tous les types d'événements pris en charge et d'envoyer des charges utiles simulées réalistes à votre point de terminaison. Il boucle afin que vous puissiez tester plusieurs événements en une seule session.
...
<Frame>
    <img src="/images/webhooks/logs.png" alt="Journaux" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
    <img src="/images/webhooks/activity.png" alt="Activité" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/images/webhooks/alerting.png" alt="Paramètres d'alerte de Webhook montrant la configuration des notifications par email" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
