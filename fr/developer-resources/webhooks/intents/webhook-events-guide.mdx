...
| **Abonnement suspendu** | `subscription.on_hold`   | Déclenché lorsqu’un abonnement est temporairement suspendu en raison de l’échec d’un renouvellement. |
...
| **Échec de l’abonnement**  | `subscription.failed`    |  Indique un échec de l’abonnement. Cela signifie que nous n’avons pas pu créer un mandat. |
| **Abonnement arrivé à expiration** | `subscription.expired`   | Déclenché lorsqu’un abonnement arrive au terme de sa durée et expire.          |
