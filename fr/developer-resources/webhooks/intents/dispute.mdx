...
<Warning>
Vous disposez de **10 jours** pour répondre à un litige après sa création. Consultez [Bonnes pratiques pour répondre aux litiges](/features/transactions/disputes#dispute-response-best-practices) pour connaître les éléments de preuve à rassembler et savoir comment les formater.
</Warning>
