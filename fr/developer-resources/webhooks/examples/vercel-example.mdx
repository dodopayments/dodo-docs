...
4. **Journalise l'événement** - Stocke le webhook brut dans la table `webhook_events` pour la piste d'audit
5. **Traite l'événement** - Crée ou met à jour des clients et des abonnements dans Neon
