...
4. **Traite l'événement** - Crée ou met à jour les clients et les abonnements dans Neon
...
| Env vars non disponibles | Définissez les variables dans la CLI ou le tableau de bord, puis redéployez |

## Ressources

- [Docs des Fonctions Netlify](https://docs.netlify.com/functions/overview/)
- [CLI Netlify](https://docs.netlify.com/cli/get-started/)
