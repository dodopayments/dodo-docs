...
La fonction est déjà configurée dans `functions/webhook/index.ts` - il suffit de la déployer :
...
5. **Gère les erreurs** - Journalise les échecs et marque l'événement pour réessai
...
| Problème | Solution |
|-------|----------|
| Vérification échouée | Vérifiez que la clé webhook est correcte dans le tableau de bord DodoPayments |
