...
4. **Traite l'événement** - Crée ou met à jour les clients et les abonnements
...
| Worker ne se déploie pas | Exécutez `npm install`, vérifiez la syntaxe de `wrangler.toml` |
