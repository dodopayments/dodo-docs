---
title: Adaptateur SveleteKit
description: Apprenez à intégrer Dodo Payments avec votre projet SveleteKit App
  Router en utilisant notre Adaptateur SveleteKit. Couvre le processus de
  paiement, le portail client, les webhooks et la configuration d'un
...
<Card title="Gestionnaire de Paiement" icon="cart-shopping" href="#checkout-route-handler">
    Intégrez le processus de paiement Dodo Payments dans votre application SveleteKit.
</Card>
...
<Info>
Tous les exemples supposent que vous utilisez le SveleteKit App Router.
</Info>

<Tabs>
<Tab title="Gestionnaire de Paiement">
  <Info>
  Utilisez ce gestionnaire pour intégrer le processus de paiement Dodo Payments dans votre application SveleteKit. Prend en charge les flux de paiement statiques (GET), dynamiques (POST) et de session (POST).
  </Info>
  <CodeGroup>
...
<Tab title="Gestionnaire de Webhook">
  <Info>
  Utilisez ce gestionnaire pour recevoir et traiter les événements webhook de Dodo Payments de manière sécurisée dans votre application SveleteKit.
  </Info>
  <CodeGroup>
...
Le Gestionnaire de Route du Portail Client vous permet d'intégrer de manière transparente le portail client Dodo Payments dans votre application SveleteKit.
