...
Le [Dodo Agent Plugin](/developer-resources/build-with-ai-coding-agents) installe les deux serveurs MCP et les dix-sept skills en une seule étape pour Claude Code, Codex CLI, Cursor, VS Code / GitHub Copilot, Kiro et OpenCode. Gemini CLI ne reçoit que les deux serveurs MCP, car il ne dispose pas de primitive d’agent-skill. Consultez le [guide des AI Coding Agents](/developer-resources/build-with-ai-coding-agents) pour connaître les commandes d’installation propres à chaque agent.
