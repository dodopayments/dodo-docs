...
Le [Dodo Agent Plugin](/developer-resources/build-with-ai-coding-agents) installe en une seule étape les serveurs MCP et les dix-sept skills pour Claude Code, Codex CLI, Cursor et OpenCode. Consultez le [guide des agents de codage IA](/developer-resources/build-with-ai-coding-agents) pour connaître les commandes d’installation propres à chaque agent.
