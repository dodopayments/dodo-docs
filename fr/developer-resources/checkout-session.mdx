...
Configuration d'abonnement à la demande pour la facturation basée sur l'utilisation ou à la mesure.
...
Remplacement optionnel de la description du produit pour la facturation et les lignes d'articles. Si non spécifié, la description enregistrée du produit sera utilisée.
</ParamField>
