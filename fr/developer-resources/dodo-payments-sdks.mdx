...
Dodo Payments fournit des SDK officiels pour plusieurs langages de programmation, chacun conçu avec les meilleures pratiques spécifiques à chaque langage et des fonctionnalités modernes pour une intégration de paiement sans faille.

## SDK disponibles

Choisissez le SDK qui correspond à votre stack technologique :
...
<Card title="SDK PHP" icon="php" href="/developer-resources/sdks/php">
  SDK conforme à PSR-4 pour les applications PHP modernes 8+
</Card>

<Card title="SDK Go" icon="golang" href="/developer-resources/sdks/go">
  Interface Go idiomatique avec support de contexte et typage fort
</Card>
...
<Card title="SDK C#" icon="c" href="/developer-resources/sdks/csharp">
  SDK type-safe pour .NET 8+ avec API basée sur async Task (Beta)
</Card>
...
- **Gestion des erreurs** : Gestion des exceptions complète avec des messages d'erreur détaillés
