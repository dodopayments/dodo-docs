...
<Card title="TypeScript SDK" icon="js" href="/developer-resources/sdks/typescript">
  Intégration type-safe pour TypeScript et Node.js avec API basée sur des promesses et pagination automatique
</Card>
...
<Card title="Ruby SDK" icon="gem" href="/developer-resources/sdks/ruby">
  Interface élégante Ruby suivant les conventions et meilleures pratiques Ruby
</Card>
...
- **Support Async** : Modèles modernes async/await lorsque cela est applicable
...
<Info>
Apple Pay, Google Pay, Cash App et UPI ne sont pas actuellement supportés dans le SDK React Native. Le support pour ces méthodes de paiement est prévu pour de futures versions.
</Info>
...
Intégrez en moins de 10 lignes de code avec nos adaptateurs de framework. Choisissez parmi nos frameworks recommandés ou explorez toutes les options supportées.
...
<AccordionGroup>
<Accordion title="Afficher les autres 8+ frameworks supportés">
  <CardGroup cols={4}>
...
Nous accueillons les contributions à tous nos SDKs ! Chaque dépôt a un `CONTRIBUTING.md` fichier avec des directives pour :
