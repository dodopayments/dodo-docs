...
<CardGroup cols={2}>
{/* LOCKED_PATTERN_e11b972ff38970af092497ad2b5da99c */}
  Référence de l'API pour la création et la configuration des compteurs d'utilisation pour suivre la consommation des clients
</Card>
{/* LOCKED_PATTERN_b87752b420a84d90b09130bc3e896ab1 */}
  Référence de l'API pour envoyer des événements d'utilisation à vos compteurs configurés pour les calculs de facturation
</Card>
</CardGroup>
