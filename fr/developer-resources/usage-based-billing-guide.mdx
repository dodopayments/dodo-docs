...
<Frame>
<img src="/images/guides/usage-based-billing/meter-quantities-chart.png" alt="Graphique des quantités mesurées montrant les tendances d'utilisation au fil du temps avec une visualisation en dégradé violet" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/guides/usage-based-billing/events-table.png" alt="Tableau des événements montrant les noms des événements, les identifiants et les contrôles de pagination pour une analyse détaillée des événements" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
Configuration du filtre (utilisant la logique AND) :
