...
Pour des informations détaillées sur la configuration d'Apple Pay, Google Pay et d'autres portefeuilles numériques, consultez la page des <a href="/features/payment-methods/digital-wallets">Portefeuilles numériques</a>.
...
|----------------|-----------------|----------------------|
| Profondeur d'intégration | Entièrement intégré à la page | Modal en haut de la page |
| Contrôle de mise en page | Contrôle total | Limité |
| Branding | Intégré | Séparé de la page |
| Effort de mise en œuvre | Plus élevé | Moins élevé |
| Meilleur pour | Pages de paiement personnalisées, flux de haute conversion | Intégration rapide, pages existantes |
...
<Card title="Paiement en superposition" icon="layer-group" href="/developer-resources/overlay-checkout">
    Utilisez le paiement en superposition pour une intégration rapide basée sur des modaux.
</Card>
...
<Card title="Guide d'intégration" icon="book" href="/developer-resources/integration-guide">
    Guide complet pour l'intégration de Dodo Payments.
</Card>
</CardGroup>
