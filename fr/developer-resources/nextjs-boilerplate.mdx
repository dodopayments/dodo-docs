...
<Info>
Ce modèle utilise Next.js 16 App Router avec TypeScript, Tailwind CSS 4, et le `@dodopayments/nextjs` adaptateur.
</Info>
...
- **UI moderne** - Page de tarification propre avec un thème sombre utilisant Tailwind CSS
...
<Accordion title="Échec de la redirection de paiement">
**Causes courantes :**
