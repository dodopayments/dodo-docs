...
Cette section couvre la **configuration du thème côté client** à l’aide du SDK de paiement. Vous pouvez également configurer les thèmes **côté serveur** lors de la création d’une session de paiement via l’API en utilisant le paramètre `theme_config`. Consultez [Checkout Theme Customization](/features/checkout#checkout-theme-customization) pour la configuration au niveau de l’API.
