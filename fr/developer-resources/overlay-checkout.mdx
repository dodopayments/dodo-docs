...
Une fois confirmé, vérifiez qu'Apple Pay apparaît au moment du paiement et testez le flux complet.
</Step>
</Steps>

<Warning>
Apple Pay nécessite la vérification du domaine avant d'apparaître en production. Contactez le support avant de passer en ligne si vous prévoyez d'offrir Apple Pay.
</Warning>
...
Choisissez le bon type de paiement selon votre cas d'utilisation :

| Fonctionnalité | Checkout en overlay | Checkout en ligne |
|----------------|-------------------|-----------------|
...
<Tip>
Utilisez le **checkout en overlay** pour une intégration plus rapide avec des modifications minimales de vos pages existantes. Utilisez le **checkout en ligne** lorsque vous souhaitez un contrôle maximal sur l'expérience de paiement et un branding intégré.
</Tip>

## Ressources connexes

<CardGroup cols={2}>
<Card title="Checkout en ligne" icon="credit-card" href="/developer-resources/inline-checkout">
...
Pour plus d'aide, visitez notre [communauté Discord](https://discord.gg/bYqAp4ayYh) ou contactez notre équipe de support développeurs.
