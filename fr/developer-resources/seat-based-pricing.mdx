...
<Frame>
  <img src="/images/cookbooks/seat-based/seat-based-addons-creation.png" alt="Créer un produit d'abonnement de base" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/images/cookbooks/seat-based/seat-based-subscription.png" alt="Créer un produit d'abonnement de base" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/images/cookbooks/seat-based/seat-based-addons.png" alt="Attacher un complément à l'abonnement" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Check>
Votre serveur devrait démarrer correctement et afficher « Server running on [http://localhost:3000](http://localhost:3000) »
</Check>
</Step>
...
<Frame>
  <img src="/images/cookbooks/seat-based/seat-based-billing-ui.png" alt="Créer un produit d'abonnement de base" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
