...
<Frame>
    <img src="/images/cookbooks/ai-chat-app/ai-chat-demo.png" alt="Démo du chat IA"/>
</Frame>
...
Maintenant, nous allons saisir les détails spécifiques pour notre service de chat IA :
...
1. Dans votre tableau de bord Dodo Payments, allez dans **Développeurs** → **Clés API**
...
1. Rendez-vous sur [aistudio.google.com](https://aistudio.google.com/api-keys)
...
De plus, définissez le **Prix fixe** sur `0` afin de garantir que les clients ne sont facturés qu'en fonction de leur utilisation, sans frais de base.
...
**Prix par unité** : saisissez `0.00001` (ce qui correspond à 0,01 $ pour 1 000 jetons ou 0,00001 $ par jeton)

**Seuil gratuit** : saisissez `10000` (les clients bénéficient de 10 000 jetons gratuits par mois)
...
<Tip>
**Fonctionnement de la facturation** : si un client utilise 25 000 jetons dans un mois, il sera facturé pour 15 000 jetons (25 000 - 10 000 gratuits) = 15 000 × 0,00001 $ = 0,15 $
</Tip>
</Step>
...
<Frame>
  <img src="/images/cookbooks/ai-chat-app/aggregation.png" alt="Jetons clients du compteur"/>
</Frame>
...
<Frame>
  <img src="/images/cookbooks/ai-chat-app/free-tier-test.png" alt="Test du palier gratuit"/>
</Frame>
...
<CardGroup cols={2}>
  <Card title="LLM Blueprint" icon="robot" href="/developer-resources/ingestion-blueprints/llm">
    En savoir plus sur le blueprint LLM Ingestion
  </Card>
