...
{/* LOCKED_PATTERN_c21ea96b1e20037b291044a1d897b04e */}
  Référence de l'API pour créer des produits d'abonnement et gérer le cycle de vie des abonnements
</Card>
{/* LOCKED_PATTERN_08ed481caa915d7a238364a556427420 */}
  Référence de l'API pour mettre à niveau, rétrograder ou changer les plans d'abonnement avec des options de prorata
</Card>
{/* LOCKED_PATTERN_2047d0ff0f7dc8f82d1032143e196fd0 */}
  Référence de l'API pour mettre à jour les méthodes de paiement et réactiver les abonnements en attente
</Card>
{/* LOCKED_PATTERN_e887d5c7e993031251906dd3e3d548dc */}
  Référence de l'API pour mettre à jour les détails de l'abonnement et la configuration
</Card>
