...
|----------|------|----------|-------------|
| `business_id` | string | Oui | Identifiant unique de l’entreprise |
| `timestamp` | string | Oui | Horodatage du moment où l’événement s’est produit (pas nécessairement identique à celui de sa livraison) |
| `type` | string | Oui | Type d’événement. Consultez [Types d’événements](#event-types) |
| `data` | object | Oui | Payload principal des données. Consultez [Objet de données](#data-object) |
