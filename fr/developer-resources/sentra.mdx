---
title: Sentra
description: Install the Sentra extension for VS Code, Cursor, or Windsurf to
  integrate billing and payments into your app using AI-powered assistance.
icon: code
keywords:
  - Dodo Payments
...
1. Connectez-vous à votre [tableau de bord Dodo Payments](https://app.dodopayments.com).
2. Accédez à **Développeur** › **Clés API**.
...
<Frame>
  <img
    ...
    alt="Interface Sentra montrant l'entrée de l'invite avec exemple de tâche"
    width="50%"
  style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
