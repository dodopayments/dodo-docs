...
{/* LOCKED_PATTERN_848a353666469e7a047ef05af5a45770 */}
    Intégrez le paiement Dodo Payments à votre application Fastify.
</Card>
...
{/* LOCKED_PATTERN_28fd81a4703a84d931eeff69f1520d54 */}
  <Info>
  Utilisez ce gestionnaire pour intégrer le paiement Dodo Payments à votre application Fastify. Il prend en charge les flux de paiement statiques (GET), dynamiques (POST) et par session (POST).
  </Info>
  <CodeGroup>
...
{/* LOCKED_PATTERN_0026b036379d81a9d03c36b3b6e83ddd */}
  <Info>
  Utilisez ce gestionnaire pour recevoir et traiter en toute sécurité les événements webhook de Dodo Payments dans votre application Fastify.
  </Info>
  <CodeGroup>
...
Désactiver le champ ligne d'adresse.
</ParamField>
...
- Pour obtenir la liste complète des champs du corps POST pris en charge, consultez :
...
Les sessions de paiement offrent une expérience de paiement hébergée plus sécurisée qui gère l'intégralité du flux de paiement tant pour les achats ponctuels que pour les abonnements, avec un contrôle total de la personnalisation.
...
Si la valeur est <code>true</code>, envoie un e-mail au client contenant le lien du portail.
</ParamField>
