...
<Info>
Ce modèle utilise Astro 5 avec TypeScript, Tailwind CSS 4, et le `@dodopayments/astro` adaptateur.
</Info>
...
Remplacez le `CUSTOMER_ID` codé en dur dans `src/components/Header.astro` par un identifiant client réel de votre tableau de bord Dodo.
