...
<Note>
Imaginez vendre un abonnement numérique à un utilisateur en France. Avec Dodo Payments, nous collectons le paiement, déclarons la TVA auprès des autorités françaises, et vous envoyons le revenu net. Pas de maux de tête fiscaux. Pas d'avocats. Juste de la croissance.
</Note>
...
Avec Dodo Payments en tant que MoR :
...
<Tip>
"Pensez à une passerelle de paiement comme à un tunnel. Maintenant, imaginez le Merchant of Record comme un tunnel, un train, un conducteur et un personnel de billetterie tout-en-un."
</Tip>
...
- Votre entreprise opère uniquement dans un pays
...
<Note>
Pour de nombreuses startups, utiliser une passerelle peut suffire au départ - mais à mesure que la complexité augmente, passer à un MoR peut faire gagner du temps, réduire les risques et accélérer la croissance internationale.
</Note>
...
<CardGroup cols={2}>
<Card title="Support de Devises Adaptatif" icon="money-bill-wave" href="/features/adaptive-currency">
Découvrez comment Dodo présente automatiquement les prix dans les devises locales de vos clients
</Card>

<Card title="Méthodes de Paiement Supportées" icon="credit-card" href="/features/payment-methods">
Découvrez les 30+ méthodes de paiement disponibles via Dodo Payments
</Card>
</CardGroup>
...
<CardGroup cols={2}>
<Card title="Inscrivez-vous Gratuitement" icon="user-plus" href="https://app.dodopayments.com/signup">
Créez votre compte Dodo Payments et commencez à vendre à l'échelle mondiale dès aujourd'hui
</Card>

<Card title="Parlez à l'Équipe Commerciale" icon="envelope" href="mailto:founders@dodopayments.com">
Obtenez des conseils personnalisés de notre équipe
</Card>
</CardGroup>

<Tip>
Laissez Dodo gérer les choses difficiles - afin que vous puissiez vous concentrer sur la création d'un excellent produit.
</Tip>