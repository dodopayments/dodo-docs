...
Utilisez le point de terminaison `POST /addons` pour créer de nouveaux modules complémentaires avec des prix personnalisés, des descriptions et des options de configuration.
...
Modifiez les modules complémentaires existants à l'aide du point de terminaison `PATCH /addons/{id}` pour mettre à jour les prix, les descriptions ou la disponibilité.
...
Mettez à jour les images des modules complémentaires à l'aide du point de terminaison `PUT /addons/{id}/images` pour une meilleure présentation du produit.
