...
- **Tarification** : Définissez une tarification unique ou récurrente pour le module complémentaire
- **Devise** : Définissez le prix de base dans n’importe quelle devise que Dodo Payments peut facturer. Le sélecteur de devises avec recherche épingle **USD, GBP, EUR et INR** en haut de la liste ; les clients dont la devise ne correspond pas à votre devise de base sont facturés via [Adaptive Currency](/features/adaptive-currency)
- **Cycle de facturation** : Doit correspondre au cycle de facturation de votre abonnement
- **Limites de quantité** : Définissez les quantités minimale et maximale par client
- **Disponibilité** : Contrôlez les produits d’abonnement pouvant utiliser le module complémentaire
