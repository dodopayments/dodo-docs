...
4. Vérifiez que les événements ont des timestamps corrects (pas de dates futures)
</Accordion>
...
3. Envisagez d'utiliser `difference_immediately` pour une facturation des mises à niveau plus simple
</Accordion>
