...
| Statut               | Description                                                                              |
|----------------------|------------------------------------------------------------------------------------------|
| Non initié           | La date d'échéance du versement n'est pas encore arrivée, il n'a donc pas été initié     |
| En cours             | La date d'échéance du versement est arrivée et le versement est en cours                 |
| En attente           | Le versement est mis en attente par l'équipe des versements (par le backend jusqu'à ce que le tableau de bord administrateur soit disponible) |
| Réussi               | Le versement sur le compte professionnel a été traité avec succès                       |
| Échoué               | Le versement sur le compte professionnel a échoué                                        |
...
>
  Obtenez une vue d'ensemble complète de tous les soldes de vos portefeuilles USD, GBP et EUR, des journaux de transactions et de l'activité financière liée aux versements.
</Card>
