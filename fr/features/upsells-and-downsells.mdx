...
|------|----------|----------|
| `difference_immediately` | Facture instantanément la différence de prix ($30→$80 = $50) | Mises à niveau simples |
...
| `full_immediately` | Facture le prix total du nouveau forfait, sans tenir compte du temps restant | Réinitialisation du cycle de facturation |
| `do_not_bill` | Applique la modification du forfait sans frais immédiats ; le nouveau forfait est facturé au prochain renouvellement et la date de facturation initiale est conservée | Mises à niveau offertes et migrations gratuites |
...
<Info>
Les crédits provenant des rétrogradations utilisant `difference_immediately` sont liés à l’abonnement et appliqués automatiquement aux renouvellements futurs. Ils sont distincts des droits de [Credit-Based Billing](/features/credit-based-billing).
</Info>
