...
<Step title="Accéder aux Informations de Paiement Associées">
    Dans les détails du litige, localisez le champ <strong>Paiement Associé</strong>. Cliquez sur l'<strong>icône en forme d'œil</strong> ici pour voir les détails complets du paiement lié au litige.
</Step>
</Steps>
...
## Meilleures Pratiques pour Répondre aux Litiges
...
<Step title="Formater & Soumettre les Preuves">
