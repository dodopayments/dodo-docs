...
<Steps>
  ...
  <Step title="Transmettez les données de référence à Dodo Payments">
    ...
    <Callout type="info">
      Pour plus de détails, consultez la [documentation API de Dodo Payments](https://docs.dodopayments.com/api-reference/introduction)
    </Callout>
  </Step>
  ...
  <Step title="Tester votre intégration">
    ...
    **Liste de vérification des tests :**
    ...
    - ✅ Visitez votre site web via le lien d'affilié
    - ✅ Assurez-vous que le script Affonso se charge et que le cookie `affonso_referral` est configuré
    - ✅ Complétez une inscription (facultatif)
...
<Info>
Pour des instructions détaillées sur la configuration, consultez notre [guide d'intégration Dub](/integrations/dub) qui couvre comment suivre les événements de conversion de vente et attribuer des revenus à vos liens d'affiliation.
</Info>

### Configuration rapide avec Dub Partners

1. **Activez le suivi des conversions** dans votre tableau de bord Dub pour les liens d'affiliés
2. **Capturez l'ID de clic de Dub** (`dub_id` cookie) lors de la création de sessions de paiement
...
<Card title="En savoir plus" icon="book" href="/integrations/dub">
...
<CardGroup cols={2}>
  ...
  <Card title="Support Dub" icon="headset">
    - Visitez la [documentation Dub](https://dub.co/docs) pour des guides de suivi des conversions
  ...
  <Card title="Guides d'intégration" icon="book">
