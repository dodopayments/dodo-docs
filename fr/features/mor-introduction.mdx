...
Oui. Avec [Bring Your Own Processor (BYOP)](/features/byop), vous pouvez connecter votre propre compte Stripe ou Adyen et y acheminer les paiements provenant de pays sélectionnés, tandis que Dodo Payments continue de gérer les produits, les abonnements, la facturation et les analyses. Les pays que vous ne routez pas explicitement continuent de passer par Dodo Payments en tant que Merchant of Record à service complet, ce qui nous permet d’assumer la responsabilité fiscale et la responsabilité liée à la fraude sur ces routes.
</Accordion>
