...
1. Un prélèvement pour les montants dus restants
2. Une facture
3. Le traitement du paiement avec le nouveau mode de paiement
4. La réactivation de l'abonnement à l'état `active` après un paiement réussi
...
Mettez à jour le mode de paiement pour un abonnement. Pour les abonnements actifs, cela met à jour le mode de paiement pour les renouvellements futurs. Pour les abonnements dans l'état `on_hold`, cela réactive l'abonnement en créant un prélèvement pour les montants dus restants.
...
### Sessions de caisse (abonnements)
Lors de la création de sessions de caisse, incluez votre produit d'abonnement et des options supplémentaires facultatives :
