...
Les crédits sont attachés aux produits en tant que **droits** dans le processus de création ou de modification des produits. Vous pouvez attacher jusqu'à **5 crédits par produit**. Les crédits fonctionnent avec les trois types de tarification.
