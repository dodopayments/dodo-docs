...
<img src="/images/CBB/Checkout.png" alt="Caisse montrant les crédits inclus avec l'achat du produit" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
Définissez les crédits selon votre propre unité : tokens, appels API, heures de calcul ou toute autre métrique pertinente pour votre produit. Les unités personnalisées utilisent la précision que vous définissez (de 0 à 10 décimales).
...
| Source | Description |
|--------|-------------|
| **Abonnement** | Crédits accordés lors de l’achat d’un abonnement, puis réattribués à chaque cycle de facturation |
| **Ponctuel** | Crédits accordés avec un produit acheté ponctuellement |
| **Extension** | Crédits accordés avec une extension ajoutée à un abonnement |
| **API** | Crédits accordés manuellement via l’API ou le tableau de bord |
| **Report** | Crédits reportés du cycle de facturation précédent |
...
<img src="/images/CBB/Desktop - Entitlements  - Credits.jpg" alt="Page de liste des crédits montrant les droits de crédit créés" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Create Credit.jpg" alt="Formulaire de création de crédit montrant les informations de base, les paramètres généraux et les paramètres d'abonnement" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
Uniquement pour les crédits d’unité personnalisée. Nombre de décimales autorisées, de `0` à `10` :

- `0` - Nombres entiers (idéal pour les éléments dénombrables comme les appels API)
- `1` - Une décimale (0,0)
- `2` - Deux décimales (0,00) - **par défaut**
- `3` - Trois décimales (0,000)
- Jusqu’à `10` - Pour les unités nécessitant une grande précision (p. ex. les tokens fractionnaires ou la micro-utilisation)
...
<img src="/images/CBB/Desktop - Attach Credit - Subscription.jpg" alt="Section des droits de produit montrant le bouton d'attachement des crédits" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - Subscription-2.jpg" alt="Panneau Ajouter des crédits avec menu déroulant de sélection de crédit" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Attach Credit - Subscription-4.jpg" alt="Formulaire de configuration des crédits avec cycle de facturation, période d'essai et paramètres de proration" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - Subscription-5.jpg" alt="Panneau Ajouter des crédits montrant les crédits sélectionnés avec détails" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
</Steps>
...
<img src="/images/CBB/Desktop - Attach Credit - OTP.jpg" alt="Section des prix du produit avec Paiement unique sélectionné" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - UBB-3.jpg" alt="Panneau Sélectionner un compteur montrant le seuil gratuit et le basculement des crédits" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - UBB-5.jpg" alt="Configuration du compteur avec sélection de crédits et unités de compteur par crédit" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - UBB-6.jpg" alt="Configuration de crédits pour le produit UBB" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - UBB-1.jpg" alt="Compteur configuré montrant les détails de l'attachement des crédits" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
</Steps>
...
<img src="/images/CBB/Desktop - Usage Billing.jpg" alt="Tableau de bord de facturation à l'utilisation montrant le tableau d'événements avec crédits consommés" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Checkout.png" alt="Page de caisse montrant le produit avec crédits d'appels API inclus" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Customer Portal.jpg" alt="Vue du portail client des crédits avec solde et historique des transactions" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Subscription Details.jpg" alt="Page des détails de l'abonnement montrant les droits et l'historique d'utilisation" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Transactions - Payment Summary.jpg" alt="Page des détails de la transaction montrant les droits de crédit" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Entitlements  - Credits.jpg" alt="Page de liste des crédits dans la section Produits" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Customer Details.jpg" alt="Page des détails du client avec l'onglet Crédits montrant le solde et les transactions" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
|---------------------|-------------|
| **Crédit ajouté** | Crédits accordés (abonnement, achat ponctuel ou API) |
| **Crédit déduit** | Crédits consommés via l’utilisation ou un débit manuel |
...
| **Dépassement facturé** | Utilisation dépassant le solde de crédits lorsque la facturation des dépassements est activée |
| **Réinitialisation du dépassement** | Dépassement suivi effacé lors de la réinitialisation du cycle de facturation |
| **Recharge automatique** | Réapprovisionnement automatique des crédits lorsque le solde est faible |
...
| `credit.deducted` | Crédits consommés via l’utilisation ou un débit manuel |
| `credit.expired` | Crédits inutilisés expirés |
| `credit.rolled_over` | Crédits reportés vers une nouvelle attribution |
...
| `credit.overage_reset` | Le dépassement suivi a été réinitialisé à la fin du cycle de facturation |
| `credit.manual_adjustment` | Ajustement manuel du crédit/débit effectué |
| `credit.balance_low` | Le solde est passé sous le seuil configuré |

Tous les événements du registre (chaque événement `credit.*` à l’exception de `credit.balance_low`) incluent la payload complète `CreditLedgerEntry` avec le solde avant/après, le dépassement avant/après, la référence de la source et le `metadata` de l’abonnement ou du paiement source de l’attribution (vide pour les attributions créées directement via l’API). L’événement `credit.balance_low` inclut la configuration du seuil et le solde actuel.
