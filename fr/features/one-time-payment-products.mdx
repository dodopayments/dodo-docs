...
Utilisez `GET /payments` pour lister les paiements et `GET /payments/{payment_id}` pour en récupérer un. Récupérez les lignes d'articles avec `GET /payments/{payment_id}/line-items`.
