...
<Frame>
  <img src="/images/products.png" alt="Produits à paiement unique" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
Utilisez `POST /checkouts` pour créer des frais uniques à partir de produits.
