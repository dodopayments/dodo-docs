...
sidebarTitle: BNPL
description: Offer Klarna, Afterpay, Billie, and Sunbit installment payments to
  increase average order value and conversion. Learn about eligibility, minimum
  amounts, and testing.
icon: calendar-days
keywords:
  - Dodo Payments
