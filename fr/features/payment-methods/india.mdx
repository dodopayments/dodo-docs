...
| Niveau | Où définir | Portée |
|-------|--------------|-------|
| **Par requête** | `mandate_min_amount_inr_paise` sur une session de paiement ou un abonnement | Une transaction |
| **Marchand** | Paramètres de l’entreprise | Tous vos abonnements en INR |
| **Système** | — | 15 000 ₹ par défaut |
