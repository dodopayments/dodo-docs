...
description: Acceptez UPI et toutes les cartes émises en Inde avec des mandats
  d'abonnement conformes à la RBI. Comprenez le délai de traitement de 48
  heures, les limites de mandat et la gestion des webhooks.
...
**Solution :** Ceci est prévu. Construisez votre système pour gérer des délais variables allant jusqu'à environ 51 heures au total.
</Accordion>

<Accordion title="Mandate cancelled but subscription still active">
**Cause :** Cas particulier dans les réglementations RBI — l'annulation d'un mandat pendant la fenêtre de traitement ne résilie pas immédiatement l'abonnement.

**Solution :** Le prochain prélèvement échouera et l'abonnement passera à `on_hold`. Surveillez les webhooks pour `payment.failed`.
</Accordion>
</AccordionGroup>
...
<Card title="Subscriptions" icon="repeat" href="/features/subscription">
Documentation complète de l'abonnement y compris les mandats RBI.
</Card>
