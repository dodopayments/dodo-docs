...
Créez une session de paiement avec `crypto_currency` dans les méthodes de paiement autorisées.
</Step>
...
**Vérification :**
1. `crypto_currency` est-il inclus dans `allowed_payment_method_types` ?
2. Le montant de la transaction respecte-t-il le minimum (0,50 $) ?
