...
Lorsque vous êtes invité à saisir un CPF Pix, entrez `1234567890`. Un code QR de test sera généré — scannez-le avec l’appareil photo habituel de votre téléphone (aucune application Pix n’est nécessaire). Vous serez redirigé vers une page de test où vous pourrez simuler la réussite ou l’échec de la transaction.
</Step>
</Steps>
