...
Créez une session de paiement avec `we_chat_pay` dans les méthodes de paiement autorisées.
</Step>
...
**Vérifiez :**
1. `we_chat_pay` inclus dans `allowed_payment_method_types` ?
2. Devise de facturation réglée sur USD ou CNY ?
3. Le montant de la transaction respecte-t-il le minimum ?
