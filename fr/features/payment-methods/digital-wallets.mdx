...
Le fichier doit être accessible sans redirections et être servi avec `Content-Type: application/octet-stream` ou `text/plain`.
</Step>
...
<Warning>
Apple Pay nécessite HTTPS. Il n'apparaîtra pas sur `localhost` sans une configuration SSL correcte.
</Warning>
...
<Accordion title="Inclure toujours les alternatives de carte">
...
<AccordionGroup>
<Accordion title="Bouton Apple Pay n'apparaît pas">
**Vérifiez :**
...
<Accordion title="Bouton Google Pay n'apparaît pas">
**Vérifiez :**
1. Utilisation de Chrome ou d'un navigateur compatible ?
2. Le client a des cartes dans Google Pay ?
3. Paramètre Chrome "Autoriser les sites à vérifier les méthodes de paiement" activé ?
