...
<Frame>
<img src="/images/usage-based/UBB-2.png" alt="Interface de création de compteur montrant le nom de l'événement, le type d'agrégation et les options de filtrage" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/usage-based/UBB-3.png" alt="Filtrage d'événements" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
**Opérateurs de comparaison** : égal à, différent de, supérieur à, supérieur ou égal à, inférieur à, inférieur ou égal à, contient, ne contient pas
...
<Frame>
<img src="/images/usage-based/UBB-1.png" alt="Analytique de compteur" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Attach Credit - UBB-5.jpg" alt="Configuration du compteur avec la facturation de l'utilisation en bascule des crédits activée" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
