...
Horodatage ISO 8601 (UTC). Utilise par défaut l’heure actuelle du serveur s’il est omis. Incluez-le pour une facturation précise avec des événements différés ou groupés. Les horodatages datant de plus d’une heure ou de plus de 5 minutes dans le futur sont rejetés.
</ParamField>
