...
La Page Clients affichera une liste de tous les clients actuels et passés ayant interagi avec votre entreprise.
</Step>
</Steps>

<Frame>
<img src="/images/customer/customers-list.png" alt="Page de liste des clients affichant tous les clients avec leurs détails"/>
</Frame>
...
<Frame>
<img src="/images/customer/customer-details.png" alt="Page de détails du client affichant les informations du client et l'historique des transactions"/>
</Frame>
...
Les Portefeuilles Clients vous permettent de construire des systèmes de facturation basés sur le crédit similaires à OpenAI ou Claude. Chaque client reçoit automatiquement un portefeuille pouvant contenir des crédits prépayés dans plusieurs devises.
