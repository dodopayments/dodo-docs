...
description: Learn how to legally bypass Apple and Google's 30% app store fees
  using Merchant of Record solutions and compliant payment strategies
icon: shield-check
keywords:
  - Dodo Payments
...
**Ce que c’est :** Intégrez une interface de paiement — telle qu’un SDK tiers natif — directement dans votre application afin de permettre un paiement fluide sans obliger les utilisateurs à quitter l’application.
