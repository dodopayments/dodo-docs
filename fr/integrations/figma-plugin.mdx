...
- **Support d'environnement** : Configurable pour les environnements de test et de production  
- **Proxy CORS** : Utilise un proxy Cloudflare Worker pour gérer les restrictions CORS
- **Support TypeScript** : Implémentation entièrement typée avec gestion appropriée des erreurs

## Prise en main

<Steps>
<Step title="Créer un Plugin de Base">
Créez votre propre projet de plugin Figma en utilisant le [guide de démarrage rapide des plugins Figma](https://www.figma.com/plugin-docs/plugin-quickstart-guide/). Cela générera une structure avec un fichier `manifest.json`.
...
Cet exemple sert de point de départ pour votre intégration.
...
1. **Saisie de l'Utilisateur** : Les utilisateurs saisissent leur clé de licence dans l'interface utilisateur du plugin
...
2. Testez en profondeur à la fois en mode test et en mode production
...
L'implémentation complète de l'exemple est disponible à : [github.com/dodopayments/dodopayments-figma](https://github.com/dodopayments/dodopayments-figma)
