...
L'intégration de Dodo Payments avec Slack vous permet de recevoir des notifications en temps réel concernant vos paiements directement dans votre espace de travail Slack. Cette intégration vous permet de rester informé sur l'état de vos paiements, de suivre les transactions et de gérer vos paiements plus efficacement.
...
<Step title="Accorder les autorisations Slack">
  Accordez les autorisations nécessaires à l'application Incoming Webhooks Slack afin qu'elle puisse publier des messages dans le canal de votre choix.
  <Frame>
...
### Notifications d'abonnement enrichies
...
### Gestionnaire complet de tous les événements
