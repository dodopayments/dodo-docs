...
<Step title="Open the Webhook Section">
  Dans votre tableau de bord Dodo Payments, naviguez vers <b>Webhooks → + Ajouter un point de terminaison</b> et développez le menu déroulant des intégrations.
  <Frame>
    <img src="/images/integrations/windmill.png" alt="Ajouter un point de terminaison et menu déroulant des intégrations" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
