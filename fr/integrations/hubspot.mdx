...
<Step title="Ouvrir la section Webhook">
  ...
  <Frame>
    <img src="/images/integrations/hubspot.png" alt="Ajouter un point de terminaison et menu déroulant des intégrations" />
  </Frame>
</Step>

<Step title="Sélectionner HubSpot">
  Choisissez la carte d'intégration <b>HubSpot</b>.
</Step>

<Step title="Connecter HubSpot">
  Cliquez sur <b>Connecter à HubSpot</b> et autorisez les portées OAuth requises.
</Step>
...
- Utilisez l'explorateur d'API de HubSpot pour tester la création d'objets
...
<AccordionGroup>
<Accordion title="Enregistrements non créés dans HubSpot">
