...
<Step title="Open the Webhook Section">
  Dans votre tableau de bord Dodo Payments, ouvrez <b>Webhooks → + Ajouter un Endpoint</b> et développez le menu déroulant pour révéler les intégrations.
  <Frame>
    <img src="/images/integrations/discord.png" alt="Ajouter Endpoint et menu déroulant des intégrations" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
