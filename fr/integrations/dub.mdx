...
<Tip>
**Intégration du programme d'affiliation** : Cette intégration fonctionne également parfaitement avec **Dub Partners** pour le suivi des références et des commissions d'affiliation. Utilisez le suivi des conversions de Dub pour attribuer les ventes à vos liens d'affiliation et mesurer la performance des partenaires. En savoir plus sur la configuration des programmes d'affiliation dans notre [guide des fonctionnalités Affiliés](/features/affiliates).
</Tip>
...
1. **Capturer l'identifiant de clic de Dub** à partir du cookie `dub_id` lors de la création des sessions de paiement
...
<Step title="Activer le suivi des conversions dans Dub">
  Dans votre tableau de bord Dub, activez le suivi des conversions pour les liens pour lesquels vous souhaitez suivre les ventes. Cela permet à Dub d'enregistrer les événements de vente lorsque les clients finalisent leurs achats.
...
<Step title="C'est fait !">
  Les événements de conversion de vente apparaîtront maintenant dans votre tableau de bord d'analytique Dub avec une attribution complète à vos liens.
</Step>
</Steps>

## Guide de mise en œuvre

### Étape 1 : Ajouter l'identifiant de clic et l'identifiant client aux métadonnées de paiement
...
### Suivre les ventes avec exclusion de la taxe

Envoyez uniquement le montant avant impôt à Dub pour un suivi précis des revenus :
...
- Assurez-vous que vous ne suivez que sur les événements {/* INLINE_CODE_PLACEHOLDER_bfeed7a4ab5393d394108752765f7cfb */, pas `payment.processing`
...
<CardGroup cols={2}>
<Card title="Documentation des conversions Dub" icon="book" href="https://dub.co/docs/conversions/quickstart">
  En savoir plus sur le suivi des conversions et les fonctionnalités d'analyse de Dub.
</Card>
...
<Card title="Guide des événements Webhook" icon="webhook" href="/developer-resources/webhooks/intents/webhook-events-guide">
  En savoir plus sur tous les événements webhook disponibles de Dodo Payments.
</Card>
</CardGroup>
