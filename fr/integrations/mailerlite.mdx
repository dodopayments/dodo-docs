...
<Step title="Sélectionner MailerLite">
...
<Step title="Tester et créer">
  Testez avec des charges utiles d'exemple et cliquez sur <b>Créer</b> pour activer la synchronisation des abonnés.
</Step>
...
<AccordionGroup>
<Accordion title="Les abonnés ne sont pas ajoutés">
...
<Accordion title="Les champs personnalisés ne se mettent pas à jour">
...
<Accordion title="Erreurs de limite de taux">
...
<Accordion title="L'attribution de groupe ne fonctionne pas">
...
|-----------|------|-------|-------------|
| `email` | chaîne | Oui | Adresse e-mail valide (RFC 2821) |
| `fields` | objet | Non | Objet avec des paires nom/valeur de champ |
| `fields.name` | chaîne | Non | Prénom de l'abonné |
| `fields.last_name` | chaîne | Non | Nom de famille de l'abonné |
| `fields.company` | chaîne | Non | Nom de l'entreprise |
| `fields.country` | chaîne | Non | Pays |
| `fields.city` | chaîne | Non | Ville |
| `fields.phone` | chaîne | Non | Numéro de téléphone |
| `groups` | tableau | Non | Tableau des IDs de groupe à ajouter à l'abonné |
| `status` | chaîne | Non | Un de : actif, désabonné, non confirmé, rebond, indésirable |
| `subscribed_at` | chaîne | Non | Date au format `yyyy-MM-dd HH:mm:ss` |
| `ip_address` | chaîne | Non | Adresse IP de l'abonné |
