...
| `fields` | object | Non | Objet avec des paires nom/valeur de champ |
...
| `groups` | array | Non | Tableau d'ID de groupe pour ajouter l'abonné |
| `status` | string | Non | Un des : actif, désinscrit, non confirmé, rebondi, indésirable |
