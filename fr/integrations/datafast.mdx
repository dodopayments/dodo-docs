...
<Step title="Open the Webhook Section">
  ...
  <Frame>
    <img src="/images/integrations/datafast/add.png" alt="Ajouter un point de terminaison et menu déroulant des intégrations" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
...
<Step title="Enter API Key">
  ...
  <Frame>
    <img src="/images/integrations/datafast/api-key.png" alt="Ajouter une clé API" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
