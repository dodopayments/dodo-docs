...
<Step title="Open the Webhook Section">
  ...
  <Frame>
    <img src="/images/integrations/teams.png" alt="Ajouter un point de terminaison et menu déroulant des intégrations" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
...
function handler(webhook) {
  if (webhook.eventType.startsWith("dispute.")) {
    ...
    const color = d.dispute_status === "dispute_won" ? "Good" : d.dispute_status === "dispute_lost" ? "Attention" : "Warning";
    const title = d.dispute_status === "dispute_won" ? "🏆 Dispute Won" : d.dispute_status === "dispute_lost" ? "❌ Dispute Lost" : "🚨 Dispute Update";
