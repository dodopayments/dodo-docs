...
<Step title="Entrer la clé API">
  ...
  <Card title="Apprenez à créer et gérer des clés API" icon="key" href="https://docs.autosend.com/api-keys">
    Consultez la documentation d'AutoSend pour des instructions détaillées sur la création et la gestion des clés API.
  </Card>
</Step>
...
- **Vérifiez votre domaine d'expéditeur** : Assurez-vous que votre domaine d'email d'expéditeur est vérifié dans AutoSend pour améliorer la délivrabilité et éviter les problèmes d'authentification. Les domaines vérifiés aident à prévenir les emails d'atterrir dans les dossiers de spam.
...
<AccordionGroup>
<Accordion title="Emails non envoyés">
