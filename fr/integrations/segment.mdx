...
<Step title="Ouvrir la section Webhook">
  ...
  <Frame>
    <img src="/images/integrations/segment.png" alt="Ajouter un point de terminaison et menu déroulant des intégrations" />
  </Frame>
</Step>

<Step title="Sélectionner Segment">
  Choisissez la carte d'intégration <b>Segment</b>.
</Step>

<Step title="Entrer la clé d'écriture">
...
### Identifier les propriétés des clients
...
<AccordionGroup>
<Accordion title="Événements n'apparaissant pas dans Segment">
...
- Assurez-vous que les noms d'événements sont des chaînes, et non des objets
</Accordion>
</AccordionGroup>