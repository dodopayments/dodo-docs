...
- `DISCOUNT_CONCURRENT_REDEMPTION`
  - **Déclencheur :** Une autre utilisation du même code a conservé le verrou de ligne de la limite d’utilisation trop longtemps
  - **Message :** La remise est utilisée simultanément ; veuillez réessayer
  - **Remarque :** Transitoire. Le code peut encore avoir de la capacité disponible, la requête peut donc être relancée sans risque. N’affichez pas ce message au client sous la forme « code épuisé ».
