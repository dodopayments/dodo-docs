...
- `DISCOUNT_CODE_EXPIRED`
  - **Déclencheur :** Code de réduction dépassé `expires_at` date
  - **Message :** Le code de réduction a expiré

- `DISCOUNT_CODE_USAGE_LIMIT_EXCEEDED`
  - **Déclencheur :** Code de réduction réutilisé après `usage_limit` atteint
  - **Message :** La limite d'utilisation ne peut pas être inférieure à times_used / La limite d'utilisation du code de réduction a été atteinte
...
- `INVALID_TAX_ID`
  - **Déclencheur :** Échec de la validation de la TVA/GST/TIN
...
- `LINE_ITEM_NOT_FOUND`
  ...
  - **Message :** L'article de ligne {id} introuvable dans le paiement

- `LINE_ITEM_PRORATED`
  - **Déclencheur :** Tentative de remboursement ou de mise à jour sur une ligne proratisée
...
- `LINE_ITEM_REFUND_AMOUNT_TOO_HIGH`
  ...
  - **Message :** Le montant de remboursement demandé pour l'article de ligne {id} incluant la taxe est {amount} ce qui est supérieur au montant payé {amount}

- `LINE_ITEM_REFUND_AMOUNT_TOO_LOW`
  - **Déclencheur :** Montant de remboursement en dessous du seuil minimum
  - **Message :** Le montant de remboursement demandé pour l'article de ligne {id} est {amount} ce qui est trop bas
...
- `PAYMENT_NOT_SUCCEEDED`
  - **Déclencheur :** Tentative de remboursement/processus d'un paiement non réussi
...
- `UNSUPPORTED_CURRENCY`
  ...
  - **Message :** La devise n'est pas actuellement prise en charge / Seuls les produits USD et INR sont actuellement pris en charge / Seuls USD et INR sont pris en charge pour le prix des addons / Ne peut demander que USD ou INR pour billing_currency / Devise non prise en charge / Devise inattendue pour les abonnements par carte indienne
