...
- `LINE_ITEM_REFUND_AMOUNT_TOO_HIGH`
  ...
  - **Message :** Montant de remboursement demandé pour l'article de ligne {id} incluant la taxe est {amount} qui est supérieur au montant payé {amount}
...
- `TOTAL_PAYMENT_AMOUNT_BELOW_MINIMUM_AMOUNT`
  ...
  - **Message :** Montant minimum de {display_str} est requis pour traiter le paiement
