...
description: Understand every Dodo Payments transaction failure code, whether it
  is a soft or hard decline, and the recommended action to recover the payment.
