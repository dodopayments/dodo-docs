...
- Les valeurs de métadonnées peuvent être une chaîne, un nombre ou un booléen ; les chaînes peuvent comporter jusqu'à 500 caractères
...
- Les métadonnées ne sont pas recherchables via notre API mais sont renvoyées dans les réponses de l'API et les webhooks
...
- Gardez les valeurs concises et significatives
