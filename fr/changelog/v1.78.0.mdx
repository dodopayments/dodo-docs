...
### 1. **Préférences de communication**
   ...
   <Frame>
     <img src="/images/communication-preferences/overview.png" alt="Vue d'ensemble des préférences de communication montrant les paramètres de notification" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
...
### 2. **Champs personnalisés dans les sessions de paiement**
   ...
   **Avantages**
   ...
   <Info>
   Les valeurs des champs personnalisés sont renvoyées dans le tableau `custom_field_responses` au sein des réponses de paiement et d’abonnement.
   </Info>

   En savoir plus : [Champs personnalisés de la session de paiement](/developer-resources/checkout-session#15-collecting-custom-fields)
