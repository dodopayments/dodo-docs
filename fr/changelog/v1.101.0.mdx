...
|---------|-------|-------|
| Checkout Sessions | `customer_business_name`, `feature_flags.allow_customer_editing_business_name` | 250 caractères max. ; l'indicateur est défini par défaut sur `false` |
| Payments | `customer_business_name` | 250 caractères max. |
| Subscriptions | `customer_business_name` | Définir ou effacer via `PATCH /subscriptions/{subscription_id}` |
