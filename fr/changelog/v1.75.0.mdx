...
### 1. **Collections de Produits**  
   ...
   <Frame>
     <img src="/images/product-collection/checkout-page.png" alt="Page de paiement de la collection de produits montrant plusieurs options de plan" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
