...
description: Enhanced Analytics Dashboard with comprehensive revenue and
  retention insights, Reports 2.0 with detailed business reporting capabilities,
  and improved subscription management features for better business intelligence
...
<Frame>
  <img src="/images/analytics/revenue-breakdown.png" alt="Tableau de bord de répartition des revenus montrant ARR projeté, répartition MRR et taux de croissance" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/images/analytics/retention.png" alt="Tableau de bord des analyses de rétention montrant le taux d'attrition des clients, le taux d'attrition des revenus et les tendances d'attrition" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/images/analytics/reports.png" alt="Tableau de bord Rapports 2.0 montrant divers types de rapports" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/images/analytics/payout.png" alt="Tableau de bord du rapport de paiement montrant des informations détaillées sur les paiements" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
