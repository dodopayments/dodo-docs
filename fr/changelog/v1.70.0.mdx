...
description: Inline checkout support, use existing payment methods for instant
  checkouts, manage subscription plans from dashboard, generate short payment
  links, skip success pages with redirect_immediately, and enable on-demand
...
1. **Inline Checkout - Fully Embedded Checkout Experiences (BETA)**  
   ...
   <Frame>
   <img src="/images/inline-checkout/cover.png" alt="Image de couverture de la caisse inline" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
...
3. **Subscription Plan Changes in Dashboard with Next Billing Date Updates**  
    ...
    <Frame>
    <img src="/images/changelog/subscription-plan-changes.png" alt="Modifications du plan d'abonnement dans le tableau de bord" style={{ maxHeight: '500px', width: 'auto' }} />
    </Frame>
...
4. **Short Links for Payment URLs**  
   ...
   <Frame>
   <img src="/images/changelog/short-links.png" alt="Fonctionnalité de liens courts pour les URL de paiement" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
