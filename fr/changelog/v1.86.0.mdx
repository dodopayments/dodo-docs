...
Les crédits sont ajoutés en tant que **droits** lors de la création de produit. Vous pouvez attacher jusqu’à **5 crédits par produit**, et les crédits fonctionnent avec les trois types de tarification : abonnements, paiements ponctuels et facturation à l’usage.
...
curl -X GET 'https://test.dodopayments.com/payments?dispute_status=dispute_opened' \
...
En savoir plus : [List Payments API](/api-reference/payments/get-payments)
