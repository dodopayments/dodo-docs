...
<Accordion title="Test regional methods with correct addresses">
Các phương thức thanh toán khu vực (UPI, iDEAL, v.v.) yêu cầu địa chỉ thanh toán phù hợp. Địa chỉ thanh toán ở Mỹ sẽ không hiển thị iDEAL.
</Accordion>

<Accordion title="Verify minimum amounts">
Các phương thức BNPL yêu cầu tối thiểu $50.01. Kiểm tra rằng chúng xuất hiện/ẩn đúng cách dựa trên tổng số giỏ hàng.
</Accordion>
</AccordionGroup>
...
<Card title="Webhooks" icon="webhook" href="/developer-resources/webhooks">
Thiết lập webhooks cho các sự kiện kiểm tra.
</Card>

<Card title="CLI Webhook Testing" icon="terminal" href="/developer-resources/sdks/cli#webhook-testing">
Kiểm tra webhooks cục bộ với Dodo Payments CLI.
</Card>
</CardGroup>
