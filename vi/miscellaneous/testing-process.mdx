...
Sử dụng [Dodo Payments CLI](/developer-resources/sdks/cli#webhook-testing) để kiểm thử webhooks trên local:
- `dodo wh listen` chuyển tiếp live test webhooks đến local server của bạn
- `dodo wh trigger` gửi mock payloads cho tất cả 22 event types
</Accordion>
