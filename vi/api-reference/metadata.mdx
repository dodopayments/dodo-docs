...
- Các khóa siêu dữ liệu có thể dài tới 40 ký tự
- Các giá trị siêu dữ liệu có thể là chuỗi, số hoặc boolean; chuỗi có thể dài tới 500 ký tự
- Các đối tượng, mảng và `null` không được chấp nhận làm giá trị siêu dữ liệu
- Bạn có thể có tối đa 50 cặp khóa-giá trị siêu dữ liệu mỗi đối tượng
- Khóa chỉ nên chứa các ký tự chữ và số, dấu gạch ngang và dấu gạch dưới
- Siêu dữ liệu không thể tìm kiếm được bằng API của chúng tôi nhưng được trả về trong các phản hồi API và webhook
