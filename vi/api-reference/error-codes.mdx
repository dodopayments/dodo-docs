...
- `DISCOUNT_CONCURRENT_REDEMPTION`
  - **Trigger:** Một lần đổi mã khác của cùng mã đã giữ khóa hàng giới hạn sử dụng quá lâu
  - **Message:** Giảm giá đang được đổi đồng thời; vui lòng thử lại
  - **Note:** Lỗi tạm thời. Mã vẫn có thể còn lượt sử dụng, vì vậy có thể an toàn thử lại yêu cầu. Không hiển thị lỗi này cho khách hàng dưới dạng "mã đã hết lượt sử dụng".
