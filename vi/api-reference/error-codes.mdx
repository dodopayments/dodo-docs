...
- `UNSUPPORTED_BILLING_CURRENCY`
  - **Trigger:** Đơn vị tiền tệ thanh toán được yêu cầu không được hỗ trợ cho subscription này
  - **Message:** Đơn vị tiền tệ thanh toán không phải USD không được hỗ trợ cho subscription
...
- `UNSUPPORTED_CURRENCY`
  - **Trigger:** Đơn vị tiền tệ của product hoặc addon không phải là đơn vị tiền tệ mà Dodo Payments có thể tính phí. Giá cơ bản có thể được thiết lập bằng bất kỳ đơn vị tiền tệ nào có thể tính phí, vì vậy điều này thường có nghĩa là mã tiền tệ không hợp lệ hoặc chưa được hỗ trợ.
  - **Message:** Đơn vị tiền tệ hiện chưa được hỗ trợ / Hiện chỉ hỗ trợ product bằng USD và INR / Chỉ hỗ trợ USD và INR cho giá addon / Chỉ có thể yêu cầu USD hoặc INR cho billing_currency / Đơn vị tiền tệ không được hỗ trợ / Đơn vị tiền tệ không mong đợi cho subscription sử dụng thẻ Ấn Độ
