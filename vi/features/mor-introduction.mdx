...
Có. Với [Bring Your Own Processor (BYOP)](/features/byop), bạn có thể kết nối tài khoản Stripe hoặc Adyen của riêng mình và định tuyến các khoản thanh toán từ những quốc gia được chọn qua đó, trong khi Dodo Payments tiếp tục vận hành các sản phẩm, gói đăng ký, hoạt động lập hóa đơn và phân tích. Các quốc gia mà bạn không định tuyến một cách rõ ràng vẫn tiếp tục được xử lý qua Dodo Payments với tư cách là Merchant of Record cung cấp dịch vụ đầy đủ, nhờ đó chúng tôi có thể chịu trách nhiệm pháp lý về thuế và gian lận trên các tuyến đó.
</Accordion>
