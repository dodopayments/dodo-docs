...
<CardGroup cols={2}>
<Card title="Thanh Toán Theo Chỗ Ngồi" icon="users" href="/developer-resources/seat-based-pricing">
Tạo tiện ích mở rộng cho các chỗ ngồi nhóm bổ sung, giấy phép người dùng hoặc nâng cấp dung lượng với giá theo chỗ ngồi.
</Card>

<Card title="Mở Rộng Sử Dụng" icon="bolt" href="/features/usage-based-billing">
Mở rộng giới hạn sử dụng, cuộc gọi API hoặc dung lượng dữ liệu với giá tiện ích mở rộng linh hoạt.
</Card>
</CardGroup>
...
<Steps>
<Step title="Lập Kế Hoạch Tiện ích mở rộng của Bạn">
...
<AccordionGroup>
<Accordion title="Tạo Add-ons">
Sử dụng điểm cuối `POST /addons` để tạo add-ons mới với giá tùy chỉnh, mô tả và tùy chọn cấu hình.

<Card title="Tài liệu API" icon="code" href="/api-reference/addons/create-addon">
Xem tài liệu API đầy đủ để tạo tiện ích mở rộng.
</Card>
</Accordion>

<Accordion title="Cập nhật Add-ons">
Chỉnh sửa các add-ons hiện có bằng cách sử dụng điểm cuối `PATCH /addons/{id}` để cập nhật giá cả, mô tả hoặc tình trạng có sẵn.

<Card title="Tài liệu API" icon="code" href="/api-reference/addons/update-addon">
Tìm hiểu cách cập nhật chi tiết tiện ích mở rộng một cách lập trình.
</Card>
</Accordion>

<Accordion title="Danh sách và Lấy lại">
Sử dụng `GET /addons` để liệt kê tất cả các add-ons hoặc `GET /addons/{id}` để lấy chi tiết cụ thể của một add-on.

<Card title="Tài liệu API" icon="code" href="/api-reference/addons/list-addons">
Truy cập tài liệu API đầy đủ về danh sách và lấy thông tin.
</Card>
</Accordion>

<Accordion title="Quản lý Hình ảnh">
Cập nhật hình ảnh add-on bằng cách sử dụng điểm cuối `PUT /addons/{id}/images` để có hình thức sản phẩm tốt hơn.
