...
- **Định giá**: Đặt số tiền add-on (`price`) theo đơn vị tiền tệ nhỏ nhất. Add-on được tính phí theo chu kỳ của subscription chính
- **Tiền tệ**: Đặt giá cơ bản bằng bất kỳ loại tiền tệ nào mà Dodo Payments có thể tính phí. Bộ chọn tiền tệ có thể tìm kiếm ghim **USD, GBP, EUR và INR** lên đầu; khách hàng sử dụng loại tiền tệ khác với tiền tệ cơ sở của bạn sẽ được tính phí thông qua [Adaptive Currency](/features/adaptive-currency)
- **Số lượng**: Khách hàng chọn số lượng khi add-on được thêm vào subscription
- **Tính khả dụng**: Kiểm soát những sản phẩm subscription nào có thể sử dụng add-on
- **Cài đặt thuế**: Cấu hình `tax_category`
