...
|---------|-------|-------|
| Checkout Sessions | `customer_business_name`, `feature_flags.allow_customer_editing_business_name` | Tối đa 250 ký tự; flag mặc định là `false` |
| Payments | `customer_business_name` | Tối đa 250 ký tự |
| Subscriptions | `customer_business_name` | Thiết lập hoặc xóa thông qua `PATCH /subscriptions/{subscription_id}` |
