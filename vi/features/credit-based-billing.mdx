...
<img src="/images/CBB/Checkout.png" alt="Trang thanh toán hiển thị tín dụng bao gồm với việc mua sản phẩm" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Entitlements  - Credits.jpg" alt="Trang danh sách tín dụng hiển thị quyền tín dụng đã tạo" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Create Credit.jpg" alt="Biểu mẫu tạo tín dụng hiển thị thông tin cơ bản, cài đặt chung và cài đặt đăng ký" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - Subscription.jpg" alt="Phần quyền sản phẩm hiển thị nút đính kèm Tín dụng" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - Subscription-2.jpg" alt="Bảng điều khiển Thêm Tín dụng với hộp chọn tín dụng" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Attach Credit - Subscription-4.jpg" alt="Biểu mẫu cấu hình tín dụng với chu kỳ thanh toán, thử nghiệm và các cài đặt phân chia" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - Subscription-5.jpg" alt="Bảng điều khiển Thêm Tín dụng hiển thị tín dụng đã chọn với chi tiết" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
</Steps>
...
<img src="/images/CBB/Desktop - Attach Credit - OTP.jpg" alt="Phần định giá sản phẩm với Tùy chọn Thanh toán Đơn đã chọn" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - UBB.jpg" alt="Cấu hình định giá dựa trên sử dụng" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - UBB-3.jpg" alt="Bảng chọn Meter hiển thị ngưỡng miễn phí và chuyển đổi tín dụng" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - UBB-5.jpg" alt="Cấu hình Meter với lựa chọn tín dụng và đơn vị đo lường mỗi tín dụng" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - UBB-6.jpg" alt="Cấu hình tín dụng cho sản phẩm UBB" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - UBB-1.jpg" alt="Meter đã cấu hình hiển thị chi tiết đính kèm tín dụng" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
</Steps>
...
<img src="/images/CBB/Desktop - Usage Billing.jpg" alt="Bảng điều khiển Hóa đơn Sử dụng hiển thị bảng sự kiện với tín dụng đã tiêu thụ" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Checkout.png" alt="Trang thanh toán hiển thị sản phẩm với tín dụng cuộc gọi API bao gồm" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Customer Portal.jpg" alt="Giao diện Cổng khách hàng hiển thị tín dụng với số dư và lịch sử giao dịch" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Subscription Details.jpg" alt="Trang chi tiết đăng ký hiển thị quyền lợi và lịch sử sử dụng" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Transactions - Payment Summary.jpg" alt="Trang chi tiết giao dịch hiển thị quyền lợi tín dụng" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Entitlements  - Credits.jpg" alt="Trang danh sách tín dụng trong phần Sản phẩm" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Customer Details.jpg" alt="Trang chi tiết khách hàng với tab Tín dụng hiển thị số dư và giao dịch" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
