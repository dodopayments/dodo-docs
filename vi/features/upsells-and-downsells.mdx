...
| Chế độ | Cách hoạt động | Phù hợp nhất cho |
|------|----------|----------|
| `difference_immediately` | Tính và thu ngay phần chênh lệch giá ($30→$80 = $50) | Nâng cấp đơn giản |
| `prorated_immediately` | Tính phí dựa trên thời gian còn lại trong chu kỳ thanh toán | Tính phí công bằng theo thời gian |
| `full_immediately` | Tính toàn bộ giá của gói mới, bỏ qua thời gian còn lại | Đặt lại chu kỳ thanh toán |
| `do_not_bill` | Áp dụng thay đổi gói mà không thu phí ngay; gói mới được tính phí vào lần gia hạn tiếp theo và giữ nguyên ngày thanh toán ban đầu | Nâng cấp hỗ trợ và chuyển đổi miễn phí |
