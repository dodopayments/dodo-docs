...
<Info>
Các khoản tín dụng từ việc hạ cấp sử dụng `difference_immediately` là theo phạm vi đăng ký và tự động áp dụng cho các lần gia hạn sau. Chúng khác với [Customer Credits](/features/customer-credit).
</Info>
