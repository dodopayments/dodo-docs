...
Đăng nhập vào Bảng điều khiển Merchant của bạn và đi tới Business → Business Settings.
</Step>
...
<Info>
Phí Adaptive Currency do khách hàng chịu, không phải người bán. 
</Info>
...
<Info>
Phí Adaptive Currency, thường là phí FX, không được hoàn lại.
</Info>
...
<Info>
Tất cả số tiền được làm tròn theo logic làm tròn nội bộ của Dodo Payments.
</Info>
...
Truyền `billing_currency` để đặt rõ ràng tiền thanh toán cho phiên.

<Info>
Khi Adaptive Pricing bị tắt, `billing_currency` bị bỏ qua.
</Info>
