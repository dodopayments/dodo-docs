...
Gói đăng ký Team Pro có giá \$99/tháng và bao gồm 5 chỗ. Nếu bạn có hơn 5 người dùng, bạn sẽ trả thêm \$15/tháng cho mỗi chỗ bổ sung.

Ví dụ: nếu nhóm của bạn cần 15 chỗ:
- Gói cơ bản: \$99/tháng (bao gồm 5 chỗ)
- Phần bổ sung: 10 chỗ bổ sung × \$15/tháng = \$150/tháng
- Tổng chi phí hàng tháng: \$99 + \$150 = \$249 cho 15 chỗ
...
<CardGroup cols={2}>
<Card title="Seat-Based Pricing Tutorial" icon="code" href="/developer-resources/seat-based-pricing">
  Hướng dẫn triển khai đầy đủ kèm mã.
</Card>

<Card title="Add-ons" icon="puzzle" href="/features/addons">
  Tìm hiểu chuyên sâu về hệ thống add-on.
</Card>

<Card title="Plan Changes & Proration" icon="arrows-rotate" href="/developer-resources/subscription-upgrade-downgrade">
  Xử lý các thay đổi đối với gói đăng ký.
</Card>
