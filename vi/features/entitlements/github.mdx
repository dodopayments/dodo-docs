...
sidebarTitle: GitHub
description: Grant customers collaborator access to a private GitHub repository
  at the permission level you choose, and revoke automatically on cancellation.
icon: github
keywords:
  - Dodo Payments
  - GitHub
