...
description: Manage prepaid monetary balances for your customers. Fund wallets,
  apply balances to subscription invoices, handle refunds as wallet funds, and
...
<Info>
Every customer automatically gets a wallet when you create their account. Wallets support USD, EUR, and GBP currencies with separate monetary balances for each.
</Info>

<Warning>
**Customer Wallets ≠ Credit-Based Billing**

Customer Wallets hold **real monetary balances** (USD, EUR, GBP) that can be applied to invoices and subscription payments.
...
<Info>
Currently, only **USD**, **EUR**, and **GBP** balances are available. The INR native wallet has been discontinued — see [Payout Structure](/features/payouts/payout-structure). INR remains supported as a transaction currency for UPI, RuPay, and Indian-card subscriptions.
</Info>
