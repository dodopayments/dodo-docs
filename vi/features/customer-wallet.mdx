...
description: Build credit-based billing systems like OpenAI or Claude with
  customer wallets. Track balances, manage credits, and create sophisticated
  financial workflows.
icon: wallet
tag: NEW
keywords:
...
<Frame>
  <img src="/images/customer/customer-wallet.png" alt="Ví Khách Hàng" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
