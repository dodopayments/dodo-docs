...
ISO 8601 timestamp (UTC). Mặc định là thời gian hiện tại của máy chủ nếu bị bỏ qua. Bao gồm giá trị này để tính phí chính xác cho các sự kiện bị trì hoãn/theo lô. Các timestamp cũ hơn 1 giờ hoặc sớm hơn thời điểm hiện tại quá 5 phút sẽ bị từ chối.
</ParamField>
