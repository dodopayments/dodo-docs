...
<Frame>
<img src="/images/usage-based/UBB-2.png" alt="Giao diện tạo đồng hồ đo hiển thị tên sự kiện, loại tổng hợp và các tùy chọn lọc" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/usage-based/UBB-3.png" alt="Lọc sự kiện" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
**Bộ so sánh**: bằng, không bằng, lớn hơn, lớn hơn hoặc bằng, nhỏ hơn, nhỏ hơn hoặc bằng, chứa, không chứa
...
<Frame>
<img src="/images/usage-based/UBB-1.png" alt="Phân tích đồng hồ đo" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Attach Credit - UBB-5.jpg" alt="Cấu hình đồng hồ đo với tùy chọn bật Tính phí sử dụng trong Tín dụng" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
