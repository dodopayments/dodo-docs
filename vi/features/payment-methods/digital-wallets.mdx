...
Gửi email **support@dodopayments.com** với:
...
<Warning>
Apple Pay yêu cầu HTTPS. Nó sẽ không xuất hiện trên `localhost` nếu không có cấu hình SSL phù hợp.
</Warning>
...
<Accordion title="Luôn bao gồm các phương thức thay thế thẻ">
Không phải tất cả khách hàng đều có ví điện tử. Luôn bao gồm `credit` và `debit` trong các phương thức cho phép của bạn.
</Accordion>
...
**Kiểm tra:**
1. Tên miền đã được xác minh với Dodo Payments?
2. Sử dụng HTTPS?
3. Thiết bị là iOS 17+ / Safari 17+ / iPadOS 17+?
4. Khách hàng có thẻ trong Apple Wallet không?
5. `apple_pay` có bao gồm trong `allowed_payment_method_types` không?
...
**Kiểm tra:**
1. Sử dụng Chrome hoặc trình duyệt tương thích?
2. Khách hàng có thẻ trong Google Pay không?
3. Cài đặt Chrome "Cho phép các trang kiểm tra phương thức thanh toán" đã được bật chưa?
4. `google_pay` có bao gồm trong `allowed_payment_method_types` không?
