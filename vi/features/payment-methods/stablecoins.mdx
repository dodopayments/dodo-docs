...
| :--- | :----- | :------ |
| `crypto` | Stablecoins | Toàn cầu (trừ IN) |
...
Tạo một phiên thanh toán với `crypto` trong các phương thức thanh toán được phép.
</Step>
...
**Kiểm tra:**
1. `crypto` có trong `allowed_payment_method_types` không?
2. Số tiền giao dịch đáp ứng tối thiểu ($0.50)?
