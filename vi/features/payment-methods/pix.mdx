...
Khi được yêu cầu nhập Pix CPF, hãy nhập `1234567890`. Một mã QR thử nghiệm sẽ được tạo — hãy quét mã bằng camera điện thoại thông thường của bạn (không cần ứng dụng Pix). Bạn sẽ được chuyển hướng đến một trang thử nghiệm, nơi bạn có thể mô phỏng giao dịch thành công hoặc thất bại.
</Step>
</Steps>
