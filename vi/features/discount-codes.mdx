...
Áp dụng mã trong khi thanh toán được lưu trữ với `discount_code` và các điều khiển UI.
</Card>
...
<Info>
Trong các Phiên giao dịch thanh toán, truyền `discount_code` để tự động áp dụng một mã, và thiết lập `feature_flags.allow_discount_code` để hiển thị trường đầu vào.
</Info>
