...
3. **Chọn Phản Hồi của Bạn**
   ...
   <Frame>
       <img src="/images/disputes/1.png" alt="Tạo Tranh Chấp" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
...
5. **Nếu Phản Đối**
   - Chuẩn bị nộp bằng chứng
   - Làm theo các thực hành tốt nhất bên dưới
   
   <Frame>
       <img src="/images/disputes/2.png" alt="Tạo Tranh Chấp" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
   
   <Frame>
       <img src="/images/disputes/3.png" alt="Tạo Tranh Chấp" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>

<Info>
Bạn có **10 ngày** để phản hồi một tranh chấp sau khi tranh chấp được tạo. Đồng hồ đếm ngược hiển thị trên tranh chấp trong dashboard của bạn phản ánh cùng khoảng thời gian này.
</Info>
...
<Frame caption="Visa RDR configuration in the Dodo Payments dashboard">
    <img src="/images/disputes/rdr.png" alt="Cài đặt Visa RDR hiển thị bật tắt và cấu hình ngưỡng" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Step title="Open the Disputes Settings">
    Điều hướng đến **Cài Đặt → Kinh Doanh** trong bảng điều khiển Dodo Payments của bạn và tìm phần **Visa Rapid Dispute Resolution (RDR)**.
</Step>
