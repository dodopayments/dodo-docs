...
- **Phản hồi API**: Đối tượng thanh toán và đăng ký bao gồm `custom_field_responses`
</Info>
...
<Info>
Phản hồi trường tùy chỉnh tự động được bao gồm trong payloads webhook (`payment.succeeded`, `subscription.active`, v.v.) và có thể được truy vấn qua API. Sử dụng chúng để làm giàu CRM của bạn, kích hoạt luồng onboard hoặc tùy chỉnh trải nghiệm khách hàng.
</Info>
