...
Trạng thái subscription đã kích hoạt dunning. Một trong các giá trị sau:
- `on_hold` — Subscription bị tạm dừng do thanh toán không thành công
- `cancelled` — Khách hàng đã hủy từ customer portal
</ParamField>
