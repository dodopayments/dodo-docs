...
| **Subscription Paused**  | `subscription.paused`    | Được kích hoạt khi subscription bị tạm dừng.                                        |
| **Subscription Renewed** | `subscription.renewed`   | Xảy ra khi subscription được gia hạn thành công.                              |
| **Subscription Plan Changed** | `subscription.plan_changed` | Được kích hoạt khi subscription được nâng cấp, hạ cấp hoặc thay đổi với các addon khác. |
| **Subscription Payment Method Updated** | `subscription.update_payment_method` | Được gửi khi phương thức thanh toán của subscription được cập nhật. Mang theo payload của Subscription. |
| **Subscription Cancelled** | `subscription.cancelled` | Được kích hoạt khi subscription bị merchant hoặc khách hàng hủy.         |
| **Subscription Failed**  | `subscription.failed`    |  Cho biết subscription không thành công. Điều này có nghĩa là chúng tôi không thể tạo mandate. |
