...
<Warning>
Bạn có **10 ngày** để phản hồi tranh chấp sau khi tranh chấp được tạo. Xem [Các phương pháp hay nhất để phản hồi tranh chấp](/features/transactions/disputes#dispute-response-best-practices) để biết các bằng chứng cần thu thập và cách định dạng.
</Warning>
