...
1. Chọn trang web của bạn → tab **Chức năng**
2. Nhấp vào chức năng `webhook`
3. Xem nhật ký theo thời gian thực và lịch sử gọi
...
| Vấn đề | Giải pháp |
|-------|----------|
| Xác minh không thành công | Kiểm tra khóa webhook từ bảng điều khiển DodoPayments là chính xác |
| Lỗi kết nối cơ sở dữ liệu | Xác minh chuỗi kết nối Neon và sử dụng kết nối nhóm |
| Không tìm thấy chức năng (404) | Chạy `netlify init` và `npm run deploy` lại |
