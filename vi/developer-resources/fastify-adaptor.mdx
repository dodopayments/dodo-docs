...
Địa chỉ email của Customer.
</ParamField>
<ParamField query="country" type="string">
Quốc gia của Customer.
</ParamField>
<ParamField query="addressLine" type="string">
Dòng địa chỉ của Customer.
</ParamField>
<ParamField query="city" type="string">
Thành phố của Customer.
</ParamField>
<ParamField query="state" type="string">
Tiểu bang/tỉnh của Customer.
</ParamField>
<ParamField query="zipCode" type="string">
Mã zip/mã bưu chính của Customer.
</ParamField>
