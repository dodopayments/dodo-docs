...
Đối với các khoản phí tiếp theo, sử dụng endpoint [POST /subscriptions/{subscription_id}/charge](/api-reference/subscriptions/create-charge) và chỉ định số tiền cần thu từ khách hàng cho giao dịch đó.
...
**Để tính phí đăng ký theo yêu cầu:**

Đối với các lần tính phí tiếp theo, sử dụng endpoint [POST /subscriptions/{subscription_id}/charge](/api-reference/subscriptions/create-charge) và chỉ định số tiền cần tính phí đối với khách hàng cho giao dịch đó.

<Note>
Để có hướng dẫn chi tiết từng bước—bao gồm cả ví dụ yêu cầu/phản hồi, chính sách thử lại an toàn, và xử lý webhook—xem <a href="/developer-resources/ondemand-subscriptions">Hướng dẫn Đăng Ký Theo Yêu Cầu</a>.
</Note>
