...
| `type` | string | Có | Loại sự kiện. Xem [Các loại sự kiện đăng ký](#subscription-event-types) |
| `data` | object | Có | Payload dữ liệu chính. Xem [Các payload webhook đăng ký](/developer-resources/webhooks/intents/subscription) |
