...
<Expandable title="Data object properties">
  ...
  Loại tài nguyên. Một trong những: `Payment`, `Subscription`, `Refund`, `Dispute`, `LicenseKey`, `CreditLedgerEntry`, `CreditBalanceLow`, `AbandonedCheckout`, `DunningAttempt`, hoặc `EntitlementGrant`.
  </ResponseField>
  
  Các trường bổ sung khác nhau tùy theo loại sự kiện. Xem tài liệu cụ thể cho sự kiện để biết đầy đủ các lược đồ.
</Expandable>
</ResponseField>
...
Công cụ tương tác này cho phép bạn chọn từ tất cả các loại sự kiện được hỗ trợ và gửi tải trọng giả lập thực tế đến điểm cuối của bạn. Nó lặp lại để bạn có thể kiểm thử nhiều sự kiện trong một phiên.
...
<Frame>
    <img src="/images/webhooks/logs.png" alt="Nhật ký" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
    <img src="/images/webhooks/activity.png" alt="Hoạt động" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/images/webhooks/alerting.png" alt="Cài đặt Cảnh báo Webhook hiển thị cấu hình thông báo qua email" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
