...
2. Tạo một sản phẩm (thanh toán một lần hoặc đăng ký). Sản phẩm đăng ký phải có giá ít nhất là **$1** (hoặc tương đương trong đồng tiền bạn chọn); các khoản dưới mức tối thiểu này không được hỗ trợ.
...
<Card title="Create Checkout Session" icon="code" href="/api-reference/checkout-sessions/create">
  Tham khảo API để tạo các phiên thanh toán an toàn, được lưu trữ cho các khoản thanh toán một lần và đăng ký
</Card>
<Card title="Create Payment Link" icon="link" href="/api-reference/payments/post-payments">
  Tham khảo API để tạo liên kết thanh toán động một cách lập trình
</Card>
</CardGroup>