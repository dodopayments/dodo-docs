...
- `subscription.plan_changed`: Đã thay đổi gói subscription (nâng cấp/hạ cấp/cập nhật add-on)
- `subscription.on_hold`: Tính phí thay đổi gói thất bại, các lần gia hạn đã bị dừng
- `payment.succeeded`: Tính phí ngay lập tức cho việc thay đổi gói thành công
...
- `subscription.plan_changed`: gói subscription đã được thay đổi (nâng cấp/hạ cấp/thay đổi add-on)
- `subscription.on_hold`: tính phí thất bại, các lần gia hạn đã bị dừng
- `subscription.renewed`: gia hạn thành công
- `payment.succeeded`: thanh toán cho việc thay đổi gói hoặc gia hạn thành công
