...
<Card title="Xử lý Thanh Toán" icon="cart-shopping" href="#checkout-route-handler">
    Tích hợp thanh toán Dodo Payments vào ứng dụng SvelteKit của bạn.
</Card>
...
<Info>
Tất cả các ví dụ đều giả định rằng bạn đang sử dụng SvelteKit App Router.
</Info>

<Tabs>
<Tab title="Xử lý Thanh Toán">
  <Info>
  Sử dụng trình xử lý này để tích hợp thanh toán Dodo Payments vào ứng dụng SvelteKit của bạn. Hỗ trợ các luồng thanh toán tĩnh (GET), động (POST) và phiên (POST).
  </Info>
  <CodeGroup>
...
<Tab title="Xử lý Cổng Thông Tin Khách Hàng">
  <Info>
  Sử dụng trình xử lý này để cho phép khách hàng quản lý đăng ký và thông tin của họ thông qua cổng thông tin khách hàng Dodo Payments.
  </Info>
  <CodeGroup>
...
<Tab title="Xử lý Webhook">
  <Info>
  Sử dụng trình xử lý này để nhận và xử lý các sự kiện webhook của Dodo Payments một cách an toàn trong ứng dụng SvelteKit của bạn.
  </Info>
  <CodeGroup>
