...
<Info>
SDK yêu cầu .NET Standard 2.0 hoặc phiên bản mới hơn. Nó hoạt động với ASP.NET Core, ứng dụng Console và các loại dự án .NET khác.
</Info>
...
Để lặp qua tất cả các kết quả trên tất cả các trang, sử dụng phương thức `Paginate`:
...
Đăng ký khách hàng trong `Program.cs`:
...
<CardGroup cols={2}>
<Card title="Kho lưu trữ GitHub" icon="github" href="https://github.com/dodopayments/dodopayments-csharp">
...
<Card title="Báo cáo sự cố" icon="bug" href="https://github.com/dodopayments/dodopayments-csharp/issues">
