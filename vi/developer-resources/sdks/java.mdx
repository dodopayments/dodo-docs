...
<Card title="An toàn kiểu" icon="shield-check">
  API kiểu mạnh với độ an toàn tại thời điểm biên dịch
</Card>

<Card title="An toàn với luồng" icon="bolt">
  An toàn cho việc sử dụng đồng thời trong các ứng dụng đa luồng
</Card>

<Card title="Mẫu Builder" icon="layer-group">
  Mẫu builder trực quan để xây dựng các yêu cầu
</Card>

<Card title="Hỗ trợ bất đồng bộ" icon="arrows-rotate">
...
<CardGroup cols={2}>
<Card title="Kho lưu trữ GitHub" icon="github" href="https://github.com/dodopayments/dodopayments-java">
...
<Card title="Báo cáo sự cố" icon="bug" href="https://github.com/dodopayments/dodopayments-java/issues">
