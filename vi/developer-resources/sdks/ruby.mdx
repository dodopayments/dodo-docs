...
<Tip>
Luôn sử dụng phiên bản SDK mới nhất để truy cập các tính năng Dodo Payments mới nhất. Chạy `bundle update dodopayments` thường xuyên để luôn được cập nhật.
</Tip>
