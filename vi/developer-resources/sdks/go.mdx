...
<Warning>
Luôn lưu trữ các khóa API của bạn một cách an toàn bằng cách sử dụng biến môi trường. Không bao giờ mã hóa chúng trong mã nguồn của bạn.
</Warning>

## Tính năng chính

<CardGroup cols={2}>
<Card title="Hỗ trợ Context" icon="clock">
  Hỗ trợ đầy đủ cho context.Context để hủy bỏ và thời gian chờ
</Card>

<Card title="Kiểu mạnh" icon="shield-check">
  Yêu cầu và phản hồi có kiểu mạnh để đảm bảo an toàn tại thời điểm biên dịch
</Card>

<Card title="Middleware" icon="layer-group">
  Hỗ trợ middleware có thể mở rộng cho logging, metrics và logic tùy chỉnh
</Card>

<Card title="An toàn Goroutine" icon="bolt">
  Client an toàn cho luồng được thiết kế cho các hoạt động đồng thời
</Card>
</CardGroup>
...
<CardGroup cols={2}>
<Card title="Kho lưu trữ GitHub" icon="github" href="https://github.com/dodopayments/dodopayments-go">
...
<Card title="Báo cáo sự cố" icon="bug" href="https://github.com/dodopayments/dodopayments-go/issues">
