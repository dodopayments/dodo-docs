...
SDK sử dụng các tham số được đặt tên để chỉ định các tham số tùy chọn. Bạn có thể khởi tạo các đối tượng giá trị bằng cách sử dụng phương thức khởi tạo tĩnh `with`:
...
<Lưu ý>
  Các tham số `extra*` có tên giống nhau sẽ ghi đè lên các tham số đã được tài liệu hóa.
</Lưu ý>
