...
`SFSafariViewController` không thể tự bắt URL trả về của nó. Xem trang
...
<Warning>
`@dodopayments/react-native-checkout` cũng cung cấp Expo config plugin, nhưng
hiện tại plugin này không ghi URL scheme hoặc manifest placeholder nào. Chỉ thêm plugin này
sẽ **không** đăng ký callback scheme — hãy sử dụng cấu hình ở trên. Xem
trang [React Native SDK](/developer-resources/sdks/react-native).
</Warning>
