...
description: Tích hợp Dodo Payments
  với dự án Nuxt của bạn bằng module Nuxt chính thức. Bao gồm checkout, customer
  portal, webhooks và thiết lập môi trường an toàn.
icon: code-merge
keywords:
  - "Dodo Payments"
  - Nuxt
