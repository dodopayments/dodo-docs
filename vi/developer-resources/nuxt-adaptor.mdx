...
<CardGroup cols={2}>
<Card title="Đường dẫn API Thanh toán" icon="cart-shopping" href="#checkout-api-route">
    Tích hợp thanh toán Dodo vào ứng dụng Nuxt của bạn bằng cách sử dụng một đường dẫn máy chủ.
</Card>
<Card title="Đường dẫn API Cổng thông tin Khách hàng" icon="user" href="#customer-portal-api-route">
    Cho phép khách hàng quản lý đăng ký và thông tin qua một đường dẫn máy chủ Nuxt.
</Card>
<Card title="Đường dẫn API Webhook" icon="bell" href="#webhook-api-route">
...
<Steps>
<Step title="Cài đặt mô-đun Nuxt">
...
<Step title="Đăng ký mô-đun trong nuxt.config.ts">
Thêm <code>@dodopayments/nuxt</code> vào mảng <code>modules</code> của bạn và cấu hình nó:
...
<Info>
Tất cả các tích hợp Dodo Payments trong Nuxt đều được xử lý qua các đường dẫn máy chủ trong thư mục <code>server/routes/api/</code>.
</Info>

<Tabs>
<Tab title="Đường dẫn API Thanh toán">
<Info>
...
<Warning>
Nếu <code>productId</code> bị thiếu hoặc không hợp lệ, trình xử lý sẽ trả về phản hồi 400.
</Warning>
...
<Tab title="Đường dẫn API Cổng thông tin Khách hàng">
<Info>
Tạo một đường dẫn GET để cho phép khách hàng truy cập cổng thông tin của họ. Chấp nhận <code>customer_id</code> như một tham số truy vấn.
</Info>
<CodeGroup>
...
<Tab title="Đường dẫn API Webhook">
<Info>
Tạo một đường dẫn POST để nhận và xử lý các sự kiện webhook từ Dodo Payments một cách an toàn.
</Info>
<CodeGroup>
...
<Warning>
Nếu <code>productId</code> bị thiếu, trình xử lý sẽ trả về phản hồi 400. Các tham số truy vấn không hợp lệ cũng dẫn đến phản hồi 400.
</Warning>
...
## Trình xử lý Đường dẫn Cổng thông tin Khách hàng
