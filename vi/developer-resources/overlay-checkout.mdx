...
Để biết thông tin chi tiết về cách thiết lập Apple Pay, Google Pay và các ví điện tử khác, hãy tham khảo trang <a href="/features/payment-methods/digital-wallets">Ví điện tử</a>.
...
<Card title="API Phiên thanh toán" icon="code" href="/api-reference/checkout-sessions/create">
    Tạo các phiên thanh toán để làm động lực cho trải nghiệm thanh toán của bạn.
</Card>

<Card title="Webhooks" icon="webhook" href="/developer-resources/webhooks">
    Xử lý các sự kiện thanh toán từ phía máy chủ với webhooks.
</Card>
...
Để biết thêm trợ giúp, hãy truy cập vào [cộng đồng Discord của chúng tôi](https://discord.gg/bYqAp4ayYh) hoặc liên hệ với đội ngũ hỗ trợ phát triển của chúng tôi.
