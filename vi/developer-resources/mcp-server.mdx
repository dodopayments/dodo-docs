...
[Dodo Agent Plugin](/developer-resources/build-with-ai-coding-agents) cài đặt cả MCP servers và toàn bộ mười bảy skills chỉ trong một bước cho Claude Code, Codex CLI, Cursor, VS Code / GitHub Copilot, Kiro và OpenCode. Gemini CLI chỉ nhận được hai MCP servers vì không có primitive dành cho agent-skill. Xem [hướng dẫn AI Coding Agents](/developer-resources/build-with-ai-coding-agents) để biết các lệnh cài đặt cho từng agent.
