...
[Dodo Agent Plugin](/developer-resources/build-with-ai-coding-agents) cài đặt cả MCP servers và toàn bộ mười bảy skills chỉ trong một bước cho Claude Code, Codex CLI, Cursor và OpenCode. Xem [hướng dẫn AI Coding Agents](/developer-resources/build-with-ai-coding-agents) để biết các lệnh cài đặt cho từng agent.
