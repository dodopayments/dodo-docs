...
<Info>
Xác minh miền chỉ cần thiết cho **thanh toán inline (nhúng trực tiếp)**. Overlay checkout, hosted checkout và liên kết thanh toán không cần.
</Info>

Apple Pay được xác minh trên mỗi miền từ bảng điều khiển.

<Steps>
<Step title="Open Wallet domains">
Đi tới **Cài đặt → Phương thức thanh toán** và, trên hàng **Apple Pay**, nhấp vào **Quản lý miền**.

<Frame caption="Open Wallet domains from the Apple Pay row">
  <img src="/images/apple-pay-domains/manage-domains.png" alt="Nút Quản lý miền trên hàng Apple Pay trong cài đặt Phương thức thanh toán" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>

<Step title="Download the domain association file">
Từ bảng điều khiển miền Wallet, tải về tệp liên kết.

<Frame caption="Download the Apple Pay domain association file">
  <img src="/images/apple-pay-domains/wallet-domains-panel.png" alt="Bảng điều khiển miền Wallet với nút Tải về tệp" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>

<Step title="Register your domain">
Nhấp vào **Đăng ký miền** và nhập miền nơi bạn nhúng thanh toán inline (ví dụ: `shop.example.com`), sau đó nhấp **Tiếp tục**.

<Frame caption="Register the domain where you embed inline checkout">
  <img src="/images/apple-pay-domains/register-domain.png" alt="Biểu mẫu Đăng ký miền với một miền đã nhập" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
Nó phải được phục vụ qua HTTPS, có thể truy cập mà không cần chuyển hướng, và được phục vụ với `Content-Type: application/octet-stream` hoặc `text/plain`.
</Step>

<Step title="Verify the domain">
Nhấp vào **Xác minh miền**. Dodo Payments xác nhận tệp đang hoạt động và gửi miền của bạn tới Apple.

<Frame caption="Verify the hosted association file">
  <img src="/images/apple-pay-domains/verify-domain.png" alt="Màn hình Xác minh miền của bạn với đường dẫn lưu trữ tệp liên kết và nút Xác minh miền" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>

<Step title="Confirm it's active">
Khi trạng thái hiển thị **Hoạt động**, Apple Pay được kích hoạt cho miền đó. Sử dụng nút chuyển **Đã kích hoạt** để bật hoặc tắt theo từng miền.

<Frame caption="Verified domains show an Active status">
  <img src="/images/apple-pay-domains/domains-active.png" alt="Danh sách miền Wallet hiển thị các miền có trạng thái Apple Pay Hoạt động và các nút chuyển Đã kích hoạt" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
3. Hoàn thành giao dịch kiểm tra
</Step>
</Steps>
...
|---------|-----------------|------------------|
| Độ sâu tích hợp | Nhúng hoàn toàn trong trang | Mô đun trên trang |
| Kiểm soát bố cục | Toàn quyền kiểm soát | Hạn chế |
| Thương hiệu | Liền mạch | Tách biệt khỏi trang |
| Nỗ lực thực hiện | Cao hơn | Thấp hơn |
| Phù hợp nhất cho | Trang thanh toán tùy chỉnh, luồng chuyển đổi cao | Tích hợp nhanh, trang hiện có |

<Tip>
Sử dụng **thanh toán inline** khi bạn muốn kiểm soát tối đa trải nghiệm thanh toán và thương hiệu liền mạch. Sử dụng **thanh toán overlay** cho tích hợp nhanh hơn với thay đổi tối thiểu cho các trang hiện có.
</Tip>
...
<Card title="Overlay Checkout" icon="layer-group" href="/developer-resources/overlay-checkout">
    Sử dụng thanh toán overlay để tích hợp nhanh dựa trên mô đun.
</Card>

<Card title="Checkout Sessions API" icon="code" href="/api-reference/checkout-sessions/create">
    Tạo các phiên thanh toán để cung cấp năng lượng cho trải nghiệm thanh toán của bạn.
</Card>

<Card title="Webhooks" icon="webhook" href="/developer-resources/webhooks">
    Xử lý các sự kiện thanh toán trên máy chủ với webhooks.
</Card>
...
Để biết thêm trợ giúp, hãy truy cập [cộng đồng Discord](https://discord.gg/bYqAp4ayYh) của chúng tôi hoặc liên hệ với nhóm hỗ trợ nhà phát triển của chúng tôi.
