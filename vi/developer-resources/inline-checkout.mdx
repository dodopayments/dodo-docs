...
Tải xuống [tệp liên kết miền Apple Pay](https://checkout.dodopayments.com/.well-known/apple-developer-merchantid-domain-association).
</Step>
...
| Tính năng | Thanh toán Nhúng | Thanh toán Overlay |
|---------|-----------------|------------------|
...
Để được trợ giúp thêm, hãy truy cập cộng đồng [Discord của chúng tôi](https://discord.gg/bYqAp4ayYh) hoặc liên hệ với đội hỗ trợ phát triển của chúng tôi.
