...
Hướng dẫn chi tiết để triển khai thanh toán một lần
</Card>
...
- Tham gia [cộng đồng Discord](https://discord.gg/bYqAp4ayYh) của chúng tôi để đặt câu hỏi và thảo luận
- Kiểm tra [kho lưu trữ GitHub](https://github.com/dodopayments/expo-boilerplate) để xem các vấn đề và cập nhật
- Liên hệ [đội ngũ hỗ trợ](mailto:support@dodopayments.com) của chúng tôi để được trợ giúp
