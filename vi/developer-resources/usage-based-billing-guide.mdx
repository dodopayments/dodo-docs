...
<Frame>
<img src="/images/guides/usage-based-billing/meter-quantities-chart.png" alt="Biểu đồ số lượng đồng hồ hiển thị xu hướng sử dụng theo thời gian với hình ảnh gradient màu tím" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/guides/usage-based-billing/events-table.png" alt="Bảng sự kiện hiển thị tên sự kiện, ID và điều khiển phân trang cho phân tích sự kiện chi tiết" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
- Thuộc tính: `plan_type`, So sánh: `equals`, Giá trị: `premium`
- Thuộc tính: `hour`, So sánh: `greater_than_or_equals`, Giá trị: `9`
- Thuộc tính: `hour`, So sánh: `less_than`, Giá trị: `17`
...
<Card title="Create Meter" icon="gauge" href="/api-reference/meters/create-meter">
  Tham khảo API để tạo và cấu hình các đồng hồ đo sử dụng cho việc theo dõi tiêu thụ của khách hàng
</Card>
<Card title="Ingest Usage Events" icon="arrow-right" href="/api-reference/usage-events/ingest-events">
  Tham khảo API để gửi sự kiện sử dụng đến các đồng hồ đo đã cấu hình của bạn cho việc tính toán hóa đơn
</Card>
</CardGroup>
