...
**Ví dụ**: Đặt `$0.50` trên mỗi đơn vị có nghĩa là:
- 1.000 đơn vị tiêu thụ = 1.000 × $0.50 = 500,00 $ phí
- 500 đơn vị tiêu thụ = 500 × $0.50 = 250,00 $ phí
- 100 đơn vị tiêu thụ = 100 × $0.50 = 50,00 $ phí
</ParamField>
...
- Tính Chất: `plan_type`, Bộ So Sánh: `equals`, Giá Trị: `premium`
- Tính Chất: `hour`, Bộ So Sánh: `greater_than_or_equal`, Giá Trị: `9`
- Tính Chất: `hour`, Bộ So Sánh: `less_than`, Giá Trị: `17`
