...
<Frame>
  <img
    ...
    alt="Chợ tiện ích mở rộng VS Code hiển thị tiện ích Sentra"
...
2. Điều hướng đến **Developer** › **API Keys**.
...
<Frame>
  <img
    ...
    alt="Màn hình cấu hình Sentra với phần nhập khóa API và lựa chọn môi trường"
    width="50%"
  style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<Frame>
  <img
    ...
    alt="Giao diện Sentra hiển thị mục nhập lời nhắc với ví dụ về nhiệm vụ"
    width="50%"
  style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
