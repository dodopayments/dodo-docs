...
- Một tài khoản merchant Dodo Payments.
- API key của bạn (`DODO_PAYMENTS_API_KEY`) và webhook secret key từ dashboard. Xem [hướng dẫn tạo API key](/api-reference/introduction#api-key-management-and-authentication).
- Một backend endpoint có thể nhận webhook.
