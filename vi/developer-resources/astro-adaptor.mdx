...
Cố định số tiền được tính, theo đơn vị tiền tệ chính (ví dụ: <code>12.5</code> tương đương $12.50). Chỉ áp dụng cho các sản phẩm Pay What You Want và sẽ bị bỏ qua nếu thấp hơn giá tối thiểu của sản phẩm.
</ParamField>
