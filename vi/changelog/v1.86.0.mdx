...
<Frame>
<img src="/images/CBB/Checkout.png" alt="Trang thanh toán hiển thị các khoản tín dụng bao gồm với việc mua sản phẩm" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/CBB/Customer Portal.jpg" alt="Giao diện tín dụng Cổng khách hàng với số dư và lịch sử giao dịch" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/design/general-overview.jpg" alt="Trang cài đặt thiết kế với chế độ xem trước trực tiếp của thanh toán, cổng khách hàng và cửa hàng" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/design/general-color-settings.jpg" alt="Cài đặt nâng cao được mở rộng hiển thị đầy đủ cấu hình màu cho chế độ sáng và tối" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Tip>
Sử dụng các trường này để xây dựng bảng điều khiển tranh chấp và hoàn tiền, kích hoạt cảnh báo khi trạng thái tranh chấp thay đổi, hoặc hiển thị các khoản thanh toán cần chú ý.
</Tip>

Tìm hiểu thêm: [API Liệt kê Thanh toán](/api-reference/payments/get-payments)

### 4. **Bảng Hoàn Tiền trong Cổng Khách Hàng**

Cổng Khách Hàng hiện đã có một mục riêng biệt **Hoàn Tiền** nơi khách hàng có thể xem tất cả các khoản hoàn tiền liên quan đến khoản thanh toán của họ. Mỗi mục hoàn tiền sẽ hiển thị số tiền hoàn lại, trạng thái, ngày và khoản thanh toán gốc mà nó được phát hành, cung cấp cho khách hàng sự minh bạch đầy đủ về lịch sử hoàn tiền của họ mà không cần liên hệ với bộ phận hỗ trợ.

<Check>
Bảng hoàn tiền có sẵn tự động trong cổng khách hàng cho tất cả các doanh nghiệp. Không cần cấu hình.
</Check>

Tìm hiểu thêm: [Cổng Khách Hàng](/features/customer-portal)

### 5. **Sao Chép Sang Chế Độ Trực Tiếp cho Đồng Hồ**

Bây giờ bạn có thể **sao chép đồng hồ từ chế độ thử nghiệm sang chế độ trực tiếp** trực tiếp từ bảng điều khiển. Khi bạn đã hoàn tất việc thử nghiệm cấu hình đồng hồ ở chế độ thử nghiệm, hãy sử dụng hành động sao chép để nhân rộng nó sang chế độ trực tiếp với tất cả các cài đặt được bảo tồn: loại tổng hợp, tên sự kiện, bộ lọc, và các liên kết tín dụng. Điều này loại bỏ nhu cầu tạo lại đồng hồ thủ công khi chuyển từ phát triển sang sản xuất.

<Tip>
Xây dựng và xác nhận cấu hình đồng hồ của bạn trong chế độ thử nghiệm trước, sau đó sao chép chúng sang chế độ trực tiếp khi bạn sẵn sàng đi vào sản xuất. Điều này đảm bảo cấu hình thanh toán của bạn được thử nghiệm trước khi nó xử lý việc sử dụng thực tế của khách hàng.
</Tip>

Tìm hiểu thêm: [Thanh toán Dựa trên Sử dụng](/features/usage-based-billing/introduction) | [Đồng Hồ](/features/usage-based-billing/meters)
