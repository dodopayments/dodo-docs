...
Tín dụng được đính kèm như các **quyền lợi** trong quy trình tạo sản phẩm. Bạn có thể đính kèm tối đa **5 tín dụng cho mỗi sản phẩm**, và tín dụng hoạt động với cả ba loại giá: đăng ký, thanh toán một lần và thanh toán dựa trên sử dụng.
