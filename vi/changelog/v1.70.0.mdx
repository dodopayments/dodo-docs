...
1. **Thanh Toán Trực Tiếp - Trải Nghiệm Thanh Toán Hoàn Toàn Nhúng (BETA)**  
   ...
   <Frame>
   <img src="/images/inline-checkout/cover.png" alt="Ảnh bìa Thanh toán Nội Tuyến" />
   </Frame>
...
3. **Thay Đổi Kế Hoạch Đăng Ký Trong Bảng Điều Khiển Với Cập Nhật Ngày Thanh Toán Tiếp Theo**  
    ...
    <Frame>
    <img src="/images/changelog/subscription-plan-changes.png" alt="Thay đổi gói đăng ký trong bảng điều khiển" />
    </Frame>
