...
1. **Thanh Toán Trực Tiếp - Trải Nghiệm Thanh Toán Hoàn Toàn Nhúng (BETA)**  
   ...
   <Frame>
   <img src="/images/inline-checkout/cover.png" alt="Hình ảnh bìa Thanh toán Nội tuyến" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
   ...
   <Tip>
   Sử dụng thanh toán nội tuyến khi bạn muốn kiểm soát tối đa thiết kế thanh toán. Sử dụng [overlay checkout](/developer-resources/overlay-checkout) để tích hợp nhanh hơn với ít sự thay đổi trên các trang hiện tại.
   </Tip>
...
3. **Thay Đổi Kế Hoạch Đăng Ký Trong Bảng Điều Khiển Với Cập Nhật Ngày Thanh Toán Tiếp Theo**  
    ...
    <Frame>
    <img src="/images/changelog/subscription-plan-changes.png" alt="Thay đổi gói đăng ký trong bảng điều khiển" style={{ maxHeight: '500px', width: 'auto' }} />
    </Frame>
...
4. **Liên Kết Ngắn Cho URL Thanh Toán**  
   ...
   <Frame>
   <img src="/images/changelog/short-links.png" alt="Tính năng liên kết ngắn cho URL thanh toán" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
   ...
   <Info>
   Liên kết ngắn được quản lý trong bảng điều khiển của bạn và có thể xem qua [List Short Links API](/api-reference/products/get-products-short-links).
   </Info>
