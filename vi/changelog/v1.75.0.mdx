...
keywords:
  ...
  - ghi chú phát hành
  - cập nhật sản phẩm
  - v1.75.0 (ngày 23 tháng 1 năm 2026)
---
...
### 1. **Bộ sản phẩm**  
   ...
   <Frame>
     <img src="/images/product-collection/checkout-page.png" alt="Trang thanh toán của Bộ sưu tập sản phẩm hiển thị nhiều tùy chọn gói" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
