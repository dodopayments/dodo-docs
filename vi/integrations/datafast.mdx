...
<Step title="Open the Webhook Section">
  Trong bảng điều khiển Dodo Payments của bạn, điều hướng đến <b>Webhooks → + Thêm Endpoint</b> và mở rộng menu thả xuống tích hợp.
  <Frame>
    <img src="/images/integrations/datafast/add.png" alt="Thêm Endpoint và menu thả xuống tích hợp" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
...
<Step title="Enter API Key">
  ...
  <Frame>
    <img src="/images/integrations/datafast/api-key.png" alt="Thêm Khóa API" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
