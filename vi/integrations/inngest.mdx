...
<Step title="Open the Webhook Section">
  Trong bảng điều khiển Dodo Payments, điều hướng đến <b>Webhooks → + Thêm Điểm cuối</b> và mở rộng menu thả xuống tích hợp.
  <Frame>
    <img src="/images/integrations/inngest.png" alt="Thêm Điểm cuối và menu thả xuống tích hợp" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
