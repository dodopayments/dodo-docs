...
- Sử dụng các phần đính kèm thông điệp phong phú với màu sắc, các trường và định dạng để rõ ràng và dễ hành động.
- Luôn bao gồm dữ liệu quan trọng như số tiền, email của khách hàng và ID để dễ dàng nhận diện.
