...
<Step title="Open the Webhook Section">
  Trong bảng điều khiển Dodo Payments của bạn, điều hướng đến <b>Webhooks + Thêm Endpoint</b> và mở rộng trình đơn tích hợp.
  <Frame>
    <img src="/images/integrations/mailerlite.png" alt="Thêm Endpoint và trình đơn tích hợp" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
