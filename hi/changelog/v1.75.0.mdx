...
### 1. **Product Collections**  
   ...
   <Frame>
     <img src="/images/product-collection/checkout-page.png" alt="प्रोडक्ट कलेक्शन चेकआउट पेज जो कई प्लान विकल्प दिखा रहा है" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
