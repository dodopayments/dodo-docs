...
### 1. **कम्युनिकेशन प्रेफरेंस**
   ...
   <Frame>
     <img src="/images/communication-preferences/overview.png" alt="सूचना सेटिंग्स दिखाते हुए संचार प्राथमिकताएँ अवलोकन" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
...
### 2. **चेकआउट सेशन्स में कस्टम फ़ील्ड्स**
   ...
   **लाभ**
   ...
   <Info>
   Payment और subscription responses में custom field values `custom_field_responses` array के भीतर लौटाए जाते हैं।
   </Info>

   और जानें: [Checkout Session Custom Fields](/developer-resources/checkout-session#15-collecting-custom-fields)
