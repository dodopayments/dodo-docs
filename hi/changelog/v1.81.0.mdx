...
भुगतान को अलग से refunds endpoint पर query किए बिना, यह तुरंत जाँचने के लिए कि भुगतान refund किया गया है या नहीं, `refund_status` field को `GET /payments/{payment_id}` response में जोड़ा गया।
