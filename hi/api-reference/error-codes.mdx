...
- `DISCOUNT_CONCURRENT_REDEMPTION`
  - **Trigger:** उसी code का एक और redemption usage-limit row lock को बहुत देर तक होल्ड किए रहा
  - **Message:** Discount का redemption एक साथ किया जा रहा है; कृपया फिर से प्रयास करें
  - **Note:** अस्थायी। code में अभी भी capacity हो सकती है, इसलिए request को फिर से भेजना सुरक्षित है। इसे ग्राहक को "code exhausted" के रूप में न दिखाएँ।
