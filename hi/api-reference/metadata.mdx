...
- मेटाडेटा की की लंबाई 40 अक्षरों तक हो सकती है
- मेटाडेटा मान स्ट्रिंग, नंबर, या boolean हो सकते हैं; स्ट्रिंग की लंबाई 500 अक्षरों तक हो सकती है
- ऑब्जेक्ट, arrays, और `null` को मेटाडेटा मान के रूप में स्वीकार नहीं किया जाता है
- आप प्रति ऑब्जेक्ट 50 मेटाडेटा की-मूल्य युग्मों तक रख सकते हैं
- की में केवल अल्फ़ान्यूमेरिक अक्षर, डैश, और अंडरस्कोर होने चाहिए
- हमारा API मेटाडेटा पर खोज नहीं कर सकता है, लेकिन यह API प्रतिक्रियाओं और webhooks में लौटाया जाता है
...
### करें:
- मेटाडेटा कुंजियों के लिए संगत नामकरण कन्वेंशनों का उपयोग करें
- अपने मेटाडेटा स्कीमा का आंतरिक रूप से दस्तावेज़ीकरण करें
