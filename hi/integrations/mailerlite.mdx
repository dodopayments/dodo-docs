...
2. **सदस्यता क्षेत्र** पर जाएं
3. **क्षेत्र बनाएं** पर क्लिक करें और निम्नलिखित जैसे फ़ील्ड जोड़ें:
   - `total_spent` (संख्या)
...
|-----------|------|----------|-------------|
| `email` | string | हाँ | वैध ईमेल पता (RFC 2821) |
| `fields` | object | नहीं | फ़ील्ड नाम/मान जोड़े वाला ऑब्जेक्ट |
| `fields.name` | string | नहीं | सदस्य का पहला नाम |
| `fields.last_name` | string | नहीं | सदस्य का अंतिम नाम |
...
| `groups` | array | नहीं | सदस्य को जोड़ने के लिए समूह ID की एक सूची |
| `status` | string | नहीं | निम्नलिखित में से एक: सक्रिय, सदस्यता रद्द, अप्रतिबंधित, बाउंस, जंक |
| `subscribed_at` | string | नहीं | `yyyy-MM-dd HH:mm:ss` प्रारूप में तिथि |
| `ip_address` | string | नहीं | सदस्य का IP पता |
