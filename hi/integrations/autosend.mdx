...
<Info>
इस एकीकरण के लिए प्रमाणीकरण के लिए आपके AutoSend API कुंजी की आवश्यकता है। आप अपनी API कुंजी AutoSend डैशबोर्ड में Settings > API Keys के तहत पा सकते हैं।
</Info>
...
<Step title="Webhook अनुभाग खोलें">
  ...
  <Frame>
    <img src="/images/integrations/autosend.png" alt="एंडपॉइंट और एकीकरण ड्रॉपडाउन जोड़ें" />
  </Frame>
</Step>

<Step title="AutoSend एकीकरण चुनें">
...
<Step title="API कुंजी दर्ज करें">
  ...
  <Card title="API कुंजी बनाने और प्रबंधित करने के तरीके के बारे में जानें" icon="key" href="https://docs.autosend.com/api-keys">
...
- **व्यक्तिगतकरण के लिए गतिशील डेटा का उपयोग करें**: ग्राहकों की विशिष्ट जानकारी जैसे नाम, भुगतान राशि और सदस्यता विवरण के साथ ईमेल को व्यक्तिगत बनाने के लिए `dynamicData` फ़ील्ड का उपयोग करें। व्यक्तिगत ईमेल की व्यस्तता दर अधिक होती है।
...
<AccordionGroup>
<Accordion title="ईमेल भेजे नहीं जा रहे हैं">
- सत्यापित करें कि API कुंजी सही और सक्रिय है
- जांचें कि प्रेषक डोमेन AutoSend में सत्यापित है
- सुनिश्चित करें कि प्राप्तकर्ता के ईमेल पते मान्य हैं
- AutoSend भेजने की सीमाएँ और कोटा की समीक्षा करें
- सत्यापित करें कि API एंडपॉइंट URL सही है: `https://api.autosend.com/v1/mails/send`
- जांचें कि आवश्यक पैरामीटर पेलोड में मौजूद हैं
</Accordion>

<Accordion title="परिवर्तन त्रुटियाँ">
- सुनिश्चित करें कि JSON संरचना AutoSend API प्रारूप से मेल खाती है
- जाँच करें कि सभी आवश्यक फ़ील्ड मौजूद हैं (`to`, `from`, `templateId` या `html`/`text`)
- सुनिश्चित करें कि ईमेल पते उचित प्रारूप में हैं
- यदि टेम्पलेट्स का उपयोग कर रहे हैं तो `templateId` मान्य है
- जांचें कि `dynamicData` कुंजियाँ आपके टेम्पलेट चर से मेल खाती हैं
</Accordion>

<Accordion title="टेम्पलेट मुद्दे">
- सुनिश्चित करें कि आपका टेम्पलेट ID सही और AutoSend में सक्रिय है
- जांचें कि `dynamicData` कुंजियाँ आपके टेम्पलेट में उपयोग की गई चरों से मेल खाती हैं
- सुनिश्चित करें कि सभी आवश्यक टेम्पलेट चर प्रदान किए गए हैं
