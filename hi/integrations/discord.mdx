...
<Step title="Open the Webhook Section">
  अपने Dodo Payments डैशबोर्ड में, <b>Webhooks → + Add Endpoint</b> खोलें और इंटीग्रेशन को दिखाने के लिए ड्रॉपडाउन को विस्तारित करें।
  <Frame>
    <img src="/images/integrations/discord.png" alt="एंडपॉइंट जोड़ें और इंटीग्रेशन ड्रॉपडाउन" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
