...
<Step title="Open the Webhook Section">
  अपने Dodo Payments डैशबोर्ड में <b>Webhook</b> अनुभाग पर जाएं। <b>+ Add Endpoint</b> बटन पर क्लिक करें, फिर अन्य इंटीग्रेशन का प्रदर्शन करने के लिए webhook ड्रॉपडाउन खोलें।
  <Frame>
    <img src="/images/integrations/slack/1.png" alt="Dodo Payments डैशबोर्ड दिखा रहा है Add Endpoint बटन और इंटीग्रेशन ड्रॉपडाउन" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>

<Step title="Select Slack Integration">
  <b>Slack</b> इंटीग्रेशन चुनें और <b>Connect your Slack workspace</b> पर क्लिक करें।
  <Frame>
    <img src="/images/integrations/slack/2.png" alt="Slack इंटीग्रेशन कार्ड और कनेक्ट बटन" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>

<Step title="Grant Slack Permissions">
  Incoming Webhooks Slack App के लिए आवश्यक अनुमतियाँ प्रदान करें ताकि वह आपके चुने हुए चैनल में संदेश पोस्ट कर सके।
  <Frame>
    <img src="/images/integrations/slack/3.png" alt="Slack OAuth अनुमतियाँ स्क्रीन Incoming Webhooks ऐप के लिए" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>

<Step title="Customize Transformation Code">
  अपने उपयोग मामले के लिए Slack सूचनाओं को अनुकूलित करने के लिए ट्रांसफॉर्मेशन कोड जोड़ें या संपादित करें। आप प्री-मेड टेम्पलेट्स का उपयोग कर सकते हैं या अपना स्वयं का लॉजिक लिख सकते हैं।
  <Frame>
    <img src="/images/integrations/slack/4.png" alt="Slack इंटीग्रेशन के लिए ट्रांसफॉर्मेशन कोड एडिटर" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>

<Step title="Test and Create">
  अपने ट्रांसफॉर्मेशन कोड को कस्टम या प्री-मेड इवेंट पेलोड्स के साथ टेस्ट करें। एक बार जब आप संतुष्ट हो जाते हैं, तो इंटीग्रेशन को सक्रिय करने के लिए <b>Create</b> पर क्लिक करें।
  <Frame>
    <img src="/images/integrations/slack/5.png" alt="टेस्ट ट्रांसफॉर्मेशन और क्रिएट बटन" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
...
अपने Slack नोटिफ़िकेशन को प्रभावी बनाने के लिए:
- स्पष्टता और कार्रवाई योग्य जानकारी के लिए रंगों, फ़ील्ड और फ़ॉर्मेटिंग वाले रिच मैसेज अटैचमेंट का उपयोग करें।
- त्वरित पहचान के लिए हमेशा राशि, ग्राहक ईमेल और IDs जैसे महत्वपूर्ण डेटा शामिल करें।
- इवेंट के प्रकार के अनुरूप रंग चुनें: सफलता के लिए हरा (`good`), विवाद या विफलताओं के लिए लाल (`danger`), रद्दीकरण के लिए पीला (`warning`), और सूचनात्मक इवेंट के लिए नीला (`#3aa3e3`)।
- प्रत्येक इवेंट कब हुआ, इसे ट्रैक करने में सहायता के लिए टाइमस्टैम्प जोड़ें।
