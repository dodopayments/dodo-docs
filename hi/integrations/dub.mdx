...
<Step title="Open the Webhook Section">
  अपने Dodo Payments डैशबोर्ड में, **Webhooks → + Add Endpoint** पर जाएं और इंटिग्रेशंस ड्रॉपडाउन को विस्तृत करें।
  <Frame>
...
<Step title="Enter API Key">
  कॉन्फ़िगरेशन फ़ील्ड में अपना Dub API Key प्रदान करें।
  <Frame>
