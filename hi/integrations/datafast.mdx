...
1. **DataFast के विज़िटर ID** को `datafast_visitor_id` कुकी से कैप्चर करें जब चेकआउट सत्र बनाए जाएं।
2. **विज़िटर ID** को अपने भुगतान मेटाडेटा में स्टोर करें।
3. **जब भुगतान सफल हो** जाए तो DataFast को भुगतान डेटा भेजें उनके Payment API का उपयोग करते हुए।
...
<Steps>
<Step title="DataFast स्क्रिप्ट इंस्टॉल करें">
  सबसे पहले, अपनी वेबसाइट पर DataFast ट्रैकिंग स्क्रिप्ट इंस्टॉल करें। यह `datafast_visitor_id` कुकी बनाता है जो आपके विजिटरों को ट्रैक करता है।
  
  विशिष्ट इंस्टॉलेशन निर्देशों के लिए [DataFast दस्तावेज़ीकरण](https://datafa.st/docs) पर जाएं।
</Step>
...
<AccordionGroup>
<Accordion title="DataFast में भुगतान नहीं दिखाई दे रहे">
- सत्यापित करें कि आपका DataFast API कुंजी सही और सक्रिय है।
- सुनिश्चित करें कि `datafast_visitor_id` को कैप्चर और भुगतान मेटाडेटा में स्टोर किया जा रहा है।
- सुनिश्चित करें कि वेबहुक रूपांतरण सही ढंग से Payload को प्रारूपित कर रहा है।
- सत्यापित करें कि वेबहुक `payment.succeeded` घटनाओं पर ट्रिगर हो रहा है।
- किसी भी त्रुटि संदेश या API लॉग के लिए DataFast डैशबोर्ड की जांच करें।
</Accordion>

<Accordion title="राजस्व सटीक श्रेणी काम नहीं कर रहा">
- पुष्टि करें कि DataFast ट्रैकिंग स्क्रिप्ट आपकी वेबसाइट पर स्थापित और काम कर रही है।
- सुनिश्चित करें कि `datafast_visitor_id` कुकी सही तरीके से सेट की गई है।
- चेकआउट निर्माण और भुगतान पूर्णता के बीच विज़िटर IDs का मिलान सुनिश्चित करें।
- सुनिश्चित करें कि आप चेकआउट सत्र बनाने से पहले विज़िटर ID को कैप्चर कर रहे हैं।
- अतिरिक्त मार्गदर्शन के लिए DataFast के [Payment API डॉक्यूमेंटेशन](https://datafa.st/docs/payments-api) की समीक्षा करें।
</Accordion>
...
- सुनिश्चित करें कि राशि सही ढंग से परिवर्तित है (ज्यादातर मुद्राओं के लिए 100 से विभाजित करें, सिवाय शून्य दशमलव मुद्राओं के)।
- सत्यापित करें कि API अंत बिंदु URL सही है: `https://datafa.st/api/v1/payments`
- नमूना वेबहुक Payload के साथ रूपांतरण का परीक्षण करें।
</Accordion>
