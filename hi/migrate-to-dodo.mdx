...
<CardGroup cols={3}>
  ...
  {/* LOCKED_PATTERN_44e2925240b67d182d6f86f9636951dc */}
    संपर्क विवरण सहित अपने पूरे ग्राहक डेटाबेस को स्थानांतरित करें।
  </Card>
  {/* LOCKED_PATTERN_29c15debb5855eb235de507aeaeb57d4 */}
    सभी डिस्काउंट कोड और प्रचारात्मक ऑफ़र को सहजता से स्थानांतरित करें।
  </Card>
</CardGroup>
...
- **लेमन स्क्वीजी सहायता**: `dodo-migrate lemonsqueezy --help`
- **स्ट्रीप सहायता**: `dodo-migrate stripe --help`
...
- **समस्या रिपोर्ट करें**: [GitHub](https://github.com/dodopayments/dodo-migrate)
