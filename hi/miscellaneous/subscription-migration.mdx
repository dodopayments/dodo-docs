...
| `country` | दो-अक्षरीय देश कोड (ISO 3166-1 alpha-2) |
| `currency` | तीन-अक्षरीय मुद्रा कोड (ISO 4217) |
...
<Warning>
`card_token` फ़ील्ड महत्वपूर्ण है—इसे आयात के दौरान भुगतान विधियों के साथ ग्राहक रिकॉर्ड को मेल करने के लिए उपयोग किया जाता है। सुनिश्चित करें कि यह भुगतान विधि निर्यात में टोकन के साथ बिल्कुल मेल खाता है।
</Warning>
