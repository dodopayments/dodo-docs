...
description: सदस्यता + उपयोग, सीटें + ऐड-ऑन, बेस + ओवरएज और अन्य विकल्पों को
  मिलाकर उन्नत मूल्य निर्धारण रणनीतियाँ बनाएँ।
icon: layer-group
keywords:
  - "Dodo Payments"
  - हाइब्रिड बिलिंग मॉडल
  - भुगतान प्लेटफ़ॉर्म
  - SaaS बिलिंग
---

<Info>
हाइब्रिड बिलिंग दो या अधिक बिलिंग मॉडल को एकल मूल्य निर्धारण रणनीति में संयोजित करती है। इससे आप अलग-अलग आयामों—आवर्ती शुल्क, उपयोग, सीटों और सुविधाओं—से मूल्य प्राप्त कर सकते हैं और ग्राहकों को लचीलापन व पूर्वानुमेयता दे सकते हैं।
</Info>

<CardGroup cols={2}>
<Card title="Usage-Based Billing" icon="chart-line" href="/features/usage-based-billing/introduction">
  consumption-based pricing के लिए आधार।
</Card>

<Card title="Subscriptions" icon="repeat" href="/features/subscription">
  recurring billing के लिए आधार।
</Card>

<Card title="Add-ons" icon="puzzle" href="/features/addons">
  वैकल्पिक upgrades के साथ subscriptions का विस्तार करें।
</Card>

<Card title="Seat-Based Billing" icon="users" href="/features/seat-based-billing">
  प्रति-उपयोगकर्ता pricing models।
</Card>
</CardGroup>
...
हाइब्रिड बिलिंग कई मूल्य निर्धारण आयामों को एकल product offering में संयोजित करती है। flat-rate subscriptions और usage-based pricing में से किसी एक को चुनने के बजाय, आप दोनों का एक साथ उपयोग करते हैं।

### हाइब्रिड बिलिंग का उपयोग क्यों करें?

| व्यावसायिक लक्ष्य | हाइब्रिड समाधान |
|--------------|-----------------|
| पूर्वानुमेय राजस्व + वृद्धि की संभावना | बेस subscription + usage overage |
| बढ़ने वाली टीम pricing | प्रति-seat + feature add-ons |
| ग्राहकों को आकर्षित करें, बाद में विस्तार करें | कम base fee + consumption charges |
| Enterprise flexibility | Committed spend + on-demand charges |
| परिवर्तनीय उपयोग के लिए उचित pricing | Included allowance + pay-per-use |
...
## हाइब्रिड मॉडल 1: Subscription + Usage

यह सबसे सामान्य हाइब्रिड मॉडल है। ग्राहक base subscription fee के साथ included allowances से अधिक consumption के लिए शुल्क चुकाते हैं।
...
एक subscription product बनाएँ और pricing के साथ usage meter संलग्न करें।
...
<Info>
Usage meter सीधे subscription product से संलग्न होता है। Usage charges की गणना करके उन्हें subscription invoice में स्वचालित रूप से जोड़ दिया जाता है।
</Info>
</Step>
...
पूरी billing period के दौरान usage को track करें।
...
Free threshold base subscription में शामिल usage को कवर करता है।
...
कोई base fee नहीं; पहली usage से ही हर unit billable है।
...
अलग-अलग tiers में अलग-अलग allowances शामिल होते हैं।
