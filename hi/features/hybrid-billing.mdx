...
**समाधान**:
1. सुनिश्चित करें कि इवेंट संग्रहण कार्य कर रहा है (API प्रतिक्रियाओं की जांच करें)
2. पुष्टि करें कि `customer_id` सब्सक्रिप्शन ग्राहक से मेल खाता है
3. जांचें कि `event_name` मीटर कॉन्फ़िगरेशन से मेल खाता है
4. पुष्टि करें कि इवेंट के पास सही टाइमस्टैम्प हैं (भविष्य की तिथि नहीं)
</Accordion>
...
**समाधान**:
1. पुष्टि करने से पहले सटीक शुल्क दिखाने के लिए `previewChangePlan` API का उपयोग करें
2. सूचित करें कि प्रोरशन सब्सक्रिप्शन और एड-ऑन पर लागू होता है
