...
2. Dodo Payments, Discord की ओर संकेत करने वाले `oauth_url` के साथ `Pending` स्थिति में एक grant बनाता है।
3. ग्राहक को "Join the Discord" बटन (OAuth link) वाला ईमेल प्राप्त होता है। यह link उनके Customer Portal में भी दिखाई देता है।
4. ग्राहक के authorize करने के बाद, bot उन्हें server में जोड़ता है और configured role assign करता है। grant `Delivered` में चला जाता है।
5. यदि subscription cancel, pause या expire हो जाती है, या merchant manually revoke करता है, तो bot role हटा देता है और grant `Revoked` में चला जाता है।
...
- `entitlement_grant.created`, ग्राहक के authorize करने के लिए `status: "Pending"` और `oauth_url` के साथ fire होता है।
- role assign होने के बाद `entitlement_grant.delivered` fire होता है।
- role हटाए जाने पर `entitlement_grant.revoked` fire होता है।
