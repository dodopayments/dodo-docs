...
2. Dodo Payments ग्राहक के GitHub account को लिंक करने के लिए एक `Pending` status और एक `oauth_url` के साथ grant बनाता है।
3. ग्राहक अपने email या Customer Portal में दिए गए link के माध्यम से authorization करता है।
4. Dodo Payments ग्राहक के GitHub account को configured permission के साथ repository में invite करता है। Invitation create होने के बाद grant `Delivered` में चला जाता है।
5. यदि subscription cancel, refund या revoke की जाती है, तो ग्राहक को collaborator के रूप में हटा दिया जाता है।
