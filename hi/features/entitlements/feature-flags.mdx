...
| ट्रिगर | प्रभाव |
|---|---|
| एकमुश्त भुगतान सफल होता है / subscription सक्रिय हो जाती है | Grant को `status: Delivered` और `delivered_at` सेट करके बनाया जाता है। |
| Subscription को होल्ड पर रखा जाता है, रद्द किया जाता है या उसकी अवधि समाप्त हो जाती है | संबंधित `revocation_reason` के साथ Grant को निरस्त कर दिया जाता है। |
| एकमुश्त भुगतान पर Refund | Grant को `revocation_reason: refund` के साथ निरस्त कर दिया जाता है। |
| Subscription पुनः सक्रिय हो जाती है (उदाहरण के लिए, dunning सफल होता है) | निरस्त Grant को `Delivered` पर पुनर्स्थापित कर दिया जाता है — वही Grant `id`, और revocation फ़ील्ड साफ़ कर दिए जाते हैं। |
| Manual API revoke | Grant को `revocation_reason: manual` के साथ निरस्त कर दिया जाता है। Renewal पर यह अपने-आप पुनर्स्थापित नहीं होता। |
