...
- **प्रत्येक delivery channel के लिए एक entitlement का उपयोग करें।** अलग-अलग role intentions वाले products में एक ही Discord entitlement साझा न करें; स्पष्ट revocation के लिए प्रत्येक role के लिए एक entitlement बनाएँ।
- **पहले test mode में परीक्षण करें।** entitlement बनाएँ, उसे test product से जोड़ें, checkout चलाएँ और grant के `pending → delivered` के माध्यम से transition पर नज़र रखें। पुष्टि करें कि test subscription रद्द करने पर grant revoke हो जाता है।
- **`entitlement_grant.delivered` को सुनें, `payment.succeeded` को नहीं।** fulfilment पूरा होने से पहले payment सफल हो सकता है (विशेष रूप से OAuth flows में)। अपने systems में dependent features को unlock करने से पहले delivered event की प्रतीक्षा करें।
- **`entitlement_grant.failed` को actionable मानें।** failed grant का अर्थ है कि customer ने payment किया, लेकिन उसे access नहीं मिला। इन मामलों को अपनी support team के सामने रखें या regrant trigger करें।
- **`revocation_reason` को अपने retention flows से map करें।** `subscription_on_hold` revoke recoverable होता है (customer अपना card update कर सकता है)। `manual` revoke intentional होता है। Customer communications में इनके साथ अलग-अलग व्यवहार करें।
