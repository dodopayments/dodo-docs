...
| Event | When | Action |
| :---- | :--- | :----- |
| `subscription.active` | Mandate authorized | सदस्यता प्रारंभ रिकॉर्ड करें |
| `payment.succeeded` | ~48 घंटे चार्ज की तारीख के बाद | पहुंच प्रदान/जारी रखें |
| `payment.failed` | डेबिट विफल | ग्राहक को सूचना दें, पहुंच रोकें |
| `subscription.on_hold` | भुगतान विफल | भुगतान विधि अद्यतन के लिए संकेत करें |
| `subscription.active` | भुगतान के बाद पुनः सक्रिय | पहुंच पुनर्स्थापित करें |
