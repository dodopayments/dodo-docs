...
<Info>
इस खंड में **सर्वर-साइड API** थीम कॉन्फ़िगरेशन को `customization.theme_config` के साथ शामिल किया गया है। यदि आप **Checkout SDK** (ओवरले या इनलाइन चेकआउट) का उपयोग कर रहे हैं, तो [ओवरले चेकआउट](/developer-resources/overlay-checkout#theme-customization) में थीम अनुकूलन अनुभाग देखें जो कि camelCase गुणों का उपयोग करता है (उदाहरण के लिए, `bgPrimary` के बजाय `bg_primary`)।
</Info>
...
| `font_primary_url` | प्राथमिक फ़ॉन्ट के लिए URL |
| `font_secondary_url` | सेकेंडरी फ़ॉन्ट के लिए URL |
| `font_size` | फ़ॉन्ट आकार: `xs`, `sm`, `md`, `lg`, `xl`, `2xl` |
| `font_weight` | फ़ॉन्ट वजन: `normal`, `medium`, `bold`, `extraBold` |
| `radius` | UI तत्वों के लिए बॉर्डर रेडियस (उदा., `4px`, `0.5rem`, `8px`) |
| `pay_button_text` | पे बटन के लिए कस्टम टेक्स्ट (उदा., "खरीद पूरी करें", "अभी सब्सक्राइब करें") |

### रंग कॉन्फ़िगरेशन (लाइट/डार्क मोड)

प्रत्येक मोड (`light` और `dark`) निम्नलिखित रंग प्रॉपर्टियों का समर्थन करता है:

| प्रॉपर्टी | विवरण |
|----------|-------------|
| `bg_primary` | बैकग्राउंड प्राथमिक रंग |
| `bg_secondary` | बैकग्राउंड सेकेंडरी रंग |
| `text_primary` | टेक्स्ट प्राथमिक रंग |
| `text_secondary` | टेक्स्ट सेकेंडरी रंग |
| `text_placeholder` | टेक्स्ट प्लेसहोल्डर रंग |
| `text_error` | टेक्स्ट त्रुटि रंग |
| `text_success` | टेक्स्ट सफलता रंग |
| `border_primary` | बॉर्डर प्राथमिक रंग |
| `border_secondary` | बॉर्डर सेकेंडरी रंग |
| `button_primary` | प्राथमिक बटन बैकग्राउंड रंग |
| `button_primary_hover` | प्राथमिक बटन होवर रंग |
| `button_secondary` | सेकेंडरी बटन बैकग्राउंड रंग |
...
<Tip>
आपको सभी रंग प्रॉपर्टी निर्दिष्ट करने की आवश्यकता नहीं है। कोई भी निर्दिष्ट प्रॉपर्टीज़ डिफॉल्ट थीम मान का उपयोग करेंगी।
</Tip>
