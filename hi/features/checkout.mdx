...
<Info>
यह अनुभाग `customization.theme_config` का उपयोग करके **सर्वर-साइड API** थीम कॉन्फ़िगरेशन को कवर करता है। यदि आप **Checkout SDK** (ओवरले या इनलाइन चेकआउट) का उपयोग कर रहे हैं, तो [Overlay Checkout](/developer-resources/overlay-checkout#theme-customization) या [Inline Checkout](/developer-resources/inline-checkout#theme-customization) में थीम अनुकूलन अनुभाग देखें जो camelCase गुणों (जैसे `bgPrimary` के बजाय `bg_primary`) का उपयोग करते हैं।
</Info>
