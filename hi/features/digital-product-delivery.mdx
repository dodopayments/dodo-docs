...
| Event | Behavior |
|---|---|
| INLINE_CODE_PLACEHOLDER_bfeed7a4ab5393d_END (one-time) | एक grant जारी करें। Grant में लगभग 15 मिनट तक valid presigned download URLs होते हैं; customer email link या Customer Portal page को फिर से खोलकर उन्हें refresh कर सकते हैं। |
| `subscription.active` | एक grant जारी करें। Subscription active रहने तक फ़ाइलें accessible रहती हैं। |
| `subscription.renewed` | No-op। वही grant जारी रहता है; हर fetch पर नए presigned URLs mint किए जाते हैं। |
| `subscription.on_hold` / `cancelled` / `expired` | Grant revoke करें। नए presigned URLs जारी नहीं किए जाते। |
| `subscription.plan_changed` | पुराने grant को revoke करें और नए plan के entitlement के लिए नया grant जारी करें। |
