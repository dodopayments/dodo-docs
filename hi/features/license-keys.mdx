...
## रिटर्न URL में लाइसेंस कीज

जब कोई ग्राहक लाइसेंस कीज़ सक्षम किए गए उत्पाद के लिए खरीदारी पूरी करता है, तो लाइसेंस कुंजी स्वचालित रूप से आपके `return_url` में एक क्वेरी पैरामीटर के रूप में जोड़ दी जाती है। यह आपको आपकी सफल पृष्ठ पर कुंजी तुरंत दिखाने की अनुमति देता है, बिना अतिरिक्त API कॉल किए।

```text
https://yoursite.com/return?payment_id=pay_xxx&status=succeeded&license_key=LK-001&email=customer%40example.com
```

यदि खरीदारी से कई लाइसेंस कीज़ उत्पन्न होते हैं (उदाहरण के लिए, मात्रा > 1), तो वे कॉमा से पृथक रहती हैं:

```text
https://yoursite.com/return?payment_id=pay_xxx&status=succeeded&license_key=LK-001,LK-002&email=customer%40example.com
```

सदस्यताओं के लिए, `subscription_id` का उपयोग किया जाता है बजाय `payment_id` के:
...
<Tip>
अपने रिटर्न पृष्ठ पर `license_key` पैरामीटर को पार्स करें ताकि ग्राहकों को कुंजी तुरंत दिखा सके और खरीद के बाद के अनुभव को सुधार सके।
</Tip>

## सर्वोत्तम अभ्यास

- **सीमाएं स्पष्ट रखें**: समाप्ति और सक्रियण के लिए समझदारी भरी डिफ़ॉल्ट चुनें
- **उपयोगकर्ताओं का मार्गदर्शन करें**: सही सक्रियण निर्देश और स्व-सहायता दस्तावेज़ीकरण प्रदान करें
- **जांच को स्वचालित करें**: एक्सेस देने से पहले सर्वर-साइड कीज़ को मान्य करें
- **घटनाओं की निगरानी करें**: दुरुपयोग का पता लगाने और स्वचालित रद्द करने के लिए वेबहुक का उपयोग करें
