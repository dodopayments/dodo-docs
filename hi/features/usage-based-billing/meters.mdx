...
<Frame>
<img src="/images/usage-based/UBB-2.png" alt="मीटर निर्माण इंटरफ़ेस जिसमें इवेंट नाम, सारणीकरण प्रकार और फ़िल्टरिंग विकल्प दर्शाए गए हैं" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/usage-based/UBB-3.png" alt="इवेंट फ़िल्टरिंग" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
**तुलना ऑपरेटर**: बराबर है, बराबर नहीं है, से अधिक, से अधिक या बराबर, से कम, से कम या बराबर, इसमें शामिल है, इसमें शामिल नहीं है
...
<Frame>
<img src="/images/usage-based/UBB-1.png" alt="मीटर विश्लेषण" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Attach Credit - UBB-5.jpg" alt="क्रेडिट टॉगल में बिल उपयोग के साथ मीटर कॉन्फ़िगरेशन सक्षम" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
