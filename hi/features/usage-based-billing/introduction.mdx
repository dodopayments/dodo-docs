...
<Frame>
<img src="/images/usage-based/UBB-2.png" alt="मीटर इंटरफेस बनाएं" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/usage-based/UBB-4.png" alt="मूल्य निर्धारण विन्यास" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
डॉलर में प्रति-यूनिट शुल्क लेने के बजाय, आप मीटर को ग्राहक के [क्रेडिट बैलेंस](/features/credit-based-billing) से घटाने के लिए कॉन्फ़िगर कर सकते हैं। क्रेडिट प्रत्येक बिलिंग चक्र के साथ ताजा होते हैं और किसी भी ओवरएज शुल्क से पहले लागू होते हैं।
...
<Frame>
<img src="/images/usage-based/UBB-5.png" alt="उत्पाद में मीटर जोड़ना" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/guides/usage-based-billing/meter-quantities-chart.png" alt="मीटर डैशबोर्ड" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
