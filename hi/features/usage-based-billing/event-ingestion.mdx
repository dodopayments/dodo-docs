...
आपके मीटर के इवेंट नाम से मेल खाता इवेंट प्रकार (केस-सेंसिटिव)। उदाहरण: `api.call`, `image.generated`
</ParamField>
</Accordion>
...
संघटन और फ़िल्टरिंग के लिए अतिरिक्त प्रॉपर्टीज:
...
डुप्लिकेट रोकने के लिए निश्चित आईडी का उपयोग करें: `${customerId}_${action}_${timestamp}`
</Accordion>
...
API कुंजी सही है और प्रारूप का उपयोग करें: `Bearer YOUR_API_KEY`
</Accordion>
...
<Accordion title="धातात्मकता संचित नहीं हो रही">
- धातात्मकता कुंजी मीटर के "ओवर प्रॉपर्टी" से सटीक रूप से मेल खानी चाहिए
- संख्याएँ उपयोग करें, स्ट्रिंग नहीं: `tokens: 150` नहीं `tokens: "150"`
</Accordion>
</AccordionGroup>
