...
ISO 8601 timestamp (UTC)। यदि इसे छोड़ा जाए, तो वर्तमान server time डिफ़ॉल्ट होता है। delayed/batch events के साथ सटीक billing के लिए इसे शामिल करें। 1 घंटे से पुराने या भविष्य में 5 मिनट से अधिक के timestamps अस्वीकार कर दिए जाते हैं।
</ParamField>
...
<Tip>
बेहतर प्रदर्शन के लिए प्रति अनुरोध अधिकतम 1,000 ईवेंट एकत्र करें। API प्रति कॉल 1,000 ईवेंट की एक सख्त सीमा लागू करता है।
</Tip>
