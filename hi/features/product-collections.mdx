...
|---------|-------------|---------|
| **एकाधिक Subscriptions की अनुमति दें** | Customers एक ही समय में एक से अधिक active subscription रख सकते हैं | Enabled |
| **Subscription Updates की अनुमति दें** | Customers Customer Portal के माध्यम से कभी भी अपनी मौजूदा subscriptions को upgrade या downgrade कर सकते हैं | Disabled |
| **Subscription Cancellation की अनुमति दें** | Customers Customer Portal से अपनी subscriptions स्वयं cancel कर सकते हैं | Enabled |
| **Trial Misuse रोकें** | जिन Customers ने पहले ही trial redeem कर लिया है, उन्हें नया trial देने के बजाय paid, no-trial purchase में बदल दिया जाता है | Disabled |
...
<Info>
Trial redemptions का मिलान और रिकॉर्ड किस तरह किया जाता है, इसकी जानकारी के लिए [Preventing Trial Misuse](/features/subscription#preventing-trial-misuse) देखें।
</Info>
...
Product Collections को Dodo Payments dashboard के माध्यम से या API द्वारा programmatically प्रबंधित किया जा सकता है। API collection creation, updates, image uploads, archiving और nested groups तथा products के प्रबंधन पर पूर्ण नियंत्रण प्रदान करता है।

### Dashboard Operations

- **Create**: products और groups के साथ नई collections सेट अप करें
...
- **Enable/Disable products**: checkout में दिखाई देने वाले products नियंत्रित करें
- **Archive**: किसी collection को स्थायी रूप से delete किए बिना छिपाएँ (बाद में unarchive किया जा सकता है)
...
निम्न endpoints आपको product collections को programmatically create, update, retrieve, archive और organize करने की अनुमति देते हैं — इसमें nested groups और उनके भीतर मौजूद products का प्रबंधन भी शामिल है।

<AccordionGroup>
<Accordion title="Listing Product Collections">
अपने account से संबद्ध सभी product collections को `GET` request के माध्यम से `/product-collections` endpoint का उपयोग करके प्राप्त करें। यह pagination, brand के आधार पर filtering और archived collections को शामिल करने का समर्थन करता है।
...
pre-signed URL के माध्यम से image upload करके उसे collection से संबद्ध करें। `/product-collections/{id}/images` endpoint से upload URL का अनुरोध करें, फिर image को 60 seconds के भीतर लौटाए गए URL पर `PUT` करें।
...
`DELETE` request को `/product-collections/{id}` endpoint पर भेजकर collection को archive करें। इससे collection नए उपयोग से छिप जाती है, लेकिन स्थायी रूप से remove नहीं होती।
...
Groups आपको collection के भीतर products को व्यवस्थित करने देते हैं (उदाहरण के लिए, "Monthly Plans" बनाम "Annual Plans")। किसी collection के भीतर groups जोड़ने, update करने या remove करने के लिए groups endpoints का उपयोग करें।
...
किसी group के भीतर मौजूद individual product items को manage करें — नए products जोड़ें, मौजूदा items (जैसे display order) को update करें या उन्हें पूरी तरह remove करें।
...
<Card title="Add Products to Group" icon="code" href="/api-reference/product-collections/add-group-items">
  किसी collection के भीतर group में एक या अधिक products जोड़ें।
</Card>
<Card title="Update Group Item" icon="code" href="/api-reference/product-collections/update-group-item">
  किसी group के भीतर product item को update करें।
</Card>
...
- **रणनीतिक रूप से order करें**: सबसे लोकप्रिय या recommended plan को पहले रखें, क्योंकि checkout पर वह pre-selected होगा
...
- **अच्छी तरह test करें**: live जाने से पहले test mode में checkout और plan change flows verify करें

<Check>
अब आप product collections बनाने और customers को unified plan selection experience देने के लिए तैयार हैं।
</Check>
...
<Card title="Checkout" icon="cart-shopping" href="/features/checkout">
  collection products को unified checkout experience में display करें।
</Card>

<Card title="Customer Portal" icon="id-card" href="/features/customer-portal">
  Customers को उसी collection के भीतर upgrade या downgrade करने दें।
</Card>
