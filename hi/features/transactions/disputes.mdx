...
3. **अपनी प्रतिक्रिया चुनें**
   - आप या तो विवाद स्वीकार कर सकते हैं या उसका विरोध कर सकते हैं
   
   <Frame>
       <img src="/images/disputes/1.png" alt="विवाद निर्माण" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
...
5. **यदि विरोध कर रहे हैं**
   - प्रमाण जमा करने के लिए तैयार रहें
   - नीचे दिए गए सर्वोत्तम प्रथाओं का पालन करें
   
   <Frame>
       <img src="/images/disputes/2.png" alt="विवाद निर्माण" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
   
   <Frame>
       <img src="/images/disputes/3.png" alt="विवाद निर्माण" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
...
<Frame caption="Visa RDR configuration in the Dodo Payments dashboard">
    <img src="/images/disputes/rdr.png" alt="वीज़ा आरडीआर सेटिंग्स दिखाते हुए सक्षम टॉगल और थ्रेशोल्ड कॉन्फ़िगरेशन" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
