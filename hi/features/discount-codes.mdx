...
- **लचीले छूट**: प्रतिशत या निश्चित राशि की छूट
- **स्टैक करने योग्य कोड**: एक चेकआउट, भुगतान या सब्सक्रिप्शन प्रति 20 कोड तक लागू करें — विशेष कोड बनाए बिना अभियानों को संयोजित करें (उदा. <code>`WELCOME10`</code> + <code>`BLACKFRIDAY20`</code>)
- **लक्षित नियंत्रण**: उत्पाद और सब्सक्रिप्शन चक्रों द्वारा प्रतिबंधित करें
- **अभियान शासन**: समाप्ति तिथियां और उपयोग सीमाएं
- **सहज चेकआउट**: चेकआउट सत्रों के माध्यम से UI फ़ील्ड और API समर्थन
