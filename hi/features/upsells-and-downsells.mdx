...
<Info>
`difference_immediately` के साथ किए गए डाउनग्रेड से मिलने वाले क्रेडिट्स सदस्यता-स्कोप्ड होते हैं और स्वचालित रूप से भविष्य के नवीनीकरण में लागू होते हैं। ये [Customer Credits](/features/customer-credit) से अलग होते हैं।
</Info>
