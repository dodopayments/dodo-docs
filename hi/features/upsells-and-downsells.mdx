...
| मोड | व्यवहार | इसके लिए सर्वोत्तम |
|------|----------|----------|
| `difference_immediately` | मूल्य का अंतर तुरंत चार्ज करता है ($30→$80 = $50) | सरल अपग्रेड |
| `prorated_immediately` | billing cycle में बचे समय के आधार पर चार्ज करता है | उचित समय-आधारित billing |
| `full_immediately` | नए प्लान की पूरी कीमत चार्ज करता है और बचे समय को अनदेखा करता है | billing cycle रीसेट होता है |
| `do_not_bill` | बिना किसी तत्काल चार्ज के plan change लागू करता है; नए प्लान का billing अगले renewal पर किया जाता है और मूल billing date बरकरार रहती है | सौजन्य अपग्रेड और निःशुल्क migration |
