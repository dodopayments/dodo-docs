...
<Frame>
  <img src="/images/product-collection/checkout-page.png" alt="प्रोडक्ट कलेक्शन्स" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
बार-बार उपयोग होने वाले उत्पादों के लिए, `price` ऑब्जेक्ट को एक आवर्ती मूल्य (`type: recurring_price`) पर सेट करें और `payment_frequency_interval` और `subscription_period_interval` (`Day`, `Week`, `Month`, या `Year`) के साथ उनके संबंधित संख्या निर्दिष्ट करें।
...
यदि आप अब किसी उत्पाद को प्रदर्शित या उपयोग नहीं करना चाहते हैं, तो आप `DELETE` अनुरोध का उपयोग करके इसे `/products/{id}` एंडपॉइंट पर संग्रहित कर सकते हैं। यह क्रिया उत्पाद को छुपा देती है लेकिन इसे स्थायी रूप से हटाती नहीं है।
