...
सभी लेज़र इवेंट्स (`credit.added` से लेकर `credit.manual_adjustment` तक) में पूरा `CreditLedgerEntry` पेलोड शामिल होता है जिसमें बैलेंस पहले/बाद, ओवरएज पहले/बाद, स्रोत संदर्भ, और ग्रांट के स्रोत सब्सक्रिप्शन या भुगतान का `metadata` शामिल होता है (API के माध्यम से सीधे निर्मित ग्रांट के लिए खाली)। `credit.balance_low` इवेंट में थ्रेशोल्ड कॉन्फ़िगरेशन और वर्तमान बैलेंस शामिल होता है।
