...
- **मूल्य निर्धारण प्रकार**: <b>Subscription</b> (इस गाइड) चुनें। विकल्प हैं Single Payment और Usage Based Billing।
- **मूल्य** (आवश्यक): मुद्रा के साथ आधार आवर्ती मूल्य। मूल्य कम से कम **$1** (या आपकी चुनी गई मुद्रा के समकक्ष) होना चाहिए। इस न्यूनतम से कम राशि का समर्थन नहीं किया गया है और सदस्यता काम नहीं करेगी।
- **डिस्काउंट लागू (%)**: आधार मूल्य पर लागू वैकल्पिक प्रतिशत छूट; चेकआउट और इनवॉयस में प्रतिबिंबित।
- **भुगतान हर बार दोहराएं** (आवश्यक): नवीनीकरण के लिए अंतराल, जैसे, हर 1 महीना। आवृत्ति (महीने या वर्ष) और मात्रा चुनें।
- **सदस्यता अवधि** (आवश्यक): कुल अवधि जिसके लिए सदस्यता सक्रिय रहती है (जैसे, 10 वर्ष)। इस अवधि के समाप्त होने के बाद, नवीनीकरण बंद हो जाएगा जब तक कि इसे बढ़ाया न जाए।
- **परीक्षण अवधि दिन** (आवश्यक): दिनों में परीक्षण की लंबाई सेट करें। परीक्षणों को अक्षम करने के लिए 0 का उपयोग करें। जब परीक्षण समाप्त होता है, तो पहला शुल्क स्वचालित रूप से होता है।
- **ऐड-ऑन चुनें**: बेस प्लान के साथ ग्राहक अधिकतम 10 ऐड-ऑन खरीद सकते हैं।
...
|---|---|---|---|---|
| **उन्नयन** | शेष दिनों के लिए आनुपातिक शुल्क | पूर्ण मूल्य अंतर का शुल्क | पूरी नई योजना का शुल्क | कोई शुल्क नहीं — तुरंत स्विच करें |
| **डाउनग्रेड** | शेष दिनों के लिए आनुपातिक क्रेडिट | मूल्य अंतर का पूर्ण क्रेडिट | कोई क्रेडिट नहीं, पूरा शुल्क | कोई क्रेडिट नहीं — तुरंत स्विच करें |
| **बिलिंग चक्र** | आज से शुरू होता है | आज से शुरू होता है | आज से शुरू होता है | वही रहता है |
| **सर्वश्रेष्ठ के लिए** | निष्पक्ष समय-आधारित बिलिंग | साधारण स्तर परिवर्तन | बिलिंग चक्र रीसेट | मुफ्त माइग्रेशन या शिष्टाचार स्विच |
</Info>
...
अगला नवीनीकरण **फरवरी 15** (जनवरी 16 + 30 दिन) को: **$80.00/महीना**।
...
<Info>
सब्सक्रिप्शन आवर्ती राजस्व के लिए एक लचीला आधार हैं। सरल शुरुआत करें, पूरी तरह से परीक्षण करें, और अपनाने, घटाव, और विस्तार मीट्रिक्स के आधार पर पुनरावृत्ति करें।
</Info>

  48 घंटे की प्रसंस्करण विंडो के दौरान:

  - ग्राहक अपने बैंकिंग ऐप्स के माध्यम से आदेश रद्द कर सकते हैं।
  - यदि कोई ग्राहक इस अवधि के दौरान आदेश रद्द करता है, तो सदस्यता **सक्रिय** रहेगी (यह भारतीय कार्ड और UPI AutoPay सदस्यता के लिए एक विशेष स्थिति है)।
  - हालांकि, वास्तविक कटौती विफल हो सकती है, और इस मामले में, हम सदस्यता को **रोक पर** रखेंगे।

  **विशिष्ट स्थिति प्रबंधन:** यदि आप चार्ज चालू करने पर ग्राहकों को लाभ, क्रेडिट, या सदस्यता उपयोग प्रदान करते हैं, तो आपको इस 48 घंटे की विंडो को अपने एप्लिकेशन में सही तरीके से संभालना होगा। विचार करें:

  - भुगतान पुष्टि तक लाभ सक्रियण में देरी करना
  - अनुग्रह अवधि या अस्थायी पहुंच को लागू करना
  - आदेश रद्दीकरण के लिए सदस्यता स्थिति की निगरानी करना
  - आपके एप्लिकेशन तर्क में सदस्यता होल्ड स्थितियों का प्रबंधन करना

  <Tip>
  भुगतान स्थिति परिवर्तनों को ट्रैक करने के लिए सदस्यता वेबहुक्स की निगरानी करें और उस स्थिति को संभालें जहां आदेश 48 घंटे की विंडो के दौरान रद्द किए जाते हैं।
  </Tip>

## सर्वोत्तम अभ्यास

- **स्पष्ट स्तरों के साथ प्रारंभ करें**: 2-3 योजनाएं जिनमें स्पष्ट अंतर हो
- **मूल्य निर्धारण संवाद करें**: कुल, भाग बदलने और अगले नवीनीकरण को दिखाएं
- **परीक्षणों का समझदारी से उपयोग करें**: केवल समय के साथ नहीं, ऑनबोर्डिंग के साथ परिवर्तित करें
- **ऐड‑ऑन का लाभ उठाएं**: बेस योजनाओं को सरल रखें और एक्स्ट्रा को अपसेल करें
- **परिवर्तनों का परीक्षण करें**: योजना परिवर्तनों और भाग बदलने को परीक्षण मोड में सत्यापित करें

<Info>
सदस्यताएँ आवर्ती राजस्व के लिए एक लचीला आधार हैं। सरल प्रारंभ करें, पूरी तरह से परीक्षण करें, और अपनाने, छोड़ने और विस्तार के मेट्रिक्स के आधार पर पुनरावृति करें।
</Info>