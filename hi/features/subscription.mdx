...
अगली billing date पर रद्द करने, subscription period बढ़ाने, billing details अपडेट करने या metadata में बदलाव करने के लिए `PATCH /subscriptions/{id}` का उपयोग करें। quantity बदलने के लिए इसके बजाय [Change Plan API](/api-reference/subscriptions/change-plan) का उपयोग करें — `PATCH`, `quantity` स्वीकार नहीं करता।
