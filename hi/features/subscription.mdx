...
| ट्रांज़िशन | इवेंट |
|------------|-------|
| सब्सक्रिप्शन सक्रिय किया गया | `subscription.active` |
| नवीनीकरण सफल होता है | `subscription.renewed` |
| नवीनीकरण विफल → रोका गया | `subscription.on_hold` |
| सब्सक्रिप्शन रोका गया | `subscription.paused` |
| रोके गए सब्सक्रिप्शन को फिर से शुरू किया गया | `subscription.unpaused` |
| निर्माण विफल होता है | `subscription.failed` |
| प्लान अपग्रेड/डाउनग्रेड किया गया | `subscription.plan_changed` |
| रद्द किया गया | `subscription.cancelled` |
| अवधि समाप्त हुई | `subscription.expired` |
| किसी भी फ़ील्ड में बदलाव | `subscription.updated` |
...
अगली बिलिंग तिथि पर रद्द करने, सब्सक्रिप्शन की अवधि बढ़ाने, बिलिंग विवरण अपडेट करने या मेटाडेटा में बदलाव करने के लिए `PATCH /subscriptions/{subscription_id}` का उपयोग करें। मात्रा बदलने के लिए इसके बजाय [Change Plan API](/api-reference/subscriptions/change-plan) का उपयोग करें — `PATCH`, `quantity` स्वीकार नहीं करता।
...
### सब्सक्रिप्शन की अवधि बढ़ाएँ
एक नया `subscription_period_count` और `subscription_period_interval`, `PATCH /subscriptions/{subscription_id}` को पास करके सब्सक्रिप्शन कितने समय तक चलता है, यह अवधि बढ़ाएँ। नए काउंट और इंटरवल के आधार पर सब्सक्रिप्शन की समाप्ति तिथि फिर से निर्धारित की जाती है — उदाहरण के लिए, किसी ग्राहक को उसके वर्तमान प्लान पर अतिरिक्त समय देने के लिए:
