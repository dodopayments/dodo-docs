...
<Card title="Global Merchant of Record" icon="globe">
  जटिलता के बिना वैश्विक बनें: 190+ देशों में अंतर्निहित कवरेज, 80+ मुद्राएँ, और 30+ भुगतान विधियाँ
</Card>
...
<Step title="Add Your First Product">
  ...
  <Card title="Usage-Based Billing" icon="chart-bar" href="/features/usage-based-billing/introduction">
    API कॉल, क्रेडिट, टोकन या किसी भी उपयोग मेट्रिक के लिए ग्राहकों से शुल्क लें - AI और SaaS के लिए आदर्श
  </Card>
  <Card title="Credit-Based Billing" icon="coins" href="/features/credit-based-billing">
    क्रेडिट जारी करें (API कॉल, टोकन, कम्प्यूट यूनिट) और जैसे-जैसे ग्राहक उपभोग करें, कटौती करें - रोलओवर और अति नियंत्रण के साथ
  </Card>
  </CardGroup>
</Step>
...
<Card title="Community Support" icon="users" href="https://discord.gg/bYqAp4ayYh">
  सहायता और चर्चा के लिए हमारे Discord समुदाय से जुड़ें
</Card>
