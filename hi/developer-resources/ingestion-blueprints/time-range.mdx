...
अपने [Dodo Payments Dashboard](https://app.dodopayments.com/) में मीटर बनाएं:
- **इवेंट नाम**: `time_range_usage` (या आपका पसंदीदा नाम)
- **संग्रहण प्रकार**: `sum` कुल अवधि को ट्रैक करने के लिए
- **ऑवर प्रॉपर्टी**: `durationSeconds`, `durationMinutes`, या `durationMs`
</Step>
...
<Warning>
**सटीक समय**: सटीक समय ट्रैकिंग के लिए `Date.now()` या `performance.now()` का उपयोग करें, विशेषकर सर्वरलेस फ़ंक्शंस के लिए।
</Warning>
