...
- **एकत्रण प्रकार**: `count` कॉल की संख्या को ट्रैक करने के लिए
- प्रतिक्रिया समय, स्थिति कोड आदि जैसी मेटाडेटा को ट्रैक करने के लिए अतिरिक्त गुण कॉन्फ़िगर करें।
</Step>
...
स्वचालित-फ्लश से पहले घटनाओं की अधिकतम संख्या। डिफ़ॉल्ट: `100`।
</ParamField>

<ParamField path="flushInterval" type="number">
मिलिसेकंड में स्वचालित-फ्लश अंतराल। डिफ़ॉल्ट: `5000` (5 सेकंड)।
</ParamField>

## सर्वोत्तम प्रथाएँ

<Tip>
**उच्च मात्रा के लिए बैचिंग का उपयोग करें**: उन अनुप्रयोगों के लिए जो 10 से अधिक अनुरोध प्रति सेकंड संभालते हैं, ओवरहेड को कम करने और प्रदर्शन में सुधार के लिए `createBatch()` का उपयोग करें।
</Tip>

<Warning>
**हमेशा बैच को साफ करें**: डेटा हानि से बचने के लिए APPLICATION SHUTDOWN पर `batch.cleanup()` को कॉल करें ताकि लंबित घटनाओं को फ्लश किया जा सके।
</Warning>
