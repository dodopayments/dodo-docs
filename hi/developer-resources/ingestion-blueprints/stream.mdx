...
<Step title="मीटर बनाएँ">
अपने [Dodo Payments Dashboard](https://app.dodopayments.com/) में मीटर बनाएँ:
- **इवेंट नाम**: `stream_consumption` (या आपकी पसंद का नाम)
- **संविधान प्रकार**: `sum` ताकि कुल स्ट्रीम किए गए बाइट्स को ट्रैक किया जा सके
- **ओवर प्रॉपर्टी**: `bytes` ताकि बैंडविड्थ उपयोग के आधार पर बिल बनाया जा सके
</Step>
