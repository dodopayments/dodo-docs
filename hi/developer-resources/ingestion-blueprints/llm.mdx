...
4. **अपने मीटर को कॉन्फ़िगर करें**:
   ...
   - **संमिलन प्रकार**: टोकन गिनती जोडने के लिए `sum` चुनें
   - **प्रॉपर्टी पर**: क्या ट्रैक करना है चुनें:
     - `inputTokens` - इनपुट/प्रांप्ट टोकन ट्रैक करें
     - `outputTokens` - आउटपुट/पूर्णता टोकन ट्रैक करें (जब लागू हो तो तर्क टोकन शामिल होते हैं)
...
<Warning>
हमेशा विकास के दौरान `test_mode` का उपयोग करें ताकि उत्पादन मेट्रिक्स पर प्रभाव न पड़े।
</Warning>
</ParamField>
...
<Note>
जब AI SDK के माध्यम से तर्क-योग्य मॉडलों का उपयोग करते हैं (जैसे कि Google's Gemini 2.5 Flash थिंकिंग मोड में), तर्क टोकन स्वचालित रूप से `outputTokens` गिनती में शामिल होते हैं ताकि सटीक बिलिंग हो सके।
</Note>
</Accordion>
...
<Note>
**Gemini थिंकिंग मोड:** Gemini मॉडलों का उपयोग करते समय जिनमें थिंकिंग/तर्क करने की क्षमताएं होती हैं (जैसे Gemini 2.5 Pro), SDK स्वचालित रूप से `thoughtsTokenCount` (तर्क टोकन) को `outputTokens` में शामिल करता है ताकि पूर्ण गणना लागत को सही ढंग से प्रदर्शित किया जा सके।
</Note>
</Accordion>
</AccordionGroup>
...
- `inputTokens` - उपयोग किए गए इनपुट/प्रांप्ट टोकन की संख्या
- `outputTokens` - उपयोग किए गए आउटपुट/पूर्णता टोकन की संख्या (जब लागू हो तो तर्क टोकन शामिल होते हैं)
- `totalTokens` - कुल टोकन (इनपुट + आउटपुट)
- `model` - उपयोग किया गया LLM मॉडल (जैसे, "gpt-4")
- `provider` - LLM प्रदाता (यदि लपेटने वाले मेटाडेटा में शामिल है)
- जब आपने क्लाइंट को लपेटते समय कोई कस्टम मेटाडेटा प्रदान किया हो

<Note>
**तर्क टोकन:** उन मॉडलों के लिए जिनमें तर्क करने की क्षमताएं होती हैं, `outputTokens` सामान्यत: पूर्णता टोकन और तर्क टोकन दोनों को शामिल करता है।
</Note>
</ParamField>

<Info>
आपका Dodo Payments मीटर `metadata` फ़ील्ड (विशेष रूप से `inputTokens`, `outputTokens` या `totalTokens`) का उपयोग करके उपयोग और बिलिंग की गणना करता है।
</Info>
