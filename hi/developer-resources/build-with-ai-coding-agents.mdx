...
<Accordion title="Local API key mode — OpenCode">
अपनेआप को `dodopayments-api` में घोषित करें — आपकी प्रविष्टि प्लगइन के डिफ़ॉल्ट रिमोट सर्वर से ऊपर आती है:
...
लागू करने के लिए OpenCode को पुनरारंभ करें।
</Accordion>
</AccordionGroup>
...
<CardGroup cols={2}>
<Card title="MCP Server" icon="terminal" href="/developer-resources/mcp-server">
  दोनों MCP सर्वरों के लिए पूरी संदर्भ — सभी समर्थित क्लाइंट, कॉन्फ़िगरेशन, और उपलब्ध उपकरण
</Card>
...
<Card title="Sentra IDE Assistant" icon="bolt" href="/developer-resources/sentra">
  VS Code, Cursor, और Windsurf के लिए AI संचालित बिलिंग सहायक — अपने संपादक में पूछें, बनाएँ, और योजना बनाएँ
</Card>

<Card title="API Reference" icon="book" href="/api-reference/introduction">
  सभी Dodo Payments एंडपॉइंट्स के लिए OpenAPI का पूरा संदर्भ
</Card>
</CardGroup>