...
आप इन संस्थाओं का कोई भी संयोजन `scopes` पैरामीटर में निर्दिष्ट करके समन्वयित कर सकते हैं। सभी समन्वयन ऑपरेशनों में अंतर्दृष्टिगत होते हैं और केवल नए या अपडेटेड रिकॉर्ड को अनुकूलित प्रदर्शन के लिए स्थानांतरित करते हैं।
...
समन्वयित करने के लिए डेटा संस्थाओं की कॉमा से अलग सूची। उपलब्ध स्कोप: `licences`, `payments`, `customers`, `subscriptions`। उदाहरण: `"payments,customers"`.
</ParamField>

<ParamField path="--api-key" type="string" required>
आपकी Dodo Payments API कुंजी। इसे लाइव मोड के लिए `dp_live_` या टेस्ट मोड के लिए `dp_test_` से शुरू होना चाहिए।
</ParamField>

<ParamField path="--env" type="string" required>
पर्यावरण लक्ष्य। इसे `"live_mode"` या `"test_mode"` होना चाहिए। यह निर्धारित करता है कि Dodo Payments का कौन सा वातावरण समन्वयित किया जाएगा।
</ParamField>
...
<Tip>
`interval` विकल्प का उपयोग करते समय `.start()` स्वचालित समन्वय के लिए आवश्यक है। समन्वय निर्दिष्ट अंतराल पर लगातार चलेगा जब तक प्रक्रिया को रोक नहीं दिया जाता।
</Tip>
...
<Tip>
जब मैनुअल समन्वय का उपयोग कर रहे हैं, तो `interval` विकल्प की आवश्यकता नहीं है। आप जब भी समन्वय ऑपरेशन करने की आवश्यकता हो `.run()` को कॉल कर सकते हैं।
</Tip>

#### PostgreSQL उदाहरण

PostgreSQL के साथ `dodo-sync` का उपयोग कैसे करें:
...
MySQL के साथ `dodo-sync` का उपयोग कैसे करें:
...
ClickHouse के साथ `dodo-sync` का उपयोग कैसे करें:
...
संस्थाओं का एक सरणी जो समन्वयित की जाएगी। उपलब्ध विकल्प: `"licences"`, `"payments"`, `"customers"`, `"subscriptions"`। आप इनका कोई भी संयोजन शामिल कर सकते हैं।
</ParamField>
...
स्वचालित समन्वय के बीच समय सेकंड में। `.start()` का उपयोग करते समय यह आवश्यक है। मैनुअल समन्वय के लिए `.run()` का उपयोग करते समय वैकल्पिक।
</ParamField>
...
<Warning>
**MongoDB**: आपके डेटाबेस सर्वर पर अपने नाम का एक डेटाबेस `dodopayments_sync` होगा। सभी समन्वय डेटा वहां संग्रहीत किया जाएगा। यह डेटाबेस नाम वर्तमान में स्थिर है और इसे बदला नहीं जा सकता।

**PostgreSQL**: आपके कनेक्शन URI में निर्दिष्ट डेटाबेस में तालिकाएँ (`Subscriptions`, `Payments`, `Licenses`, `Customers`) बनाई जाएँगी। डेटा JSONB के रूप में संग्रहीत किया जाता है।

**MySQL**: आपके कनेक्शन URI में निर्दिष्ट डेटाबेस में तालिकाएँ (`Subscriptions`, `Payments`, `Licenses`, `Customers`) बनाई जाएँगी। डेटा JSON के रूप में संग्रहीत किया जाता है।

**ClickHouse**: ReplacingMergeTree इंजन का उपयोग करते हुए तालिकाएँ (`Subscriptions`, `Payments`, `Licenses`, `Customers`) बनाई जाएँगी। जब क्वेरी करते हैं, तो सुनिश्चित करें कि डुप्लिकेट रहित परिणामों के लिए `FINAL` कीवर्ड का उपयोग करें।
</Warning>
