...
पूरा नाम field अक्षम करें।
</ParamField>
<ParamField query="disableFirstName" type="boolean">
पहले नाम का field अक्षम करें।
</ParamField>
<ParamField query="disableLastName" type="boolean">
अंतिम नाम का field अक्षम करें।
</ParamField>
<ParamField query="disableEmail" type="boolean">
email field अक्षम करें।
</ParamField>
<ParamField query="disableCountry" type="boolean">
देश का field अक्षम करें।
</ParamField>
<ParamField query="disableAddressLine" type="boolean">
address line का field अक्षम करें।
</ParamField>
<ParamField query="disableCity" type="boolean">
शहर का field अक्षम करें।
</ParamField>
<ParamField query="disableState" type="boolean">
राज्य का field अक्षम करें।
</ParamField>
<ParamField query="disableZipCode" type="boolean">
zip code का field अक्षम करें।
</ParamField>
<ParamField query="paymentCurrency" type="string">
भुगतान की currency निर्दिष्ट करें (उदाहरण के लिए, <code>USD</code>)।
</ParamField>
<ParamField query="showCurrencySelector" type="boolean">
currency selector दिखाएँ।
</ParamField>
<ParamField query="paymentAmount" type="number">
चार्ज की जाने वाली राशि को major currency units में निश्चित करता है (उदाहरण के लिए, $12.50 के लिए <code>12.5</code>)। केवल Pay What You Want products के लिए, और यदि यह product की न्यूनतम कीमत से कम है तो इसे अनदेखा कर दिया जाता है।
</ParamField>
...
पर्यावरण वेरिएबल सेटअप:

सुनिश्चित करें कि इन पर्यावरण वेरिएबल्स को अपने प्रोजेक्ट में परिभाषित करें:
...
इन्हें अपने कोड के अंदर इस प्रकार उपयोग करें:

process.env.DODO_PAYMENTS_API_KEY
process.env.DODO_PAYMENTS_WEBHOOK_SECRET

सुरक्षा नोट: संस्करण नियंत्रण में सीक्रेट्स को कमिट न करें। .env फाइलों का उपयोग स्थानीय रूप से करें और डिप्लॉयमेंट वातावरण में सीक्रेट्स मैनेजर्स (जैसे, AWS, Vercel, Heroku, आदि) का उपयोग करें।