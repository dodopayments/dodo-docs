...
<Warning>
इवेंट का नाम `ai_chat_usage` बिल्कुल उसी तरह होना चाहिए जैसा हम बाद में अपने एप्लिकेशन कोड से भेजेंगे। इवेंट नाम केस-संवेदी है!
</Warning>
</Step>
...
**मापन यूनिट**: प्रकार → `tokens`

<Info>
हम "Sum" का उपयोग कर रहे हैं क्योंकि हम कई चैट संदेशों में उपभोक्त किए गए सभी टोकनों को जोड़ना चाहते हैं। SDK स्वचालित रूप से प्रत्येक इवेंट में `totalTokens` भेजता है।
</Info>
</Step>
...
<Steps>
<Step title="Dodo भुगतान API कुंजी प्राप्त करें">
1. अपने Dodo भुगतान डैशबोर्ड में, **डेवलपर्स** → **API कुंजी** पर जाएं
2. **API कुंजी बनाएं** पर क्लिक करें
3. API कुंजी की नकल करें - यह `test_abc123...` की तरह दिखेगी
...
इसके अतिरिक्त, **स्थिर मूल्य** को `0` पर सेट करें ताकि यह सुनिश्चित हो सके कि ग्राहकों को केवल उनके उपयोग के आधार पर चार्ज किया जाए, बिना किसी बेस शुल्क के।
...
**प्रति यूनिट मूल्य**: दर्ज करें → `0.00001` (यह $0.01 प्रति 1,000 टोकन या $0.00001 प्रति टोकन है)

**फ्री थ्रेशोल्ड**: दर्ज करें → `10000` (ग्राहकों को प्रति माह 10,000 फ्री टोकन मिलते हैं)
...
<Step title="अपने ग्राहक आईडी खोजें">
1. अपने Dodo भुगतान डैशबोर्ड में वापस जाएं
2. बाएं साइडबार में **सेल्स** -> **ग्राहक** पर जाएं
3. ग्राहक को खोजें जिसे आपने अभी बनाया है (परीक्षण ईमेल के साथ)
4. ग्राहक आईडी की नकल करें - यह `cus_123` की तरह दिखेगी
...
UPDATE `package.json` को माड्यूल प्रकार और स्क्रिप्ट जोड़ें:
...
CREATE एक `.env` फ़ाइल अपने प्रोजेक्ट रूट में:
...
<Step title="बैकेंड सर्वर बनाएं">
CREATE `src/server.ts` और इस पूरे सर्वर कोड की नकल करें:
...
अब चलिए एक सुंदर चैट इंटरफेस जोड़ते हैं जिसमें पूरा वार्तालाप इतिहास है! CREATE `public/index.html`:
...
1. सत्यापित करें कि आपकी `.env` फ़ाइल में चरण 2 से सभी API कुंजियाँ हैं
...
<Note>
यह सुनिश्चित करें कि आप चरण 4 से अपने वास्तविक परीक्षण ग्राहक आईडी के साथ `CUSTOMER_ID` को `server.ts` में अपडेट करें।
</Note>
</Step>
...
- ग्राहक आईडी: आपका परीक्षण ग्राहक आईडी
...
**समाधान:**
1. सत्यापित करें कि इवेंट नाम मीटर कॉन्फ़िगरेशन के साथ बिल्कुल मेल खाता है (केस-संवेदी: `ai_chat_usage`)
2. जाँच करें कि ग्राहक आईडी Dodo भुगतान डैशबोर्ड में मौजूद है
3. सरल API कॉल के साथ API कुंजी का परीक्षण करें
4. त्रुटि संदेशों के लिए सर्वर लॉग की जाँच करें
</Accordion>
...
- `.env` फ़ाइल में अतिरिक्त स्थान या उद्धरण

**समाधान:**
- सुनिश्चित करें कि परीक्षण कुंजी `test_` से शुरू होती है, लाइव कुंजी `live_` से शुरू होती है
- `.env` फ़ाइल में किसी भी कुंजी के चारों ओर उद्धरण हटा दें
- आवश्यकता होने पर एक नई कुंजी उत्पन्न करें
</Accordion>
</AccordionGroup>
