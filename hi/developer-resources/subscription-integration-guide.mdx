...
Subsequent charges के लिए, [POST /subscriptions/{subscription_id}/charge](/api-reference/subscriptions/create-charge) endpoint का उपयोग करें और उस transaction के लिए customer से charge की जाने वाली amount specify करें।

<Note>
पूरी step-by-step guide (जिसमें request/response examples, safe retry policies और webhook handling शामिल हैं) के लिए <a href="/developer-resources/ondemand-subscriptions">On-Demand Subscriptions Guide</a> देखें।
</Note>
