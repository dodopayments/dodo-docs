...
| प्रॉपर्टी | टाइप | आवश्यक | विवरण |
|----------|------|----------|-------------|
| `business_id` | string | हाँ | बिज़नेस के लिए विशिष्ट पहचानकर्ता |
| `timestamp` | string | हाँ | इवेंट के घटित होने का timestamp (यह आवश्यक नहीं है कि यह उसके डिलीवर होने के समय के समान हो) |
| `type` | string | हाँ | इवेंट का प्रकार। [Subscription Event Types](#subscription-event-types) देखें |
| `data` | object | हाँ | मुख्य डेटा payload। [Subscription webhook payloads](/developer-resources/webhooks/intents/subscription) देखें |
