...
अगली शुल्कों के लिए, [POST /subscriptions/{subscription_id}/charge](/api-reference/subscriptions/create-charge) एपीआई का उपयोग करें और उस लेनदेन के लिए ग्राहक से वसूल की जाने वाली राशि निर्दिष्ट करें।
