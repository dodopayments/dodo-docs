...
<Step title="पर्यावरण चर कॉन्फ़िगर करें">
  अपने डोडो पेमेंट्स क्रेडेंशियल्स को अपने वातावरण में जोड़ें:
...
सरल, साझा भुगतान लिंक के लिए स्थिर चेकआउट का उपयोग करें। उत्पाद आईडी को क्वेरी पैरामीटर के रूप में पास करें:
...
| **Hono** | एज तैनाती, क्लाउडफ्लेयर वर्कर्स | एज, Node.js |
