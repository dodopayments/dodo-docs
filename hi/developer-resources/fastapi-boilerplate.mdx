...
<Info>
यह बायलरप्लेट FastAPI का उपयोग करता है जिसमें async/await पैटर्न, वैलिडेशन के लिए Pydantic, और API एकीकरण के लिए `dodopayments` Python SDK शामिल है।
</Info>
...
root निदेशिका में एक `.env` फ़ाइल बनाएं:
...
<Warning>
कभी भी अपनी `.env` फ़ाइल को संस्करण नियंत्रण में न डालें। यह पहले से `.gitignore` में शामिल है।
</Warning>
</Step>
...
| एपीआई अंत बिंदु | विधि | विवरण |
|----------|--------|-------------|
| `/checkout` | POST | एक नई चेकआउट सत्र बनाएँ |
| `/webhook` | POST | डोडो पेमेंट्स वेबहुक को संभालें |
...
| `payment.failed` | भुगतान प्रयास विफल |
...
<Warning>
उत्पादन में तैनाती से पहले:
- `DODO_PAYMENTS_ENVIRONMENT` को `live_mode` में स्विच करें
- डैशबोर्ड से उत्पादन एपीआई कुंजी का उपयोग करें
- वेबहुक URL को अपने उत्पादन डोमेन पर अपडेट करें
- सभी अंत बिंदुओं के लिए HTTPS सक्षम करें
</Warning>
...
<Accordion title="चेकआउट सत्र बनाने में विफलता">
**सामान्य कारण:**
- अमान्य उत्पाद ID - सत्यापित करें कि यह आपके डोडो डैशबोर्ड में है
- `.env` में गलत एपीआई कुंजी या पर्यावरण सेटिंग
...
अपने [डोडो डैशबोर्ड](https://app.dodopayments.com/developer/webhooks) में वेबहुक URL को ngrok URL में अपडेट करें। सुनिश्चित करें कि आप सही वेबहुक सत्यापन कुंजी के साथ अपनी `.env` फ़ाइल को अपडेट करते हैं।
</Accordion>

<Accordion title="वेबहुक सिग्नेचर सत्यापन विफलता">
- सुनिश्चित करें कि `DODO_PAYMENTS_WEBHOOK_KEY` आपकी `.env` में सही सेट है
- सत्यापन के लिए कच्चे अनुरोध शरीर का उपयोग कर रहे हैं यह सत्यापित करें
- सुनिश्चित करें कि आप `webhook-signature` हेडर को सही तरीके से पढ़ रहे हैं
</Accordion>
</AccordionGroup>
