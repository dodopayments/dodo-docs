...
- सुनिश्चित करें कि `DODO_PAYMENTS_WEBHOOK_KEY` आपके `.env` में सही तरीके से सेट है
- सत्यापित करें कि आप signature verification के लिए raw request body का उपयोग कर रहे हैं
- सभी तीन `webhook-id`, `webhook-timestamp`, और `webhook-signature` headers को `webhook.verify()` में पास करें — Standard Webhooks signature केवल body को नहीं, बल्कि `id.timestamp.body` को कवर करता है
</Accordion>
</AccordionGroup>
