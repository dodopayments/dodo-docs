...
ngrok URL पर अपने [Dodo डैशबोर्ड](https://app.dodopayments.com/developer/webhooks) में वेबहुक URL अपडेट करें। सुनिश्चित करें कि आप अपने `.env` फ़ाइल को सही वेबहुक सत्यापन कुंजी के साथ अपडेट कर रहे हैं।
</Accordion>
