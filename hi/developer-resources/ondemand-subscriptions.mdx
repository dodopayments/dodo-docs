...
<Tip>
यह गाइड एक चेकआउट सत्र के माध्यम से ऑन-डिमांड सब्सक्रिप्शन बनाता है (`POST /checkouts`), जो हमेशा एक होस्टेड `checkout_url` लौटाता है। वहाँ ग्राहक को अनुमति देने के लिए पुनर्निर्देशित करें, और सेट करें `return_url` जहां उन्हें बाद में पहुंचना चाहिए।
</Tip>
...
यदि पुनः प्रयास विफल हो रहे हैं क्योंकि भुगतान विधि स्वयं टूटी हुई है (जैसे कि कार्ड का समाप्त होना, खाता बंद होना, आदि), तो ग्राहक से नया प्राप्त करने के लिए [`POST /subscriptions/{subscription_id}/update-payment-method`](/api-reference/subscriptions/update-payment-method) का उपयोग करें। सफलता पर, सदस्यता `active` में लौट आती है और `payment.succeeded` के बाद `subscription.active` वेबहुक जारी किए जाते हैं।
</Step>
</Steps>
...
सब्सक्रिप्शन बनाने के लिए अपनी परीक्षण API कुंजी का उपयोग करें, फिर लौटाए गए `checkout_url` को खोलें और अनुमोदन पूरा करें।
</Step>
<Step title="Trigger a charge">
एक छोटा सा चार्ज भेजने के लिए चार्ज एन्डपॉइंट को कॉल करें `product_price` (उदा., `100`) और सत्यापित करें कि आपको `payment.succeeded` प्राप्त हो।
</Step>
<Step title="Go live">
एक बार जब आप इवेंट्स और आंतरिक स्थिति अपडेट को सत्यापित कर लेते हैं, तो अपनी लाइव API कुंजी में स्विच करें।
</Step>
</Steps>
