...
<Info>
सभी उदाहरण मानते हैं कि आप SvelteKit ऐप राउटर का उपयोग कर रहे हैं।
</Info>

<Tabs>
<Tab title="चेकआउट हैंडलर">
  <Info>
  इस हैंडलर का उपयोग अपने SvelteKit ऐप में Dodo Payments चेकआउट को एकीकृत करने के लिए करें। स्थिर (GET), गतिशील (POST), और सत्र (POST) भुगतान प्रवाह का समर्थन करता है।
  </Info>
  <CodeGroup>
...
<Tab title="ग्राहक पोर्टल हैंडलर">
  <Info>
  इस हैंडलर का उपयोग ग्राहकों को Dodo Payments ग्राहक पोर्टल के माध्यम से अपने सब्सक्रिप्शन और विवरण प्रबंधित करने की अनुमति देने के लिए करें।
  </Info>
  <CodeGroup>
...
<Tab title="वेबहुक हैंडलर">
  <Info>
  इस हैंडलर का उपयोग अपने SvelteKit ऐप में Dodo Payments वेबहुक घटनाओं को सुरक्षित रूप से प्राप्त और संसाधित करने के लिए करें।
  </Info>
  <CodeGroup>
...
<Info>
Dodo Payments आपके वेबसाइट में भुगतान एकीकृत करने के लिए तीन प्रकार के भुगतान प्रवाह का समर्थन करता है, यह एडेप्टर सभी प्रकार के भुगतान प्रवाह का समर्थन करता है।
</Info>
