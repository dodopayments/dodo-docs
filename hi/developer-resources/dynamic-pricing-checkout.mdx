...
1. **कीमत की सीमाएँ निर्धारित करें**: न्यूनतम कीमत (आवश्यक) और वैकल्पिक रूप से अधिकतम कीमत निर्धारित करें
2. **गणनात्मक राशियाँ पास करें**: चेकआउट सत्र बनाने पर उत्पाद कार्ट में `amount` फ़ील्ड शामिल करें
3. **ग्राहकों को चुनने दें**: यदि कोई राशि प्रदान नहीं की गई है, तो ग्राहक अपनी खुद की कीमत दर्ज कर सकते हैं (आपकी सीमाओं के भीतर)

<Info>
जब आप उत्पाद कार्ट में `amount` पास करते हैं, तो वह राशि चेकआउट के लिए उपयोग की जाती है। यदि आप `amount` फ़ील्ड को छोड़ देते हैं, तो ग्राहकों को चेकआउट के दौरान अपनी कीमत चुनने की अनुमति होती है (आपके न्यूनतम/अधिकतम सेटिंग्स के अधीन)।
</Info>
...
जब आपका उत्पाद Pay What You Want के साथ कॉन्फ़िगर किया जाता है, तो आप गतिशील राशियों के साथ चेकआउट सत्र बना सकते हैं। उत्पाद कार्ट में `amount` फ़ील्ड आपको प्रत्येक चेकआउट सत्र के लिए कीमत को प्रोग्रामेटिक रूप से सेट करने की अनुमति देती है।
...
- **यदि `amount` छूटा हुआ है**: ग्राहक चेकआउट के दौरान अपनी कीमत दर्ज कर सकते हैं (आपकी सीमाओं के भीतर)

<Warning>
`amount` फ़ील्ड केवल Pay What You Want उत्पादों के लिए लागू है। नियमित उत्पादों के लिए, यह फ़ील्ड अनदेखी की जाती है।
</Warning>
...
यदि आप ग्राहकों को चेकआउट के दौरान अपनी कीमत चुनने देना चाहते हैं, तो बस उत्पाद कार्ट से `amount` फ़ील्ड को हटा दें। चेकआउट पृष्ठ पर एक इनपुट फ़ील्ड प्रदर्शित होगा जहां ग्राहक आपकी न्यूनतम और अधिकतम सीमाओं के भीतर कोई भी राशि दर्ज कर सकते हैं।
...
<Card title="कीमत निर्धारण निर्णयों का ट्रैक करें" icon="chart-line">
विशिष्ट राशियों के चयन के कारण को ट्रैक करने के लिए मेटाडेटा का उपयोग करें (जैसे, `pricing_tier`, `discount_code`, `user_segment`)।
</Card>
...
<AccordionGroup>
<Accordion title="राशि अनदेखी की जा रही है">
यदि आपका `amount` फ़ील्ड अनदेखी की जा रही है, तो सुनिश्चित करें कि:
...
<Accordion title="ग्राहक अपनी कीमत नहीं दर्ज कर सकता">
यदि ग्राहक कीमत इनपुट फ़ील्ड नहीं देख पा रहे हैं, तो सुनिश्चित करें कि आपने उत्पाद कार्ट से `amount` फ़ील्ड हटा दिया है। जब `amount` प्रदान किया गया है, तो चेकआउट उस सटीक राशि का उपयोग करता है।
</Accordion>
</AccordionGroup>