...
चार्ज की जाने वाली राशि को major currency units में निश्चित करता है (e.g., $12.50 के लिए <code>12.5</code>)। केवल Pay What You Want products के लिए, और यदि यह product की minimum price से कम हो तो इसे अनदेखा कर दिया जाता है।
</ParamField>
...
Checkout sessions एक अधिक सुरक्षित, hosted checkout experience प्रदान करते हैं, जो पूर्ण customization control के साथ one-time purchases और subscriptions दोनों के लिए complete payment flow को संभालता है।
