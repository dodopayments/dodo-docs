...
<Step title="क्लाइंट प्रारंभ करें">
...
<Step title="अपना पहला API कॉल करें">
...
<Info>
हम Node.js SDK से नए TypeScript SDK में माइग्रेट हुए हैं। यदि आप पुराने Node.js SDK का उपयोग कर रहे हैं, तो अपने एकीकरण को अपडेट करने के लिए [माइग्रेशन गाइड](https://github.com/dodopayments/dodopayments-typescript/blob/main/MIGRATION.md) देखें।
</Info>
...
<Card title="Next.js" icon="atom" href="/developer-resources/nextjs-adaptor">
  App Router समर्थन के साथ React-आधारित पूर्ण-स्टैक फ्रेमवर्क
</Card>
...
<Card title="Convex" icon="database" href="/developer-resources/convex-component">
  रीयल-टाइम क्षमताओं के साथ Backend-as-a-Service
</Card>
</CardGroup>

<AccordionGroup>
<Accordion title="अन्य 8+ समर्थित फ्रेमवर्क दिखाएँ">
  <CardGroup cols={4}>
...
हम सभी SDKs में योगदान का स्वागत करते हैं! प्रत्येक रिपॉजिटरी में एक `CONTRIBUTING.md` फ़ाइल है जिसमें निम्नलिखित के लिए दिशानिर्देश हैं:
