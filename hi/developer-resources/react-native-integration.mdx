...
<Step title="भुगतान प्रदाता सेटअप करें">
    अपने ऐप को `DodoPaymentProvider` से लपेटें:
...
<Step title="भुगतान स्क्रीन लागू करें">
    अपनी भुगतान स्क्रीन को `useCheckout` हुक का उपयोग करते हुए बनाएँ। यहाँ एक पूर्ण कार्यान्वयन है:
...
आप रंगों, फ़ॉन्ट, और अन्य को अनुकूलित करके React Native Unified Checkout को अपने ऐप के डिज़ाइन से मेल करने के लिए रूपांतरित कर सकते हैं, जो `initPaymentSession()` को कॉल करते समय उपस्थिति पैरामीटर के माध्यम से है।
...
| `secondaryText` | इनपुट फ़ील्ड के लिए लेबल पाठ रंग |
| `componentText` | इनपुट पाठ का रंग (जैसे, कार्ड संख्या, ज़िप कोड) |
| `placeholderText` | इनपुट फ़ील्ड के लिए प्लेसहोल्डर पाठ रंग |
| `icon` | आइकनों के लिए रंग (जैसे, क्लोज़ बटन) |
