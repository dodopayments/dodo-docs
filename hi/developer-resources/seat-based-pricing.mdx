...
**पुनरावर्ती कीमत**: दर्ज करें → `49.00`

**बिलिंग चक्र**: चयन करें → `Monthly`
...
<Step title="अपने पर्यावरण फ़ाइल बनाएँ">
अपनी डोडो पेमेंट्स API कुंजी के साथ एक `.env` फ़ाइल बनाएँ:
...
<Warning>
कभी भी अपनी API कुंजी को संस्करण नियंत्रण में कमिट न करें। `.env` को अपनी `.gitignore` फ़ाइल में जोड़ें।
</Warning>
</Step>
...
आसान परीक्षण के लिए एक `public/index.html` फ़ाइल बनाएँ:
...
<Step title="स्थिर फ़ाइलें प्रदान करें">
HTML फ़ाइल प्रदान करने के लिए इसे अपनी `src/server.ts` में जोड़ें:
...
<Check>
**स्थिर फ़ाइलें कॉन्फ़िगर की गईं!** अपने डेमो इंटरफ़ेस को देखने के लिए `http://localhost:3000` पर जाएँ।
</Check>
</Step>
</Steps>
...
<Steps>
<Step title="अपने सर्वर को प्रारंभ करें">
1. सुनिश्चित करें कि आपकी `.env` फ़ाइल में सही API कुंजी है
2. अपने कोड में उत्पाद और ऐड-ऑन आईडी को अपने डोडो पेमेंट्स डैशबोर्ड के वास्तविक मानों के साथ अपडेट करें
...
1. अपने ब्राउज़र को खोलें और `http://localhost:3000` पर जाएँ
2. आपको सीट-आधारित मूल्य निर्धारण डेमो इंटरफ़ेस दिखाई देगा
3. विभिन्न सीट मात्रा (0, 3, 10, आदि) का प्रयास करें
4. प्रत्येक मात्रा के लिए "चेकआउट लिंक उत्पन्न करें" पर क्लिक करें
5. सत्यापित करें कि चेकआउट URLs सही ढंग से उत्पन्न होते हैं
