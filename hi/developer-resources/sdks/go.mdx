...
<Info>
SDK को Go 1.22 या बाद के संस्करणों की आवश्यकता है, जो आधुनिक Go सुविधाओं का उपयोग करके सर्वोत्तम प्रदर्शन के लिए है।
</Info>
...
<CardGroup cols={2}>
<Card title="संदर्भ समर्थन" icon="clock">
  रद्दीकरण और समय सीमा के लिए context.Context का पूर्ण समर्थन
</Card>

<Card title="मजबूत टाइपिंग" icon="shield-check">
  संकलन समय की सुरक्षा के लिए मजबूत टाइप वाले अनुरोध और प्रतिक्रियाएँ
</Card>

<Card title="मिडलवेयर" icon="layer-group">
  लॉगिंग, मेट्रिक्स और कस्टम लॉजिक के लिए विस्तारित मिडलवेयर समर्थन
</Card>

<Card title="गोरूटीन सुरक्षित" icon="bolt">
...
<CardGroup cols={2}>
<Card title="GitHub रिपॉजिटरी" icon="github" href="https://github.com/dodopayments/dodopayments-go">
...
<Card title="समस्याएँ रिपोर्ट करें" icon="bug" href="https://github.com/dodopayments/dodopayments-go/issues">
