...
जब API एक गैर-सफलता स्थिति कोड लौटाता है, तो SDK एक प्रकार की त्रुटि लौटाता है
`*dodopayments.Error`। यह `StatusCode`, अंतर्निहित `*http.Request` और
`*http.Response`, और त्रुटि बॉडी के JSON को उजागर करता है। इसे जाँचने के लिए `errors.As` पैटर्न का उपयोग करें और विशिष्ट मामलों को संभालने के लिए `StatusCode` पर शाखा करें:
