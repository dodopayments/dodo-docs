...
<Info>
`productPrice` को सबसे कम मुद्रा संप्रदाय में व्यक्त किया जाता है (जैसे, USD के लिए सेंट, INR के लिए पैसे)। $25.00 चार्ज करने के लिए, पास करें `2500`।
</Info>

<Tip>
`subscriptions().charge(...)` के माध्यम से चार्जिंग [ऑन-डिमांड सब्सक्रिप्शन्स](/developer-resources/ondemand-subscriptions) के लिए होती है। उत्पाद की मूल्य निर्धारण अनुसूची के आधार पर मानक निर्धारित सब्सक्रिप्शन स्वचालित रूप से बिल किए जाते हैं।
</Tip>
...
### इवेंट्स बैच में इन्गेस्ट करें

कई इवेंट्स को प्रभावी ढंग से प्राप्त करें (प्रत्येक अनुरोध पर अधिकतम 1000):
...
विभिन्न स्थितियों के लिए व्यापक त्रुटि प्रबंधन:
...
<Tip>
SDK स्वत: कनेक्शन त्रुटियों, 408, 409, 429, और 5xx त्रुटियों पर अनुरोधों को पुनः प्रयास करता है।
</Tip>

## एसिंक्रोनस ऑपरेशन्स

एसिंक्रोनस ऑपरेशन्स के लिए CompletableFuture का उपयोग करें:
...
<Card title="Report Issues" icon="bug" href="https://github.com/dodopayments/dodopayments-java/issues">
  त्रुटियों की रिपोर्ट करें या फीचर्स का अनुरोध करें
</Card>
</CardGroup>

## समर्थन

जावा SDK के साथ सहायता चाहिए?
...
- **GitHub**: [रिपोज़िटरी](https://github.com/dodopayments/dodopayments-java) पर एक समस्या खोलें

## योगदान

हम योगदान का स्वागत करते हैं! शुरू करने के लिए [योगदान दिशानिर्देश](https://github.com/dodopayments/dodopayments-java/blob/main/CONTRIBUTING.md) देखें।
