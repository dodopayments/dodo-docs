...
<Tip>
हमेशा नवीनतम SDK संस्करण का उपयोग करें ताकि डोडो भुगतान की नवीनतम सुविधाओं तक पहुंच प्राप्त हो सके। नवीनतम संस्करण के लिए [Maven Central](https://central.sonatype.com/artifact/com.dodopayments.api/dodo-payments-java) की जांच करें।
</Tip>
...
<Card title="प्रकार सुरक्षा" icon="shield-check">
  संकलन-समय सुरक्षा के साथ मजबूत प्रकार वाला API
</Card>

<Card title="थ्रेड-सुरक्षित" icon="bolt">
  मल्टी-थ्रेडेड अनुप्रयोगों में समवर्ती उपयोग के लिए सुरक्षित
</Card>

<Card title="बिल्डर पैटर्न" icon="layer-group">
  अनुरोधों का निर्माण करने के लिए सहज बिल्डर पैटर्न
</Card>

<Card title="असिंक्रोनस समर्थन" icon="arrows-rotate">
  असिंक्रोनस संचालन के लिए CompletableFuture समर्थन
</Card>
</CardGroup>
...
<CardGroup cols={2}>
<Card title="गिटहब रिपॉजिटरी" icon="github" href="https://github.com/dodopayments/dodopayments-java">
...
<Card title="डिस्कॉर्ड समुदाय" icon="discord" href="https://discord.gg/bYqAp4ayYh">
  मदद प्राप्त करें और डेवलपर्स से जुड़ें
</Card>

<Card title="समस्याएँ रिपोर्ट करें" icon="bug" href="https://github.com/dodopayments/dodopayments-java/issues">
