...
विकास के लिए, चाबियाँ `appsettings.json` में संग्रहीत करने के बजाय [उपयोगकर्ता रहस्य](https://learn.microsoft.com/en-us/aspnet/core/security/app-secrets) का उपयोग करें:
...
- **GitHub**: [repository](https://github.com/dodopayments/dodopayments-csharp) पर एक समस्या खोलें
