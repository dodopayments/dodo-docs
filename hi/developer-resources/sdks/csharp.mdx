...
<Info>
SDK को .NET Standard 2.0 या बाद के संस्करण की आवश्यकता है। यह ASP.NET Core, कंसोल एप्लिकेशन और अन्य .NET प्रोजेक्ट प्रकारों के साथ काम करता है।
</Info>
...
<Card title="Async/Await" icon="bolt">
  नॉन-ब्लॉकिंग ऑपरेशनों के लिए पूर्ण async Task-आधारित API
</Card>

<Card title="Strong Typing" icon="shield-check">
  नल संदर्भ प्रकारों के साथ व्यापक प्रकार की सुरक्षा
</Card>

<Card title="Dependency Injection" icon="layer-group">
  .NET निर्भरता इंजेक्शन के लिए प्रथम श्रेणी का समर्थन
</Card>
...
| ------------- | --------------------------- | -------- | --------------------------------- |
| `BearerToken` | `DODO_PAYMENTS_API_KEY`     | सही     | -                                 |
| `WebhookKey`  | `DODO_PAYMENTS_WEBHOOK_KEY` | गलत    | -                                 |
| `BaseUrl`     | `DODO_PAYMENTS_BASE_URL`    | सही     | `"https://live.dodopayments.com"` |
...
सभी पृष्ठों में सभी परिणामों के माध्यम से पुनरावृत्त करने के लिए, `Paginate` विधि का उपयोग करें:
...
<CardGroup cols={2}>
<Card title="GitHub रिपॉजिटरी" icon="github" href="https://github.com/dodopayments/dodopayments-csharp">
...
<Card title="समस्याएँ रिपोर्ट करें" icon="bug" href="https://github.com/dodopayments/dodopayments-csharp/issues">
