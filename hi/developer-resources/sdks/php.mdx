...
<Note>
  Dodo Payments PHP API लाइब्रेरी वर्तमान में **बीटा** में है। हम इसके साथ प्रयोग करने के लिए उत्साहित हैं! कृपया [एक समस्या दर्ज करके](https://github.com/dodopayments/dodopayments-php/issues) कोई सुझाव, बग रिपोर्ट या फीचर अनुरोध साझा करें।
</Note>
...
SDK वैकल्पिक तर्कों को निर्दिष्ट करने के लिए नामित पैरामीटर का उपयोग करता है। आप स्टैटिक `with` कंस्ट्रक्टर का उपयोग करके मूल्य वस्तुओं को प्रारंभ कर सकते हैं:
...
जब पुस्तकालय API से कनेक्ट नहीं कर पाता है या एक गैर-सफल स्थिति कोड (4xx या 5xx) प्राप्त करता है, तो `APIException` का एक उपवर्ग फेंका जाता है:
...
<Tip>
  हमेशा API कॉल को संभावित त्रुटियों को संभालने के लिए try-catch ब्लॉकों में लपेटें
  सुचारू रूप से और उपयोगकर्ताओं को अर्थपूर्ण फीडबैक प्रदान करें।
</Tip>
...
<Note>
  समान नाम वाले `extra*` पैरामीटर दस्तावेज़ीकृत पैरामीटर को ओवरराइड करते हैं।
</Note>
...
<CardGroup cols={2}>
<Card title="GitHub रिपॉजिटरी" icon="github" href="https://github.com/dodopayments/dodopayments-php">
...
<Card title="समस्याएँ रिपोर्ट करें" icon="bug" href="https://github.com/dodopayments/dodopayments-php/issues">
