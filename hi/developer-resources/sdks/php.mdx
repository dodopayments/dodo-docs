...
SDK वैकल्पिक तर्कों को निर्दिष्ट करने के लिए नामित पैरामीटर का उपयोग करता है। आप निम्नलिखित स्थैतिक `with` कन्स्ट्रक्टर का उपयोग करके मान वस्तुओं को प्रारंभ कर सकते हैं:
...
जब पुस्तकालय API से कनेक्ट नहीं कर पाता है या गैर-सफल स्थिति कोड (4xx या 5xx) प्राप्त करता है, तो एक `APIException` का उप-वर्ग उत्पन्न होता है:
...
| समय समाप्त      | `APITimeoutException`          |
...
<Note>
  समान नाम वाले `extra*` पैरामीटर प्रलेखित पैरामीटर को ओवरराइड करते हैं।
</Note>
