...
<Info>
इवेंट्स के लिए अद्वितीय `event_id` मान होना आवश्यक है ताकि उन्हें idempotency मिल सके। एक ही अनुरोध में डुप्लिकेट आईडी अस्वीकृत होते हैं, और मौजूदा आईडी के साथ पिछले अनुरोधों को नजरअंदाज कर दिया जाता है।
</Info>
...
- `'info'` - जानकारी, चेतावनियाँ, और त्रुटियाँ दिखाएँ  
...
DodoPayments API में सूची विधियाँ पृष्ठबद्ध हैं। आप सभी पृष्ठों के आइटम के बीच घूमने के लिए `for await … of` सिंटैक्स का उपयोग कर सकते हैं:
...
- वेब ब्राउज़र (अप-टू-डेट Chrome, Firefox, Safari, Edge, और अन्य)
- Node.js 20 LTS या बाद के संस्करण ([non-EOL](https://endoflife.date/nodejs))
- Deno v1.28.0 या उच्चतर
- Bun 1.0 या बाद के संस्करण
- Cloudflare Workers
- Vercel Edge Runtime
- Jest 28 या अधिक `"node"` के साथ वातावरण
- Nitro v2.6 या अधिक
