...
checkout browser के toolbar, buttons और color scheme को `customization` के माध्यम से `CheckoutParams` पर customize करें। Options को platform के अनुसार group किया गया है, क्योंकि Android का Custom Tab और iOS का `SFSafariViewController` अलग-अलग native controls expose करते हैं। सभी fields optional हैं; `customization` को छोड़ने पर प्रत्येक platform का default appearance उपयोग होता है।
...
`standard` system का "X" icon दिखाता है; `back` इसके बजाय back arrow बनाता है।
</ParamField>

<ParamField body="closeButtonPosition" type="CloseButtonPosition">
Toolbar के किस side पर close button दिखाई देता है।
</ParamField>
...
`start` केवल गलत उपयोग या platform failure के लिए `CheckoutException` throw करता है।
Cancelled या declined payment हमेशा result होता है, exception नहीं।
...
<Info>
यदि checkout के दौरान app बंद हो जाता है, तो अगली launch पर session recover करें और
