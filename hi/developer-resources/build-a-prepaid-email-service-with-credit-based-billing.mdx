...
description: MailKit बनाएं, एक transactional email platform जिसमें प्रीपेड ईमेल
  क्रेडिट हैं। Resend और Dodo Payments
  द्वारा संचालित मासिक subscription plan, एकमुश्त top-up packs, प्रत्येक send पर
  तुरंत credit deduction और कम balance की proactive alerts।
icon: envelope
keywords:
  - "Dodo Payments"
  - developer guide
