...
<Accordion title="चेकआउट रीडायरेक्ट विफल">
**सामान्य कारण:**
...
<Accordion title="ग्राहक पोर्टल लिंक काम नहीं कर रहा">
`CUSTOMER_ID` को `src/app/components/Header.tsx` में हार्डकोडेड के बजाय अपने Dodo डैशबोर्ड से वास्तविक ग्राहक ID के साथ बदलें।
