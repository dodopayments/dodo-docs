...
2. एक उत्पाद बनाएं (एक-बार भुगतान या सदस्यता)। सदस्यता उत्पादों की कीमत कम से कम **$1** (या आपकी चुनी हुई मुद्रा के समकक्ष) होनी चाहिए; इस न्यूनतम से नीचे की राशि का समर्थन नहीं किया जाता है।
...
<Card title="Create Checkout Session" icon="code" href="/api-reference/checkout-sessions/create">
  एकल भुगतान और सब्सक्रिप्शन के लिए सुरक्षित, होस्टेड चेकआउट सत्र बनाने के लिए API संदर्भ
</Card>
<Card title="Create Payment Link" icon="link" href="/api-reference/payments/post-payments">
  प्रोग्रामेटिक रूप से डायनेमिक पेमेंट लिंक बनाने के लिए API संदर्भ
</Card>
</CardGroup>