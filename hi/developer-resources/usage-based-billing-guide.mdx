...
- `equals` - सटीक मिलान
- `not_equals` - बहिष्करण फ़िल्टर
- `greater_than` - गणना की तुलना
- `greater_than_or_equals` - गणना की तुलना (समावेशी)
- `less_than` - गणना की तुलना
- `less_than_or_equals` - गणना की तुलना (समावेशी)
- `contains` - स्ट्रिंग में उपस्ट्रिंग शामिल
- `does_not_contain` - स्ट्रिंग बहिष्करण फ़िल्टर
</Step>
...
<Frame>
<img src="/images/guides/usage-based-billing/meter-quantities-chart.png" alt="मीटर मात्राएँ चार्ट जो समय के साथ उपयोग प्रवृत्तियों को बैंगनी ग्रेडिएंट विज़ुअलाइज़ेशन के साथ दिखा रहा है" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/guides/usage-based-billing/events-table.png" alt="इवेंट्स टेबल जो इवेंट के नाम, आईडी, और विस्तृत इवेंट विश्लेषण के लिए पेजिनेशन कंट्रोल्स दिखा रहा है" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
- गुण: `plan_type`, तुलनित्र: `equals`, मान: `premium`
- गुण: `hour`, तुलनित्र: `greater_than_or_equals`, मान: `9`
- गुण: `hour`, तुलनित्र: `less_than`, मान: `17`
...
<Card title="Create Meter" icon="gauge" href="/api-reference/meters/create-meter">
  API reference for creating and configuring usage meters for tracking customer consumption
</Card>
<Card title="Ingest Usage Events" icon="arrow-right" href="/api-reference/usage-events/ingest-events">
  API reference for sending usage events to your configured meters for billing calculations
</Card>
</CardGroup>