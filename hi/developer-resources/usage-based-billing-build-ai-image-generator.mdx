...
अब हम अपनी PixelGen AI सेवा के लिए विशिष्ट विवरण दर्ज करेंगे:

**मीटर का नाम**: इसे ठीक से कॉपी और पेस्ट करें → `Image Generation Meter`

**विवरण**: इसे कॉपी करें → `Tracks each AI image generation request made by customers using our DALL-E powered service`

**इवेंट का नाम**: यह महत्वपूर्ण है - ठीक से कॉपी करें → `image.generated`

<Warning>
इवेंट का नाम `image.generated` बिल्कुल उसी से मेल खाना चाहिए जो हम बाद में अपनी एप्लिकेशन कोड से भेजेंगे। इवेंट नाम केस-सेंसिटिव हैं!
</Warning>
</Step>

<Step title="हम इमेज कैसे गिनते हैं, कॉन्फ़िगर करें">
संघटन सेट करें (कैसे मीटर हमारी घटनाओं को गिनता है):

**संघटन प्रकार**: ड्रॉपडाउन से **गिनती** चुनें

**मापने की यूनिट**: टाइप करें → `images`
...
<Step title="गुणवत्ता फ़िल्टरिंग जोड़ें">
...
1. **इवेंट फ़िल्टरिंग सक्षम करें**: इसे **ऑन** करें
2. **फ़िल्टर लॉजिक**: **या** चुनें (इसका मतलब है "यदि इनमें से कोई भी शर्त सही है तो गिनें")
3. **पहली शर्त जोड़ें**:
   - प्रॉपर्टी की: `quality`
   - कंपरेटर: `equals`  
   - मूल्य: `standard`
4. **दूसरी के लिए "शर्त जोड़ें" पर क्लिक करें**:
   - प्रॉपर्टी की: `quality`
   - कंपरेटर: `equals`
   - मूल्य: `hd`
...
**उत्पाद का नाम**: इसे कॉपी करें → `PixelGen AI - Image Generation`

**विवरण**: इसे कॉपी करें → `AI-powered image generation service with pay-per-use billing`
...
इसके अतिरिक्त, सुनिश्चित करें कि **फिक्स्ड प्राइस** को `0` पर सेट किया गया है ताकि ग्राहकों को केवल उनके उपयोग के आधार पर चार्ज किया जाए, बिना किसी आधार शुल्क के।
...
<Step title="अपनी मूल्य निर्धारण सेट करें">
...
**प्रति यूनिट कीमत**: दर्ज करें → `0.05` (यह प्रति छवि $0.05 है)

**फ्री थ्रेशोल्ड**: दर्ज करें → `10` (ग्राहकों को प्रति माह 10 फ्री छवियाँ मिलती हैं)

<Tip>
**बिलिंग कैसे काम करती है**: यदि एक ग्राहक एक महीने में 25 इमेज उत्पन्न करता है, तो उन्हें 15 इमेज के लिए चार्ज किया जाएगा (25 - 10 मुफ्त) = 15 × $0.05 = $0.75
</Tip>
</Step>
...
भुगतानी लिंक कुछ इस तरह दिखेगा: `https://test.checkout.dodopayments.com/buy/pdt_IgPWlRsfpbPd5jQKezzW1?quantity=1`
</Step>
...
<Step title="अपने ग्राहक आईडी को खोजें">
1. अपने डोडो भुगतान डैशबोर्ड पर वापस जाएं
2. बाईं साइडबार में **ग्राहक** पर जाएं
3. उस ग्राहक को खोजें जिसे आपने अभी बनाया (जिसके पास परीक्षण ईमेल है)
4. ग्राहक आईडी कॉपी करें - यह ऐसे दिखेगी `cus_abc123def456`
...
<Step title="मुख्य एप्लिकेशन बनाएं">
एक फ़ाइल बनाएं जिसका नाम `index.ts` हो और इस पूर्ण एप्लिकेशन कोड को कॉपी करें:
</Step>
</Steps>
...
<Steps>
<Step title="अपने वातावरण को सेट करें">
पहले, सुनिश्चित करें कि आपके पास सब कुछ कॉन्फ़िगर किया गया है:

1. अपने `pixelgen-ai` निर्देशिका में एक `.env` फ़ाइल बनाएं
2. अपने वास्तविक एपीआई कीज जोड़ें:
...
<Step title="अपनी पहली परीक्षण इमेज उत्पन्न करें">
...
<Step title="कुछ और इमेज उत्पन्न करें">
...
<Step title="बिलिंग गणनाओं की पुष्टि करें">
...
<Step title="बिलिंग थ्रेशोल्ड का परीक्षण करें">
...
<AccordionGroup>
<Accordion title="डैशबोर्ड में घटनाएँ नहीं दिखाई दे रही हैं">
**संभावित कारण:**
