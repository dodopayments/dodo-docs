...
**मीटर नाम**: इसे ठीक से कॉपी और पेस्ट करें → `Image Generation Meter`

**विवरण**: इसे कॉपी करें → `Tracks each AI image generation request made by customers using our DALL-E powered service`

**इवेंट नाम**: यह महत्वपूर्ण है - ठीक से कॉपी करें → `image.generated`

<Warning>
इवेंट नाम `image.generated` को हमारे एप्लिकेशन कोड से बाद में भेजे जाने वाले नाम से ठीक से मेल खाना चाहिए। इवेंट नाम केस-सेंसिटिव होते हैं!
</Warning>
</Step>
...
**मापने की इकाई**: टाइप करें → `images`
...
1. **इवेंट फ़िल्टरिंग सक्षम करें**: इसे **ON** करें
2. **फ़िल्टर लॉजिक**: **OR** चुनें (इसका मतलब है "यदि इनमें से कोई भी शर्त सही है तो गिनें")
3. **पहली शर्त जोड़ें**:
   - प्रॉपर्टी की: `quality`
   - तुलना करने वाला: `equals`  
   - मान: `standard`
4. **दूसरी शर्त के लिए "शर्त जोड़ें" पर क्लिक करें**:
   - प्रॉपर्टी की: `quality`
   - तुलना करने वाला: `equals`
   - मान: `hd`
...
**उत्पाद नाम**: इसे कॉपी करें → `PixelGen AI - Image Generation`
...
इसके अतिरिक्त, सुनिश्चित करें कि **फिक्स्ड प्राइस** `0` पर सेट है ताकि ग्राहकों को केवल उनके उपयोग के आधार पर चार्ज किया जाए, बिना किसी बेस फ़ी के।
...
**प्रति इकाई मूल्य**: दर्ज करें → `0.05` (यह $0.05 प्रति छवि है)

**फ्री थ्रेशोल्ड**: दर्ज करें → `10` (ग्राहकों को प्रति माह 10 मुफ्त छवियाँ मिलती हैं)
...
1. अपने डोडो पेमेंट्स डैशबोर्ड पर वापस जाएं
...
एक फ़ाइल बनाएं जिसका नाम `index.ts` हो और इस पूरे एप्लिकेशन कोड को कॉपी करें:
</Step>
</Steps>
