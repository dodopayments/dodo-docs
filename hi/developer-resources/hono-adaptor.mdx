...
सुनिश्चित करें कि आपके प्रोजेक्ट में ये पर्यावरण वेरिएबल्स परिभाषित हों:
...
सुरक्षा नोट: सीक्रेट्स को वर्शन कंट्रोल में कमिट न करें। स्थानीय रूप से .env फाइल्स और डिप्लॉयमेंट वातावरणों में सीक्रेट्स मैनेजर्स (जैसे, AWS, Vercel, Heroku, आदि) का उपयोग करें।