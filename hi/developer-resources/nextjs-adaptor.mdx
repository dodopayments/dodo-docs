...
Major currency units में charge की गई राशि को निश्चित करता है (जैसे, $12.50 के लिए <code>12.5</code>)। केवल Pay What You Want products के लिए, और यदि यह product की न्यूनतम कीमत से कम है तो इसे अनदेखा किया जाता है।
</ParamField>
...
<Warning>
Dynamic Checkout, deprecated `POST /payments` और `POST /subscriptions` endpoints के लिए proxy का काम करता है। यह मौजूदा integrations के लिए काम करता रहता है, लेकिन नए integrations को नीचे दिए गए **Checkout Sessions** का उपयोग करना चाहिए।
</Warning>
...
Checkout sessions एक अधिक सुरक्षित, hosted checkout अनुभव प्रदान करते हैं, जो पूर्ण customization control के साथ one-time purchases और subscriptions, दोनों के लिए पूरी payment flow को संभालता है।
...
Customer Portal Route Handler आपको Dodo Payments customer portal को अपने Next.js application में सहजता से integrate करने में सक्षम बनाता है।
...
- **Payload Validation:** Zod के साथ validated है। Invalid payloads के लिए 400 लौटाता है।
- **Error Handling:**
