---
title: Next.js एडाप्टर
description: अपने Next.js ऐप राउटर प्रोजेक्ट के साथ Dodo Payments को एकीकृत करने
  के लिए हमारे NextJS एडाप्टर का उपयोग करना सीखें। चेकआउट, ग्राहक पोर्टल, वेबहुक
...
{/* LOCKED_PATTERN_848a353666469e7a047ef05af5a45770 */}
    स्टैटिक, डायनामिक, और सेशन प्रवाहों के साथ Dodo Payments चेकआउट को एकीकृत करें।
</Card>
...
{/* LOCKED_PATTERN_727e199da3d921456f615ec3f0aa16ca */}
    Dodo Payments वेबहूक इवेंट प्राप्त करें और प्रक्रिया करें।
</Card>
</CardGroup>
...
<Warning>
अपनी <code>.env</code> फ़ाइल या सीक्रेट्स को कभी वर्शन कंट्रोल में कमिट न करें।
</Warning>
</Step>
</Steps>
...
<Info>
सभी उदाहरण मानते हैं कि आप Next.js App Router का उपयोग कर रहे हैं।
</Info>

<Tabs>
{/* LOCKED_PATTERN_28fd81a4703a84d931eeff69f1520d54 */}
  <Info>
  इस हैंडलर का उपयोग अपने Next.js ऐप में Dodo Payments चेकआउट को एकीकृत करने के लिए करें। यह स्टैटिक (GET), डायनामिक (POST), और चेकआउट सेशन (POST) भुगतान प्रवाहों का समर्थन करता है।
  </Info>
  <CodeGroup>
...
{/* LOCKED_PATTERN_085b207030169d6eead800f9835ef4fb */}
  <Info>
  इस हैंडलर का उपयोग ग्राहकों को Dodo Payments ग्राहक पोर्टल के माध्यम से अपनी सब्सक्रिप्शन और विवरण प्रबंधित करने की अनुमति देने के लिए करें।
  </Info>
  <CodeGroup>
...
{/* LOCKED_PATTERN_0026b036379d81a9d03c36b3b6e83ddd */}
  <Info>
  इस हैंडलर का उपयोग अपने Next.js ऐप में Dodo Payments वेबहूक इवेंट को सुरक्षित रूप से प्राप्त करने और प्रक्रिया करने के लिए करें।
  </Info>
  <CodeGroup>
...
<Info>
Dodo Payments आपकी वेबसाइट में भुगतान एकीकृत करने के लिए तीन प्रकार के भुगतान प्रवाहों का समर्थन करता है, यह एडेप्टर सभी प्रकार के भुगतान प्रवाहों का समर्थन करता है।
</Info>
...
<Warning>
यदि <code>productId</code> गायब है, तो हैंडलर 400 प्रतिक्रिया लौटाता है। अवैध क्वेरी पैरामीटर भी 400 प्रतिक्रिया देते हैं।
</Warning>
...
चेकआउट सेशन एक अधिक सुरक्षित, होस्टेड चेकआउट अनुभव प्रदान करते हैं जो एक-बार खरीद और सब्सक्रिप्शन दोनों के लिए पूर्ण भुगतान प्रवाह को संभालते हैं और पूर्ण अनुकूलन नियंत्रण देते हैं।
...
ग्राहक पोर्टल रूट हैंडलर आपको अपने Next.js एप्लिकेशन में Dodo Payments ग्राहक पोर्टल को सहजता से एकीकृत करने की अनुमति देता है।
...
यदि इसे <code>true</code> पर सेट किया जाता है, तो ग्राहक को पोर्टल लिंक वाला ईमेल भेजा जाता है।
</ParamField>
