...
एनवायरनमेंट वेरिएबल सेटअप:

सुनिश्चित करें कि आपके प्रोजेक्ट में ये एनवायरनमेंट वेरिएबल परिभाषित हों:
...
इनका उपयोग अपने कोड के अंदर इस प्रकार करें:

process.env.DODO_PAYMENTS_API_KEY
process.env.DODO_PAYMENTS_WEBHOOK_KEY

सुरक्षा नोट: गुप्त जानकारी को वर्शन नियंत्रण में कमिट न करें। स्थानीय रूप से .env फाइलों और परिनियोजन परिवेश में सीक्रेट मैनेजर (जैसे, AWS, Vercel, Heroku, आदि) का उपयोग करें।