...
भुगतान के बाद, ग्राहकों को आपके `return_url` पर अतिरिक्त क्वेरी पैरामीटर के साथ पुनर्निर्देशित किया जाता है जो भुगतान स्थिति के लिए होते हैं।
</Step>
</Steps>
...
**उदाहरण**: `"US"` (संयुक्त राज्य), `"CA"` (कनाडा), `"GB"` (संयुक्त राज्य), `"DE"` (जर्मनी)
...
<Warning>
**महत्वपूर्ण**: हमेशा `credit` और `debit` को बैकअप विकल्पों के रूप में शामिल करें ताकि जब पसंदीदा भुगतान विधियाँ उपलब्ध न हों तो चेकआउट विफलताओं से बचा जा सके।
</Warning>
...
<Expandable title="कस्टमाइज़ेशन ऑब्जेक्ट प्रॉपर्टीज">
...
<Note>
जब `confirm` को `true` पर सेट किया जाता है, तो ग्राहक सीधे चेकआउट पृष्ठ पर ले जाए जाते हैं, किसी भी पुष्टि के चरणों को बायपास करते हुए।
</Note>
...
<Note>
`billing_currency` ओवरराइड केवल तब प्रभावी होता है जब आपके खाते की सेटिंग्स में अनुकूली मुद्रा सक्षम होती है। यदि अनुकूली मुद्रा अक्षम है, तो यह पैरामीटर कोई प्रभाव नहीं डालेगा।
</Note>
...
<Warning>
जब `payment_method_id` का उपयोग किया जाता है, तो `confirm` को `true` पर सेट किया जाना चाहिए और एक मौजूदा `customer_id` प्रदान किया जाना चाहिए। भुगतान विधि की वैधता को भुगतान की मुद्रा के साथ मान्य किया जाएगा।
</Warning>
...
<Note>
जब `redirect_immediately` सक्षम होता है, तो ग्राहकों को भुगतान पूरा होने के तुरंत बाद आपके `return_url` पर पुनर्निर्देशित किया जाता है, पूरी तरह से डिफ़ॉल्ट सफलता पृष्ठ को छोड़ते हुए।
</Note>
