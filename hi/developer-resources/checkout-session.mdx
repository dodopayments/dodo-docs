...
**सामान्य विकल्प**: `credit`, `debit`, `upi_collect`, `apple_pay`, `google_pay`, `amazon_pay`, `klarna`, `affirm`, `afterpay_clearpay`, `cashapp`, `ach`, `multibanco`, `bancontact_card`, `eps`, `ideal`, `blik`, `paypal`। यह पूरी सूची नहीं है — सभी स्वीकृत मानों के लिए [Create Checkout Session API reference](/api-reference/checkout-sessions/create) देखें।
...
<Note>
Preview किया गया `current_breakup.subtotal` पहले से ही product पर लागू होने वाले [Purchasing Power Parity](/features/purchasing-power-parity) और [Charm Pricing](/features/charm-pricing) को दर्शाता है।
</Note>
...
<Note>
Preview `trial_period_days` (प्रभावी trial अवधि, चाहे free हो या paid) और `trial_amount` (discounts के बाद प्रति unit trial charge, price currency की minor units में) भी लौटाता है। `trial_amount` केवल [paid trial](/features/subscription#paid-trials) के लिए मौजूद होता है और free trial या किसी trial के न होने पर `null` होता है। आज वास्तव में देय taxed total के लिए `current_breakup` का उपयोग करें।
</Note>
...
## Dynamic Links से Checkout Sessions पर जाना

### मुख्य अंतर
पहले, Dynamic Links का उपयोग करके payment link बनाते समय, आपको customer का पूरा billing address देना आवश्यक था।

Checkout Sessions के साथ अब यह आवश्यक नहीं है। आपके पास जो भी जानकारी हो, आप उसे भेज सकते हैं और बाकी काम हम संभाल लेंगे। उदाहरण के लिए:
