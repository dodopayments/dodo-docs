...
**फॉर्मेट**: देश कोड शामिल करें, जैसे `"+1234567890"` US नंबरों के लिए
</ParamField>
</Expandable>
</Tab>
</Tabs>
...
**उदाहरण**: `"US"` (संयुक्त राज्य), `"CA"` (कनाडा), `"GB"` (संयुक्त राज्य किंगडम), `"DE"` (जर्मनी)
...
**उदाहरण**: `"94102"` (US), `"M5V 3A8"` (कनाडा), `"SW1A 1AA"` (UK)
</ParamField>
</Expandable>
</ParamField>
...
**उदाहरण**: `"USD"` US डॉलर के लिए, `"EUR"` यूरो के लिए
...
चेकआउट इंटरफ़ेस में छूट कोड इनपुट फ़ील्ड दिखाएँ।
</ParamField>
...
मौजूदा ग्राहकों को अपडेट करने के बजाय एक नया ग्राहक रिकॉर्ड बनाने के लिए मजबूर करें।
</ParamField>
...
<Expandable title="सदस्यता डेटा वस्तु गुण">
<ParamField body="trial_period_days" type="integer">
पहली चार्ज से पहले परीक्षण अवधि के लिए दिनों की संख्या। 0 से 10000 दिनों के बीच होना चाहिए।
</ParamField>

<ParamField body="on_demand" type="object">
उपयोग-आधारित या मीटर किए गए बिलिंग के लिए ऑन-डिमांड सदस्यता कॉन्फ़िगरेशन।
...
ग्राहक को प्रारंभिक चार्ज के लिए उत्पाद की कीमत। यदि निर्दिष्ट नहीं किया गया है, तो उत्पाद की संग्रहीत कीमत का उपयोग किया जाएगा।
...
उत्पाद मूल्य की वैकल्पिक मुद्रा। यदि निर्दिष्ट नहीं किया गया है, तो उत्पाद की मुद्रा पर डिफ़ॉल्ट होता है।
</ParamField>
...
क्या अनुकूली मुद्रा शुल्क उत्पाद की कीमत में शामिल किए जाने चाहिए (सत्य) या ऊपर जोड़े जाने चाहिए (झूठा)। यदि अनुकूली मूल्य निर्धारण सक्षम नहीं है तो अनदेखा किया जाएगा।
</ParamField>
</Expandable>
</ParamField>
</Expandable>
...
### 11. तत्काल चेकआउट के लिए मौजूदा भुगतान विधियों का उपयोग करना
...
<Warning>
जब `payment_method_id` का उपयोग करते हैं, तो `confirm` को `true` पर सेट किया जाना चाहिए और एक मौजूदा `customer_id` प्रदान किया जाना चाहिए। भुगतान विधि की मुद्रा के साथ पात्रता के लिए मान्य किया जाएगा।
</Warning>

<Info>
भुगतान विधि ग्राहक की होनी चाहिए और भुगतान मुद्रा के साथ संगत होनी चाहिए। यह पुनः आने वाले ग्राहकों के लिए एक-क्लिक खरीदारी को सक्षम करता है।
</Info>

### 12. साफ़ भुगतान URLs के लिए शॉर्ट लिंक
...
<Tip>
शॉर्ट लिंक SMS, ईमेल, या सोशल मीडिया साझा करने के लिए आदर्श हैं। ये लंबे URLs की तुलना में याद रखने में आसान होते हैं और अधिक ग्राहक विश्वास बनाते हैं।
</Tip>

### 13. भुगतान सफलता पृष्ठ को छोड़ें और तुरंत पुनर्निर्देशित करें
...
<Note>
जब `redirect_immediately` सक्षम होता है, तो ग्राहकों को भुगतान पूर्ण होने के तुरंत बाद आपके `return_url` पर पुनर्निर्देशित किया जाता है, डिफ़ॉल्ट सफलता पृष्ठ को पूरी तरह से छोड़ते हुए।
</Note>

## चेकआउट सत्रों का पूर्वावलोकन

चेकआउट सत्र बनाने से पहले, आप कर, छूट, और कुल सहित मूल्य निर्धारण का पूर्वावलोकन कर सकते हैं। यह ग्राहकों को चेकआउट करने से पहले सटीक मूल्य निर्धारण प्रदर्शित करने के लिए उपयोगी है।
...
### प्रमुख अंतर
पहले, जब गतिशील लिंक के साथ भुगतान लिंक बनाते समय, आपको ग्राहक का पूरा बिलिंग पता प्रदान करना आवश्यक था।

चेकआउट सत्रों के साथ, यह अब आवश्यक नहीं है। आप बस जो भी जानकारी आपके पास है, उसे पास कर सकते हैं, और हम बाकी का ध्यान रखेंगे। उदाहरण के लिए:

- यदि आप केवल ग्राहक के बिलिंग देश को जानते हैं, तो बस वही प्रदान करें।
- चेकआउट प्रवाह स्वचालित रूप से ग्राहक को भुगतान पृष्ठ पर ले जाने से पहले गायब विवरण एकत्र करेगा।
