...
<Info>
ग्राहक प्रतिक्रिया कस्टम फ़ील्ड में शामिल हैं:
- **वेबहुक्स**: `payment.succeeded`, `subscription.active`, और अन्य संबंधित ईवेंट पेलोड में `custom_field_responses` एरे शामिल है
- **एपीआई प्रतिक्रियाएँ**: भुगतान और सब्सक्रिप्शन ऑब्जेक्ट में `custom_field_responses` शामिल है
</Info>
...
<Info>
कस्टम फ़ील्ड प्रतिक्रियाएँ स्वचालित रूप से वेबहुक पेलोड (`payment.succeeded`, `subscription.active`, आदि) में शामिल होती हैं और एपीआई के माध्यम से प्राप्त की जा सकती हैं। इन्हें अपने CRM को समृद्ध करने, ऑनबोर्डिंग फ्लो को ट्रिगर करने, या ग्राहक अनुभव को अनुकूलित करने के लिए उपयोग करें।
</Info>
