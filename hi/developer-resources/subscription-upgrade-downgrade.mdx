...
You can apply a discount code when changing subscription plans. This is useful for offering promotional pricing on upgrades or migrations.
...
| No code provided, existing discount with `preserve_on_plan_change=true` | Existing discount is automatically preserved if applicable to the new product. |
| No code provided, no preservable discount | No discount applied to the new plan. |

<Tip>
Use the [Preview Plan Change API](/api-reference/subscriptions/preview-change-plan) with a `discount_code` to show customers exactly how much they'll save before confirming the plan change.
</Tip>
...
| **Billing cycle** | Unchanged | Unchanged | Resets to today | Unchanged |
...
- <a href="/api-reference/subscriptions/change-plan">प्लान बदलें API</a> की समीक्षा करें
- <a href="/features/credit-based-billing">क्रेडिट-आधारित बिलिंग</a> का अन्वेषण करें
- `subscription.on_hold` के लिए अलर्ट लागू करें
- हमारे <a href="/developer-resources/webhooks">Webhook इंटीग्रेशन गाइड</a> को देखें
