...
<Info>
डाउंग्रेड्स के दौरान <code>difference_immediately</code> का उपयोग करके बनाए गए क्रेडिट सदस्यता-विशिष्ट होते हैं और <a href="/features/credit-based-billing">Credit-Based Billing</a> अधिकारों से अलग होते हैं। ये स्वतः ही उसी सदस्यता के भविष्य के नवीनीकरणों पर लागू हो जाते हैं और सदस्यताओं के बीच हस्तांतरित नहीं किए जा सकते।
</Info>
...
- <a href="/api-reference/subscriptions/change-plan">Change Plan API</a> की समीक्षा करें
- <a href="/features/credit-based-billing">Credit-Based Billing</a> का अन्वेषण करें
- `subscription.on_hold` के लिए अलर्ट लागू करें
- हमारे <a href="/developer-resources/webhooks">Webhook Integration Guide</a> को देखें
