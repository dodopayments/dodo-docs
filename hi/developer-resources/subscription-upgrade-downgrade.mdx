...
नई योजना के लिए इकाइयों की संख्या (सीट-आधारित उत्पादों के लिए)।
</ParamField>
...
<AccordionGroup>
<Accordion title="200 OK">
प्लान परिवर्तन अनुरोध सफलतापूर्वक संसाधित किया गया। सदस्यता अपडेट की जा रही है और भुगतान प्रक्रिया शुरू हो गई है।
</Accordion>
...
<Accordion title="401 Unauthorized">
अमान्य या गायब API कुंजी। सत्यापित करें कि आपका `DODO_PAYMENTS_API_KEY` सही है और उचित अनुमतियाँ हैं।
</Accordion>
...
<Accordion title="422 Unprocessable Entity">
सदस्यता को बदला नहीं जा सकता (उदाहरण के लिए, पहले से रद्द किया गया, उत्पाद उपलब्ध नहीं है, आदि)।
</Accordion>

<Accordion title="500 Internal Server Error">
सर्वर त्रुटि हुई। थोड़ी देरी के बाद अनुरोध को पुनः प्रयास करें।
</Accordion>
</AccordionGroup>
...
- <a href="/api-reference/subscriptions/change-plan">प्लान API बदलें</a> की समीक्षा करें
- <a href="/features/credit-based-billing">क्रेडिट-बेस्ड बिलिंग</a> का अनुसंधान करें
- `subscription.on_hold` के लिए अलर्ट लागू करें
