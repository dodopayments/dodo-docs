...
- `subscription.active`: Plan change successful, subscription अपडेट हो गई
- `subscription.plan_changed`: Subscription plan बदला गया (upgrade/downgrade/addon update)
- `subscription.on_hold`: Plan change charge विफल हुआ, renewals रोक दिए गए
- `payment.succeeded`: Plan change के लिए immediate charge सफल हुआ
- `payment.failed`: Immediate charge विफल हुआ
...
### संभाले जाने वाले event types
- `subscription.active`: subscription सक्रिय हुई
- `subscription.plan_changed`: subscription plan बदला गया (upgrade/downgrade/addon changes)
- `subscription.on_hold`: charge विफल हुआ, renewals रोक दिए गए
- `subscription.renewed`: renewal सफल हुआ
- `payment.succeeded`: Plan change या renewal का payment सफल हुआ
- `payment.failed`: payment विफल हुआ
