...
- आपका API key (`DODO_PAYMENTS_API_KEY`) और dashboard से webhook secret key। [API key generation guide](/api-reference/introduction#api-key-management-and-authentication) देखें।
- एक backend endpoint जो webhooks प्राप्त कर सके।
