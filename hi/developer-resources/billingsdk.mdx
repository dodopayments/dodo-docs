...
<Frame>
  <iframe 
        ...
        title="बिलिंग SDK | डोडो पेमेंट्स"
        frameBorder="0"
...
<Steps>
<Step title="CLI स्थापित करें">
  बिना स्थापना के CLI चलाने के लिए npx का उपयोग करें:
...
<Step title="एक परियोजना प्रारंभ करें">
...
1. रजिस्ट्री से घटक कॉन्फ़िगरेशन डाउनलोड करें
2. अपने `components/billingsdk/` निर्देशिका में घटक फ़ाइलें स्थापित करें
3. यदि आवश्यक हो तो अपनी परियोजना कॉन्फ़िगरेशन अपडेट करें
4. किसी भी अतिरिक्त निर्भरताओं को स्थापित करें

## उत्पन्न फ़ाइलों की संरचना

`init` चलाने के बाद, आपको निम्नलिखित के साथ एक संपूर्ण परियोजना संरचना मिलेगी:
...
<Warning>
हमेशा अपने API कुंजियों को सुरक्षित रूप से पर्यावरण चर का उपयोग करके स्टोर करें। कभी भी उन्हें संस्करण नियंत्रण में कमिट न करें।
</Warning>
...
<CardGroup cols={3}>
  <Card title="पूर्ण दस्तावेज़ीकरण" icon="book" href="https://billingsdk.com/docs">
    उदाहरणों और सर्वोत्तम प्रथाओं के साथ बिलिंग SDK के लिए पूर्ण गाइड
  </Card>
  <Card title="CLI संदर्भ" icon="terminal" href="https://billingsdk.com/docs/cli">
    सभी कमांड और विकल्पों के लिए विस्तृत CLI दस्तावेज़ीकरण
  </Card>
  <Card title="घटक पुस्तकालय" icon="boxes-stacked" href="https://billingsdk.com/docs/components">
    लाइव उदाहरणों के साथ सभी उपलब्ध घटकों को ब्राउज़ करें
  </Card>
</CardGroup>
