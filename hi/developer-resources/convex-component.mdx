...
<CardGroup cols={2}>
<Card title="चेकआउट फ़ंक्शन" icon="cart-shopping" href="#checkout-function">
    सत्र-आधारित प्रवाह के साथ Dodo Payments चेकआउट को एकीकृत करें।
</Card>
<Card title="ग्राहक पोर्टल" icon="user" href="#customer-portal-function">
    ग्राहकों को सदस्यता और विवरण प्रबंधित करने की अनुमति दें।
</Card>
<Card title="वेबहुक" icon="bell" href="#webhook-handler">
    Dodo Payments वेबहुक घटनाओं को प्राप्त और संसाधित करें।
</Card>
</CardGroup>
...
<Step title="Convex कॉन्फ़िग में घटक जोड़ें">
अपने Convex कॉन्फ़िगरेशन में Dodo Payments घटक जोड़ें:
...
इनलाइन कोड_स्थान धारक_4d5daf7f8f5d0aac_END को संपादित करने के बाद, आवश्यक प्रकार उत्पन्न करने के लिए एक बार इनलाइन कोड_स्थान धारक_df44b4239cc52213_END चलाएँ।
</Step>
<Step title="पर्यावरण चर सेट करें">
अपने Convex डैशबोर्ड में पर्यावरण चर सेट करें (**सेटिंग्स** → **पर्यावरण चर**)। आप इसे चलाकर डैशबोर्ड तक पहुँच सकते हैं:
...
- `DODO_PAYMENTS_API_KEY` - आपका Dodo Payments API कुंजी
- `DODO_PAYMENTS_ENVIRONMENT` - `test_mode` या `live_mode` पर सेट करें
- `DODO_PAYMENTS_WEBHOOK_SECRET` - आपकी वेबहुक सीक्रेट (वेबहुक हैंडलिंग के लिए आवश्यक)

<Warning>
संवेदनशील जानकारी के लिए हमेशा Convex पर्यावरण चर का उपयोग करें। कभी भी गुप्त जानकारी को संस्करण नियंत्रण में न डालें।
</Warning>
</Step>
</Steps>
...
<Steps>
<Step title="आंतरिक क्वेरी बनाएँ">
पहले, अपने डेटाबेस से ग्राहकों को लाने के लिए एक आंतरिक क्वेरी बनाएँ। इसका उपयोग भुगतान फ़ंक्शंस में ग्राहकों की पहचान के लिए किया जाएगा।

<Warning>
इस क्वेरी का उपयोग करने से पहले, कृपया सुनिश्चित करें कि आपने अपने `convex/schema.ts` फ़ाइल में उचित स्कीमा परिभाषित किया है या क्वेरी को आपके मौजूदा स्कीमा के अनुसार बदलें।
</Warning>
...
<Step title="DodoPayments घटक कॉन्फ़िगर करें">
 <CodeGroup>
...
<Tabs>
<Tab title="चेकआउट फ़ंक्शन सेटअप">
  <Info>
  इस फ़ंक्शन का उपयोग अपने Convex ऐप में Dodo Payments चेकआउट को एकीकृत करने के लिए करें। पूर्ण फ़ीचर समर्थन के साथ सत्र-आधारित चेकआउट का उपयोग करता है।
  </Info>
  <CodeGroup>
...
<Tab title="ग्राहक पोर्टल सेटअप">
  <Info>
  इस फ़ंक्शन का उपयोग ग्राहकों को Dodo Payments ग्राहक पोर्टल के माध्यम से अपनी सब्सक्रिप्शनों और विवरणों का प्रबंधन करने की अनुमति देने के लिए करें। ग्राहक को स्वचालित रूप से `identify` फ़ंक्शन के माध्यम से पहचाना जाता है।
  </Info>
  <CodeGroup>
...
<Tab title="वेबहुक हैंडलर सेटअप">
  <Info>
  इस हैंडलर का उपयोग अपने Convex ऐप में Dodo Payments वेबहुक घटनाओं को सुरक्षित रूप से प्राप्त और संसाधित करने के लिए करें। सभी वेबहुक हैंडलर्स पहले पैरामीटर के रूप में Convex `ActionCtx` प्राप्त करते हैं, जिससे आपको `ctx.runQuery()` और `ctx.runMutation()` का उपयोग करके अपने डेटाबेस के साथ इंटरैक्ट करने की अनुमति मिलती है।
  </Info>
  <CodeGroup>
  ...
  <Warning>
  सुनिश्चित करें कि आप प्रत्येक वेबहुक घटना के लिए अपने Convex बैकएंड में संबंधित डेटाबेस म्यूटेशन परिभाषित करें जिन्हें आप संभालना चाहते हैं। उदाहरण के लिए, सफल भुगतानों को रिकॉर्ड करने के लिए एक <code>createPayment</code> म्यूटेशन बनाएं या सदस्यता स्थिति को प्रबंधित करने के लिए एक <code>createSubscription</code> म्यूटेशन बनाएं।
  </Warning>
</Tab>
</Tabs>
...
<Info>
Dodo Payments Convex घटक सत्र-आधारित चेकआउट का उपयोग करता है, जो पूर्व-निर्धारित उत्पाद कार्ट और ग्राहक विवरण के साथ एक सुरक्षित, अनुकूलन योग्य चेकआउट अनुभव प्रदान करता है। यह सभी भुगतान प्रवाह के लिए अनुशंसित दृष्टिकोण है।
</Info>
...
<Info>
ग्राहक को आपके DodoPayments सेटअप में कॉन्फ़िगर किए गए `identify` फ़ंक्शन का उपयोग करके स्वचालित रूप से पहचाना जाता है। इस फ़ंक्शन को ग्राहक का `dodoCustomerId` लौटाना चाहिए।
</Info>
...
<Info>
अपने React घटकों से Convex हुक के साथ चेकआउट फ़ंक्शन का उपयोग करें।
</Info>
