...
संपादन के बाद `convex.config.ts` को, आवश्यक प्रकार उत्पन्न करने के लिए `npx convex dev` को एक बार चलाएँ।
</Step>
<Step title="पर्यावरण चर सेट करें">
अपने Convex डैशबोर्ड में पर्यावरण चर सेट करें (**Settings** → **Environment Variables**)। आप इसे चलाकर डैशबोर्ड तक पहुँच सकते हैं:
...
- `DODO_PAYMENTS_WEBHOOK_SECRET` - आपका वेबहुक गुप्त (वेबहुक हैंडलिंग के लिए आवश्यक)
...
<Warning>
इस क्वेरी का उपयोग करने से पहले, सुनिश्चित करें कि आपने अपने `convex/schema.ts` फ़ाइल में उपयुक्त स्कीमा को परिभाषित किया है या क्वेरी को अपने मौजूदा स्कीमा के अनुसार बदलें।
</Warning>
...
<Tab title="ग्राहक पोर्टल सेटअप">
  <Info>
  इस फ़ंक्शन का उपयोग ग्राहकों को Dodo Payments ग्राहक पोर्टल के माध्यम से उनकी सदस्यताओं और विवरणों का प्रबंधन करने की अनुमति देने के लिए करें। ग्राहक को स्वचालित रूप से `identify` फ़ंक्शन के माध्यम से पहचाना जाता है।
  </Info>
  <CodeGroup>
...
<Tab title="वेबहुक हैंडलर सेटअप">
  <Info>
  इस हैंडलर का उपयोग Dodo Payments वेबहुक घटनाओं को सुरक्षित रूप से अपने Convex ऐप में प्राप्त और संसाधित करने के लिए करें। सभी वेबहुक हैंडलर Convex `ActionCtx` को पहले पैरामीटर के रूप में प्राप्त करते हैं, जिससे आप अपने डेटाबेस के साथ बातचीत करने के लिए `ctx.runQuery()` और `ctx.runMutation()` का उपयोग कर सकते हैं।
  </Info>
  <CodeGroup>
