...
| Field | Description |
|-------|-------------|
| `subTotal` | किसी भी discount या tax को लागू करने से पहले session में सभी line items का योग। |
| `discount` | लागू किए गए सभी discounts का कुल value। |
| `tax` | calculated tax amount। `inline` mode में, address fields के साथ user के interaction करने पर यह dynamically update होता है। |
| `total` | session की base currency में `subTotal - discount + tax` का mathematical result। |
| `currency` | standard subtotal, discount और tax values का ISO currency code (जैसे, `"USD"`)। |
| `finalTotal` | customer से वास्तव में charge की जाने वाली राशि। इसमें additional foreign exchange adjustments या local payment method fees शामिल हो सकती हैं, जो basic price breakdown का हिस्सा नहीं होतीं। |
| `finalTotalCurrency` | वह currency जिसमें customer वास्तव में payment कर रहा है। यदि [purchasing power parity](/features/purchasing-power-parity) या local currency conversion active है, तो यह `currency` से अलग हो सकती है। |
