...
[Apple Pay डोमेन एसोसिएशन फाइल](https://checkout.dodopayments.com/.well-known/apple-developer-merchantid-domain-association) डाउनलोड करें।
</Step>

<Step title="Request activation">
अपना उत्पादन डोमेन URL के साथ **support@dodopayments.com** को ईमेल करें और Apple Pay सक्रियता का अनुरोध करें।
</Step>

<Step title="Test after confirmation">
पुष्टि होने पर, सुनिश्चित करें कि Apple Pay चेकआउट में दिखता है और पूरी प्रवाह का परीक्षण करें।
</Step>
</Steps>

<Warning>
Apple Pay को उत्पादन में दिखने से पहले डोमेन सत्यापन की आवश्यकता है। यदि आप Apple Pay की पेशकश करना चाहते हैं तो लाइव होने से पहले समर्थन से संपर्क करें।
</Warning>
...
| सुविधा | इनलाइन चेकआउट | ओवरले चेकआउट |
|---------|-----------------|------------------|
| एकीकरण की गहराई | पृष्ठ में पूर्ण रूप से अंतर्निहित | पृष्ठ के ऊपर पर मोडल |
| लेआउट नियंत्रण | पूरा नियंत्रण | सीमित |
| ब्रांडिंग | निर्बाध | पृष्ठ से अलग |
| कार्यान्वयन प्रयास | उच्चतर | निम्नतर |
| सर्वोत्तम के लिए | कस्टम चेकआउट पृष्ठ, उच्च-कन्वर्जन प्रवाह | त्वरित एकीकरण, मौजूदा पृष्ठ |

<Tip>
जब आप चेकआउट अनुभव पर अधिकतम नियंत्रण और निर्बाध ब्रांडिंग चाहते हैं, तो **इनलाइन चेकआउट** का उपयोग करें। न्यूनतम परिवर्तनों के साथ मौजूदा पृष्ठों के लिए त्वरित एकीकरण के लिए **ओवरले चेकआउट** का उपयोग करें।
</Tip>
...
<Card title="Checkout Sessions API" icon="code" href="/api-reference/checkout-sessions/create">
    अपने चेकआउट अनुभव संचालित करने के लिए चेकआउट सत्र बनाएं।
</Card>

<Card title="Webhooks" icon="webhook" href="/developer-resources/webhooks">
    वेबहुक्स के साथ सर्वर-साइड पर भुगतान इवेंट्स को प्रबंधित करें।
</Card>
...
अधिक मदद के लिए, हमारी [Discord समुदाय](https://discord.gg/bYqAp4ayYh) पर जाएँ या हमारे डेवलपर सपोर्ट टीम से संपर्क करें।
