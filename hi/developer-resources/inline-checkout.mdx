...
## Apple Pay सक्षम करना

Apple Pay ग्राहकों को उनके सहेजे गए भुगतान विधियों का उपयोग करके तेजी से और सुरक्षित रूप से भुगतान पूरा करने की अनुमति देता है। जब सक्षम किया जाता है, तो ग्राहक समर्थित उपकरणों पर चेकआउट ओवरले से सीधे Apple Pay मोडल लॉन्च कर सकते हैं।

<Info>
Apple Pay iOS 17+, iPadOS 17+, और macOS पर Safari 17+ पर समर्थित है।
</Info>

अपने डोमेन के लिए उत्पादन में Apple Pay सक्षम करने के लिए, इन चरणों का पालन करें:

<Steps>
<Step title="Apple Pay डोमेन एसोसिएशन फ़ाइल डाउनलोड और अपलोड करें">
...
फ़ाइल को अपने वेब सर्वर पर `/.well-known/apple-developer-merchantid-domain-association` पर अपलोड करें। उदाहरण के लिए, यदि आपकी वेबसाइट `example.com` है, तो फ़ाइल को `https://example.com/well-known/apple-developer-merchantid-domain-association` पर उपलब्ध कराएँ।

</Step>

<Step title="Apple Pay सक्रियण का अनुरोध करें">

ईमेल **support@dodopayments.com** निम्नलिखित जानकारी के साथ:

- आपका उत्पादन डोमेन URL (जैसे, `https://example.com`)
- अपने डोमेन के लिए Apple Pay सक्षम करने का अनुरोध

<Check>
आपको 1-2 कार्य दिवसों के भीतर पुष्टि प्राप्त होगी जब Apple Pay आपके डोमेन के लिए सक्षम हो जाएगा।
</Check>

</Step>

<Step title="Apple Pay उपलब्धता की पुष्टि करें">

पुष्टि प्राप्त करने के बाद, अपने चेकआउट में Apple Pay का परीक्षण करें:

1. समर्थित उपकरण (iOS 17+, iPadOS 17+, या macOS पर Safari 17+) पर अपने चेकआउट को खोलें
2. सत्यापित करें कि Apple Pay बटन एक भुगतान विकल्प के रूप में प्रकट होता है
...
<Warning>
Apple Pay को आपके डोमेन के लिए सक्षम किया जाना चाहिए इससे पहले कि यह उत्पादन में भुगतान विकल्प के रूप में प्रकट हो। यदि आप Apple Pay की पेशकश करने की योजना बना रहे हैं तो लाइव जाने से पहले समर्थन से संपर्क करें।
</Warning>
...
अधिक मदद के लिए, हमारे [Discord समुदाय](https://discord.gg/bYqAp4ayYh) पर जाएं या हमारी डेवलपर समर्थन टीम से संपर्क करें.
