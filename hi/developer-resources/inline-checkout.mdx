...
<Info>
डोमेन सत्यापन केवल **इनलाइन (एम्बेडेड) चेकआउट** के लिए आवश्यक है। ओवरले चेकआउट, होस्टेड चेकआउट और भुगतान लिंक को इसकी आवश्यकता नहीं होती है।
</Info>

Apple Pay प्रति डोमेन डैशबोर्ड से सत्यापित किया जाता है।

<Steps>
<Step title="Open Wallet domains">
**Settings → Payment Methods** पर जाएं और **Apple Pay** पंक्ति में **Manage domains** पर क्लिक करें।

<Frame caption="Open Wallet domains from the Apple Pay row">
  <img src="/images/apple-pay-domains/manage-domains.png" alt="Payment Methods सेटिंग्स में Apple Pay पंक्ति पर Manage domains बटन" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>

<Step title="Download the domain association file">
वॉलेट डोमेन पैनल से एसोसिएशन फ़ाइल डाउनलोड करें।

<Frame caption="Download the Apple Pay domain association file">
  <img src="/images/apple-pay-domains/wallet-domains-panel.png" alt="डॉउनलोड फ़ाइल बटन के साथ वॉलेट डोमेन पैनल" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>

<Step title="Register your domain">
**Register domain** पर क्लिक करें और वह डोमेन दर्ज करें जहां आप इनलाइन चेकआउट एम्बेड करते हैं (उदाहरण के लिए `shop.example.com`), फिर **Continue**।

<Frame caption="Register the domain where you embed inline checkout">
  <img src="/images/apple-pay-domains/register-domain.png" alt="डोमेन दर्ज किए गए डोमेन रूप को पंजीकृत करें" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
इसे HTTPS पर सर्व करना चाहिए, बिना रीडायरेक्ट के पहुंच योग्य होना चाहिए, और `Content-Type: application/octet-stream` या `text/plain` के साथ सर्व करना चाहिए।
</Step>
...
<Frame caption="Verify the hosted association file">
  <img src="/images/apple-pay-domains/verify-domain.png" alt="एसोसिएशन फ़ाइल होस्ट पथ और Verify domain बटन के साथ अपना डोमेन सत्यापित करें स्क्रीन" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>

<Step title="Confirm it's active">
जब स्थिति **Active** दिखाती है, तो उस डोमेन के लिए Apple Pay सक्षम होता है। प्रति डोमेन इसे चालू या बंद करने के लिए **Enabled** टॉगल का उपयोग करें।

<Frame caption="Verified domains show an Active status">
  <img src="/images/apple-pay-domains/domains-active.png" alt="वॉलेट डोमेन सूची, जिसमें सक्रिय Apple Pay स्थिति और सक्षम टॉगल के साथ डोमेन दिखाई देती हैं" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>

<Step title="Test the integration">
1. Apple डिवाइस पर चेकआउट खोलें
2. सुनिश्चित करें कि Apple Pay बटन दिखाई दे
3. एक परीक्षण लेन-देन पूरा करें
</Step>
</Steps>

## ब्राउज़र समर्थन

Dodo Payments Checkout SDK निम्नलिखित ब्राउज़र का समर्थन करता है:
...
|---------|-----------------|------------------|
| एकीकरण गहराई | पृष्ठ में पूरी तरह एम्बेडेड | पृष्ठ के शीर्ष पर मोडल |
| लेआउट नियंत्रण | पूरी तरह से नियंत्रण | सीमित |
| ब्रांडिंग | सीमलेस | पृष्ठ से अलग |
| कार्यान्वयन प्रयास | उच्च | निम्न |
| सर्वोत्तम | कस्टम चेकआउट पेज, उच्च-परिवर्तन प्रवाह | त्वरित एकीकरण, मौजूदा पृष्ठ |

<Tip>
जब आप चेकआउट अनुभव पर अधिकतम नियंत्रण और सीमलेस ब्रांडिंग चाहते हैं, तो **इनलाइन चेकआउट** का उपयोग करें। आपके मौजूदा पृष्ठों में न्यूनतम परिवर्तनों के साथ तेज़ एकीकरण के लिए **ओवरले चेकआउट** का उपयोग करें।
</Tip>
...
<Card title="Checkout Sessions API" icon="code" href="/api-reference/checkout-sessions/create">
    अपने चेकआउट अनुभवों को सशक्त बनाने के लिए चेकआउट सत्र बनाएं।
</Card>

<Card title="Webhooks" icon="webhook" href="/developer-resources/webhooks">
    वेबहुक के साथ सर्वर-साइड भुगतान इवेंट को संभालें।
</Card>
...
अधिक सहायता के लिए, हमारी [Discord community](https://discord.gg/bYqAp4ayYh) पर जाएं या हमारे डेवलपर सहायता दल से संपर्क करें।
