...
<Step title="Access Webhook Settings">
    डोडो पेमेंट्स डैशबोर्ड पर नेविगेट करें और `Developer > Webhooks` पर जाएँ।
</Step>
...
<Step title="Navigate to Webhook Details">
    अपने डोडो पेमेंट्स डैशबोर्ड पर जाएँ और `Developer > Webhooks` पर नेविगेट करें।
</Step>
...
इस webhook को ट्रिगर करने वाला ईवेंट प्रकार (जैसे `payment.succeeded`, `subscription.active`).
...
<CardGroup cols={2}>
{/* LOCKED_PATTERN_e00062f1a73be4cdce7478c87f820958 */}
  प्रोग्रामेटिक रूप से वेबहुक एंडपॉइंट्स बनाने और कॉन्फ़िगर करने के लिए API संदर्भ
</Card>
{/* LOCKED_PATTERN_ebcc49f16b467c5d38d8a9f461e25ccd */}
  आपके वेबहुक एंडपॉइंट्स को पुनः प्राप्त करने और प्रबंधित करने के लिए API संदर्भ
</Card>
</CardGroup>
