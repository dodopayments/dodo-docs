...
<Expandable title="Data object properties">
  ...
  संसाधन का प्रकार। इनमें से एक: `Payment`, `Subscription`, `Refund`, `Dispute`, `LicenseKey`, `CreditLedgerEntry`, `CreditBalanceLow`, `AbandonedCheckout`, `DunningAttempt`, या `EntitlementGrant`।
  </ResponseField>
  
  अतिरिक्त फ़ील्ड्स घटना प्रकार के अनुसार भिन्न होते हैं। पूर्ण स्कीमाओं के लिए घटना-विशिष्ट दस्तावेज़ देखें।
</Expandable>
</ResponseField>
...
यह इंटरैक्टिव टूल आपको सभी समर्थित घटना प्रकारों में से चुनने देता है और आपके एंडपॉइंट पर यथार्थवादी मॉक payloads भेजता है। यह दोहराता है ताकि आप एक सत्र में कई घटनाओं का परीक्षण कर सकें।
