...
<Steps>
  ...
  <Step title="Create Usage Meters">
    ...
    * **Output Tokens:** 1,000,000 tokens / \$10.00 = \$1 प्रति 100,000 tokens।
    ...
    Dodo डैशबोर्ड में, आप "Meter units per credit" को इनपुट के लिए 4,000 और आउटपुट के लिए 1,000 पर सेट करेंगे। Credits को सेंट में दर्शाया जाता है, इसलिए एक credit ऊपर दिए गए प्रति-डॉलर आंकड़ों के 1/100 भाग के लिए भुगतान करता है।
  </Step>
