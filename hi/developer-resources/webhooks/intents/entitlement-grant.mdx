...
|---|---|
| `subscription_cancelled` | ग्राहक की subscription रद्द कर दी गई (`subscription.cancelled` event)। |
| `subscription_on_hold` | विफल renewal के कारण subscription hold पर है (`subscription.on_hold`)। Recoverable: एक सफल retry से grant फिर से मिलता है। |
| `SubscriptionPaused` | subscription को pause कर दिया गया (`subscription.paused`)। Recoverable: resume करने से grant फिर से मिलता है। |
| `subscription_expired` | subscription अपनी अवधि के अंत तक पहुँच गई (`subscription.expired`)। |
| `plan_changed` | plan बदल गया; नए grants जारी करने से पहले पुराने grants revoke कर दिए जाते हैं (`subscription.plan_changed`)। |
| `refund` | मूल one-time payment के लिए refund संसाधित किया गया (`refund.succeeded`)। |
| `manual` | किसी merchant ने API या dashboard के माध्यम से grant revoke कर दिया। subscription renewal पर manual revokes के लिए grant अपने-आप फिर से नहीं मिलता। |
| `license_key_disabled` | license-key grant के पीछे की license key disable कर दी गई। key को फिर से enable करने पर grant अपने-आप re-activate हो जाता है। |
| `platform_external` | integration का platform पक्ष sync से बाहर हो गया (उदाहरण के लिए, Discord role को manually हटा दिया गया, GitHub App ने repository access खो दिया, या reconciliation pass ने कोई missing target पाया)। underlying platform issue का समाधान होने तक subscription renewal पर grant अपने-आप फिर से नहीं मिलता। |
