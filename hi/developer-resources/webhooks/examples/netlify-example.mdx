...
3. SQL संपादक खोलें
4. [`schema.sql`](#database-schema) के कंटेंट को कॉपी और पेस्ट करें
5. क्वेरी चलाएँ
...
> **नोट:** हम आपकी वेबहुक URL मिलने के बाद तैनाती के बाद `DODO_PAYMENTS_WEBHOOK_KEY` सेट करेंगे।
...
1. [DodoPayments Dashboard](https://app.dodopayments.com) पर जाएं → डेवलपर → वेबहुक्स
2. एक नया वेबहुक अंत बिंदु बनाएं
...
✅ **सिग्नेचर सत्यापन** - dodopayments पुस्तकालय का उपयोग करके  
...
> **नोट:** यह कार्यान्वयन तीन प्रमुख सदस्यता घटनाओं (`subscription.active`, `subscription.cancelled`, `subscription.renewed`) को न्यूनतम फील्ड के साथ संभालने का प्रदर्शन करता है। आप अपनी आवश्यकताओं के आधार पर अतिरिक्त इवेंट प्रकारों और फ़ील्ड का समर्थन करने के लिए इसे आसानी से बढ़ा सकते हैं।
...
वेबहुक हैंडलर:
1. **सिग्नेचर सत्यापित करता है** - यह सुनिश्चित करता है कि अनुरोध DodoPayments से HMAC-SHA256 का उपयोग करके है
2. **डुप्लिकेट के लिए जांच करता है** - वेबहुक आईडी का उपयोग करके एक ही इवेंट को दो बार प्रोसेस करने से रोकता है
3. **इवेंट लॉग करता है** - ऑडिट ट्रेल के लिए `webhook_events` तालिका में कच्चा वेबहुक स्टोर करता है
4. **इवेंट को प्रोसेस करता है** - Neon में ग्राहकों और सदस्यताओं को बनाता या अपडेट करता है
5. **त्रुटियों को संभालता है** - विफलताओं को लॉग करता है और ईवेंट को पुनः प्रयास के लिए अप्रक्रमित चिह्नित करता है
...
**नेटलिफाई डैशबोर्ड में लॉग देखें:**
1. अपने साइट का चयन करें → **फंक्शंस** टैब
2. `webhook` फ़ंक्शन पर क्लिक करें
3. वास्तविक समय के लॉग और आवाहन इतिहास देखें
...
| मुद्दा | समाधान |
|-------|----------|
| सत्यापन विफल | DodoPayments डैशबोर्ड से वेबहुक कुंजी की जांच करें |
| डेटाबेस कनेक्शन त्रुटि | Neon कनेक्शन स्ट्रिंग की पुष्टि करें और पूल कनेक्शन का उपयोग करें |
| फ़ंक्शन नहीं मिला (404) | `netlify init` और `npm run deploy` फिर से चलाएं |
| एन्व वेरिएबल उपलब्ध नहीं हैं | CLI या डैशबोर्ड में वेरिएबल सेट करें, फिर पुन: तैनात करें |
