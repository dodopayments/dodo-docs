...
वेबहुक हैंडलर:
1. **हस्ताक्षर की पुष्टि करता है** - सुनिश्चित करता है कि अनुरोध DodoPayments से HMAC-SHA256 का उपयोग करके है
2. **डुप्लिकेट की जांच करता है** - एक ही इवेंट को दो बार प्रोसेस करने से रोकने के लिए वेबहुक आईडी का उपयोग करता है
3. **इवेंट को लॉग करता है** - ऑडिट ट्रेल के लिए `webhook_events` तालिका में कच्चा वेबहुक संग्रहीत करता है
4. **इवेंट को प्रोसेस करता है** - Neon में ग्राहकों और सब्सक्रिप्शन को बनाता या अपडेट करता है
5. **त्रुटियों को संभालता है** - विफलताओं को लॉग करता है और पुनः प्रयास के लिए इवेंट को अप्रसंस्कृत के रूप में चिह्नित करता है
...
1. अपनी साइट का चयन करें → **फंक्शंस** टैब
2. `webhook` फ़ंक्शन पर क्लिक करें
3. वास्तविक समय के लॉग और आवाहन इतिहास को देखें
...
| Env vars उपलब्ध नहीं हैं | CLI या डैशबोर्ड में वेरिएबल सेट करें, फिर पुनः तैनात करें |
