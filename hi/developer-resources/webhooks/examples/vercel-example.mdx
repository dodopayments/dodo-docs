...
1. [Neon](https://neon.com) पर साइन अप करें
2. एक नया प्रोजेक्ट बनाएं
3. SQL एडिटर खोलें
4. [`schema.sql`](#database-schema) की सामग्री को कॉपी करें और चिपकाएँ
5. क्वेरी चलाएँ
...
> **Note:** हम `DODO_PAYMENTS_WEBHOOK_KEY` को तैनाती के बाद तब सेट करेंगे जब आपके पास आपका वेबहुक URL होगा।
...
✅ **Signature verification** - dodopayments लाइब्रेरी का उपयोग
✅ **Idempotency** - वेबहुक IDs के साथ डुप्लिकेट प्रोसेसिंग को रोकता है
✅ **Event logging** - `webhook_events` तालिका में पूर्ण ऑडिट ट्रेल
✅ **Error handling** - लॉग किया जाता है और पुनः प्रयास योग्य होता है

> **Note:** यह इम्प्लीमेंटेशन तीन मुख्य सब्सक्रिप्शन इवेंट्स (`subscription.active`, `subscription.cancelled`, `subscription.renewed`) को न्यूनतम फ़ील्ड्स के साथ संभालने का प्रदर्शन करता है। आप अपनी आवश्यकताओं के अनुसार अतिरिक्त इवेंट प्रकारों और फ़ील्ड्स का समर्थन करने के लिए इसे आसानी से बढ़ा सकते हैं।
...
वेबहुक हैंडलर:
1. **Disables body parsing** - सिग्नेचर सत्यापन के लिए कच्ची बॉडी तक पहुंचने हेतु
2. **Verifies the signature** - HMAC-SHA256 का उपयोग करके सुनिश्चित करता है कि अनुरोध DodoPayments से है
3. **Checks for duplicates** - एक ही इवेंट को दो बार प्रोसेस करने से रोकने के लिए वेबहुक ID का उपयोग करता है
4. **Logs the event** - ऑडिट ट्रेल के लिए कच्चे वेबहुक को `webhook_events` तालिका में संग्रहीत करता है
5. **Processes the event** - Neon में ग्राहकों और सब्सक्रिप्शनों को बनाता या अपडेट करता है
6. **Handles errors** - विफलताओं को लॉग करता है और पुनः प्रयास के लिए इवेंट को अप्रोसेस्ड के रूप में चिह्नित करता है
