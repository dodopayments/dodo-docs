...
> **नोट:** हम आपकी वेबहुक URL प्राप्त करने के बाद परिनियोजन के बाद `DODO_PAYMENTS_WEBHOOK_KEY` सेट करेंगे।
...
3. अपनी वेबहुक URL को एंडपॉइंट के रूप में कॉन्फ़िगर करें
4. इन सदस्यता घटनाओं को सक्षम करें:
   - `subscription.active`
   - `subscription.cancelled`
   - `subscription.renewed`
5. **साइनिंग सीक्रेट** की कॉपी करें
...
✅ **Signature verification** - dodopayments पुस्तकालय का उपयोग करके  
✅ **Idempotency** - वेबहुक IDs के साथ डुप्लीकेट प्रोसेसिंग को रोकता है  
✅ **Event logging** - `webhook_events` तालिका में पूर्ण ऑडिट ट्रेल  
✅ **Error handling** - लॉग किया गया और पुनः प्रयास करने योग्य

> **नोट:** यह कार्यान्वयन तीन मुख्य सदस्यता घटनाओं (`subscription.active`, `subscription.cancelled`, `subscription.renewed`) को न्यूनतम क्षेत्रों के साथ संभालने का प्रदर्शन करता है। आप अपने आवश्यकताओं के आधार पर अतिरिक्त घटना प्रकारों और क्षेत्रों को समर्थन देने के लिए इसे आसानी से विस्तारित कर सकते हैं।
...
वेबहुक हैंडलर:
1. **बॉडी पार्सिंग को अक्षम करता है** - सिग्नेचर सत्यापन के लिए कच्चे बॉडी तक पहुंचने के लिए
2. **सिग्नेचर को सत्यापित करता है** - HMAC-SHA256 का उपयोग करके सुनिश्चित करता है कि अनुरोध DodoPayments से है
3. **डुप्लिकेट की जांच करता है** - एक ही घटना को दो बार प्रोसेसिंग से रोकने के लिए वेबहुक ID का उपयोग करता है
4. **घटना लॉग करता है** - ऑडिट ट्रेल के लिए `webhook_events` तालिका में कच्चे वेबहुक को स्टोर करता है
5. **घटना को प्रोसेस करता है** - Neon में ग्राहकों और सदस्यताओं को बनाता या अपडेट करता है
6. **त्रुटियों को संभालता है** - असफलताओं को लॉग करता है और पुनः प्रयास के लिए घटना को अप्रयुक्त के रूप में चिह्नित करता है
