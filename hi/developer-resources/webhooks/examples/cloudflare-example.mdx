...
`wrangler.toml` को संपादित करें और अपना कार्यकर्ता नाम सेट करें:
...
> **नोट:** यह कार्यान्वयन तीन मुख्य सदस्यता घटनाओं (`subscription.active`, `subscription.cancelled`, `subscription.renewed`) को न्यूनतम फ़ील्ड के साथ संभालने का प्रदर्शन करता है। आप इसे अपनी आवश्यकताओं के आधार पर अतिरिक्त इवेंट प्रकारों और फ़ील्ड का समर्थन करने के लिए आसानी से बढ़ा सकते हैं।
...
4. **इवेंट को प्रोसेस करता है** - ग्राहकों और सदस्यताओं को बनाता या अपडेट करता है
...
| डेटाबेस कनेक्शन त्रुटि | Neon कनेक्शन स्ट्रिंग की पुष्टि करें |
| कार्यकर्ता तैनात नहीं हो रहा है | `npm install` चलाएं, `wrangler.toml` सिंटैक्स की जांच करें |
