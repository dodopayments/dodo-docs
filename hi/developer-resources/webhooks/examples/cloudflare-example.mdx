...
5. क्वेरी चलाएं
6. अपने कनेक्शन स्ट्रिंग को Neon से प्राप्त करें → कनेक्शन विवरण
...
> **नोट:** हम आप की वेबहुक URL मिलने के बाद तैनाती के बाद `DODO_PAYMENTS_WEBHOOK_KEY` सेट करेंगे।

### 5. wrangler.toml को अपडेट करें

`wrangler.toml` को संपादित करें और अपने कार्यकर्ता का नाम सेट करें:
...
> **नोट:** यह कार्यान्वयन तीन मुख्य सदस्यता घटनाओं (`subscription.active`, `subscription.cancelled`, `subscription.renewed`) को न्यूनतम फील्ड के साथ संभालने का प्रदर्शन करता है। आप अपनी आवश्यकताओं के आधार पर अतिरिक्त घटना प्रकारों और फील्ड का समर्थन करने के लिए इसे आसानी से बढ़ा सकते हैं।
...
वेबहुक हैंडलर:
1. **Signature को सत्यापित करता है** - HMAC-SHA256 का उपयोग करके यह सुनिश्चित करता है कि अनुरोध DodoPayments से है
2. **डुप्लिकेट की जांच करता है** - एक ही घटना को दो बार प्रोसेसिंग से रोकने के लिए वेबहुक ID का उपयोग करता है
3. **घटना को लॉग करता है** - ऑडिट ट्रेल के लिए `webhook_events` तालिका में कच्चा वेबहुक स्टोर करता है
4. **घटना को प्रोसेस करता है** - ग्राहकों और सदस्यताओं को बनाता या अपडेट करता है
5. **त्रुटियों को संभालता है** - विफलताओं को लॉग करता है और पुनः प्रयास के लिए घटना को अप्रक्रमित के रूप में चिह्नित करता है
...
| डेटाबेस संबंध त्रुटि | Neon कनेक्शन स्ट्रिंग की पुष्टि करें |
| कार्यकर्ता तैनात नहीं हो रहा | `npm install` चलाएं, `wrangler.toml` की सिंटैक्स जांचें |
