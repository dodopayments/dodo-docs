...
<Info>
यह अनुभाग Checkout SDK का उपयोग करके **क्लाइंट-साइड** थीम कॉन्फ़िगरेशन को कवर करता है। आप एपीआई के माध्यम से एक चेकआउट सेशन बनाते समय `theme_config` पैरामीटर का उपयोग कर **सर्वर-साइड** पर भी थीम कॉन्फ़िगर कर सकते हैं। API-स्तरीय कॉन्फ़िगरेशन के लिए [Checkout Theme Customization](/features/checkout#checkout-theme-customization) देखें।
</Info>
