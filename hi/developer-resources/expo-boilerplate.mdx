...
एकमुश्त भुगतानों को लागू करने के लिए विस्तृत मार्गदर्शिका
</Card>

<Card title="API Reference" icon="brackets-curly" href="/api-reference/introduction">
Dodo Payments API का पूरा documentation देखें
</Card>
</CardGroup>

## सहायता

boilerplate के लिए सहायता चाहिए?

- प्रश्नों और चर्चाओं के लिए हमारी [Discord community](https://discord.gg/bYqAp4ayYh) से जुड़ें
- समस्याओं और अपडेट के लिए [GitHub repository](https://github.com/dodopayments/expo-boilerplate) देखें
