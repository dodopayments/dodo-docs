...
<Warning>
अपने `.env` फ़ाइल को संस्करण नियंत्रण में कभी भी कमिट न करें। यह पहले से `.gitignore` में शामिल है।
</Warning>
</Step>
...
अपने डिवाइस पर Expo Go ऐप के साथ QR कोड स्कैन करें, या iOS सिम्युलेटर के लिए `i` या Android अनुकरणकर्ता के लिए `a` दबाएं।
