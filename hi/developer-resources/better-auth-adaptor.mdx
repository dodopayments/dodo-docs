...
<AccordionGroup>
  <Accordion title="Plugin Options">
    - <b>client</b> (आवश्यक): DodoPayments क्लाइंट इंस्टेंस
    - <b>createCustomerOnSignUp</b> (वैकल्पिक): उपयोगकर्ता साइनअप पर ग्राहकों को स्वचालित रूप से बनाएं
    - <b>use</b> (आवश्यक): सक्षम करने के लिए प्लगइन्स का ऐरे (checkout, portal, usage, webhooks)
    - <b>getCustomerParams</b> (वैकल्पिक): एक फ़ंक्शन जो BetterAuth `User` को प्राप्त करता है और DodoPayments ग्राहक के निर्माण और अपडेट के साथ संलग्न करने के लिए अतिरिक्त फ़ील्ड्स को लौटाता है (जैसे `metadata`, `phone_number`)
  ...
  <Accordion title="Checkout Plugin Options">
    - <b>products</b>: उत्पादों का ऐरे या उत्पाद लौटाने वाला async फ़ंक्शन -{" "}
    <b>successUrl</b>: सफल भुगतान के बाद रीडायरेक्ट करने के लिए URL -{" "}
    <b>authenticatedUsersOnly</b>: उपयोगकर्ता प्रमाणीकरण की आवश्यकता (डिफ़ॉल्ट: false)
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion title="Common Issues">
    - <b>अमान्य API कुंजी</b>: अपने <code>DODO_PAYMENTS_API_KEY</code> को <code>.env</code> में ठीक से जांचें। -{" "}
    <b>Webhook हस्ताक्षर असमानता</b>: सुनिश्चित करें कि webhook गुप्त Dodo Payments डैशबोर्ड में सेट किए गए गुप्त से मेल खाता है। - <b>ग्राहक नहीं बना</b>: पुष्टि करें{" "}
    <code>createCustomerOnSignUp</code> को <code>true</code> पर सेट किया गया है।
  </Accordion>
  <Accordion title="Best Practices">
    - सभी गुप्त और कुंजियों के लिए वातावरण वेरिएबल्स का उपयोग करें। - <code>test_mode</code> में परीक्षण करें पहले <code>live_mode</code> पर स्विच करें। - डिबगिंग और ऑडिटिंग के लिए webhook इवेंट्स को लॉग करें।
  </Accordion>
</AccordionGroup>

# LLMs के लिए प्रोम्प्ट
