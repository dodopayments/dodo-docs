...
{/* LOCKED_PATTERN_848a353666469e7a047ef05af5a45770 */}
    अपने Astro ऐप में Dodo Payments चेकआउट को एकीकृत करें।
</Card>
{/* LOCKED_PATTERN_df89dec21e12f4bf30b6acf75ba025e1 */}
    ग्राहकों को अपनी सदस्यताओं और विवरणों को प्रबंधित करने की अनुमति दें।
</Card>
...
<Warning>
अपनी <code>.env</code> फ़ाइल या गुप्त जानकारी को संस्करण नियंत्रण में कभी कमिट न करें।
</Warning>
</Step>
</Steps>
...
<Info>
सभी उदाहरण यह मानते हैं कि आप Astro App Router का उपयोग कर रहे हैं।
</Info>

<Tabs>
{/* LOCKED_PATTERN_28fd81a4703a84d931eeff69f1520d54 */}
  <Info>
  इस हैंडलर का उपयोग अपने Astro ऐप में Dodo Payments चेकआउट को एकीकृत करने के लिए करें। यह स्थैतिक (GET), गतिशील (POST) और सत्र (POST) भुगतान प्रवाह का समर्थन करता है।
  </Info>
  <CodeGroup>
...
<Tab title="Customer Portal Handler">
  <Info>
  ग्राहकों को Dodo Payments ग्राहक पोर्टल के माध्यम से अपनी सदस्यताएँ और विवरण प्रबंधित करने की अनुमति देने के लिए इस हैंडलर का उपयोग करें।
  </Info>
  <CodeGroup>
...
{/* LOCKED_PATTERN_0026b036379d81a9d03c36b3b6e83ddd */}
  <Info>
  अपने Astro ऐप में Dodo Payments वेबहुक इवेंट्स को सुरक्षित रूप से प्राप्त करने और संसाधित करने के लिए इस हैंडलर का उपयोग करें।
  </Info>
  <CodeGroup>
...
<Info>
Dodo Payments आपके वेबसाइट में भुगतान एकीकृत करने के लिए तीन प्रकार के भुगतान प्रवाह का समर्थन करता है; यह एडेप्टर सभी प्रकार के भुगतान प्रवाहों का समर्थन करता है।
</Info>
...
कोई भी क्वेरी पैरामीटर जो <code>metadata_</code> से शुरू होता है, मेटाडेटा के रूप में पास किया जाएगा।
</ParamField>
...
- समर्थित POST बॉडी फ़ील्ड की पूरी सूची के लिए, देखें:
  - [एक बार भुगतान उत्पाद के लिए अनुरोध बॉडी](https://docs.dodopayments.com/api-reference/payments/post-payments)
...
चेकआउट सत्र एक अधिक सुरक्षित, होस्टेड चेकआउट अनुभव प्रदान करते हैं जो एक बार की खरीद और सब्सक्रिप्शन दोनों के लिए पूर्ण भुगतान प्रवाह को संभालते हैं और पूर्ण अनुकूलन नियंत्रण प्रदान करते हैं।
...
<ParamField query="send_email" type="boolean">
यदि <code>true</code> सेट है, तो ग्राहक को पोर्टल लिंक के साथ ईमेल भेजता है।
</ParamField>
