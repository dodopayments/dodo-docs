...
[Dodo Agent Plugin](/developer-resources/build-with-ai-coding-agents) Claude Code, Codex CLI, Cursor और OpenCode के लिए MCP servers और सभी सत्रह skills को एक ही चरण में इंस्टॉल करता है। प्रत्येक agent के इंस्टॉल commands के लिए [AI Coding Agents गाइड](/developer-resources/build-with-ai-coding-agents) देखें।
