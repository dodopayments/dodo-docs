...
<Info>
I crediti creati dai downgrade usando <code>difference_immediately</code> sono limitati alla singola sottoscrizione e distinti dai diritti di <a href="/features/credit-based-billing">Credit-Based Billing</a>. Si applicano automaticamente ai rinnovi futuri della stessa sottoscrizione e non sono trasferibili tra sottoscrizioni.
</Info>
...
- Rivedi l’<a href="/api-reference/subscriptions/change-plan">Change Plan API</a>
- Esplora <a href="/features/credit-based-billing">Credit-Based Billing</a>
- Implementa avvisi per `subscription.on_hold`
- Dai un’occhiata alla nostra <a href="/developer-resources/webhooks">Webhook Integration Guide</a>
