...
<Tip>
Utilizza sempre l'ultima versione dell'SDK per accedere alle nuove funzionalità di Dodo Payments. Esegui `bundle update dodopayments` regolarmente per rimanere aggiornato.
</Tip>
...
<CardGroup cols={2}>
<Card title="Convenzioni Ruby" icon="gem">
  Segue le convenzioni di denominazione e i modelli idiomatici di Ruby
</Card>

<Card title="Sintassi Elegante" icon="code">
...
<CardGroup cols={2}>
<Card title="Repository GitHub" icon="github" href="https://github.com/dodopayments/dodopayments-ruby">
...
<Card title="Segnala Problemi" icon="bug" href="https://github.com/dodopayments/dodopayments-ruby/issues">
