...
<Tip>
Usa sempre l'ultima versione dell'SDK per accedere alle nuove funzionalità di Dodo Payments. Esegui `bundle update dodopayments` regolarmente per rimanere aggiornato.
</Tip>
