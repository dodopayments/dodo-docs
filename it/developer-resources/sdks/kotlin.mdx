...
<Info>
`billing` richiede almeno un codice `country` ISO di due lettere. Usa `AttachExistingCustomer` per associare un cliente esistente oppure `NewCustomer` per crearne uno. `productPrice` è espresso nella denominazione più bassa della valuta.
</Info>
...
Monitora l'utilizzo per i contatori:
...
Usa il client asincrono per le operazioni basate su coroutine:
...
Usa con le applicazioni Android:
...
Integra con le applicazioni server Ktor:
...
<Card title="Discord Community" icon="discord" href="https://discord.gg/bYqAp4ayYh">
  Ottieni assistenza e mettiti in contatto con gli sviluppatori
</Card>
...
Hai bisogno di aiuto con l'SDK Kotlin?
...
- **GitHub**: Apri una segnalazione nel [repository](https://github.com/dodopayments/dodopayments-kotlin)

## Contributi

Accogliamo con piacere i contributi! Consulta le [linee guida per i contributi](https://github.com/dodopayments/dodopayments-kotlin/blob/main/CONTRIBUTING.md) per iniziare.
