...
<Tip>
Usa sempre l'ultima versione del SDK per accedere alle nuove funzionalità di Dodo Payments. Controlla [Maven Central](https://central.sonatype.com/artifact/com.dodopayments.api/dodo-payments-kotlin) per la versione più recente.
</Tip>

<Info>
L'SDK richiede Java 8 o versioni successive ed è compatibile con le piattaforme JVM e Android.
</Info>
...
<Tip>
Usa il `runCatching` di Kotlin per un approccio più funzionale alla gestione degli errori con i tipi Result.
</Tip>
...
<CardGroup cols={2}>
<Card title="Repository GitHub" icon="github" href="https://github.com/dodopayments/dodopayments-kotlin">
...
<Card title="Segnala Problemi" icon="bug" href="https://github.com/dodopayments/dodopayments-kotlin/issues">
