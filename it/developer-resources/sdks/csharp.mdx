...
<Info>
L’SDK C# è attualmente in versione beta. Stiamo lavorando attivamente per migliorarlo e apprezziamo il tuo feedback.
</Info>
...
<Warning>
Conserva sempre le chiavi API in modo sicuro usando variabili d’ambiente, segreti utente o Azure Key Vault. Non inserire mai direttamente le chiavi nel codice sorgente né committarle nel controllo di versione.
</Warning>
...
<Card title="Async/Await" icon="bolt">
  API completa basata su Task asincroni per operazioni non bloccanti
</Card>

{/* LOCKED_PATTERN_b690ec4e9cf6169c266a79afb70867b2 */}
  Sicurezza dei tipi completa con i nullable reference types
</Card>

<Card title="Dependency Injection" icon="layer-group">
  Supporto di primo livello per dependency injection .NET
</Card>
...
{/* LOCKED_PATTERN_840c768c319c580bdbf50678a652009b */}
  Ricevi assistenza e entra in contatto con gli sviluppatori
</Card>
