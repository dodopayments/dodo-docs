...
<Tip>
La fatturazione tramite `subscriptions().charge(...)` è destinata a [abbonamenti su richiesta](/developer-resources/ondemand-subscriptions). Gli abbonamenti programmati standard vengono addebitati automaticamente in base al programma di prezzi del prodotto.
</Tip>
...
<Card title="Discord Community" icon="discord" href="https://discord.gg/bYqAp4ayYh">
  Ottieni supporto e connettiti con sviluppatori
</Card>
...
- **GitHub**: Apri un problema sul [repository](https://github.com/dodopayments/dodopayments-java)

## Contributi

Accogliamo con favore i contributi! Consulta le [linee guida per i contributi](https://github.com/dodopayments/dodopayments-java/blob/main/CONTRIBUTING.md) per iniziare.
