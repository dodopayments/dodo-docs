...
<Tip>
Usa sempre l'ultima versione dell'SDK per accedere alle nuove funzionalità di Dodo Payments. Controlla [Maven Central](https://central.sonatype.com/artifact/com.dodopayments.api/dodo-payments-java) per l'ultima versione.
</Tip>

<Info>
L'SDK supporta Java 8 e tutte le versioni successive, inclusi Java 11, 17 e 21.
</Info>
...
<Warning>
Conserva sempre le tue chiavi API in modo sicuro utilizzando variabili d'ambiente, proprietà di sistema o un sistema di gestione della configurazione sicuro. Non codificarle mai nel tuo codice sorgente.
</Warning>

## Caratteristiche Principali

<CardGroup cols={2}>
<Card title="Sicurezza dei Tipi" icon="shield-check">
...
<Card title="Pattern Builder" icon="layer-group">
  Pattern builder intuitivo per costruire richieste
</Card>

<Card title="Supporto Async" icon="arrows-rotate">
...
<Tip>
L'SDK ripete automaticamente le richieste in caso di errori di connessione, 408, 409, 429 e errori 5xx con backoff esponenziale.
</Tip>
...
<CardGroup cols={2}>
<Card title="Repository GitHub" icon="github" href="https://github.com/dodopayments/dodopayments-java">
...
<Card title="Segnala Problemi" icon="bug" href="https://github.com/dodopayments/dodopayments-java/issues">
