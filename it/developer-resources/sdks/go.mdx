...
<Warning>
Conserva sempre le tue chiavi API in modo sicuro utilizzando variabili di ambiente. Non codificarle mai nel tuo codice sorgente.
</Warning>

## Caratteristiche Principali

<CardGroup cols={2}>
<Card title="Supporto al Contesto" icon="clock">
  Supporto completo per context.Context per cancellazione e timeout
</Card>
...
<Card title="Middleware" icon="layer-group">
  Supporto middleware estensibile per logging, metriche e logica personalizzata
</Card>

<Card title="Sicuro per Goroutine" icon="bolt">
...
<CardGroup cols={2}>
<Card title="Repository GitHub" icon="github" href="https://github.com/dodopayments/dodopayments-go">
...
<Card title="Segnala Problemi" icon="bug" href="https://github.com/dodopayments/dodopayments-go/issues">
