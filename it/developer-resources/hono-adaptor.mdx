---
title: Hono Adaptor
description: Learn how to integrate Dodo Payments with your Hono App Router
...
Utilizza questi all'interno del tuo codice come:

process.env.DODO_PAYMENTS_API_KEY
process.env.DODO_PAYMENTS_WEBHOOK_KEY

Nota sulla Sicurezza: NON inviare segreti al controllo versione. Usa file .env localmente e gestori di segreti negli ambienti di distribuzione (ad es., AWS, Vercel, Heroku, ecc.).