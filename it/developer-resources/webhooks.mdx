...
<Step title="Access Webhook Settings">
    Naviga alla Dashboard di DodoPayments e vai a `Developer > Webhooks`.
</Step>
...
<Step title="Navigate to Webhook Details">
    Vai alla tua Dashboard di Dodo Payments e naviga a `Developer > Webhooks`.
</Step>
...
## Riferimento API Relativo

<CardGroup cols={2}>
{/* LOCKED_PATTERN_e00062f1a73be4cdce7478c87f820958 */}
  Riferimento API per creare e configurare programmaticamente gli endpoint webhook
</Card>
