...
<Expandable title="Data object properties">
  ...
  Tipo di risorsa. Una tra: `Payment`, `Subscription`, `Refund`, `Dispute`, `LicenseKey`, `CreditLedgerEntry`, `CreditBalanceLow`, `AbandonedCheckout`, `DunningAttempt`, o `EntitlementGrant`.
  </ResponseField>
...
Questo strumento interattivo ti consente di selezionare tutti i tipi di evento supportati e invia payload mock realistici al tuo endpoint. Si ripete affinché tu possa testare più eventi in una sola sessione.
...
<Frame>
    <img src="/images/webhooks/logs.png" alt="Log" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
    <img src="/images/webhooks/activity.png" alt="Attività" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/images/webhooks/alerting.png" alt="Impostazioni di avviso Webhook che mostrano la configurazione delle notifiche email" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
