...
Disabilita il campo per il nome completo.
</ParamField>
<ParamField query="disableFirstName" type="boolean">
Disabilita il campo per il nome.
</ParamField>
<ParamField query="disableLastName" type="boolean">
Disabilita il campo per il cognome.
</ParamField>
...
Ogni parametro di query che inizia con <code>metadata_</code> verrà passato come metadata.
</ParamField>
...
Il Gestore della Route del Portale Clienti ti consente di integrare senza soluzione di continuità il portale clienti di Dodo Payments nella tua applicazione SvelteKit.
