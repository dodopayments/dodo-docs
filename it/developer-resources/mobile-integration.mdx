...
<Warning>
`@dodopayments/react-native-checkout` include anche un plugin di configurazione Expo, ma
attualmente non scrive alcuno schema URL né alcun placeholder del manifest. Aggiungerlo da solo
**non** registrerà lo schema di callback: usa la configurazione precedente. Consulta la pagina
