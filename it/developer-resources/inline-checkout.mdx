...
Scarica il [file di associazione dominio Apple Pay](http://checkout.dodopayments.com/.well-known/apple-developer-merchantid-domain-association).
</Step>
...
|---------|-----------------|------------------|
| Profondità d'integrazione | Completamente integrato nella pagina | Modale sopra la pagina |
| Controllo del layout | Controllo completo | Limitato |
| Branding | Integrazione fluida | Separato dalla pagina |
...
Per ulteriore aiuto, visita la nostra [comunità su Discord](https://discord.gg/bYqAp4ayYh) o contatta il nostro team di supporto per sviluppatori.
