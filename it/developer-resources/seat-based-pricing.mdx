...
<Warning>
Non committare mai la tua chiave API nel controllo versione. Aggiungi `.env` al tuo `.gitignore` file.
</Warning>
</Step>
...
<Step title="Aggiungi una semplice interfaccia web">
...
<Step title="Servire file statici">
...
1. Assicurati di avere il tuo `.env` file con la corretta chiave API
2. Aggiorna gli ID prodotto e add-on nel tuo codice con i valori reali dal tuo cruscotto Dodo Payments
...
1. Apri il tuo browser e vai su `http://localhost:3000`
2. Dovresti vedere l'interfaccia demo del prezzo basato sui posti
3. Prova diverse quantità di posti (0, 3, 10, ecc.)
4. Clicca su "Genera Link di Checkout" per ciascuna quantità
