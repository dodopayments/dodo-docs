...
5. **Gestisce gli errori** - Registra i fallimenti e contrassegna l'evento per il retry
...
<Nota>
Il flag `--no-verify-jwt` è necessario perché i webhook non includono i token JWT. La sicurezza è fornita dalla verifica della firma del webhook.
</Nota>
...
| Errore di permesso del database | Assicurati di utilizzare la Service Role Key |
