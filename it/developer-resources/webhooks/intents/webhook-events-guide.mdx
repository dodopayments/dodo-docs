...
|--------------------------|--------------------------|---------------------------------------------------------------------------------|
| **Abbonamento attivo**  | `subscription.active`    | Indica che un abbonamento è ora attivo e che sono programmati addebiti ricorrenti.|
| **Abbonamento aggiornato** | `subscription.updated`   | Attivato quando viene aggiornato un campo qualsiasi dell'abbonamento (sincronizzazione in tempo reale senza polling). |
| **Abbonamento sospeso** | `subscription.on_hold`   | Attivato quando un abbonamento viene sospeso temporaneamente a causa di un rinnovo non riuscito. |
...
| **Piano dell'abbonamento modificato** | `subscription.plan_changed` | Attivato quando un abbonamento viene aggiornato, declassato o modificato con componenti aggiuntivi diversi. |
...
| **Abbonamento non riuscito**  | `subscription.failed`    | Indica un abbonamento non riuscito. Significa che non siamo riusciti a creare un mandato. |
| **Abbonamento scaduto** | `subscription.expired`   | Attivato quando un abbonamento raggiunge la fine della sua durata e scade.          |
