...
Aggiorna l'URL del webhook nel tuo [dashboard Dodo](https://app.dodopayments.com/developer/webhooks) all'URL di ngrok. Assicurati di aggiornare il tuo file `.env` con la chiave di verifica del webhook corretta.
</Accordion>
