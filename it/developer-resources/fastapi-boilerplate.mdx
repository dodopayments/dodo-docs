...
Aggiorna l'URL del webhook nel tuo [dashboard Dodo](https://app.dodopayments.com/developer/webhooks) all'URL ngrok. Assicurati di aggiornare il tuo `.env` file con la chiave di verifica del webhook corretta.
</Accordion>

<Accordion title="La verifica della firma del webhook fallisce">
