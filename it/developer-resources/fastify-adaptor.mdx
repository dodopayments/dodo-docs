---
title: Adattatore Fastify
description: Scopri come integrare Dodo Payments con il tuo progetto Fastify App
  Router utilizzando il nostro Adattatore NextJS. Copre checkout, portale
