...
<Step title="Inizializza un Progetto">
...
<Step title="Aggiungi Componenti">
...
<CardGroup cols={3}>
  <Card title="Documentazione Completa" icon="book" href="https://billingsdk.com/docs">
    Guida completa a Billing SDK con esempi e migliori pratiche
  </Card>
  <Card title="Riferimento CLI" icon="terminal" href="https://billingsdk.com/docs/cli">
    Documentazione dettagliata del CLI per tutti i comandi e le opzioni
  </Card>
  <Card title="Libreria di Componenti" icon="boxes-stacked" href="https://billingsdk.com/docs/components">
    Sfoglia tutti i componenti disponibili con esempi dal vivo
  </Card>
</CardGroup>
