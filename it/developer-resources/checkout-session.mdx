...
<Expandable title="Proprietà dell'oggetto personalizzazione">
...
<Expandable title="Proprietà dell'oggetto flag funzionalità">
...
<Expandable title="Proprietà dell'oggetto dati abbonamento">
...
Sovrascrittura opzionale della descrizione del prodotto per la fatturazione e gli articoli di linea. Se non specificato, verrà utilizzata la descrizione memorizzata del prodotto.
</ParamField>

<ParamField body="adaptive_currency_fees_inclusive" type="boolean">
Se le spese per la valuta adattiva devono essere incluse nel prezzo del prodotto (vero) o aggiunte sopra (falso). Ignorato se la tariffazione adattiva non è abilitata.
</ParamField>
</Expandable>
</ParamField>
</Expandable>
...
### Differenze Chiave
In precedenza, quando creavi un link di pagamento con Link Dinamici, era necessario fornire l'indirizzo di fatturazione completo del cliente.

Con le Sessioni di Checkout, questo non è più necessario. Puoi semplicemente passare le informazioni che hai e noi ci occuperemo del resto. Ad esempio:
...
<Step title="È tutto!">
Sì. Non sono necessari ulteriori elaborazioni o passaggi di migrazione speciali da parte tua.
</Step>
</Steps>
