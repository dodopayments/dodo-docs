...
**Formato**: Includi il codice paese, ad es., `"+1234567890"` per numeri statunitensi
</ParamField>
</Expandable>
</Tab>
</Tabs>
...
**Esempio**: `"en"` per inglese, `"es"` per spagnolo
</ParamField>
</Expandable>
</ParamField>
...
<Note>
L'override di `billing_currency` ha effetto solo quando la valuta adattiva è abilitata nelle impostazioni del tuo account. Se la valuta adattiva è disabilitata, questo parametro non avrà effetto.
</Note>
