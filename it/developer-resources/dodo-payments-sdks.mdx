...
<Step title="Inizializza il Client">
...
<Step title="Fai la tua prima chiamata API">
...
<Info>
Siamo migrati dall'SDK Node.js al nuovo SDK TypeScript. Se stai utilizzando l'SDK Node.js legacy, consulta la [guida alla migrazione](https://github.com/dodopayments/dodopayments-typescript/blob/main/MIGRATION.md) per aggiornare la tua integrazione.
</Info>
...
Accogliamo con favore i contributi a tutti i nostri SDK! Ogni repository ha un file `CONTRIBUTING.md` con linee guida per:
