...
Genera una chiave API e un segreto Webhook dalla dashboard Dodo. Imposta l'ambiente su `test_mode` durante lo sviluppo.
</Step>
...
L'interfaccia di prezzo legge questo array `features` e lo rende dinamicamente.
</Step>
...
- Checkout di abbonamento tramite Dodo Payments
- Funzione Edge di Supabase per webhook (`dodo-webhook`)
- Schema e migrazioni di Drizzle ORM
- Dashboard con fatture, stato dell'abbonamento e caratteristiche del piano
...
<AccordionGroup>
<Accordion title="Firma webhook non valida (401)">
...
<Accordion title="Il push al database non riesce">
...
- Assicurati che sia lo stesso in Google Cloud e nel provider Auth di Supabase
</Accordion>
</AccordionGroup>
