...
2. Crea un prodotto (pagamento unico o abbonamento). I prodotti in abbonamento devono avere un prezzo di almeno **1 $** (o l'equivalente nella valuta scelta); importi inferiori a questo minimo non sono supportati.
...
<Card title="Create Checkout Session" icon="code" href="/api-reference/checkout-sessions/create">
  Riferimento API per la creazione di sessioni di pagamento sicure e ospitate per pagamenti una tantum e abbonamenti
</Card>
<Card title="Create Payment Link" icon="link" href="/api-reference/payments/post-payments">
  Riferimento API per la creazione di link di pagamento dinamici in modo programmatico
</Card>
</CardGroup>