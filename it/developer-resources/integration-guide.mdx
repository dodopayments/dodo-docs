...
4. Genera la tua chiave API:
   - Vai a Sviluppatore > API
   - [Guida dettagliata](/api-reference/introduction#api-key-management-and-authentication)
   - Copia la chiave API nella variabile d'ambiente denominata DODO_PAYMENTS_API_KEY
