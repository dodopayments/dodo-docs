...
<Step title="Imposta fornitore di pagamento">
    Avvolgi la tua app con l'`DodoPaymentProvider`:
...
<Step title="Implementa la schermata di pagamento">
    Crea la tua schermata di pagamento utilizzando il gancio `useCheckout`. Ecco un'implementazione completa:
