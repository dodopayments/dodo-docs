...
<Frame>
<img src="/images/guides/usage-based-billing/meter-quantities-chart.png" alt="Grafico delle quantità del contatore che mostra le tendenze d'uso nel tempo con visualizzazione a gradiente viola" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/guides/usage-based-billing/events-table.png" alt="Tabella degli eventi che mostra i nomi degli eventi, gli ID e i controlli di paginazione per un'analisi dettagliata degli eventi" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Card title="Create Meter" icon="gauge" href="/api-reference/meters/create-meter">
  Riferimento API per la creazione e configurazione di contatori d'uso per monitorare il consumo dei clienti
</Card>
<Card title="Ingest Usage Events" icon="arrow-right" href="/api-reference/usage-events/ingest-events">
  Riferimento API per inviare eventi di utilizzo ai tuoi contatori configurati per i calcoli di fatturazione
</Card>
</CardGroup>
