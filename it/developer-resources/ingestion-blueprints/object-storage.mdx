...
Crea un meter nella tua [Dodo Payments Dashboard](https://app.dodopayments.com/):
- **Nome Evento**: `object_storage_upload` (o un nome di tua scelta)
- **Tipo di Aggregazione**: `sum` per tenere traccia del totale dei byte caricati
- **Sulla Proprietà**: `bytes` per fatturare in base alla dimensione di archiviazione
</Step>
