...
**Nome del Meter**: Copia e incolla esattamente → `Image Generation Meter`
...
<Warning>
Il nome dell'evento `image.generated` deve corrispondere esattamente a ciò che invieremo dal nostro codice applicativo in seguito. I nomi degli eventi sono case-sensitive!
</Warning>
</Step>

<Step title="Configura come contiamo le immagini">
...
<Step title="Aggiungi filtraggio di qualità">
...
1. **Abilita il Filtro degli Eventi**: Attiva questo **ON**
...
Inoltre, imposta il **Prezzo Fisso** a `0` per garantire che i clienti vengano addebitati solo in base al loro utilizzo, senza tassa di base.
...
**Soglia Gratuita**: Inserisci → `10` (i clienti ricevono 10 immagini gratuite al mese)
...
<Step title="Completa un acquisto di test">
...
1. Torna al tuo cruscotto Dodo Payments
...
<Step title="Crea l'applicazione principale">
Crea un file chiamato `index.ts` e copia questo codice applicativo completo:
</Step>
</Steps>
...
<Steps>
<Step title="Imposta il tuo ambiente">
...
<Step title="Genera la tua prima immagine di test">
...
<Step title="Genera alcune altre immagini">
...
<Step title="Controlla il tuo dashboard di Dodo Payments">
...
<Step title="Verifica i calcoli di fatturazione">
...
<Step title="Testa la soglia di fatturazione">
