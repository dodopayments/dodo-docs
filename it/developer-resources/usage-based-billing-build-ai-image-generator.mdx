...
**Nome del Meter**: Copia e incolla esattamente questo → `Image Generation Meter`
...
<Warning>
Il nome dell'evento `image.generated` deve corrispondere esattamente a quello che invieremo dal nostro codice applicativo in seguito. I nomi degli eventi sono case-sensitive!
</Warning>
</Step>
...
Inoltre, imposta il **Prezzo Fisso** a `0` per garantire che i clienti vengano addebitati solo in base al loro utilizzo, senza alcuna tariffa base.
