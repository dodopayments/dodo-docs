...
description: Follow along as we build PixelGen AI - an AI image generation
...
keywords:
  ...
  - tutorial fatturazione utilizzo
---
...
2. Vai a **Vendite → Clienti** nella barra laterale
3. Trova il cliente che hai appena creato (con l'email di test)
4. Copia l'ID del cliente - sarà simile a `cus_abc123def456`
