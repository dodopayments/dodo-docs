...
<Info>
Questa sezione copre la configurazione del tema **lato client** utilizzando l’SDK Checkout. Puoi anche configurare i temi **lato server** quando crei una sessione di checkout tramite l’API utilizzando il parametro `theme_config`. Consulta [Checkout Theme Customization](/features/checkout#checkout-theme-customization) per la configurazione a livello di API.
</Info>
