...
<Frame>
<img src="/images/product-catalog/product-metadata-ui.png" alt="Interfaccia metadati prodotto nel dashboard di Dodo Payments" />
</Frame>
...
- Documenta internamente il tuo schema di metadati
- Mantieni i valori brevi e significativi
- Usa i metadati solo per dati statici
- Considera di usare prefissi per diversi sistemi (ad es., `crm_id`, `inventory_sku`)
