...
- `DISCOUNT_CONCURRENT_REDEMPTION`
  - **Trigger:** Un altro utilizzo dello stesso codice ha mantenuto troppo a lungo il blocco della riga del limite di utilizzo
  - **Message:** Lo sconto è in fase di utilizzo contemporaneamente; riprova
  - **Note:** Temporaneo. Il codice potrebbe avere ancora disponibilità, quindi è possibile riprovare la richiesta senza rischi. Non mostrare questo messaggio al cliente come "codice esaurito".
