...
- `UNSUPPORTED_BILLING_CURRENCY`
  ...
  - **Message:** La valuta di fatturazione diversa da USD non è supportata per gli abbonamenti
...
- `UNSUPPORTED_CURRENCY`
  - **Trigger:** La valuta del prodotto o dell'addon non è una valuta in cui Dodo Payments può effettuare addebiti. I prezzi base possono essere impostati in qualsiasi valuta addebitabile; ciò significa generalmente che il codice valuta non è valido o non è ancora supportato.
  - **Message:** La valuta non è attualmente supportata / Attualmente sono supportati solo i prodotti in USD e INR / Per il prezzo dell'addon sono supportati solo USD e INR / È possibile richiedere solo USD o INR per billing_currency / Valuta non supportata / Valuta imprevista per gli abbonamenti con carta indiana
