...
| Codice di Errore | Errore Utente | Descrizione |
|----------------|----------------|-------------|
...
| `CARD_VELOCITY_EXCEEDED` | Sì | Sono stati tentati troppi acquisti in un breve periodo |
...
| `FRAUDULENT` | Sì | La transazione è stata contrassegnata come potenzialmente fraudolenta |
| `GENERIC_DECLINE` | No | La transazione è stata rifiutata per un motivo non specificato |
| `INCORRECT_CVC` | Sì | Il codice CVC fornito è errato |
| `INCORRECT_NUMBER` | Sì | Il numero della carta è stato inserito in modo errato |
| `INSUFFICIENT_FUNDS` | Sì | Il conto non ha fondi sufficienti per completare la transazione |
| `INVALID_ACCOUNT` | Sì | I dettagli dell'account forniti sono invalidi |
| `INVALID_AMOUNT` | Sì | L'importo della transazione è invalido |
| `INVALID_CARD_NUMBER` | Sì | Il formato del numero della carta è invalido |
| `INVALID_CARD_OWNER` | Sì | Le informazioni sul proprietario della carta sono invalide |
| `INVALID_CVC` | Sì | Il formato del CVC è invalido |
| `INVALID_EXPIRY_YEAR` | Sì | L'anno di scadenza della carta è invalido |
| `INVALID_PIN` | Sì | Il PIN fornito è errato |
| `INVALID_REQUEST` | Sì | La richiesta di transazione contiene dati non validi |
| `INVALID_UPI_ID` | Sì | L'ID UPI fornito è invalido |
...
| `MANDATE_INVALID` | Sì | Il mandato di pagamento è invalido |
...
| `PROVIDER_UNSUPPORTED` | No | Il fornitore di pagamenti non supporta questo tipo di transazione |
