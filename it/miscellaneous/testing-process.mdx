...
Test di carta, 3D Secure e metodi di pagamento salvati.

Test di Apple Pay, Google Pay, Amazon Pay.

Test di Klarna, Afterpay e Billie.

Test UPI e mandato RBI.

Test di iDEAL, Bancontact, EPS, Multibanco.

Configura i webhooks per gli eventi di prova.

Testa i webhooks localmente con il Dodo Payments CLI.
