...
Aggiunto il campo `refund_status` alla risposta `GET /payments/{payment_id}` per verificare rapidamente se un pagamento è stato rimborsato senza interrogare separatamente l'endpoint dei rimborsi.
