...
### 1. **Product Collections**  
   ...
   <Frame>
     <img src="/images/product-collection/checkout-page.png" alt="Pagina di checkout della collezione di prodotti che mostra più opzioni di piano" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
