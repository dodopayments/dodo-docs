...
1. **Checkout Inline - Esperienze di Checkout Completamente Incorporate (BETA)**  
   ...
   <Frame>
   <img src="/images/inline-checkout/cover.png" alt="Immagine di copertina del pagamento inline" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
...
3. **Modifiche ai Piani di Abbonamento nella Dashboard con Aggiornamenti della Prossima Data di Fatturazione**  
    ...
    <Frame>
    <img src="/images/changelog/subscription-plan-changes.png" alt="Modifiche al piano di abbonamento nel dashboard" style={{ maxHeight: '500px', width: 'auto' }} />
    </Frame>
...
4. **Link Brevi per URL di Pagamento**  
   ...
   <Frame>
   <img src="/images/changelog/short-links.png" alt="Funzionalità di collegamenti brevi per URL di pagamento" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
