...
<Frame>
<img src="/images/CBB/Checkout.png" alt="Checkout che mostra i crediti inclusi con l'acquisto del prodotto" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
I crediti vengono aggiunti come **diritti** nel flusso di creazione del prodotto. Puoi associare fino a **5 crediti per prodotto** e funzionano con tutti e tre i tipi di prezzo: abbonamenti, pagamenti una tantum e fatturazione basata sull’utilizzo.
...
<Frame>
<img src="/images/CBB/Customer Portal.jpg" alt="Vista dei crediti nel portale clienti con saldo e cronologia delle transazioni" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/design/general-overview.jpg" alt="Pagina delle impostazioni di design con anteprima dal vivo del checkout, del portale clienti e dello storefront" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
