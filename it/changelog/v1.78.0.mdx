...
### 1. **Preferenze di Comunicazione**
   ...
   <Frame>
     <img src="/images/communication-preferences/overview.png" alt="Panoramica delle Preferenze di Comunicazione che mostra le impostazioni di notifica" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
...
### 2. **Campi Personalizzati nelle Sessioni di Checkout**
   ...
   **Vantaggi**
   ...
   <Info>
   I valori dei campi personalizzati vengono restituiti nell'array `custom_field_responses` nelle risposte relative ai pagamenti e agli abbonamenti.
   </Info>

   Scopri di più: [Campi personalizzati della sessione di Checkout](/developer-resources/checkout-session#15-collecting-custom-fields)
