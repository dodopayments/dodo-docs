...
Le risposte relative ai pagamenti e alle contestazioni ora includono un discriminatore `payment_provider` (`stripe`, `adyen` o `dodo`), così puoi identificare come è stata instradata ogni transazione; inoltre, la risposta di anteprima della sessione di checkout restituisce `is_byop`. I campi sono aggiuntivi: il traffico Merchant-of-Record continua a riportare `payment_provider: dodo`.
