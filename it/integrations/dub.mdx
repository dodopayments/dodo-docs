...
<Step title="Open the Webhook Section">
  Nel tuo dashboard di Dodo Payments, vai a **Webhooks → + Aggiungi Endpoint** ed espandi il menu a tendina delle integrazioni.
  <Frame>
    <img src="/images/integrations/dub/add.png" alt="Aggiungi Endpoint e menu a tendina delle integrazioni" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
...
<Step title="Enter API Key">
  Fornisci la tua chiave API Dub nel campo di configurazione.
  <Frame>
    <img src="/images/integrations/dub/api-key.png" alt="Aggiungi Chiave API" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
