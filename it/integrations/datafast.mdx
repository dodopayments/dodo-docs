...
<Steps>
<Step title="Installa lo script DataFast">
  Prima di tutto, installa lo script di tracciamento DataFast sul tuo sito web. Questo crea il cookie `datafast_visitor_id` che tiene traccia dei tuoi visitatori.
...
<AccordionGroup>
<Accordion title="Pagamenti non visualizzati in DataFast">
- Verifica che la tua chiave API di DataFast sia corretta e attiva
- Controlla che l'`datafast_visitor_id` venga catturata e memorizzata nei metadati di pagamento
...
- Conferma che lo script di tracciamento DataFast sia installato e funzionante sul tuo sito web
...
- Consulta la [documentazione dell'API di pagamento di DataFast](https://datafa.st/docs/payments-api) per ulteriori indicazioni
</Accordion>
...
- Testa la trasformazione con i payload del webhook di esempio
</Accordion>
