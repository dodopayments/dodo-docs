...
<Step title="Open the Webhook Section">
  Nel tuo dashboard Dodo Payments, vai a <b>Webhooks → + Aggiungi Endpoint</b> ed espandi il menu a tendina delle integrazioni.
  <Frame>
...
<Step title="Enter API Key">
  Fornisci la tua chiave API DataFast nel campo di configurazione.
  <Frame>
