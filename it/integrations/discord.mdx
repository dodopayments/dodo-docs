...
<Step title="Open the Webhook Section">
  Nel tuo dashboard di Dodo Payments, apri <b>Webhooks → + Aggiungi Endpoint</b> e espandi il menu a tendina per rivelare le integrazioni.
  <Frame>
    <img src="/images/integrations/discord.png" alt="Aggiungi Endpoint e menu a tendina delle integrazioni" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
