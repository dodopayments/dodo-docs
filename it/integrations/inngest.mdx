...
<Step title="Open the Webhook Section">
  Nel tuo dashboard di Dodo Payments, vai su <b>Webhooks → + Aggiungi Endpoint</b> ed espandi il menu a tendina delle integrazioni.
  <Frame>
    <img src="/images/integrations/inngest.png" alt="Aggiungi Endpoint e integrazioni a tendina" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
