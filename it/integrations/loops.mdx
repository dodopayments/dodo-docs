...
<Step title="Open the Webhook Section">
  Nel tuo cruscotto Dodo Payments, vai a <b>Webhooks → + Aggiungi Endpoint</b> ed espandi il menu a tendina delle integrazioni.
  <Frame>
    <img src="/images/integrations/loops.png" alt="Aggiungi Endpoint e menu a tendina delle integrazioni" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
