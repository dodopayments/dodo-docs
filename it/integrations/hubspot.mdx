...
<Step title="Open the Webhook Section">
  Nel tuo dashboard di Dodo Payments, vai su <b>Webhooks → + Aggiungi Endpoint</b> e espandi il menu a discesa delle integrazioni.
  <Frame>
    <img src="/images/integrations/hubspot.png" alt="Aggiungi Endpoint e menu a discesa delle integrazioni" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
