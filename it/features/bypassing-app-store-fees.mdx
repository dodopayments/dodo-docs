...
**Che cos'è:** incorpora un'interfaccia di pagamento, ad esempio un SDK nativo di terze parti, direttamente nella tua app per consentire un checkout fluido senza richiedere agli utenti di uscire dall'app.
