...
3. **Scegli la tua risposta**
   - Puoi accettare o contestare la disputa
   
   <Frame>
       <img src="/images/disputes/1.png" alt="Creazione della disputa" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
...
5. **Se contesti**
   ...
   - Segui le migliori pratiche seguenti
   
   <Frame>
       <img src="/images/disputes/2.png" alt="Creazione della disputa" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
   
   <Frame>
       <img src="/images/disputes/3.png" alt="Creazione della disputa" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>

<Info>
Hai **10 giorni** per rispondere a una contestazione dopo la sua creazione. Il conto alla rovescia mostrato sulla contestazione nella tua dashboard riflette lo stesso intervallo di tempo.
</Info>
...
<Frame caption="Visa RDR configuration in the Dodo Payments dashboard">
    <img src="/images/disputes/rdr.png" alt="Impostazioni Visa RDR che mostrano l'interruttore abilitato e la configurazione della soglia" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Step title="Open the Disputes Settings">
    Vai a **Impostazioni → Attività** nella tua dashboard di Dodo Payments e individua la sezione **Visa Rapid Dispute Resolution (RDR)**.
</Step>
