...
Timestamp ISO 8601 (UTC). Se omesso, utilizza l’ora corrente del server. Includilo per una fatturazione accurata con eventi ritardati/in batch. I timestamp più vecchi di 1 ora o con un anticipo superiore a 5 minuti vengono rifiutati.
</ParamField>
...
<Tip>
Raggruppa fino a 1.000 eventi per richiesta per ottenere prestazioni migliori. L'API impone un limite massimo di 1.000 eventi per chiamata.
</Tip>
