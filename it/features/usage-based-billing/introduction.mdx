...
<Frame>
<img src="/images/usage-based/UBB-2.png" alt="Interfaccia di creazione misuratore" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/usage-based/UBB-4.png" alt="Configurazione dei prezzi" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
Anziché addebitare in dollari per unità, puoi configurare i contatori in modo che detraiano dal [saldo crediti](/features/credit-based-billing) del cliente. I crediti si rinnovano ad ogni ciclo di fatturazione e vengono applicati prima di eventuali costi aggiuntivi.
...
<Frame>
<img src="/images/usage-based/UBB-5.png" alt="Aggiungere misuratore al prodotto" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/guides/usage-based-billing/meter-quantities-chart.png" alt="Dashboard del misuratore" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
