...
| Livello | Dove impostare | Ambito |
|-------|--------------|-------|
| **Per richiesta** | `mandate_min_amount_inr_paise` su una checkout session o subscription | Una transazione |
| **Merchant** | Impostazioni dell'attività | Tutte le tue subscription INR |
| **Sistema** | — | ₹15,000 predefinito |
