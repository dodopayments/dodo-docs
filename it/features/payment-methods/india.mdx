...
sidebarTitle: India
description: Accetta UPI e tutte le carte emesse in India con mandati di
  abbonamento conformi a RBI. Comprendi il ritardo di elaborazione di 48 ore, i
  limiti dei mandati e la gestione dei webhook.
...
<Accordion title="Payment deduction delayed beyond 48 hours">
**Causa:** I ritardi nelle API bancarie possono estendere l'elaborazione di 2-3 ore aggiuntive.

**Soluzione:** Questo è previsto. Costruisci il tuo sistema per gestire ritardi variabili fino a un totale di ~51 ore.
</Accordion>

<Accordion title="Mandate cancelled but subscription still active">
**Causa:** Caso limite nelle normative RBI — l'annullamento di un mandato durante la finestra di elaborazione non annulla immediatamente l'abbonamento.
...
<Card title="Webhooks" icon="webhook" href="/developer-resources/webhooks">
Gestione dei webhook per eventi di pagamento.
</Card>
