...
<Accordion title="Fornire alternative per la carta">
Non tutti i clienti europei hanno accesso a questi metodi regionali (turisti, espatriati, ecc.). Includere sempre `credit` e `debit` come alternative.
</Accordion>
...
<AccordionGroup>
<Accordion title="Metodo europeo non apparente">
**Controlla:**
