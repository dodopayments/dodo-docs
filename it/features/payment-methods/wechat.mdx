...
Crea una sessione di checkout con `we_chat_pay` nei metodi di pagamento consentiti.
</Step>
...
**Controlla:**
1. `we_chat_pay` incluso in `allowed_payment_method_types`?
2. Valuta di fatturazione impostata su USD o CNY?
