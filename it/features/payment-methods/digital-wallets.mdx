...
| Portafoglio | Disponibilità | Valute | Abbonamenti | Configurazione richiesta |
| :----- | :----------- | :--------- | :-----------: | :------------- |
| **Apple Pay** | Globale (esclusa l'India) | Tutte | Sì | Verifica del dominio |
| **Google Pay** | Globale (esclusa l'India) | Tutte | Sì | Nessuna |
| **Amazon Pay** | Globale (esclusa l'India) | USD | No | Nessuna |
| **Cash App Pay** | Solo Stati Uniti | USD | Sì | Nessuna |
...
### Disponibilità
- **Regione:** Globale, esclusa l'India
- **Valuta:** Solo USD
