...
- Il tuo dominio di produzione (ad es., `https://yourdomain.com`)
- Conferma che il file sia ospitato
...
<Accordion title="Includere sempre i fallback per le carte">
...
<AccordionGroup>
<Accordion title="Pulsante Apple Pay non appare">
**Controlla:**
1. Dominio verificato con Dodo Payments?
2. Stai usando HTTPS?
3. Il dispositivo è iOS 17+ / Safari 17+ / iPadOS 17+?
4. Il cliente ha carte nel Wallet di Apple?
...
<Accordion title="Pulsante Google Pay non appare">
**Controlla:**
1. Stai usando Chrome o un browser compatibile?
2. Il cliente ha carte in Google Pay?
3. Impostazione di Chrome "Consenti ai siti di controllare i metodi di pagamento" abilitata?
