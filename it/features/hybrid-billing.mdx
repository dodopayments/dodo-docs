...
**Soluzioni**:
1. Utilizza l'API `previewChangePlan` per mostrare gli addebiti esatti prima di confermare
2. Comunica che la ripartizione si applica a abbonamenti E add-on
3. Considera di utilizzare `difference_immediately` per una fatturazione dell'upgrade più semplice
</Accordion>
