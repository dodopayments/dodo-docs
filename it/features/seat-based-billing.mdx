...
keywords:
  - Dodo Payments
  - fatturazione basata sui posti
  - piattaforma di pagamento
  - fatturazione SaaS
  - prezzi basati sui posti
  - fatturazione per utente
  - fatturazione per team
---
<Info>
...
Un abbonamento Team Pro costa \$99/mese e include 5 postazioni. Se hai più di 5 utenti, paghi \$15/mese aggiuntivi per ogni postazione extra.

Ad esempio, se il tuo team ha bisogno di 15 postazioni:
- Piano base: \$99/mese (include 5 postazioni)
- Componenti aggiuntivi: 10 postazioni extra × \$15/mese = \$150/mese
- Costo mensile totale: \$99 + \$150 = \$249 per 15 postazioni
...
<Card title="Add-ons" icon="puzzle" href="/features/addons">
  Comprendi a fondo il sistema degli add-on.
</Card>
...
<Card title="Subscription Webhooks" icon="bell" href="/developer-resources/webhooks/intents/subscription">
  Tieni traccia degli eventi degli abbonamenti.
</Card>
</CardGroup>
