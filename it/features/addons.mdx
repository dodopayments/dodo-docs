...
- **Prezzi**: Imposta un prezzo una tantum o ricorrente per l'add-on
- **Valuta**: Imposta il prezzo di base in qualsiasi valuta che Dodo Payments può addebitare. Il selettore di valuta ricercabile fissa **USD, GBP, EUR e INR** in cima; ai clienti al di fuori della tua valuta di base viene addebitato l'importo tramite [Adaptive Currency](/features/adaptive-currency)
- **Ciclo di fatturazione**: Deve corrispondere al ciclo di fatturazione del tuo abbonamento
- **Limiti di quantità**: Imposta le quantità minima e massima per cliente
