...
<AccordionGroup>
<Accordion title="Crea Componenti Aggiuntivi">
...
<Accordion title="Aggiorna Componenti Aggiuntivi">
...
Utilizza `GET /addons` per elencare tutti i componenti aggiuntivi o `GET /addons/{id}` per recuperare i dettagli di un componente aggiuntivo specifico.
