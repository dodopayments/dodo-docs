...
2. Dodo Payments crea un grant con stato `Pending` e con un `oauth_url` che consente al cliente di collegare il proprio account GitHub.
3. Il cliente autorizza tramite il link nell'email o nel Customer Portal.
4. Dodo Payments invita l'account GitHub del cliente al repository con il livello di autorizzazione configurato. Il grant passa a `Delivered` una volta creata l'invitation.
