...
<Steps>
  ...
  <Step title="Aggiungi lo Script di Tracciamento">
    ...
    Questo script:
    - Tiene traccia delle visite affiliate
  ...
  <Step title="Testa la tua Integrazione">
    ...
    **Checklist di Testing:**
    - ✅ Crea un'affiliazione e genera un link di tracciamento
    - ✅ Visita il tuo sito web tramite il link affiliato
    ...
    - ✅ Conferma il tracciamento e l'attribuzione nella tua dashboard di Affonso
  </Step>
</Steps>
...
2. **Cattura l'ID di clic di Dub** (`dub_id` cookie) quando crei sessioni di checkout
3. **Memorizza l'ID di clic** nei metadati di pagamento insieme alle informazioni del cliente
4. **Configura l'integrazione webhook** per inviare i dati di vendita a Dub quando i pagamenti sono andati a buon fine
