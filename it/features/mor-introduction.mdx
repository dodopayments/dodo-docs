...
Sì. Con [Bring Your Own Processor (BYOP)](/features/byop) puoi collegare il tuo account Stripe o Adyen e instradare i pagamenti provenienti dai Paesi selezionati attraverso di esso, mentre Dodo Payments continua a gestire prodotti, abbonamenti, fatturazione e analisi. I Paesi che non instradi esplicitamente continuano a passare attraverso Dodo Payments come tuo Merchant of Record a servizio completo, permettendoci di assumerci la responsabilità fiscale e per le frodi su tali instradamenti.
</Accordion>
