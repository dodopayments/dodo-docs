...
<Frame>
<img src="/images/customer/customers-list.png" alt="Pagina dell'elenco dei clienti che mostra tutti i clienti con i loro dettagli" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/customer/customer-details.png" alt="Pagina dei dettagli del cliente che mostra informazioni e cronologia delle transazioni" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
- Tutti gli accrediti e gli addebiti dei fondi
- Saldo corrente del portafoglio in ogni valuta (USD, EUR, GBP)
- Motivi e timestamp delle transazioni
- Cronologia dettagliata delle transazioni per la riconciliazione
Visualizza il registro dei crediti del portafoglio del cliente, che mostra:
...
I portafogli dei clienti sono conti con saldo monetario prepagato per i tuoi clienti. Ogni cliente riceve automaticamente un portafoglio che può contenere fondi reali in più valute (USD, EUR e GBP), utilizzabili per le fatture degli abbonamenti, per i saldi dei rimborsi o alimentati con bonus promozionali.

### Funzionalità principali

- **Supporto multi-valuta**: monitora separatamente i saldi monetari in USD, EUR e GBP.
- **Saldi prepagati**: i clienti possono detenere fondi da applicare alle fatture future e ai pagamenti degli abbonamenti.
- **Cronologia delle transazioni**: visualizza il registro completo di tutti gli accrediti e gli addebiti dei fondi.
- **Design API-first**: aggiungi, detrai e verifica programmaticamente i saldi dei portafogli.
- **Fatturazione basata sui crediti**: consenti ai clienti di acquistare crediti in anticipo e spenderli per i tuoi servizi.
- **Cronologia delle transazioni**: visualizza il registro completo di tutti i crediti e gli addebiti.
- **Design API-first**: aggiungi, rimuovi e verifica programmaticamente i saldi dei portafogli.
