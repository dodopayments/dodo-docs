...
Entrambi i campi sono inclusi anche nel payload del webhook `subscription.cancelled` e puoi compilarli programmaticamente su `PATCH /subscriptions/{id}` quando programmi o esegui un annullamento tramite l'API.
