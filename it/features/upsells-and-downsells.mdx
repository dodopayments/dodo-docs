...
| `full_immediately` | Addebita il prezzo completo del nuovo piano, ignorando il tempo rimanente | Reimpostazione del ciclo di fatturazione |
| `do_not_bill` | Applica la modifica del piano senza alcun addebito immediato; il nuovo piano viene fatturato al rinnovo successivo e la data di fatturazione originale viene mantenuta | Upgrade omaggio e migrazioni gratuite |
...
<Info>
I crediti derivanti da downgrade tramite `difference_immediately` sono limitati all'abbonamento e vengono applicati automaticamente ai rinnovi futuri. Sono distinti dalle assegnazioni di [Credit-Based Billing](/features/credit-based-billing).
</Info>
