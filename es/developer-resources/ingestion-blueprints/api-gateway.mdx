...
<Tip>
**Usa Lotes para Alto Volumen**: Para aplicaciones que manejan más de 10 solicitudes por segundo, usa `createBatch()` para reducir la sobrecarga y mejorar el rendimiento.
</Tip>

<Warning>
**Siempre Limpia los Lotes**: Llama a `batch.cleanup()` al apagado de la aplicación para vaciar eventos pendientes y prevenir la pérdida de datos.
</Warning>
