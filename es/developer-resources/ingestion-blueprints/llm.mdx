...
<Note>
Al usar modelos con capacidades de razonamiento a través del SDK de IA (como Gemini 2.5 Flash de Google con modo de pensamiento), los tokens de razonamiento se incluyen automáticamente en el conteo de `outputTokens` para una facturación precisa.
</Note>
</Accordion>
