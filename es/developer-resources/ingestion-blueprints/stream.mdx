...
description: Rastrea el consumo de datos de transmisión para video, audio,
...
<Tip>
**Rastrear por Fragmento**: Para transmisiones largas, rastrea el consumo en fragmentos en lugar de esperar a que se complete toda la transmisión.
</Tip>

<Warning>
**Conteo Preciso de Bytes**: Asegúrate de que los conteos de bytes incluyan toda la sobrecarga (encabezados, sobrecarga de protocolo) si facturas por el ancho de banda total.
</Warning>
