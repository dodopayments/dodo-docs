...
2. **Lógica de Filtrado**: Selecciona **O** (esto significa "cuenta si ALGUNA de estas condiciones es verdadera")
...
Además, establece el **Precio Fijo** en `0` para garantizar que los clientes solo sean cobrados en función de su uso, sin tarifa base.
...
**Umbral Libre**: Ingresa → `10` (los clientes obtienen 10 imágenes gratis por mes)
...
1. Regresa a tu panel de control de Dodo Payments
