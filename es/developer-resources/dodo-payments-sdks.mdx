...
<Tip>
Siempre usa la última versión del SDK para acceder a las características y mejoras más recientes. Revisa tu gestor de paquetes para actualizaciones regularmente y asegúrate de tener acceso a todas las capacidades de Dodo Payments.
</Tip>
...
<Card title="Python SDK" icon="python" href="/developer-resources/sdks/python">
  Interfaz Pythonic con soporte para async/await para aplicaciones Python 3.7+
</Card>

<Card title="PHP SDK" icon="php" href="/developer-resources/sdks/php">
  SDK compatible con PSR-4 para aplicaciones modernas de PHP 8+
</Card>

<Card title="Go SDK" icon="golang" href="/developer-resources/sdks/go">
  Interfaz idiomática de Go con soporte para contexto y tipado fuerte
</Card>
...
<Card title="React Native SDK" icon="mobile" href="/developer-resources/react-native-integration">
  SDK nativo móvil para construir experiencias de pago seguras en aplicaciones de iOS y Android
</Card>
...
Todos los SDK comparten estas capacidades centrales:
...
- **Pruebas**: Soporte completo para un entorno de sandbox para desarrollo y pruebas
...
- Integración fluida con aplicaciones de React Native

<Info>
Apple Pay, Google Pay, Cash App y UPI no son actualmente compatibles con el SDK de React Native. Se planea el soporte para estos métodos de pago en futuras versiones.
</Info>
...
<Info>
Migramos del SDK de Node.js al nuevo SDK de TypeScript. Si estás usando el SDK legado de Node.js, consulta la [guía de migración](https://github.com/dodopayments/dodopayments-typescript/blob/main/MIGRATION.md) para actualizar tu integración.
</Info>
...
- **GitHub**: Abre un problema en el repositorio del SDK respectivo
