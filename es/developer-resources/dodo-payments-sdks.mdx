...
## Migración desde Node.js SDK
 ...
 <Info>
Migramos desde el SDK de Node.js al nuevo SDK de TypeScript. Si estás usando el SDK de Node.js heredado, consulta la [guía de migración](https://github.com/dodopayments/dodopayments-typescript/blob/main/MIGRATION.md) para actualizar tu integración.
</Info>
...
- **Discord**: Únete a nuestro [servidor de la comunidad](https://discord.gg/bYqAp4ayYh) para obtener ayuda en tiempo real
