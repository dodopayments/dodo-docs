...
- **Seguridad de tipos**: Tipado fuerte para garantizar la seguridad en tiempo de compilación y ofrecer mejor compatibilidad con el IDE
- **Manejo de errores**: Manejo integral de excepciones con mensajes de error detallados
- **Autenticación**: Autenticación sencilla mediante API key con compatibilidad con variables de entorno
- **Compatibilidad con async**: Patrones modernos de async/await cuando corresponde
- **Paginación automática**: Paginación automática para respuestas de listas
- **Facturación basada en el uso**: Compatibilidad integrada para realizar el seguimiento e ingerir eventos de uso
- **Pruebas**: Compatibilidad completa con Test Mode para desarrollo y pruebas
...
<Card title="CLI" icon="terminal" href="/developer-resources/sdks/cli">
  Interfaz de línea de comandos generada automáticamente con compatibilidad para la API de Dodo Payments
</Card>
