...
description: Aprende a integrar Dodo Payments con tu proyecto Fastify App Router
  utilizando nuestro adaptador NextJS. Cubre el proceso de pago, el portal del
...
<Card title="Manejador de Checkout" icon="cart-shopping" href="#checkout-route-handler">
    Integra el proceso de pago de Dodo Payments en tu aplicación Fastify.
</Card>
...
<Warning>
Nunca comitas tu archivo <code>.env</code> o secretos en el control de versiones.
</Warning>
</Step>
</Steps>
...
<Tab title="Manejador de Webhook">
  <Info>
  Usa este manejador para recibir y procesar eventos de webhook de Dodo Payments de manera segura en tu aplicación Fastify.
  </Info>
  <CodeGroup>
...
Especificar el monto del pago (por ejemplo, <code>1000</code> para $10.00).
</ParamField>
...
Las sesiones de checkout proporcionan experiencias de checkout más seguras y alojadas que manejan el flujo de pago completo tanto para compras únicas como para suscripciones con control total de personalización.
...
Si se establece en <code>true</code>, se envía un correo electrónico al cliente con el enlace al portal.
</ParamField>
...
Parámetros de Consulta:
    ...
    send_email (opcional): si es verdadero, se envía al cliente el enlace al portal
...
DODO_PAYMENTS_RETURN_URL=https://tuapp.com/success
DODO_PAYMENTS_WEBHOOK_KEY=tu-secreto-de-webhook
...
Nota de Seguridad: NO comitas secretos en el control de versiones. Usa archivos .env localmente y gestores de secretos en entornos de despliegue (por ejemplo, AWS, Vercel, Heroku, etc.).