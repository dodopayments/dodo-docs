...
Especificar la divisa del pago (p. ej., <code>USD</code>).
</ParamField>
<ParamField query="showCurrencySelector" type="boolean">
Mostrar el selector de divisa.
</ParamField>
<ParamField query="paymentAmount" type="number">
Fija el importe cobrado, en unidades principales de la divisa (p. ej., <code>12.5</code> para 12,50 $). Solo para productos Pay What You Want e ignorado si es inferior al precio mínimo del producto.
</ParamField>
