...
<Expandable title="Data object properties">
  ...
  Tipo de recurso. Uno de: `Payment`, `Subscription`, `Refund`, `Dispute`, `LicenseKey`, `CreditLedgerEntry`, `CreditBalanceLow`, `AbandonedCheckout`, `DunningAttempt`, o `EntitlementGrant`.
  </ResponseField>
...
Esta herramienta interactiva te permite seleccionar entre todos los tipos de eventos compatibles y enviar cargas de prueba realistas a tu endpoint. Se repite para que puedas probar múltiples eventos en una sola sesión.
...
<Frame>
  <img src="/images/webhooks/alerting.png" alt="Configuración de alertas de Webhook mostrando configuración de notificaciones por correo electrónico" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
