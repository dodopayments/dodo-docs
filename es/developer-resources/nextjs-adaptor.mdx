...
description: Learn how to integrate Dodo Payments with your Next.js App Router
  project using our NextJS Adaptor. Covers checkout, customer portal, webhooks,
...
Fixes the amount charged, in major currency units (e.g., <code>12.5</code> for $12.50). Pay What You Want products only, and ignored if below the product's minimum price.
</ParamField>
...
Checkout Sessions proporciona una experiencia de checkout alojada y más segura que gestiona todo el flujo de pago, tanto para compras únicas como para suscripciones, con control total de personalización.
