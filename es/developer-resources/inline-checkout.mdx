...
Para obtener información detallada sobre la configuración de Apple Pay, Google Pay y otros monederos digitales, consulta la página de <a href="/features/payment-methods/digital-wallets">Monederos Digitales</a>.
...
<Warning>
Apple Pay requiere verificación de dominio antes de aparecer en producción. Contacta al soporte antes de lanzarte si planeas ofrecer Apple Pay.
</Warning>
...
| Característica | Checkout Inline | Checkout Overlay |
|----------------|-----------------|------------------|
...
<Tip>
Usa **checkout inline** cuando quieras el máximo control sobre la experiencia de pago y un branding sin fisuras. Usa **checkout overlay** para una integración más rápida con cambios mínimos en tus páginas existentes.
</Tip>
