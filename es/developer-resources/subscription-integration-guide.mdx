...
Para cargos posteriores, utiliza el endpoint [POST /subscriptions/{subscription_id}/charge](/api-reference/subscriptions/create-charge) y especifica el monto a cobrar al cliente por esa transacción.
...
<Note>
Para una guía completa y paso a paso, incluyendo ejemplos de solicitud/respuesta, políticas de repetición segura, y manejo de webhook, consulta la <a href="/developer-resources/ondemand-subscriptions">Guía de Suscripciones Bajo Demanda</a>.
</Note>
...
<Card title="Patch Subscription" icon="pen" href="/api-reference/subscriptions/patch-subscriptions">
  Referencia de API para actualizar detalles y configuración de suscripción
</Card>
</CardGroup>