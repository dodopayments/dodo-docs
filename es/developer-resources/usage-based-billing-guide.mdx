...
<Frame>
<img src="/images/guides/usage-based-billing/meter-quantities-chart.png" alt="Gráfico de cantidades del medidor que muestra tendencias de uso a lo largo del tiempo con visualización de gradiente morado" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/guides/usage-based-billing/events-table.png" alt="Tabla de eventos mostrando nombres de eventos, IDs y controles de paginación para análisis detallado de eventos" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
