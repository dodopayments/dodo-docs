...
Marca de tiempo ISO 8601 de cuando ocurrió el evento. Si no se proporciona, se establece de forma predeterminada en la marca de tiempo UTC actual. Debe estar dentro de un intervalo de 1 hora en el pasado y 5 minutos en el futuro; las marcas de tiempo fuera de ese intervalo se rechazan.
</ParamField>
...
<Info>
**Establece las marcas de tiempo de forma intencionada.** Omite `timestamp` para eventos en tiempo real y se establecerá de forma predeterminada en la marca de tiempo UTC actual. Establécela explícitamente (ISO 8601) para eventos retrasados o procesados por lotes, de modo que el uso se registre en el periodo de facturación correcto, pero ten en cuenta que el intervalo aceptado es reducido: los eventos con marcas de tiempo de hace más de **1 hora** o de más de **5 minutos en el futuro** se rechazan. No se admite la recuperación histórica; vacía los eventos almacenados en búfer dentro de ese intervalo de una hora.
</Info>
