...
Elegir entre los operadores disponibles:
...
- `contains` - La cadena contiene una subcadena
...
**Ejemplo**: Configurar `$0.50` por unidad significa:
- 1,000 unidades consumidas = 1,000 × $0.50 = 500.00 cargado
- 500 unidades consumidas = 500 × $0.50 = 250.00 cargado
- 100 unidades consumidas = 100 × $0.50 = 50.00 cargado
</ParamField>
