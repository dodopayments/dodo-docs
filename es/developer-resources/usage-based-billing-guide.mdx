...
description: Aprende cómo configurar medidores y enviar eventos de uso para
...
- Determina cómo se deben agregar los eventos (conteo, suma, etc.)
...
Selecciona cómo se deben agregar los eventos:
...
<Warning>
Este campo es obligatorio cuando se utilizan los tipos de agregación Suma, Máx o Último.
</Warning>
</ParamField>
...
Especifica el nombre de la propiedad de tus metadatos de evento.
</Step>
...
<Warning>
Las propiedades filtradas deben estar incluidas en tus metadatos de evento para que las condiciones funcionen correctamente. Los eventos que faltan propiedades requeridas serán excluidos del conteo.
</Warning>
</Step>
...
Una vez que hayas creado tu medidor, necesitas vincularlo a un producto para habilitar la facturación basada en el uso. Este proceso conecta los datos de uso de tu medidor con las reglas de precios para la facturación de los clientes.
...
Transforma tus datos de uso en cargos facturables configurando correctamente la configuración de tu producto:
...
El ID de cliente de Dodo Payments al que se debe atribuir este uso.
</ParamField>
...
Propiedades adicionales para filtrado y agregación. Incluye cualquier valor referenciado en la "Sobre la Propiedad" de tu medidor o condiciones de filtrado.
</ParamField>
...
<Frame>
<img src="/images/guides/usage-based-billing/meter-quantities-chart.png" alt="Gráfico de cantidades de medidores que muestra tendencias de uso a lo largo del tiempo con visualización de degradado púrpura" />
</Frame>
...
Escenario: Facturar según el conteo máximo de usuarios concurrentes

Configuración del Medidor:
- Nombre del Evento: `concurrent.users`
- Tipo de Agregación: Máx
- Sobre la Propiedad: `count`
...
Configuración de Filtrado (usando lógica AND):
...
Soluciones:
- Asegúrate de que las claves de metadatos coincidan exactamente con tu configuración de Sobre la Propiedad
