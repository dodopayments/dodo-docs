...
<CardGroup cols={2}>
<Card title="Inicio Rápido" icon="rocket" href="#integration-workflow">
  Haz que tu integración de pagos móviles funcione en 4 simples pasos
</Card>

<Card title="Ejemplos de Plataforma" icon="code" href="#platform-specific-integration">
...
<Steps>
<Step title="Backend: Crear Sesión de Pago">
<Card title="Documentación de API de Sesión de Pago" icon="book" href="/developer-resources/checkout-session">
Aprende cómo crear una sesión de pago en tu backend usando Node.js, Python y más. Consulta ejemplos completos y referencias de parámetros en la documentación dedicada de <strong>API de Sesiones de Pago</strong>.
</Card>
<Note>
...
<Step title="Móvil: Obtener URL de Pago">
...
<Step title="Móvil: Abrir Pago en el Navegador">
Abre la URL de pago en un navegador seguro dentro de la aplicación para el procesamiento del pago.

<Card 
  title="Ver ejemplos de integración específicos de la plataforma" 
  icon="box" 
...
<Step title="Backend: Manejar la Finalización del Pago">
...
<Tip>
Usa InAppBrowser para una experiencia de navegador nativa. Maneja deep links para callbacks de pago.
</Tip>
...
<Warning>
**Cumplimiento Regional**: Los SDK de pago en la aplicación tienen restricciones regionales. En **iOS**, los SDK de pago nativos son legales solo en la **UE** (bajo los términos de DMA). En **Android**, son legales en mercados de Facturación por Elección del Usuario (UCB). Para otras regiones, utiliza el enfoque de enlaces de pago anterior para asegurar el cumplimiento con la App Store y Play Store.
</Warning>

<Card 
  title="Guía de Integración del SDK de React Native" 
  icon="mobile-screen" 
  href="/developer-resources/react-native-integration"
>
  Guía completa para integrar el SDK de React Native de Dodo con hojas de pago nativas, opciones de personalización completas y manejo directo de pagos. Incluye instrucciones de configuración, implementación y pruebas.
</Card>

<Info>
Revisa la [Guía de Evitación de Tarifas de la App Store](/features/bypassing-app-store-fees) para entender los requisitos de cumplimiento regional para integraciones de pago en la aplicación.
</Info>
