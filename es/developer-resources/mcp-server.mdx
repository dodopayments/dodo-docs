...
Después de hacer clic, establece tus variables de entorno en `mcp.json` a través de **Configuraciones de Cursor** > **Herramientas y MCP** > **Nuevo Servidor MCP**.
...
<Tip>
Claude Code automáticamente recoge variables de entorno de tu shell, por lo que también puedes exportarlas antes de ejecutar el comando.
</Tip>
</Tab>
...
Después de hacer clic, establece tus variables de entorno en `mcp.json` a través de **Paleta de Comandos** > **MCP: Abrir Configuración de Usuario**.
...
<Steps>
<Step title="Abrir configuraciones de Zed">
...
Verifica que `DODO_PAYMENTS_ENVIRONMENT` esté configurada correctamente (`live_mode` para producción).
...
Algunos clientes no admiten todas las características del esquema JSON. Usa `--describe-capabilities` para entender qué se admite.
</Accordion>
</AccordionGroup>
...
<Card title="Repositorio de GitHub" icon="github" href="https://github.com/dodopayments/dodopayments-typescript/tree/main/packages/mcp-server">
  Ver el código fuente del servidor MCP y contribuir
</Card>
