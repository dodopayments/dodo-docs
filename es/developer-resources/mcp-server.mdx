...
El [Dodo Agent Plugin](/developer-resources/build-with-ai-coding-agents) instala los dos servidores MCP y las diecisiete habilidades en un solo paso para Claude Code, Codex CLI, Cursor, VS Code / GitHub Copilot, Kiro y OpenCode. Gemini CLI solo obtiene los dos servidores MCP, ya que no tiene una primitiva de habilidades de agente. Consulta la [guía de agentes de codificación con IA](/developer-resources/build-with-ai-coding-agents) para ver los comandos de instalación de cada agente.
