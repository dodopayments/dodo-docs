...
**Ver logs en el Tablero de Vercel:**
1. Selecciona tu proyecto
2. Ve a **Despliegues** → último despliegue
3. Haz clic en **Funciones** → **Logs**
...
| Tiempo de espera de función | Optimiza las consultas; el plan Pro tiene un tiempo de espera más largo (60s) |
