...
5. Copia el **Secret de Firma**

### 9. Establecer Clave de Webhook y Volver a Desplegar
...
3. **Registra el evento** - Almacena el webhook en bruto en la tabla `webhook_events` para auditoría
