...
3. Ver registros en tiempo real e historial de invocaciones

**Configurar en el Tablero de DodoPayments:**
1. Ve a Desarrolladores → Webhooks
2. Agrega el endpoint con tu URL de Funciones de Netlify
...
| Variables de entorno no disponibles | Establece variables en CLI o tablero, luego vuelve a desplegar |
