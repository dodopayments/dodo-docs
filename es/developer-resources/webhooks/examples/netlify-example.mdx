...
5. **Maneja errores** - Registra fallos y marca el evento como no procesado para reintentar
...
**Ver logs en el Tablero de Netlify:**
1. Selecciona tu sitio → pestaña **Funciones**
2. Haz clic en la función `webhook`
3. Ve los logs en tiempo real y el historial de invocaciones
...
| Función no encontrada (404) | Ejecuta `netlify init` y `npm run deploy` nuevamente |
| Variables de entorno no disponibles | Establece variables en la CLI o en el tablero, luego vuelve a desplegar |
