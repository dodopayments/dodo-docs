...
| **Método de pago de la suscripción actualizado** | `subscription.update_payment_method` | Se envía cuando se actualiza el método de pago de una suscripción. Incluye el payload de la suscripción. |
| **Suscripción cancelada** | `subscription.cancelled` | Se activa cuando el merchant o el cliente cancela una suscripción.         |
...
| **Suscripción expirada** | `subscription.expired`   | Se activa cuando una suscripción llega al final de su período y expira.          |
