...
| **Suscripción actualizada** | `subscription.updated`   | Se activa cuando se actualiza cualquier campo de una suscripción (sincronización en tiempo real sin sondeo). |
...
| **Plan de suscripción cambiado** | `subscription.plan_changed` | Se activa cuando una suscripción se actualiza, se degrada o se modifica con diferentes complementos. |
