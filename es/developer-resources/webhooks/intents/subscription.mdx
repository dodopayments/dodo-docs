...
| `subscription.plan_changed` | El plan de suscripción se actualizó, mejoró, degradó o modificó |
| `subscription.update_payment_method` | El método de pago de la suscripción se actualiza |
