...
- **Portal del cliente** - Creación fácil de sesiones del portal del cliente
...
<Accordion title="La creación de la sesión de pago falla">
**Causas comunes:**
...
Actualiza la URL del webhook en tu [panel de Dodo](https://app.dodopayments.com/developer/webhooks) a la URL de ngrok. Asegúrate de actualizar tu `.env` archivo con la clave de verificación de webhook correcta.
</Accordion>
