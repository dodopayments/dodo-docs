...
{/* LOCKED_PATTERN_848a353666469e7a047ef05af5a45770 */}
    Integra el checkout de Dodo Payments en tu aplicación Hono.
</Card>
...
<Warning>
Nunca subas tu archivo <code>.env</code> ni tus secretos al control de versiones.
</Warning>
</Step>
</Steps>
...
<Info>
Todos los ejemplos asumen que estás usando el Hono App Router.
</Info>

<Tabs>
{/* LOCKED_PATTERN_28fd81a4703a84d931eeff69f1520d54 */}
  <Info>
  Utiliza este manejador para integrar el checkout de Dodo Payments en tu aplicación Hono. Admite flujos estáticos (GET), dinámicos (POST) y de sesión (POST).
  </Info>
  <CodeGroup>
...
{/* LOCKED_PATTERN_0026b036379d81a9d03c36b3b6e83ddd */}
  <Info>
  Utiliza este manejador para recibir y procesar de forma segura los eventos webhook de Dodo Payments en tu aplicación Hono.
  </Info>
  <CodeGroup>
...
<Info>
Dodo Payments admite tres tipos de flujos de pago para integrar pagos en tu sitio web; este adaptador admite todos los tipos.
</Info>
...
Deshabilita el campo de primer nombre.
</ParamField>
...
Cualquier parámetro de consulta que comience con <code>metadata_</code> se enviará como metadata.
</ParamField>
...
- Para una lista completa de campos de cuerpo POST compatibles, consulta:
...
Las sesiones de checkout ofrecen una experiencia de checkout alojada más segura que maneja el flujo completo de pago tanto para compras únicas como para suscripciones con control total sobre la personalización.
