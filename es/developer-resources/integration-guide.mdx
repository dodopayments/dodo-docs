...
2. Crea un producto (pago único o suscripción). Los productos de suscripción deben tener un precio de al menos **$1** (o el equivalente en la moneda que elijas); los montos por debajo de este mínimo no se soportan.
...
## Referencia del API relacionada

<CardGroup cols={2}>
<Card title="Create Checkout Session" icon="code" href="/api-reference/checkout-sessions/create">
  Referencia del API para crear sesiones de pago seguras y alojadas para pagos únicos y suscripciones
</Card>
<Card title="Create Payment Link" icon="link" href="/api-reference/payments/post-payments">
  Referencia del API para crear enlaces de pago dinámicos programáticamente
</Card>
</CardGroup>