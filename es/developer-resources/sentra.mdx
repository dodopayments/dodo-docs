...
4. Introduce tu clave API de Dodo Payments cuando se te pida.
...
3. **Recargar ventana**: Usa la Paleta de Comandos (`Cmd+Shift+P` / `Ctrl+Shift+P`) y ejecuta "Desarrollador: Recargar Ventana".
