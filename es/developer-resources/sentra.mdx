...
<Frame>
  <img
    ...
    alt="Pantalla de configuración de Sentra con ingreso de clave API y selección de entorno"
    width="50%"
  style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<Frame>
  <img
    ...
    alt="Interfaz de Sentra mostrando entrada de comandos con tarea de ejemplo"
    width="50%"
  style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
