...
<Card title="Manejador de Checkout" icon="cart-shopping" href="#checkout-route-handler">
    Integra el proceso de pago de Dodo Payments en tu aplicación Tanstack.
</Card>
...
<Info>
Todos los ejemplos asumen que estás utilizando el Tanstack App Router.
</Info>

<Tabs>
<Tab title="Manejador de Checkout">
  <Info>
  Usa este manejador para integrar el proceso de pago de Dodo Payments en tu aplicación Tanstack. Soporta flujos de pago estáticos (GET), dinámicos (POST) y de sesión (POST).
  </Info>
  <CodeGroup>
...
<Tab title="Manejador del Portal del Cliente">
  ...
  <CodeGroup>
    ```typescript Manejador de Ruta Tanstack expandable
...
<Tab title="Manejador de Webhook">
  <Info>
  Usa este manejador para recibir y procesar eventos de webhook de Dodo Payments de manera segura en tu aplicación Tanstack.
  </Info>
  <CodeGroup>
