...
<Info>
Las respuestas de los clientes a campos personalizados se incluyen en:
...
<Info>
Las respuestas de campos personalizados se incluyen automáticamente en las cargas útiles de los webhooks (`payment.succeeded`, `subscription.active`, etc.) y se pueden recuperar mediante la API. Úsalas para enriquecer tu CRM, activar flujos de incorporación o personalizar la experiencia del cliente.
</Info>
