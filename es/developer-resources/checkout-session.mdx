...
Cantidad que el cliente paga si pay_what_you_want está habilitado. Si está deshabilitado, este campo será ignorado.
...
Información de la dirección de facturación para un cálculo de impuestos preciso, prevención de fraude y cumplimiento normativo.
...
Código de país ISO de dos letras (ISO 3166-1 alpha-2). Este campo siempre es requerido cuando se proporciona billing_address.
...
Habilitar el modo de recopilación de dirección mínima. Cuando está habilitado, el proceso de pago solo recopila:
- **País**: Siempre requerido para la determinación de impuestos
- **Código postal**: Solo en regiones donde es necesario para el cálculo del impuesto sobre las ventas, IVA o GST.

Esto reduce significativamente la fricción en el proceso de pago al eliminar campos de formulario innecesarios.

<Tip>
Habilita la dirección mínima para completar el proceso de pago más rápido. La recopilación de dirección completa sigue estando disponible para las empresas que requieren detalles de facturación completos.
</Tip>
</ParamField>
...
Permitir a los clientes seleccionar su moneda preferida durante el proceso de pago.
</ParamField>
...
Recopilar números de teléfono de los clientes durante el proceso de pago.
</ParamField>
...
Permitir a los clientes editar su dirección de correo electrónico durante el proceso de pago.
</ParamField>

<ParamField body="allow_customer_editing_name" type="boolean">
Permitir a los clientes editar su nombre durante el proceso de pago.
</ParamField>

<ParamField body="allow_customer_editing_street" type="boolean">
Permitir a los clientes editar la dirección de la calle durante el proceso de pago.
</ParamField>

<ParamField body="allow_customer_editing_city" type="boolean">
Permitir a los clientes editar la ciudad durante el proceso de pago.
</ParamField>

<ParamField body="allow_customer_editing_state" type="boolean">
Permitir a los clientes editar el estado durante el proceso de pago.
</ParamField>

<ParamField body="allow_customer_editing_country" type="boolean">
Permitir a los clientes editar el país durante el proceso de pago.
</ParamField>

<ParamField body="allow_customer_editing_zipcode" type="boolean">
Permitir a los clientes editar el código postal durante el proceso de pago.
</ParamField>
...
Moneda opcional del precio del producto. Si no se especifica, se utilizará la moneda del producto por defecto.
</ParamField>

<ParamField body="product_description" type="string">
Descripción opcional del producto para la facturación y los artículos de línea. Si no se especifica, se utilizará la descripción almacenada del producto.
</ParamField>
...
### 1. Proceso de Pago Simple para un Solo Producto
...
### 4. Proceso de Pago Pre-confirmado
...
### 5. Proceso de Pago con Sobrecarga de Moneda

<Note>
La sobrecarga de `billing_currency` solo tiene efecto cuando la moneda adaptativa está habilitada en la configuración de tu cuenta. Si la moneda adaptativa está deshabilitada, este parámetro no tendrá efecto.
</Note>
...
### 7. Proceso de Pago B2B con Recopilación de ID Fiscal
...
### 8. Proceso de Pago con Tema Oscuro y Código de Descuento
...
### 10. Proceso de Pago BNPL (Compra Ahora, Paga Después)
