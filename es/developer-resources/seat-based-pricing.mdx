...
**Precio Recurrente**: Introduzca → `49.00`

**Ciclo de Facturación**: Seleccionar → `Monthly`
...
<Step title="Crear su archivo de entorno">
...
<Warning>
Nunca comprometa su clave API en el control de versiones. Agregue `.env` a su archivo `.gitignore`.
</Warning>
</Step>

<Step title="Implementar la creación de la sesión de pago">
...
<Step title="Agregar una interfaz web simple">
...
<Step title="Servir archivos estáticos">
...
2. Actualice los IDs del producto y complemento en su código con los valores reales de su panel de Dodo Payments
