---
title: Adaptador SveleteKit
description: Aprende a integrar Dodo Payments con tu proyecto SveleteKit App
  Router utilizando nuestro Adaptador SveleteKit. Cubre el proceso de pago, el
...
<Card title="Manejador de Checkout" icon="cart-shopping" href="#checkout-route-handler">
    Integra el proceso de pago de Dodo Payments en tu aplicación SveleteKit.
</Card>
...
<Info>
Todos los ejemplos asumen que estás utilizando el SveleteKit App Router.
</Info>

<Tabs>
<Tab title="Manejador de Checkout">
  <Info>
  Usa este manejador para integrar el proceso de pago de Dodo Payments en tu aplicación SveleteKit. Soporta flujos de pago estáticos (GET), dinámicos (POST) y de sesión (POST).
  </Info>
  <CodeGroup>
...
<Tab title="Manejador de Webhook">
  <Info>
  Usa este manejador para recibir y procesar eventos de webhook de Dodo Payments de manera segura en tu aplicación SveleteKit.
  </Info>
  <CodeGroup>
...
- Para una lista completa de los campos soportados en el cuerpo POST, consulta:
...
El Manejador de Ruta del Portal del Cliente te permite integrar sin problemas el portal del cliente de Dodo Payments en tu aplicación SveleteKit.
