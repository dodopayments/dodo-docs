...
Fija el importe cobrado en unidades principales de moneda (p. ej., <code>12.5</code> para $12.50). Solo para productos Pay What You Want; se ignora si está por debajo del precio mínimo del producto.
</ParamField>
...
Utiliza estas en tu código como:
