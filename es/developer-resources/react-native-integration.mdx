...
<Step title="Configurar el proveedor de pagos">
...
<Step title="Crear función de utilidad de pago">
    ...
    <Note>
    Esta función asume que tienes un endpoint de API de backend que crea intenciones de pago y devuelve un secreto de cliente. Asegúrate de que tu backend esté correctamente configurado para manejar la creación de pagos. Consulta nuestro [Tutorial de Integración de API](/developer-resources/integration-tutorial) para ejemplos de configuración de backend.
    </Note>
</Step>
...
Puedes personalizar el Checkout Unificado de React Native para que coincida con el diseño de tu aplicación modificando colores, fuentes y más a través del parámetro de apariencia al llamar `initPaymentSession()`.
...
Puedes personalizar el radio del borde, el ancho del borde y la sombra utilizados en toda la interfaz de pago:
