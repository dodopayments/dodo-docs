...
- Habilitar el registro de depuración en desarrollo
- Verificar las solicitudes de red a tu backend
- Verificar que las claves de API estén configuradas correctamente
- Probar en ambas plataformas, iOS y Android
- Revisar nuestras [Preguntas Frecuentes Técnicas](/miscellaneous/faq) para problemas comunes
- Usar [Modo de Prueba vs Modo en Vivo](/miscellaneous/test-mode-vs-live-mode) de manera adecuada
</Accordion>
</AccordionGroup>
