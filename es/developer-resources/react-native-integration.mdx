...
<Step title="Implementar la pantalla de pago">
    Crea tu pantalla de pago utilizando el `useCheckout` hook. Aquí tienes una implementación completa:
...
Puedes personalizar el React Native Unified Checkout para que coincida con el diseño de tu app modificando colores, fuentes y más a través del parámetro de apariencia al llamar `initPaymentSession()`.
...
| `componentBackground` | Color de fondo para inputs, tabs y otros componentes |
| `componentBorder` | Color de borde exterior para inputs, tabs y otros componentes |
| `componentDivider` | Color de borde interior (bordes compartidos) para componentes |
| `primaryText` | Color del texto del encabezado |
| `secondaryText` | Color del texto de etiqueta para campos de entrada |
| `componentText` | Color del texto de entrada (p. ej., número de tarjeta, código postal) |
| `placeholderText` | Color del texto del placeholder para campos de entrada |
| `icon` | Color para iconos (p. ej., botón de cerrar) |
