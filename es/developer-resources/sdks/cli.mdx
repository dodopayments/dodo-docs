...
`dodo wh trigger` puede enviar payloads simulados para los 46 tipos de eventos que entrega Dodo Payments:

| Categoría | Eventos |
|----------|--------|
| **Suscripción** | `active`, `updated`, `on_hold`, `paused`, `renewed`, `plan_changed`, `cancelled`, `failed`, `expired`, `update_payment_method` |
...
| **Concesión de entitlement** | `created`, `delivered`, `failed`, `revoked` |
