...
<Tip>
Siempre usa la última versión del SDK para acceder a las nuevas características de Dodo Payments. Ejecuta `bundle update dodopayments` regularmente para mantenerte al día.
</Tip>
