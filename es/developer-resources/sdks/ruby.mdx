...
<Tip>
Siempre utiliza la última versión del SDK para acceder a las nuevas características de Dodo Payments. Ejecuta `bundle update dodopayments` regularmente para mantenerte actualizado.
</Tip>
...
<Warning>
Almacena tus claves API de forma segura utilizando variables de entorno. Nunca las incluyas en el control de versiones ni las expongas en tu código.
</Warning>
