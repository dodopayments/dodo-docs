...
<Info>
El SDK de C# está actualmente en versión beta. Estamos trabajando activamente en mejoras y agradecemos sus comentarios.
</Info>
...
<Warning>
Guarde siempre sus claves de API de forma segura utilizando variables de entorno, secretos de usuario o Azure Key Vault. Nunca las codifique directamente en su código fuente ni las confirme en el control de versiones.
</Warning>
...
<Card title="Async/Await" icon="bolt">
  API completa basada en Task asíncronas para operaciones no bloqueantes
</Card>

{/* LOCKED_PATTERN_b690ec4e9cf6169c266a79afb70867b2 */}
  Seguridad integral de tipos con tipos de referencia anulables
</Card>
...
| Propiedad      | Variable de entorno        | Requerido | Valor predeterminado                     |
| ------------- | --------------------------- | -------- | --------------------------------- |
...
Para iterar por todos los resultados en todas las páginas, utilice el método `Paginate`:
...
Registre el cliente en `Program.cs`:
...
Agregue la configuración en `appsettings.json`:
...
{/* LOCKED_PATTERN_d84823c1531da9ccd5d4ca62a721106e */}
  Vea el código fuente y contribuya
</Card>
...
{/* LOCKED_PATTERN_ff730e4be5f7cef2bb5beaecbb22a37f */}
  Informe errores o solicite funciones
</Card>
</CardGroup>
