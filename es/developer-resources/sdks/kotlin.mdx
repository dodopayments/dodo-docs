---
title: Kotlin
description: Integra Dodo Payments en tus aplicaciones Kotlin con corutinas
...
<Tip>
Siempre usa la última versión del SDK para acceder a las nuevas características de Dodo Payments. Consulta [Maven Central](https://central.sonatype.com/artifact/com.dodopayments.api/dodo-payments-kotlin) para la versión más reciente.
</Tip>

<Info>
El SDK requiere Kotlin 1.6 o superior y es compatible con las plataformas JVM y Android.
</Info>
...
<Card title="Null Safety" icon="shield-check">
  Aprovecha la seguridad de nulos de Kotlin para un manejo robusto de errores
</Card>
