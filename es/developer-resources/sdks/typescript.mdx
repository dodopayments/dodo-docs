...
<Card title="TypeScript Primero" icon="shield-check">
  Soporte completo para TypeScript con definiciones de tipos completas para todos los endpoints de la API
</Card>

<Card title="Paginación Automática" icon="arrows-rotate">
  La paginación automática para respuestas de lista hace que trabajar con grandes conjuntos de datos sea sencillo
</Card>

<Card title="Manejo de Errores" icon="triangle-exclamation">
  Tipos de error integrados con mensajes detallados para diferentes escenarios de falla
</Card>
