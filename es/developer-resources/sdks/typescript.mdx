...
<Info>
Los eventos deben tener valores `event_id` únicos para la idempotencia. Los IDs duplicados dentro de la misma solicitud son rechazados, y las solicitudes posteriores con IDs existentes son ignoradas.
</Info>
