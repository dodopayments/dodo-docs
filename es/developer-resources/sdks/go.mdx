...
<Info>
El SDK requiere Go 1.22 o versiones posteriores, aprovechando las características modernas de Go para un rendimiento óptimo.
</Info>
...
<CardGroup cols={2}>
<Card title="Soporte de Contexto" icon="clock">
  Soporte completo para context.Context para cancelación y tiempos de espera
</Card>
...
<Card title="Middleware" icon="layer-group">
  Soporte de middleware extensible para registro, métricas y lógica personalizada
</Card>

<Card title="Seguro para Goroutines" icon="bolt">
...
<CardGroup cols={2}>
<Card title="Repositorio de GitHub" icon="github" href="https://github.com/dodopayments/dodopayments-go">
...
<Card title="Reportar Problemas" icon="bug" href="https://github.com/dodopayments/dodopayments-go/issues">
