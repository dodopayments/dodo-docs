---
title: Go
description: Integra Dodo Payments en tus aplicaciones Go con un SDK idiomático y eficiente
icon: golang
---
...
<Card title="Soporte de Contexto" icon="clock">
  Soporte completo para context.Context para cancelaciones y tiempos de espera
</Card>
