...
<Info>
`productPrice` se expresa en la denominación más baja de la moneda (por ejemplo, centavos para USD, paise para INR). Para cobrar $25.00, pase `2500`.
</Info>

<Tip>
Cobrar a través de `subscriptions().charge(...)` está destinado para [suscripciones bajo demanda](/developer-resources/ondemand-subscriptions). Las suscripciones programadas estándar se facturan automáticamente según el programa de precios del producto.
</Tip>
...
### Ingestar Eventos en Lote

Ingesta múltiple de eventos eficientemente (máximo 1000 por solicitud):
...
Manejo de errores comprensivo para diferentes escenarios:
...
<Tip>
El SDK reintenta automáticamente solicitudes en errores de conexión, 408, 409, 429 y errores 5xx con retroceso exponencial.
</Tip>
...
¡Damos la bienvenida a las contribuciones! Revisa las [directrices de contribución](https://github.com/dodopayments/dodopayments-java/blob/main/CONTRIBUTING.md) para comenzar.
