...
<Tip>
Siempre utiliza la última versión del SDK para acceder a las nuevas características de Dodo Payments. Consulta [Maven Central](https://central.sonatype.com/artifact/com.dodopayments.api/dodo-payments-java) para la versión más reciente.
</Tip>
...
<CardGroup cols={2}>
<Card title="Seguridad de Tipo" icon="shield-check">
  API fuertemente tipada con seguridad en tiempo de compilación
</Card>

<Card title="Seguro para Hilos" icon="bolt">
...
<Card title="Soporte Asíncrono" icon="arrows-rotate">
  Soporte para CompletableFuture en operaciones asíncronas
</Card>
</CardGroup>
...
<Tip>
El SDK reintenta automáticamente las solicitudes en caso de errores de conexión, 408, 409, 429 y errores 5xx con retroceso exponencial.
</Tip>

## Operaciones Asíncronas

Utiliza CompletableFuture para operaciones asíncronas:
