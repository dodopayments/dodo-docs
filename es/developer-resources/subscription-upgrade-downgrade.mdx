...
<Card title="Guía de Integración de Suscripciones" icon="book" href="/developer-resources/subscription-integration-guide">
  Aprende cómo crear y gestionar suscripciones desde cero con nuestra guía de integración completa.
</Card>
</CardGroup>
...
- Calcula el monto prorrateado exacto basado en el tiempo de ciclo restante
...
- Downgrade: acredita el valor restante para renovaciones futuras
...
El nuevo ID del producto al que cambiar la suscripción.
</ParamField>
...
Configura el manejo de webhook para rastrear los resultados del cambio de plan:

- `subscription.active`: Cambio de plan exitoso, suscripción actualizada
- `subscription.plan_changed`: Plan de suscripción cambiado (actualización/downgrade/actualización de complemento)
...
Basado en los eventos de webhook, actualiza tu aplicación:
...
Al cambiar los planes de suscripción, también puedes modificar complementos:
...
<Info>
Los complementos se incluyen en el cálculo de prorrata y se cobrarán de acuerdo con el modo de prorrata seleccionado.
</Info>
...
<Tip>
Elige `prorated_immediately` para una contabilidad justa del tiempo; elige `full_immediately` para reiniciar la facturación; usa `difference_immediately` para actualizaciones simples y crédito automático en downgrades.
</Tip>
...
- `subscription.plan_changed`: plan de suscripción cambiado (actualización/downgrade/cambios de complemento)
...
<Note>
Para esquemas de carga útil detallados, consulta los <a href="/developer-resources/webhooks/intents/subscription">Payloads de webhook de suscripción</a> y los <a href="/developer-resources/webhooks/intents/payment">Payloads de webhook de pago</a>.
</Note>
...
- Verifica que el punto final del webhook sea accesible y responda correctamente
</Accordion>
...
- Notifica al cliente que actualice su método de pago
...
- Configura el punto final de webhook de prueba
- Establece monitoreo y registro
</Step>

<Step title="Probar diferentes modos de prorrata">
