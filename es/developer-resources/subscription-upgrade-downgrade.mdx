...
<Info>
Los créditos creados por las degradaciones que usan <code>difference_immediately</code> tienen alcance de suscripción y son distintos de los beneficios de <a href="/features/credit-based-billing">Credit-Based Billing</a>. Se aplican automáticamente a las renovaciones futuras de la misma suscripción y no son transferibles entre suscripciones.
</Info>
