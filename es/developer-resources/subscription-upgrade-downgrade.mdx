...
- `subscription.plan_changed`: Plan de suscripción cambiado (actualización/reducción/cambio de addon)
- `subscription.on_hold`: Falló el cargo por el cambio de plan, se detuvieron las renovaciones
- `payment.succeeded`: El cargo inmediato por el cambio de plan se realizó correctamente
...
- `subscription.plan_changed`: plan de suscripción cambiado (actualización/reducción/cambios en el addon)
- `subscription.on_hold`: falló el cargo, se detuvieron las renovaciones
- `subscription.renewed`: renovación exitosa
- `payment.succeeded`: el pago por el cambio de plan o la renovación se realizó correctamente
