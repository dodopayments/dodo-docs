...
<CardGroup cols={2}>
  ...
  <Card title="Clientes" icon="users">
    Mantén tus datos de clientes sincronizados, incluidos los perfiles de clientes, información de contacto y metadatos.
  </Card>
  <Card title="Suscripciones" icon="repeat">
    Sincroniza datos de suscripción, incluidas suscripciones activas, ciclos de facturación y cambios en el estado de suscripción.
  </Card>
...
Límite de tasa en solicitudes por segundo. Controla qué tan rápido el motor de sincronización realiza solicitudes a la API de Dodo Payments para evitar abrumar la API.
</ParamField>
