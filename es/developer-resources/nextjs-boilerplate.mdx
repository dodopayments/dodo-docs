...
<Info>
Esta plantilla utiliza Next.js 16 App Router con TypeScript, Tailwind CSS 4 y el adaptador `@dodopayments/nextjs`.
</Info>
...
- **API Key:** [Panel → Desarrollador → Claves de API](https://app.dodopayments.com/developer/api-keys)
- **Webhook Key:** [Panel → Desarrollador → Webhooks](https://app.dodopayments.com/developer/webhooks)
...
<Step title="Configura Variables de Entorno">
...
Actualiza la URL del webhook en tu [panel de Dodo](https://app.dodopayments.com/developer/webhooks) a la URL de ngrok. Recuerda actualizar tu archivo .env con la clave de verificación de webhook correcta.
</Accordion>
