...
- Rastrea automáticamente el uso de tokens (sin código manual)
...
**Agregarse Sobre**: Escribe → `totalTokens`

**Unidad de Medida**: Escribe → `tokens`
...
<Steps>
<Step title="Obtén la Clave API de Dodo Payments">
...
Además, establece el **Precio Fijo** en `0` para asegurarte de que los clientes solo sean cobrados según su uso, sin tarifa base.
...
3. Encuentra al cliente que acabas de crear (con el correo electrónico de prueba)
...
<Step title="Crea el servidor backend">
...
2. Encuentra a tu cliente de prueba
...
1. Ten varias conversaciones más (apunta a ~15,000+ tokens en total)
...
<Accordion title="Conteos de tokens mostrando cero">
**Causas posibles:**
...
2. Actualiza a la última versión del SDK de Blueprints: `npm install @dodopayments/ingestion-blueprints@latest`
</Accordion>
