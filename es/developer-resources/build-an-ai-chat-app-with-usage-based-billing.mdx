...
description: Follow along as we build an AI chat app with automatic token
  tracking and usage-based billing
icon: code
keywords:
  - Dodo Payments
  - guía del desarrollador
  - aplicación de chat AI
...
<Frame>
    <img src="/images/cookbooks/ai-chat-app/ai-chat-demo.png" alt="Demostración de Chat IA" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/images/cookbooks/ai-chat-app/aggregation.png" alt="Tokens del Cliente del Medidor" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/images/cookbooks/ai-chat-app/free-tier-test.png" alt="Prueba de Nivel Gratuito" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
