...
<Card title="Manejador de Checkout" icon="cart-shopping" href="#checkout-route-handler">
    Integra el proceso de pago de Dodo Payments en tu aplicación Remix.
</Card>
...
<Info>
Todos los ejemplos asumen que estás utilizando el Remix App Router.
</Info>

<Tabs>
<Tab title="Manejador de Checkout">
  <Info>
  Usa este manejador para integrar el proceso de pago de Dodo Payments en tu aplicación Remix. Soporta flujos de pago estáticos (GET), dinámicos (POST) y de sesión (POST).
  </Info>
  <CodeGroup>
...
<Tab title="Manejador de Webhook">
  <Info>
  Usa este manejador para recibir y procesar eventos de webhook de Dodo Payments de manera segura en tu aplicación Remix.
  </Info>
  <CodeGroup>
