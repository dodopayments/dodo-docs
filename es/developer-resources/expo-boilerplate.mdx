...
<Warning>
Nunca commits tu archivo `.env` al control de versiones. Ya está incluido en `.gitignore`.
</Warning>
</Step>
...
Escanea el código QR con la app Expo Go en tu dispositivo, o presiona `i` para simulador de iOS o `a` para emulador de Android.
