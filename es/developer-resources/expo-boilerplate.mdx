...
- Consulta el [repositorio de GitHub](https://github.com/dodopayments/expo-boilerplate) para informar sobre problemas y consultar actualizaciones
- Contacta con nuestro [equipo de soporte](mailto:support@dodopayments.com) para obtener ayuda
