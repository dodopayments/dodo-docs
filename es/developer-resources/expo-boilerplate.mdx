...
Una plantilla lista para producción para integrar Dodo Payments en aplicaciones Expo/React Native. Esta plantilla incluye la creación de sesiones de checkout, manejo de pagos y una configuración adecuada de TypeScript para ayudarte a comenzar a aceptar pagos en tu aplicación móvil rápidamente.
...
<Card title="Integración en React Native" icon="react" href="/developer-resources/react-native-integration">
