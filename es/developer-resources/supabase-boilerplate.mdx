...
description: Utiliza el starter oficial de Next.js + Supabase + Dodo Payments
  para suscripciones y envía suscripciones rápidamente. Incluye autenticación,
  esquema de base de datos, manejador de webhooks y UI de precios.
icon: database
---
...
- Confirma que desplegaste la última función `dodo-webhook`
...
- Asegúrate de que sea la misma en Google Cloud y el proveedor de Supabase Auth
</Accordion>
</AccordionGroup>
