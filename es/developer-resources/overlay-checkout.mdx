...
Para obtener información detallada sobre cómo configurar Apple Pay, Google Pay y otros monederos digitales, consulte la página de <a href="/features/payment-methods/digital-wallets">Monederos Digitales</a>.

### Configuración Rápida para Apple Pay

<Steps>
<Step title="Descargar archivo de asociación de dominio">
Descargue el [archivo de asociación de dominio de Apple Pay](http://checkout.dodopayments.com/.well-known/apple-developer-merchantid-domain-association).
</Step>
...
<Step title="Probar después de la confirmación">
...
|---------|---------------------|-----------------|
| Profundidad de integración | Modal sobre la página | Totalmente incrustado en la página |
| Control de diseño | Limitado | Control total |
| Branding | Separado de la página | Sin problemas |
