...
<Step title="Open the Webhook Section">
  En tu panel de Dodo Payments, navega a <b>Webhooks → + Agregar Endpoint</b> y despliega el menú de integraciones.
  <Frame>
    <img src="/images/integrations/datafast/add.png" alt="Agregar Endpoint y menú de integraciones" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
...
<Step title="Enter API Key">
  ...
  <Frame>
    <img src="/images/integrations/datafast/api-key.png" alt="Agregar Clave API" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
