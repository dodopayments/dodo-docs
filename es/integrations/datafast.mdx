...
<Step title="Instalar el Script de DataFast">
  Primero, instala el script de seguimiento de DataFast en tu sitio web. Esto crea la `datafast_visitor_id` cookie que rastrea a tus visitantes.
...
<Step title="¡Listo!">
  🎉 Los datos de ingresos ahora aparecerán en tu tablero de DataFast con la atribución completa a los canales de marketing.
</Step>
</Steps>
...
<Step title="Seleccionar DataFast">
