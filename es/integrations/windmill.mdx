...
<Step title="Abre la Sección de Webhooks">
  ...
  <Frame>
    <img src="/images/integrations/windmill.png" alt="Agregar Endpoint y menú desplegable de integraciones" />
  </Frame>
</Step>

<Step title="Selecciona Windmill">
  Elige la tarjeta de integración <b>Windmill</b>.
</Step>

<Step title="Crea un Flujo de Trabajo en Windmill">
...
<Step title="Configura la Transformación">
  Edita el código de transformación para dar formato a los eventos para tu flujo de trabajo de Windmill.
</Step>
...
<AccordionGroup>
<Accordion title="Operaciones de Base de Datos">
- Actualizar registros de clientes en PostgreSQL/MySQL
- Registrar eventos de pago en almacenes de datos
- Sincronizar datos con sistemas externos
- Actualizar niveles de inventario
- Rastrear métricas analíticas
</Accordion>

<Accordion title="Lógica Empresarial">
- Calcular métricas de ingresos
- Procesar reembolsos y ajustes
- Manejar el ciclo de vida de suscripciones
- Generar informes y exportaciones
- Validar datos de pago
</Accordion>

<Accordion title="Integraciones Externas">
- Enviar datos a plataformas de análisis
- Actualizar sistemas CRM
- Activar campañas de correo electrónico
...
<AccordionGroup>
<Accordion title="Flujos de trabajo no se activan">
...
<Accordion title="Problemas de procesamiento de datos">
