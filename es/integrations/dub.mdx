...
<Step title="Open the Webhook Section">
  En el panel de control de Dodo Payments, navega a **Webhooks → + Add Endpoint** y despliega el menú de integraciones.
  <Frame>
    <img src="/images/integrations/dub/add.png" alt="Añadir Endpoint y menú de integraciones" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
...
<Step title="Enter API Key">
  ...
  <Frame>
    <img src="/images/integrations/dub/api-key.png" alt="Añadir Clave API" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
