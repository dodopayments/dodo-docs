...
<Step title="Open the Webhook Section">
  En el panel de control de Dodo Payments, ve a <b>Webhooks → + Añadir Endpoint</b> y despliega el menú de integraciones.
  <Frame>
    <img src="/images/integrations/hubspot.png" alt="Añadir Endpoint y menú desplegable de integraciones" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
