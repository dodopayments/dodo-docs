...
<Step title="Open the Webhook Section">
  En el panel de control de Dodo Payments, navega a <b>Webhooks → + Añadir Endpoint</b> y despliega el menú de integraciones.
  <Frame>
    <img src="/images/integrations/customer-io.png" alt="Añadir Endpoint y menú de integraciones desplegable" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
