...
description: Envía correos electrónicos transaccionales a través de Resend
  basados en eventos de Dodo Payments con alta capacidad de entrega.
icon: envelope
---

## Introducción

Envía correos electrónicos transaccionales profesionales automáticamente cuando ocurren eventos de pago. Entrega confirmaciones de pago, actualizaciones de suscripción y notificaciones importantes con la infraestructura de correo electrónico confiable de Resend y excelentes tasas de entrega.
...
<Step title="Configura la transformación">
  Edita el código de transformación para formatear correos electrónicos para la API de Resend.
</Step>
...
<Step title="¡Listo!">
  🎉 Los eventos de pago ahora desencadenarán automáticamente correos electrónicos transaccionales a través de Resend.
</Step>
</Steps>
...
- Usa dominios de remitente verificados para mejor capacidad de entrega
...
- Asegúrate de que el dominio del remitente esté verificado en Resend
...
- Verifica que el contenido HTML esté correctamente formateado
- Verifica que la dirección de correo electrónico del remitente esté verificada
</Accordion>
</AccordionGroup>