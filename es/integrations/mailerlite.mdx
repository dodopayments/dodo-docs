...
<Step title="Open the Webhook Section">
  En el panel de control de Dodo Payments, navega a <b>Webhooks + Añadir Endpoint</b> y expande el menú desplegable de integraciones.
  <Frame>
    <img src="/images/integrations/mailerlite.png" alt="Añadir Endpoint y menú desplegable de integraciones" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
