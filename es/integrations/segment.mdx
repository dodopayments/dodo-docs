---
title: Segment
description: Envía eventos de Dodo Payments a Segment para la integración de
  análisis y plataforma de datos de clientes.
icon: chart-line
---

## Introducción

Rastrea eventos de pago en Segment para potenciar tus análisis, automatización de marketing y plataforma de datos de clientes. Envía eventos de pago, suscripción y ciclo de vida del cliente a más de 300 herramientas de downstream automáticamente.
...
<Step title="Selecciona Segment">
  Elige la tarjeta de integración <b>Segment</b>.
</Step>

<Step title="Ingresa la Clave de Escritura">
...
<AccordionGroup>
<Accordion title="Eventos no aparecen en Segment">
