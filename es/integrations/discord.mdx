...
<Step title="Open the Webhook Section">
  En tu panel de control de Dodo Payments, abre <b>Webhooks → + Añadir Endpoint</b> y expande el menú desplegable para mostrar integraciones.
  <Frame>
    <img src="/images/integrations/discord.png" alt="Añadir Endpoint y menú desplegable de integraciones" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
