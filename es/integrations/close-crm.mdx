...
<Step title="Abre la sección de Webhook">
  ...
  <Frame>
    <img src="/images/integrations/close-crm.png" alt="Agregar Endpoint y menú desplegable de integraciones" />
  </Frame>
</Step>

<Step title="Selecciona Close CRM">
  Elige la tarjeta de integración <b>Close CRM</b>.
</Step>
...
<AccordionGroup>
<Accordion title="Registros no creados en Close CRM">
