...
- `DISCOUNT_CONCURRENT_REDEMPTION`
  - **Activador:** Otro canje del mismo código mantuvo bloqueada durante demasiado tiempo la fila del límite de uso
  - **Mensaje:** El descuento se está canjeando de forma simultánea; vuelve a intentarlo
  - **Nota:** Transitorio. Es posible que el código aún tenga capacidad, por lo que es seguro volver a intentar la solicitud. No muestres esto al cliente como "código agotado".
