...
- **Suscripciones activas**: Actualiza el método de pago cuando una tarjeta expira o el cliente desea usar un método de pago diferente
...
- El método de pago se actualiza de inmediato
...
<Warning>
Si el pago falla después de actualizar el método de pago para una suscripción en `on_hold`, la suscripción permanecerá en estado `on_hold`. Monitorea los eventos de webhook para rastrear el estado del pago.
</Warning>
