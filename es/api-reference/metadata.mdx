...
- Los valores de metadatos pueden ser una cadena, número o booleano; las cadenas pueden tener hasta 500 caracteres
- No se aceptan objetos, arreglos e `null` como valores de metadatos
- Puedes tener hasta 50 pares clave-valor de metadatos por objeto
- Las claves deben contener solo caracteres alfanuméricos, guiones y guiones bajos
- Los metadatos no son buscables usando nuestra API pero se devuelven en las respuestas de la API y webhooks
