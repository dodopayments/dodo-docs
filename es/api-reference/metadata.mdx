...
### Hacer:
- Utilice convenciones de nomenclatura consistentes para las claves de metadatos
- Documente su esquema de metadatos internamente
- Mantenga los valores cortos y significativos
- Utilice metadatos solo para datos estáticos
- Considere usar prefijos para diferentes sistemas (por ejemplo, `crm_id`, `inventory_sku`)
