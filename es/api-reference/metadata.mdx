...
description: Aprende cómo usar metadatos para almacenar información adicional
  sobre tus objetos de Dodo Payments
icon: tags
---
...
- Almacenar información duplicada que esté disponible en otro lugar del objeto
