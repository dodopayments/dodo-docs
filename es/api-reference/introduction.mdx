...
## Guías del Desarrollador Relacionadas

Explora nuestras guías completas para entender cómo implementar características clave usando la API:

<CardGroup cols={2}>
{/* LOCKED_PATTERN_f7cf71c4394981bb4f21a4fe70918d2a */}
  Aprende a integrar pagos únicos, sesiones de pago y enlaces de pago en tu aplicación
</Card>
{/* LOCKED_PATTERN_111d19916a89f7256f741dfba74b6bd8 */}
  Guía completa para implementar suscripciones, gestionar planes y manejar eventos del ciclo de vida de las suscripciones
</Card>
{/* LOCKED_PATTERN_5077a75db45fcbd237199b9c9e2a1768 */}
  Configura medidores y eventos de uso para modelos de facturación por uso y precios basados en consumo
</Card>
...
{/* LOCKED_PATTERN_da690bf0c88a9186dd98cff7b602ef0f */}
  Crea experiencias de pago alojadas y seguras con plena personalización y características avanzadas
</Card>
</CardGroup>