...
| `INCORRECT_NUMBER` | Sí | El número de tarjeta se ingresó incorrectamente |
...
| `INVALID_EXPIRY_YEAR` | Sí | El año de caducidad de la tarjeta es inválido |
...
| `PICKUP_CARD` | Sí | La tarjeta ha sido reportada como robada y debe ser retirada |
...
| `REENTER_TRANSACTION` | Sí | La transacción debe ser reingresada |
