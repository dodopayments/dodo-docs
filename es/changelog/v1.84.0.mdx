...
<Frame>
<img src="/images/product-analytics/overview.png" alt="Analítica a Nivel de Producto" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
| **Se aplica tarifa de disputa** | Se cobra una tarifa de disputa en transacciones resueltas por RDR -- esto cubre el costo de disputar con Visa en su nombre |
| **Cero carga operativa** | No se requiere recopilación de evidencia ni hay plazos de respuesta |
| **Mejor experiencia del cliente** | Los titulares de tarjetas reciben reembolsos instantáneos |
| **Protección de cuenta** | Evite el Programa de Monitoreo de Disputas de Visa (VDMP) |
...
<Frame>
<img src="/images/customer-portal/new-portal.png" alt="Rediseño de la IU del Portal del Cliente" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
