...
<Frame>
<img src="/images/CBB/Checkout.png" alt="Compra mostrando créditos incluidos con la compra del producto" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
Los créditos se adjuntan como **derechos** en el flujo de creación de productos. Puedes adjuntar hasta **5 créditos por producto**, y funcionan con los tres tipos de precio: suscripciones, pagos únicos y facturación basada en uso.
...
<Frame>
<img src="/images/design/general-overview.jpg" alt="Página de configuración de diseño con vista previa en vivo de la compra, portal del cliente y tienda" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/design/general-color-settings.jpg" alt="Configuración avanzada expandida mostrando configuración completa de colores para modos claro y oscuro" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
Más información: [List Payments API](/api-reference/payments/get-payments)
