...
|---------|-------|-------|
| Checkout Sessions | `customer_business_name`, `feature_flags.allow_customer_editing_business_name` | Máx. 250 caracteres; el indicador tiene como valor predeterminado `false` |
