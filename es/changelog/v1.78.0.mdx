...
### 1. **Preferencias de comunicación**
   ...
   <Frame>
     <img src="/images/communication-preferences/overview.png" alt="Descripción general de las Preferencias de Comunicación mostrando la configuración de notificaciones" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
...
### 2. **Campos personalizados en sesiones de pago**
   ...
   **Beneficios**
   ...
   <Info>
   Los valores de los campos personalizados se devuelven en el array `custom_field_responses` dentro de las respuestas de pagos y suscripciones.
   </Info>

   Más información: [Campos personalizados de Checkout Session](/developer-resources/checkout-session#15-collecting-custom-fields)
