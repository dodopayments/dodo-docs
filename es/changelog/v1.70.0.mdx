...
keywords:
  ...
  - v1.70.0 (24 de diciembre de 2025)
---
...
1. **Pago en Línea - Experiencias de Pago Totalmente Integradas (BETA)**  
   ...
   <Frame>
   <img src="/images/inline-checkout/cover.png" alt="Imagen de portada de pago inline" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
   ...
   <Tip>
   Usa el checkout inline cuando quieras máximo control sobre el diseño del checkout. Usa [overlay checkout](/developer-resources/overlay-checkout) para una integración más rápida con cambios mínimos en las páginas existentes.
   </Tip>
...
3. **Cambios en el Plan de Suscripción en el Panel con Actualizaciones de la Próxima Fecha de Facturación**  
    ...
    <Frame>
    <img src="/images/changelog/subscription-plan-changes.png" alt="Cambios en el plan de suscripción en el panel de control" style={{ maxHeight: '500px', width: 'auto' }} />
    </Frame>
...
4. **Enlaces Cortos para URLs de Pago**  
   ...
   <Frame>
   <img src="/images/changelog/short-links.png" alt="Característica de enlaces cortos para URLs de pago" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
   ...
   <Info>
   Los enlaces cortos se gestionan en tu panel y se pueden ver mediante la [List Short Links API](/api-reference/products/get-products-short-links).
   </Info>
