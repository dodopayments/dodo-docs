...
### 7. **Capacidades de Filtrado Mejoradas para Clientes, Descuentos y Claves de Licencia**  
   ...
   **Filtros de API de Clientes**
   ...
   | `created_at_gte` | Filtrar clientes creados en o después de esta marca de tiempo |
   ...
   **Filtros de API de Descuentos**
   ...
   | `active` | Filtrar por estado activo (true = no expirado, false = expirado) |
   | `product_id` | Filtrar por restricción de producto (solo descuentos que aplican a este producto) |
   ...
   **Filtros de API de Claves de Licencia**
   ...
   | `status` | Filtrar por estado de clave de licencia (`active`, `expired`, `disabled`) |
   | `product_id` | Filtrar por ID de producto |
   | `created_at_gte` | Filtrar claves de licencia creadas en o después de esta marca de tiempo |
