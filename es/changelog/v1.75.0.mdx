...
### 1. **Colecciones de Productos**  
   ...
   <Frame>
     <img src="/images/product-collection/checkout-page.png" alt="Página de pago de la colección de productos que muestra múltiples opciones de plan" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
