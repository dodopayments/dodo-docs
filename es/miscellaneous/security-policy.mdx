...
En Dodo Payments, tomamos la seguridad en serio y apreciamos la divulgación responsable de vulnerabilidades que nos ayudan a mejorar nuestra plataforma. Si descubres una vulnerabilidad de seguridad, te animamos a que nos la reportes siguiendo las directrices a continuación.
...
4. **Seguimiento**: Podemos comunicarnos para obtener información adicional o aclaraciones según sea necesario.
