...
Usa [Dodo Payments CLI](/developer-resources/sdks/cli#webhook-testing) para probar webhooks localmente:
- `dodo wh listen` reenvía webhooks de prueba en tiempo real a tu servidor local
- `dodo wh trigger` envía cargas útiles simuladas para todos los tipos de eventos de webhook compatibles
</Accordion>
