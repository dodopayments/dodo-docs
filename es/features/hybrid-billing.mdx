...
2. Confirma que `customer_id` coincida con el cliente de suscripción
3. Verifica que `event_name` coincida con la configuración del medidor
4. Asegúrate de que los eventos tengan las marcas de tiempo correctas (no fechadas en el futuro)
</Accordion>
...
3. Considera usar `difference_immediately` para una facturación de actualización más sencilla
</Accordion>
