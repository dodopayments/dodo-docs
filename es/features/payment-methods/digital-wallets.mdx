...
- Su dominio de producción (por ejemplo, `https://yourdomain.com`)
...
<Warning>
Apple Pay requiere HTTPS. No aparecerá en `localhost` sin la configuración adecuada de SSL.
</Warning>
...
<Accordion title="Siempre incluir alternativas para tarjetas">
No todos los clientes tienen billeteras digitales. Siempre incluya `credit` e `debit` en sus métodos permitidos.
</Accordion>
