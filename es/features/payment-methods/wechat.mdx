...
Crea una sesión de pago con `we_chat_pay` en los métodos de pago permitidos.
</Step>
...
**Verificar:**
1. ¿`we_chat_pay` incluido en `allowed_payment_method_types`?
2. ¿Moneda de facturación establecida en USD o CNY?
3. ¿El monto de la transacción cumple con el mínimo?
