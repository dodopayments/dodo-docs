...
Dodo se encarga de todo el cumplimiento.
</Card>
...
| Región | Marca | Número de tarjeta | Caducidad | CVV |
| :----- | :---- | :---------------- | :------- | :-- |
...
<Warning>
Las tarjetas de prueba solo funcionan en modo de prueba. Nunca las uses en transacciones de producción.
</Warning>
...
No restrinjas los tipos de tarjeta a menos que sea necesario. Los clientes esperan que su tarjeta preferida funcione.
</Accordion>

{/* LOCKED_PATTERN_36ea69811843ab63e30c9adfe5480db2 */}
Muestra los logotipos de Visa, Mastercard y Amex en tu pago para generar confianza.
</Accordion>

{/* LOCKED_PATTERN_a2460e683926e842cbf9f35f34fc22e0 */}
Muestra mensajes de error claros. No expongas códigos de error sin procesar a los clientes.
</Accordion>

{/* LOCKED_PATTERN_dcad0cc52f8890b7449a1928b8900110 */}
Los métodos de pago guardados aumentan significativamente la conversión en compras recurrentes.
</Accordion>
</AccordionGroup>
...
**Causas:** Fondos insuficientes, tarjeta expirada, CVV incorrecto, protección antifraude del banco.

**Solución:** Pide al cliente que verifique los datos o intente con otra tarjeta.
</Accordion>

{/* LOCKED_PATTERN_fc0de6d86e0d3a883592cd5021135d00 */}
**Causas:** El cliente abandonó, el sistema del banco no está disponible, tiempo de espera agotado.

**Solución:** Reintenta o pide al cliente que contacte con su banco.
</Accordion>

{/* LOCKED_PATTERN_4bc73f56ca60c57879a7e4dc2104aed2 */}
**Causas:** Tarjeta regional no compatible, restricciones en prepago.
