...
<Tip>
Incluye tanto `credit` como `debit` a menos que tengas una razón específica para excluir una. Muchas clientes prefieren las tarjetas de débito y a menudo tienen tarifas más bajas.
</Tip>
...
| Región | Marca | Número de Tarjeta | Fecha de Expiración | CVV |
| :----- | :---- | :---------- | :----- | :-- |
