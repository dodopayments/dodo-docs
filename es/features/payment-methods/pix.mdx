...
Cuando se te pida un CPF de Pix, ingresa `1234567890`. Se generará un código QR de prueba: escanéalo con la cámara normal de tu teléfono (no se necesita aplicación Pix). Serás redirigido a una página de prueba de Stripe donde podrás simular la transacción como éxito o fallo.
</Step>
</Steps>
