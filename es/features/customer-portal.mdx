...
<Card title="Historial de Facturación" icon="file-invoice">
    Ver todas las transacciones y detalles de facturas. Descargar PDFs de cada factura de tu cuenta.
</Card>
...
2. **Agregar un nuevo método de pago**: Ingresar los nuevos detalles de la tarjeta de forma segura.
