...
1. **Selecciona “Comprar ahora”**: Una vez listo, el cliente hace clic en “Comprar” del producto deseado, selecciona la cantidad y pulsa “Comprar ahora”
2. **Redirección al pago de Dodo Payments**:
    - El cliente será llevado a la pasarela de pago de Dodo Payments
    - El cliente completa el flujo de pago seguro en Dodo Payments.
3. **Confirmación**:
    - Después del pago exitoso, Dodo Payments muestra una confirmación.
    - Opcionalmente, el cliente puede ser redirigido a una página de “Gracias” en tu escaparate según la URL de redirección ingresada.

{/* LOCKED_PATTERN_35f236e4662089cf021f43e28086b7b8 */}
  Personaliza la apariencia de tu escaparate con temas preconstruidos, tipografías, colores y vista previa en vivo desde la página de Diseño.
