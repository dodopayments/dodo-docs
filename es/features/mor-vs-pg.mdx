...
<Note>
Imagina vender una suscripción digital a un usuario en Francia. Con Dodo Payments, recaudamos el pago, presentamos el IVA a las autoridades francesas y te enviamos los ingresos netos. Sin dolores de cabeza fiscales. Sin abogados. Solo crecimiento.
</Note>
...
<Tip>
"Piensa en un payment gateway como un túnel. Ahora imagina el Merchant of Record como un túnel, tren, conductor y personal de boletos todo en uno."
</Tip>
...
Hay casos en los que usar solo un payment gateway podría tener sentido:
...
<Note>
Para muchas startups, usar un gateway puede ser suficiente inicialmente, pero a medida que la complejidad crece, cambiar a un MoR puede ahorrar tiempo, reducir riesgos y acelerar el crecimiento internacional.
</Note>
...
- Prevención de fraudes y cumplimiento PCI integrados
...
<CardGroup cols={2}>
<Card title="Soporte de Moneda Adaptativa" icon="money-bill-wave" href="/features/adaptive-currency">
Descubre cómo Dodo presenta automáticamente los precios en las monedas locales de tus clientes
</Card>

<Card title="Métodos de Pago Soportados" icon="credit-card" href="/features/payment-methods">
...
<CardGroup cols={2}>
<Card title="Regístrate Gratis" icon="user-plus" href="https://app.dodopayments.com/signup">
Crea tu cuenta de Dodo Payments y comienza a vender globalmente hoy
</Card>

<Card title="Habla con Ventas" icon="envelope" href="mailto:founders@dodopayments.com">
Obtén orientación personalizada de nuestro equipo
</Card>
</CardGroup>

<Tip>
Deja que Dodo maneje lo difícil, para que puedas concentrarte en construir un gran producto.
</Tip>