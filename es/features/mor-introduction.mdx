...
Sí. Con [Bring Your Own Processor (BYOP)](/features/byop) puedes conectar tu propia cuenta de Stripe o Adyen y enrutar los pagos de países seleccionados a través de ella, mientras Dodo Payments sigue impulsando productos, suscripciones, facturación y análisis. Los países que no enrutes explícitamente seguirán procesándose a través de Dodo Payments como tu Merchant of Record de servicio completo, lo que nos permite asumir la responsabilidad fiscal y por fraude en esas rutas.
</Accordion>
