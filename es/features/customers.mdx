...
<Frame>
<img src="/images/customer/customers-list.png" alt="Página de lista de clientes mostrando todos los clientes con sus detalles" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/customer/customer-details.png" alt="Página de detalles del cliente mostrando la información del cliente y el historial de transacciones" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
- Saldo actual de la wallet en cada moneda (USD, EUR, GBP)
- Motivos y marcas de tiempo de las transacciones
- Historial detallado de transacciones para la conciliación
Consulta el libro mayor de crédito de la wallet del cliente, que muestra:
...
Las wallets de clientes son cuentas de saldo monetario prepagado para tus clientes. Cada cliente recibe automáticamente una wallet que puede contener fondos reales en varias monedas (USD, EUR y GBP), que pueden aplicarse a las facturas de suscripción, utilizarse para saldos de reembolsos o financiarse con bonos promocionales.

### Características clave

- **Compatibilidad con varias monedas**: realiza un seguimiento por separado de los saldos monetarios en USD, EUR y GBP.
- **Saldos prepagados**: los clientes pueden mantener fondos que se aplican a futuras facturas y pagos de suscripciones.
- **Historial de transacciones**: consulta el libro mayor completo de todas las adiciones y deducciones de fondos.
- **Diseño centrado en la API**: añade, deduce y consulta los saldos de las wallets mediante programación.
- **Facturación basada en créditos**: permite a los clientes comprar créditos por adelantado y gastarlos en tus servicios.
- **Historial de transacciones**: consulta el libro mayor completo de todos los créditos y débitos.
- **Diseño centrado en la API**: añade, elimina y consulta los saldos de las wallets mediante programación.
