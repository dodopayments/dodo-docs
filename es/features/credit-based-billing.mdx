...
| Plan | Precio | Créditos/mes | Excesos |
|------|--------|---------------|---------|
| Starter | $29/mes | 10,000 tokens | $0.003/token |
| Pro | $99/mes | 100,000 tokens | $0.002/token |
| Enterprise | $499/mes | 1,000,000 tokens | $0.001/token |

**Configuración:**
- Tipo de crédito: Unidad personalizada ("AI Tokens")
- Precisión: 0 (tokens enteros)
- Acumulación: 25% máximo, plazo de 1 mes
- Excesos: Activados, factura el exceso durante la facturación
...
| Plan | Precio | Créditos/mes | Excesos |
|------|--------|---------------|---------|
| Free | $0/mes | 1,000 llamadas | Bloqueado |
| Developer | $19/mes | 50,000 llamadas | $0.001/llamada |
| Business | $99/mes | 500,000 llamadas | $0.0005/llamada |

**Configuración:**
- Tipo de crédito: Unidad personalizada ("API Calls")
- Precisión: 0 (llamadas enteras)
- Acumulación: Desactivada
- Excesos: Los planes Developer+ permiten exceso (se perdona al reiniciar), el plan Free desactiva el exceso
...
- **Establece expectativas claras**: Muestra las asignaciones de créditos, los saldos restantes y los precios por exceso de forma destacada en tus páginas de producto y en el portal del cliente.
- **Usa unidades significativas**: Nombra los créditos según lo que representan (p. ej., "API Calls", "AI Tokens") en lugar de términos genéricos. Esto ayuda a los clientes a comprender el valor.
- **Configura la expiración con cuidado**: Las ventanas de expiración cortas (7 días) generan urgencia, pero pueden frustrar a los clientes. Las ventanas más largas (30–90 días) son más amigables para la mayoría de productos SaaS.
- **Monitorea saldos bajos**: Establece umbrales de saldo bajo para avisar a los clientes antes de que se queden sin crédito, reduciendo así cargos inesperados por exceso.
- **Prueba en modo prueba**: Crea créditos, asígnalos a productos de prueba y simula el ciclo completo de compra → uso → deducción → expiración antes de lanzar en producción.

<Info>
La facturación basada en créditos funciona perfectamente con todas las demás funciones de Dodo Payments: suscripciones con pruebas, cambios de plan con prorrateo y el portal del cliente. Comienza con una configuración básica y amplíala conforme evolucione tu modelo de precios.
</Info>
