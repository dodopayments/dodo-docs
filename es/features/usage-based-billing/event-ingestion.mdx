...
Marca de tiempo ISO 8601 (UTC). Si se omite, se establece de forma predeterminada en la hora actual del servidor. Inclúyala para una facturación precisa con eventos retrasados o por lotes. Se rechazan las marcas de tiempo con más de 1 hora de antigüedad o con más de 5 minutos de adelanto.
</ParamField>
