...
Tipo de evento que coincide con el nombre del evento de tu medidor (sensible a mayúsculas y minúsculas). Ejemplos: `api.call`, `image.generated`
</ParamField>
</Accordion>
...
Propiedades adicionales para la agregación y filtrado:
...
<AccordionGroup>
<Accordion title="Usa IDs de evento únicos">
...
Verifica que la clave API sea correcta y usa el formato: `Bearer YOUR_API_KEY`
</Accordion>
...
<Accordion title="Metadata no se agrega">
- Las claves de metadata deben coincidir exactamente con el "Over Property" del medidor
