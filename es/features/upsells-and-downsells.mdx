...
| Beneficio | Impacto |
|---------|--------|
| **Compras con un solo clic** | Omite por completo el formulario de pago para clientes recurrentes |
| **Mayor conversión** | Reduce la fricción en el momento de la decisión |
| **Procesamiento instantáneo** | Los cargos se procesan de inmediato con `confirm: true` |
| **Experiencia fluida** | Los clientes permanecen en tu aplicación durante todo el flujo |
...
|------|---------------|-------------|
| `difference_immediately` | Cobra la diferencia de precio al instante ($30→$80 = $50) | Mejoras sencillas |
| `prorated_immediately` | Cobra según el tiempo restante en el ciclo de facturación | Facturación justa basada en el tiempo |
| `full_immediately` | Cobra el precio completo del nuevo plan, ignorando el tiempo restante | El ciclo de facturación se reinicia |
...
<Info>
Los créditos de las degradaciones que usan `difference_immediately` están limitados a la suscripción y se aplican automáticamente a renovaciones futuras. Son distintos de [Customer Credits](/features/customer-credit).
</Info>
...
|-------|---------|--------|
| `payment.succeeded` | Pago de upsell/cross-sell completado | Entregar producto, actualizar acceso |
| `payment.failed` | Fracaso del cargo con un solo clic | Mostrar error, ofrecer reintento o alternativa |
| `subscription.plan_changed` | Actualización/degradación completada | Actualizar funciones, enviar confirmación |
...
{/* LOCKED_PATTERN_6b10960b04bb42ef84a26a555ea37ef0 */}
  Guía detallada sobre cambios de plan, modos de prorrateo y manejo de fallos.
</Card>

{/* LOCKED_PATTERN_da690bf0c88a9186dd98cff7b602ef0f */}
  Referencia completa para crear sesiones de checkout con todas las opciones.
</Card>

{/* LOCKED_PATTERN_21ee79536ea260bb1b780561228e964b */}
  Referencia de la API para listar los métodos de pago del cliente.
</Card>

{/* LOCKED_PATTERN_d444a97f37298c956d29f6d98a16ee0d */}
  Mejora las suscripciones con complementos flexibles para aumentar los ingresos.
</Card>
</CardGroup>
