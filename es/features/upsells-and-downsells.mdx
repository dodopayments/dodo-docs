...
|------|----------|----------|
| `difference_immediately` | Cobra la diferencia de precio al instante ($30→$80 = $50) | Actualizaciones sencillas |
| `prorated_immediately` | Cobra según el tiempo restante del ciclo de facturación | Facturación justa basada en el tiempo |
| `full_immediately` | Cobra el precio completo del nuevo plan e ignora el tiempo restante | Reinicio del ciclo de facturación |
| `do_not_bill` | Aplica el cambio de plan sin realizar un cargo inmediato; el nuevo plan se factura en la siguiente renovación y se conserva la fecha de facturación original | Actualizaciones de cortesía y migraciones gratuitas |
...
<Info>
Los créditos de degradaciones que usan `difference_immediately` están vinculados a la suscripción y se aplican automáticamente a renovaciones futuras. Son distintos de los derechos de [Facturación basada en créditos](/features/credit-based-billing).
</Info>
