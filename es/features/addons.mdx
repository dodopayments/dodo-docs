...
- **Moneda**: Establece el precio base en cualquier moneda que Dodo Payments pueda cobrar. El selector de monedas con búsqueda fija **USD, GBP, EUR e INR** en la parte superior; a los clientes fuera de tu moneda base se les factura mediante [Adaptive Currency](/features/adaptive-currency)
...
- **Configuración de impuestos**: Configura las categorías de impuestos adecuadas
