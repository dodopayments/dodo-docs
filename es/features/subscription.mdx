...
## Subscriptions with RBI-Compliant Mandates
  ...
  - **Cargos por debajo del piso del mandato (por defecto ₹15,000):** Creamos un mandato a demanda por el monto del piso. El monto de la suscripción se cobra periódicamente según la frecuencia de tu suscripción, hasta el límite del mandato.
  - **Cargos en o por encima del piso del mandato:** Creamos un mandato de suscripción (o un mandato a demanda) por el monto exacto de la suscripción.

  El piso del mandato es configurable por comerciante o por solicitud a través de `mandate_min_amount_inr_paise` (INR paise). El monto registrado con el banco es `max(mandate_floor, billing_amount)` — por lo que el piso efectivamente se convierte en el techo de autorización visible para el cliente siempre que la facturación sea menor.

Para obtener información detallada sobre los mandatos conformes al RBI y el piso del mandato configurable para métodos de pago en la India, consulta la página de <a href="/features/payment-methods/india#configurable-mandate-floor">Métodos de Pago en la India</a>.
  ...
  **Importante:** Al actualizar o degradar suscripciones, considera cuidadosamente los límites del mandato:
  ...
  - Si una actualización/degradación resulta en un monto de cargo que excede los Rs 15,000 y supera el límite de pago a demanda existente, el cargo de la transacción puede fallar.
  ...
  Para los cargos de suscripción de Rs 15,000 o más:
  ...
  **Cronograma de Procesamiento:** Los cargos recurrentes en tarjetas indias y suscripciones UPI siguen un patrón de procesamiento único:
  ...
  - Los cargos se **inician** en la fecha programada de acuerdo a la frecuencia de tu suscripción.
  ...
  - Si un cliente cancela el mandato durante este período, la suscripción permanecerá **activa** (este es un caso especial específico de las suscripciones AutoPay en tarjetas indias y UPI).
  - Sin embargo, la deducción real puede fallar, y en ese caso, pondremos la suscripción **en espera**.

  **Manejo de Casos Limítrofes:** Si proporcionas beneficios, créditos o uso de suscripción a los clientes inmediatamente al inicio del cargo, necesitas manejar esta ventana de 48 horas adecuadamente en tu aplicación. Considera:
  ...
  <Tip>
  Monitorea los webhooks de suscripción para rastrear cambios de estado de pago y manejar casos limítrofes donde los mandatos son cancelados durante la ventana de 48 horas.
  </Tip>

## Mejores Prácticas

- **Empieza con niveles claros**: 2-3 planes con diferencias obvias
- **Comunica el precio**: Muestra totales, prorrateo y la próxima renovación
- **Usa pruebas con cuidado**: Convierte con integración, no solo con tiempo
...
<Info>
Las suscripciones son una base flexible para ingresos recurrentes. Empieza simple, prueba a fondo e itera basado en métricas de adopción, cancelación y expansión.
</Info>