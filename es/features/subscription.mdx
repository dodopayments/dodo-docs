...
<Info>
Los cambios de plan activan cargos inmediatos. Los cargos fallidos pueden mover la suscripción al estado `on_hold`. Haz seguimiento de los cambios mediante eventos de webhook `subscription.plan_changed`.
</Info>
