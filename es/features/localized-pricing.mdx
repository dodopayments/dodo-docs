...
| :--- | :--- | :--- |
| **Precio Localizado** | Un precio fijo que estableces por moneda o país | Exactamente el monto que estableces |
| [**Moneda Adaptativa**](/features/adaptive-currency) | Convierte automáticamente tu precio base a tasas de cambio en vivo | Precio base convertido a la tasa de cambio actual |
| [**Códigos de Descuento**](/features/discount-codes) | Una reducción porcentual o fija del precio base | Precio base menos el descuento |
