...
3. **Elige Tu Respuesta**
   ...
   <Frame>
       <img src="/images/disputes/1.png" alt="Creación de Disputa" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
...
5. **Si Contrarrestas**
   ...
   <Frame>
       <img src="/images/disputes/2.png" alt="Creación de Disputa" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
   
   <Frame>
       <img src="/images/disputes/3.png" alt="Creación de Disputa" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>

<Info>
Tienes **10 días** para responder a una disputa después de que se cree. La cuenta regresiva que se muestra sobre la disputa en tu panel refleja el mismo plazo.
</Info>
...
<Frame caption="Visa RDR configuration in the Dodo Payments dashboard">
    <img src="/images/disputes/rdr.png" alt="Configuraciones de Visa RDR mostrando el toggle habilitado y configuración del umbral" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Step title="Open the Disputes Settings">
    Navega a **Configuraciones → Empresa** en tu panel de Dodo Payments y localiza la sección de **Visa Rapid Dispute Resolution (RDR)**.
</Step>
