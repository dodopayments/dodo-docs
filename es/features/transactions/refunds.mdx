---
title: Refunds
description: The Refunds section allows merchants to manage and initiate refunds
  for transactions. Merchants can initiate full or partial refunds directly from
  the transaction details view, with built-in rules ensuring compliance and
...
<Frame>
  <img src="/images/transactions/refunds/initiate-refund.png" alt="Botón de iniciar reembolso en la página de detalles de pago" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/images/transactions/refunds/refunds-page.png" alt="Página de reembolsos mostrando una lista de transacciones de reembolso" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
...
<Frame>
  <img src="/images/transactions/refunds/refund-receipt-template.png" width="50%" alt="Plantilla de recibo de reembolso mostrando los detalles del reembolso" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
