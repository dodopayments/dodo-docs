...
<Info>
En Sesiones de Pago, pasa `discount_code` para aplicar un código previamente, y establece `feature_flags.allow_discount_code` para mostrar el campo de entrada.
</Info>
