...
Verifica si un descuento es válido por su ID.
</Card>

<Card title="Obtener Descuento por Código" icon="tag" href="/api-reference/discounts/get-discount-by-code">
Busca y valida un descuento usando su nombre de código (por ejemplo, "SAVE20").
</Card>
...
<Tip>
Usa límites de ciclo para precios introductorios en suscripciones (por ejemplo, "50% de descuento durante 3 meses").
</Tip>
...
<Accordion title="Obtener descuento por código">
Busca un descuento usando su código legible por humanos (por ejemplo, "SAVE20") en lugar del ID interno.

<Card title="Referencia de API" icon="code" href="/api-reference/discounts/get-discount-by-code">
Recupera el descuento por nombre de código.
</Card>
</Accordion>

<Accordion title="Actualizar descuentos">
Modifica la configuración del descuento, como monto, expiración o restricciones.
...
<Info>
Los códigos de descuento son palancas poderosas para la adquisición y retención. Comienza con ofertas simples y bien nombradas, valida a fondo y itera según el rendimiento.
</Info>