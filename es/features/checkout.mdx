...
<Frame>
  <img src="/images/changelog/minimal-address.png" alt="Modo de dirección mínima que muestra solo los campos de país y código postal en el pago" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/images/checkout/theme-example.png" alt="Página de pago personalizada con tema" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Info>
Esta sección cubre la configuración del tema **del lado del servidor** usando `customization.theme_config`. Si estás utilizando el **SDK de Checkout** (superposición o pago en línea), consulta las secciones de personalización de temas en [Superposición de Checkout](/developer-resources/overlay-checkout#theme-customization) o [Pago en Línea](/developer-resources/inline-checkout#theme-customization) que usan propiedades en camelCase (por ejemplo, `bgPrimary` en lugar de `bg_primary`).
</Info>
