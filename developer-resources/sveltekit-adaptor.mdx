...
description: "Learn how to integrate Dodo Payments with your SvelteKit App Router project using our SvelteKit Adaptor. Covers checkout, customer portal, webhooks, and secure environment setup."
icon: "code-merge"
keywords: ["Dodo Payments", "SvelteKit", "SvelteKit integration", "Svelte", "payment integration", "sveltekit adaptor"]
---
...
<Warning>
Dynamic Checkout proxies the deprecated `POST /payments` and `POST /subscriptions` endpoints. It keeps working for existing integrations, but new integrations should use **Checkout Sessions** below.
</Warning>
