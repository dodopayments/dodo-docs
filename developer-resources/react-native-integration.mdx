...
<Step title="Install the SDK">
    ...
    <Tabs>
    <Tab title="npm">
        ```bash npm-install.sh icon="terminal" expandable
        npm install dodopayments-react-native-sdk
        ```
    </Tab>
    <Tab title="yarn">
        ```bash yarn-install.sh icon="terminal" expandable
...
<Step title="Platform-specific setup">
    ...
    <Tab title="iOS">
        ...
        ```bash ios-setup.sh icon="terminal" expandable
        cd ios && pod install && npm run ios
        ```
    </Tab>
    <Tab title="Android">
        Run the following command:
        ```bash android-setup.sh icon="terminal" expandable
        npm run android
        ```
    </Tab>
    </Tabs>
...
<Step title="Setup Payment Provider">
    ...
    ```tsx App.tsx icon="react" expandable
...
<Step title="Create payment utility function">
    ...
    ```tsx utils/fetchPaymentParams.ts icon="typescript" expandable
...
<Step title="Implement the payment screen">
    ...
    ```tsx PaymentScreen.tsx icon="react" expandable
    import React from 'react';
...
```tsx appearance-config.tsx icon="react" expandable
const appearance = {
  colors: {
    light: {
      primary: '#F8F8F2',
...
```tsx shape-config.tsx icon="react" expandable
const appearance = {
  shapes: {
...
```tsx button-config.tsx icon="react" expandable
const appearance = {
  primaryButton: {
    colors: {
      background: '#000000',
...
```tsx session-params.tsx icon="react" expandable
const params: sessionParams = {
  ...paymentSheetParams,
  configuration: {
    appearance: {
...
<Tabs>
  <Tab title="Payment Result Handler">
    ...
    ```tsx payment-result-handler.tsx icon="react" expandable
  ...
  <Tab title="Network & Validation Errors">
    ...
    ```tsx payment-retry.tsx icon="react" expandable
