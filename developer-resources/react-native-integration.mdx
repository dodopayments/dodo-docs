...
Before integrating the React Native SDK, ensure you have:

<Note>
**Required:**
- React Native development environment (0.60+)
- Dodo Payments merchant account with API access
- Publishable key from your dashboard (separate for test/live modes)
