...
<Step title="Rotate Secret (Optional)">
    If needed, you can rotate your webhook secret for enhanced security. Click **Rotate secret** on the same card.
...
Open the endpoint from **Developer → Webhooks**, where the **Overview** tab shows **Delivery stats (last 24h)** for its recent attempts.
