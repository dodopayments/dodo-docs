...
<Info>
**Event catalog**, **Endpoints**, **Logs**, **Activity**, and **Settings** are tabs of the webhooks portal itself. **Overview**, **Testing**, and **Advanced** appear only once you open an individual endpoint.
</Info>
...
<Step title="Navigate to Activity Tab">
    Go to **Developer → Webhooks** and open the **Activity** tab.
</Step>
