...
<Expandable title="Data object properties">
  ...
  Type of resource. One of: `Payment`, `Subscription`, `Refund`, `Dispute`, `LicenseKey`, `CreditLedgerEntry`, `CreditBalanceLow`, `AbandonedCheckout`, `DunningAttempt`, or `EntitlementGrant`.
  </ResponseField>
...
This interactive tool lets you select from all supported event types and sends realistic mock payloads to your endpoint. It loops so you can test multiple events in one session.
