...
icon: 'triangle'
keywords: ["Dodo Payments", "Vercel Functions", "serverless", "webhook handler", "webhook deployment"]
---
...
<CodeGroup>
  ...
  CREATE TABLE IF NOT EXISTS subscriptions (
    ...
    status TEXT NOT NULL CHECK (status IN ('pending', 'active', 'on_hold', 'past_due', 'paused', 'cancelled', 'failed', 'expired')),
