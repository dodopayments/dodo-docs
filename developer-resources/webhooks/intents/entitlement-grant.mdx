...
| `SubscriptionPaused` | The subscription was paused (`subscription.paused`). Recoverable: resuming produces a re-grant. Branch on the `subscription.paused` webhook rather than matching this string. |
