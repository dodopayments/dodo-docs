...
description: The payload sent to your webhook endpoint when credit-based billing events occur — virtual credits (API calls, tokens, compute hours) granted, consumed, expired, rolled over, or balance alerts. These webhooks are not related to Customer Wallets (monetary balances).
icon: "coins"
keywords: ["Dodo Payments", "credit webhook", "credit events", "webhook integration", "credit-based billing"]
---
...
The brand this credit entitlement belongs to.
</ParamField>
