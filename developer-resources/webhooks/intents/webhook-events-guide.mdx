...
| **Subscription Past Due** | `subscription.past_due` | Triggered when a failed renewal opens a [grace period](/features/subscription#grace-period). Access continues until the window ends. |
