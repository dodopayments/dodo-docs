...
| **Event Name**           | **Event Type**           | **Description**                                                                 |
|--------------------------|--------------------------|---------------------------------------------------------------------------------|
| **Payout Not Initiated** | `payout.not_initiated`   | A payout has been created but not yet initiated.                                |
| **Payout On Hold**       | `payout.on_hold`         | A payout has been placed on hold.                                               |
| **Payout In Progress**   | `payout.in_progress`     | A payout is being processed.                                                    |
| **Payout Failed**        | `payout.failed`          | A payout attempt failed.                                                        |
| **Payout Success**       | `payout.success`         | A payout completed successfully.                                                |
