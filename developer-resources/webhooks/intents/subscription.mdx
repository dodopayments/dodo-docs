...
| `subscription.past_due` | A renewal failed and the subscription entered its [grace period](/features/subscription#grace-period). Access continues until the window ends |
| `subscription.paused` | Subscription is paused |
| `subscription.unpaused` | Subscription is resumed after being paused |
