...
| `subscription.past_due` | A renewal payment failed and the grace period opened; the customer keeps access until the deadline. The payload carries `past_due_ends_at` |
