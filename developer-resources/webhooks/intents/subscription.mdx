...
| `subscription.cancellation_scheduled` | A cancellation has been scheduled for a future date (e.g., end of current billing period) |
| `subscription.trial_ending` | Fired ahead of trial expiry — useful for trial-ending reminders and conversion campaigns |
| `subscription.upcoming_renewal` | Fired ahead of a scheduled renewal — useful for renewal reminders or pre-billing checks |
