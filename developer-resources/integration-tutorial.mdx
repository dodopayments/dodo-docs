...
<CardGroup cols={2}>
  <Card title="⚡ Quick Setup" icon="bolt" href="#boilerplate-setup">
  ...
  <Card title="🔔 Webhooks" icon="bell" href="#webhook-integration">
...
<Steps>
  <Step title="Clone the Repository">
    ...
    ```bash clone-repo.sh icon="terminal" expandable
  ...
  <Step title="Install Dependencies">
    ...
    <Tabs>
      ...
      <Tab title="pnpm">
        ```bash pnpm-install.sh icon="terminal" expandable
        pnpm install
        ```
      </Tab>
    </Tabs>
  ...
  <Step title="Environment Configuration">
    ...
    ```bash copy-env.sh icon="terminal" expandable
    cp .env.example .env.local
    ```
    
    Edit `.env.local` with your actual API keys:
    
    ```env .env.local icon="gear" expandable
  ...
  <Step title="Start Development Server">
    ...
    ```bash start-dev.sh icon="terminal" expandable
    npm run dev
    ```
    ...
    **Verify Setup:**
    ...
    - ✅ Payment components render correctly
...
<Steps>
  <Step title="Webhook Endpoint Setup">
    ...
    ```typescript pages/api/webhooks/dodo.ts icon="typescript" expandable
  ...
  <Step title="Event Handlers Implementation">
    ...
    <Tabs>
      <Tab title="Payment Events">
        ```typescript lib/webhook-handlers/payment.ts icon="typescript" expandable
      ...
      <Tab title="Subscription Events">
        ```typescript lib/webhook-handlers/subscription.ts icon="typescript" expandable
  ...
  <Step title="Webhook Testing">
    ...
    <AccordionGroup>
      <Accordion title="Local Development Testing">
        ...
        ```bash ngrok-setup.sh icon="terminal" expandable
        # Install ngrok
        npm install -g ngrok
      ...
      <Accordion title="Manual Testing">
        ...
        ```bash test-webhook.sh icon="terminal" expandable
...
<Tabs>
  <Tab title="Payment Testing">
    ...
    **Test Environment Setup:**
    1. ✅ Use [test API keys](/miscellaneous/test-mode-vs-live-mode) in development
  ...
  <Tab title="Subscription Testing">
    ...
    **Subscription Lifecycle:**
    ...
    3. ✅ Recurring payments (use test mode acceleration)
  ...
  <Tab title="Webhook Testing">
    ...
    **Security Testing:**
    ```javascript webhook-security-test.js icon="js" expandable
...
<Steps>
  ...
  <Step title="Production Configuration">
    ...
    ```env .env.production icon="gear" expandable
...
<AccordionGroup>
  <Accordion title="Community & Support">
    - 💬 [Developer Community](https://community.dodopayments.com) - Get help from other developers
    - 📚 [Technical FAQs](/api-reference/technical-faqs) - Common questions and answers
    - 🎫 [Developer Support](/miscellaneous/help-support) - Direct support for integration issues
    - 📖 [API Documentation](/api-reference/payments/get-payments) - Complete API reference
  </Accordion>
  
  <Accordion title="Additional Resources">
    - 🎥 **Video Tutorials**: Linked throughout this guide for visual learners
    - 🔧 **SDK Documentation**: Platform-specific guides for different languages
    - 🧪 **Testing Tools**: Comprehensive testing strategies and test data
