...
icon: "bolt"
keywords: ["Dodo Payments", "developer guide", "on-demand billing", "variable charges", "mandate", "on-demand subscriptions"]
---
...
<AccordionGroup>
  <Accordion title="Charge request body parameters">
    ...
    <ParamField body="customer_balance_config" type="object">
      Specify how the customer's wallet balance is used to settle this charge.
    </ParamField>
...
Use your test API key to create the subscription, then open the returned `checkout_url` and complete the mandate.
</Step>
