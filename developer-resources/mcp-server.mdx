---
title: MCP Server
description: Enable AI assistants to interact with the Dodo Payments API through Code Mode—a high-performance architecture for seamless payment operations and subscription management.
icon: "/images/logos/mcp.svg"
keywords: ["Dodo Payments", "developer guide", "MCP server", "AI integration", "payment automation"]
---
