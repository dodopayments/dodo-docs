...
Go to **Settings → Payment Methods** and on the **Apple Pay** row, click **Manage domains**. In the Wallet domains panel, click **Register domain** and enter the domain where you embed inline checkout (e.g. `shop.example.com`).
</Step>

<Step title="Host the domain association file">
Download the association file from the Wallet domains screen and host it at:
```
...
<Step title="Verify">
Click **Verify domain**. Dodo Payments confirms the file is live and submits your domain to Apple. Once its status shows **Active**, Apple Pay is enabled for that domain.
</Step>
</Steps>
