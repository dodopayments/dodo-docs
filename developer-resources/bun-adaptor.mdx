...
```
    ...
    • Provide links to the Dodo Payments documentation for more details on webhook events and checkout session configuration

Always be helpful, concise, and provide copy-pasteable code examples.
