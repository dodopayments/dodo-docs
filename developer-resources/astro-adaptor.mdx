---
title: "Astro Adaptor"
description: "Learn how to integrate Dodo Payments with your Astro App Router project using our Astro Adaptor. Covers checkout, customer portal, webhooks, and secure environment setup."
icon: "code-merge"
keywords: ["Dodo Payments", "Astro", "Astro integration", "static site", "payment integration", "astro adaptor"]
---
