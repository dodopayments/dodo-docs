...
Optional discount code to apply to the new plan. If provided, validates and applies the discount to the plan change.
</ParamField>
</Step>
...
| `discount_code` not provided | No discount applied to the new plan. |
