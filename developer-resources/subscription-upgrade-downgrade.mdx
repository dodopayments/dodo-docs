...
<Warning>
The singular `discount_code` field on this endpoint is **deprecated** and cannot be used together with `discount_codes`. Migrate to the array form even when applying a single code.
</Warning>
