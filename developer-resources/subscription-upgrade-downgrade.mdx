...
Optional add-ons for the new plan. Leaving this empty removes any existing add-ons.
</ParamField>
...
When changing subscription plans, you can also modify add-ons:

```javascript
// Add add-ons to the new plan
...
<Info>
Add-ons are included in the proration calculation and will be charged according to the selected proration mode.
</Info>
