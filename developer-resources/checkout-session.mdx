...
<Info>
The singular `discount_code` field is **deprecated** and cannot be used together with `discount_codes`. Migrate to `discount_codes` even when applying a single code.
</Info>
</ParamField>
