...
| Pro | \$25/month | 100 | 5/day (up to 150/month total) | Credit rollovers, on-demand top-ups, usage-based Cloud + AI, custom domains |
...
- **Credit rollovers on paid plans**: Unused monthly credits carry over.
...
<Steps>
  <Step title="Create a Custom Unit Credit Entitlement">
    Define the message credit system in your Dodo Payments dashboard. This entitlement handles the monthly pool and rollovers.
...
<CardGroup cols={2}>
  <Card title="Credit-Based Billing" icon="coins" href="/features/credit-based-billing">
    Manage message credits with rollovers and shared team pools.
  </Card>
