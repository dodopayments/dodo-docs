...
<Card title="Python SDK" icon="python" href="/developer-resources/sdks/python">
  Pythonic interface with async/await support for Python 3.9+ applications
</Card>
...
- **Testing**: Full Test Mode support for development and testing
...
<Card title="CLI" icon="terminal" href="/developer-resources/sdks/cli">
  Interactive terminal client with a built-in AI assistant and webhook testing tools
</Card>

**Features:**
- Interactive TUI with a command palette, plus direct subcommands for scripting
- Built-in AI assistant powered by `dodopayments-mcp`, running locally
- API keys stored in your OS secret store, never in plaintext on disk
- Webhook tooling to forward live test webhooks locally or trigger mock payloads offline
