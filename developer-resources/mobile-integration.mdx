...
<ParamField body="closeButtonStyle" type="'default' | 'back'" default="default">
`default` shows the system "X" icon; `back` draws a back arrow instead.
</ParamField>

<ParamField body="closeButtonPosition" type="'start' | 'end'" default="start">
Which side of the toolbar the close button appears on.
</ParamField>

<ParamField body="shareButtonEnabled" type="boolean" default="true">
Shows the toolbar's share icon.
</ParamField>

<ParamField body="showTitleEnabled" type="boolean" default="false">
Shows the page title under the URL in the toolbar.
</ParamField>

<ParamField body="urlBarHidingEnabled" type="boolean" default="false">
Lets the toolbar auto-hide as the page scrolls.
</ParamField>

<ParamField body="bookmarksButtonEnabled" type="boolean" default="true">
Shows "Bookmark this page" in the overflow menu.
</ParamField>

<ParamField body="downloadsButtonEnabled" type="boolean" default="true">
Shows "Download page" in the overflow menu.
</ParamField>

<ParamField body="colorScheme" type="'system' | 'light' | 'dark'" default="system">
...
<ParamField body="dismissButtonStyle" type="'done' | 'close' | 'cancel'" default="done">
...
<ParamField body="barCollapsingEnabled" type="boolean" default="true">
