...
This comprehensive guide walks you through integrating one-time payments with Dodo Payments. Learn about payment links, API integration, webhook handling, and best practices for secure payment processing.

<CardGroup cols={2}>
  <Card title="Quick Start" icon="bolt" href="#api-integration">
    Get started with payment links in minutes
  </Card>
  <Card title="Static Links" icon="link" href="#1-static-payment-links">
    Simple, shareable payment URLs
  </Card>
  <Card title="Dynamic Links" icon="code" href="#2-dynamic-payment-links">
    API-generated payment links with custom data
  </Card>
  <Card title="Webhooks" icon="webhook" href="#implementing-webhooks">
...
Before integrating payment processing, ensure you have:
...
- A webhook endpoint for payment notifications

**Recommended:**
- Basic understanding of HTTP requests and JSON
- HTTPS-enabled domain for production webhooks
- Knowledge of your preferred programming language/framework
</Note>
...
<Step title="Construct your payment link">
  ...
  ```text payment-url.txt icon="link" expandable
...
<Step title="Control form fields (optional)">
  ...
  <CodeGroup>
  ```text query-params.txt icon="code" expandable
...
<Tabs>
  ...
  <Tab title="Node.js SDK">
    ```javascript payment-creation.js icon="js" expandable
...
main();
  ...
  <Tab title="Python SDK">
    ```python payment-creation.py icon="python" expandable
    import os
...
print(payment.payment_link)
  ...
  <Tab title="Go SDK">
    ```go payment-creation.go icon="go" expandable
    package main
...
<Tab title="Api Reference">
    ```javascript api-route.js icon="js" expandable
