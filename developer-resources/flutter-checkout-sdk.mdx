...
native cores as the standalone [iOS](/developer-resources/ios-checkout-sdk)
and [Android](/developer-resources/android-checkout-sdk) SDKs. All checkout
logic lives in those native cores; the Dart layer passes the call through a
typed [Pigeon](https://pub.dev/packages/pigeon) channel.
...
<Card title="React Native SDK" icon="react" href="/developer-resources/react-native-checkout-sdk">
  The same contract, for React Native apps.
</Card>
</CardGroup>
