...
Select **License Key** as the integration and configure how each issued key behaves: the **Activations Limit**, **Duration**, and customer-facing **Activation Instructions**.
...
<Step title="Set fulfillment to manual">
Set the fulfillment mode to **Manual** so each purchase creates a pending grant for you to fulfill, then save.
</Step>
</Steps>
</Tab>
