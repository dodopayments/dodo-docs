...
description: Get started quickly with our minimal Go boilerplate for integrating Dodo Payments into your Go backend applications
icon: "golang"
tag: "NEW"
keywords: ["Dodo Payments", "starter template", "quick start", "go boilerplate"]
---
