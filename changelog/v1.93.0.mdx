...
|----------------|----------|
| `prorated_immediately` | Bill or credit the prorated difference immediately, based on time left in the cycle |
| `difference_immediately` | Charge only the price difference between the new and current plan immediately |
| `full_immediately` | Charge the full price of the new plan immediately |
