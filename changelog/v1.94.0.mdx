...
description: "Abandoned Cart Recovery, Subscription Dunning, discount metadata, recovery webhooks, Pix payments for Brazil, and WeChat Pay for Chinese customers"
...
Pass `we_chat_pay` in `allowed_payment_method_types` when creating a checkout session:
