...
Navigate to **Business Settings → Design** in your Merchant Dashboard. The page has four tabs:
...
Learn more: [List Payments API](/api-reference/payments/list-payments)
