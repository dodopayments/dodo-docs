...
Credits are attached as **entitlements** in the product creation flow. You can attach up to **5 credits per product**, and credits work with all three pricing types: subscriptions, one-time payments, and usage-based billing.
