...
description: "Third-party analytics, checkout theme customization, prevent plan change on payment failure, and balance ledger API"
icon: "arrows-turn-right"
keywords: ["Dodo Payments", "changelog", "release notes", "product updates", "v1.81.0 (february 6, 2026)"]
---
...
Added `refund_status` field to `GET /payments/{payment_id}` response to quickly check if a payment has been refunded without querying the refunds endpoint separately.
