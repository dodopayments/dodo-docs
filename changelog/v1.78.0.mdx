...
### 2. **Custom Fields in Checkout Sessions**
   ...
   **Benefits**
   ...
   <Info>
   Custom field values are returned in the `custom_field_responses` array within payment and subscription responses.
   </Info>

   Learn more: [Checkout Session Custom Fields](/developer-resources/checkout-session#15-collecting-custom-fields)
