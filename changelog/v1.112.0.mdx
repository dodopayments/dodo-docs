...
description: "Discount codes gain Amount discounts, scheduling, customer eligibility rules, and per-currency options, alongside a rebuilt native webhooks experience with email alerting and recurring payments with SEPA Direct Debit and Cash App Pay — plus customer-friendly payment failure messages, payout webhooks, a self-service login email change, a setting that lets customers cancel their own subscriptions, and a currency filter on list payments."
...
### 3. **Recurring Payments with SEPA Direct Debit and Cash App Pay**

Subscriptions are no longer card-only in the markets these methods serve. SEPA Direct Debit can now back a recurring subscription on EUR checkouts, and Cash App Pay can back one on US checkouts billed in USD.

- **SEPA Direct Debit** — customers across the Eurozone can authorize recurring debits directly from their bank account, without a card.
- **Cash App Pay** — US customers can pay for subscriptions with their Cash App balance or linked funding source.

<Warning>
SEPA Direct Debit does not confirm instantly. A payment takes **6 business days** to confirm, so treat a subscription as active only once the payment reaches a succeeded state.
</Warning>

Learn more: [European Payment Methods](/features/payment-methods/europe) | [Digital Wallets](/features/payment-methods/digital-wallets)

### 4. **Clearer Payment Failure Messages**
...
### 5. **Let Customers Cancel Their Own Subscriptions**
...
### 7. **Change Your Login Email From the Dashboard**
...
### 8. **Analytics: New Widgets and Refinements**
...
### 10. **Clearer Payout Bank Account Forms**
