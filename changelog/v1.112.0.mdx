...
description: "Discount codes gain Amount discounts, scheduling, customer eligibility rules, and per-currency options, alongside a rebuilt native webhooks experience with email alerting — plus customer-friendly payment failure messages, payout webhooks, a self-service login email change, a setting that lets customers cancel their own subscriptions, and a currency filter on list payments."
...
### 8. **Recurring Payments with SEPA Direct Debit and Cash App Pay**
