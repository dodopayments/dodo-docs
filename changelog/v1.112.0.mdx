...
- **Activity and logs** — browse delivered messages, and open a **message detail** page to inspect the payload and every delivery attempt with its response code and duration. Each attempt can be replayed from there.
