...
The dashboard now loads noticeably faster. The startup loading overlay is shorter, the first screen after sign-in appears sooner, and large accounts feel more responsive across the payments list and dashboard search.
