...
description: "Discount codes gain Amount discounts, scheduling, customer eligibility rules, and per-currency options, alongside a rebuilt native webhooks experience with email alerting — plus recurring payments with SEPA Direct Debit and Cash App Pay, customer-friendly payment failure messages, payout webhooks, a self-service login email change, a setting that lets customers cancel their own subscriptions, and a currency filter on list payments."
icon: "arrows-turn-right"
keywords: ["Dodo Payments", "changelog", "release notes", "product updates", "v1.112.0 (august 5, 2026)", "discount codes", "webhooks", "recurring payments", "payment failures", "payout webhooks", "customer portal", "analytics", "disputes"]
---
...
### 10. **Dispute Response Window Extended to 10 Days**
