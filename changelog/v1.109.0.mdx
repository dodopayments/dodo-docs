...
description: "Paid trials for subscriptions and checkout, trial-misuse prevention, Payout Accounts for managing multiple bank accounts, product and add-on pricing in any chargeable currency, Analytics v3, and a new subscription.update_payment_method webhook — plus checkout preview, subscription filtering, and dashboard improvements."
icon: "arrows-turn-right"
keywords: ["Dodo Payments", "changelog", "release notes", "product updates", "v1.109.0 (july 21, 2026)", "paid trials", "trial misuse", "payout accounts", "multi-currency pricing", "analytics", "webhooks"]
---
...
### 7. **`next_billing_date` in Checkout Session Preview**
...
### 8. **Filter Subscriptions by `cancel_at_next_billing_date`**
...
### 9. **Copy Checkout Design From Test to Live Mode**
...
### 11. **All List-API Fields as Selectable Table Columns**
...
### 12. **Keyboard Accessibility Across Dashboard & Checkout**
