...
keywords: ["Dodo Payments", "changelog", "release notes", "product updates", "v0.10.0 (8 dec 2024)"]
---
...
- **Static Payment Links**: Added more query parameters to the static payment links to provide more flexibility in the checkout process. For more details, click [here](/developer-resources/integration-guide#4-static-payment-links).
