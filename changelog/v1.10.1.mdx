...
- **Configurable Payment Methods**: New `allowed_payment_method_types` configuration enables merchants to customize available payment options during checkout. See the [Allowed Payment Methods](/features/payment-methods#configuring-payment-methods) documentation for implementation details.
