...
keywords: ["Dodo Payments", "changelog", "release notes", "product updates", "v1.10.1 (21 march 2025)"]
---
...
- **Configurable Payment Methods**: New `allowed_payment_method_types` configuration enables merchants to customize available payment options during checkout. See the [Allowed Payment Methods](/features/payment-methods#per-checkout-payment-method-configuration) documentation for implementation details.
...
- **On-Demand Subscriptions**: New API endpoints for flexible subscription billing (available for select merchants).  Learn more in the [On-Demand Subscriptions](/developer-resources/ondemand-subscriptions) guide.
