...
|---------|--------------|------------|
| [v1.97.6](/changelog/v1.97.6) | May 7, 2026 | Import existing license keys, adaptive currency fees inclusive setting, Entitlement Engine, require_phone_number for checkout sessions, configurable INR e-mandate floor, and subscription cancellation reasons in the customer portal |
