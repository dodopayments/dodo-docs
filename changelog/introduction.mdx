...
|---------|--------------|------------|
| [v1.98.0](/changelog/v1.98.0) | May 14, 2026 | Stackable discount codes on checkout sessions, payments, subscriptions, and plan changes; per-checkout-session credit entitlement overrides; and three new subscription lifecycle webhooks (cancellation_scheduled, trial_ending, upcoming_renewal) |
