...
|---------|--------------|------------|
| [v1.97.6](/changelog/v1.97.6) | May 7, 2026 | Entitlement Engine launch, subscription cancellation reasons in the customer portal, configurable INR e-mandate floor, adaptive currency fees inclusive setting, import existing license keys, and require_phone_number for checkout sessions |
