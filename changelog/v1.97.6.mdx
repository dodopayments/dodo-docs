...
description: "Entitlement Engine launch, subscription cancellation reasons in the customer portal, configurable INR e-mandate floor, adaptive currency fees inclusive setting, import existing license keys, require_phone_number for checkout sessions, and bug fixes"
