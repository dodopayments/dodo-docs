...
description: "Import existing license keys via API, adaptive currency fees inclusive setting, Entitlement Engine launch, require_phone_number for checkout sessions, configurable INR e-mandate floor, subscription cancellation reasons in the customer portal, and bug fixes"
...
### 1. **Import Existing License Keys**
...
Dodo Payments now ships with a unified **Entitlement Engine** powering automatic delivery of every fulfilment integration. A single product can deliver multiple entitlements (license keys, downloadable files, Discord roles, GitHub access, Telegram invites, Framer remix links, Notion templates) on every successful purchase or active subscription.
...
### 3. **Adaptive Currency Fees Inclusive Business Setting**
...
### 4. **`require_phone_number` for Checkout Sessions**
...
### 5. **Configurable Mandate Minimum Amount for INR E-Mandates**
...
### 6. **Subscription Cancellation Reasons in the Customer Portal**
