...
keywords: ["Dodo Payments", "changelog", "release notes", "product updates", "v1.34.0 (18th june 2025)"]
---
...
- **React Native SDK (Beta)**: Released our React Native SDK in beta, enabling secure payment processing in native Android and iOS apps with customizable UI components and screens. Learn more in our [React Native SDK](/developer-resources/sdks/react-native) documentation.
