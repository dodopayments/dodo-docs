...
description: Tingkatkan pendapatan dengan pembelian sekali klik menggunakan
  metode pembayaran yang tersimpan untuk penawaran pasca-pembelian, peningkatan
  langganan, dan cross-sell.
...
|------|----------|----------|
| `difference_immediately` | Menagih selisih harga secara langsung ($30→$80 = $50) | Upgrade sederhana |
| `prorated_immediately` | Menagih berdasarkan sisa waktu dalam siklus penagihan | Penagihan berbasis waktu yang adil |
| `full_immediately` | Menagih harga penuh paket baru, mengabaikan sisa waktu | Siklus penagihan dimulai ulang |
| `do_not_bill` | Menerapkan perubahan paket tanpa tagihan langsung; paket baru ditagihkan pada perpanjangan berikutnya dan tanggal penagihan awal tetap dipertahankan | Upgrade sebagai bentuk penghargaan dan migrasi gratis |
