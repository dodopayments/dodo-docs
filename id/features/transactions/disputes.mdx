...
3. **Pilih Tanggapan Anda**
   - Anda dapat memilih untuk menerima atau membalas sengketa
   
   <Frame>
       <img src="/images/disputes/1.png" alt="Pembuatan Sengketa" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
...
5. **Jika Membalas**
   - Siapkan untuk menyerahkan bukti
   - Ikuti praktik terbaik di bawah ini
   
   <Frame>
       <img src="/images/disputes/2.png" alt="Pembuatan Sengketa" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
   
   <Frame>
       <img src="/images/disputes/3.png" alt="Pembuatan Sengketa" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>

<Info>
Anda memiliki waktu **10 hari** untuk menanggapi sengketa setelah sengketa tersebut dibuat. Hitung mundur yang ditampilkan pada sengketa di dashboard Anda mencerminkan jangka waktu yang sama.
</Info>
...
<Frame caption="Visa RDR configuration in the Dodo Payments dashboard">
    <img src="/images/disputes/rdr.png" alt="Pengaturan Visa RDR menampilkan toggle yang diaktifkan dan konfigurasi ambang batas" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Step title="Open the Disputes Settings">
    Arahkan ke **Pengaturan → Bisnis** di dasbor Dodo Payments Anda dan temukan bagian **Visa Rapid Dispute Resolution (RDR)**.
</Step>
