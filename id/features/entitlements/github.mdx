...
2. Dodo Payments membuat grant dengan status `Pending` dan `oauth_url` untuk memungkinkan pelanggan menautkan akun GitHub mereka.
3. Pelanggan memberikan otorisasi melalui tautan di email atau customer portal mereka.
4. Dodo Payments mengundang akun GitHub pelanggan ke repository dengan izin yang dikonfigurasi. Grant berubah menjadi `Delivered` setelah undangan dibuat.
5. Jika subscription dibatalkan, dikembalikan dananya, atau dicabut, pelanggan dihapus sebagai collaborator.
