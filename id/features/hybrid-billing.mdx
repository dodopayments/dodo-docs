...
2. Konfirmasi `customer_id` cocok dengan pelanggan berlangganan
3. Periksa `event_name` cocok dengan konfigurasi meter
4. Verifikasi acara memiliki cap waktu yang benar (tidak bersejarah di masa depan)
</Accordion>
...
**Solusi**:
1. Gunakan `previewChangePlan` API untuk menunjukkan biaya tepat sebelum konfirmasi
2. Sampaikan bahwa prorata berlaku untuk langganan DAN add-on
