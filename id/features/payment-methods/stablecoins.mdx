...
| Jenis | Metode | Negara |
| :--- | :----- | :------ |
| `crypto_currency` | Stablecoins | Global (Kec. IN) |
...
Buat sesi checkout dengan `crypto_currency` dalam metode pembayaran yang diizinkan.
</Step>
...
**Periksa:**
1. `crypto_currency` termasuk dalam `allowed_payment_method_types`?
