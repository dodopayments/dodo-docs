...
<Note>
Di Inggris, Afterpay beroperasi sebagai "Clearpay" tetapi menggunakan tipe API yang sama (`afterpay_clearpay`).
</Note>
...
Ini adalah perilaku yang diharapkan. Jangan sertakan BNPL di `allowed_payment_method_types` untuk produk di bawah $50.
...
| **GBP** | Inggris dan semua negara Eropa yang didukung |

Mata uang lain yang didukung oleh Klarna (DKK, NOK, SEK, CZK, RON, PLN, CHF) berfungsi di negara masing-masing.

<Info>
Misalnya, transaksi USD hanya akan menunjukkan opsi BNPL kepada pelanggan di AS. Transaksi EUR akan menunjukkan opsi BNPL di semua negara Eropa yang didukung. Transaksi GBP akan menunjukkan opsi BNPL kepada pelanggan di Inggris dan semua negara Eropa yang didukung.
</Info>

| Penyedia | Mata Uang yang Didukung |
| :------- | :------------------- |
| Klarna | USD, EUR, GBP, DKK, NOK, SEK, CZK, RON, PLN, CHF |
| Afterpay | USD (AS), GBP (Inggris) |
...
**Periksa:**
1. Jumlah transaksi minimal $50.01?
...
**Solusi:** Seringkali, transaksi berada di bawah minimum. Verifikasi jumlah memenuhi ambang $50.01.
</Accordion>

<Accordion title="Pelanggan ditolak oleh penyedia BNPL">
**Penyebab:**
- Riwayat kredit yang tidak cukup dengan penyedia
- Terlalu banyak rencana cicilan aktif
- Verifikasi identitas gagal

**Solusi:** Ini diharapkan untuk beberapa pelanggan. Pastikan fallback kartu tersedia. Jangan ungkapkan alasan penolakan secara spesifik.
</Accordion>

<Accordion title="Pembayaran terjebak dalam status pending">
**Penyebab:** Pelanggan tidak menyelesaikan alur autentikasi dengan penyedia BNPL.

**Solusi:** Pembayaran akan timeout dan gagal. Pelanggan dapat mencoba lagi atau menggunakan metode lain.
</Accordion>
</AccordionGroup>
