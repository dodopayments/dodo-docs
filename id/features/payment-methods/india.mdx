...
sidebarTitle: India
description: Terima UPI dan semua kartu yang diterbitkan di India dengan mandat
  berlangganan sesuai dengan RBI. Pahami penundaan pemrosesan 48 jam, batasan
...
**Solusi:** Ini diharapkan. Bangun sistem Anda untuk menangani penundaan variabel hingga total ~51 jam.
</Accordion>

<Accordion title="Mandate cancelled but subscription still active">
**Penyebab:** Kasus batasan dalam regulasi RBI — pembatalan mandat selama jendela pemrosesan tidak langsung membatalkan langganan.

**Solusi:** Tagihan berikutnya akan gagal dan langganan akan beralih ke `on_hold`. Pantau webhook untuk `payment.failed`.
</Accordion>
</AccordionGroup>
...
<Card title="Webhooks" icon="webhook" href="/developer-resources/webhooks">
Penanganan webhook untuk acara pembayaran.
</Card>
