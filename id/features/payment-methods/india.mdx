...
| Tingkat | Tempat pengaturan | Cakupan |
|-------|--------------|-------|
| **Per permintaan** | `mandate_min_amount_inr_paise` pada sesi checkout atau langganan | Satu transaksi |
| **Merchant** | Pengaturan bisnis | Semua langganan INR Anda |
