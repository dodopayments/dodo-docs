...
<Step title="Permintaan aktivasi">
Email **support@dodopayments.com** dengan:
- Domain produksi Anda (misalnya, `https://yourdomain.com`)
- Konfirmasi bahwa file dihosting
...
<Accordion title="Selalu sertakan fallback kartu">
...
2. Menggunakan HTTPS?
3. Perangkat menggunakan iOS 17+ / Safari 17+ / iPadOS 17+?
4. Pelanggan memiliki kartu di Apple Wallet?
5. `apple_pay` disertakan dalam `allowed_payment_method_types`?
...
4. `google_pay` disertakan dalam `allowed_payment_method_types`?
