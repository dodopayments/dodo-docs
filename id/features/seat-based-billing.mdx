...
Sebagai contoh, jika tim Anda membutuhkan 15 kursi:
...
| Mode | Menambahkan Kursi | Menghapus Kursi |
|------|------------------|----------------|
| `prorated_immediately` | Biaya untuk sisa hari dalam siklus | Kredit untuk hari yang tidak terpakai |
| `difference_immediately` | Biaya harga kursi penuh | Kredit diterapkan untuk pembaruan di masa depan |
...
| Acara | Kapan Dipicu | Kasus Penggunaan |
|-------|--------------|----------------|
| `subscription.active` | Langganan baru diaktifkan | Menyediakan kursi awal |
| `subscription.plan_changed` | Kursi ditambahkan/dihapus | Memperbarui jumlah kursi di aplikasi Anda |
| `subscription.renewed` | Langganan diperpanjang | Mengonfirmasi jumlah kursi tidak berubah |
| `subscription.cancelled` | Langganan dibatalkan | Menghapus semua kursi |
...
<Tab title="Peningkatan Otomatis">
Secara otomatis tambahkan kursi saat batas tercapai.
...
<AccordionGroup>
<Accordion title="Jumlah kursi tidak cocok antara aplikasi dan penagihan">
...
**Solusi**:
1. Implementasikan pengelola webhook untuk `subscription.plan_changed`
2. Tambahkan tombol "Sinkronisasi dengan penagihan" yang mengambil langganan saat ini
3. Atur TTL cache untuk memastikan penyegaran secara teratur
</Accordion>

<Accordion title="Biaya prorasi tidak terduga">
...
3. Dokumentasikan kebijakan pro-rata Anda di pusat bantuan
</Accordion>

<Accordion title="Add-on tidak muncul di checkout">
**Gejala**: Add-on kursi tidak tersedia selama checkout.
...
<Accordion title="Tidak dapat mengurangi kursi di bawah penggunaan saat ini">
...
<Card title="Perubahan Rencana & Prorasi" icon="arrows-rotate" href="/developer-resources/subscription-upgrade-downgrade">
