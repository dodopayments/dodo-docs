...
<CardGroup cols={2}>
<Card title="Tutorial Implementasi" icon="code" href="/developer-resources/seat-based-pricing">
  Panduan langkah demi langkah dengan contoh kode.
</Card>

<Card title="Dokumentasi Add-ons" icon="puzzle" href="/features/addons">
...
Langganan Tim Pro biaya $99/bulan dan mencakup 5 kursi. Jika Anda memiliki lebih dari 5 pengguna, Anda membayar tambahan $15/bulan untuk setiap kursi tambahan.

Sebagai contoh, jika tim Anda memerlukan 15 kursi:
- Rencana Dasar: $99/bulan (termasuk 5 kursi)
- Tambahan: 10 kursi ekstra × $15/bulan = $150/bulan
...
<Steps>
<Step title="Tentukan Rencana Dasar">
...
<Step title="Pertimbangkan Frekuensi Penagihan">
...
|------|-------------|----------------|
| `prorated_immediately` | Biaya untuk sisa hari dalam siklus | Kredit untuk hari yang tidak terpakai |
| `difference_immediately` | Biaya harga kursi penuh | Kredit diterapkan pada pembaruan mendatang |
| `full_immediately` | Biaya harga kursi penuh, reset siklus penagihan | Tidak ada kredit |

### Contoh Prorata

**Skenario: 15 hari siklus penagihan tersisa, menambah 5 kursi dengan $10/kursi**
...
<Tip>
**Memilih mode prorata untuk perubahan kursi**: Gunakan `prorated_immediately` untuk penagihan berbasis hari yang adil ketika tim sering menyesuaikan kursi. Gunakan `difference_immediately` untuk perhitungan yang lebih sederhana yang mengenakan atau mengkreditkan harga kursi penuh. Lihat [Panduan Prorata](/developer-resources/subscription-upgrade-downgrade#proration-modes) untuk perbandingan yang lebih mendetail.
</Tip>

### Prabuka Sebelum Mengubah

Selalu tinjau prorata sebelum membuat perubahan:
...
| `subscription.plan_changed` | Kursi ditambah/dihapus | Perbarui jumlah kursi di aplikasi Anda |
| `subscription.renewed` | Langganan diperbarui | Konfirmasi jumlah kursi tidak berubah |
| `subscription.cancelled` | Langganan dibatalkan | Menonaktifkan semua kursi |
...
<Tab title="Batas Lunak dengan Peringatan">
Izinkan melebihi dengan peringatan dan periode tenggang.
...
<Tab title="Pembaruan Otomatis">
Secara otomatis menambah kursi ketika batas tercapai.
...
Tawarkan berbagai tipe kursi dengan harga yang berbeda:
...
**Implementasi:** Buat tambahan terpisah untuk setiap tipe kursi.
...
**Implementasi:** Buat produk terpisah untuk rencana bulanan dan tahunan dengan harga tambahan yang berbeda.

### Persyaratan Minimum Kursi

Memerlukan jumlah minimum kursi untuk rencana tertentu:
...
### Praktik Terbaik Pen定harga

- **Komunikasi yang Jelas**: Tampilkan harga per-kursi dengan jelas di halaman harga Anda
- **Kursi yang Termasuk**: Pertimbangkan untuk menyertakan beberapa kursi dalam harga dasar untuk mengurangi gesekan
- **Diskon Volume**: Tawarkan tarif per-kursi yang lebih rendah untuk tim besar untuk memenangkan kesepakatan perusahaan
- **Insentif Tahunan**: Diskon untuk rencana tahunan untuk meningkatkan aliran kas dan retensi
...
- **Sinkronkan Secara Berkala**: Secara berkala sinkronkan jumlah kursi lokal Anda dengan Dodo Payments melalui API
- **Tangani Kegagalan**: Jika perubahan kursi gagal, tampilkan pesan kesalahan yang jelas dan opsi untuk mencoba kembali
...
- **Pengurangan yang Mudah**: Jangan menyulitkan pengurangan kursi (ini membangun kepercayaan)
...
<AccordionGroup>
<Accordion title="Ketidaksesuaian jumlah kursi antara aplikasi dan penagihan">
...
3. Atur cache TTL untuk memastikan pembaruan reguler
</Accordion>

<Accordion title="Biaya prorata tidak terduga">
**Gejala**: Pelanggan bingung dengan jumlah biaya di tengah siklus.

**Penyebab**:
- Mode prorata tidak dikomunikasikan dengan jelas
- Pelanggan tidak melihat prabuka sebelum mengonfirmasi

**Solusi**:
1. Selalu gunakan `previewChangePlan` sebelum melakukan perubahan
2. Tampilkan rincian yang jelas: "Menambahkan X kursi = $Y hari ini (pro rata untuk Z hari)"
3. Dokumentasikan kebijakan prorata Anda di pusat bantuan
</Accordion>

<Accordion title="Add-on tidak muncul dalam checkout">
**Gejala**: Tambahan kursi tidak tersedia saat checkout.

**Penyebab**:
- Tambahan tidak terpasang pada produk
- Tambahan diarsipkan atau dihapus
- Ketidakcocokan mata uang antara produk dan tambahan

**Solusi**:
1. Verifikasi bahwa tambahan terpasang di pengaturan produk
2. Periksa status tambahan di dasbor Add-Ons
3. Pastikan mata uang cocok dengan tepat
</Accordion>

<Accordion title="Tidak bisa mengurangi kursi di bawah penggunaan saat ini">
...
<CardGroup cols={2}>
<Card title="Tutorial Penetapan Harga Berdasarkan Kursi" icon="code" href="/developer-resources/seat-based-pricing">
...
<Card title="Perubahan Rencana & Prorata" icon="arrows-rotate" href="/developer-resources/subscription-upgrade-downgrade">
  Tangani modifikasi langganan.
</Card>

<Card title="Webhook Langganan" icon="bell" href="/developer-resources/webhooks/intents/subscription">
