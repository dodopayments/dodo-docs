...
Timestamp ISO 8601 (UTC). Defaultnya adalah waktu server saat ini jika tidak disertakan. Sertakan untuk penagihan yang akurat dengan event tertunda/batch. Timestamp yang lebih lama dari 1 jam, atau lebih dari 5 menit di masa mendatang, akan ditolak.
</ParamField>
...
<Tip>
Kumpulkan hingga 1.000 event per permintaan untuk kinerja yang lebih baik. API memberlakukan batas keras sebanyak 1.000 event per panggilan.
</Tip>
