...
Ya. Dengan [Bring Your Own Processor (BYOP)](/features/byop), Anda dapat menghubungkan akun Stripe atau Adyen Anda sendiri dan merutekan pembayaran dari negara-negara tertentu melaluinya, sementara Dodo Payments tetap mendukung produk, langganan, invoicing, dan analytics. Negara-negara yang tidak Anda rutekan secara eksplisit akan tetap diproses melalui Dodo Payments sebagai Merchant of Record layanan lengkap Anda, sehingga kami dapat menanggung liabilitas pajak dan fraud pada rute-rute tersebut.
</Accordion>
