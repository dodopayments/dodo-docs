...
description: Learn how to implement Purchasing Power Parity pricing with
  ParityDeals and Evendeals integrations to offer location-based discounts for
  your customers on Dodo Payments
