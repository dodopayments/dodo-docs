...
<Info>
Setelah berhasil memperbarui metode pembayaran untuk langganan `on_hold`, pelanggan akan melihat halaman konfirmasi dan menerima notifikasi email tentang pembayaran yang berhasil dan pengaktifan kembali langganan.
</Info>
...
Klik "Konfirmasi Perubahan" untuk memperbarui metode pembayaran. Untuk langganan `on_hold`, ini akan secara otomatis membuat tagihan untuk tunggakan yang tersisa.
</Step>
