...
<Info>
Kredit dari downgrade menggunakan `difference_immediately` terbatas pada langganan dan diterapkan otomatis ke pembaruan berikutnya. Kredit ini berbeda dari <a href="/features/customer-credit">Customer Credits</a>.
</Info>
