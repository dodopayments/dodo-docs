...
Biaya selisih harga segera (upgrade) atau menambahkan kredit untuk pembaruan mendatang (downgrade). Terbaik untuk skenario upgrade/downgrade yang sederhana.
...
<Info>
Kredit dari downgrade menggunakan `difference_immediately` bersifat terikat pada langganan dan diterapkan secara otomatis pada pembaruan mendatang. Mereka berbeda dari <a href="/features/customer-credit">Kredit Pelanggan</a>.
</Info>

#### `full_immediately`
Biaya jumlah rencana baru secara penuh segera, mengabaikan waktu yang tersisa. Terbaik untuk mereset siklus penagihan.
...
- **Komunikasikan harga**: Tampilkan total, prorasi, dan pembaruan berikutnya
- **Gunakan percobaan dengan bijaksana**: Konversi dengan onboarding, bukan hanya waktu
- **Manfaatkan add‑ons**: Buat rencana dasar sederhana dan tawarkan tambahan
- **Uji perubahan**: Validasi perubahan rencana dan prorasi dalam mode uji

<Info>
Langganan adalah dasar fleksibel untuk pendapatan berulang. Mulailah dengan sederhana, uji secara menyeluruh, dan iterasi berdasarkan adopsi, churn, dan metrik ekspansi.
</Info>