...
- **Nama dengan jelas**: Gunakan kode yang mudah dikenali yang cocok dengan nama kampanye
- **Batas waktu**: Tambahkan tanggal kedaluwarsa untuk menciptakan urgensi dan mencegah penyalahgunaan
- **Jangkau secara bijak**: Batasi ke produk tertentu untuk menghindari kebocoran margin
- **Validasi lebih awal**: Periksa kelayakan kode sebelum menyelesaikan checkout
- **Pantau dampak**: Lacak penggunaan dan konversi berdasarkan kampanye

<Info>
Kode diskon adalah alat yang ampuh untuk akuisisi dan retensi. Mulailah dengan penawaran yang sederhana dan diberi nama dengan baik, validasi secara menyeluruh, dan iterasi berdasarkan kinerja.
</Info>