...
<img src="/images/CBB/Checkout.png" alt="Checkout menampilkan kredit yang termasuk dengan pembelian produk" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
Tentukan kredit dalam unit Anda sendiri - token, panggilan API, jam komputasi, atau metrik apa pun yang bermakna bagi produk Anda. Unit kustom menggunakan presisi yang Anda tetapkan (0 hingga 10 tempat desimal).
...
| Sumber | Deskripsi |
|--------|-------------|
| **Subscription** | Kredit yang diterbitkan bersama pembelian subscription, diterbitkan kembali setiap siklus penagihan |
| **One-Time** | Kredit yang diterbitkan bersama produk pembayaran satu kali |
| **Add-on** | Kredit yang diterbitkan bersama add-on yang ditambahkan ke subscription |
| **API** | Kredit yang diberikan secara manual melalui API atau dasbor |
| **Rollover** | Kredit yang dibawa dari siklus penagihan sebelumnya |
...
<img src="/images/CBB/Desktop - Entitlements  - Credits.jpg" alt="Halaman daftar kredit menampilkan hak kredit yang telah dibuat" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Create Credit.jpg" alt="Formulir pembuatan kredit menampilkan info dasar, pengaturan umum, dan pengaturan langganan" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
Hanya untuk kredit Unit Kustom. Jumlah tempat desimal yang diizinkan, dari `0` hingga `10`:

- `0` - Bilangan bulat (cocok untuk item yang dapat dihitung seperti panggilan API)
- `1` - Satu desimal (0.0)
- `2` - Dua desimal (0.00) - **default**
- `3` - Tiga desimal (0.000)
- Hingga `10` - Untuk unit dengan presisi tinggi (misalnya token pecahan atau penggunaan mikro)
...
<img src="/images/CBB/Desktop - Attach Credit - Subscription.jpg" alt="Bagian hak produk menampilkan tombol lampirkan Kredit" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - Subscription-2.jpg" alt="Panel Tambah Kredit dengan dropdown pemilihan kredit" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Attach Credit - Subscription-4.jpg" alt="Formulir konfigurasi kredit dengan siklus penagihan, uji coba, dan pengaturan proration" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - Subscription-5.jpg" alt="Panel Tambah Kredit menampilkan kredit yang dipilih dengan detail" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
</Steps>
...
<img src="/images/CBB/Desktop - Attach Credit - OTP.jpg" alt="Bagian harga produk dengan Pembayaran Sekali pilih" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - UBB.jpg" alt="Konfigurasi harga Berdasarkan Penggunaan" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - UBB-3.jpg" alt="Panel Pilih Meter menampilkan ambang batas gratis dan toggle kredit" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - UBB-5.jpg" alt="Konfigurasi meter dengan pemilihan kredit dan unit meter per kredit" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - UBB-6.jpg" alt="Konfigurasi kredit untuk produk UBB" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - UBB-1.jpg" alt="Meter yang dikonfigurasi menampilkan detail lampiran kredit" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
</Steps>
...
<img src="/images/CBB/Desktop - Usage Billing.jpg" alt="Dashboard Penagihan Penggunaan menampilkan tabel acara dengan kredit yang dikonsumsi" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Checkout.png" alt="Halaman pembayaran menampilkan produk dengan kredit panggilan API yang termasuk" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Customer Portal.jpg" alt="Tampilan portal pelanggan dengan saldo dan riwayat transaksi" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Subscription Details.jpg" alt="Halaman detail langganan menampilkan hak dan riwayat penggunaan" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Transactions - Payment Summary.jpg" alt="Halaman detail transaksi menampilkan hak kredit" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Entitlements  - Credits.jpg" alt="Halaman daftar kredit di bagian Produk" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Customer Details.jpg" alt="Halaman detail pelanggan dengan tab Kredit menampilkan saldo dan transaksi" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
|-----------------|-------------|
| **Credit Added** | Kredit yang diberikan (subscription, pembayaran satu kali, atau API) |
| **Credit Deducted** | Kredit yang digunakan melalui pemakaian atau debit manual |
| **Credit Expired** | Kredit yang kedaluwarsa tanpa rollover |
| **Credit Rolled Over** | Kredit yang dibawa ke periode berikutnya |
| **Rollover Forfeited** | Kredit rollover yang hangus setelah jumlah rollover maksimum tercapai |
| **Overage Charged** | Pemakaian yang melebihi saldo kredit saat overage diaktifkan |
| **Overage Reset** | Overage yang dilacak dihapus saat reset siklus penagihan |
| **Auto Top-Up** | Pengisian ulang kredit secara otomatis saat saldo rendah |
| **Manual Adjustment** | Kredit atau debit yang diterapkan secara manual oleh merchant |
| **Refund** | Kredit yang dikembalikan |
...
| Peristiwa | Deskripsi |
|-------|-------------|
| `credit.added` | Kredit yang diberikan kepada pelanggan |
| `credit.deducted` | Kredit yang digunakan melalui pemakaian atau debit manual |
| `credit.expired` | Kredit yang tidak digunakan dan kedaluwarsa |
| `credit.rolled_over` | Kredit yang dibawa ke grant baru |
| `credit.rollover_forfeited` | Kredit yang hangus setelah jumlah rollover maksimum tercapai |
| `credit.overage_charged` | Biaya overage yang diterapkan |
| `credit.overage_reset` | Overage yang dilacak direset pada akhir siklus penagihan |
| `credit.manual_adjustment` | Penyesuaian kredit/debit manual dilakukan |
| `credit.balance_low` | Saldo turun di bawah ambang batas yang dikonfigurasi |

Semua peristiwa ledger (setiap peristiwa `credit.*` kecuali `credit.balance_low`) menyertakan payload `CreditLedgerEntry` lengkap dengan saldo sebelum/sesudah, overage sebelum/sesudah, referensi sumber, dan `metadata` dari subscription atau pembayaran sumber grant (kosong untuk grant yang dibuat langsung melalui API). Peristiwa `credit.balance_low` menyertakan konfigurasi ambang batas dan saldo saat ini.
