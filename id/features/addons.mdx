...
- **Mata uang**: Tetapkan harga dasar dalam mata uang apa pun yang dapat ditagihkan oleh Dodo Payments. Pemilih mata uang yang dapat dicari menempatkan **USD, GBP, EUR, dan INR** di bagian atas; pelanggan di luar mata uang dasar Anda akan ditagih melalui [Adaptive Currency](/features/adaptive-currency)
- **Siklus penagihan**: Harus sesuai dengan siklus penagihan langganan Anda
- **Batas kuantitas**: Tetapkan jumlah minimum dan maksimum per pelanggan
