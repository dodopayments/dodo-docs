...
description: Explore Atlas, a fully functional AI art generation demo
  application showcasing usage-based billing, subscriptions, and one-time
  payments with Dodo Payments checkout integration.
icon: palette
keywords:
  - Dodo Payments
  - produk demo atlas
...
<Frame>
  <img alt="Produk Demo Atlas - Platform pembuatan seni AI dengan penagihan terintegrasi" src="/images/atlas/atlas-demo-product.png" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
