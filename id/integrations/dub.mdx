...
<Tip>
**Integrasi Program Afiliasi**: Integrasi ini juga bekerja dengan baik dengan **Dub Partners** untuk melacak rujukan dan komisi afiliasi. Gunakan pelacakan konversi Dub untuk mengaitkan penjualan dengan tautan afiliasi Anda dan mengukur kinerja mitra. Pelajari lebih lanjut tentang cara mengatur program afiliasi di [panduan fitur Afiliasi kami](/features/affiliates).
</Tip>
...
1. Akun [Dub](https://dub.co) dengan workspace
...
- Verifikasi bahwa webhook dipicu pada acara `payment.succeeded`
- Konfirmasi bahwa pelacakan konversi diaktifkan untuk tautan Dub Anda
</Accordion>

<Accordion title="Atribusi pendapatan tidak berfungsi">
- Konfirmasi bahwa pengguna mengklik tautan pendek Dub Anda sebelum checkout
- Verifikasi bahwa cookie `dub_id` diatur dengan benar di domain Anda
...
- Verifikasi bahwa URL endpoint API benar: `https://api.dub.co/track/sale`
- Uji transformasi dengan payload webhook contoh
</Accordion>

<Accordion title="Penjualan duplikat sedang dilacak">
- Pastikan Anda hanya melacak pada acara {/* INLINE_CODE_PLACEHOLDER_bfeed7a4ab5393d394108752765f7cfb */, bukan `payment.processing`
