...
<Step title="Klon Implementasi Contoh">
Klon repositori [dodopayments-figma](https://github.com/dodopayments/dodopayments-figma) dan perbarui `manifest.json` dengan nama dan ID dari folder plugin yang Anda buat.
...
3. Ikuti [panduan penerbitan plugin Figma](https://www.figma.com/plugin-docs/publishing-plugins/)
