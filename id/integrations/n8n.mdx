...
<Step title="Open the Webhook Section">
  Di dashboard Dodo Payments Anda, navigasikan ke <b>Webhooks → + Tambah Endpoint</b> dan buka dropdown integrasi.
  <Frame>
    <img src="/images/integrations/n8n.png" alt="Tambah Endpoint dan dropdown integrasi" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
