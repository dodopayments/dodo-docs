...
<Step title="Open the Webhook Section">
  ...
  <Frame>
    <img src="/images/integrations/datafast/add.png" alt="Tambah Endpoint dan dropdown integrasi" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
...
<Step title="Enter API Key">
  Sediakan DataFast API Key Anda di bidang konfigurasi.
  <Frame>
    <img src="/images/integrations/datafast/api-key.png" alt="Tambah API Key" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
