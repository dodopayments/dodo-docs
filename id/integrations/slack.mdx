...
- Gunakan lampiran pesan kaya dengan warna, field, dan format untuk kejelasan dan tindakan.
- Selalu sertakan data kunci seperti jumlah, email pelanggan, dan ID untuk identifikasi yang cepat.
- Pilih warna yang sesuai dengan jenis acara: hijau (`good`) untuk keberhasilan, merah (`danger`) untuk sengketa atau kegagalan, kuning (`warning`) untuk pembatalan, dan biru (`#36a64f`) untuk acara informasional.
