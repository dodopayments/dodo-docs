...
<Step title="Open the Webhook Section">
  Buka bagian <b>Webhook</b> di dashboard Dodo Payments Anda. Klik tombol <b>+ Add Endpoint</b>, lalu buka dropdown webhook untuk melihat integrasi lainnya.
  <Frame>
...
<Step title="Grant Slack Permissions">
  Berikan izin yang diperlukan kepada Aplikasi Incoming Webhooks Slack sehingga dapat memposting pesan di saluran pilihan Anda.
  <Frame>
...
<Step title="Customize Transformation Code">
  Tambahkan atau edit kode transformasi untuk menyesuaikan notifikasi Slack Anda sesuai kebutuhan. Anda dapat menggunakan template siap pakai atau menulis logika sendiri.
  <Frame>
...
<Step title="Test and Create">
  Uji kode transformasi Anda dengan payload event kustom atau siap pakai. Setelah Anda puas, klik <b>Create</b> untuk mengaktifkan integrasi.
  <Frame>
...
- Gunakan lampiran pesan yang kaya dengan warna, kolom, dan pemformatan agar jelas dan dapat ditindaklanjuti.
- Selalu sertakan data penting seperti jumlah, email pelanggan, dan ID agar dapat diidentifikasi dengan cepat.
- Pilih warna yang sesuai dengan jenis peristiwa: hijau (`good`) untuk keberhasilan, merah (`danger`) untuk sengketa atau kegagalan, kuning (`warning`) untuk pembatalan, dan biru (`#3aa3e3`) untuk peristiwa informatif.
- Tambahkan stempel waktu untuk membantu melacak kapan setiap peristiwa terjadi.
