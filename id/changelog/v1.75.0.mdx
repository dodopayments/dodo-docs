...
### 1. **Produk Koleksi**  
   ...
   <Frame>
     <img src="/images/product-collection/checkout-page.png" alt="Halaman pembayaran Product Collection yang menunjukkan beberapa opsi paket" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
