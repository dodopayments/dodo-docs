...
Menambahkan `refund_status` field ke `GET /payments/{payment_id}` response untuk memeriksa dengan cepat apakah pembayaran telah dikembalikan tanpa perlu melakukan query ke endpoint refunds secara terpisah.
