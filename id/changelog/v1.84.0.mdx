...
<Frame>
<img src="/images/product-analytics/overview.png" alt="Analitik Tingkat Produk" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
| **Biaya sengketa tetap berlaku** | Biaya sengketa tetap dikenakan pada transaksi yang diselesaikan RDR -- ini mencakup biaya berdebat dengan Visa atas nama Anda |
| **Tanpa beban operasional** | Tidak ada pengumpulan bukti atau batas waktu tanggapan |
| **Pengalaman pelanggan lebih baik** | Pemegang kartu mendapatkan pengembalian dana instan |
| **Perlindungan akun** | Tetap keluar dari Program Pemantauan Sengketa Visa (VDMP) |
...
<Frame>
<img src="/images/customer-portal/new-portal.png" alt="Perombakan UI Portal Pelanggan" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
