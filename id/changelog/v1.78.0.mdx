...
### 1. **Preferensi Komunikasi**
   ...
   <Frame>
     <img src="/images/communication-preferences/overview.png" alt="Ikhtisar Preferensi Komunikasi yang menampilkan pengaturan notifikasi" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
...
### 2. **Bidang Kustom dalam Sesi Checkout**
   ...
   **Manfaat**
   ...
   <Check>
   Nilai custom field dikembalikan dalam array `custom_field_responses` dalam respons pembayaran dan subscription.
   </Check>

   Pelajari selengkapnya: [Kolom Kustom Checkout Session](/developer-resources/checkout-session#15-collecting-custom-fields)
