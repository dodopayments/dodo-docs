...
<Frame>
<img src="/images/CBB/Checkout.png" alt="Checkout menunjukkan kredit yang disertakan dengan pembelian produk" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/CBB/Customer Portal.jpg" alt="Tampilan kredit Portal Pelanggan dengan saldo dan riwayat transaksi" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/design/general-overview.jpg" alt="Halaman pengaturan desain dengan pratinjau langsung dari checkout, portal pelanggan, dan storefront" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Tip>
Gunakan bidang-bidang ini untuk membangun dasbor sengketa dan pengembalian dana, memicu peringatan pada perubahan status sengketa, atau menampilkan pembayaran yang memerlukan perhatian.
</Tip>

Pelajari lebih lanjut: [List Payments API](/api-reference/payments/get-payments)

### 4. **Tabel Pengembalian Dana di Portal Pelanggan**

Portal Pelanggan sekarang menyertakan bagian **Pengembalian Dana** khusus di mana pelanggan dapat melihat semua pengembalian dana yang terkait dengan pembayaran mereka. Setiap entri pengembalian dana menunjukkan jumlah, status, tanggal, dan pembayaran asli yang dikeluarkan, memberikan pelanggan transparansi penuh terhadap riwayat pengembalian dana mereka tanpa perlu menghubungi dukungan.

<Check>
Tabel pengembalian dana tersedia secara otomatis di portal pelanggan untuk semua bisnis. Tidak diperlukan konfigurasi.
</Check>

Pelajari lebih lanjut: [Customer Portal](/features/customer-portal)

### 5. **Salin ke Mode Langsung untuk Meter**

Anda sekarang dapat **menyalin meter dari mode uji ke mode langsung** langsung dari dasbor. Setelah Anda selesai menguji konfigurasi meter di mode uji, gunakan aksi salin untuk menduplikasinya ke mode langsung dengan semua pengaturan yang dipertahankan: jenis agregasi, nama acara, filter, dan asosiasi kredit. Ini menghilangkan kebutuhan untuk membuat ulang meter secara manual saat pindah dari pengembangan ke produksi.

<Tip>
Bangun dan validasi konfigurasi meter Anda di mode uji terlebih dahulu, lalu salin ke mode langsung saat Anda siap untuk produksi. Ini memastikan pengaturan penagihan Anda diuji sebelum menangani penggunaan pelanggan nyata.
</Tip>

Pelajari lebih lanjut: [Usage-Based Billing](/features/usage-based-billing/introduction) | [Meters](/features/usage-based-billing/meters)
