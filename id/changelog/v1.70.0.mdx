...
1. **Checkout Inline - Pengalaman Checkout Terintegrasi Penuh (BETA)**  
   ...
   <Frame>
   <img src="/images/inline-checkout/cover.png" alt="Gambar Sampul Checkout Inline" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
...
3. **Perubahan Rencana Langganan di Dasbor dengan Pembaruan Tanggal Penagihan Berikutnya**  
    ...
    <Frame>
    <img src="/images/changelog/subscription-plan-changes.png" alt="Perubahan paket langganan di dashboard" style={{ maxHeight: '500px', width: 'auto' }} />
    </Frame>
...
4. **Tautan Pendek untuk URL Pembayaran**  
   ...
   <Frame>
   <img src="/images/changelog/short-links.png" alt="Fitur tautan pendek untuk URL pembayaran" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
