...
| `next_billing_date` | Tanggal penagihan yang dijadwalkan berikutnya (ISO 8601) |
| `card_token` | Token unik dari pemroses Anda saat ini |

<Warning>
Field `card_token` sangat penting—ini digunakan untuk mencocokkan catatan pelanggan dengan metode pembayaran mereka saat impor. Pastikan ini cocok persis dengan token di ekspor metode pembayaran.
</Warning>
