...
<Note>
Untuk memulai migrasi langganan, hubungi [tim dukungan kami](mailto:support@dodopayments.com). Mereka akan menghubungkan Anda dengan Insinyur Solusi yang berdedikasi yang akan membimbing Anda melalui seluruh proses.
</Note>
...
<AccordionGroup>
<Accordion title="Verifikasi kepatuhan PCI DSS">
Dodo Payments adalah compliant PCI DSS Level 1. Untuk memenuhi kewajiban kepatuhan, kami hanya dapat menerima data kartu dari pemroses pembayaran lain yang compliant PCI DSS Level 1.
...
Lihat [Attestation of Compliance (AOC)](https://pub-2a89184e4c954b599464449d23f506bb.r2.dev/dodo-payments-pci-dss-aoc.pdf) kami untuk dibagikan kepada pemroses Anda saat ini.
</Accordion>

<Accordion title="Integrasi Dodo Payments">
...
<Accordion title="Otorisasi akses data">
...
<Steps>
<Step title="Minta ekspor metode pembayaran dari pemroses Anda saat ini">
Hubungi tim dukungan pemroses pembayaran Anda saat ini dan ajukan permintaan resmi untuk ekspor lengkap token kartu pelanggan Anda.
...
<Step title="Siapkan ekspor data pelanggan">
...
| Field | Deskripsi |
|-------|-------------|
| `customer_id` | Identifikasi pelanggan internal Anda |
...
| `payment_amount` | Jumlah langganan dalam unit mata uang terkecil |
...
| `card_token` | Token unik dari pemroses Anda saat ini |

<Warning>
Field `card_token` sangat penting—digunakan untuk mencocokkan catatan pelanggan dengan metode pembayaran mereka selama impor. Pastikan ini cocok persis dengan token dalam ekspor metode pembayaran.
</Warning>
...
<Step title="Validasi dan pengujian">
...
<Step title="Verifikasi pasca-migrasi">
...
<Accordion title="Kunci Publik PGP Dodo Payments">
...
<CardGroup cols={2}>
<Card title="Hubungi Dukungan" icon="envelope" href="mailto:support@dodopayments.com">
Hubungi untuk memulai migrasi Anda dan terhubung dengan Insinyur Solusi.
</Card>

<Card title="Dokumentasi API" icon="code" href="/api-reference">
