...
- Nilai metadata dapat berupa string, angka, atau boolean; string dapat memiliki panjang hingga 500 karakter
- Objek, array, dan `null` tidak diterima sebagai nilai metadata
- Anda dapat memiliki hingga 50 pasang kunci-nilai metadata per objek
