...
- `UNSUPPORTED_BILLING_CURRENCY`
  - **Pemicu:** Mata uang penagihan yang diminta tidak didukung untuk subscription ini
  - **Pesan:** Mata uang penagihan selain USD tidak didukung untuk subscription
...
- `UNSUPPORTED_CURRENCY`
  - **Pemicu:** Mata uang produk atau addon bukan mata uang yang dapat ditagihkan oleh Dodo Payments. Harga dasar dapat ditetapkan dalam mata uang apa pun yang dapat ditagihkan, jadi biasanya ini berarti kode mata uang tidak valid atau belum didukung.
  - **Pesan:** Mata uang saat ini tidak didukung / Saat ini hanya produk dalam USD dan INR yang didukung / Saat ini hanya USD dan INR yang didukung untuk harga addon / Hanya dapat meminta USD atau INR untuk billing_currency / Mata Uang Tidak Didukung / Mata uang tidak terduga untuk subscription kartu India
