...
<AccordionGroup>
  <Accordion title="Plugin Options">
    - <b>client</b> (wajib): Instance klien DodoPayments
    - <b>createCustomerOnSignUp</b> (opsional): Auto-buat pelanggan saat pengguna mendaftar
    - <b>use</b> (wajib): Array plugin yang diaktifkan (checkout, portal, penggunaan, webhooks)
    - <b>getCustomerParams</b> (opsional): Fungsi yang menerima BetterAuth `User` dan mengembalikan field tambahan untuk dilampirkan ke pelanggan DodoPayments saat pembuatan dan pembaruan (misalnya `metadata`, `phone_number`)
  ...
  <Accordion title="Checkout Plugin Options">
    - <b>products</b>: Array produk atau fungsi asinkron yang mengembalikan produk -{" "}
    <b>successUrl</b>: URL untuk diarahkan setelah pembayaran berhasil -{" "}
    <b>authenticatedUsersOnly</b>: Memerlukan autentikasi pengguna (default: false)
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion title="Common Issues">
    - <b>Kunci API tidak valid</b>: Periksa kembali <code>DODO_PAYMENTS_API_KEY</code> Anda di <code>.env</code>. -{" "}
    <b>Tanda tangan webhook tidak cocok</b>: Pastikan rahasia webhook cocok dengan yang disetel di Dashboard Dodo Payments. - <b>Pelanggan tidak dibuat</b>: Konfirmasi <code>createCustomerOnSignUp</code> diatur ke <code>true</code>.
  </Accordion>
  <Accordion title="Best Practices">
    - Gunakan variabel lingkungan untuk semua rahasia dan kunci. - Uji di <code>test_mode</code> sebelum beralih ke <code>live_mode</code>. - Catat kejadian webhook untuk debugging dan audit.
  </Accordion>
</AccordionGroup>

# Permintaan untuk LLMs
