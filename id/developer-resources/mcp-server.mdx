...
<Tab title="Claude Desktop">
Atur server MCP Pembayaran Dodo di Claude Desktop untuk mengaktifkan akses percakapan ke data pembayaran Anda.
<Steps>
...
Atur server MCP Pembayaran Dodo di Cline (VS Code) untuk mengaktifkan akses percakapan ke data pembayaran Anda.
<Steps>
...
Saat menerapkan secara jarak jauh, selalu memerlukan otentikasi melalui header `Authorization` atau header `x-dodo-payments-api-key`.
