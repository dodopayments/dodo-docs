...
[Dodo Agent Plugin](/developer-resources/build-with-ai-coding-agents) menginstal kedua server MCP dan ketujuh belas skill dalam satu langkah untuk Claude Code, Codex CLI, Cursor, dan OpenCode. Lihat [panduan AI Coding Agents](/developer-resources/build-with-ai-coding-agents) untuk perintah instalasi khusus setiap agen.
