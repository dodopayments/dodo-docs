...
[Dodo Agent Plugin](/developer-resources/build-with-ai-coding-agents) menginstal kedua MCP servers dan ketujuh belas skills dalam satu langkah untuk Claude Code, Codex CLI, Cursor, VS Code / GitHub Copilot, Kiro, dan OpenCode. Gemini CLI hanya mendapatkan kedua MCP servers, karena tidak memiliki primitive agent-skill. Lihat [panduan AI Coding Agents](/developer-resources/build-with-ai-coding-agents) untuk perintah instalasi per-agent.
