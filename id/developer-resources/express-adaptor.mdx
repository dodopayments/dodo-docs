...
Menetapkan jumlah yang ditagihkan dalam unit utama mata uang (misalnya, <code>12.5</code> untuk $12.50). Hanya untuk produk Pay What You Want dan diabaikan jika nilainya di bawah harga minimum produk.
</ParamField>
