...
[Dodo Payments CLI](/developer-resources/sdks/cli) menyediakan dua perintah untuk menguji webhook selama pengembangan lokal tanpa perlu meninggalkan terminal.
...
| Mode | Fungsinya | Yang ditetapkan |
|------|--------------|--------------|
| **Recover failed messages** | Me-replay setiap pesan ke endpoint ini yang gagal. | Titik awal: **8 hours ago**, **Yesterday**, **3 days ago**, **Last week**, atau **2 weeks ago** |
| **Replay missing messages** | Me-replay pesan yang tidak pernah dikirim ke endpoint ini, misalnya setelah Anda membuatnya berlangganan jenis event baru. | Titik awal yang sama |
| **Bulk replay messages** | Me-replay pesan yang sesuai dengan filter yang Anda pilih, termasuk pesan yang sudah berhasil dikirim. | Batas **Since** dan **Until**, dengan default dua minggu terakhir, serta jenis event, channel, atau tag opsional |
