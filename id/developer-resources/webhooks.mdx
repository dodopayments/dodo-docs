...
<Step title="Access Webhook Settings">
    Buka dasbor DodoPayments dan pergi ke `Developer > Webhooks`.
</Step>
...
<Step title="Navigate to Webhook Details">
    Buka dasbor Dodo Payments Anda dan navigasikan ke `Developer > Webhooks`.
</Step>
...
{/* LOCKED_PATTERN_e00062f1a73be4cdce7478c87f820958 */}
  Referensi API untuk membuat dan mengonfigurasi endpoint webhook secara programmis
</Card>
