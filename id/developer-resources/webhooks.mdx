...
<Expandable title="Data object properties">
  ...
  Jenis sumber daya. Salah satu dari: `Payment`, `Subscription`, `Refund`, `Dispute`, `LicenseKey`, `CreditLedgerEntry`, `CreditBalanceLow`, `AbandonedCheckout`, `DunningAttempt`, atau `EntitlementGrant`.
  </ResponseField>
  
  Bidang tambahan bervariasi berdasarkan jenis acara. Lihat dokumentasi khusus acara untuk skema lengkap.
</Expandable>
</ResponseField>
...
Alat interaktif ini memungkinkan Anda memilih dari semua jenis acara yang didukung dan mengirimkan payload tiruan yang realistis ke endpoint Anda. Alat ini berulang sehingga Anda dapat menguji beberapa acara dalam satu sesi.
...
<Frame>
    <img src="/images/webhooks/activity.png" alt="Aktivitas" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/images/webhooks/alerting.png" alt="Pengaturan Peringatan Webhook menunjukkan konfigurasi notifikasi email" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
