...
**Contoh:** `1` untuk item tunggal, `3` untuk kuantitas ganda
</ParamField>
...
**Pilihan Tersedia**: `credit`, `debit`, `upi_collect`, `apple_pay`, `google_pay`, `amazon_pay`, `klarna`, `affirm`, `afterpay_clearpay`, `cashapp`, `multibanco`, `bancontact_card`, `eps`, `ideal`, `przelewy24`, `paypal`
...
<Card title="Pranala API Preview" icon="code" href="/api-reference/checkout-sessions/preview">
...
### Perbedaan Utama
Sebelumnya, saat membuat tautan pembayaran dengan Tautan Dinamis, Anda diminta untuk memberikan alamat penagihan lengkap pelanggan.

Dengan Sesi Checkout, ini tidak lagi diperlukan. Anda dapat dengan mudah melewatkan informasi yang Anda miliki, dan kami akan menangani sisanya. Contohnya:
