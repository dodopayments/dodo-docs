...
- API key Anda (`DODO_PAYMENTS_API_KEY`) dan webhook secret key dari dashboard. Lihat [panduan pembuatan API key](/api-reference/introduction#api-key-management-and-authentication).
- Endpoint backend yang dapat menerima webhook.
