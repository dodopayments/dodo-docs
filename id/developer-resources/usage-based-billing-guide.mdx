...
<Frame>
<img src="/images/guides/usage-based-billing/meter-quantities-chart.png" alt="Grafik kuantitas meter menunjukkan tren penggunaan dari waktu ke waktu dengan visualisasi gradasi ungu" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/guides/usage-based-billing/events-table.png" alt="Tabel acara menampilkan nama acara, ID, dan kontrol paginasi untuk analisis acara yang lebih mendetail" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
- Properti: `hour`, Pembanding: `greater_than_or_equals`, Nilai: `9`
