...
**Contoh**: Menetapkan `$0.50` per unit berarti:
- 1.000 unit yang digunakan = 1.000 × $0,50 = 500,00 dikenakan
- 500 unit yang digunakan = 500 × $0,50 = 250,00 dikenakan
- 100 unit yang digunakan = 100 × $0,50 = 50,00 dikenakan
</ParamField>
...
- Jenis Agregasi: Jumlah
- Berdasarkan Properti: `bytes`
