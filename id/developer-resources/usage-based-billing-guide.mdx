...
## Referensi API yang Terkait

<CardGroup cols={2}>
{/* LOCKED_PATTERN_e11b972ff38970af092497ad2b5da99c */}
  Referensi API untuk membuat dan mengkonfigurasi pengukur penggunaan dalam melacak konsumsi pelanggan
</Card>
{/* LOCKED_PATTERN_b87752b420a84d90b09130bc3e896ab1 */}
  Referensi API untuk mengirimkan peristiwa penggunaan ke meteran yang telah Anda konfigurasi untuk perhitungan penagihan
</Card>
</CardGroup>
