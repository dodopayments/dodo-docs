---
title: Adaptor Next.js
description: Pelajari cara mengintegrasikan Dodo Payments dengan proyek Next.js
...
<Card title="Checkout Handler" icon="cart-shopping" href="#checkout-route-handler">
    Integrasikan checkout Dodo Payments dengan alur statis, dinamis, dan sesi.
</Card>
...
<Warning>
Jangan pernah meng-commit file <code>.env</code> atau rahasia ke versi kontrol.
</Warning>
</Step>
</Steps>
...
<Tab title="Checkout Handler">
  <Info>
  Gunakan handler ini untuk mengintegrasikan checkout Dodo Payments ke dalam aplikasi Next.js Anda. Mendukung alur pembayaran statis (GET), dinamis (POST), dan sesi checkout (POST).
  </Info>
  <CodeGroup>
...
<Tab title="Webhook Handler">
  <Info>
  Gunakan handler ini untuk menerima dan memproses event webhook Dodo Payments secara aman di aplikasi Next.js Anda.
  </Info>
  <CodeGroup>
...
Pengenal produk (misalnya, <code>?productId=pdt_nZuwz45WAs64n3l07zpQR</code>).
</ParamField>
...
Customer Portal Route Handler memungkinkan Anda mengintegrasikan customer portal Dodo Payments ke dalam aplikasi Next.js secara mulus.
...
- **Metode:** Hanya request POST yang didukung. Metode lainnya mengembalikan 405.
