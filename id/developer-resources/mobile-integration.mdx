...
[React Native](/developer-resources/sdks/react-native) untuk handler
lengkapnya.
</Tab>
<Tab title="Expo">
...
<Warning>
`@dodopayments/react-native-checkout` juga menyediakan plugin konfigurasi Expo, tetapi
saat ini tidak menulis skema URL maupun placeholder manifest. Menambahkannya saja
**tidak akan** mendaftarkan skema callback Anda — gunakan konfigurasi di atas. Lihat
halaman [React Native SDK](/developer-resources/sdks/react-native).
</Warning>
