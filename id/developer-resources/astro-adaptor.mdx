...
<Tab title="Pengelola Checkout">
  <Info>
  Gunakan pengelola ini untuk mengintegrasikan checkout Dodo Payments ke dalam aplikasi Astro Anda. Mendukung alur pembayaran statis (GET), dinamis (POST), dan sesi (POST).
  </Info>
  <CodeGroup>
...
<Tab title="Pengelola Webhook">
  <Info>
  Gunakan pengelola ini untuk menerima dan memproses acara webhook Dodo Payments dengan aman di aplikasi Astro Anda.
  </Info>
  <CodeGroup>
...
Setiap parameter kuery yang dimulai dengan <code>metadata_</code> akan diteruskan sebagai metadata.
</ParamField>
