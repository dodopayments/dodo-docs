...
Tentukan currency pembayaran (misalnya, <code>USD</code>).
</ParamField>
<ParamField query="showCurrencySelector" type="boolean">
Tampilkan pemilih currency.
</ParamField>
...
Query parameter apa pun yang diawali dengan <code>metadata_</code> akan diteruskan sebagai metadata.
</ParamField>
