...
Menetapkan jumlah yang ditagihkan dalam satuan utama mata uang (misalnya, <code>12.5</code> untuk $12.50). Hanya untuk produk Pay What You Want, dan diabaikan jika berada di bawah harga minimum produk.
</ParamField>
...
Customer Portal Route Handler memungkinkan Anda mengintegrasikan portal pelanggan Dodo Payments ke dalam aplikasi Remix dengan lancar.
