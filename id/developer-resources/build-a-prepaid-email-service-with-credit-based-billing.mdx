...
description: Build MailKit, a transactional email platform with prepaid email
  credits. A monthly subscription plan, one-time top-up packs, instant credit
  deduction on every send, and proactive low-balance alerts powered by Resend
  and Dodo Payments.
icon: envelope
keywords:
  - Dodo Payments
