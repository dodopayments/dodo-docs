...
- **Jenis Agregasi**: `sum` untuk melacak durasi total
- **Properti Atas**: `durationSeconds`, `durationMinutes`, atau `durationMs`
</Step>
...
<Warning>
**Pengukuran Waktu Akurat**: Gunakan `Date.now()` atau `performance.now()` untuk pelacakan waktu yang akurat, terutama untuk fungsi tanpa server.
</Warning>
