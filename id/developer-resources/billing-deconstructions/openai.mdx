...
keywords: ["Dodo Payments", "OpenAI", "OpenAI billing", "token-based pricing", "billing model", "openai billing model"]
---
...
<Steps>
  ...
  <Step title="Create Usage Meters">
    ...
    * **Output Tokens:** 1,000,000 tokens / \$10.00 = 100,000 tokens per \$1.
    ...
    In the Dodo dashboard, you would set the "Meter units per credit" to 4,000 for input and 1,000 for output. Credits are denominated in cents, so one credit buys 1/100th of the per-dollar figures above.
  </Step>
