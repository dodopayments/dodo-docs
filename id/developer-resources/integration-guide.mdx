...
2. Buat produk (pembayaran satu kali atau berlangganan). Produk berlangganan harus memiliki harga setidaknya **$1** (atau setara dengan mata uang yang Anda pilih); jumlah di bawah minimum ini tidak didukung.
...
<Card title="Create Checkout Session" icon="code" href="/api-reference/checkout-sessions/create">
  Referensi API untuk membuat sesi pembayaran ter-host yang aman untuk pembayaran satu kali dan langganan
</Card>
<Card title="Create Payment Link" icon="link" href="/api-reference/payments/post-payments">
  Referensi API untuk membuat tautan pembayaran dinamis secara programatis
</Card>
</CardGroup>