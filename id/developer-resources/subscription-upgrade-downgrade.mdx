...
<Info>
Kredit yang dibuat melalui downgrade menggunakan <code>difference_immediately</code> memiliki cakupan langganan dan berbeda dari hak istimewa <a href="/features/credit-based-billing">Credit-Based Billing</a>. Kredit tersebut secara otomatis diterapkan pada perpanjangan di masa mendatang untuk langganan yang sama dan tidak dapat dipindahkan antar langganan.
</Info>
