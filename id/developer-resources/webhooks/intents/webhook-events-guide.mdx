...
|--------------------------|---------------------------|---------------------------------------------------------------------------------|
| **Subscription Active**  | `subscription.active`    | Menunjukkan bahwa subscription kini aktif dan biaya berulang telah dijadwalkan.|
| **Subscription Updated** | `subscription.updated`   | Dipicu saat field subscription apa pun diperbarui (sinkronisasi real-time tanpa polling). |
| **Subscription On Hold** | `subscription.on_hold`   | Dipicu saat subscription untuk sementara ditangguhkan karena renewal gagal. |
| **Subscription Paused**  | `subscription.paused`    | Dipicu saat subscription dijeda.                                        |
| **Subscription Renewed** | `subscription.renewed`   | Terjadi saat subscription berhasil diperbarui.                              |
| **Subscription Plan Changed** | `subscription.plan_changed` | Dipicu saat subscription di-upgrade, di-downgrade, atau diubah dengan addon yang berbeda. |
| **Subscription Payment Method Updated** | `subscription.update_payment_method` | Dikirim saat payment method subscription diperbarui. Membawa payload Subscription. |
| **Subscription Cancelled** | `subscription.cancelled` | Dipicu saat subscription dibatalkan oleh merchant atau customer.         |
| **Subscription Failed**  | `subscription.failed`    |  Menunjukkan subscription yang gagal. Ini berarti kami tidak dapat membuat mandate. |
| **Subscription Expired** | `subscription.expired`   | Dipicu saat subscription mencapai akhir masa berlakunya dan kedaluwarsa.          |
