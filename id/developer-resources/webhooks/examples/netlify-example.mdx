...
2. Klik pada fungsi `webhook`
3. Lihat log waktu nyata dan riwayat pemanggilan
...
| Kesalahan koneksi database | Verifikasi string koneksi Neon dan gunakan koneksi terkelola |
| Fungsi tidak ditemukan (404) | Jalankan `netlify init` dan `npm run deploy` lagi |
| Variabel env tidak tersedia | Atur variabel di CLI atau dasbor, lalu redeploy |
