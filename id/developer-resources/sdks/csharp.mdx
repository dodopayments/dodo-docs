...
SDK menghasilkan pengecualian spesifik berdasarkan kode status HTTP. Semua error 4xx mewarisi dari `DodoPayments4xxException`.
...
<Tip>
Untuk pengembangan, gunakan [rahasia pengguna](https://learn.microsoft.com/en-us/aspnet/core/security/app-secrets) daripada menyimpan kunci di `appsettings.json`:
