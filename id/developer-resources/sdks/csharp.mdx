...
SDK melempar exception tertentu berdasarkan status code HTTP. Semua error 4xx mewarisi `DodoPayments4xxException`.

| Status | Exception                                   |
| ------ | ------------------------------------------- |
| 400    | `DodoPaymentsBadRequestException`           |
| 401    | INLINE_CODE_PLACEHOLDER_45880aad96d175132_END         |
...
<Tip>
Untuk development, gunakan [user secrets](https://learn.microsoft.com/en-us/aspnet/core/security/app-secrets) alih-alih menyimpan key di `appsettings.json`:
