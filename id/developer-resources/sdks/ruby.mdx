...
<Tip>
Selalu gunakan versi SDK terbaru untuk mengakses fitur Dodo Payments yang terbaru. Jalankan `bundle update dodopayments` secara rutin agar tetap terupdate.
</Tip>
