...
<Info>
Acara harus memiliki nilai `event_id` yang unik untuk idempotensi. ID duplikat dalam permintaan yang sama ditolak, dan permintaan selanjutnya dengan ID yang ada diabaikan.
</Info>
...
Metode daftar dalam API DodoPayments dipaginasi. Anda dapat menggunakan sintaks `for await … of` untuk iterasi melalui item di semua halaman:
...
- Peramban web (Chrome, Firefox, Safari, Edge terbaru, dan lainnya)
- Node.js 20 LTS atau versi lebih tinggi ([non-EOL](https://endoflife.date/nodejs))
