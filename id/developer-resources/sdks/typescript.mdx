...
<CardGroup cols={2}>
<Card title="TypeScript Pertama" icon="shield-check">
...
<Card title="Penanganan Kesalahan" icon="triangle-exclamation">
  Tipe kesalahan bawaan dengan pesan rinci untuk berbagai skenario kegagalan
</Card>

<Card title="Pengulangan Cerdas" icon="repeat">
...
<Info>
Acara harus memiliki nilai `event_id` yang unik untuk idempotensi. ID duplikat dalam permintaan yang sama akan ditolak, dan permintaan berikutnya dengan ID yang ada akan diabaikan.
</Info>
...
Metode daftar dalam API DodoPayments dipaginasi. Anda dapat menggunakan sintaks `for await … of` untuk mengiterasi melalui item di semua halaman:
...
- Node.js 20 LTS atau versi lebih baru ([non-EOL](https://endoflife.date/nodejs))
...
<CardGroup cols={2}>
<Card title="Repositori GitHub" icon="github" href="https://github.com/dodopayments/dodopayments-typescript">
...
<Card title="Laporkan Masalah" icon="bug" href="https://github.com/dodopayments/dodopayments-typescript/issues">
