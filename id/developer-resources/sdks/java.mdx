...
<Tip>
Selalu gunakan versi SDK terbaru untuk mengakses fitur Dodo Payments terbaru. Periksa [Maven Central](https://central.sonatype.com/artifact/com.dodopayments.api/dodo-payments-java) untuk versi terbaru.
</Tip>

<Info>
SDK mendukung Java 8 dan semua versi setelahnya, termasuk Java 11, 17, dan 21.
</Info>
...
<Warning>
Selalu simpan kunci API Anda dengan aman menggunakan variabel lingkungan, properti sistem, atau sistem manajemen konfigurasi yang aman. Jangan pernah mengkodekannya secara langsung dalam kode sumber Anda.
</Warning>
...
<Card title="Keamanan Tipe" icon="shield-check">
  API yang diketik dengan kuat dengan keamanan waktu kompilasi
</Card>

<Card title="Aman untuk Thread" icon="bolt">
  Aman untuk digunakan secara bersamaan dalam aplikasi multi-threaded
</Card>

<Card title="Pola Builder" icon="layer-group">
  Pola builder yang intuitif untuk membangun permintaan
</Card>

<Card title="Dukungan Async" icon="arrows-rotate">
...
<Tip>
SDK secara otomatis mencoba ulang permintaan pada kesalahan koneksi, 408, 409, 429, dan kesalahan 5xx dengan backoff eksponensial.
</Tip>
...
<CardGroup cols={2}>
<Card title="Repositori GitHub" icon="github" href="https://github.com/dodopayments/dodopayments-java">
...
<Card title="Laporkan Masalah" icon="bug" href="https://github.com/dodopayments/dodopayments-java/issues">
