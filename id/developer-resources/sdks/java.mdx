...
<Info>
`productPrice` dinyatakan dalam denominasi mata uang terendah (misalnya, sen untuk USD, paise untuk INR). Untuk menagih $25,00, kirimkan `2500`.
</Info>

<Tip>
Penagihan melalui `subscriptions().charge(...)` dimaksudkan untuk [langganan sesuai permintaan](/developer-resources/ondemand-subscriptions). Langganan terjadwal standar ditagih secara otomatis berdasarkan jadwal harga produk.
</Tip>

## Penagihan Berbasis Penggunaan

### Mengonfigurasi Meter

Buat dan kelola meteran untuk melacak penggunaan:
...
### Memasukkan Acara Secara Batch

Masukkan beberapa acara secara efisien (maksimal 1000 per permintaan):
...
<Tip>
SDK secara otomatis mengulangi permintaan pada kesalahan koneksi, 408, 409, 429, dan kesalahan 5xx dengan backoff eksponensial.
</Tip>
...
- **GitHub**: Buka isu di [repository](https://github.com/dodopayments/dodopayments-java)
