...
2. Perbarui ID produk dan add-on di kode Anda dengan nilai sebenarnya dari dasbor Dodo Payments Anda
3. Mulai server Anda:
...
2. Anda harus melihat antarmuka demo harga berbasis kursi
3. Coba jumlah kursi yang berbeda (0, 3, 10, dll.)
4. Klik "Hasilkan Tautan Checkout" untuk setiap jumlah
5. Verifikasi bahwa URL checkout telah dihasilkan dengan benar
