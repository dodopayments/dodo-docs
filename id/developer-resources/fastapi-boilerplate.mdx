...
<Card title="Repositori GitHub" icon="github" href="https://github.com/dodopayments/fastapi-boilerplate">
...
<Info>
Boilerplate ini menggunakan FastAPI dengan pola async/await, Pydantic untuk validasi, dan SDK Python `dodopayments` untuk integrasi API yang mulus.
</Info>
...
<Step title="Buat Lingkungan Virtual">
...
<Step title="Instal Ketergantungan">
...
<Warning>
Jangan pernah mengkomit file `.env` ke kontrol versi. Ini sudah termasuk di `.gitignore`.
</Warning>
</Step>
...
- Ganti `DODO_PAYMENTS_ENVIRONMENT` dengan `live_mode`
...
<AccordionGroup>
<Accordion title="Kesalahan impor atau modul yang hilang">
...
<Accordion title="Kesalahan saat membuat sesi checkout">
**Penyebab umum:**
- ID produk tidak valid - verifikasi bahwa itu ada di dasbor Dodo Anda
- Kunci API atau pengaturan lingkungan salah di `.env`
...
- Pastikan `DODO_PAYMENTS_WEBHOOK_KEY` disetel dengan benar di `.env`
