---
title: Bun Adaptor
description: Pelajari cara mengintegrasikan <CardGroup cols={2}> dengan proyek server Bun
  Anda menggunakan Bun Adaptor kami. Mencakup checkout, portal pelanggan,
  webhook, dan penyiapan environment yang aman.
icon: code-merge
keywords:
  - Dodo Payments
  - Bun
...
Pengenal produk (misalnya, <code>?productId=pdt_xxx</code>).
</ParamField>
...
Menetapkan jumlah yang dikenakan biaya dalam unit utama mata uang (misalnya, <code>12.5</code> untuk $12.50). Hanya untuk produk Pay What You Want, dan diabaikan jika nilainya di bawah harga minimum produk.
</ParamField>
