...
Catatan Keamanan: Jangan memasukkan rahasia ke dalam kontrol versi. Gunakan file .env secara lokal dan pengelola rahasia di lingkungan deployment (misalnya, AWS, Vercel, Heroku, dll.).