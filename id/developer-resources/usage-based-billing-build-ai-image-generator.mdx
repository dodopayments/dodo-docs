...
**Nama Acara**: Ini penting - salin persis → `image.generated`
...
1. **Aktifkan Penyaringan Acara**: Alihkan ini **NYALAKAN**
2. **Logika Penyaringan**: Pilih **ATAU** (ini berarti "hitung jika SATU dari kondisi ini benar")
...
Selain itu, atur **Harga Tetap** ke `0` untuk memastikan pelanggan hanya dikenakan biaya berdasarkan penggunaan mereka, tanpa biaya dasar.
...
2. Tambahkan kunci API sebenarnya Anda:
