...
Apple Pay memungkinkan pelanggan untuk menyelesaikan pembayaran dengan cepat dan aman menggunakan metode pembayaran yang disimpan. Saat diaktifkan, pelanggan dapat meluncurkan modal Apple Pay langsung dari overlay checkout di perangkat yang didukung.
...
<Steps>
<Step title="Unduh dan unggah file asosiasi domain Apple Pay">
...
Unggah file tersebut ke server web Anda di `/.well-known/apple-developer-merchantid-domain-association`. Misalnya, jika situs web Anda adalah `example.com`, buat file tersebut tersedia di `https://example.com/well-known/apple-developer-merchantid-domain-association`.

</Step>

<Step title="Minta aktivasi Apple Pay">

Kirim email ke **support@dodopayments.com** dengan informasi berikut:
...
<Step title="Verifikasi ketersediaan Apple Pay">
