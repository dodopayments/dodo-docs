...
<CardGroup cols={2}>
<Card title="Pengelola Checkout" icon="cart-shopping" href="#checkout-route-handler">
    Integrasikan checkout Dodo Payments ke dalam aplikasi SvelteKit Anda.
</Card>
<Card title="Portal Pelanggan" icon="user" href="#customer-portal-route-handler">
...
<Tabs>
<Tab title="Pengelola Checkout">
  <Info>
  Gunakan pengelola ini untuk mengintegrasikan checkout Dodo Payments ke dalam aplikasi SvelteKit Anda. Mendukung alur pembayaran statis (GET), dinamis (POST), dan sesi (POST).
  </Info>
  <CodeGroup>
...
<Tab title="Pengelola Portal Pelanggan">
  <Info>
  Gunakan pengelola ini untuk memungkinkan pelanggan mengelola langganan dan detail mereka melalui portal pelanggan Dodo Payments.
  </Info>
  <CodeGroup>
...
<Tab title="Pengelola Webhook">
  <Info>
  Gunakan pengelola ini untuk menerima dan memproses peristiwa webhook Dodo Payments dengan aman di aplikasi SvelteKit Anda.
  </Info>
  <CodeGroup>
...
Parameter kuery apa pun yang dimulai dengan <code>metadata_</code> akan diteruskan sebagai metadata.
</ParamField>

<Warning>
Jika <code>productId</code> hilang, pengelola mengembalikan respons 400. Parameter kuery yang tidak valid juga menghasilkan respons 400.
</Warning>
...
- Untuk daftar lengkap bidang body POST yang didukung, lihat:
  - [Body permintaan untuk Produk Pembayaran Satu Kali](https://docs.dodopayments.com/api-reference/payments/post-payments)
...
Sesi checkout menyediakan pengalaman checkout yang lebih aman dan dihosting yang menangani alur pembayaran lengkap untuk pembelian satu kali dan langganan dengan kontrol kustomisasi penuh.
...
Pengelola Rute Portal Pelanggan memungkinkan Anda untuk mengintegrasikan portal pelanggan Dodo Payments ke dalam aplikasi SvelteKit Anda dengan mulus.
