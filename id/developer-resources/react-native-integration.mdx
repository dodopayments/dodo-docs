...
<Step title="Pengaturan Penyedia Pembayaran">
...
Anda dapat menyesuaikan React Native Unified Checkout untuk mencocokkan desain aplikasi Anda dengan memodifikasi warna, font, dan lainnya melalui parameter penampilan saat memanggil `initPaymentSession()`.
