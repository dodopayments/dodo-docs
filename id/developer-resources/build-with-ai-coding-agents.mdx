...
- **Membuat sesi checkout dan link pembayaran** — [Pembayaran sekali](/features/one-time-payment-products) dan [langganan](/features/subscription)
- **Menjalankan penagihan berbasis langganan dan penggunaan secara end-to-end** — [Langganan](/features/subscription), [Penagihan berbasis penggunaan](/features/usage-based-billing), [Penagihan berbasis kredit](/features/credit-based-billing)
- **Menghasilkan handler yang sesuai dengan Standar Webhooks** dengan verifikasi tanda tangan — [Webhooks](/developer-resources/webhooks)
...
- **Menerapkan penagihan berbasis kredit** dengan hak, saldo, rollover, dan kelebihan — [Kredit](/features/credit-based-billing)
