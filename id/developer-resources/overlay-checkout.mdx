...
Unggah file ke server web Anda di `/.well-known/apple-developer-merchantid-domain-association`. Misalnya, jika situs web Anda adalah `example.com`, buat file tersedia di `https://example.com/well-known/apple-developer-merchantid-domain-association`.
...
<Tip>
Gunakan **overlay checkout** untuk integrasi yang lebih cepat dengan perubahan minimal pada halaman yang ada. Gunakan **inline checkout** ketika Anda menginginkan kontrol maksimum atas pengalaman checkout dan branding yang mulus.
</Tip>
...
<Card title="Webhooks" icon="webhook" href="/developer-resources/webhooks">
    Tangani acara pembayaran di sisi server dengan webhooks.
</Card>
