...
<Info>
Bagian ini membahas konfigurasi tema **di sisi klien** menggunakan SDK Checkout. Anda juga dapat mengonfigurasi tema **di sisi server** saat membuat sesi checkout melalui API menggunakan parameter `theme_config`. Lihat [Kustomisasi Tema Checkout](/features/checkout#checkout-theme-customization) untuk konfigurasi tingkat API, atau gunakan [halaman Desain](/features/design) di dasbor untuk mengonfigurasi tema secara visual dengan pratinjau langsung.
</Info>
