...
<Step title="Inisialisasi Proyek">
...
1. Mengunduh konfigurasi komponen dari registry
2. Menginstal file komponen di direktori `components/billingsdk/`
3. Memperbarui konfigurasi proyek Anda jika diperlukan
4. Menginstal ketergantungan tambahan

## Struktur File yang Dihasilkan

Setelah menjalankan `init`, Anda akan mendapatkan struktur proyek yang lengkap dengan:
...
<CardGroup cols={3}>
  <Card title="Dokumentasi Lengkap" icon="book" href="https://billingsdk.com/docs">
    Panduan lengkap untuk Billing SDK dengan contoh dan praktik terbaik
  </Card>
  <Card title="Referensi CLI" icon="terminal" href="https://billingsdk.com/docs/cli">
    Dokumentasi CLI terperinci untuk semua perintah dan opsi
  </Card>
  <Card title="Perpustakaan Komponen" icon="boxes-stacked" href="https://billingsdk.com/docs/components">
