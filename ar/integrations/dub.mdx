...
<Step title="Open the Webhook Section">
  في لوحة تحكم Dodo Payments، انتقل إلى **Webhooks → + إضافة Endpoint** وقم بتوسيع قائمة التكاملات المنسدلة.
  <Frame>
    <img src="/images/integrations/dub/add.png" alt="إضافة Endpoint وقائمة التكاملات المنسدلة" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
...
<Step title="Enter API Key">
  قم بتزويد مفتاح Dub API الخاص بك في حقل الإعدادات.
  <Frame>
    <img src="/images/integrations/dub/api-key.png" alt="إضافة مفتاح API" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
