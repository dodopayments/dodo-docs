...
<Step title="Open the Webhook Section">
  في لوحة معلومات دفعات Dodo، انتقل إلى <b>Webhooks → + إضافة نقطة نهاية</b> وقم بتوسيع القائمة المنسدلة للتكاملات.
  <Frame>
...
<Step title="Enter API Key">
  قدّم مفتاح API الخاص بك لـ DataFast في حقل التكوين.
  <Frame>
