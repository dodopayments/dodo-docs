...
<Step title="Open the Webhook Section">
  في لوحة تحكم Dodo Payments الخاصة بك، انتقل إلى <b>Webhooks → + Add Endpoint</b> وافتح قائمة الدمج المنسدلة.
  <Frame>
    <img src="/images/integrations/inngest.png" alt="إضافة نقطة النهاية وقائمة الدمج المنسدلة" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
