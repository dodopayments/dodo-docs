...
<Step title="Open the Webhook Section">
  في لوحة معلومات Dodo Payments الخاصة بك، انتقل إلى <b>Webhooks + إضافة الواجهة النهائية</b> وقم بتوسيع قائمة التكامل.
  <Frame>
    <img src="/images/integrations/mailerlite.png" alt="إضافة الواجهة النهائية وقائمة التكامل" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
