...
<Step title="Open the Webhook Section">
  في لوحة معلومات Dodo Payments الخاصة بك، انتقل إلى <b>Webhooks → + إضافة نقطة نهاية</b> وقم بتوسيع القائمة المنسدلة للتكاملات.
  <Frame>
    <img src="/images/integrations/windmill.png" alt="إضافة نقطة نهاية وقائمة التكاملات المنسدلة" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
