...
<Step title="Open the Webhook Section">
  انتقل إلى قسم <b>Webhook</b> في لوحة تحكم Dodo Payments الخاصة بك. انقر فوق زر <b>+ إضافة نقطة نهاية</b>، ثم افتح قائمة الـ webhook للكشف عن عمليات الدمج الأخرى.
  <Frame>
    <img src="/images/integrations/slack/1.png" alt="لوحة تحكم Dodo Payments تعرض زر إضافة نقطة نهاية وقائمة منسدلة للتكاملات" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>

<Step title="Select Slack Integration">
  اختر تكامل <b>Slack</b> وانقر على <b>ربط مساحة عمل Slack الخاصة بك</b>.
  <Frame>
    <img src="/images/integrations/slack/2.png" alt="بطاقة تكامل Slack وزر الربط" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>

<Step title="Grant Slack Permissions">
  قم بمنح الأذونات اللازمة لتطبيق Incoming Webhooks Slack حتى يتمكن من نشر الرسائل في القناة التي تختارها.
  <Frame>
    <img src="/images/integrations/slack/3.png" alt="شاشة أذونات OAuth لتطبيق Incoming Webhooks" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>

<Step title="Customize Transformation Code">
  أضف أو حرر كود التحويل لتخصيص إشعارات Slack حسب احتياجك. يمكنك استخدام القوالب الجاهزة أو كتابة منطقك الخاص.
  <Frame>
    <img src="/images/integrations/slack/4.png" alt="محرر كود التحويل لتكامل Slack" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>

<Step title="Test and Create">
  قم باختبار كود التحويل الخاص بك باستخدام بيانات الأحداث المخصصة أو الجاهزة. عند رضاك، اضغط على <b>إنشاء</b> لتفعيل التكامل.
  <Frame>
    <img src="/images/integrations/slack/5.png" alt="اختبار التحويل وزر الإنشاء" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
...
- استخدم مرفقات الرسائل الغنية التي تتضمن الألوان والحقول والتنسيق لتحقيق الوضوح وقابلية اتخاذ الإجراءات.
- احرص دائمًا على تضمين البيانات الأساسية مثل المبالغ ورسائل البريد الإلكتروني للعملاء والمعرّفات لسهولة التعرّف السريع.
- اختر ألوانًا تتوافق مع نوع الحدث: الأخضر (`good`) للنجاح، والأحمر (`danger`) للنزاعات أو حالات الفشل، والأصفر (`warning`) لعمليات الإلغاء، والأزرق (`#3aa3e3`) للأحداث الإعلامية.
- أضف طوابع زمنية للمساعدة في تتبّع وقت وقوع كل حدث.
