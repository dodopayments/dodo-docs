...
<Step title="Open the Webhook Section">
  في لوحة تحكم Dodo Payments الخاصة بك، انتقل إلى <b>Webhooks → + إضافة نقطة نهاية</b> وقم بتوسيع قائمة الدمج المنسدلة.
  <Frame>
    <img src="/images/integrations/n8n.png" alt="إضافة نقطة نهاية وقائمة الدمج المنسدلة" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
