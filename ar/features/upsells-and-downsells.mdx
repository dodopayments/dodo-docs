...
|------|----------|----------|
| `difference_immediately` | يفرض فرق السعر فورًا ($30→$80 = $50) | ترقيات بسيطة |
| `prorated_immediately` | يفرض الرسوم بناءً على الوقت المتبقي في دورة الفوترة | فوترة عادلة حسب الوقت |
| `full_immediately` | يفرض سعر الخطة الجديدة بالكامل، متجاهلًا الوقت المتبقي | إعادة ضبط دورة الفوترة |
| `do_not_bill` | يطبّق تغيير الخطة من دون فرض رسوم فورية؛ تتم فوترة الخطة الجديدة عند التجديد التالي، مع الحفاظ على تاريخ الفوترة الأصلي | الترقيات المجانية وعمليات الترحيل المجانية |
