...
<Info>
الاعتمادات الناتجة عن التخفيض باستخدام `difference_immediately` تكون مخصصة للاشتراك وتُطبق تلقائيًا على التجديدات المستقبلية. وهي متميزة عن [Customer Credits](/features/customer-credit).
</Info>
