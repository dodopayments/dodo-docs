...
| :--- | :--- | :--- |
| **التسعير المحلي** | سعر ثابت تقوم بتحديده لكل عملة أو بلد | بالضبط المبلغ الذي تحدده |
| [**تكييف العملة**](/features/adaptive-currency) | يحول تلقائياً سعرك الأساسي بأسعار صرف العملات الحية | السعر الأساسي محول بسعر الصرف الحالي |
| [**رموز التخفيض**](/features/discount-codes) | نسبة مئوية أو تخفيض ثابت عن السعر الأساسي | السعر الأساسي ناقص الخصم |
