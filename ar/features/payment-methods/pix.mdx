...
عند مطالبتك بإدخال Pix CPF، أدخل `1234567890`. سيتم إنشاء رمز QR للاختبار — امسحه باستخدام كاميرا هاتفك العادية (لا حاجة إلى تطبيق Pix). ستتم إعادة توجيهك إلى صفحة اختبار حيث يمكنك محاكاة نجاح المعاملة أو فشلها.
</Step>
</Steps>
