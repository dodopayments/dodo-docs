...
| النوع | الطريقة | البلد |
| :--- | :----- | :------ |
| `crypto` | Stablecoins | عالمية (باستثناء IN) |
...
أنشئ جلسة دفع مع `crypto` في طرق الدفع المسموح بها.
</Step>
...
**تحقق:**
1. هل تم تضمين `crypto` في `allowed_payment_method_types`؟
2. هل المبلغ يتوافق مع الحد الأدنى ($0.50)؟
