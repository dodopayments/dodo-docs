...
يجب أن يكون الملف متاحًا بدون إعادة توجيه ويتم تقديمه مع `Content-Type: application/octet-stream` أو `text/plain`.
</Step>

<Step title="طلب تفعيل">
البريد الإلكتروني **support@dodopayments.com** مع:
...
<Warning>
تتطلب Apple Pay استخدام HTTPS. لن تظهر على `localhost` بدون إعداد SSL صحيح.
</Warning>
...
<Accordion title="تضمين بدائل البطاقة دائمًا">
ليس لدى جميع العملاء محافظ رقمية. دائمًا قم بتضمين `credit` و `debit` في طرق الدفع المسموح بها.
</Accordion>
