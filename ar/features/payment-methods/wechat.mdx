...
أنشئ جلسة دفع باستخدام `wechat_pay` في طرق الدفع المسموح بها.
</Step>
...
**تحقق:**
1. `wechat_pay` مضمنة في `allowed_payment_method_types`؟
2. هل تم تحديد عملة الفوترة بالدولار الأمريكي أو اليوان؟
3. هل يفي مبلغ المعاملة بالحد الأدنى؟
