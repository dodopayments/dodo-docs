...
<Info>
تؤدي تغييرات الخطط إلى تحصيل رسوم فورية. قد تنقل الرسوم الفاشلة الاشتراك إلى حالة `on_hold`. تتبّع التغييرات عبر أحداث webhook من نوع `subscription.plan_changed`.
</Info>
