...
### تمديد فترة الاشتراك
قم بتمديد فترة الاشتراك بتمرير `subscription_period_count` جديدة و `subscription_period_interval` إلى `PATCH /subscriptions/{id}`. يتم إعادة حساب انتهاء الاشتراك من العدد والفترة الزمنية الجديدة — على سبيل المثال، لمنح العميل وقتًا إضافيًا على خطته الحالية:
...
<Note>
يمكن فقط **زيادة** فترة الاشتراك، ولا يمكن تقصيرها أبدًا.
</Note>

### الاشتراكات عند الطلب
قم بإنشاء اشتراك عند الطلب وفرض رسوم لاحقة عند الحاجة:
...
### إعادة تنشيط الاشتراك من on_hold
إعادة تنشيط اشتراك وُضع في الانتظار بسبب فشل الدفع:
...
## الاشتراكات مع الالتزامات المتوافقة مع RBI

تعمل اشتراكات UPI وبطاقات الهند تحت لوائح RBI (بنك الاحتياطي الهندي) مع متطلبات التزام معينة:

### حدود الالتزام

يعتمد نوع الالتزام والمبلغ على الشحن الدوري لاشتراكك:

- **الرسوم أقل من حد الالتزام (افتراضيًا ₹15,000):** نقوم بإنشاء التزام عند الطلب لمبلغ الحد الأدنى. يتم تحصيل مبلغ الاشتراك بشكل دوري وفقًا لتكرار الاشتراك حتى حد الالتزام.
  - **الرسوم التي تساوي أو تزيد عن حد الالتزام:** نقوم بإنشاء التزام اشتراك (أو التزام عند الطلب) لمبلغ الاشتراك الدقيق.

يمكن تكوين حد الالتزام لكل تاجر أو لكل طلب عبر `mandate_min_amount_inr_paise` (INR paise). المبلغ المسجل لدى البنك هو `max(mandate_floor, billing_amount)` — لذا فإن الحد الأدنى يصبح عمليًا سقف التفويض المباشر للعملاء عند انخفاض الفواتير.

للحصول على معلومات تفصيلية حول الالتزامات المتوافقة مع RBI والحد الأدنى القابل للتكوين لطرق الدفع الهندية، انظر صفحة <a href="/features/payment-methods/india#configurable-mandate-floor">طرق الدفع الهندية</a>.

### اعتبارات الترقية والتخفيض

**مهم:** عند ترقية أو تخفيض الاشتراكات، يجب مراعاة حدود الالتزام بعناية:

- إذا أدت الترقية/التخفيض إلى مبلغ شحن يتجاوز ₹15,000 ويتجاوز حد الدفع الفوري القائم، فقد يفشل رسوم المعاملة.
  - في مثل هذه الحالات، قد يحتاج العميل إلى تحديث طريقة الدفع الخاصة به أو تغيير الاشتراك مرة أخرى لإنشاء التزام جديد بالحد الصحيح.

### التفويض للرسوم العالية القيمة

لرسوم الاشتراك البالغة ₹15,000 أو أكثر:
...
**جدول المعالجة:** تتبع الرسوم الدورية على البطاقات الهندية واشتراكات UPI نمط معالجة فريد:

- يتم **بدء** الرسوم في التاريخ المحدد وفقًا لتكرار الاشتراك.
  - يحدث **الخصم** الفعلي من حساب العميل بعد **48 ساعة** من بدء الدفع.
  - قد يمتد هذا النطاق الزمني البالغ 48 ساعة إلى **2-3 ساعات إضافية** اعتمادًا على استجابات واجهة برمجة التطبيقات للبنك.

### نافذة إلغاء الالتزام

خلال نافذة المعالجة لمدة 48 ساعة:

- يمكن للعملاء إلغاء الالتزام عبر تطبيقات البنوك الخاصة بهم.
  - إذا ألغى العميل الالتزام خلال هذه الفترة، سيبقى الاشتراك **نشطًا** (هذه حالة حافة خاصة بالاشتراكات عبر AutoPay البطاقات الهندية و UPI).
  - ومع ذلك، قد يفشل الخصم الفعلي، وفي هذه الحالة، سنضع الاشتراك **في الانتظار**.

**معالجة حالة الحافة:** إذا قمت بتوفير مزايا أو ائتمانات أو استخدام اشتراك للعملاء فور بدء الشحن، فستحتاج إلى معالجة هذا النطاق الزمني البالغ 48 ساعة بشكل مناسب في تطبيقك. النظر في:

- تأخير تفعيل المزايا حتى يتم تأكيد الدفع
  - تنفيذ فترات سماح أو وصول مؤقت
  - مراقبة حالة الاشتراك لإلغاء الالتزامات
  - معالجة حالات انتظار الاشتراك في منطق التطبيق الخاص بك

 <Tip>
  مراقبة الويب هوكس للاشتراك لتتبع تغييرات حالة الدفع ومعالجة حالات الحافة حيث يتم إلغاء الالتزامات خلال النطاق الزمني البالغ 48 ساعة.
  </Tip>

## أفضل الممارسات

- **ابدأ بتصنيفات واضحة**: خطتان إلى ثلاث خطط مع فروق واضحة
- **وضح التسعير**: عرض الإجماليات والتناسب والتجديد التالي
- **استخدام التجارب بإيجابية**: التحويل مع الإعداد وليس فقط الوقت
- **الاستفادة من الإضافات**: الحفاظ على الخطط الأساسية بسيطة وزيادة المبيعات الإضافية
- **اختبار التغييرات**: التحقق من صحة تغييرات الخطط والتناسب في وضع الاختبار

 <Info>
تعد الاشتراكات أساسًا مرنًا للإيرادات المتكررة. ابدأ ببساطة، اختبر بدقة، وكرر بناءً على مؤشرات التبني، والتغيير، والتوسع.
</Info>