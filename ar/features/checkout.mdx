...
<Info>
تتناول هذه القسم **إعدادات موضوع API للجانب الخادم** باستخدام `customization.theme_config`. إذا كنت تستخدم **Checkout SDK** (الإطار المتداخل أو الشراء المضمن)، انظر قسم تخصيص الموضوع في [Overlay Checkout](/developer-resources/overlay-checkout#theme-customization) الذي يستخدم خصائص camelCase (مثل `bgPrimary` بدلاً من `bg_primary`).
</Info>
