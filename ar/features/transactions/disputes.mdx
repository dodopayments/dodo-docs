...
3. **اختر استجابتك**
   ...
   <Frame>
       <img src="/images/disputes/1.png" alt="إنشاء النزاع" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
...
5. **إذا كنت تعترض**
   ...
   <Frame>
       <img src="/images/disputes/2.png" alt="إنشاء النزاع" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
   
   <Frame>
       <img src="/images/disputes/3.png" alt="إنشاء النزاع" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
...
<Frame caption="Visa RDR configuration in the Dodo Payments dashboard">
    <img src="/images/disputes/rdr.png" alt="إعدادات Visa RDR تظهر التبديل المُمَكّن وتكوين العتبة" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Step title="Open the Disputes Settings">
    انتقل إلى **الإعدادات → الأعمال** في لوحة معلومات Dodo Payments وابحث عن قسم **التسوية السريعة للنزاعات Visa (RDR)**.
</Step>
