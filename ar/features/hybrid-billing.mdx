...
4. تحقق من أن الأحداث تحتوي على طوابع زمنية صحيحة (ليست مؤرخة في المستقبل)
</Accordion>
...
**الحلول**:
1. استخدم `previewChangePlan` API لعرض التكاليف الدقيقة قبل التأكيد
2. إعلام أن النسبة المئوية تنطبق على الاشتراكات بالإضافة إلى الإضافات
3. النظر في استخدام `difference_immediately` لفواتير ترقية أبسط
</Accordion>
