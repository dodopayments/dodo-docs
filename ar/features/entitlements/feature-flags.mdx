...
| المشغّل | التأثير |
|---|---|
| نجاح عملية دفع لمرة واحدة / تفعيل الاشتراك | تم إنشاء المنحة مع تعيين `status: delivered` و `delivered_at`. |
| وضع الاشتراك قيد التعليق أو إلغاؤه أو انتهاؤه | تم إلغاء المنحة مع `revocation_reason` المطابق. |
| استرداد مبلغ لعملية دفع لمرة واحدة | تم إلغاء المنحة مع `revocation_reason: refund`. |
| استعادة الاشتراك (على سبيل المثال، نجاح عملية التحصيل المتأخر) | تتم استعادة المنحة المُلغاة إلى `Delivered` — مع بقاء معرّف المنحة `id` نفسه ومسح حقول الإلغاء. |
| إلغاء يدوي عبر API | تم إلغاء المنحة مع `revocation_reason: manual`. لا تتم استعادتها تلقائيًا عند التجديد. |
