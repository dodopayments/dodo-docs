...
2. تنشئ Dodo Payments منحة بالحالة `Pending` مع `oauth_url` للعميل لربط حسابه على GitHub.
3. يفوّض العميل الوصول من خلال الرابط الموجود في بريده الإلكتروني أو في بوابة العميل.
4. تدعو Dodo Payments حساب العميل على GitHub إلى المستودع باستخدام مستوى الأذونات المُعدّ. تنتقل المنحة إلى الحالة `Delivered` بمجرد إنشاء الدعوة.
5. إذا تم إلغاء الاشتراك أو ردّ المبلغ أو سحبه، تتم إزالة العميل من قائمة المتعاونين.
