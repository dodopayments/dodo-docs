...
description: Charge customers based on what they actually use with flexible
  metering and automated billing.
icon: box
keywords:
  - Dodo Payments
  - الفوترة القائمة على الاستخدام
  - الفوترة بحسب الاستخدام
---
...
<Frame>
<img src="/images/usage-based/UBB-2.png" alt="إنشاء واجهة العداد" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/usage-based/UBB-4.png" alt="تكوين التسعير" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
بدلاً من فرض رسوم لكل وحدة بالدولار، يمكنك إعداد العدادات لخصم من [رصيد الائتمان](/features/credit-based-billing) الخاص بالعميل. يتم تجديد الأرصدة في كل دورة فوترة وتُطبَّق قبل أي رسوم تجاوز.
...
<Frame>
<img src="/images/usage-based/UBB-5.png" alt="إضافة العداد إلى المنتج" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/guides/usage-based-billing/meter-quantities-chart.png" alt="لوحة العداد" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
