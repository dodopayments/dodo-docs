...
قم بإرفاق أرصدة بمنتج الاشتراك أثناء عملية الدفع:
...
أرسل أحداث الاستخدام التي تخصم الأرصدة تلقائيًا:
...
| الخطة | السعر | الأرصدة/الشهر | التكلفة الإضافية |
|--------|--------|----------------|-------------------|
| Starter | $29/شهر | 10,000 رمز | $0.003/رمز |
| Pro | $99/شهر | 100,000 رمز | $0.002/رمز |
| Enterprise | $499/شهر | 1,000,000 رمز | $0.001/رمز |

**الإعداد:**
- نوع الرصيد: وحدة مخصصة ("AI Tokens")
- الدقة: 0 (رموز كاملة)
- التراكم: 25% كحد أقصى، بإطار زمني قدره شهر واحد
- التكلفة الإضافية: مفعلة، احتساب التكلفة الإضافية عند الفواتير
- العداد: `ai.generation` مع تجميع Sum على حقل `tokens`
</Accordion>
...
| الخطة | السعر | الأرصدة/الشهر | التكلفة الإضافية |
|--------|--------|----------------|-------------------|
| Free | $0/شهر | 1,000 مكالمة | محظورة |
| Developer | $19/شهر | 50,000 مكالمة | $0.001/مكالمة |
| Business | $99/شهر | 500,000 مكالمة | $0.0005/مكالمة |

**الإعداد:**
- نوع الرصيد: وحدة مخصصة ("API Calls")
- الدقة: 0 (مكالمات كاملة)
- التراكم: معطل
- التكلفة الإضافية: خطط Developer+ تتيح التكلفة الإضافية (يتم السماح عند إعادة الضبط)، خطة Free تعطل التكلفة الإضافية
- العداد: `api.request` مع تجميع Count
</Accordion>
...
| الخطة | السعر | الأرصدة/الشهر | التكلفة الإضافية |
|--------|--------|----------------|-------------------|
| Personal | $9/شهر | 100 ساعة-جيجابايت | $0.05/ساعة-جيجابايت |
| Team | $49/شهر | 1,000 ساعة-جيجابايت | $0.03/ساعة-جيجابايت |

**الإعداد:**
- نوع الرصيد: وحدة مخصصة ("GB-hours")
- الدقة: 2 (منزلتين عشريتين)
- التراكم: 50% كحد أقصى، يُحتفظ به مرة واحدة
- التكلفة الإضافية: مفعلة بحد 200%
- العداد: `storage.usage` مع تجميع Sum
</Accordion>
</AccordionGroup>
...
- **ابدأ ببساطة**: ابدأ بنوع رصيد واحد وبدون تراكم. أضف التعقيد بناءً على ملاحظات العملاء وأنماط الاستخدام.
- **حدد توقعات واضحة**: اعرض تخصيصات الرصيد، الأرصدة المتبقية، وتسعير التكلفة الإضافية بشكل بارز في صفحات منتجك وبوابة العملاء.
- **استخدم وحدات ذات معنى**: سمِّ الأرصدة بحسب ما تمثله (مثل "API Calls"، "AI Tokens") بدلًا من مصطلحات عامة. يساعد ذلك العملاء على فهم القيمة.
- **اضبط انتهاء الصلاحية بعناية**: نوافذ الانتهاء القصيرة (7 أيام) تخلق إحساسًا بالإلحاح لكنها قد تثير انزعاج العملاء. النوافذ الأطول (30–90 يومًا) أكثر ملاءمة لمعظم منتجات SaaS.
- **راقب الأرصدة المنخفضة**: عيّن عتبات للرصيد المنخفض لتنبيه العملاء قبل نفاد الرصيد، مما يقلل من مفاجآت رسوم التكلفة الإضافية.
- **اختبر في وضع الاختبار**: أنشئ أرصدة، وأرفقها بمنتجات اختبار، وحاكي دورة الشراء → الاستخدام → الخصم → انتهاء الصلاحية بالكامل قبل التشغيل الفعلي.

<Info>
تعمل الفوترة القائمة على الأرصدة بسلاسة مع جميع ميزات Dodo Payments الأخرى - الاشتراكات مع التجارب، تغيير الخطط مع التسعير الجزئي، وبوابة العملاء. ابدأ بإعداد أساسي وتوسع مع تطور نموذج التسعير الخاص بك.
</Info>
