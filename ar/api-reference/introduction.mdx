...
## أدلة المطورين ذات الصلة

استكشف أدلتنا الشاملة لفهم كيفية تنفيذ الميزات الرئيسية باستخدام API:

<CardGroup cols={2}>
{/* LOCKED_PATTERN_f7cf71c4394981bb4f21a4fe70918d2a */}
  تعلم كيفية دمج المدفوعات لمرة واحدة، جلسات الشراء، وروابط الدفع في تطبيقك
</Card>
{/* LOCKED_PATTERN_111d19916a89f7256f741dfba74b6bd8 */}
  دليل كامل لتنفيذ الاشتراكات، إدارة الخطط، والتعامل مع أحداث دورة حياة الاشتراك
</Card>
{/* LOCKED_PATTERN_5077a75db45fcbd237199b9c9e2a1768 */}
  إعداد المقاييس وأحداث الاستخدام للفوترة المستندة إلى الاستهلاك والنماذج التسعيرية المستندة إلى الاستهلاك
</Card>
{/* LOCKED_PATTERN_1949669cb5cca6b200ee8d40a98aeca1 */}
  تلقي الإشعارات الفورية وأتمتة سير العمل باستخدام أحداث webhook
</Card>
{/* LOCKED_PATTERN_da690bf0c88a9186dd98cff7b602ef0f */}
  قم بإنشاء تجارب شراء مستضافة وآمنة مع تخصيص كامل وميزات متقدمة
</Card>
</CardGroup>