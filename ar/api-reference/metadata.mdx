...
### افعل:
- استخدم اتفاقيات تسمية متسقة لمفاتيح البيانات الوصفية
- وثّق مخطط البيانات الوصفية داخليًا
- اجعل القيم قصيرة ومعنوية
- استخدم البيانات الوصفية للبيانات الثابتة فقط
- فكّر في استخدام بادئات للأنظمة المختلفة (على سبيل المثال، `crm_id`، `inventory_sku`)
