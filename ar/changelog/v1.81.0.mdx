...
تمت إضافة حقل `refund_status` إلى استجابة `GET /payments/{payment_id}` للتحقق سريعًا مما إذا كانت الدفعة قد تم ردّها دون الاستعلام عن نقطة نهاية عمليات ردّ الأموال بشكل منفصل.
