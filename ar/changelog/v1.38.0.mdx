...
description: Analytics Chart Sharing, Multiple Partial Refunds, Cumulative
  Revenue Analytics, Context7 Integration, Next.js Adapter
...
<Frame>
  <img src="/images/changelog/share-chart.png" alt="واجهة مشاركة مخطط التحليلات تظهر زر المشاركة وخيارات اللون" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/images/changelog/revenue-chart.png" alt="مخططات الإيرادات التراكمية تعرض اتجاهات نمو الإيرادات" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
