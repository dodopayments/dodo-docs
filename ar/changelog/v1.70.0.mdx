...
1. **الدفع المدمج - تجارب دفع مدمجة بالكامل (بيتا)**  
   ...
   <Frame>
   <img src="/images/inline-checkout/cover.png" alt="صورة غلاف الدفع المضمنة" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
   ...
   - **طرق SDK**: استخدم `open()`، `close()`، و`isOpen()` للتحكم في الدفع برمجيًا
   ...
   <Tip>
   استخدم الدفع المضمن عندما تريد السيطرة القصوى على تصميم صفحة الدفع. استخدم [overlay checkout](/developer-resources/overlay-checkout) للتكامل الأسرع مع أقل قدر من التعديلات على الصفحات الحالية.
   </Tip>
...
3. **تغييرات خطة الاشتراك في لوحة التحكم مع تحديثات تاريخ الفوترة التالي**  
    ...
    <Frame>
    <img src="/images/changelog/subscription-plan-changes.png" alt="تغييرات خطة الاشتراك في لوحة التحكم" style={{ maxHeight: '500px', width: 'auto' }} />
    </Frame>
...
4. **روابط قصيرة لروابط الدفع**  
   ...
   <Frame>
   <img src="/images/changelog/short-links.png" alt="ميزة الروابط المختصرة لعناوين الدفع" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
   ...
   <Info>
   يتم إدارة الروابط القصيرة في لوحة التحكم ويمكنك عرضها عبر [List Short Links API](/api-reference/products/get-products-short-links).
   </Info>
