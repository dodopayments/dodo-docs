...
### 1. **مجموعات المنتجات**  
   ...
   <Frame>
     <img src="/images/product-collection/checkout-page.png" alt="صفحة الدفع مجموعة المنتجات تعرض خيارات خطط متعددة" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
