...
<Accordion title="Test regional methods with correct addresses">
طرق الدفع الإقليمية (UPI، iDEAL، إلخ) تتطلب عناوين فواتير متطابقة. لن تظهر iDEAL بعنوان فوترة أمريكي.
</Accordion>

<Accordion title="Verify minimum amounts">
طرق BNPL تتطلب حد أدنى قدره $50.01. اختبر أنها تظهر/تختفي بشكل صحيح بناءً على إجمالي سلة التسوق.
</Accordion>
</AccordionGroup>
...
<Card title="BNPL" icon="calendar-days" href="/features/payment-methods/bnpl">
اختبار Klarna، Afterpay، وBillie.
</Card>
