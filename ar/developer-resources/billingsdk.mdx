...
<Frame>
  <iframe 
        ...
        title="SDK الفوترة | مدفوعات دودي"
        frameBorder="0"
...
1. تحميل تكوين المكون من السجل
2. تثبيت ملفات المكون في دليل `components/billingsdk/`
3. تحديث تكوين مشروعك إذا لزم الأمر
4. تثبيت أي تبعيات إضافية

## هيكل الملفات الناتجة

بعد تشغيل `init`، ستحصل على بنية مشروع كاملة مع:
...
<CardGroup cols={3}>
  <Card title="التوثيق الكامل" icon="book" href="https://billingsdk.com/docs">
    دليل كامل لـ SDK الفوترة مع أمثلة وأفضل الممارسات
  </Card>
  <Card title="مرجع CLI" icon="terminal" href="https://billingsdk.com/docs/cli">
    توثيق CLI مفصل لجميع الأوامر والخيارات
  </Card>
  <Card title="مكتبة المكونات" icon="boxes-stacked" href="https://billingsdk.com/docs/components">
    تصفح جميع المكونات المتاحة مع أمثلة حية
  </Card>
</CardGroup>
