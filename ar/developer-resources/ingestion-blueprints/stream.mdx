...
قم بإنشاء مقياس في [لوحة معلومات دودي بايمنتس](https://app.dodopayments.com/):
- **اسم الحدث**: `stream_consumption` (أو الاسم الذي تفضله)
- **نوع التجميع**: `sum` لتتبع إجمالي البيانات المتدفقة
- **خاصية المجموع**: `bytes` لتحديد الفوترة بناءً على استخدام النطاق الترددي
</Step>
