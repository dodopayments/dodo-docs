...
قم بإنشاء عداد في [لوحة تحكم مدفوعات ديديو](https://app.dodopayments.com/):
- **اسم الحدث**: `object_storage_upload` (أو الاسم الذي تفضله)
- **نوع التجميع**: `sum` لتتبع إجمالي بايتات التحميل
- **عبر الملكية**: `bytes` لتقدير الفواتير بناءً على حجم التخزين
</Step>
