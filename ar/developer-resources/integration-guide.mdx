...
2. قم بإنشاء منتج (دفع لمرة واحدة أو اشتراك). يجب أن تكون المنتجات المشتراكة بسعر لا يقل عن **$1** (أو ما يعادله بالعملة التي اخترتها)؛ لا يتم دعم المبالغ الأقل من هذا الحد الأدنى.
...
<Card title="Create Checkout Session" icon="code" href="/api-reference/checkout-sessions/create">
  مرجع API لإنشاء جلسات دفع آمنة ومُستضافة للمدفوعات لمرة واحدة والاشتراكات
</Card>
