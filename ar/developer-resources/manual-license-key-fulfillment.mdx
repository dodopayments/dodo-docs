...
إذا كنت تفضل عدم الاعتماد على webhooks، يمكنك سرد المنح لصلاحية مفتاح الترخيص وتصفية حسب `status`. كل منح في صلاحية مفتاح الترخيص هو بالفعل منح لمفتاح ترخيص، لذا لا حاجة لفلتر `integration_type`:
