...
<Card title="SvelteKit" icon="code" href="/developer-resources/sveltekit-adaptor">
  إطار عمل Svelte كامل مع تكامل الخطافات الخادمة
</Card>
...
<Card title="TanStack Start" icon="chart-line" href="/developer-resources/tanstack-adaptor">
  إطار عمل React كامل آمن من النوع مع وظائف خادمة
</Card>
...
| الميزة | الوصف |
|---------|-------------|
| **معالج الدفع** | دعم لتدفقات الدفع الثابتة، الديناميكية، والمعتمدة على الجلسة |
