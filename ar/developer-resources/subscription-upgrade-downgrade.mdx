...
<AccordionGroup>
<Accordion title="200 OK">
تمت معالجة طلب تغيير الخطة بنجاح. يتم تحديث الاشتراك وبدأت عملية الدفع.
</Accordion>

<Accordion title="400 Bad Request">
معلمات الطلب غير صالحة. تحقق من توفير جميع الحقول المطلوبة وتنسيقها بشكل صحيح.
</Accordion>

<Accordion title="401 Unauthorized">
مفتاح API غير صالح أو مفقود. تحقق أن `DODO_PAYMENTS_API_KEY` صحيح ويملك الأذونات المناسبة.
</Accordion>
...
<Accordion title="422 Unprocessable Entity">
لا يمكن تغيير الاشتراك (مثل: تم إلغاؤه بالفعل، المنتج غير متوفر، إلخ).
</Accordion>

<Accordion title="500 Internal Server Error">
حدث خطأ في الخادم. حاول إعادة الطلب بعد تأخير قصير.
</Accordion>
</AccordionGroup>
...
- راجع <a href="/api-reference/subscriptions/change-plan">API تغيير الخطة</a>
- استكشف <a href="/features/credit-based-billing">الفوترة القائمة على الائتمان</a>
- نفذ التنبيهات لـ `subscription.on_hold`
- اطلع على <a href="/developer-resources/webhooks">دليل تكامل Webhook الخاص بنا</a>
