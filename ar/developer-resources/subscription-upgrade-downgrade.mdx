...
- `subscription.on_hold`: فشل تحصيل رسوم تغيير الخطة، وتم إيقاف عمليات التجديد
- `payment.succeeded`: نجح التحصيل الفوري لرسوم تغيير الخطة
...
### أنواع الأحداث التي يجب معالجتها
- `subscription.active`: تم تفعيل الاشتراك
- `subscription.plan_changed`: تم تغيير خطة الاشتراك (ترقية/تخفيض/تغييرات الإضافة)
- `subscription.on_hold`: فشل تحصيل الرسوم، وتم إيقاف عمليات التجديد
- `subscription.renewed`: نجحت عملية التجديد
- `payment.succeeded`: نجح الدفع مقابل تغيير الخطة أو التجديد
