...
<Info>
الاعتمادات التي تم إنشاؤها بواسطة التدرجات التنازلية باستخدام <code>difference_immediately</code> مرتبطة بالاشتراك ومميزة عن استحقاقات <a href="/features/credit-based-billing">الفوترة المعتمدة على الرصيد</a>. تُطبق تلقائيًا على عمليات التجديد المستقبلية لنفس الاشتراك ولا يمكن نقلها بين الاشتراكات.
</Info>
...
- راجع <a href="/api-reference/subscriptions/change-plan">Change Plan API</a>
- استكشف <a href="/features/credit-based-billing">Credit-Based Billing</a>
- نفّذ تنبيهات لـ `subscription.on_hold`
- اطلع على <a href="/developer-resources/webhooks">Webhook Integration Guide</a>
