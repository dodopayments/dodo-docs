...
<Card title="Discord Community" icon="discord" href="https://discord.gg/bYqAp4ayYh">
  احصل على المساعدة واتصل بالمطورين
</Card>
</CardGroup>
...
- **Discord**: انضم إلى [الخادم المجتمعي](https://discord.gg/bYqAp4ayYh) للحصول على دعم في الوقت الحقيقي
- **Email**: تواصل معنا عبر support@dodopayments.com
- **GitHub**: افتح مشكلة على [المستودع](https://github.com/dodopayments/dodopayments-rust/issues)

## المساهمة

نرحب بالمساهمات! تحقق من [إرشادات المساهمة](https://github.com/dodopayments/dodopayments-rust/blob/main/CONTRIBUTING.md) للبدء.
