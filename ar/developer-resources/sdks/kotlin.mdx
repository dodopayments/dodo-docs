...
{/* كود_مكان_الإشارة_52a7712bd20eebeec4b17f22fe7c5790 */}

### Maven

أضف الاعتماد إلى `pom.xml`:

{/* كود_مكان_الإشارة_3dd9ebe91ca967e663d6cb4dbd952a56 */}

<Tip>
استخدم دائمًا أحدث إصدار من SDK للوصول إلى أحدث ميزات مدفوعات دودي. تحقق من [Maven Central](https://central.sonatype.com/artifact/com.dodopayments.api/dodo-payments-kotlin) للحصول على أحدث إصدار.
</Tip>

<Info>
يتطلب SDK جافا 8 أو أحدث وهو متوافق مع كل من منصات JVM و Android.
</Info>
...
<CardGroup cols={2}>
<Card title="الكوروتينات" icon="bolt">
  دعم كامل لكوروتينات كوتلن للعمليات غير المتزامنة
</Card>

<Card title="الأمان من القيم الفارغة" icon="shield-check">
  استغل أمان كوتلن من القيم الفارغة لمعالجة الأخطاء بشكل قوي
</Card>

<Card title="دوال التمديد" icon="code">
  امتدادات كوتلن idiomatic لوظائف محسّنة
</Card>

<Card title="فئات البيانات" icon="layer-group">
...
استخدم `Result` لمعالجة الأخطاء بشكل وظيفي:

{/* كود_مكان_الإشارة_26a09a717efffa9246c69f75a0d7b5f3 */}

<Tip>
استخدم `runCatching` من كوتلن لنهج أكثر وظيفية في معالجة الأخطاء باستخدام أنواع Result.
</Tip>
...
<CardGroup cols={2}>
<Card title="مستودع GitHub" icon="github" href="https://github.com/dodopayments/dodopayments-kotlin">
...
<Card title="الإبلاغ عن المشكلات" icon="bug" href="https://github.com/dodopayments/dodopayments-kotlin/issues">
