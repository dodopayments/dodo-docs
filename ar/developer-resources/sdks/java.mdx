...
<Info>
يتم التعبير عن `productPrice` بأدنى فئة من العملة (مثل السنتات بالنسبة إلى USD، والبايس بالنسبة إلى INR). لفرض رسوم قدرها 25.00$، مرّر `2500`.
</Info>

<Tip>
يُقصد استخدام `subscriptions().charge(...)` لتحصيل الرسوم من [الاشتراكات عند الطلب](/developer-resources/ondemand-subscriptions). تتم فوترة الاشتراكات المجدولة القياسية تلقائيًا استنادًا إلى جدول تسعير المنتج.
</Tip>
...
أنشئ العدادات وأدرها لتتبع الاستخدام:
...
### استيعاب الأحداث على دفعات

استوعب أحداثًا متعددة بكفاءة (بحد أقصى 1000 لكل طلب):
...
معالجة شاملة للأخطاء في مختلف السيناريوهات:
...
<Tip>
يعيد SDK محاولة الطلبات تلقائيًا عند حدوث أخطاء الاتصال، وأخطاء 408 و409 و429 وأخطاء 5xx، مع استخدام التراجع الأُسّي.
</Tip>
...
هل تحتاج إلى مساعدة بشأن Java SDK؟
...
- **GitHub**: افتح مشكلة في [المستودع](https://github.com/dodopayments/dodopayments-java)

## المساهمة

نرحّب بالمساهمات! راجع [إرشادات المساهمة](https://github.com/dodopayments/dodopayments-java/blob/main/CONTRIBUTING.md) للبدء.
