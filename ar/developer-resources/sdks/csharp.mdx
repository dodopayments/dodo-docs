...
<Card title="Async/Await" icon="bolt">
  واجهة برمجة تطبيقات كاملة تعتمد على async Task للعمليات غير الحظرية
</Card>

<Card title="Strong Typing" icon="shield-check">
  أمان نوع شامل مع أنواع الإشارة القابلة لأن تكون فارغة
</Card>
...
نرحب بالمساهمات! راجع [إرشادات المساهمة](https://github.com/dodopayments/dodopayments-csharp/blob/main/CONTRIBUTING.md) للبدء.
