...
<Tip>
استخدم دائمًا أحدث إصدار من SDK للوصول إلى أحدث ميزات مدفوعات Dodo. قم بتشغيل `bundle update dodopayments` بانتظام للبقاء على اطلاع.
</Tip>
...
<CardGroup cols={2}>
<Card title="تقاليد روبي" icon="gem">
  يتبع تقاليد التسمية في روبي وأنماطها الاصطلاحية
</Card>

<Card title="بنية أنيقة" icon="code">
...
<CardGroup cols={2}>
<Card title="مستودع GitHub" icon="github" href="https://github.com/dodopayments/dodopayments-ruby">
...
<Card title="الإبلاغ عن المشكلات" icon="bug" href="https://github.com/dodopayments/dodopayments-ruby/issues">
