...
keywords:
  - Dodo Payments
  - دليل المطور
  - التحقق عن طريق النافذة العلوية
  - التحقق عن طريق النافذة المنبثقة
...
<Info>
يغطي هذا القسم **تكوين السمة من جانب العميل** باستخدام مجموعة تطوير أدوات Checkout. يمكنك أيضًا تكوين السمات **من جانب الخادم** عند إنشاء جلسة دفع عبر واجهة برمجة التطبيقات باستخدام المعامل `theme_config`. راجع [تخصيص سمة Checkout](/features/checkout#checkout-theme-customization) لتكوين على مستوى واجهة برمجة التطبيقات، أو استخدم [صفحة التصميم](/features/design) في لوحة التحكم لتكوين السمات بصريًا مع معاينة مباشرة.
</Info>
