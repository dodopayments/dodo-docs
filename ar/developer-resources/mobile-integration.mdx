...
<CardGroup cols={2}>
<Card title="بدء سريع" icon="rocket" href="#integration-workflow">
  قم بتشغيل تكامل مدفوعات الهاتف المحمول في 4 خطوات بسيطة
</Card>

<Card title="أمثلة على المنصات" icon="code" href="#platform-specific-integration">
...
<Steps>
<Step title="الخلفي: إنشاء جلسة الدفع">
<Card title="وثائق واجهة برمجة التطبيقات لجلسة الدفع" icon="book" href="/developer-resources/checkout-session">
تعلم كيفية إنشاء جلسة دفع في الخادم الخلفي الخاص بك باستخدام Node.js وPython والمزيد. راجع الأمثلة الكاملة والمراجع المعلمات في وثائق <strong>واجهة برمجة التطبيقات لجلسات الدفع</strong> المخصصة.
</Card>
<Note>
...
<Step title="الهاتف المحمول: الحصول على عنوان URL للدفع">
...
<Step title="الهاتف المحمول: فتح الدفع في المتصفح">
افتح عنوان URL للدفع في متصفح آمن داخل التطبيق لمعالجة الدفع.

<Card 
  title="عرض أمثلة التكامل الخاصة بالمنصة" 
  icon="box" 
...
<Step title="الخلفي: معالجة إكمال الدفع">
...
أضف هذا الاعتماد إلى `package.json`:
...
<Tip>
استخدم InAppBrowser لتجربة المتصفح الأصلية. تعامل مع الروابط العميقة لردود الدفع.
</Tip>
...
<Warning>
**الامتثال الإقليمي**: تحتوي SDK الدفع داخل التطبيق على قيود إقليمية. على **iOS**، SDK الدفع الأصلية قانونية فقط في **الاتحاد الأوروبي** (بموجب شروط DMA). على **Android**، هي قانونية في أسواق اختيار المستخدم (UCB). بالنسبة للمناطق الأخرى، استخدم نهج روابط الدفع أعلاه لضمان الامتثال لمتجر التطبيقات ومتجر Play.
</Warning>

<Card 
  title="دليل تكامل SDK لـ React Native" 
  icon="mobile-screen" 
  href="/developer-resources/react-native-integration"
>
  دليل كامل لتكامل SDK دودي لـ React Native مع أوراق الدفع الأصلية، وخيارات التخصيص الكاملة، ومعالجة الدفع المباشرة. يتضمن تعليمات الإعداد والتنفيذ والاختبار.
</Card>

<Info>
راجع [دليل تجاوز رسوم متجر التطبيقات](/features/bypassing-app-store-fees) لفهم متطلبات الامتثال الإقليمي لتكاملات الدفع داخل التطبيق.
</Info>
...
<Tip>
استخدم WebView لروابط الدفع. تعامل مع عنوان URL لإعادة التوجيه لاكتشاف إكمال الدفع.
</Tip>
...
<Check>
لأي أسئلة أو دعم، اتصل بـ <a href="mailto:support@dodopayments.com">support@dodopayments.com</a>.
</Check>