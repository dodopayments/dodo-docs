...
description: Detect failed payments from webhooks and the API, read the failure
  reason, surface it to customers safely, and decide when to retry or collect a
  new payment method.
