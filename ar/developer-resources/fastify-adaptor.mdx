...
يثبّت المبلغ المُحصّل بوحدات العملة الأساسية (مثلًا، <code>12.5</code> مقابل 12.50 دولارًا). لمنتجات ادفع ما تريد فقط، ويتم تجاهله إذا كان أقل من الحد الأدنى لسعر المنتج.
</ParamField>
<ParamField query="showDiscounts" type="boolean">
إظهار حقول الخصم.
</ParamField>
<ParamField query="metadata_*" type="string">
سيتم تمرير أي معلمة استعلام تبدأ بـ <code>metadata_</code> كـ metadata.
</ParamField>
