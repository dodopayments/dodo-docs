...
<Step title="تهيئة متغيرات البيئة">
أنشئ ملفًا `.env` في الدليل الجذر:
...
<تحذير>
لا تقم أبداً بإدخال ملفك `.env` في التحكم بالإصدارات. إنه مُدرج بالفعل في `.gitignore`.
</تحذير>
</Step>
...
امسح رمز الاستجابة السريعة QR باستخدام تطبيق Expo Go على جهازك، أو اضغط على `i` لمحاكي iOS أو `a` لمحاكي Android.
