...
<Steps>
  ...
  <Step title="Create Usage Meters">
    ...
    * **Output Tokens:** 1,000,000 tokens / \$10.00 = 100,000 tokens per \$1.
    ...
    في لوحة تحكم Dodo، ستضبط "وحدات القياس لكل رصيد" على 4,000 للإدخال و1,000 للإخراج. تُقاس الأرصدة بالسنتات، لذا يشتري رصيد واحد 1/100 من القيم لكل دولار المذكورة أعلاه.
  </Step>
