...
<Info>
يستخدم هذا النموذج FastAPI مع أنماط async/await، وPydantic للتحقق، و`dodopayments` SDK بايثون لدمج API بسلاسة.
</Info>
...
قم بتحديث عنوان URL للويب هوك في [لوحة تحكم دودي](https://app.dodopayments.com/developer/webhooks) إلى عنوان URL الخاص بـ ngrok. تأكد من تحديث ملف `.env` الخاص بك بمفتاح التحقق الصحيح للويب هوك.
</Accordion>
