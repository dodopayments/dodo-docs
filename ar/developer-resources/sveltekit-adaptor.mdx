...
description: تعلم كيفية دمج مدفوعات دودي مع مشروع SvelteKit App Router الخاص بك
  باستخدام موائم SvelteKit. يغطي الدفع، بوابة العملاء، الويب هوكس، وإعداد البيئة
  الآمنة.
icon: code-merge
---
...
<Card title="معالج الدفع" icon="cart-shopping" href="#checkout-route-handler">
    دمج دفع دودي في تطبيق SvelteKit الخاص بك.
</Card>
...
<Tab title="معالج الدفع">
  <Info>
  استخدم هذا المعالج لدمج دفع دودي في تطبيق SvelteKit الخاص بك. يدعم تدفقات الدفع الثابتة (GET)، الديناميكية (POST)، والجلسة (POST).
  </Info>
  <CodeGroup>
...
يمكنك من خلال معالج بوابة العملاء دمج بوابة عملاء مدفوعات دودي بسلاسة في تطبيق SvelteKit الخاص بك.
