...
يُثبّت Dodo Agent Plugin خوادم MCP وجميع المهارات السبع عشرة في خطوة واحدة لكل من Claude Code وCodex CLI وCursor وOpenCode. راجع [دليل وكلاء البرمجة بالذكاء الاصطناعي](/developer-resources/build-with-ai-coding-agents) للاطلاع على أوامر التثبيت الخاصة بكل وكيل.
