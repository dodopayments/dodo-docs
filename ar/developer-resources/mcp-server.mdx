...
يُثبّت [Dodo Agent Plugin](/developer-resources/build-with-ai-coding-agents) خادمي MCP وجميع المهارات السبع عشرة في خطوة واحدة لكل من Claude Code وCodex CLI وCursor وVS Code / GitHub Copilot وKiro وOpenCode. يحصل Gemini CLI على خادمي MCP فقط، لأنه لا يتضمن agent-skill primitive. راجع [دليل AI Coding Agents](/developer-resources/build-with-ai-coding-agents) للاطلاع على أوامر التثبيت الخاصة بكل agent.
