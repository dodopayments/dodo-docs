...
قم بتعيين URI إعادة التوجيه إلى: `https://[your-project-ref].supabase.co/auth/v1/callback` في Google Cloud، ثم قم بتمكين مزود Google في Supabase Auth باستخدام معرف العميل والسر الخاص بك.
</Step>

<Step title="تكوين مدفوعات Dodo">
قم بإنشاء مفتاح API وسر Webhook من لوحة معلومات Dodo. قم بتعيين البيئة إلى `test_mode` أثناء التطوير.
</Step>
...
واجهة تسعير UI تقرأ هذا `features` المصفوفة وتعرضها ديناميكيًا.
</Step>
...
- عملية الدفع عبر الاشتراك عبر مدفوعات Dodo
- وظيفة Edge في Supabase للويب هوكس (`dodo-webhook`)
...
- تأكد من نفس الشيء في Google Cloud ومزود Supabase Auth
</Accordion>
</AccordionGroup>
