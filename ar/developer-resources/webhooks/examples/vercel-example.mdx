---
title: وظائف Vercel
description: نشر Webhooks DodoPayments على Vercel
icon: triangle
---

<Card title="مستودع GitHub" icon="github" href="https://github.com/dodopayments/cloud-functions/tree/main/vercel">
...
- [حساب Vercel](https://vercel.com/signup)
...
معالج webhook:
1. **يعطل تحليل الجسم** - للوصول إلى الجسم الخام للتحقق من التوقيع
2. **يتحقق من التوقيع** - يضمن أن الطلب من DodoPayments باستخدام HMAC-SHA256
3. **يتحقق من التكرارات** - يستخدم معرف webhook لمنع معالجة نفس الحدث مرتين
4. **يسجل الحدث** - يخزن webhook الخام في جدول `webhook_events` لتدقيق السجل
5. **يعالج الحدث** - ينشئ أو يحدث العملاء والاشتراكات في Neon
6. **يتعامل مع الأخطاء** - يسجل الفشل ويحدد الحدث على أنه غير معالج لإعادة المحاولة
...
**عرض السجلات في لوحة تحكم Vercel:**
1. اختر مشروعك
2. انتقل إلى **النشر** → أحدث نشر
3. انقر على **الوظائف** → **السجلات**

**تكوين في لوحة تحكم DodoPayments:**
1. انتقل إلى المطورين → Webhooks
2. أضف نقطة النهاية مع عنوان URL لوظائف Vercel الخاصة بك
...
| خطأ في اتصال قاعدة البيانات | تحقق من سلسلة اتصال Neon واستخدم الاتصال المجمّع |
| انتهاء مهلة الوظيفة | تحسين الاستعلامات؛ خطة Pro لديها مهلة أطول (60 ثانية) |
| متغيرات البيئة غير متاحة | تعيينها في لوحة التحكم أو CLI، تأكد من تحديد جميع البيئات، إعادة النشر |

## الموارد

- [وثائق وظائف Vercel](https://vercel.com/docs/functions)
- [Vercel CLI](https://vercel.com/docs/cli)
- [وثائق Neon](https://neon.com/docs/)
- [دليل أحداث Webhook](/developer-resources/webhooks/intents/webhook-events-guide)
- [مستودع GitHub](https://github.com/dodopayments/cloud-functions/tree/main/vercel)
