...
<Card title="مستودع GitHub" icon="github" href="https://github.com/dodopayments/cloud-functions/tree/main/netlify">
...
2. انقر على وظيفة `webhook`
3. عرض السجلات في الوقت الحقيقي وتاريخ الاستدعاء
...
| خطأ في اتصال قاعدة البيانات | تحقق من سلسلة الاتصال الخاصة بـ Neon واستخدم الاتصال المجمّع |
| الوظيفة غير موجودة (404) | قم بتشغيل `netlify init` و `npm run deploy` مرة أخرى |
| المتغيرات البيئية غير متاحة | قم بتعيين المتغيرات في CLI أو لوحة التحكم، ثم أعد النشر |
