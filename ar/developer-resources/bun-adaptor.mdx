...
معرّف المنتج (مثلًا، <code>?productId=pdt_xxx</code>).
</ParamField>
...
يثبّت المبلغ المحصّل بوحدات العملة الأساسية (مثلًا، <code>12.5</code> مقابل 12.50 دولارًا). متاح لمنتجات «ادفع ما تريد» فقط، ويتم تجاهله إذا كان أقل من الحد الأدنى لسعر المنتج.
</ParamField>
