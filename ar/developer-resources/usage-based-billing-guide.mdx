...
اختر من المشغلين المتاحين:
- `equals` - مطابقة تامة
- `not_equals` - فلتر استبعاد
...
- `contains` - السلسلة تحتوي على جزء نصي
- `does_not_contain` - فلتر استبعاد السلسلة
</Step>
...
<Frame>
<img src="/images/guides/usage-based-billing/meter-quantities-chart.png" alt="مخطط كميات العداد يعرض اتجاهات الاستخدام على مر الزمن مع تصور بتدرج أرجواني" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/guides/usage-based-billing/events-table.png" alt="جدول الأحداث يعرض أسماء الأحداث ومعرفاتها وعناصر التحكم في التصفح لتحليل الأحداث بشكل مفصل" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
- الخاصية: `hour`, المقارن: `greater_than_or_equals`, القيمة: `9`
