...
معرّف المنتج (على سبيل المثال، <code>?productId=pdt_nZuwz45WAs64n3l07zpQR</code>).
</ParamField>
...
تحديد عملة الدفع (على سبيل المثال، <code>USD</code>).
</ParamField>
<ParamField query="showCurrencySelector" type="boolean">
إظهار محدد العملة.
</ParamField>
<ParamField query="paymentAmount" type="number">
يثبّت المبلغ الذي يتم تحصيله، بوحدات العملة الرئيسية (على سبيل المثال، <code>12.5</code> مقابل 12.50 دولارًا). لمنتجات Pay What You Want فقط، ويتم تجاهله إذا كان أقل من الحد الأدنى لسعر المنتج.
</ParamField>
