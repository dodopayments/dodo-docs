...
يثبّت المبلغ المحصّل بوحدات العملة الأساسية (مثلًا، <code>12.5</code> مقابل 12.50 دولارًا). لمنتجات Pay What You Want فقط، ويتم تجاهله إذا كان أقل من الحد الأدنى لسعر المنتج.
</ParamField>
