...
وضع السمة: `'light'` or `'dark'`
</ParamField>

### تخصيص المظهر

يمكنك تخصيص منصب الخروج الموحد React Native لتناسب تصميم تطبيقك عن طريق تعديل الألوان، الخطوط، وأكثر من ذلك من خلال معلمة المظهر عند استدعاء `initPaymentSession()`.

#### تخصيص الألوان

كل فئة لون تحدد لون مكون واحد أو أكثر في واجهة المستخدم. على سبيل المثال، `primary` يحدد لون زر الدفع.

| فئة اللون | الاستخدام |
|----------------|-------|
| `primary` | اللون الأساسي لزر الدفع والعناصر المحددة |
| `background` | لون خلفية صفحة الدفع |
| `componentBackground` | لون خلفية المدخلات، التبويبات، والمكونات الأخرى |
| `componentBorder` | لون الحدود الخارجية للمدخلات، التبويبات، والمكونات الأخرى |
| `componentDivider` | لون الحدود الداخلية (الحدود المشتركة) للمكونات |
| `primaryText` | لون نص العنوان |
| `secondaryText` | لون نص العلامة لحقول الإدخال |
