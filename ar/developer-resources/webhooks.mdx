...
<Step title="Access Webhook Settings">
    توجه إلى لوحة تحكم DodoPayments وانتقل إلى `Developer > Webhooks`.
</Step>
...
<Step title="Navigate to Webhook Details">
    اذهب إلى لوحة تحكم Dodo Payments وانتقل إلى `Developer > Webhooks`.
</Step>
...
{/* LOCKED_PATTERN_e00062f1a73be4cdce7478c87f820958 */}
  مرجع API لإنشاء وتكوين نقاط نهاية webhook برمجيًا
</Card>
{/* LOCKED_PATTERN_ebcc49f16b467c5d38d8a9f461e25ccd */}
  مرجع API لاسترجاع وإدارة نقاط نهاية webhook الخاصة بك
</Card>
</CardGroup>
