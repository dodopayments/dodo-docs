...
<Frame>
  <img src="/images/cover-images/Webhooks.webp" alt="صورة الغلاف للWebhook" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Expandable title="Data object properties">
  ...
  نوع المورد. واحد من: `Payment`, `Subscription`, `Refund`, `Dispute`, `LicenseKey`, `CreditLedgerEntry`, `CreditBalanceLow`, `AbandonedCheckout`, `DunningAttempt`, أو `EntitlementGrant`.
  </ResponseField>
  
  تختلف الحقول الإضافية حسب نوع الحدث. انظر الوثائق الخاصة بالحدث للحصول على المخططات الكاملة.
</Expandable>
</ResponseField>
...
<CardGroup cols={2}>
  <Card title="Event Types" icon="list" href="/developer-resources/webhooks/intents/webhook-events-guide">
    استعرض جميع أنواع أحداث الويب هوك المتاحة
  </Card>
  ...
  <Card title="Handle Payment Failures" icon="screwdriver-wrench" href="/developer-resources/handle-payment-failures">
    تفاعل مع `payment.failed` واسترجع الدفعات المرفوضة
  </Card>
</CardGroup>
...
<Frame>
    <img src="/images/webhooks/endpoints.png" alt="تفاصيل النقطة النهائية" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
تتيح لك هذه الأداة التفاعلية اختيار جميع أنواع الأحداث المدعومة وإرسال حمولات محاكاة واقعية إلى نقطة النهاية الخاصة بك. يتم التكرار حتى تتمكن من اختبار أحداث متعددة في جلسة واحدة.
...
<Frame>
  <img src="/images/webhooks/alerting.png" alt="إعدادات تنبيه Webhook تُظهر تكوين إشعارات البريد الإلكتروني" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
