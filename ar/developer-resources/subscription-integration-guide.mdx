...
| `timestamp` | string | نعم | الطابع الزمني لوقت حدوث الحدث (وليس بالضرورة الوقت نفسه الذي تم فيه تسليمه) |
| `type` | string | نعم | نوع الحدث. راجع [أنواع أحداث الاشتراك](#subscription-event-types) |
| `data` | object | نعم | حمولة البيانات الرئيسية. راجع [حِمولات webhook للاشتراك](/developer-resources/webhooks/intents/subscription) |
