...
لإجراء عمليات الدفع اللاحقة، استخدم نقطة النهاية [POST /subscriptions/{subscription_id}/charge](/api-reference/subscriptions/create-charge) وحدد المبلغ الذي سيتم خصمه من العميل لتلك المعاملة.
