...
<Card title="Global Merchant of Record" icon="globe">
  انطلق عالميًا دون تعقيد: تغطية مدمجة في أكثر من 190 دولة، وأكثر من 80 عملة، وأكثر من 30 طريقة دفع
</Card>
...
<Step title="Add Your First Product">
  ...
  <Card title="One-Time Payment" icon="box" href="/features/one-time-payment-products">
    مناسب للتنزيلات الرقمية أو الدورات أو المشتريات الفردية
  </Card>
  
  <Card title="Subscription Product" icon="repeat" href="/features/subscription">
    مثالي لـ SaaS أو العضويات أو الخدمات المتكررة
  </Card>
  <Card title="Usage-Based Billing" icon="chart-bar" href="/features/usage-based-billing/introduction">
    فاتورة العملاء مقابل مكالمات API أو الأرصدة أو الرموز أو أي مقياس استخدام - مثالي للذكاء الاصطناعي و SaaS
  </Card>
  <Card title="Credit-Based Billing" icon="coins" href="/features/credit-based-billing">
    إصدار أرصدة (مكالمات API، الرموز، وحدات الحوسبة) وخصمها مع استهلاك العملاء - مع الضوابط المرحلية وتجاوز الحدود
  </Card>
  </CardGroup>
</Step>
...
<Card title="API Reference" icon="terminal" href="/api-reference/introduction">
  المرجع الكامل لـ OpenAPI والنقاط النهاية والمعلمات وأمثلة الطلبات لجميع واجهات برمجة تطبيقات Dodo Payments
</Card>

<Card title="Community Support" icon="users" href="https://discord.gg/bYqAp4ayYh">
  انضم إلى مجتمع Discord الخاص بنا للحصول على المساعدة والمناقشات
</Card>
