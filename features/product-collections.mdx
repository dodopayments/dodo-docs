...
| **Allow Subscription Cancellation** | Customers can cancel their own subscriptions from the Customer Portal | Enabled |
...
<Info>
Turning off "Allow Subscription Cancellation" hides self-service cancellation from customers and rejects cancellation requests made through the Customer Portal API. Your own merchant-side cancellations are unaffected. See [Cancelling a Subscription](/features/customer-portal#cancelling-a-subscription).
</Info>
