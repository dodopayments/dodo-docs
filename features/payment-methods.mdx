...
<Card title="Crypto" icon="bitcoin-sign" href="/features/payment-methods/crypto">
Accept cryptocurrency payments from customers worldwide, billed in USD.
</Card>
