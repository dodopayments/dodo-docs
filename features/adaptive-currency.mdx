...
- The Merchant Dashboard shows the transaction in your global currency (USD) only.
...
- Invoices show only the global currency (USD) amount.
- Taxes and platform fees are calculated on the global (USD) amount.
