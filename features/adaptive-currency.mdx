...
You can also override the merchant default per request by passing `adaptive_currency_fees_inclusive` (boolean) on a checkout session, payment, or on-demand subscription:
