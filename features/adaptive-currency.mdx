...
Go to **Settings → Business** and enable the Adaptive Pricing toggle if you haven't already.
</Step>

<Step title="Toggle Fees Inclusive">
Once Adaptive Pricing is on, enable the **Fees Inclusive** sub-toggle in the same section.
</Step>
</Steps>
