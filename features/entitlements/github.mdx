...
Choose **GitHub Access** as the integration. If GitHub is not yet connected, you'll be prompted to install the Dodo Payments GitHub App on the organization or user account that owns the repository. Approve the install and the org is connected.
</Step>

<Step title="Pick a repository and permission">
After connecting, choose the **repository** the entitlement should grant access to and pick the **permission** level. The dashboard's repository picker only shows repositories the GitHub App has access to.

<Frame caption="Creating a GitHub entitlement. Pick the repository and the permission you want customers to receive.">
<img src="/images/entitlements/create.png" alt="GitHub entitlement form with repository selector and permission dropdown" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
