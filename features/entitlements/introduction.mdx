...
<Card title="Figma" icon="figma" href="/features/entitlements/figma">
Grant access to a Figma file when a customer subscribes or buys.
</Card>
...
Choose the integration type: License Key, Digital Files, Discord, GitHub, Telegram, Figma, Framer, or Notion. For platform integrations, connect your account first if you haven't already.
</Step>
...
<img src="/images/entitlements/create.png" alt="New Entitlement form with integration selector and configuration fields" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
