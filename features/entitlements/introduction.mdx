...
description: Automatically deliver license keys, downloadable files, and access to platforms like Discord, GitHub, Telegram, Framer, and Notion when customers pay.
icon: "gift"
