...
Choose **Discord Access** as the integration. If you have not yet connected Discord for your business, you'll be prompted to **Connect your Discord workspace**. Click through, sign in to Discord, and grant the bot permission to manage members and roles in the server you want to gate.
</Step>

<Step title="Pick a server and role">
After connecting, select the **server** (guild) you want to grant access to. Optionally pick a **role** to assign on delivery, or leave it blank to grant server membership only.

<Frame>
<img src="/images/entitlements/create.png" alt="Discord entitlement configuration with server and role pickers" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
