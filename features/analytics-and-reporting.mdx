...
The main Analytics dashboard provides comprehensive insights across your entire business. Access it from the sidebar under **Business > Analytics**.
...
Navigate to **Business > Reports** to access the reporting suite.
