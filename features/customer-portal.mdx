...
- **Retrieve license keys**: Access all keys tied to purchases, review each key's activations, and deactivate an activation to free up a slot.
...
<Card title="License Keys" icon="key">
    View the license keys tied to a purchase along with their activations, and deactivate an activation to free up a slot.
</Card>
</CardGroup>
