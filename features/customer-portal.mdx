...
By default, an immediate plan change charges the customer's saved payment method directly. Turning on **Collect Plan Change Payments by Payment Link** changes that: instead of charging the saved card, the customer is sent to a Dodo Checkout page to pay.
...
<Frame>
    <img src="/images/customer-portal/plan-change-checkout.png" alt="Hosted Dodo Checkout page where the customer pays for the plan change" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
