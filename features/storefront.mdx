...
2. **Redirect to Dodo Payments checkout**:
    - The customer will be taken to the Dodo Payments checkout
    - The customer completes the secure checkout flow on Dodo Payments.
3. **Confirmation**:
    - After successful payment, Dodo Payments shows a confirmation.
...
<Card title="Design & Theme Customization" icon="palette" href="/features/design">
  Customize your storefront appearance with pre-built themes, typography, colors, and live preview from the Design page.
</Card>