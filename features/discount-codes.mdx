...
<Warning>
The singular `discount_code` field is **deprecated** and cannot be used together with `discount_codes`. Migrate to the array form — pass `discount_codes: ['CODE']` even when applying a single code.
</Warning>
