...
<Frame>
    <img src="/images/discount-codes/discount-create.png" alt="New Discount Code form showing type, amount, name, code, and currency options" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>

<Frame>
    <img src="/images/discount-codes/configure_usage_limit.png" alt="Usage and expiry limits panel with start date, expiration date, and usage limits configured" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>

<Frame>
    <img src="/images/discount-codes/discount-create2.png" alt="Eligibility, restrictions, and advanced options for a discount code" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
    <img src="/images/discount-codes/discount_flat_discount_option.png" alt="Discount code editor with the Amount type selected, showing a flat 500 INR deduction" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
    <img src="/images/discount-codes/discount_restriction.png" alt="Customer eligibility dropdown showing Any, First-time, Existing, and Specific customer options" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
- **Maximum discount** — for an Amount discount this is the deduction itself; for a Percentage discount it caps how much the code can take off.
- **Minimum cart value** — the code only applies when the cart reaches this subtotal. `0` means no minimum.
- **Default** — one entry can be marked as the default that other, unconfigured currencies convert from.

<Frame>
    <img src="/images/discount-codes/discount_currency_options.png" alt="Currency options panel with per-currency amount and minimum subtotal for INR and USD" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
