...
<Info>
`discount_codes` accepts an array of up to 20 codes that stack in order. The singular `discount_code` field is deprecated — use `discount_codes` for both single and multiple codes.
</Info>
