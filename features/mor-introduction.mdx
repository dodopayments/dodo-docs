...
title: "Introduction"
description: "Dodo Payments acts as your Merchant of Record, handling global payments, tax compliance, fraud protection, and regulatory liability so you can focus on building your product."
icon: "building-columns"
keywords: ["Dodo Payments", "introduction", "payment platform", "SaaS billing"]
---
...
Yes. With [Bring Your Own Processor (BYOP)](/features/byop) you can connect your own Stripe or Adyen account and route payments from selected countries through it, while Dodo Payments continues to power products, subscriptions, invoicing, and analytics. Countries you do not explicitly route keep flowing through Dodo Payments as your full-service Merchant of Record, which is what allows us to assume tax and fraud liability on those routes.
</Accordion>
