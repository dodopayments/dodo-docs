...
title: Crypto
sidebarTitle: Crypto
description: Accept cryptocurrency payments from customers worldwide. Learn about supported coins, USD billing, and configuration for crypto checkout.
icon: "bitcoin-sign"
keywords: ["Dodo Payments", "crypto", "cryptocurrency", "Bitcoin", "payment methods", "USD"]
---
...
sequenceDiagram
    ...
    Customer->>Checkout: Select Crypto
