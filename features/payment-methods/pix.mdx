...
title: Pix
sidebarTitle: Pix
description: Accept Pix payments from Brazilian customers. Learn about real-time bank transfers, QR code payments, and configuration for the Brazilian market.
icon: "brazilian-real-sign"
keywords: ["Dodo Payments", "Pix", "Brazil", "BRL", "payment methods", "bank transfer"]
---
...
<Step title="Enter test CPF and complete the flow">
When prompted for a Pix CPF, enter `1234567890`. Follow the simulated Pix payment flow — a test QR code will be generated.
</Step>
</Steps>
