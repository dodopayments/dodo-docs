...
icon: "calendar-days"
keywords: ["Dodo Payments", "buy now pay later", "BNPL", "Klarna", "Afterpay", "payment methods", "buy now pay later (bnpl)"]
---
...
**Check:**
1. Transaction amount within the provider's supported range? (Klarna/Afterpay: min $50.01)
