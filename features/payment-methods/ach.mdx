...
| **Transaction Fee** | 1.5%, capped at $15.00 |

<Info>
ACH is priced as a bank debit, not as a card: a flat **1.5%** of the payment, capped at **$15.00**. The card base rate, the fixed per-transaction fee, and the international surcharge do not apply. Because the fee is capped, the saving against a card grows with order value — a $10,000 ACH payment is charged $15.00. Recovery fees (abandoned cart, dunning, and retry) are billed separately at their own rates and sit outside the cap. See the [pricing page](https://dodopayments.com/pricing) for the rates that apply to your account.
</Info>
