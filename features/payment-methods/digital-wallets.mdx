...
icon: "wallet"
keywords: ["Dodo Payments", "Apple Pay", "Google Pay", "digital wallets", "payment methods"]
---
...
The Kotlin Mobile SDK and React Native SDK open Dodo's hosted checkout in
the platform's real browser surface (Chrome Custom Tabs / `SFSafariViewController`),
not a WebView, so Apple Pay and Google Pay work the same way they do on the
web. iOS and Flutter checkout SDKs are coming soon.
