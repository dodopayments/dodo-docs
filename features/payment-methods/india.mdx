...
sidebarTitle: India
description: Accept UPI and all Indian-issued cards in India with RBI-compliant subscription mandates. Understand the 48-hour processing delay, mandate limits, and webhook handling.
icon: "indian-rupee-sign"
keywords: ["Dodo Payments", "UPI", "RuPay", "Indian payments", "INR", "payment methods", "india payment methods"]
---

India has unique payment infrastructure dominated by UPI (60%+ of digital transactions) and Indian-issued cards (Rupay, etc.). Dodo Payments supports all of these with full RBI compliance for subscription mandates.
...
Unlike most alternative payment methods, UPI and all Indian-issued cards (Rupay, etc.) support recurring payments via RBI mandates.
</Card>
</CardGroup>
...
| **Indian-issued Credit Cards** | Card | Yes* | ₹1 |
| **Indian-issued Debit Cards** | Card | Yes* | ₹1 |

*Subscriptions require RBI-compliant mandates with special processing rules. The 48-hour processing delay applies to all Indian-issued cards and UPI.
...
| `credit` | Indian-issued credit cards (Rupay, etc.) |
| `debit` | Indian-issued debit cards (Rupay, etc.) |
