...
description: "Combine multiple billing modes to create sophisticated pricing strategies: subscription + usage, seats + add-ons, base + overage, and more."
icon: "layer-group"
keywords: ["Dodo Payments", "hybrid billing models", "payment platform", "SaaS billing"]
---
