...
icon: "scale-balanced"
keywords: ["Dodo Payments", "mor vs pg", "payment platform", "SaaS billing"]
---
...
| Settlement Currency             | USD, EUR, GBP, and 25+ others supported    | Depends on your merchant account           |
