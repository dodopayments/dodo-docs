...
<Frame>
<img src="/images/entitlements/create.png" alt="License Key entitlement form with activation limit, duration, and instructions" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
