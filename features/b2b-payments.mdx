...
<Frame>
<img src="/images/b2b-payments-business-name.png" alt="Checkout page with the 'Purchasing as a business' toggle enabled, showing Business Name and Tax ID Number fields" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
