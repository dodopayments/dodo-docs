...
- **Labels also follow your currency and transfer method.** Each field is named the way your bank names it, for example the China domestic bank code is labeled **CNAPS**.
