...
<Step title="Bi-Weekly">
Payouts are initiated on the **4th, 7th, 11th, 14th, 18th, 21st, 25th, and 29th** of each month, each covering the sales accrued since the previous payout date.

In short months (for example, February), windows that depend on a date the month does not have are swept into the next scheduled payout, so no funds are lost.
</Step>

<Step title="Tri-Weekly">
Payouts are initiated on **every even day of the month** — the 2nd, 4th, 6th, 8th, 10th, 12th, 14th, 16th, 18th, 20th, 22nd, 24th, 26th, 28th, and 30th (15 payout dates per month), each covering the sales accrued since the previous payout date.

In months with fewer than 30 days, the windows that would fall on a missing date are not paid that month and are swept into the next scheduled payout.
</Step>
...
- Businesses with higher transaction volumes may request **weekly**, **bi-weekly**, or **tri-weekly** payouts by contacting [support@dodopayments.com](mailto:support@dodopayments.com).
