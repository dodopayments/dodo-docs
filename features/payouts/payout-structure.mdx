...
<Step title="Biweekly">
A higher-frequency cycle with **8 payout dates per month** (on the 4th, 7th, 11th, 14th, 18th, 21st, 25th, and 29th), each covering the earnings accrued since the previous payout date. Available on request for high-volume businesses.
</Step>

<Step title="Tri-weekly">
The highest-frequency cycle, with **15 payout dates per month** (on every even-numbered day), each covering the earnings accrued since the previous payout date. Available on request for high-volume businesses.
</Step>
...
- Businesses with higher transaction volumes may request **weekly**, **biweekly**, or **tri-weekly** payouts by contacting [support@dodopayments.com](mailto:support@dodopayments.com).
