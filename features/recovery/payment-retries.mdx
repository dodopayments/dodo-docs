...
icon: "rotate-right"
keywords: ["Dodo Payments", "payment retries", "subscription recovery", "failed renewal", "dunning", "smart retries", "revenue recovery", "on hold subscription"]
---
...
<Tip>
A recovery window of **13 days** (the default) covers attempts 1 through 6. Increase the window toward the 30-day maximum if you want the later, more widely-spaced attempts to run.
</Tip>
