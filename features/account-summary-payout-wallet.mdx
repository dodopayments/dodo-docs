---
title: Balances
description: Track your financial activity across multi-currency wallets with comprehensive transaction ledgers, including payments, refunds, fees, and payouts in USD, GBP, and EUR.
icon: "file-invoice-dollar"
keywords: ["Dodo Payments", "balances", "payment platform", "SaaS billing"]
---
...
Each business account maintains **three native wallets** based on supported payout currencies:
...
- **Currency Filter:** Allows merchants to view transactions by specific wallet (USD, GBP, EUR).
