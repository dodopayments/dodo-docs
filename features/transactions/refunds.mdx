...
icon: "rotate-left"
keywords: ["Dodo Payments", "refunds", "partial refunds", "refund processing"]
---
...
| review    | The refund is held for manual review before processing.             | Risk or compliance check triggered on the refund                                                     |
