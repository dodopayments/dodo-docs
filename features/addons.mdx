...
description: "Enhance your subscription products with flexible add-ons for seat-based billing, feature upgrades, credit top-ups, and creative pricing models"
icon: "puzzle"
---
...
<Card title="Credit Top-Ups" icon="coins" href="/features/credit-based-billing">
Grant additional credits through add-ons that extend your customers' credit balance.
</Card>
</CardGroup>
...
- **Credit top-ups**: Additional credit packs for API calls, AI tokens, or any credit-based entitlement
...
- **Credit entitlements**: Attach credit entitlements to grant credits when the add-on is purchased
...
## Credits with Add-ons

Add-ons can include credit entitlements, allowing customers to purchase additional credits alongside their base subscription. When a customer purchases an add-on with credits attached, those credits are granted to their balance immediately.

This is ideal for creating credit top-up packs, promotional credit bundles, or tiered credit add-ons that give customers flexibility to extend their usage.

When attaching an add-on to a subscription product, you can configure:

- **Number of credits issued** — How many credits the customer receives when purchasing this add-on
- **Credit entitlement** — Which credit entitlement the add-on grants (e.g., API Credits, AI Tokens)
- **Free threshold** — Usage units included free with the add-on before credits are consumed

<Card title="Credit-Based Billing Guide" icon="coins" href="/features/credit-based-billing#add-ons-with-credits">
  See the full guide for configuring credit entitlements on add-ons, including screenshots and step-by-step instructions.
</Card>
...
- **Usage Extensions**: Extra storage, API calls, or bandwidth allowances
- **Service Add-ons**: Professional services, training, or consultation hours
- **Credit Top-Ups**: Additional credit packs (e.g., "500 Extra API Calls", "1000 AI Tokens")
