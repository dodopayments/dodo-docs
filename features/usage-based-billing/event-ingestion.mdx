...
icon: "bolt"
keywords: ["Dodo Payments", "event ingestion", "usage events", "event tracking", "usage-based billing"]
---
...
ISO 8601 timestamp (UTC). Defaults to the current server time if omitted. Include for accurate billing with delayed/batch events. Timestamps older than 1 hour, or more than 5 minutes in the future, are rejected.
</ParamField>
