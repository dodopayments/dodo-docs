...
In the **Pricing** section, tick **Localized Pricing**, then choose **By Country** or **By Currency**. Markets you add appear under **Countries added**.

<Frame>
  <img src="/images/localized-pricing/product-form-localized-pricing.png" alt="Localized Pricing enabled on the product form with By Country selected" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>

<Step title="Add a price for each market">
Click **Add Country Price** (or **Add Currency Price** in by-currency mode). In the **Localized pricing** panel, pick the country, choose the currency, enter the amount, and click **Add**. Repeat for each market.

<Frame>
  <img src="/images/localized-pricing/add-country-override.png" alt="Adding a country override of 999 INR for India in the Localized pricing panel" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
