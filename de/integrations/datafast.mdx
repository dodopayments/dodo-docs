...
<Step title="Transformation konfigurieren">
  Bearbeiten Sie den Transformation-Code, um Zahlungsdaten für die Payment API von DataFast zu formatieren.
</Step>
...
<Accordion title="Einnahmenzuordnung funktioniert nicht">
...
- Vergewissern Sie sich, dass Sie die Besucher-ID erfassen, bevor Sie die Checkout-Sitzung erstellen
