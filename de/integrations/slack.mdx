...
<Step title="Slack-Integration auswählen">
  ...
  <Frame>
    <img src="/images/integrations/slack/2.png" alt="Slack-Integrationskarte und Verbindungsschaltfläche" />
  </Frame>
</Step>
...
<Step title="Testen und Erstellen">
  ...
  <Frame>
    <img src="/images/integrations/slack/5.png" alt="Testen der Transformation und Erstellen-Schaltfläche" />
  </Frame>
</Step>
...
- Fügen Sie immer wichtige Daten wie Beträge, Kunden-E-Mails und IDs für eine schnelle Identifikation hinzu.
- Wählen Sie Farben, die zur Art des Ereignisses passen: grün (`good`) für Erfolge, rot (`danger`) für Streitigkeiten oder Fehler, gelb (`warning`) für Stornierungen und blau (`#36a64f`) für Informationsereignisse.
- Fügen Sie Zeitstempel hinzu, um nachverfolgen zu können, wann jedes Ereignis stattfand.
...
- Wählen Sie Farben, die zum Ereignistyp passen: grün (`good`) für Erfolg, rot (`danger`) für Streitigkeiten oder Fehler, gelb (`warning`) für Stornierungen und blau (`#36a64f`) für Informationsereignisse.
