...
<Step title="Open the Webhook Section">
  Gehen Sie zum Abschnitt <b>Webhook</b> in Ihrem Dodo Payments-Dashboard. Klicken Sie auf die Schaltfläche <b>+ Add Endpoint</b> und öffnen Sie dann das Webhook-Dropdown, um weitere Integrationen anzuzeigen.
  <Frame>
    <img src="/images/integrations/slack/1.png" alt="Dodo Payments-Dashboard zeigt Add Endpoint-Schaltfläche und Integrations-Dropdown" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>

<Step title="Select Slack Integration">
  Wählen Sie die <b>Slack</b>-Integration und klicken Sie auf <b>Connect your Slack workspace</b>.
  <Frame>
    <img src="/images/integrations/slack/2.png" alt="Slack-Integrationskarte und Verbindungsschaltfläche" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>

<Step title="Grant Slack Permissions">
  Erteilen Sie die notwendigen Berechtigungen für die Incoming Webhooks Slack App, damit sie Nachrichten in Ihrem gewählten Kanal posten kann.
  <Frame>
    <img src="/images/integrations/slack/3.png" alt="Slack OAuth-Berechtigungsbildschirm für Incoming Webhooks-App" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>

<Step title="Customize Transformation Code">
  Fügen Sie den Transformationscode hinzu oder bearbeiten Sie ihn, um Ihre Slack-Benachrichtigungen für Ihren Anwendungsfall anzupassen. Sie können die vorgefertigten Vorlagen verwenden oder Ihre eigene Logik schreiben.
  <Frame>
    <img src="/images/integrations/slack/4.png" alt="Transformationscode-Editor für Slack-Integration" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>

<Step title="Test and Create">
  Testen Sie Ihren Transformationscode mit benutzerdefinierten oder vorgefertigten Ereignis-Payloads. Sobald Sie zufrieden sind, klicken Sie auf <b>Create</b>, um die Integration zu aktivieren.
  <Frame>
    <img src="/images/integrations/slack/5.png" alt="Transformation testen und Erstellen-Schaltfläche" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
...
So gestalten Sie Ihre Slack-Benachrichtigungen effektiv:
- Verwenden Sie umfangreiche Nachrichtenanhänge mit Farben, Feldern und Formatierungen, um Klarheit und Handlungsfähigkeit zu gewährleisten.
- Fügen Sie immer wichtige Daten wie Beträge, Kunden-E-Mail-Adressen und IDs hinzu, damit eine schnelle Identifizierung möglich ist.
- Wählen Sie Farben passend zum Ereignistyp: Grün (`good`) für Erfolge, Rot (`danger`) für Zahlungsanfechtungen oder Fehler, Gelb (`warning`) für Stornierungen und Blau (`#3aa3e3`) für informative Ereignisse.
- Fügen Sie Zeitstempel hinzu, damit nachvollziehbar ist, wann jedes Ereignis aufgetreten ist.
