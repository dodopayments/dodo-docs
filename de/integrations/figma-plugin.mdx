...
Erstellen Sie Ihr eigenes Figma-Plugin-Projekt mit [Figma's Plugin-Quickstart-Anleitung](https://www.figma.com/plugin-docs/plugin-quickstart-guide/). Dies generiert ein Gerüst mit einer `manifest.json` Datei.
...
- Passen Sie `LicenseKeyInput.tsx` an, um Ihren Designvorlieben zu entsprechen
...
2. Gründlich in Test- und Live-Modus testen
3. Folgen Sie [Figma's Richtlinien zur Veröffentlichung von Plugins](https://www.figma.com/plugin-docs/publishing-plugins/)
4. Zur Überprüfung über die Figma-Community einreichen
