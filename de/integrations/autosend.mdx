...
- Überprüfen Sie, ob der API-Key korrekt und aktiv ist
...
- Überprüfen Sie die Sendegrenzen und -quoten von AutoSend
- Stellen Sie sicher, dass die API-Endpunkt-URL korrekt ist: `https://api.autosend.com/v1/mails/send`
- Überprüfen Sie, ob alle erforderlichen Parameter im Payload vorhanden sind
</Accordion>

<Accordion title="Transformationsfehler">
- Validieren Sie die JSON-Struktur, dass sie dem Format der AutoSend API entspricht
...
- Überprüfen Sie, ob alle erforderlichen Variablen für die Vorlage bereitgestellt sind
