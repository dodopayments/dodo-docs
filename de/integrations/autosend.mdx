---
title: AutoSend
description: Erfahren Sie, wie Sie die E-Mail-API von AutoSend nutzen, um
...
Versenden Sie Transaktions-E-Mails für Zahlungsereignisse mit der leistungsstarken E-Mail-API von AutoSend.
...
- Verifizieren Sie, dass die API-Endpunkt-URL korrekt ist: `https://api.autosend.com/v1/mails/send`
- Überprüfen Sie, ob die erforderlichen Parameter im Payload vorhanden sind
</Accordion>
...
- Verifizieren Sie, dass `templateId` gültig ist, wenn Sie Vorlagen verwenden
