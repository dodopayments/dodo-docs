...
<Step title="Open the Webhook Section">
  Navigieren Sie in Ihrem Dodo Payments-Dashboard zu <b>Webhooks → + Endpoint hinzufügen</b> und erweitern Sie das Integrationen-Dropdown.
  <Frame>
    <img src="/images/integrations/zapier.png" alt="Endpoint hinzufügen und Integrationen-Dropdown" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
