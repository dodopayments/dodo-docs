...
<Step title="Open the Webhook Section">
  Gehe in deinem Dodo Payments-Dashboard zu <b>Webhooks → + Endpunkt hinzufügen</b> und erweitere das Integrations-Dropdown.
  <Frame>
    <img src="/images/integrations/sendgrid.png" alt="Endpunkt hinzufügen und Integrations-Dropdown" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
