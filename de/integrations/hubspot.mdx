...
<Step title="Open the Webhook Section">
  In Ihrem Dodo Payments-Dashboard, gehen Sie zu <b>Webhooks → + Endpunkt hinzufügen</b> und erweitern Sie das Integrations-Dropdown.
  <Frame>
    <img src="/images/integrations/hubspot.png" alt="Endpunkt hinzufügen und Integrations-Dropdown" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
