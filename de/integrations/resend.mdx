...
<Step title="Open the Webhook Section">
  Gehe in deinem Dodo Payments-Dashboard zu <b>Webhooks → + Endpunkt hinzufügen</b> und klappe das Integrations-Dropdown auf.
  <Frame>
    <img src="/images/integrations/resend.png" alt="Endpunkt hinzufügen und Integrations-Dropdown" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
