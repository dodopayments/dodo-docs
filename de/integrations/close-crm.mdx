...
<Step title="Open the Webhook Section">
  Gehen Sie in Ihrem Dodo Payments-Dashboard zu <b>Webhooks → + Endpunkt hinzufügen</b> und erweitern Sie das Integrations-Dropdown.
  <Frame>
    <img src="/images/integrations/close-crm.png" alt="Endpunkt hinzufügen und Integrations-Dropdown" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
