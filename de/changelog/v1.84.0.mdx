...
<Frame>
<img src="/images/product-analytics/overview.png" alt="Produktspezifische Analysen" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
| Vorteil | Auswirkung |
|---------|--------|
| **Niedrigere Streitquote** | RDR-gelöste Streitfälle zählen nicht zum Visa-Schwellenwert von 0,9 % |
| **Streitgebühr bleibt bestehen** | Eine Streitgebühr wird weiterhin bei RDR-gelösten Transaktionen erhoben – dies deckt die Kosten für den Einspruch bei Visa in Ihrem Namen |
| **Kein operativer Aufwand** | Keine Beweissammlung oder Fristen für Antworten |
| **Besseres Kundenerlebnis** | Karteninhaber erhalten sofortige Rückerstattungen |
| **Kontoschutz** | Fernbleiben vom Dispute Monitoring Program (VDMP) von Visa |
...
<Frame>
<img src="/images/customer-portal/new-portal.png" alt="Überarbeitung der Customer Portal UI" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
