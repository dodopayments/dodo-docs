...
Das Feld `refund_status` wurde zur `GET /payments/{payment_id}`-Antwort hinzugefügt, um schnell zu überprüfen, ob eine Zahlung erstattet wurde, ohne den refunds-Endpunkt separat abzufragen.
