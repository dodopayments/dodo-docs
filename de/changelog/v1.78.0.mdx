...
### 1. **Kommunikationspräferenzen**
   ...
   <Frame>
     <img src="/images/communication-preferences/overview.png" alt="Übersicht der Kommunikationseinstellungen mit Benachrichtigungseinstellungen" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
...
### 2. **Benutzerdefinierte Felder in Checkout-Sitzungen**
   ...
   **Vorteile**
   ...
   <Info>
   Werte benutzerdefinierter Felder werden im `custom_field_responses`-Array in Zahlungs- und Abonnementantworten zurückgegeben.
   </Info>

   Mehr erfahren: [Benutzerdefinierte Felder für Checkout-Sitzungen](/developer-resources/checkout-session#15-collecting-custom-fields)
