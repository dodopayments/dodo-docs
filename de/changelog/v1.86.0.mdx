...
<Frame>
<img src="/images/CBB/Checkout.png" alt="Kasse zeigt enthaltene Guthaben mit dem Produktkauf" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/CBB/Customer Portal.jpg" alt="Ansicht des Kundenportals mit Guthaben, Kontostand und Transaktionsverlauf" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/design/general-overview.jpg" alt="Design-Einstellungsseite mit Live-Vorschau der Kasse, des Kundenportals und des Schaufensters" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/design/general-color-settings.jpg" alt="Erweiterte Einstellungen zeigen vollständige Farbanpassung für Licht- und Dunkelmodus" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Tip>
Verwenden Sie diese Felder, um Streit- und Rückerstattungs-Dashboards zu erstellen, Alarme bei Statusänderungen auszulösen oder Zahlungen hervorzuheben, die Aufmerksamkeit erfordern.
</Tip>
...
Das Kundenportal umfasst jetzt einen speziellen **Rückerstattungen**-Bereich, in dem Kunden alle Rückerstattungen zu ihren Zahlungen anzeigen können. Jeder Rückerstattungseintrag zeigt den Rückerstattungsbetrag, den Status, das Datum und die ursprüngliche Zahlung, gegen die sie ausgestellt wurde, um den Kunden volle Transparenz über ihre Rückerstattungshistorie zu bieten, ohne den Support kontaktieren zu müssen.

<Check>
Die Rückerstattungstabelle ist automatisch im Kundenportal für alle Unternehmen verfügbar. Keine Konfiguration erforderlich.
</Check>

Erfahren Sie mehr: [Customer Portal](/features/customer-portal)

### 5. **In den Live-Modus kopieren für Meter**

Sie können jetzt **Meter direkt vom Testmodus in den Live-Modus kopieren**. Wenn Sie die Konfiguration eines Meters im Testmodus abgeschlossen haben, verwenden Sie die Kopieraktion, um sie mit allen Einstellungen in den Live-Modus zu replizieren: Aggregationstyp, Ereignisname, Filter und Kreditzuordnungen. Dies eliminiert die Notwendigkeit, Meter manuell neu zu erstellen, wenn Sie von der Entwicklung in die Produktion wechseln.

<Tip>
Erstellen und validieren Sie Ihre Konfigurationen zunächst im Testmodus, und kopieren Sie sie dann in den Live-Modus, wenn Sie bereit sind, in die Produktion zu gehen. Dies stellt sicher, dass Ihr Abrechnungssetup getestet wird, bevor es den tatsächlichen Kundenverbrauch bearbeitet.
</Tip>

Erfahren Sie mehr: [Usage-Based Billing](/features/usage-based-billing/introduction) | [Meters](/features/usage-based-billing/meters)
