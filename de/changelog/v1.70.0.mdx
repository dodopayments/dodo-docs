...
3. **Änderungen der Abonnementpläne im Dashboard mit Updates zum nächsten Abrechnungsdatum**  
    ...
    <Frame>
    <img src="/images/changelog/subscription-plan-changes.png" alt="Abonnementplan-Änderungen im Dashboard" style={{ maxHeight: '500px', width: 'auto' }} />
    </Frame>
...
4. **Kurze Links für Zahlungs-URLs**  
   ...
   <Frame>
   <img src="/images/changelog/short-links.png" alt="Kurze Links Funktion für Zahlungs-URLs" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
