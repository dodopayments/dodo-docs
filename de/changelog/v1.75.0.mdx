...
### 1. **Product Collections**  
   ...
   <Frame>
     <img src="/images/product-collection/checkout-page.png" alt="Seite zur Kasse für die Produktauswahl zeigt mehrere Planoptionen" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
