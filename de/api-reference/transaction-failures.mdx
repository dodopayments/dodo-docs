...
| `AUTHENTICATION_TIMEOUT` | Ja | Der Authentifizierungsprozess ist abgelaufen |
...
| `CARD_VELOCITY_EXCEEDED` | Ja | Zu viele Transaktionen in kurzer Zeit versucht |
...
| `NETWORK_TIMEOUT` | Nein | Die Netzwerkanforderung ist abgelaufen |
