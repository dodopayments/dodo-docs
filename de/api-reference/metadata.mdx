...
### Tun:
- Verwenden Sie konsistente Namenskonventionen für Metadatenschlüssel
- Dokumentieren Sie Ihr Metadatenschema intern
- Halten Sie die Werte kurz und aussagekräftig
- Verwenden Sie Metadaten nur für statische Daten
- Ziehen Sie in Betracht, Präfixe für verschiedene Systeme zu verwenden (z.B. `crm_id`, `inventory_sku`)
