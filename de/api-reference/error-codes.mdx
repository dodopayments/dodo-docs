...
- `DISCOUNT_CONCURRENT_REDEMPTION`
  - **Auslöser:** Eine andere Einlösung desselben Codes hielt die Zeilensperre für das Nutzungslimit zu lange (HTTP 503)
  - **Nachricht:** Der Rabatt wird gerade gleichzeitig eingelöst; bitte erneut versuchen
  - **Hinweis:** Vorübergehend. Der Code kann noch über Kapazität verfügen, daher kann die Anfrage sicher erneut versucht werden. Dies darf dem Kunden nicht als „Code aufgebraucht“ angezeigt werden.
