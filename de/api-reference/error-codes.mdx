...
- `UNSUPPORTED_BILLING_CURRENCY`
  ...
  - **Nachricht:** Abonnements mit einer anderen Abrechnungswährung als USD werden nicht unterstützt
...
- `UNSUPPORTED_CURRENCY`
  - **Auslöser:** Die Währung des Produkts oder Add-ons ist keine Währung, in der Dodo Payments Gebühren erheben kann. Die Basispreise können in jeder abrechenbaren Währung festgelegt werden, daher bedeutet dies normalerweise, dass der Währungscode ungültig oder noch nicht unterstützt ist.
  - **Nachricht:** Währung wird derzeit nicht unterstützt / Derzeit werden nur Produkte in USD und INR unterstützt / Derzeit werden nur USD und INR für Add-on-Preise unterstützt / Für billing_currency kann nur USD oder INR angefordert werden / Währung nicht unterstützt / Unerwartete Währung für indische Kartenabonnements
