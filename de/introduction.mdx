...
<Accordion title="For AI Agents">
  ...
  **Installieren**. Für Claude Code, Codex CLI, Cursor, VS Code / GitHub Copilot, Kiro oder OpenCode verbindet das [Dodo Agent Plugin](/developer-resources/build-with-ai-coding-agents) beide MCP servers und alle skills in einem Schritt. Gemini CLI erhält nur die MCP servers. Eine Übersicht der Installationsbefehle für die einzelnen Agents finden Sie im [Leitfaden zu AI Coding Agents](/developer-resources/build-with-ai-coding-agents).
  ...
  **Extend**. Install official [Dodo Payments Skills](/developer-resources/agent-skills) to teach your agent how to handle checkout, subscriptions, usage-based billing, credit-based billing, webhooks, and more:
  ...
  Funktioniert mit Claude Code, Codex CLI, Cursor, VS Code / GitHub Copilot, Kiro, OpenCode und jedem Agent, der das skills protocol unterstützt.
</Accordion>
</AccordionGroup>
...
<Step title="Add Your First Product">
  ...
  <Card title="Subscription Product" icon="repeat" href="/features/subscription">
    Ideal für SaaS, Mitgliedschaften oder wiederkehrende Dienste
  </Card>
  <Card title="Usage-Based Billing" icon="chart-bar" href="/features/usage-based-billing/introduction">
    Berechnen Sie Kunden für API-Aufrufe, Credits, Tokens oder beliebige Nutzungsmetriken - ideal für KI und SaaS
  </Card>
  <Card title="Credit-Based Billing" icon="coins" href="/features/credit-based-billing">
    Geben Sie Credits aus (API-Aufrufe, Tokens, Recheneinheiten) und ziehen Sie ab, während Kunden verbrauchen - mit Übertragungs- und Überverbrauchskontrollen
  </Card>
  </CardGroup>
</Step>
...
<Step title="Choose Your Integration Method">
  ...
  <Tab title="Full SDK Integration">
    **Best for advanced, fully customized solutions:**
    ...
    - Verwenden Sie unser TypeScript/Python/Go/PHP/Java/Kotlin/C#/Ruby/Rust SDK für eine nahtlose Integration
    - Programmgesteuerter Zugriff auf alle Payment-, Subscription- und Customer Portal APIs
    - Tiefe Integration in Ihr Backend, Ihre Workflows und Ihre Datenmodelle
...
Verbinden Sie Ihren AI Coding Assistant direkt mit Dodo Payments. Das Agent Plugin lässt sich mit einem einzigen Befehl für Claude Code, Codex CLI, Cursor, VS Code / GitHub Copilot, Kiro und OpenCode einrichten. Andere MCP-kompatible Agents wie Windsurf, Claude Desktop, Cline und Zed werden manuell über die MCP servers verbunden.

<CardGroup cols={3}>
<Card title="Agent Plugin" icon="robot" href="/developer-resources/build-with-ai-coding-agents">
  Eine Installation bündelt beide MCP servers und alle siebzehn skills für Claude Code, Codex CLI, Cursor, VS Code, Kiro und OpenCode
</Card>
...
<Card title="Expo Boilerplate" icon="box-open" href="/developer-resources/expo-boilerplate">
  Starte deine In-App-Zahlungen mit React Native mithilfe unseres Open-Source-Expo-Templates
</Card>
...
Verbinde Dodo Payments mit deinen bevorzugten Tools und Plattformen, um Workflows zu automatisieren, Benachrichtigungen zu senden und deine Zahlungsabläufe zu optimieren.

<Info>
**Alles automatisieren**: Richte Echtzeitbenachrichtigungen ein, löse Workflows aus, synchronisiere Kundendaten und mehr mit unserer wachsenden Bibliothek an Integrationen.
</Info>

### Beliebte Integrationen

Verbinde Dodo Payments schnell mit den meistgenutzten Design- und Produktivitätstools, um deinen Workflow zu optimieren und Zahlungsabläufe zu automatisieren.
...
<Card title="Raycast Extension" icon="rocket" href="/integrations/raycast-extension">
  Zahlungen über Raycast verwalten
</Card>

<Card title="Figma Plugin" icon="figma" href="/integrations/figma-plugin">
  Auf Dodo Payments in Figma zugreifen
</Card>
</CardGroup>

<AccordionGroup>
  <Accordion title="Communication & Notifications">
    Bleibe mit Echtzeitbenachrichtigungen in deinen Team-Kommunikationstools über Zahlungsereignisse informiert.

    <CardGroup cols={3}>
      <Card title="Slack" icon="slack" href="/integrations/slack">
        Zahlungsbenachrichtigungen und -warnungen an Slack-Kanäle senden
      </Card>
      <Card title="Discord" icon="discord" href="/integrations/discord">
        Sofortige Zahlungsupdates auf deinem Discord-Server erhalten
      </Card>
  ...
  <Accordion title="Email Marketing & Customer Communication">
    Kundendaten synchronisieren und auf Grundlage von Zahlungsereignissen E-Mail-Kampagnen auslösen.
  ...
  <Accordion title="CRM & Sales">
    Zahlungsdaten mit CRM-Plattformen verbinden, um Vertriebs- und Kundenmanagement zu optimieren.
  ...
  <Accordion title="Automation & Workflows">
    Leistungsstarke Automatisierungen und Datenpipelines mit Plattformen zur Workflow-Automatisierung erstellen.

    <CardGroup cols={4}>
      <Card title="Zapier" icon="bolt" href="/integrations/zapier">
        Mit Zapier eine Verbindung zu über 5.000 Apps herstellen
      </Card>
      <Card title="N8N" icon="diagram-project" href="/integrations/n8n">
        Workflows mit selbst gehostetem oder Cloud-N8N automatisieren
      </Card>
      ...
      <Card title="Inngest" icon="code" href="/integrations/inngest">
        Ereignisgesteuerte Workflows mit Inngest erstellen
      </Card>
      <Card title="Segment" icon="chart-network" href="/integrations/segment">
        Zahlungsdaten an Segment CDP streamen
      </Card>
      <Card title="DataFast" icon="chart-bar" href="/integrations/datafast">
        Umsätze mit der DataFast-Analyse Marketingkanälen zuordnen
      </Card>
    </CardGroup>
  </Accordion>
</AccordionGroup>
...
<Card title="View All Integrations" icon="puzzle-piece" href="/integrations/introduction">
  Unsere vollständige Bibliothek an Integrationen mit detaillierten Einrichtungsanleitungen entdecken
</Card>
...
<Card title="Developer Documentation" icon="book" href="/developer-resources/integration-guide">
  Umfassende Anleitungen und API-Referenzen entdecken
</Card>

<Card title="API Reference" icon="terminal" href="/api-reference/introduction">
  Vollständige OpenAPI-Referenz mit Endpunkten, Parametern und Beispielanfragen für alle Dodo Payments APIs
</Card>

<Card title="Community Support" icon="users" href="https://discord.gg/bYqAp4ayYh">
  Unserer Discord-Community für Hilfe und Diskussionen beitreten
</Card>

<Card title="Contact Support" icon="headphones" href="mailto:support@dodopayments.com">
  Direkte Hilfe von unserem Support-Team erhalten
</Card>
</CardGroup>