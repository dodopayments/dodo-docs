...
<Steps>
  ...
  <Step title="Das Tracking-Skript hinzufügen">
    ...
    - Aktiviert die Verfolgung von Anmeldungen und Zahlungen
  ...
  <Step title="Testen Sie Ihre Integration">
    ...
    **Test-Checkliste:**
    ...
    - ✅ Bestätigen Sie das Tracking und die Attribution in Ihrem Affonso-Dashboard
  </Step>
</Steps>
...
3. **Speichern Sie die Klick-ID** in den Zahlungs-Metadaten zusammen mit den Kundeninformationen
