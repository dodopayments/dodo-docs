...
<Frame>
  <img alt="Atlas Demo-Produkt - KI-Kunstgenerierungsplattform mit integrierter Abrechnung" src="/images/atlas/atlas-demo-product.png" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
