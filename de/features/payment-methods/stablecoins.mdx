...
| Typ | Methode | Land |
| :--- | :----- | :------ |
| `crypto_currency` | Stablecoins | Global (außer IN) |
...
Erstellen Sie eine Checkout-Sitzung mit `crypto_currency` in den erlaubten Zahlungsmethoden.
</Step>
...
**Überprüfen:**
1. `crypto_currency` in `allowed_payment_method_types` enthalten?
2. Entspricht der Transaktionsbetrag dem Minimum (0,50 $)?
