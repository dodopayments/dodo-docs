...
Erstellen Sie eine Checkout-Sitzung mit `we_chat_pay` in den erlaubten Zahlungsmethoden.
</Step>
...
**Überprüfen:**
1. `we_chat_pay` in `allowed_payment_method_types` enthalten?
2. Rechnungswährung auf USD oder CNY gesetzt?
3. Transaktionsbetrag erfüllt das Mindestmaß?
