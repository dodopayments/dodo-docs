...
Wenn nach einer Pix-CPF gefragt wird, geben Sie `1234567890` ein. Ein Test-QR-Code wird generiert — scannen Sie ihn mit Ihrer normalen Handykamera (keine Pix-App erforderlich). Sie werden zu einer Stripe-Testseite weitergeleitet, auf der Sie die Transaktion als Erfolg oder Fehlschlag simulieren können.
</Step>
</Steps>
