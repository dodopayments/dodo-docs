...
| Ebene | Wo festlegen | Geltungsbereich |
|-------|--------------|-------|
| **Pro Anfrage** | `mandate_min_amount_inr_paise` in einer Checkout-Sitzung oder einem Abonnement | Eine Transaktion |
| **Händler** | Geschäftseinstellungen | Alle Ihre INR-Abonnements |
| **System** | — | ₹15.000 Standardwert |
