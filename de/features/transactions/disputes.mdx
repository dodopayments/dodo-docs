...
3. **Wählen Sie Ihre Antwort**
   - Sie können den Disput akzeptieren oder kontern
   
   <Frame>
       <img src="/images/disputes/1.png" alt="Dispute-Erstellung" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
...
5. **Wenn Sie kontern**
   ...
   - Befolgen Sie die unten stehenden Best Practices
   
   <Frame>
       <img src="/images/disputes/2.png" alt="Dispute-Erstellung" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
   
   <Frame>
       <img src="/images/disputes/3.png" alt="Dispute-Erstellung" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>

<Info>
Du hast **10 Tage** Zeit, auf einen Dispute zu antworten, nachdem er erstellt wurde. Der bei dem Dispute in deinem Dashboard angezeigte Countdown entspricht demselben Zeitraum.
</Info>
...
<Frame caption="Visa RDR configuration in the Dodo Payments dashboard">
    <img src="/images/disputes/rdr.png" alt="Visa RDR-Einstellungen, die den aktivierten Umschalter und die Schwellenkonfiguration zeigen" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Step title="Open the Disputes Settings">
    Navigieren Sie zu **Einstellungen → Geschäft** in Ihrem Dodo Payments-Dashboard und suchen Sie den Abschnitt **Visa Rapid Dispute Resolution (RDR)**.
</Step>
