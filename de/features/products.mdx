...
Für wiederkehrende Produkte setzen Sie `recurring: true` und geben Sie eine `billing_cycle` an (`daily`, `weekly`, `monthly`, `yearly`).
...
<CardGroup cols={3}>
<Card title="Checkout-Sitzungen" icon="code" href="/developer-resources/checkout-session">
