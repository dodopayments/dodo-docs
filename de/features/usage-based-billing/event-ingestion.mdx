...
Ereignistyp, der mit dem Ereignisnamen Ihres Zählers übereinstimmt (Groß-/Kleinschreibung beachten). Beispiele: `api.call`, `image.generated`
</ParamField>
</Accordion>
...
Zusätzliche Eigenschaften für Aggregation und Filtern:
...
<AccordionGroup>
<Accordion title="Eindeutige Ereignis-IDs verwenden">
...
Überprüfen Sie, ob der API-Schlüssel korrekt ist und verwenden Sie folgendes Format: `Bearer YOUR_API_KEY`
</Accordion>
...
<Accordion title="Metadata wird nicht aggregiert">
- Die Schlüssel der Metadaten müssen exakt mit dem "Over Property" des Zählers übereinstimmen
