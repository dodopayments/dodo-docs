...
description: Send usage events from your application to track customer
  consumption and power billing.
icon: bolt
keywords:
  - Dodo Payments
  - Ereignisaufnahme
...
ISO-8601-Zeitstempel (UTC). Wird er nicht angegeben, wird standardmäßig die aktuelle Serverzeit verwendet. Für eine genaue Abrechnung bei verzögerten/Stapelereignissen angeben. Zeitstempel, die älter als 1 Stunde sind oder mehr als 5 Minuten in der Zukunft liegen, werden abgelehnt.
</ParamField>
...
<Tip>
Bündeln Sie bis zu 1.000 Events pro Anfrage für bessere Leistung. Die API erzwingt ein festes Limit von 1.000 Events pro Aufruf.
</Tip>
