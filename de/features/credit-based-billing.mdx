...
Credits werden als **Berechtigungen** an Produkte angehängt im Produkt-Erstellungs- oder Bearbeitungsablauf. Sie können bis zu **5 Credits pro Produkt** anhängen. Credits funktionieren mit allen drei Preistypen.
...
<Info>
Sie können bis zu 5 Credits pro Produkt anhängen. Jedes Credit kann seine eigene Konfiguration haben.
</Info>
</Step>
