...
Wenn ein Abonnement aufgrund einer fehlgeschlagenen Zahlung in den `on_hold` Status versetzt wird, müssen die Kunden ihre Zahlungsmethode aktualisieren, um es wieder zu aktivieren. Der Aktualisierungsprozess führt automatisch durch:
...
4. **Reaktiviert das Abonnement** auf den `active` Status nach erfolgreicher Zahlung

<Warning>
Abonnements im `on_hold` Status werden nicht automatisch erneuert. Kunden müssen ihre Zahlungsmethode aktualisieren, um ausstehende Beträge zu begleichen und das Abonnement zu reaktivieren.
</Warning>

<Info>
Nach erfolgreicher Aktualisierung der Zahlungsmethode für ein `on_hold` Abonnement sehen die Kunden eine Bestätigungsseite und erhalten E-Mail-Benachrichtigungen über die erfolgreiche Zahlung und die Reaktivierung des Abonnements.
</Info>
...
Klicken Sie auf "Änderungen bestätigen", um die Zahlungsmethode zu aktualisieren. Für `on_hold` Abonnements wird dies automatisch eine Gebühr für ausstehende Beträge erstellen.
</Step>
...
- **Abonnement pausiert**: Wenn ein Abonnement pausiert ist, müssen die Kunden ihre Zahlungsmethode über das Portal aktualisieren, um ausstehende Beträge zu begleichen und das Abonnement zu reaktivieren. Der Aktualisierungsprozess wird automatisch für ausstehende Beträge berechnen.
