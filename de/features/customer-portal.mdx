...
Beide Felder sind auch im Webhook-Payload `subscription.cancelled` enthalten. Sie können sie programmatisch über `PATCH /subscriptions/{id}` ausfüllen, wenn Sie über die API eine Kündigung planen oder ausführen.
