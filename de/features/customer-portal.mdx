...
Zusätzlich zu geschäftsspezifischen Kundenportalen bietet Dodo Payments ein **Einheitliches Kundenportal** unter [customer.dodopayments.com](https://customer.dodopayments.com), wo Kunden alle ihre Käufe und Abonnements bei verschiedenen Unternehmen, die Dodo Payments nutzen, anzeigen und verwalten können.
