...
- **Preisgestaltung**: Legen Sie eine einmalige oder wiederkehrende Preisgestaltung für das Add-on fest
- **Währung**: Legen Sie den Basispreis in jeder Währung fest, in der Dodo Payments Gebühren erheben kann. Die durchsuchbare Währungsauswahl listet **USD, GBP, EUR und INR** ganz oben; Kunden außerhalb Ihrer Basiswährung werden über [Adaptive Currency](/features/adaptive-currency) abgerechnet
- **Abrechnungszeitraum**: Muss mit dem Abrechnungszeitraum Ihres Abonnements übereinstimmen
- **Mengenlimits**: Legen Sie minimale und maximale Mengen pro Kunde fest
- **Verfügbarkeit**: Legen Sie fest, welche Abonnementprodukte das Add-on verwenden können
- **Steuereinstellungen**: Konfigurieren Sie die entsprechenden Steuerkategorien
