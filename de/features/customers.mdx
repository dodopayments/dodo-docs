...
<Frame>
<img src="/images/customer/customers-list.png" alt="Kundenseite zeigt alle Kunden mit ihren Details" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/customer/customer-details.png" alt="Kundendetailseite zeigt Kundeninformationen und Transaktionshistorie" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
- Alle Aufladungen und Abbuchungen
- Aktueller Wallet-Saldo in jeder Währung (USD, EUR, GBP)
- Transaktionsgründe und Zeitstempel
- Detaillierte Transaktionshistorie zur Abstimmung
Sehen Sie das Wallet-Guthabenbuch des Kunden mit folgenden Angaben:
...
Customer Wallets sind Konten mit vorausbezahltem Guthaben für Ihre Kunden. Jeder Kunde erhält automatisch ein Wallet, das echte Geldbeträge in mehreren Währungen (USD, EUR und GBP) halten kann. Diese können auf Abonnementrechnungen angewendet, für Erstattungsguthaben verwendet oder mit Werbegutschriften aufgeladen werden.

### Hauptfunktionen

- **Unterstützung mehrerer Währungen**: Verfolgen Sie Geldguthaben in USD, EUR und GBP separat.
- **Vorausbezahlte Guthaben**: Kunden können Guthaben halten, das auf zukünftige Rechnungen und Abonnementzahlungen angewendet wird.
- **Transaktionshistorie**: Sehen Sie das vollständige Guthabenbuch aller Aufladungen und Abbuchungen ein.
- **API-First-Design**: Fügen Sie Wallet-Guthaben programmgesteuert hinzu, buchen Sie es ab und prüfen Sie es.
- **Guthabenbasierte Abrechnung**: Ermöglichen Sie Kunden, Guthaben im Voraus zu erwerben und für Ihre Dienste auszugeben.
- **Transaktionshistorie**: Sehen Sie das vollständige Guthabenbuch aller Gutschriften und Belastungen ein.
- **API-First-Design**: Fügen Sie Wallet-Guthaben programmgesteuert hinzu, entfernen Sie es und prüfen Sie es.
