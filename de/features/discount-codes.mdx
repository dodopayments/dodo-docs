...
- **Akquisitionsangebote**: Anreize für den ersten Kauf oder Empfehlungsbelohnungen
...
- **Produktbeschränkung** (optional): Beschränken Sie die Anwendbarkeit auf ausgewählte Produkte
...
2. Berechtigte Rabatte werden angewendet und die Gesamtsummen werden sofort aktualisiert.
...
- **Weise einschränken**: Beschränken Sie sich auf bestimmte Produkte, um Margenverluste zu vermeiden
