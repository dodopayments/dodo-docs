...
Überprüfen Sie, ob ein Rabatt anhand seiner ID gültig ist.
</Card>

<Card title="Rabatt nach Code abrufen" icon="tag" href="/api-reference/discounts/get-discount-by-code">
Suchen und validieren Sie einen Rabatt mit seinem Code-Namen (z. B. "SAVE20").
</Card>
...
Durchsuchen und verwalten Sie bestehende Rabatte; aktualisieren oder löschen Sie sie nach Bedarf.
</Card>
</CardGroup>
...
<Info>
In Checkout-Sitzungen übergeben Sie `discount_code`, um einen Code vorzuwählen, und setzen Sie `feature_flags.allow_discount_code`, um das Eingabefeld anzuzeigen.
</Info>
...
<Accordion title="Rabatt nach Code abrufen">
Suchen Sie einen Rabatt mit seinem lesbaren Code (z. B. "SAVE20") anstelle der internen ID.

<Card title="API-Referenz" icon="code" href="/api-reference/discounts/get-discount-by-code">
