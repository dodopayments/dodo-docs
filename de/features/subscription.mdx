...
Bevor Sie sich für eine Planänderung entscheiden, sehen Sie sich die genauen Kosten und das resultierende Abonnement an:
...
<Card title="Vorschau auf die Planänderungs-API" icon="eye" href="/api-reference/subscriptions/preview-change-plan">
  Vorschau auf Planänderungen, bevor Sie sich dafür entscheiden.
</Card>
...
Ein Abonnement tritt in den Zustand `on_hold` ein, wenn:
...
<Warning>
Wenn sich ein Abonnement im Zustand `on_hold` befindet, wird es nicht automatisch verlängert. Sie müssen die Zahlungsmethode aktualisieren, um das Abonnement wieder zu aktivieren.
</Warning>
...
Verwenden Sie `POST /subscriptions`, um Abonnements programmgesteuert aus Produkten zu erstellen, mit optionalen Testphasen und Add-Ons.
...
Verwenden Sie `PATCH /subscriptions/{id}`, um Mengen zu aktualisieren, am Ende der Periode zu kündigen oder Metadaten zu ändern.
...
<Accordion title="Pläne ändern (Proratisierung)">
Ändern Sie das aktive Produkt und die Mengen mit Proratisierungssteuerungen.
...
Für On-Demand-Abonnements, berechnen Sie spezifische Beträge auf Anfrage.
...
Aktualisieren Sie die Zahlungsmethode für ein Abonnement. Für aktive Abonnements wird damit die Zahlungsmethode für zukünftige Erneuerungen aktualisiert. Für Abonnements im Zustand `on_hold` reaktiviert dies das Abonnement, indem eine Gebühr für ausstehende Beträge erstellt wird.
...
- **SaaS und APIs**: Gestaffelter Zugang mit Add-Ons für Plätze oder Nutzung
...
### Planänderungen mit Proratisierung
Upgrade oder Downgrade eines Abonnements und Steuerung des Proratisierungsverhaltens:
...
Planen Sie eine Kündigung ohne sofortige Beendigung des Zugangs:
...
## Abonnements mit RBI-konformen Mandaten
  ...
  - **Gebühren unter ₹15.000:** Wir erstellen ein On-Demand-Mandat für ₹15.000 INR. Der Abonnementbetrag wird periodisch gemäß Ihrer Abonnementfrequenz bis zur Mandatsgrenze berechnet.
  ...
  **Umgang mit Sonderfällen:** Wenn Sie Kunden sofort nach der Zahlungsinitiierung Vorteile, Gutschriften oder Abonnementnutzungen gewähren, müssen Sie dieses 48-Stunden-Fenster in Ihrer Anwendung angemessen behandeln. Berücksichtigen Sie:

  - Verzögerung der Aktivierung von Vorteilen bis zur Zahlungsbestätigung
...
- **Kommunizieren Sie die Preise**: Zeigen Sie Gesamtsummen, Proratisierung und nächste Erneuerung an
- **Nutzen Sie Testphasen sinnvoll**: Konvertieren Sie mit Onboarding, nicht nur mit Zeit
- **Nutzen Sie Add-Ons**: Halten Sie Basispläne einfach und verkaufen Sie Extras
- **Testen Sie Änderungen**: Validieren Sie Planänderungen und Proratisierung im Testmodus

<Info>
Abonnements sind eine flexible Grundlage für wiederkehrende Einnahmen. Beginnen Sie einfach, testen Sie gründlich und iterieren Sie basierend auf Adoption, Abwanderung und Expansionsmetriken.
</Info>