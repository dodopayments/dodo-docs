...
<Info>
Alle Beispiele setzen voraus, dass Sie den Remix App Router verwenden.
</Info>

<Tabs>
<Tab title="Checkout Handler">
  <Info>
  Verwenden Sie diesen Handler, um den Dodo Payments Checkout in Ihre Remix-App zu integrieren. Unterstützt statische (GET), dynamische (POST) und Sitzungs- (POST) Zahlungsflüsse.
  </Info>
  <CodeGroup>
...
Der Customer Portal Route Handler ermöglicht es Ihnen, das Dodo Payments Kundenportal nahtlos in Ihre Remix-Anwendung zu integrieren.
