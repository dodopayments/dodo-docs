---
title: Astro Adaptor
description: Erfahren Sie, wie Sie Dodo Payments in Ihr Astro App Router-Projekt
  mit unserem Astro Adaptor integrieren. Behandelt Checkout, Kundenportal,
...
{/* LOCKED_PATTERN_848a353666469e7a047ef05af5a45770 */}
    Integriere den Dodo Payments Checkout in deine Astro-App.
</Card>
...
<Info>
Alle Beispiele gehen davon aus, dass du den Astro App Router verwendest.
</Info>

<Tabs>
{/* LOCKED_PATTERN_28fd81a4703a84d931eeff69f1520d54 */}
  <Info>
  Verwende diesen Handler, um den Dodo Payments Checkout in deine Astro-App zu integrieren. Unterstützt statische (GET), dynamische (POST) und sitzungsbasierte (POST) Zahlungsabläufe.
  </Info>
  <CodeGroup>
...
{/* LOCKED_PATTERN_085b207030169d6eead800f9835ef4fb */}
  <Info>
  Verwende diesen Handler, um Kunden über das Dodo Payments-Kundenportal die Verwaltung ihrer Abonnements und Daten zu ermöglichen.
  </Info>
  <CodeGroup>
...
{/* LOCKED_PATTERN_0026b036379d81a9d03c36b3b6e83ddd */}
  <Info>
  Verwende diesen Handler, um Dodo Payments Webhook-Ereignisse sicher in deiner Astro-App zu empfangen und zu verarbeiten.
  </Info>
  <CodeGroup>
...
<Info>
Dodo Payments unterstützt drei Arten von Zahlungsabläufen zur Integration von Zahlungen in deine Website; dieser Adapter unterstützt alle Zahlungsabläufe.
</Info>
...
Vollständiges Namensfeld deaktivieren.
</ParamField>
...
Checkout-Sessions bieten ein sichereres, gehostetes Checkout-Erlebnis, das den vollständigen Zahlungsablauf sowohl für Einmalkäufe als auch Abonnements übernimmt und volle Kontrolle über die Anpassung ermöglicht.
...
Der Kundenportal-Routen-Handler ermöglicht es Ihnen, das Dodo Payments Kundenportal nahtlos in Ihre Astro-Anwendung zu integrieren.
