...
<Card title="TypeScript SDK" icon="js" href="/developer-resources/sdks/typescript">
  Typsichere Integration für TypeScript und Node.js mit versprechenbasierter API und automatischer Seitenumbruch
</Card>
...
- **Automatischer Seitenumbruch**: Automatischer Seitenumbruch für Listenantworten
...
<Info>
Wir sind vom Node.js SDK zum neuen TypeScript SDK migriert. Wenn Sie das veraltete Node.js SDK verwenden, lesen Sie den [Migrationsleitfaden](https://github.com/dodopayments/dodopayments-typescript/blob/main/MIGRATION.md), um Ihre Integration zu aktualisieren.
</Info>
