...
Das [Dodo Agent Plugin](/developer-resources/build-with-ai-coding-agents) installiert beide MCP-Server und alle siebzehn Skills in einem Schritt für Claude Code, Codex CLI, Cursor, VS Code / GitHub Copilot, Kiro und OpenCode. Gemini CLI erhält nur die beiden MCP-Server, da es kein Agent-Skill-Primitiv besitzt. Im [Leitfaden für KI-Coding-Agenten](/developer-resources/build-with-ai-coding-agents) findest du Installationsbefehle für die einzelnen Agenten.
