...
<Note>
Docker-Images sind im [GitHub Container Registry](https://github.com/orgs/dodopayments/packages/container/package/mcp) verfügbar.
</Note>
...
<Step title="Claude Desktop neu starten">
    Schließen Sie Claude Desktop und öffnen Sie ihn erneut, damit die Änderungen wirksam werden.
...
Die Konfiguration wird in der `.claude.json` Datei in Ihrem Home-Verzeichnis gespeichert.
...
<Steps>
<Step title="Öffnen Sie die MCP-Konfiguration">
...
<Step title="Speichern und überprüfen">
    Speichern Sie die Konfiguration. Der MCP-Server sollte jetzt im Zed-KI-Assistenten verfügbar sein.
</Step>
</Steps>
</Tab>
...
<Info>
Besuchen Sie [modelcontextprotocol.io/clients](https://modelcontextprotocol.io/clients) für eine vollständige Liste der MCP-kompatiblen Clients und deren Konfigurationsmethoden.
</Info>
</Tab>
</Tabs>
...
**Geben Sie niemals Anmeldeinformationen in der Versionskontrolle an**
...
Verwenden Sie während der Entwicklung immer Testmodus-API-Schlüssel, um zu vermeiden, dass Produktionsdaten betroffen sind.
</Accordion>
...
Bei der Bereitstellung im Remote-Modus ist immer eine Authentifizierung über den `Authorization` Header oder den `x-dodo-payments-api-key` Header erforderlich.
...
Konfigurieren Sie Firewall-Regeln, um zu beschränken, welche Clients eine Verbindung zu Ihrem MCP-Server herstellen können.
</Accordion>
</AccordionGroup>
...
Aktivieren Sie das ausführliche Protokollieren in Ihrem MCP-Client, um Verbindungsprobleme zu diagnostizieren.
</Accordion>
...
Stellen Sie sicher, dass `DODO_PAYMENTS_ENVIRONMENT` korrekt gesetzt ist (`live_mode` für die Produktion).
...
<Accordion title="Toolausführungsfehler">
...
<Accordion title="Client-Kompatibilitätsprobleme">
...
**Überprüfen Sie die Unterstützung der Funktionen**
