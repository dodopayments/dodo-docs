...
Laden Sie die Datei auf Ihren Webserver unter `/.well-known/apple-developer-merchantid-domain-association` hoch. Wenn Ihre Website beispielsweise unter `example.com` ist, stellen Sie die Datei unter `https://example.com/well-known/apple-developer-merchantid-domain-association` zur Verfügung.
...
- Ihre Produktionsdomänen-URL (z. B. `https://example.com`)
...
3. Testen Sie den gesamten Zahlungsablauf

</Step>
</Steps>

<Warning>
Apple Pay muss für Ihre Domain aktiviert sein, bevor es als Zahlungsoption in der Produktion angezeigt wird. Kontaktieren Sie den Support, bevor Sie live gehen, wenn Sie planen, Apple Pay anzubieten.
</Warning>
...
<Card title="Inline Checkout" icon="credit-card" href="/developer-resources/inline-checkout">
    Betten Sie den Checkout direkt in Ihre Seite ein, um vollständig integrierte Erlebnisse zu schaffen.
</Card>
...
<Card title="Webhooks" icon="webhook" href="/developer-resources/webhooks">
    Behandeln Sie Zahlungsereignisse serverseitig mit Webhooks.
</Card>
