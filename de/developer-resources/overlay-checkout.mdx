...
<Info>
Dieser Abschnitt behandelt die **clientseitige** Themenkonfiguration mithilfe des Checkout SDK. Du kannst Themen auch **serverseitig** konfigurieren, wenn du eine Checkout-Session über die API mit dem `theme_config`-Parameter erstellst. Siehe [Checkout Theme Customization](/features/checkout#checkout-theme-customization) für Konfiguration auf API-Ebene oder verwende die [Design page](/features/design) im Dashboard, um Themen visuell mit Live-Vorschau zu konfigurieren.
</Info>
