...
<Frame caption="Open Wallet domains from the Apple Pay row">
  <img src="/images/apple-pay-domains/manage-domains.png" alt="Schaltfläche 'Domänen verwalten' in den Apple Pay-Zahlungsmethodeinstellungen" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<Frame caption="Download the Apple Pay domain association file">
  <img src="/images/apple-pay-domains/wallet-domains-panel.png" alt="Wallet-Domänen-Panel mit der Schaltfläche 'Datei herunterladen'" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<Frame caption="Register the domain where you embed inline checkout">
  <img src="/images/apple-pay-domains/register-domain.png" alt="Domänenregistrierungsformular mit eingetragener Domäne" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<Frame caption="Verify the hosted association file">
  <img src="/images/apple-pay-domains/verify-domain.png" alt="Domainverifizierung-Bildschirm mit Pfad zur Zuordnungsdatei und Schaltfläche 'Domäne verifizieren'" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<Frame caption="Verified domains show an Active status">
  <img src="/images/apple-pay-domains/domains-active.png" alt="Wallet-Domänenliste, die Domänen mit aktivem Apple Pay-Status und aktivierten Schaltern zeigt" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
|---------|-----------------|------------------|
| Integrationsgrad | Vollständig in Seite eingebettet | Modal über Seite |
| Layout-Kontrolle | Volle Kontrolle | Begrenzte Kontrolle |
| Branding | Nahtlos | Separat von der Seite |
