...
Für detaillierte Informationen zum Einrichten von Apple Pay, Google Pay und anderen digitalen Geldbörsen, siehe die <a href="/features/payment-methods/digital-wallets">Seite zu Digitalen Geldbörsen</a>.

### Schnelle Einrichtung für Apple Pay

<Steps>
<Step title="Laden Sie die Datei zur Domain-Verknüpfung herunter">
Laden Sie die [Apple Pay-Domain-Verknüpfungsdatei](http://checkout.dodopayments.com/.well-known/apple-developer-merchantid-domain-association) herunter.
</Step>

<Step title="Aktivierung anfordern">
E-Mail an **support@dodopayments.com** mit Ihrer Produktions-Domain-URL und der Bitte um Aktivierung von Apple Pay.
</Step>

<Step title="Nach Bestätigung testen">
Sobald bestätigt, überprüfen Sie, ob Apple Pay im Checkout erscheint, und testen Sie den vollständigen Ablauf.
</Step>
</Steps>

<Warning>
Apple Pay erfordert eine Domain-Verifizierung, bevor es in der Produktion erscheint. Kontaktieren Sie den Support, bevor Sie live gehen, wenn Sie planen, Apple Pay anzubieten.
</Warning>
...
|---------|-----------------|------------------|
| Integrationstiefe | Vollständig in der Seite eingebettet | Modal über der Seite |
| Layout-Kontrolle | Volle Kontrolle | Eingeschränkt |
| Branding | Nahtlos | Getrennt von der Seite |
| Implementierungsaufwand | Höher | Niedriger |
| Am besten geeignet für | Anpassbare Checkout-Seiten, hochkonvertierende Abläufe | Schnelle Integration, bestehende Seiten |
...
<Card title="Overlay-Checkout" icon="layer-group" href="/developer-resources/overlay-checkout">
    Verwenden Sie den Overlay-Checkout für eine schnelle modale Integration.
</Card>

<Card title="Checkout Sessions API" icon="code" href="/api-reference/checkout-sessions/create">
    Erstellen Sie Checkout-Sessions, um Ihre Checkout-Erlebnisse anzutreiben.
</Card>
