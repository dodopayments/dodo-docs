...
Legt den berechneten Betrag in größeren Währungseinheiten fest (z. B. <code>12.5</code> für 12,50 $). Nur für Pay What You Want-Produkte und wird ignoriert, wenn der Betrag unter dem Mindestpreis des Produkts liegt.
</ParamField>
