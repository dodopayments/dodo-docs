...
<Card title="Checkout-Handler" icon="cart-shopping" href="#checkout-route-handler">
    Integrieren Sie den Dodo Payments Checkout in Ihre Fastify-App.
</Card>
...
<Tab title="Webhook-Handler">
  <Info>
  Verwenden Sie diesen Handler, um Dodo Payments Webhook-Ereignisse sicher in Ihrer Fastify-App zu empfangen und zu verarbeiten.
  </Info>
  <CodeGroup>
