...
description: Learn how to integrate Dodo Payments with your Fastify App Router
...
Legt den berechneten Betrag in ganzen Währungseinheiten fest (z. B. <code>12.5</code> für 12,50 $). Nur für Pay What You Want-Produkte und wird ignoriert, wenn der Betrag unter dem Mindestpreis des Produkts liegt.
</ParamField>
...
Stellen Sie sicher, dass diese Umgebungsvariablen in Ihrem Projekt definiert sind:
...
Sicherheitshinweis: Geheimnisse nicht in die Versionskontrolle einchecken. Verwenden Sie lokal .env-Dateien und Geheimnis-Manager in Bereitstellungsumgebungen (z.B. AWS, Vercel, Heroku, etc.).