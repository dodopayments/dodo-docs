...
<Note>
  ...
  server plugin. You do not need to include <code>return_url</code> in the
  client payload.
</Note>
...
<Tip>
  If you omit <code>meter_id</code> when listing usage meters, all meters 
...
<AccordionGroup>
  <Accordion title="Plugin Options">
    ...
    - <b>createCustomerOnSignUp</b> (optional): Automatische Erstellung von Kunden bei Benutzeranmeldung
    - <b>use</b> (erforderlich): Array von Plugins, die aktiviert werden sollen (checkout, portal, usage, webhooks)
    - <b>getCustomerParams</b> (optional): Funktion, die den BetterAuth `User` empfängt und zusätzliche Felder zurückgibt, die dem DodoPayments-Kunden bei Erstellung und Aktualisierung angehängt werden sollen (z.B. `metadata`, `phone_number`)
...
<AccordionGroup>
  <Accordion title="Common Issues">
    ...
    <b>Webhook-Signatur stimmt nicht überein</b>: Stellen Sie sicher, dass das Webhook-Geheimnis mit dem im Dodo Payments Dashboard übereinstimmt. – <b>Kunde nicht erstellt</b>: Bestätigen Sie, dass{" "}
  ...
  <Accordion title="Best Practices">
    ...
    <code>test_mode</code>, bevor Sie auf <code>live_mode</code> umschalten. – Loggen Sie
    Webhook-Ereignisse für Debugging und Audits.
  </Accordion>
</AccordionGroup>
