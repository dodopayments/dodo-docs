...
description: Erfahren Sie, wie Sie Dodo Payments mit Ihrem Next.js App
...
Feld für Postleitzahl deaktivieren.
</ParamField>
...
Checkout-Sitzungen bieten eine sicherere, gehostete Checkout-Erfahrung, die den kompletten Zahlungsablauf sowohl für Einmalkäufe als auch für Abonnements mit vollständiger Anpassungskontrolle abwickelt.
...
Der Kundenportal-Routen-Handler ermöglicht es Ihnen, das Dodo Payments Kundenportal nahtlos in Ihre Next.js-Anwendung zu integrieren.
...
Wenn auf <code>true</code> gesetzt, sendet es dem Kunden eine E-Mail mit dem Portal-Link.
</ParamField>
