...
Der Customer Portal Route Handler ermöglicht die nahtlose Integration des Dodo Payments Kundenportals in Ihre Next.js-Anwendung.
...
- **Signaturprüfung:** Überprüft die Webhook-Signatur mithilfe von <code>webhookKey</code>. Gibt 401 zurück, wenn die Prüfung fehlschlägt.
...
- **Fehlerbehandlung:**
  ...
  - 500: Interner Fehler während der Prüfung
- **Ereignisweiterleitung:** Ruft basierend auf dem Payload-Typ den entsprechenden Ereignishandler auf.
