...
<Expandable title="Data object properties">
  ...
  Art der Ressource. Eine von: `Payment`, `Subscription`, `Refund`, `Dispute`, `LicenseKey`, `CreditLedgerEntry`, `CreditBalanceLow`, `AbandonedCheckout`, `DunningAttempt`, oder `EntitlementGrant`.
  </ResponseField>
...
Dieses interaktive Tool ermöglicht es Ihnen, aus allen unterstützten Ereignistypen auszuwählen und realistische Mock-Payloads an Ihren Endpunkt zu senden. Es wird wiederholt, sodass Sie mehrere Ereignisse in einer Sitzung testen können.
...
<Frame>
    <img src="/images/webhooks/logs.png" alt="Protokolle" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
    <img src="/images/webhooks/activity.png" alt="Aktivität" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/images/webhooks/alerting.png" alt="Webhook-Benachrichtigungseinstellungen mit E-Mail-Benachrichtigungskonfiguration" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
