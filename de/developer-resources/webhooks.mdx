...
Bleiben Sie über die Gesundheit Ihres Webhooks informiert mit automatischen E-Mail-Benachrichtigungen. Wenn die Zustellungen von Webhooks fehlschlagen oder Ihr Endpunkt nicht mehr reagiert, erhalten Sie E-Mail-Benachrichtigungen, damit Sie Probleme schnell beheben und Ihre Integrationen reibungslos laufen lassen können.

<Frame>
  <img src="/images/webhooks/alerting.png" alt="Webhook-Benachrichtigungseinstellungen, die die Konfiguration von E-Mail-Benachrichtigungen zeigen" />
</Frame>
...
<Step title="E-Mail-Benachrichtigungen aktivieren">
  Aktivieren Sie **E-Mail-Benachrichtigungen**, um Benachrichtigungen über Probleme bei der Webhook-Zustellung zu erhalten.
</Step>

<Step title="E-Mail-Adresse konfigurieren">
  Geben Sie die E-Mail-Adresse ein, an die Sie Webhook-Benachrichtigungen erhalten möchten. Wir senden Benachrichtigungen an diese Adresse, wenn bestimmte Ereignisse mit Ihrer Webhook-Konfiguration auftreten, wie z. B. Zustellprobleme, die Ihre Integrationen beeinträchtigen könnten.
</Step>
</Steps>
...
<Info>
Jede Plattformanleitung enthält Umgebungssetup, Signaturverifizierung und spezifische Bereitstellungsschritte für diesen Anbieter.
</Info>
