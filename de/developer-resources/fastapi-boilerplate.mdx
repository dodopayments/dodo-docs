...
<Warning>
Kommitten Sie niemals Ihre `.env` Datei in die Versionskontrolle. Sie ist bereits in `.gitignore` enthalten.
</Warning>
</Step>
...
| `/customer-portal` | POST | Generieren Sie die URL für das Kundenportal |
...
- Überprüfen Sie, ob Sie den Rohdatenkörper der Anfrage zur Signaturüberprüfung verwenden
