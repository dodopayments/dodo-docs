...
<Info>
Durch Downgrades mit <code>difference_immediately</code> erzeugte Gutschriften sind abonnementsbezogen und unterscheiden sich von den <a href="/features/credit-based-billing">Credit-Based Billing</a>-Berechtigungen. Sie werden automatisch auf künftige Verlängerungen desselben Abonnements angewendet und sind nicht zwischen Abonnements übertragbar.
</Info>
...
- Implementieren Sie Warnmeldungen für `subscription.on_hold`
