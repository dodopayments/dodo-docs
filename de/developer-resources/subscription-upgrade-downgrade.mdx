...
- `subscription.on_hold`: Belastung für Planänderung fehlgeschlagen, Verlängerungen gestoppt
- `payment.succeeded`: Sofortige Belastung für Planänderung erfolgreich
- `payment.failed`: Sofortige Belastung fehlgeschlagen
...
- `subscription.on_hold`: Belastung fehlgeschlagen, Verlängerungen gestoppt
