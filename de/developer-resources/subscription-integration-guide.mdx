...
Für nachfolgende Abbuchungen verwenden Sie den [POST /subscriptions/{subscription_id}/charge](/api-reference/subscriptions/create-charge) Endpunkt und geben Sie den Betrag an, der dem Kunden für diese Transaktion berechnet werden soll.
