...
| `timestamp` | string | Ja | Der Zeitstempel, zu dem das Ereignis aufgetreten ist (nicht unbedingt derselbe Zeitpunkt, zu dem es zugestellt wurde) |
| `type` | string | Ja | Der Ereignistyp. Siehe [Subscription-Ereignistypen](#subscription-event-types) |
| `data` | object | Ja | Die Hauptdaten-Nutzlast. Siehe [Subscription-Webhook-Nutzlasten](/developer-resources/webhooks/intents/subscription) |
