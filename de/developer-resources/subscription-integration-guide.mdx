...
Verwenden Sie für nachfolgende Abbuchungen den Endpunkt [POST /subscriptions/{subscription_id}/charge](/api-reference/subscriptions/create-charge) und geben Sie den Betrag an, den Sie dem Kunden für diese Transaktion berechnen möchten.

<Note>
Eine vollständige Schritt-für-Schritt-Anleitung (einschließlich Request-/Response-Beispielen, sicheren Richtlinien für erneute Versuche und der Verarbeitung von Webhooks) finden Sie im <a href="/developer-resources/ondemand-subscriptions">Leitfaden zu On-Demand-Abonnements</a>.
</Note>
