...
Detaillierte Anleitung zur Implementierung einmaliger Zahlungen
</Card>

<Card title="API Reference" icon="brackets-curly" href="/api-reference/introduction">
Die vollständige Dokumentation der Dodo Payments API erkunden
</Card>
</CardGroup>

## Support

Brauchst du Hilfe mit dem Boilerplate?

- Tritt unserer [Discord-Community](https://discord.gg/bYqAp4ayYh) bei, um Fragen zu stellen und dich auszutauschen
- Sieh dir das [GitHub-Repository](https://github.com/dodopayments/expo-boilerplate) an, um Probleme und Updates zu finden
