...
<Warning>
Kommitten Sie Ihre `.env`-Datei niemals in die Versionskontrolle. Sie ist bereits in `.gitignore` enthalten.
</Warning>
</Step>
...
<Step title="Auf echten Geräten testen">
