...
1. Lädt die Komponenten-Konfiguration aus dem Registrierungsverzeichnis herunter
2. Installiert die Komponentendateien in Ihrem `components/billingsdk/` Verzeichnis
3. Aktualisiert die Projektkonfiguration bei Bedarf
