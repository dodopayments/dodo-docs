...
1. Lädt die Komponenten-Konfiguration aus dem Registry herunter
2. Installiert die Komponenten-Dateien in deinem `components/billingsdk/` Verzeichnis
3. Aktualisiert die Projektkonfiguration, falls erforderlich
4. Installiert alle zusätzlichen Abhängigkeiten

## Struktur der generierten Dateien

Nach dem Ausführen von `init` erhältst du eine vollständige Projektstruktur mit:
