...
<Info>
`productPrice` wird in der niedrigsten Währungsdenomination ausgedrückt (z.B. Cent für USD, Paise für INR). Um 25,00 $ zu berechnen, geben Sie `2500` an.
</Info>

<Tip>
Das Aufladen über `subscriptions().charge(...)` ist für [On-Demand-Abonnements](/developer-resources/ondemand-subscriptions) gedacht. Standardmäßig geplante Abonnements werden automatisch gemäß dem Preisplan des Produkts abgerechnet.
</Tip>
...
Erstellen und verwalten Sie Zähler zur Nachverfolgung des Verbrauchs:
...
<Tip>
Das SDK wiederholt automatisch Anfragen bei Verbindungsfehlern, 408, 409, 429 und 5xx-Fehlern mit einem exponentiellen Zurücksetzen.
</Tip>
...
Wir begrüßen Beiträge! Lesen Sie die [Richtlinien für Beiträge](https://github.com/dodopayments/dodopayments-java/blob/main/CONTRIBUTING.md), um loszulegen.
