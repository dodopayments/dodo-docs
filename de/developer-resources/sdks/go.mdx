...
<Info>
Das SDK erfordert Go 1.22 oder spätere Versionen und nutzt moderne Go-Funktionen für optimale Leistung.
</Info>
...
<Warning>
Bewahren Sie Ihre API-Schlüssel immer sicher auf, indem Sie Umgebungsvariablen verwenden. Hardcodieren Sie sie niemals in Ihrem Quellcode.
</Warning>
