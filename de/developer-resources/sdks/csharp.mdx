...
<Info>
Das SDK erfordert .NET Standard 2.0 oder höher. Es funktioniert mit ASP.NET Core, Konsolenanwendungen und anderen .NET-Projekttypen.
</Info>
...
| ------------- | --------------------------- | -------- | --------------------------------- |
| `BearerToken` | `DODO_PAYMENTS_API_KEY`     | wahr     | -                                 |
| `WebhookKey`  | `DODO_PAYMENTS_WEBHOOK_KEY` | falsch    | -                                 |
| `BaseUrl`     | `DODO_PAYMENTS_BASE_URL`    | wahr     | `"https://live.dodopayments.com"` |
...
Um über alle Ergebnisse auf allen Seiten zu iterieren, verwenden Sie die `Paginate` Methode:
