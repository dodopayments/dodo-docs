...
<Tip>
Verwenden Sie immer die neueste SDK-Version, um auf die neuesten Funktionen von Dodo Payments zuzugreifen. Überprüfen Sie [Maven Central](https://central.sonatype.com/artifact/com.dodopayments.api/dodo-payments-kotlin) auf die neueste Version.
</Tip>
...
<Card title="Null-Sicherheit" icon="shield-check">
...
Behandeln Sie Fehler mit der Ausnahmebehandlung von Kotlin:
...
<Tip>
Verwenden Sie Kotlins `runCatching` für einen funktionaleren Ansatz zur Fehlerbehandlung mit Resultattypen.
</Tip>
...
Wir begrüßen Beiträge! Überprüfen Sie die [Mitwirkungsrichtlinien](https://github.com/dodopayments/dodopayments-kotlin/blob/main/CONTRIBUTING.md), um loszulegen.
