...
**Beispiel:** Zähle API-Aufrufe, bei denen `user_tier = "premium"` UND `endpoint = "/api/v2/users"`
</Tab>
...
**Beispiel:** Zähle Ereignisse, bei denen `method = "POST"` ODER `method = "PUT"` ODER `method = "DELETE"`
</Tab>
</Tabs>
...
**Beispiel**: Die Einstellung von `$0.50` pro Einheit bedeutet:
...
Filterkonfiguration (unter Verwendung der AND-Logik):
- Eigenschaft: `plan_type`, Comparator: `equals`, Wert: `premium`
- Eigenschaft: `hour`, Comparator: `greater_than_or_equal`, Wert: `9`
- Eigenschaft: `hour`, Comparator: `less_than`, Wert: `17`
