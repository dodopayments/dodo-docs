...
<Frame>
<img src="/images/guides/usage-based-billing/meter-quantities-chart.png" alt="Zählermengen-Diagramm, das Nutzungstrends im Laufe der Zeit mit einer lila Farbverlauf-Visualisierung zeigt" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/guides/usage-based-billing/events-table.png" alt="Ereignistabelle mit Ereignisnamen, IDs und Seitennavigation für eine detaillierte Ereignisanalyse" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
- Eigenschaft: `hour`, Vergleichsoperator: `greater_than_or_equals`, Wert: `9`
