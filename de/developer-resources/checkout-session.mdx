...
Aktivieren Sie den minimalen Adresssammlungsmodus. Wenn aktiviert, sammelt der Checkout nur:
...
Dies reduziert die Checkout-Reibung erheblich, indem unnötige Formularfelder entfernt werden.
...
Die Checkout-Oberfläche in einer bestimmten Sprache rendern.
...
Feld für Rabattcodes im Checkout anzeigen.
</ParamField>
...
Erzwingen Sie die Erstellung eines neuen Kundenkontos anstelle der Aktualisierung vorhandener.
</ParamField>
...
**Format**: Dargestellt in der kleinsten Einheit der Währung (z. B. Cent für USD). Um $1,00 zu berechnen, übergeben Sie `100`.
</ParamField>
...
Optionale Überschreibung der Produktbeschreibung für Rechnungs- und Positionen. Wenn nicht angegeben, wird die gespeicherte Beschreibung des Produkts verwendet.
</ParamField>
...
### 8. Checkout im dunklen Thema mit Rabattcode
