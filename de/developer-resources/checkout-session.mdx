...
<Info>
Antworten auf benutzerdefinierte Felder sind automatisch in Webhook-Payloads enthalten (`payment.succeeded`, `subscription.active` usw.) und können über die API abgerufen werden. Verwenden Sie sie, um Ihr CRM anzureichern, Onboarding-Flows auszulösen oder das Kundenerlebnis anzupassen.
</Info>
