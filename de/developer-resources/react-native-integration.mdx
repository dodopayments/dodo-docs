...
- Aktivieren Sie das Debug-Logging in der Entwicklungsphase
- Überprüfen Sie die Netzwerk-Anfragen an Ihr Backend
- Stellen Sie sicher, dass die API-Schlüssel korrekt konfiguriert sind
- Testen Sie auf iOS- und Android-Plattformen
- Überprüfen Sie unsere [Technischen FAQs](/miscellaneous/faq) für häufige Probleme
- Verwenden Sie den [Test- vs. Livemodus](/miscellaneous/test-mode-vs-live-mode) angemessen
</Accordion>
</AccordionGroup>
