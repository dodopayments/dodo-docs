...
Jede Farb Kategorie bestimmt die Farbe eines oder mehrerer Komponenten in der Benutzeroberfläche. Zum Beispiel definiert `primary` die Farbe des Pay-Buttons.
...
| `secondaryText` | Textfarbe für Beschriftungen von Eingabefeldern |
