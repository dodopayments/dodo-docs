...
<Step title="Erstelle einen Zähler">
...
- **Aggregationstyp**: `sum` zur Verfolgung der insgesamt gestreamten Bytes
- **Über Eigenschaft**: `bytes` zur Abrechnung basierend auf der Bandbreitennutzung
</Step>
