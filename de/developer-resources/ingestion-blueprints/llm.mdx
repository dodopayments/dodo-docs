...
1. **Anmelden** beim [Dodo Payments Dashboard](https://app.dodopayments.com/)
...
Für detaillierte Anweisungen siehe den [Usage-Based Billing Guide](/developer-resources/usage-based-billing-guide).
</Step>
...
Ihr Dodo Payments API-Schlüssel. Erhalten Sie ihn auf der [API Keys-Seite](https://app.dodopayments.com/developer/api-keys).
...
Eindeutige Kennung für dieses spezifische Ereignis. Wird vom SDK automatisch generiert.
