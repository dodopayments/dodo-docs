...
<Step title="Erstellen Sie einen Meter">
...
- **Aggregationsart**: `count` zur Verfolgung der Anzahl der Anrufe
...
<Tip>
**Verwenden Sie Batching für hohes Volumen**: Für Anwendungen, die mehr als 10 Anfragen pro Sekunde verarbeiten, verwenden Sie `createBatch()` zur Reduzierung des Overheads und zur Verbesserung der Leistung.
</Tip>

<Warning>
**Batches immer aufräumen**: Rufen Sie `batch.cleanup()` beim Herunterfahren der Anwendung auf, um ausstehende Ereignisse zu flushen und Datenverlust zu verhindern.
</Warning>
