...
<Step title="Erstelle ein Messgerät">
Erstelle ein Messgerät in deinem [Dodo Payments Dashboard](https://app.dodopayments.com/):
- **Ereignisname**: `time_range_usage` (oder dein bevorzugter Name)
...
<Warning>
**Genaues Timing**: Verwende `Date.now()` oder INLINE_CODE_PLACEHOLDER_a9f90f9b26640d33_End für genaues Zeit-Tracking, insbesondere für serverlose Funktionen.
</Warning>
