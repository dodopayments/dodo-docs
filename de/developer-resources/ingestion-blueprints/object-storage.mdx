...
- **Dodo Payments API-Schlüssel**: Holen Sie ihn aus dem [Dodo Payments Dashboard](https://app.dodopayments.com/developer/api-keys)
...
- **Aggregationsart**: `sum`, um die insgesamt hochgeladenen Bytes zu verfolgen
- **Über Property**: `bytes`, um basierend auf der Speicherkapazität abzurechnen
</Step>
