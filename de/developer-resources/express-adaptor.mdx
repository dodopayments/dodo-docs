...
Legt den berechneten Betrag in den Haupteinheiten der Währung fest (z. B. <code>12.5</code> für 12,50 $). Nur für Pay What You Want-Produkte verfügbar und wird ignoriert, wenn der Betrag unter dem Mindestpreis des Produkts liegt.
</ParamField>
