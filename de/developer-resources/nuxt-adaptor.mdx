...
Checkout-Sessions bieten ein sichereres, gehostetes Checkout-Erlebnis, das den vollständigen Zahlungsablauf sowohl für einmalige Käufe als auch für Abonnements mit umfassenden Anpassungsmöglichkeiten abwickelt.
...
Der Customer Portal-Route-Handler ermöglicht die nahtlose Integration des Dodo Payments Customer Portal in Ihre Nuxt-Anwendung.
...
- **Ereignis-Routing:** Ruft den entsprechenden Ereignishandler basierend auf dem Payload-Typ auf.
