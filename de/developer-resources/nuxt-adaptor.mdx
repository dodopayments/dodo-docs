...
Produktidentifier (z. B. <code>?productId=pdt_nZuwz45WAs64n3l07zpQR</code>).
</ParamField>
...
Jeder Query-Parameter, der mit <code>metadata_</code> beginnt, wird als Metadata übergeben.
</ParamField>
