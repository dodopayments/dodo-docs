...
| **Ereignisname**           | **Ereignistyp**           | **Beschreibung**                                                                 |
|--------------------------|--------------------------|---------------------------------------------------------------------------------|
| **Subscription aktiv**  | `subscription.active`    | Gibt an, dass ein Subscription nun aktiv ist und wiederkehrende Gebühren geplant sind.|
...
| **Subscription gekündigt** | `subscription.cancelled` | Wird ausgelöst, wenn eine Subscription vom Händler oder Kunden gekündigt wird.         |
