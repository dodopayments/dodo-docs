...
<Warning>
Übergeben Sie niemals Ihren API-Schlüssel an die Versionskontrolle. Fügen Sie `.env` zu Ihrer `.gitignore` Datei hinzu.
</Warning>
</Step>
...
2. Sie sollten die Preisdemo-Oberfläche basierend auf Sitzplätzen sehen
3. Versuchen Sie verschiedene Sitzplatzmengen (0, 3, 10 usw.)
