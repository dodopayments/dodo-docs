...
description: Erfahren Sie, wie Sie Dodo Payments in Ihr Tanstack App
  Router-Projekt integrieren können, indem Sie unseren Tanstack Adaptor
  verwenden. Behandelt Checkout, Kundenportal, Webhooks und die Einrichtung
...
{/* LOCKED_PATTERN_848a353666469e7a047ef05af5a45770 */}
    Integriere Dodo Payments Checkout in deine Tanstack-App.
</Card>
{/* LOCKED_PATTERN_df89dec21e12f4bf30b6acf75ba025e1 */}
    Erlaube Kunden, Abonnements und Details zu verwalten.
</Card>
...
Führe folgenden Befehl im Projektstamm aus:
...
Erstelle eine <code>.env</code>-Datei im Projektstamm:
...
<Info>
Alle Beispiele gehen davon aus, dass du den Tanstack App Router verwendest.
</Info>

<Tabs>
{/* LOCKED_PATTERN_28fd81a4703a84d931eeff69f1520d54 */}
  <Info>
  Nutze diesen Handler, um Dodo Payments Checkout in deine Tanstack-App zu integrieren. Unterstützt statische (GET), dynamische (POST) und Session (POST) Zahlungsabläufe.
  </Info>
  <CodeGroup>
...
{/* LOCKED_PATTERN_085b207030169d6eead800f9835ef4fb */}
  <Info>
  Nutze diesen Handler, um Kunden über das Dodo Payments Kundenportal Abonnements und Details verwalten zu lassen.
  </Info>
  <CodeGroup>
...
{/* LOCKED_PATTERN_0026b036379d81a9d03c36b3b6e83ddd */}
  <Info>
  Nutze diesen Handler, um Dodo Payments Webhook-Ereignisse sicher in deiner Tanstack-App zu empfangen und zu verarbeiten.
  </Info>
  <CodeGroup>
...
<Info>
Dodo Payments unterstützt drei Arten von Zahlungsabläufen zur Integration in deine Website, dieser Adapter unterstützt alle Zahlungsabläufe.
</Info>
...
- Unterstützt Einmal- und wiederkehrende Zahlungen.
...
Checkout-Sitzungen bieten ein sichereres, gehostetes Checkout-Erlebnis, das den vollständigen Zahlungsablauf für Einmalkäufe und Abonnements mit voller Anpassungskontrolle übernimmt.
...
Der Kundenportal-Routen-Handler ermöglicht es Ihnen, das Dodo Payments Kundenportal nahtlos in Ihre Tanstack-Anwendung zu integrieren.
...
<ParamField query="send_email" type="boolean">
Wenn auf <code>true</code> gesetzt, sendet es eine E-Mail mit dem Portallink an den Kunden.
</ParamField>
