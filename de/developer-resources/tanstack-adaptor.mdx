...
Checkout Sessions bieten ein sichereres, gehostetes Checkout-Erlebnis, das den vollständigen Payment-Flow sowohl für einmalige Käufe als auch für Abonnements abwickelt und dabei umfassende Anpassungsmöglichkeiten bietet.
...
Der Customer Portal Route Handler ermöglicht die nahtlose Integration des Dodo Payments Customer Portal in Ihre Tanstack-Anwendung.
...
Bei der Einstellung <code>true</code> wird dem Kunden eine E-Mail mit dem Portal-Link gesendet.
</ParamField>
...
- **Payload-Validierung:** Wird mit Zod validiert. Bei ungültigen Payloads wird 400 zurückgegeben.
- **Fehlerbehandlung:**
  - 401: Ungültige Signatur
  - 400: Ungültiger Payload
  - 500: Interner Fehler während der Überprüfung
- **Event-Routing:** Ruft den entsprechenden Event-Handler basierend auf dem Payload-Typ auf.
