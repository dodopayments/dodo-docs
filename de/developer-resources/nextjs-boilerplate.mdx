...
<Info>
Dieses Boilerplate nutzt Next.js 16 App Router mit TypeScript, Tailwind CSS 4 und dem `@dodopayments/nextjs` Adapter.
</Info>
...
- **Moderne UI** - Saubere, dunkel gestaltete Preisseite mit Tailwind CSS
- **Webhook-Handler** - Fertiger Webhook-Endpunkt für Zahlungsevents
- **Kundenportal** - Ein-Klick-Abonnementverwaltung
- **TypeScript** - Vollständig typisiert mit minimalen, fokussierten Typen
- **Vorausgefüllter Checkout** - Demonstriert das Übergeben von Kundendaten zur Verbesserung der Benutzererfahrung
...
<Warning>
Versuchen Sie niemals, Ihre `.env` Datei in die Versionskontrolle zu committen. Sie ist bereits in `.gitignore` enthalten.
</Warning>
</Step>
...
Löschen Sie `node_modules` und installieren Sie die Abhängigkeiten erneut:
...
- Überprüfen Sie die Browserkonsole und das Terminal auf Fehler
</Accordion>
