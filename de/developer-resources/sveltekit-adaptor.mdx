...
<Card title="Checkout-Handler" icon="cart-shopping" href="#checkout-route-handler">
    Integrieren Sie den Dodo Payments Checkout in Ihre SvelteKit-App.
</Card>
...
<Info>
Alle Beispiele setzen voraus, dass Sie den SvelteKit App Router verwenden.
</Info>

<Tabs>
<Tab title="Checkout-Handler">
  <Info>
  Verwenden Sie diesen Handler, um den Dodo Payments Checkout in Ihre SvelteKit-App zu integrieren. Unterstützt statische (GET), dynamische (POST) und Sitzungs- (POST) Zahlungsflüsse.
  </Info>
  <CodeGroup>
