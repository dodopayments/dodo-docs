...
description: Erfahren Sie, wie Sie Dodo Payments mit Ihrem SvelteKit App
  ...
  Behandelt Checkout, Kundenportal, Webhooks und die sichere Einrichtung der
  Umgebung.
icon: code-merge
---
...
Der Kundenportal-Routen-Handler ermöglicht es Ihnen, das Dodo Payments Kundenportal nahtlos in Ihre SvelteKit-Anwendung zu integrieren.
