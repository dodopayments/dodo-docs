...
Geben Sie die Währung an (z. B. <code>USD</code>).
</ParamField>
...
Checkout-Sitzungen bieten ein sichereres, gehostetes Checkout-Erlebnis, das den vollständigen Zahlungsablauf für Einmalkäufe und Abonnements mit vollständiger Anpassungskontrolle abdeckt.
...
Der Kundenportal-Route-Handler ermöglicht es Ihnen, das Dodo Payments Kundenportal nahtlos in Ihre SvelteKit-Anwendung zu integrieren.
