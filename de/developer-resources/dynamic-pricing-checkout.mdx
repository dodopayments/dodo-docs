...
**Beispiel**: Wenn dein Mindestpreis 5,00 $ beträgt, gib `5.00` (oder `500` Cent) ein.
</Step>
...
Biete unterschiedlichen Kundensegmenten unterschiedliche Preise für dasselbe Produkt an:
...
<CardGroup cols={2}>
<Card title="Setze angemessene Grenzen" icon="sliders">
...
<Card title="Preise Entscheidungen nachverfolgen" icon="chart-line">
...
<Card title="Umgang mit Randfällen" icon="exclamation-triangle">
Stelle sicher, dass deine Anwendung Fälle behandelt, in denen Beträge die Höchstgrenzen überschreiten oder unter die Mindestgrenzen fallen, elegant.
</Card>
</CardGroup>
...
<Card title="Leitfaden zu Checkout-Sitzungen" icon="cart-shopping" href="/developer-resources/checkout-session">
