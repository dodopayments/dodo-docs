...
<Tab title="Bibliotheken & SDKs">
  <CardGroup cols={1}>
    <Card title="dodopayments-webhooks (TypeScript)" href="https://github.com/sancho1952007/dodopayments-webhooks" icon="node-js">
      ...
      <br/>Beinhaltet Signaturüberprüfung und typisierte Ereignisbehandlung für Express, Hono, Elysia und mehr.
    ...
    <Card title="dodo-payments-rs (Rust)" href="https://github.com/PiyushXCoder/dodo-payments-rs" icon="rust">
      ...
      <br/>Es kommt mit vordefinierten Strukturen für Anfragen und Antworten und verwendet ein Builder-Muster, um das Erstellen und Senden von zahlungsbezogenen API-Aufrufen zu vereinfachen.
...
<Tab title="Boilerplates & Starter">
  <CardGroup cols={1}>
    ...
    <Card title="Dodo Payments Boilerplate" href="https://github.com/vanshcodeworks/dodo_payments_boilerplate" icon="rocket">
      ...
      <br/>Minimale Einrichtung zum Erstellen und Bestätigen von Zahlungen mit Beispielseiten.
