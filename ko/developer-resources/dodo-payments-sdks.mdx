...
<Card title="React Native SDK" icon="mobile" href="/developer-resources/react-native-integration">
  iOS 및 Android 앱에서 안전한 결제 환경을 구축하기 위한 네이티브 모바일 SDK
</Card>
...
{/* LOCKED_PATTERN_776027320500bde6b99bac6bed1cc64d */}
  SDK를 설치하려면 사용 언어의 패키지 관리자를 사용하세요
...
{/* LOCKED_PATTERN_2e38842e99ea3bb8f9763781777f831c */}
  ...
  <Warning>
  API 키는 항상 환경 변수를 사용하여 안전하게 저장하고 절대 버전 관리에 커밋하지 마세요.
  </Warning>
</Step>
...
{/* LOCKED_PATTERN_6ddfb9c24c549e202af4c004c17b0c78 */}
  ...
  <Check>
  이제 결제 처리를 시작할 준비가 되었습니다! 자세한 안내와 예제를 보려면 각 SDK 페이지를 방문하세요.
  </Check>
</Step>
</Steps>
...
<Card title="React Native SDK" icon="mobile" href="/developer-resources/react-native-integration">
  네이티브 UI 컴포넌트와 간소화된 결제 데이터 수집으로 iOS 및 Android 앱에서 안전한 결제 환경을 구축하세요
</Card>
...
<Info>
React Native SDK에서는 현재 Apple Pay, Google Pay, Cash App, UPI를 지원하지 않습니다. 해당 결제 수단에 대한 지원은 향후 릴리스에 계획되어 있습니다.
</Info>
...
<Card title="CLI" icon="terminal" href="/developer-resources/sdks/cli">
  78개의 API 엔드포인트를 모두 지원하는 자동 생성 명령줄 인터페이스
</Card>
...
<Info>
Node.js SDK에서 새로운 TypeScript SDK로 마이그레이션했습니다. 기존 Node.js SDK를 사용하는 경우 통합을 업데이트하려면 [마이그레이션 가이드](https://github.com/dodopayments/dodopayments-typescript/blob/main/MIGRATION.md)를 참조하세요.
</Info>
...
<Card title="Supabase" icon="database" href="developer-resources/supabase-boilerplate">
  Postgres 및 Auth를 갖춘 오픈 소스 Firebase 대체재
</Card>
