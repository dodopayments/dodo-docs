...
- 대시보드에서 확인할 수 있는 API key (`DODO_PAYMENTS_API_KEY`) 및 webhook secret key. [API key 생성 가이드](/api-reference/introduction#api-key-management-and-authentication)를 참조하세요.
- webhook을 수신할 수 있는 backend endpoint
