...
이 섹션은 Checkout SDK를 사용한 **클라이언트 측** 테마 구성을 다룹니다. API의 `theme_config` 매개변수를 통해 체크아웃 세션을 생성할 때 **서버 측**에서도 테마를 구성할 수 있습니다. API 수준 구성을 보려면 [Checkout Theme Customization](/features/checkout#checkout-theme-customization)을 참조하세요.
