...
다음에 의존성을 추가하세요 `build.gradle.kts`:
...
<Tip>
항상 최신 SDK 버전을 사용하여 최신 Dodo Payments 기능에 접근하세요. 최신 버전은 [Maven Central](https://central.sonatype.com/artifact/com.dodopayments.api/dodo-payments-kotlin)에서 확인하세요.
</Tip>

<Info>
SDK는 Java 8 이상이 필요하며 JVM 및 Android 플랫폼과 호환됩니다.
</Info>
...
<CardGroup cols={2}>
<Card title="코루틴" icon="bolt">
  비동기 작업을 위한 Kotlin 코루틴에 대한 완전한 지원
</Card>

<Card title="널 안전성" icon="shield-check">
  강력한 오류 처리를 위한 Kotlin의 널 안전성 활용
</Card>

<Card title="확장 함수" icon="code">
  향상된 기능을 위한 관용적인 Kotlin 확장
</Card>

<Card title="데이터 클래스" icon="layer-group">
...
<Tip>
Kotlin의 `runCatching`를 사용하여 Result 타입으로 오류 처리를 보다 기능적으로 접근하세요.
</Tip>
...
<CardGroup cols={2}>
<Card title="GitHub 리포지토리" icon="github" href="https://github.com/dodopayments/dodopayments-kotlin">
  소스 코드를 보고 기여하세요
</Card>
...
<Card title="문제 보고" icon="bug" href="https://github.com/dodopayments/dodopayments-kotlin/issues">
  버그를 보고하거나 기능 요청하세요
</Card>
</CardGroup>
