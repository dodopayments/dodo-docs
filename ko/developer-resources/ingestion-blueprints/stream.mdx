...
<Step title="미터 생성하기">
당신의 [Dodo Payments Dashboard](https://app.dodopayments.com/)에서 미터를 생성하세요:
- **이벤트 이름**: `stream_consumption` (또는 원하는 이름)
- **집계 유형**: `sum` 전체 스트리밍된 바이트 수를 추적하기 위해
- **오버 속성**: `bytes` 대역폭 사용량에 따라 요금을 청구하기 위해
</Step>
