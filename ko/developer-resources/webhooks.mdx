...
<Frame>
  <img src="/images/cover-images/Webhooks.webp" alt="Webhook 커버 이미지" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Step title="Create Webhook Endpoint">
    ...
    <Frame>
        <img src="/images/webhooks/create-endpoint.png" alt="Webhook 추가" style={{ maxHeight: '500px', width: 'auto' }} />
    </Frame>
</Step>
...
<Expandable title="Data object properties">
  ...
  리소스의 유형. 다음 중 하나: `Payment`, `Subscription`, `Refund`, `Dispute`, `LicenseKey`, `CreditLedgerEntry`, `CreditBalanceLow`, `AbandonedCheckout`, `DunningAttempt` 또는 `EntitlementGrant`.
  </ResponseField>
  
  추가 필드는 이벤트 유형에 따라 다릅니다. 전체 스키마는 이벤트별 문서를 참조하십시오.
</Expandable>
</ResponseField>
...
You can test your webhook integration directly from the Dodo Payments dashboard to ensure your endpoint is working correctly before going live.
    ...
    <Frame>
    <img src="/images/webhooks/endpoints.png" alt="엔드포인트 세부 정보" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
이 인터랙티브 도구를 사용하면 지원되는 모든 이벤트 유형 중에서 선택하고 실제적인 모의 페이로드를 엔드포인트에 보낼 수 있습니다. 반복 작동하여 한 세션에서 여러 이벤트를 테스트할 수 있습니다.
...
The Logs tab provides comprehensive visibility into your webhook delivery status, allowing you to monitor, debug, and manage webhook events effectively.
    ...
    <Frame>
    <img src="/images/webhooks/logs.png" alt="로그" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
The Activity tab provides real-time insights into your webhook delivery performance with visual analytics.
    ...
    <Frame>
    <img src="/images/webhooks/activity.png" alt="활동" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
Stay informed about your webhook health with automatic email notifications. When webhook deliveries start failing or your endpoint stops responding, you'll receive email alerts so you can quickly address issues and keep your integrations running smoothly.
    ...
    <Frame>
  <img src="/images/webhooks/alerting.png" alt="이메일 알림 구성이 표시된 Webhook 경보 설정" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
