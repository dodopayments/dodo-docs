...
<Step title="Access Webhook Settings">
    DodoPayments 대시보드로 이동하여 `Developer > Webhooks` 위치로 이동합니다.
</Step>
...
<Step title="Navigate to Webhook Details">
    Dodo Payments 대시보드로 이동하여 `Developer > Webhooks` 위치로 이동합니다.
</Step>
...
{/* LOCKED_PATTERN_e00062f1a73be4cdce7478c87f820958 */}
  웹훅 엔드포인트를 프로그래밍 방식으로 생성하고 구성하는 API 참조
</Card>
{/* LOCKED_PATTERN_ebcc49f16b467c5d38d8a9f461e25ccd */}
  웹훅 엔드포인트를 검색하고 관리하는 API 참조
</Card>
</CardGroup>
