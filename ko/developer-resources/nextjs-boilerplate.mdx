...
description: Get started quickly with our minimal Next.js boilerplate for
  integrating Dodo Payments into your Next.js application
...
- [결제 세션 문서](https://docs.dodopayments.com/developer-resources/checkout-session)
