...
<Accordion title="400 Bad Request">
잘못된 요청 매개변수입니다. 모든 필수 필드가 제공되고 제대로 형식화되어 있는지 확인하세요.
</Accordion>

<Accordion title="401 Unauthorized">
잘못되었거나 누락된 API 키입니다. `DODO_PAYMENTS_API_KEY`가 정확하고 적절한 권한을 가지고 있는지 확인하세요.
</Accordion>
...
<Accordion title="422 Unprocessable Entity">
구독을 변경할 수 없습니다(예: 이미 취소되었거나, 제품이 제공되지 않음 등).
</Accordion>
...
- `subscription.on_hold`에 대해 알림 구현
- <a href="/developer-resources/webhooks">Webhook 통합 가이드</a> 확인
