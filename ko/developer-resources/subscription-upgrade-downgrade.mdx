...
<Info>
<code>difference_immediately</code>를 사용하여 다운그레이드로 생성된 크레딧은 구독 범위이며 <a href="/features/credit-based-billing">크레딧 기반 청구</a> 권한과 별개입니다. 이러한 크레딧은 동일한 구독의 향후 갱신에 자동으로 적용되며 구독 간에 양도할 수 없습니다.
</Info>
...
- <a href="/features/credit-based-billing">크레딧 기반 청구</a> 살펴보기
