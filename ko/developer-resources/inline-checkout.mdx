...
생산 도메인 URL을 사용하여 **support@dodopayments.com**에 이메일을 보내고 Apple Pay 활성화를 요청하세요.
</Step>
...
| Feature | 인라인 결제 | 오버레이 결제 |
|---------|-----------------|------------------|
| 통합 깊이 | 페이지에 완전히 임베드됨 | 페이지 상단에 모달 |
| 레이아웃 제어 | 전체 제어 | 제한됨 |
| 브랜드 | 매끄러운 | 페이지와 별도 |
| 구현 노력 | 높음 | 낮음 |
| 최적 용도 | 사용자 정의 결제 페이지, 높은 전환 흐름 | 빠른 통합, 기존 페이지 |
...
자세한 도움을 원하시면 [Discord 커뮤니티](https://discord.gg/bYqAp4ayYh)를 방문하시거나 개발자 지원 팀에 문의하세요.
