...
코드_플레이스홀더_ee9497887c66f2b2_끝

</Step>
<Step title="환경 변수 설정">
프로젝트 루트에 <code>.env</code> 파일을 생성하세요:

코드_플레이스홀더_c7f24ad84ce9de21_끝
