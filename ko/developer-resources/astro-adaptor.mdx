...
<Card title="체크아웃 핸들러" icon="cart-shopping" href="#checkout-route-handler">
    Dodo Payments 체크아웃을 Astro 앱에 통합하세요.
</Card>
...
<Tab title="체크아웃 핸들러">
  <Info>
  이 핸들러를 사용하여 Dodo Payments 체크아웃을 Astro 앱에 통합하세요. 정적 (GET), 동적 (POST), 세션 (POST) 결제 흐름을 지원합니다.
  </Info>
  <CodeGroup>
...
<Tab title="웹훅 핸들러">
  <Info>
  이 핸들러를 사용하여 Dodo Payments 웹훅 이벤트를 안전하게 수신하고 처리합니다.
  </Info>
  <CodeGroup>
