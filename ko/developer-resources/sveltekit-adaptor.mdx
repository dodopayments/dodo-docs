...
<Card title="체크아웃 핸들러" icon="cart-shopping" href="#checkout-route-handler">
    Dodo Payments 체크아웃을 SvelteKit 앱에 통합하세요.
</Card>
...
코드_자리표시자_2fad78d2ca945de4_끝

</Step>
<Step title="환경 변수 설정">
프로젝트 루트에 <code>.env</code> 파일을 생성하세요:

코드_자리표시자_c7f24ad84ce9de21_끝
...
<Info>
모든 예제는 SvelteKit App Router를 사용한다고 가정합니다.
</Info>

<Tabs>
<Tab title="체크아웃 핸들러">
  <Info>
  이 핸들러를 사용하여 Dodo Payments 체크아웃을 SvelteKit 앱에 통합하세요. 정적 (GET), 동적 (POST), 세션 (POST) 결제 흐름을 지원합니다.
  </Info>
  <CodeGroup>

코드_자리표시자_4163899dd8035fd2_끝

  </CodeGroup>
  <CodeGroup>

코드_자리표시자_9f4b12d14201bef5_끝

  </CodeGroup>
  <CodeGroup>

코드_자리표시자_8e00b163b3010893_끝

  </CodeGroup>
  <CodeGroup>

코드_자리표시자_4fbf4ec13900b837_끝
...
코드_자리표시자_28b58db3f3c24688_끝

  </CodeGroup>
</Tab>
<Tab title="웹훅 핸들러">
  <Info>
  이 핸들러를 사용하여 Dodo Payments 웹훅 이벤트를 SvelteKit 앱에서 안전하게 수신하고 처리하세요.
  </Info>
  <CodeGroup>

코드_자리표시자_bdf9201bf853b93c_끝
