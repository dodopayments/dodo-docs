...
결제 amount를 지정합니다(예: $10.00의 경우 <code>1000</code>).
</ParamField>
...
Checkout session은 일회성 구매와 subscription 모두에 대해 전체 payment flow를 처리하고 완전한 사용자 지정 제어 기능을 제공하는, 더욱 안전한 hosted checkout 환경을 제공합니다.
...
<code>true</code>로 설정하면 customer에게 portal link가 포함된 이메일을 전송합니다.
</ParamField>
