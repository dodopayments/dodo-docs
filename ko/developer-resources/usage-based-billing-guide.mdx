...
<Frame>
<img src="/images/guides/usage-based-billing/meter-quantities-chart.png" alt="시간에 따른 사용 추세를 보이는 미터 수량 차트, 보라색 그래디언트 시각화" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/guides/usage-based-billing/events-table.png" alt="이벤트 이름, ID 및 상세 이벤트 분석을 위한 페이지네이션 컨트롤을 보여주는 이벤트 테이블" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
- 속성: `hour`, 비교기: `greater_than_or_equals`, 값: `9`
