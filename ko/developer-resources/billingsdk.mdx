...
2. `components/billingsdk/` 디렉터리에 구성 요소 파일을 설치합니다.
3. 필요한 경우 프로젝트 구성을 업데이트합니다.
4. 추가 종속성을 설치합니다.

## 생성된 파일 구조

`init`를 실행한 후에는 다음과 같은 전체 프로젝트 구조를 얻을 수 있습니다:
...
<CardGroup cols={3}>
  <Card title="전체 문서" icon="book" href="https://billingsdk.com/docs">
    예제 및 모범 사례가 포함된 청구 SDK에 대한 완전한 가이드
  </Card>
  <Card title="CLI 참조" icon="terminal" href="https://billingsdk.com/docs/cli">
    모든 명령 및 옵션에 대한 자세한 CLI 문서
  </Card>
  <Card title="구성 요소 라이브러리" icon="boxes-stacked" href="https://billingsdk.com/docs/components">
    라이브 예제와 함께 사용 가능한 모든 구성 요소를 탐색하세요
  </Card>
</CardGroup>
