...
<Frame>
  <img src="/images/payouts/verification-process.png" alt="인증 프로세스" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
  <img src="/images/tax-forms/W8 - BEN - PLC - SAMPLE - 1.png" alt="W-8 BEN-E 사설 유한 회사 샘플 페이지 1" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>

**Page 2**

<Frame>
  <img src="/images/tax-forms/W8 - BEN - PLC - SAMPLE - 2.png" alt="W-8 BEN-E 사설 유한 회사 샘플 페이지 2" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>

**Page 8**

<Frame>
  <img src="/images/tax-forms/W8 - BEN - PLC - SAMPLE - 8.png" alt="W-8 BEN-E 사설 유한 회사 샘플 페이지 8" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Accordion>
...
<Frame>
  <img src="/images/tax-forms/W8 - BEN - LLP SAMPLE - 1.png" alt="W-8 BEN-E LLP 샘플 페이지 1" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>

**Page 2**

<Frame>
  <img src="/images/tax-forms/W8 - BEN - LLP SAMPLE - 2.png" alt="W-8 BEN-E LLP 샘플 페이지 2" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>

**Page 8**

<Frame>
  <img src="/images/tax-forms/W8 - BEN - PLC - SAMPLE - 8.png" alt="W-8 BEN-E LLP 샘플 페이지 8" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Accordion>
</AccordionGroup>
...
<Frame>
  <img src="/images/payouts/payout-activation2.png" alt="계정 활성화됨" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
온보딩 프로세스 중에 제출된 문서에 문제가 있는 경우, Dodo Payments 검증 팀에서 특정 문서의 재제출을 요청할 수 있습니다.

대시보드에서 **재제출** 옵션을 사용하여 문서를 다시 제출할 수 있습니다.

### 언제 문서를 재제출할 수 있나요?

- **누락되거나 불완전한 정보**: 식별 번호, 회사 이름 또는 기타 주요 데이터와 같은 필수 세부 정보가 누락된 경우.
- **문서 불일치**: 제출된 문서가 제공된 사업체 또는 개인 정보와 일치하지 않을 때.
- **읽을 수 없거나 만료된 문서**: 업로드된 문서가 불분명하거나 읽을 수 없거나 만료된 경우.
- **추가 설명 필요**: 검증 팀에서 귀하의 신원 또는 사업체 정보를 명확히 하기 위해 추가 문서를 요구하는 경우.

### 문서를 재제출하는 방법

<Steps>
<Step title="Check your dashboard">
재제출 요청이 있는지 Dodo Payments 대시보드를 확인하세요 (재제출이 필요할 경우 이메일 알림도 받게 됩니다).
</Step>

<Step title="Access the resubmit option">
검증 팀이 **재제출** 옵션을 활성화하여 새 문서를 업로드할 수 있도록 합니다.
</Step>

<Step title="Upload correct documents">
대시보드에서 **인증 섹션**으로 이동하여 올바른 문서를 업로드하세요.
</Step>
...
<CardGroup cols={2}>
  <Card
    ...
    href="/miscellaneous/merchant-acceptance"
  >
    지원되는 제품 및 금지된 제품을 포함한 포괄적인 수락 기준을 검토하고 귀하의 사업체가 온보딩에 적합한지 확인하세요.
  </Card>
  <Card
    title="Review Monitoring Policy"
    icon="magnifying-glass"
    href="/miscellaneous/review-monitoring-policy"
  >
    지속적인 준수 모니터링 방법을 이해하고, 문서 검토의 트리거에 대해 배우고, 계정 상태를 사전적으로 관리하세요.
  </Card>
</CardGroup>
