...
지역 결제 방법(UPI, iDEAL 등)은 일치하는 청구지 주소가 필요합니다. 미국 청구지 주소는 iDEAL을 표시하지 않습니다.

BNPL 방법은 최소 $50.01이 필요합니다. 장바구니 총액에 따라 올바르게 나타나거나 숨겨지는지 테스트하십시오.
...
Dodo Payments CLI를 사용하여 로컬에서 웹훅 테스트.
