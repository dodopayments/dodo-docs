...
<Frame>
<img src="/images/product-catalog/product-metadata-ui.png" alt="Dodo Payments 대시보드의 제품 메타데이터 인터페이스" />
</Frame>
...
### 해야 할 일:
- 메타데이터 키에 대해 일관된 명명 규칙을 사용하세요
- 내부적으로 메타데이터 스키마를 문서화하세요
- 값은 짧고 의미 있게 유지하세요
- 정적 데이터에 대해서만 메타데이터를 사용하세요
- 서로 다른 시스템에 대해 접두사를 사용하는 것을 고려하세요 (예: `crm_id`, `inventory_sku`)
