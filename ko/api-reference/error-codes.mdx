...
- `DISCOUNT_CONCURRENT_REDEMPTION`
  - **Trigger:** 동일한 code를 다른 redemption에서 사용하면서 usage-limit row lock을 너무 오래 보유함 (HTTP 503)
  - **Message:** Discount is being redeemed concurrently; please retry
  - **Note:** 일시적인 오류입니다. code에 아직 사용 가능 횟수가 남아 있을 수 있으므로 요청을 안전하게 재시도할 수 있습니다. 고객에게 이를 "code exhausted"로 표시하지 마세요.
