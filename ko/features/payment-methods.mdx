...
| **Klarna**               | 미국, 유럽            | USD, EUR, GBP 외 7개  | 예          | $50.01 |
...
| **PAYCO**                | 대한민국              | KRW                  | 아니요      | 약 $1.00 |
| **Naver Pay**            | 대한민국              | KRW                  | 예          | 약 $1.00 |
| **Kakao Pay**            | 대한민국              | KRW                  | 예          | 약 $1.00 |
...
BNPL 수단에는 제공업체별 최소 금액이 있습니다. Klarna와 Afterpay는 $50.01을 요구합니다. 이 범위를 벗어나는 제품에는 해당 수단을 포함하지 마세요. 해당 수단은 표시되지 않으며, 이는 정상입니다.
</Accordion>
...
3. 거래 통화가 해당 수단에서 지원되나요?
    4. 거래 금액이 해당 수단의 지원 범위 내에 있나요(예: Klarna/Afterpay 최소 금액 $50.01)?
5. 구독의 경우 해당 수단이 recurring payments를 지원하나요?
