...
<Accordion title="카드 대체 수단 제공">
모든 유럽 고객이 이러한 지역 방법에 접근할 수 있는 것은 아닙니다 (관광객, 외국인 근무자 등). 항상 `credit` 및 `debit`을 대체 수단으로 포함하십시오.
</Accordion>
...
3. 방법이 `allowed_payment_method_types`에 포함되어 있습니까?

**해결책:** 유럽 방법은 엄격하게 지역적입니다. 청구 국가가 `DE` (독일)인 고객은 네덜란드 전용인 iDEAL을 볼 수 없습니다.
</Accordion>
