...
<Frame>
<img src="/images/customer/customers-list.png" alt="고객 세부 정보가 포함된 모든 고객을 보여주는 고객 목록 페이지" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/customer/customer-details.png" alt="고객 정보 및 거래 내역을 보여주는 고객 세부 정보 페이지" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
Customer Wallets는 고객을 위한 선불 금액 잔액 계정입니다. 각 고객에게는 여러 통화(USD, EUR, GBP)로 실제 자금을 보유할 수 있는 지갑이 자동으로 제공되며, 이 자금은 구독 인보이스에 적용하거나 환불 잔액으로 사용하거나 프로모션 보너스로 충전할 수 있습니다.

### Key Features

- **다중 통화 지원**: USD, EUR, GBP의 금액 잔액을 별도로 추적합니다.
- **선불 잔액**: 고객은 향후 인보이스 및 구독 결제에 적용할 자금을 보유할 수 있습니다.
- **거래 내역**: 모든 자금 추가 및 차감 내역이 포함된 전체 원장을 확인합니다.
- **API 우선 설계**: 프로그래밍 방식으로 지갑 잔액을 추가, 차감 및 확인합니다.
- **크레딧 기반 결제**: 고객이 크레딧을 선불로 구매하고 서비스에 사용할 수 있도록 합니다.
- **거래 내역**: 모든 크레딧 및 차변 내역이 포함된 전체 원장을 확인합니다.
