...
예. [Bring Your Own Processor (BYOP)](/features/byop)를 사용하면 자체 Stripe 또는 Adyen 계정을 연결하고 선택한 국가의 결제를 해당 계정을 통해 라우팅할 수 있으며, Dodo Payments는 계속해서 제품, 구독, 청구 및 분석을 지원합니다. 명시적으로 라우팅하지 않은 국가는 Dodo Payments를 전체 서비스를 제공하는 Merchant of Record로 계속 이용하게 되며, 이를 통해 해당 경로의 세금 및 사기 책임을 당사가 부담할 수 있습니다.
</Accordion>
