...
<img src="/images/CBB/Checkout.png" alt="제품 구매 시 포함된 크레딧을 보여주는 결제" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Entitlements  - Credits.jpg" alt="생성된 크레딧 권한을 보여주는 크레딧 목록 페이지" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Create Credit.jpg" alt="기본 정보, 일반 설정, 구독 설정을 보여주는 크레딧 생성 양식" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - Subscription.jpg" alt="크레딧 첨부 버튼이 있는 제품 권한 섹션" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - Subscription-2.jpg" alt="크레딧 선택 드롭다운이 있는 크레딧 추가 패널" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Attach Credit - Subscription-4.jpg" alt="청구 주기, 시험, 비례 배분 설정이 있는 크레딧 구성 양식" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - Subscription-5.jpg" alt="선택한 크레딧과 세부 정보를 보여주는 크레딧 추가 패널" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
</Steps>
...
<img src="/images/CBB/Desktop - Attach Credit - OTP.jpg" alt="단일 결제가 선택된 제품 가격 섹션" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - UBB.jpg" alt="사용량 기반 청구 가격 설정" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - UBB-3.jpg" alt="무료 임계값과 크레딧 토글이 있는 미터 선택 패널" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - UBB-5.jpg" alt="크레딧 선택 및 크레딧 당 미터 단위가 포함된 미터 구성" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - UBB-6.jpg" alt="UBB 제품에 대한 크레딧 구성" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
...
<img src="/images/CBB/Desktop - Attach Credit - UBB-1.jpg" alt="크레딧 첨부 세부 정보를 보여주는 구성된 미터" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
</Step>
</Steps>
...
<img src="/images/CBB/Desktop - Usage Billing.jpg" alt="크레딧이 소비된 이벤트 테이블을 보여주는 사용량 청구 대시보드" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Checkout.png" alt="포함된 API 호출 크레딧과 함께 제품을 보여주는 결제 페이지" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Customer Portal.jpg" alt="잔액과 거래 내역을 보여주는 고객 포털 크레딧 보기" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Subscription Details.jpg" alt="권한 및 사용 기록을 보여주는 구독 세부 정보 페이지" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Transactions - Payment Summary.jpg" alt="크레딧 권한을 보여주는 거래 세부 정보 페이지" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Entitlements  - Credits.jpg" alt="제품 섹션의 크레딧 목록 페이지" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Customer Details.jpg" alt="잔액 및 거래 내역이 있는 크레딧 탭을 보여주는 고객 세부 정보 페이지" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
**구성:**
- 크레딧 유형: 사용자 정의 단위("AI Tokens")
- 정밀도: 0 (정수 토큰)
- 이월: 최대 25%, 1개월 기간
- 초과 요금: 활성화됨, 결제 시 초과 요금 청구
...
**구성:**
- 크레딧 유형: 사용자 정의 단위("API Calls")
- 정밀도: 0 (정수 호출)
- 이월: 비활성화됨
- 초과 요금: Developer+ 요금제는 초과 요금 허용(초기화 시 면제), Free 요금제는 초과 요금 비활성화
- 미터: `api.request`, Count 집계
</Accordion>
...
**구성:**
- 크레딧 유형: 사용자 정의 단위("GB-hours")
- 정밀도: 2 (소수점 두 자리)
- 이월: 최대 50%, 한 번만 이월
- 초과 요금: 200% 제한으로 활성화됨
- 미터: `storage.usage`, Sum 집계
</Accordion>
</AccordionGroup>
