...
<CardGroup cols={2}>
<Card title="좌석 기반 청구" icon="users" href="/developer-resources/seat-based-pricing">
추가 팀 좌석, 사용자 라이센스 또는 좌석당 가격으로 용량 업그레이드를 위한 추가 기능을 만드세요.
</Card>

<Card title="사용량 확장" icon="bolt" href="/features/usage-based-billing">
유연한 추가 기능 가격으로 사용량 한도, API 호출 또는 데이터 허용량을 확장하세요.
</Card>
</CardGroup>
...
<Frame>
<img src="/images/cookbooks/seat-based/seat-based-addons.png" alt="대시보드에서 구독 제품에 첨부된 추가 기능" />
</Frame>
...
<Frame>
<img src="/images/cookbooks/seat-based/seat-based-addons-creation.png" alt="대시보드 인터페이스에서 추가 기능 만들기" />
</Frame>
...
<Steps>
<Step title="추가 기능 계획하기">
고객에게 도움이 될 추가 기능, 서비스 또는 용량을 식별하세요.
...
<Step title="첫 번째 추가 기능 만들기">
Dodo Payments 대시보드 또는 API를 사용하여 첫 번째 추가 기능 제품을 만드세요.

<Card title="대시보드 가이드" icon="box" href="/developer-resources/seat-based-pricing">
...
<AccordionGroup>
<Accordion title="추가 기능 만들기">
사용하여 `POST /addons` 엔드포인트를 통해 사용자 정의 가격, 설명 및 구성 옵션으로 새로운 추가 기능을 만듭니다.

<Card title="API 참조" icon="code" href="/api-reference/addons/create-addon">
추가 기능 생성을 위한 전체 API 문서를 확인하세요.
</Card>
</Accordion>

<Accordion title="추가 기능 업데이트">
기존 추가 기능을 수정하려면 `PATCH /addons/{id}` 엔드포인트를 사용하여 가격, 설명 또는 가용성을 업데이트합니다.

<Card title="API 참조" icon="code" href="/api-reference/addons/update-addon">
프로그래밍 방식으로 추가 기능 세부정보를 업데이트하는 방법을 알아보세요.
</Card>
</Accordion>

<Accordion title="목록 및 검색">
모든 추가 기능을 나열하려면 `GET /addons`를 사용하거나 특정 추가 기능 세부정보를 검색하려면 `GET /addons/{id}`를 사용합니다.

<Card title="API 참조" icon="code" href="/api-reference/addons/list-addons">
전체 목록 및 검색 API 문서에 접근하세요.
</Card>
</Accordion>

<Accordion title="이미지 관리">
더 나은 제품 프레젠테이션을 위해 추가 기능 이미지를 업데이트하려면 `PUT /addons/{id}/images` 엔드포인트를 사용합니다.

<Card title="API 참조" icon="code" href="/api-reference/addons/update-addon-images">
