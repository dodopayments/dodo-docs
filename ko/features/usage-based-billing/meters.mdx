...
<Frame>
<img src="/images/usage-based/UBB-2.png" alt="이벤트 이름, 집계 유형 및 필터링 옵션을 보여주는 미터 생성 인터페이스" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<Frame>
<img src="/images/usage-based/UBB-3.png" alt="이벤트 필터링" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
**비교 연산자**: 같음, 같지 않음, 초과, 이상, 미만, 이하, 포함함, 포함하지 않음
...
<Frame>
<img src="/images/usage-based/UBB-1.png" alt="미터 분석" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
...
<img src="/images/CBB/Desktop - Attach Credit - UBB-5.jpg" alt="크레딧에 사용량 청구 토글이 활성화된 미터 구성" style={{ maxHeight: '500px', width: 'auto' }} />
</Frame>
