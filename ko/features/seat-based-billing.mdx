...
Team Pro 구독은 월 \$99이며 5개의 좌석이 포함됩니다. 사용자가 5명을 초과하면 추가 좌석마다 월 \$15를 추가로 지불합니다.

예를 들어 팀에 15개의 좌석이 필요한 경우:
- 기본 요금제: 월 \$99 (5개 좌석 포함)
- 추가 요금: 추가 좌석 10개 × 월 \$15 = 월 \$150
- 월 총 비용: \$99 + \$150 = 좌석 15개 기준 \$249
...
<Card title="Add-ons" icon="puzzle" href="/features/addons">
  add-on 시스템을 심층적으로 이해합니다.
</Card>

<Card title="Plan Changes & Proration" icon="arrows-rotate" href="/developer-resources/subscription-upgrade-downgrade">
  subscription 수정 사항을 처리합니다.
</Card>

<Card title="Subscription Webhooks" icon="bell" href="/developer-resources/webhooks/intents/subscription">
  subscription 이벤트를 추적합니다.
</Card>
</CardGroup>
