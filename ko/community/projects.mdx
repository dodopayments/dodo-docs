...
<Tab title="라이브러리 및 SDKs">
  <CardGroup cols={1}>
    ...
    <Card title="dodpayments_rust_sdk (Rust)" href="https://github.com/Muhammad-Owais-Warsi/dodpayments_rust_sdk" icon="rust">
      ...
      <br/>Rust 서비스에서 핵심 엔드포인트를 호출하기 위한 타입 지정 모델 및 헬퍼 제공합니다.
    ...
    <Card title="Dodo Payments Laravel SDK (PHP)" href="https://github.com/codeplugtech/dodo-payments" icon="php">
      ...
      <br/>빠른 서비스 클래스와 헬퍼로 Laravel 애플리케이션에 Dodo Payments API 통합을 손쉽게 합니다.
    ...
    <Card title="dodo-payments-rs (Rust)" href="https://github.com/PiyushXCoder/dodo-payments-rs" icon="rust">
      ...
      <br/>요청 및 응답을 위한 미리 정의된 구조체가 있으며, 빌더 패턴을 사용해 결제 관련 API 호출을 간편하게 구성하고 보낼 수 있습니다.
...
<Card title="multi-app-dodo-payments (Python)" href="https://github.com/aniketkarne/multi-app-dodo-payments" icon="python">
      ...
      <br/>Dodo Payments를 사용하는 여러 애플리케이션에 대한 결제를 처리하는 FastAPI로 구축된 프로덕션 준비 완료 결제 마이크로서비스. 
      <br/>기능에는 다음이 포함됩니다: <br/> `credit management`, `subscription support`, `webhook processing with idempotency`, `complete audit trails`, `MixPanel Analytics`, `Backend-to-backend architecture with API key authentication`.
...
<Tab title="플러그인 & 확장">
  <CardGroup cols={1}>
    <Card title="Dodo WHMCS (PHP)" href="https://github.com/Akash123a5/dodo-whmcs" icon="php">
      ...
      <br/>Dodo Payments를 사용하여 WHMCS에서 결제를 수집할 수 있는 제공업체입니다.
...
<Tab title="보일러플레이트 & 스타터">
  <CardGroup cols={1}>
    ...
    <Card title="Dodo Payments 보일러플레이트" href="https://github.com/vanshcodeworks/dodo_payments_boilerplate" icon="rocket">
      일반 흐름을 위한 경량 스타터.
      <br/>예제 페이지와 함께 결제를 생성하고 확인하는 최소 설정.
    ...
    <Card title="PaymentService" href="https://github.com/rasadov/PaymentService" icon="rocket">
      결제 흐름을 가진 서비스 템플릿.
      <br/>결제 의도 및 웹훅 주위의 클린 아키텍처를 시연합니다.
