...
| `fields` | object | 아니오 | 필드 이름/값 쌍을 가진 객체 |
| `fields.name` | string | 아니오 | 구독자의 이름 |
| `fields.last_name` | string | 아니오 | 구독자의 성 |
| `fields.company` | string | 아니오 | 회사 이름 |
| `fields.country` | string | 아니오 | 국가 |
| `fields.city` | string | 아니오 | 도시 |
| `fields.phone` | string | 아니오 | 전화번호 |
| `groups` | array | 아니오 | 구독자를 추가할 그룹 ID의 배열 |
| `status` | string | 아니오 | 다음 중 하나: active, unsubscribed, unconfirmed, bounced, junk |
| `subscribed_at` | string | 아니오 | 형식 `yyyy-MM-dd HH:mm:ss`의 날짜 |
| `ip_address` | string | 아니오 | 구독자의 IP 주소 |
