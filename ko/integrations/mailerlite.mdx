...
<Step title="Open the Webhook Section">
  Dodo Payments 대시보드에서 <b>Webhook + 엔드포인트 추가</b>로 이동하고 통합 드롭다운을 확장하세요.
  <Frame>
    <img src="/images/integrations/mailerlite.png" alt="엔드포인트 추가 및 통합 드롭다운" style={{ maxHeight: '500px', width: 'auto' }} />
  </Frame>
</Step>
