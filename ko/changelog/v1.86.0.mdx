...
크레딧은 상품 생성 흐름에서 **권한(entitlements)** 으로 부착됩니다. 상품당 최대 **5개의 크레딧**을 부착할 수 있으며, 구독, 일회성 결제, 사용량 기반 청구의 세 가지 가격 유형과 모두 호환됩니다.
...
자세히 알아보기: [List Payments API](/api-reference/payments/get-payments)
