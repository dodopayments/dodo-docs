...
### 1. **커뮤니케이션 환경설정**
   ...
   <Frame>
     <img src="/images/communication-preferences/overview.png" alt="커뮤니케이션 환경 설정 개요가 알림 설정을 보여줌" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
...
### 2. **체크아웃 세션의 커스텀 필드**
   ...
   **혜택**
   ...
   <Info>
   사용자 정의 필드 값은 결제 및 구독 응답의 `custom_field_responses` 배열에서 반환됩니다.
   </Info>

   자세히 알아보기: [Checkout Session Custom Fields](/developer-resources/checkout-session#15-collecting-custom-fields)
