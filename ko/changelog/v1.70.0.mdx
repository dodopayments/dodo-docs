...
3. **대시보드에서 구독 계획 변경 및 다음 청구 날짜 업데이트**  
    ...
    <Frame>
    <img src="/images/changelog/subscription-plan-changes.png" alt="대시보드에서의 구독 플랜 변경" style={{ maxHeight: '500px', width: 'auto' }} />
    </Frame>
...
4. **결제 URL을 위한 짧은 링크**  
   ...
   <Frame>
   <img src="/images/changelog/short-links.png" alt="결제 URL을 위한 단축 링크 기능" style={{ maxHeight: '500px', width: 'auto' }} />
   </Frame>
