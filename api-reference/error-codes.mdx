...
- `UNSUPPORTED_DISCOUNT_TYPE`
  - **Trigger:** A discount type that is not supported in the requested context. `percentage` and `flat` are both supported; `flat_per_unit` remains blocked
  - **Message:** This discount type is not supported
