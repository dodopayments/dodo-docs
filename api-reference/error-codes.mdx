...
| **502** | Bad Gateway | An upstream service is temporarily unavailable — retry the request |
...
- `BUSINESS_ARCHIVED`
  - **Trigger:** Any customer-facing request (checkout, payment link, storefront, Customer Portal, or license key) for a business that has been archived
...
- `BRAND_ARCHIVED`
  ...
  - **Message:** Brand is archived and cannot be updated
...
- `BRAND_ARCHIVE_TARGET_REQUIRED`
  ...
  - **Message:** Brand has {count} product(s). Set move_products_to to a target brand to re-tag them.
...
- `INVALID_BRAND_ARCHIVE_TARGET`
  ...
  - **Message:** move_products_to must be a brand of this business that is not archived
